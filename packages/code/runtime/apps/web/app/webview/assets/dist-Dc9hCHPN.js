...
var O = `PopperAnchor`,
  k = _.forwardRef((e, t) => {
    ...
    return (
      _.useEffect(() => {
        let e = u.current;
        ((u.current = r?.current || c.current),
          e !== u.current && s.onAnchorChange(u.current));
      }),
...
//# sourceMappingURL=dist-Dc9hCHPN.js.map
