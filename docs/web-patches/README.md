...
- `0003-mobile-sidebar-project-actions`: keep project row action icons visible on touch browser layouts without relying on hover.
- `0004-browser-shell-branding`: identify the browser-served shell as O3 Code through title, metadata, favicon, and startup splash branding.
