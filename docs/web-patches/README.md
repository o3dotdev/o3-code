...
- `0003-browser-sidebar-iframe-renderer`: render the browser sidebar in the Mirrored Web Client with a real iframe and keep it synced from host browser snapshots.
