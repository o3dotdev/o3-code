...
| [0003 statsig-gates-always-enabled](./0003-statsig-gates-always-enabled.md) | `o3-code-patch-begin: statsig-gates-always-enabled` / `o3-code-patch-end: statsig-gates-always-enabled` | Forces only the realtime voice Statsig gate enabled while leaving other gates, configs, layers, and experiments upstream-driven. |
