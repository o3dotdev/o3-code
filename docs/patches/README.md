...
| [0009 agent runtime terminal threads](./0009-agent-runtime-terminal-threads/)   | Adds Agent Runtime metadata and terminal-backed local conversations for external CLI agents.                  |
