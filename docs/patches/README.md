...
| [0009 suppress startup error dialog](./0009-suppress-startup-error-dialog/)     | Quits cleanly instead of showing the native startup-error dialog when the Package Launcher manages the run.   |
