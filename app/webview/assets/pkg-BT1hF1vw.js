const __vite__mapDeps = (
  ...
  d = m.f ||
    (m.f = [
      "./auto-track-BpSImFMj.js",
      "./callback-D3XouXrX.js",
      "./middleware-By-EZQSy.js",
      "./middleware-DR_TC0-Y.js",
      "./chunk-Bj-mKKzh.js",
      "./tslib.es6-PiNIxp0T.js",
      "./query-string-JIIdAXm1.js",
      "./helpers-DT7PVJL_.js",
      "./gracefulDecodeURIComponent-DFJaCjF3.js",
      "./routing-middleware-HecfENOk.js",
      "./ajs-destination-BYy3-oU5.js",
      "./metric-helpers-Cs6bhyFT.js",
      "./load-script-CxIfiYMX.js",
      "./is-plan-event-enabled-BObLQg--.js",
      "./legacy-video-plugins-C4TGNpK4.js",
      "./preload-helper-I1wKxk_B.js",
      "./schema-filter-DhwWMLTv.js",
      "./remote-middleware-CNan41WJ.js",
    ]),
) => i.map((i) => d[i]);
...
import { a as b, i as x, n as S, r as C, t as w } from "./helpers-DT7PVJL_.js";
import { t as T } from "./callback-D3XouXrX.js";
import {
  a as E,
  c as D,
  d as ee,
  ...
  t as A,
  u as ae,
} from "./metric-helpers-Cs6bhyFT.js";
import { t as oe } from "./gracefulDecodeURIComponent-DFJaCjF3.js";
import {
  a as se,
  c as ce,
  o as le,
...
var pe = function (e, t) {
  ...
  me = `is nil`;
function he(e) {
  if (!w(e)) throw new j(`Event`, me);
  if (typeof e != `object`) throw new j(`Event`, N);
}
function ge(e) {
  if (!b(e.type)) throw new j(`.type`, M);
}
function _e(e) {
  if (!b(e.event)) throw new j(`.event`, M);
}
function ve(e) {
  if (!x(e.properties)) throw new j(`.properties`, N);
}
function ye(e) {
  if (!x(e.traits)) throw new j(`.traits`, N);
}
function be(e) {
  if (!b(e.messageId)) throw new j(`.messageId`, M);
}
function xe(e) {
  (he(e),
    ge(e),
    be(e),
    e.type === `track` && (_e(e), ve(e)),
    [`group`, `identify`].includes(e.type) && ye(e));
}
var Se = (function () {
    function e(e) {
      ((this.settings = e),
    ...
    return (
      ...
      (e.prototype.page = function (e, t, n, r, i) {
        ...
        return (
          ...
          t !== null && (a.name = t),
          this.normalize(o(o({}, this.baseEvent()), a))
        );
      }),
      ...
      (e.prototype.alias = function (e, t, n, r) {
        ...
        return (
          ...
          e === void 0
            ? this.normalize(o(o({}, i), this.baseEvent()))
            : this.normalize(o(o({}, this.baseEvent()), i))
        );
      }),
      ...
      (e.prototype.context = function (e) {
        ...
        return (
          n.forEach(function (n) {
            n !== `context` && (t.includes(n) ? d(i, n, e[n]) : d(r, n, e[n]));
          }),
          [r, i]
        );
      }),
      (e.prototype.normalize = function (e) {
        var n = Object.keys(e.integrations ?? {}).reduce(function (t, n) {
          var r;
          return o(o({}, t), ((r = {}), (r[n] = !!e.integrations?.[n]), r));
        }, {});
        e.options = pe(e.options || {}, function (e, t) {
          return t !== void 0;
        });
        var r = o(o({}, n), e.options?.integrations),
        ...
        return (this.settings.onFinishedEvent(u), xe(u), u);
      }),
      e
    );
  })();
function we(e, t) {
  ...
  return (
    e.forEach(function (e) {
      ...
      if (typeof t == `string`) {
        var a = e[t];
        r = typeof a == `string` ? a : JSON.stringify(a);
      } else t instanceof Function && (r = t(e));
      r !== void 0 && (n[r] = i(i([], n[r] ?? [], !0), [e], !1));
    }),
    n
  );
}
var Te = function (e) {
    return (
      typeof e == `object` && !!e && `then` in e && typeof e.then == `function`
    );
  },
  Ee = function () {
    var e,
  ...
  De = (function (e) {
    ...
    return (
      (t.prototype.register = function (e, t, i) {
              ...
              case 0:
                return (
                  ...
                  t.type === `destination` && t.name !== `Segment.io`
                    ? (t.load(e, i).catch(r), [3, 4])
                    : [3, 1]
                );
              case 1:
                return (n.trys.push([1, 3, , 4]), [4, t.load(e, i)]);
              case 2:
                return (n.sent(), [3, 4]);
              case 3:
      ...
      (t.prototype.deregister = function (e, t, i) {
        return r(this, void 0, void 0, function () {
          var r;
          return n(this, function (n) {
            switch (n.label) {
              case 0:
                return (
                  n.trys.push([0, 3, , 4]),
                  t.unload ? [4, Promise.resolve(t.unload(e, i))] : [3, 2]
                );
              case 1:
                (n.sent(), (n.label = 2));
              case 2:
        ...
        var t = we(
            this.plugins.filter(function (t) {
              ...
              return (
                ...
                e[t.name] ?? r ?? (t.name === `Segment.io` ? !0 : e.All) !== !1
              );
            }),
            `type`,
          ),
      ...
      (t.prototype.flushOne = function (e) {
        return r(this, void 0, void 0, function () {
          var t, r, i, a, o, s, c, l, u, d, c, f, p, m, g;
          return n(this, function (n) {
            switch (n.label) {
              case 0:
                if (!this.isReady()) throw Error(`Not ready`);
                (e.attempts > 1 && this.emit(`delivery_retry`, e),
                  (t = this.availableExtensions(e.event.integrations ?? {})),
                  (r = t.before),
                  (i = t.enrichment),
                  (a = 0),
                  (o = r),
                  (n.label = 1));
              case 1:
                return a < o.length ? ((s = o[a]), [4, D(e, s)]) : [3, 4];
              case 2:
                ((c = n.sent()),
                  c instanceof h && (e = c),
              ...
              case 4:
                ((l = 0), (u = i), (n.label = 5));
              case 5:
                return l < u.length ? ((d = u[l]), [4, k(e, d)]) : [3, 8];
              case 6:
                ((c = n.sent()),
                  c instanceof h && (e = c),
              ...
              case 8:
                return (
                  (f = this.availableExtensions(e.event.integrations ?? {})),
                  (p = f.destinations),
                  (m = f.after),
                  [
                    4,
    ...
    return n(this, function (n) {
      switch (n.label) {
        ...
        case 3:
          ((o = n.sent()), (n.label = 4));
        case 4:
          return a?.callback ? [4, T(o, a.callback, Oe(r, a.timeout))] : [3, 6];
        case 5:
          ((o = n.sent()), (n.label = 6));
        case 6:
...
function Ae(e, t, n, r) {
  var i = [e, t, n, r],
    a = x(e) ? e.event : e;
  if (!a || !b(a)) throw Error(`Event missing`);
  var o = x(e) ? (e.properties ?? {}) : x(t) ? t : {},
    s = {};
  (S(n) || (s = n ?? {}), x(e) && !S(t) && (s = t ?? {}));
  var c = i.find(S);
  return [a, o, s, c];
...
function je(e, t, n, r) {
  (C(e) && (e = e.toString()), C(t) && (t = t.toString()));
  var i = [e, t, n, r],
    a = i.filter(b),
    o = a[0],
    s = o === void 0 ? e : o,
    ...
    l = c === void 0 ? null : c,
    u = i.filter(x)[0];
  return [s, l, u === void 0 ? {} : u, i.find(S)];
}
function Me(e) {
  return (
...
var Ne = function (e, t, n, r, i, a) {
    return { __t: `bpc`, c: t, p: r, u: e, s: n, t: i, r: a };
  },
  Pe = Object.keys(Ne(``, ``, ``, ``, ``, ``));
function Fe(e) {
  if (!Me(e) || e.__t !== `bpc`) return !1;
  for (var t in e) if (!Pe.includes(t)) return !1;
  return !0;
}
var Ie = function (e, t) {
...
var I = function (e, t) {
    ...
    var n = e.context,
      r;
    (e.type === `page` &&
      ((r = e.properties && He(e.properties, Object.keys(t))),
      (e.properties = o(
        o(o({}, t), e.properties),
        e.name ? { name: e.name } : {},
      ))),
  ...
  Ge = (function (e) {
    a(t, e);
    function t(t) {
      return e.call(this, typeof t == `string` ? new O(4, t) : t) || this;
    }
    return (
      (t.prototype.flush = function () {
        return r(this, void 0, void 0, function () {
          return n(this, function (t) {
            return E() ? [2, []] : [2, e.prototype.flush.call(this)];
          });
        });
      }),
      t
  ...
  return Object.create(
    {
      ...
      withAttributes: function (e) {
        return z(this.converter, R({}, this.attributes, e));
      },
      withConverter: function (e) {
        return z(R({}, this.converter, e), this.attributes);
      },
    },
    {
...
function Ye(e) {
  var t = Je(e);
  if (t)
    for (var n = qe(t), r = 0; r < n.length; ++r) {
      var i = `__tld__`,
        a = n[r],
        o = { domain: `.` + a };
      try {
        if ((B.set(i, `1`, o), B.get(i))) return (B.remove(i, o), a);
      } catch {
        return;
      }
    }
...
var Xe = 365,
    ...
    return (
      Object.defineProperty(e, `defaults`, {
        get: function () {
          return {
            maxage: Xe,
            domain: Ye(window.location.href),
            path: `/`,
            sameSite: `Lax`,
          };
        },
  ...
  H = { Cookie: `cookie`, LocalStorage: `localStorage`, Memory: `memory` };
function $e(e) {
  return (
    e &&
    e.stores &&
...
function G(e) {
  return e.map(function (e) {
    var t, n;
    switch ((et(e) ? ((t = e.name), (n = e.settings)) : (t = e), t)) {
      case H.Cookie:
        return new Ze(n);
      case H.LocalStorage:
        return new Qe();
...
function tt(e, t) {
  return e.map(function (e) {
    return t && e === H.Cookie ? { name: e, settings: t } : e;
  });
}
var K = {
    persist: !0,
  ...
  nt = (function () {
    function e(e, t) {
      ...
      ((this.options = {}),
        (this.id = function (e) {
          ...
          if (r) return r;
          var i = n.legacyUserStore.get(K.cookie.oldKey);
        ...
        (this.anonymousId = function (e) {
          ...
          return e === null
            ...
            : (n.identityStore.set(n.anonKey, e ?? p()),
              n.identityStore.getAndSync(n.anonKey));
        }),
        ...
        (this.options = o(o({}, K), e)),
        (this.cookieOptions = t),
        (this.idKey = e.cookie?.key ?? K.cookie.key),
        (this.traitsKey = e.localStorage?.key ?? K.localStorage.key),
      ...
      var r = this.legacyUserStore.get(K.cookie.oldKey);
      (r &&
        typeof r == `object` &&
    ...
    return (
      ...
      (e.prototype.createStorage = function (e, t, n) {
        var r = [H.LocalStorage, H.Cookie, H.Memory];
        return e.disable
          ? new W([])
          : e.persist
            ? (e.storage !== void 0 &&
  ...
  it = (function (e) {
    ...
    function t(t, n) {
      t === void 0 && (t = rt);
      var r = e.call(this, o(o({}, rt), t), n) || this;
      return ((r.anonymousId = function (e) {}), L(r), r);
    }
    return t;
  })(nt),
  at = function (e) {
    ...
    return r(void 0, void 0, void 0, function () {
      ...
      return n(this, function (n) {
        switch (n.label) {
          case 0:
            ((r = 0),
              (i = t.getAndRemove(`addSourceMiddleware`)),
              (n.label = 1));
          case 1:
            return r < i.length
              ? ((a = i[r]), [4, Y(e, a).catch(console.error)])
              : [3, 4];
          case 2:
            (n.sent(), (n.label = 3));
          case 3:
  ...
  ct = function (e, t) {
    return r(void 0, void 0, void 0, function () {
      ...
      return n(this, function (n) {
        switch (n.label) {
          case 0:
            ((r = 0), (i = t.getAndRemove(`register`)), (n.label = 1));
          case 1:
            return r < i.length
              ? ((a = i[r]), [4, Y(e, a).catch(console.error)])
              : [3, 4];
  ...
  lt = ot.bind(void 0, `on`),
  ut = ot.bind(void 0, `setAnonymousId`),
  dt = function (e, t) {
  ...
  return r(this, void 0, void 0, function () {
    ...
    return n(this, function (n) {
      switch (n.label) {
        ...
        case 3:
          return ((i = n.sent()), t.reject(i), [3, 4]);
        case 4:
          return [2];
      }
    });
      ...
      (e.prototype._createMethod = function (e) {
        ...
        return function () {
          ...
          return new Promise(function (n, i) {
            t._preInitBuffer.add(new J(e, r, n, i));
          });
        };
      }),
      (e.prototype._createChainableMethod = function (e) {
        ...
        return function () {
          ...
          return t.instance
            ...
            : (t._preInitBuffer.add(new J(e, r)), t);
        };
      }),
      e
    );
...
function Ct(e) {
  ...
  return (
    e.forEach(function (e) {
      (bt(t[n]) >= 64 && n++, t[n] ? t[n].push(e) : (t[n] = [e]));
    }),
    t
  );
}
  ...
  function f(n) {
    if (n.length !== 0) {
      ...
      return y(`https://${e}/b`, {
        ...
        keepalive: i?.keepalive || c,
        headers: _t(i?.headers),
        method: `post`,
        body: JSON.stringify({
          writeKey: r,
          batch: a,
        ...
        if (e.status === 429) {
          var t = e.headers?.get(`x-ratelimit-reset`),
            n = typeof t == `string` ? parseInt(t) * 1e3 : u;
          throw new gt(`Rate limit exceeded: ${e.status}`, n);
        }
      });
    }
  }
        ...
        return n(this, function (n) {
          return a.length
            ? ((t = a),
              ...
              [
                2,
                f(t)?.catch(function (n) {
                  (s.system().log(`error`, `Error sending batch`, n),
                    e <= (i?.maxRetries ?? 10) &&
                      (n.name === `RateLimitError` && (d = n.retryTimeout),
                      a.push.apply(a, t),
                      a.map(function (t) {
                        if (`_metadata` in t) {
                          var n = t;
    ...
    (e === void 0 && (e = 1),
      !m &&
        ((m = setTimeout(function () {
          ((m = void 0), p(e).catch(console.error));
        }, d || u)),
        (d = 0)));
  }
  ht(function (e) {
  ...
  function g(e, t) {
    return r(this, void 0, void 0, function () {
      ...
      return n(this, function (n) {
        return (
          a.push(t),
          (e = a.length >= l || xt(a) || (i?.keepalive && St(a))),
          [2, e || c ? p() : h()]
        );
      });
    });
...
function At(e, t, i) {
  ...
  var a = t?.apiKey ?? ``,
    o = e.options.disableClientPersistence
      ? new ae(e.queue.queue.maxAttempts, [])
      : new O(e.queue.queue.maxAttempts, `${a}:dest-Segment.io`),
    s = new Set(),
    c = !1,
    l = t?.apiHost ?? _,
    u = t?.protocol ?? `https`,
  ...
  function m(a) {
    return r(this, void 0, void 0, function () {
      ...
      return n(this, function (n) {
        return E()
          ? (o.push(a), X(c, o, h, X), [2, a])
          : (s.add(a),
            (r = a.event.type.charAt(0)),
            (l = g(a.event).json()),
            a.event.type === `track` && delete l.traits,
            a.event.type === `alias` && (l = Ot(e, l)),
            o.getAttempts(a) >= o.maxAttempts
              ? (s.delete(a), [2, a])
              : [
                  2,
                  p
                    .dispatch(`${d}/${r}`, Et(e, l, t, i, a))
                    .then(function () {
                      return a;
                    })
                    .catch(function (e) {
                      if (
                        (a.log(`error`, `Error sending event`, e),
  ...
  return (o.todo && X(c, o, h, X), h);
}
var Z = `This is being deprecated and will be not be available in future releases of Analytics JS`,
  jt = l()?.analytics;
function Mt(e, t, n) {
  (t === void 0 && (t = !1), n === void 0 && (n = !1));
  var r = t ? 10 : 1;
  return new Ge(n ? new ae(r, []) : new O(r, e));
}
var Nt = (function () {
  function e(e, t) {
    ((this.timeout = 300),
      (this._getSegmentPluginMetadata = function () {
        return t.plugins.find(kt)?.metadata;
      }),
...
var Pt = (function (t) {
    ...
    function c(e, n, r, i, a) {
      ...
      ((s = t.call(this) || this),
        ...
        (s.log = Q),
        (s.addIntegrationMiddleware = Q),
        (s.listeners = Q),
        (s.addEventListener = Q),
        (s.removeAllListeners = Q),
        (s.removeListener = Q),
        (s.removeEventListener = Q),
        (s.hasListeners = Q),
        (s.add = Q),
        (s.addIntegration = Q));
      var c = n?.cookie,
        l = n?.disableClientPersistence ?? !1;
      ((s.queue = r ?? Mt(`${e.writeKey}:event-queue`, n?.retryQueue, l)),
        (s.settings = new Nt(e, s.queue)));
      var u = n?.storage;
      return (
        (s._universalStorage = s.createStore(l, u, c)),
        (s._user =
          i ??
          new nt(o({ persist: !l, storage: n?.storage }, n?.user), c).load()),
        (s._group =
          a ??
          new it(o({ persist: !l, storage: n?.storage }, n?.group), c).load()),
        (s.eventFactory = new Ue(s._user)),
    ...
    return (
      (c.prototype.createStore = function (e, t, n) {
        return e
          ? new W([new V()])
          : t && $e(t)
            ? new W(G(tt(t.stores, n)))
            : new W(
                G([H.LocalStorage, { name: H.Cookie, settings: n }, H.Memory]),
              );
      }),
        ...
        return r(this, void 0, void 0, function () {
          ...
          return n(this, function (n) {
            return (
              ...
              (o = r[2]),
              (s = r[3]),
              (c = this.eventFactory.track(i, a, o, this.integrations, t)),
              [
                2,
                this._dispatch(c, s).then(function (e) {
                  return (
                    l.emit(`track`, i, e.event.properties, e.event.options),
                    e
                  );
                }),
              ]
        ...
        return r(this, void 0, void 0, function () {
          ...
          return n(this, function (n) {
            return (
              ...
              (s = r[3]),
              (c = r[4]),
              (l = this.eventFactory.page(i, a, o, s, this.integrations, t)),
              [
                2,
                this._dispatch(l, c).then(function (e) {
                  return (
                    u.emit(`page`, i, a, e.event.properties, e.event.options),
                    e
                  );
                }),
              ]
      ...
      (c.prototype.group = function () {
        ...
        var i = F(this._group).apply(void 0, t),
          a = i[0],
          o = i[1],
          s = i[2],
          c = i[3];
        ...
        return r(this, void 0, void 0, function () {
          ...
          return n(this, function (n) {
            return (
              ...
              (o = r[2]),
              (s = r[3]),
              (c = this.eventFactory.alias(i, a, o, this.integrations, t)),
              [
                2,
                this._dispatch(c, s).then(function (e) {
        ...
        return r(this, void 0, void 0, function () {
          ...
          return n(this, function (n) {
            return (
              ...
              (s = r[3]),
              (c = r[4]),
              (l = this.eventFactory.screen(i, a, o, s, this.integrations, t)),
              [
                2,
                this._dispatch(l, c).then(function (e) {
                  return (
                    u.emit(`screen`, i, a, e.event.properties, e.event.options),
                    e
                  );
                }),
              ]
      ...
      (c.prototype.trackClick = function () {
        var t = [...arguments];
        return r(this, void 0, void 0, function () {
          var r, a;
          return n(this, function (n) {
            switch (n.label) {
              ...
              case 1:
                return (
                  (r = n.sent()),
                  [2, (a = r.link).call.apply(a, i([this], t, !1))]
                );
            }
          });
        });
      }),
      (c.prototype.trackLink = function () {
        var t = [...arguments];
        return r(this, void 0, void 0, function () {
          var r, a;
          return n(this, function (n) {
      ...
      (c.prototype.trackSubmit = function () {
        var t = [...arguments];
        return r(this, void 0, void 0, function () {
          var r, a;
          return n(this, function (n) {
            switch (n.label) {
              ...
              case 1:
                return (
                  (r = n.sent()),
                  [2, (a = r.form).call.apply(a, i([this], t, !1))]
                );
            }
          });
        });
      }),
      (c.prototype.trackForm = function () {
        var t = [...arguments];
        return r(this, void 0, void 0, function () {
          var r, a;
          return n(this, function (n) {
            ...
            switch (n.label) {
              case 0:
                return (
                  (t = s.system()),
                  (r = e.map(function (e) {
                    var n = i.queue.plugins.find(function (t) {
                      return t.name === e;
                    });
                    if (n) return i.queue.deregister(t, n, i);
      ...
      (c.prototype.timeout = function (e) {
        this.settings.timeout = e;
      }),
      (c.prototype._dispatch = function (e, t) {
        return r(this, void 0, void 0, function () {
          var r;
          return n(this, function (n) {
            return (
              ...
              E() && !this.options.retryQueue
                ? [2, r]
                : [
                    2,
                    ke(r, this.queue, this, {
                      callback: t,
                      debug: this._debug,
      ...
      (c.prototype.addSourceMiddleware = function (t) {
        return r(this, void 0, void 0, function () {
          var i = this;
                    ...
                    return r(i, void 0, void 0, function () {
                      ...
                      return n(this, function (n) {
                        switch (n.label) {
                          ...
                          case 1:
                            return (
                              (r = n.sent().sourceMiddlewarePlugin),
                              (i = {}),
      ...
      (c.prototype.addDestinationMiddleware = function (e) {
        var t = [...arguments].slice(1);
        return (
          this.queue.plugins.filter(We).forEach(function (n) {
      ...
      (c.prototype.setAnonymousId = function (e) {
        return this._user.anonymousId(e);
      }),
      (c.prototype.queryString = function (t) {
        return r(this, void 0, void 0, function () {
          var r;
          return n(this, function (n) {
            switch (n.label) {
              case 0:
                return this.options.useQueryString === !1
                  ...
                  : [
                      4,
                      e(
                        () => import(`./query-string-JIIdAXm1.js`),
                        __vite__mapDeps([6, 7, 8]),
                        import.meta.url,
                      ),
                    ];
              case 1:
                return ((r = n.sent().queryString), [2, r(this, t)]);
            }
          });
        });
      }),
      ...
      (c.prototype.noConflict = function () {
        return (console.warn(Z), de(jt ?? this), this);
      }),
      (c.prototype.normalize = function (e) {
        return (console.warn(Z), this.eventFactory.normalize(e));
      }),
      Object.defineProperty(c.prototype, `failedInitializations`, {
        get: function () {
      ...
      Object.defineProperty(c.prototype, `VERSION`, {
        get: function () {
          return f;
        },
        enumerable: !1,
      ...
      (c.prototype.initialize = function (e, t) {
        return r(this, void 0, void 0, function () {
      ...
      (c.prototype.pageview = function (e) {
        return r(this, void 0, void 0, function () {
          return n(this, function (t) {
            switch (t.label) {
              case 0:
      ...
      Object.defineProperty(c.prototype, `plugins`, {
        get: function () {
          return (console.warn(Z), this._plugins ?? {});
        },
        enumerable: !1,
        configurable: !0,
      }),
      Object.defineProperty(c.prototype, `Integrations`, {
        get: function () {
          return (
            console.warn(Z),
            this.queue.plugins
      ...
      ((this.name = `Page Enrichment`),
        ...
        (this.enrich = function (t) {
          ...
          (n.locale === void 0 && a !== void 0 && (n.locale = a),
            (n.library ??= {
              name: `analytics.js`,
              version: `${c() === `web` ? `next` : `npm:next`}-1.82.0`,
            }),
            i && !n.campaign && (n.campaign = Bt(i)));
          var o = Vt();
          (o && (n.amp = { id: o }),
            Ht(i, n, e.instance.options.disableClientPersistence ?? !1));
          try {
      ...
      (e.prototype.transform = function (e) {
        return r(this, void 0, void 0, function () {
          ...
          return n(this, function (n) {
            switch (n.label) {
              case 0:
                return [4, v(this.name, e.event, this.middleware)];
              case 1:
                return (
                  (t = n.sent()),
                  t === null &&
            ...
            return n(this, function (n) {
              switch (n.label) {
                ...
                case 1:
                  ((t = n.sent()), (n.label = 2));
                case 2:
                  return (n.trys.push([2, 5, , 6]), [4, this.ready()]);
                case 3:
                  if (!n.sent())
                    throw Error(
      ...
      switch (n.label) {
        case 0:
          ...
          ((a = e.url.split(`/`)),
            ...
            (n.label = 1));
        case 1:
          return (n.trys.push([1, 3, , 5]), [4, fe(s.replace(r, i))]);
        case 2:
          return (n.sent(), [3, 5]);
        case 3:
          return (n.sent(), [4, fe(e.url.replace(r, i))]);
        case 4:
          return (n.sent(), [3, 5]);
        case 5:
          return [3, 8];
        case 6:
          return [4, fe(e.url.replace(r, i))];
        case 7:
          (n.sent(), (n.label = 8));
        case 8:
    ...
    return n(this, function (m) {
      switch (m.label) {
        case 0:
          return (
            (u = []),
            (d = e.middlewareSettings?.routingRules ?? []),
            (f = (e.remotePlugins ?? []).map(function (e) {
                  ...
                  switch (n.label) {
                    ...
                    case 3:
                      return (
                        (r = f),
                        r
                          ? ((p = i[e.name]), [4, r(o(o({}, e.settings), p))])
                          : [3, 5]
                      );
                    case 4:
                      ((m = n.sent()),
                        ...
                        h.forEach(function (t) {
                          var n = new Gt(e.creationName, t);
                          (g.length && c && n.addMiddleware(c), u.push(n));
                        }),
                        (n.label = 5));
                    case 5:
                      return [3, 7];
                    case 6:
                      return (
                        (_ = n.sent()),
                        console.warn(`Failed to load Remote Plugin`, _),
                        A(s.system(), {
        ...
        case 1:
          return (m.sent(), [2, u.filter(Boolean)]);
      }
    });
  });
}
var Xt,
  Zt = (Xt = l()).__SEGMENT_INSPECTOR__ ?? (Xt.__SEGMENT_INSPECTOR__ = {}),
  Qt = function (e) {
    return Zt.attach?.call(Zt, e);
  };
function $t(e, t) {
  return y(`${t}/v1/projects/${e}/settings`)
    .then(function (e) {
      return e.ok
        ? e.json()
...
function en(e) {
  return It().NODE_ENV !== `test` && Object.keys(e.integrations).length > 1;
}
function tn(e) {
  return (
    It().NODE_ENV !== `test` &&
      ...
      return n(this, function (D) {
        switch (D.label) {
            ...
            return (
              ...
              tn(a)
                ? [
                    ...
                    e(
                      () =>
                        import(`./routing-middleware-HecfENOk.js`).then(
                          function (e) {
            ...
            return (
              ...
              en(a) || l.length > 0
                ? [
                    ...
                    e(
                      () =>
                        import(`./ajs-destination-BYy3-oU5.js`).then(
                          function (e) {
                            return e.ajsDestinations(
                              t,
                              a,
                              o.integrations,
                              s,
          ...
          case 6:
            return (
              (h = g),
              a.legacyVideoPluginsEnabled
                ? [
                    4,
                    e(
                      () =>
                        import(`./legacy-video-plugins-C4TGNpK4.js`).then(
                          function (e) {
                            return e.loadLegacyVideoPlugins(o);
                          },
                        ),
          ...
          case 8:
            return s.plan?.track
              ? [
                  ...
                  e(
                    () =>
                      import(`./schema-filter-DhwWMLTv.js`).then(function (e) {
                        return e.schemaFilter(s.plan?.track, a);
                      }),
          ...
          case 11:
            return (
              ...
              [
                4,
                Yt(a, o.integrations, y, s, p, f).catch(function (e) {
                  return (
          ...
          case 12:
            return (
              ...
              S
                ? [3, 14]
                : ((w = (C = x).push),
                  [4, At(o, y[`Segment.io`], a.integrations)])
            );
          case 13:
            (w.apply(C, [D.sent()]), (D.label = 14));
          case 14:
            return [4, o.register.apply(o, i(i([], x, !1), d, !1))];
          case 15:
            return ((T = D.sent()), [4, ct(o, u)]);
          case 16:
            return (
              D.sent(),
              Object.entries(a.enabledMiddleware ?? {}).some(function (e) {
                return e[1];
              })
                ? [
                    4,
                    e(
                      () =>
                        import(`./remote-middleware-CNan41WJ.js`).then(
                          function (e) {
                            ...
                            return r(E, void 0, void 0, function () {
                              ...
                              return n(this, function (n) {
                                switch (n.label) {
                                  case 0:
                                    return [4, t(T, a, s.obfuscate)];
                                  case 1:
                                    return (
                                      (e = n.sent()),
                                      (r = e.map(function (e) {
                                        return o.addSourceMiddleware(e);
                                      })),
                                      [2, Promise.all(r)]
                                    );
                                }
...
function cn(e, t, i) {
  ...
  return (
    t === void 0 && (t = {}),
    r(this, void 0, void 0, function () {
      var r, c, l, u, d, f, p, h, g, _, v;
      return n(this, function (n) {
        switch (n.label) {
          case 0:
            return t.disable === !0
              ? [2, [new Ft(), s.system()]]
              : (t.globalAnalyticsKey && ce(t.globalAnalyticsKey),
                e.cdnURL && se(e.cdnURL),
                t.initialPageview && i.add(new J(`page`, [])),
                (r = an()),
                (c = e.cdnURL ?? ue()),
                (a = e.cdnSettings) == null ? [3, 1] : ((u = a), [3, 3]));
          case 1:
            return [4, $t(e.writeKey, c)];
          case 2:
            ((u = n.sent()), (n.label = 3));
          case 3:
            return (
              (l = u),
              t.updateCDNSettings && (l = t.updateCDNSettings(l)),
              typeof t.disable == `function` ? [4, t.disable(l)] : [3, 5]
            );
          case 4:
            if (((d = n.sent()), d)) return [2, [new Ft(), s.system()]];
            n.label = 5;
          case 5:
            return (
              (f = l.integrations[`Segment.io`]?.retryQueue ?? !0),
              (t = o({ retryQueue: f }, t)),
              (p = new Pt(o(o({}, e), { cdnSettings: l, cdnURL: c }), t)),
              Qt(p),
              (h = e.plugins ?? []),
              (g = e.classicIntegrations ?? []),
              (_ = t.integrations?.[`Segment.io`]),
              m.initRemoteMetrics(
                o(o({}, l.metrics), {
                  host: _?.apiHost ?? l.metrics?.host,
                  protocol: _?.protocol,
                }),
              ),
              [4, sn(e.writeKey, l, p, t, h, g, i)]
            );
          case 6:
            return (
              (v = n.sent()),
              (p.initialized = !0),
              p.emit(`initialize`, e, t),
              [4, rn(p, r, i)]
            );
          case 7:
            return (n.sent(), [2, [p, v]]);
...
export {
  Pt as Analytics,
  ln as AnalyticsBrowser,
  un as AnalyticsNode,
  s as Context,
  u as ContextCancelation,
  Ue as EventFactory,
  it as Group,
  W as UniversalStorage,
  nt as User,
  le as getGlobalAnalytics,
  We as isDestinationPluginWithAddMiddleware,
  je as resolveAliasArguments,
  Ae as resolveArguments,
  P as resolvePageArguments,
  F as resolveUserArguments,
  At as segmentio,
};
//# sourceMappingURL=pkg-BT1hF1vw.js.map
