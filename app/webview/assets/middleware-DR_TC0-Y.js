...
for (var o = 256, s = [], c; o--; ) s[o] = (o + 256).toString(16).substring(1);
function l() {
  var e = 0,
    t,
    n = ``;
  if (!c || o + 16 > 256) {
    for (c = Array((e = 256)); e--; ) c[e] = (256 * Math.random()) | 0;
    e = o = 0;
  }
  for (; e < 16; e++)
    ((t = c[o + e]),
  ...
  h = (function () {
    ...
    return (
      ...
      (e.prototype.cancel = function (e) {
        throw e || new m({ reason: `Context Cancel` });
      }),
      (e.prototype.log = function (e, t, n) {
      ...
      (e.prototype.updateEvent = function (e, t) {
        ...
        return (a(this.event, e, t), this.event);
      }),
...
var _ = function () {
  ...
  v = function () {
    var e = [...arguments],
      t = _();
    return ((t && t.fetch) || g).apply(void 0, e);
  },
  y = `1.82.0`,
  b = `npm`;
function x() {
    ...
    return {
      ...
      tags: i(
        ...
        ),
        {
          ...
          library_version: n === `web` ? `next-${y}` : `npm:next-${y}`,
        },
      ),
    };
  };
...
var T = (function () {
    ...
    return (
      (e.prototype.increment = function (e, t) {
        if (
          ...
          var n = C(e, t, x());
          (this.queue.push(n), e.includes(`error`) && this.flush().catch(w));
        }
      }),
      (e.prototype.flush = function () {
        ...
        return n(this, void 0, void 0, function () {
          ...
          return t(this, function (t) {
            return (
              ...
              [2, v(r, { headers: n, body: JSON.stringify(e), method: `POST` })]
            );
          });
        });
      }),
  ...
  D = (function (e) {
    ...
    return (
      ...
      (t.prototype.increment = function (t, n, r) {
        (e.prototype.increment.call(this, t, n, r), E?.increment(t, r ?? []));
      }),
      t
    );
  })(f),
  O = (function (e) {
    r(t, e);
    function t(t, n) {
      return e.call(this, t, n, new D()) || this;
    }
    return (
      (t.system = function () {
  ...
  Y = J();
function X(e, t) {
  var n = new Y.Facade(e, t);
  return (
    e.type === `track` && (n = new Y.Track(e, t)),
    e.type === `identify` && (n = new Y.Identify(e, t)),
    e.type === `page` && (n = new Y.Page(e, t)),
    e.type === `alias` && (n = new Y.Alias(e, t)),
    e.type === `group` && (n = new Y.Group(e, t)),
    e.type === `screen` && (n = new Y.Screen(e, t)),
...
function Z(e, r, a) {
  return n(this, void 0, void 0, function () {
            ...
            case 0:
              return (
                ...
                [
                  4,
                  a({
                    payload: X(r, { clone: !0, traverse: !1 }),
                    integration: e,
                    next: function (e) {
    ...
    return t(this, function (e) {
      switch (e.label) {
        case 0:
          ((s = X(r, { clone: !0, traverse: !1 }).rawEvent()),
            (c = 0),
            (l = a),
            (e.label = 1));
        case 1:
          ...
          case 0:
            return (
              ...
              [
                4,
                e({
                  payload: X(i.event, { clone: !0, traverse: !1 }),
                  integrations: r ?? {},
                  next: function (e) {
                    ((n = !0), e && (i.event = e.obj));
                  },
...
//# sourceMappingURL=middleware-DR_TC0-Y.js.map
