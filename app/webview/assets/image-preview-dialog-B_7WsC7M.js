...
import { jn as t } from "./src-DAzAmbVS.js";
import { n, t as r } from "./jsx-runtime-CiQ1k8xo.js";
import { t as i } from "./clsx-DDuZWq6Y.js";
import { t as a } from "./react-dom-De86Q4ix.js";
import { W as o } from "./setting-storage-EK1Te68s.js";
import { t as s } from "./x-DMqExXY8.js";
import { t as c } from "./download-Cf0FyA1Y.js";
import { d as ee, l as te } from "./dialog-layout-D-x8fMKh.js";
import { t as ne } from "./use-stable-callback-D_6XYV-7.js";
import { t as re } from "./arrow-left-NB8jxLlJ.js";
import { i as ie, n as ae } from "./image-preview-shortcuts-KUvoZhoW.js";
import { t as oe } from "./minus-D-AnULF0.js";
import { t as se } from "./plus-PQBYSO-0.js";
var l = e(n(), 1),
  ce = e(a(), 1),
  u = r(),
  le = 200,
  d = `no-drag pointer-events-auto flex cursor-interaction items-center justify-center rounded-full bg-token-editor-background/95 text-token-foreground shadow-md ring-1 ring-black/5 backdrop-blur-sm transition-transform hover:bg-token-menu-background hover:ring-token-focus-border focus:outline-none focus-visible:ring-1 focus-visible:ring-token-focus-border active:scale-95 disabled:cursor-not-allowed disabled:opacity-50`,
  f = i(d, `h-10 min-w-10 px-3`);
function p({
  src: e,
  alt: t,
  caption: n,
  ...
  previewContent: p,
  triggerContent: h,
  toolbarLeadingAction: _,
  contentMaxWidthClassName: ye,
  closeAriaLabel: be,
  downloadSrc: v = e,
  imageDecoding: xe,
  imageDraggable: Se,
  imageFetchPriority: Ce,
  imageLoading: we,
  imageReferrerPolicy: Te,
  onCloseAutoFocus: Ee,
  onImageError: De,
  onNextImage: y,
  onPreviousImage: b,
  portalContainer: Oe,
  showZoomControls: ke = !0,
}) {
  let x = o(),
    [S, Ae] = (0, l.useState)(null),
    [je, C] = (0, l.useState)(null),
    [w, T] = (0, l.useState)(null),
    [E, Me] = (0, l.useState)(null),
    D = (0, l.useRef)(null),
    O = (0, l.useRef)(null),
    k = (0, l.useRef)(null),
    ...
    P = E?.src === e ? E : null,
    F = de({ naturalSize: P, previewViewportSize: je }),
    I = (w?.src === e ? w.zoomPercent : null) ?? F,
    L = pe(F),
    R = L[0] ?? I,
    z = L.at(-1) ?? I,
    ze =
      I == null
        ? null
        : x.formatNumber(I / 100, {
            style: `percent`,
            maximumFractionDigits: 0,
          }),
    B = _e(e, t),
    Be = I != null && R != null && I > R,
    Ve = I != null && z != null && I < z,
    V = n?.trim() || null,
    He = b != null || y != null,
    H = () => {
      (A.current.clear(), (j.current = null), (M.current = null), T(null));
    },
    U = () => {
      b != null && (H(), b());
    },
    ...
    q = (0, l.useCallback)(
      (t) => {
        let n = ue(t);
        return n == null ? !1 : (S != null && K(S), Me({ src: e, ...n }), !0);
      },
      [S, e, K],
    ),
    J = (0, l.useCallback)(
      (t) => {
        t.decode != null &&
          t.decode().then(
            () => {
              !t.isConnected || t.getAttribute(`src`) !== e || q(t);
            },
            () => void 0,
          );
      },
  ...
  if (I != null && P != null) {
    let e = I / 100;
    Y = { width: `${P.width * e}px`, height: `${P.height * e}px` };
  }
  let X = ({ clientX: t, clientY: n, zoomPercent: r }) => {
      let i = D.current;
      if (S == null || i == null) {
        T({ src: e, zoomPercent: r });
        return;
      }
      ...
      if (
        ...
        !S.isConnected || !i.isConnected)
      )
        return;
      let c = i.getBoundingClientRect();
      ((S.scrollLeft += c.left + c.width * o - t),
        (S.scrollTop += c.top + c.height * s - n));
    },
    We = (t) => {
      if (S == null) {
        T({ src: e, zoomPercent: t });
        return;
      }
    ...
    Z = (e) => {
      I != null && We(fe({ currentZoomPercent: I, direction: e, zoomRamp: L }));
    },
    Ge = () => {
      (T(null), S != null && ((S.scrollLeft = 0), (S.scrollTop = 0)));
    },
    Ke = ne((e) => {
      switch (e.type) {
        case `step-zoom`:
    ...
    Q = ne((e) => {
      if (!e.ctrlKey || I == null) return;
      (e.preventDefault(), e.stopPropagation());
      let t = m({
        maximumZoomPercent: z,
        minimumZoomPercent: R,
        zoomPercent: I * Math.exp(-me(e) / le),
      });
      if (t == null || t === I) return;
      let n = he({
        event: e,
        fallbackPoint: k.current,
        previewViewportNode: S,
      });
    ...
    qe = (0, l.useCallback)(
      (e) => {
        ...
        if (t !== e) {
          ...
          (e.addEventListener(`wheel`, Q, { passive: !1 }), K(e));
        }
      },
      [Q, K],
    ),
    Je = (e) => {
      if (
        ((k.current = { clientX: e.clientX, clientY: e.clientY }),
        e.pointerType !== `touch`)
      )
        return;
      if (
        ...
        A.current.set(e.pointerId, { clientX: e.clientX, clientY: e.clientY }),
        A.current.size === 1 && S != null)
      ) {
        j.current = {
      ...
      M.current =
        t == null || I == null
          ? null
          : { distance: t.distance, zoomPercent: I };
    },
    Ye = (e) => {
      if (
        ((k.current = { clientX: e.clientX, clientY: e.clientY }),
        e.pointerType === `touch` && A.current.has(e.pointerId))
      ) {
        if (
          (A.current.set(e.pointerId, {
            clientX: e.clientX,
            clientY: e.clientY,
          }),
          A.current.size > 1)
        ) {
          (e.preventDefault(), e.stopPropagation(), (j.current = null));
          let t = M.current,
            n = g(A.current);
        ...
        S == null ||
          j.current == null ||
          (j.current.pointerId === e.pointerId &&
            (e.preventDefault(),
            e.stopPropagation(),
            (S.scrollLeft =
              j.current.scrollLeft - (e.clientX - j.current.clientX)),
            (S.scrollTop =
              j.current.scrollTop - (e.clientY - j.current.clientY))));
      }
    },
    $ = (e) => {
      if (e.pointerType !== `touch`) return;
      if (
        (A.current.delete(e.pointerId),
      ...
      let t = A.current.entries().next().value;
      if (A.current.size === 1 && t != null) {
        let [e, n] = t;
        ((j.current =
          S == null
            ? null
      ...
      ((j.current = null),
        (M.current =
          n == null || I == null
            ? null
            : { distance: n.distance, zoomPercent: I }));
    };
  return (
    (0, l.useEffect)(() => {
      if (!r) return;
    ...
    (0, l.useEffect)(() => {
      if (S == null || (K(S), typeof ResizeObserver > `u`)) return;
    ...
    (0, u.jsx)(te, {
      ...
      children: (0, u.jsxs)(`div`, {
        className: i(
          ...
          He ? `px-16 sm:px-20` : `px-4 sm:px-8`,
        ),
        onPointerDown: (e) => {
          e.target === e.currentTarget && G(!1);
        },
          ...
          (0, u.jsxs)(`div`, {
            ...
            children: [
              _ == null
                ...
                : (0, u.jsx)(`button`, {
                    ...
                    className: i(
                      d,
                      `relative`,
                      _.active ? `h-9 min-w-0 p-1` : `h-9 min-w-10 px-3`,
                    ),
              ...
              (0, u.jsx)(`a`, {
                ...
                children: (0, u.jsx)(c, { className: `icon-xs` }),
              }),
              (0, u.jsx)(`button`, {
                type: `button`,
                className: f,
                ...
                children: (0, u.jsx)(s, { className: `icon-sm` }),
              }),
            ],
          }),
          b == null
            ...
            : (0, u.jsx)(`button`, {
                ...
                children: (0, u.jsx)(re, { className: `icon-sm` }),
              }),
          y == null
            ? null
            : (0, u.jsx)(`button`, {
                ...
                children: (0, u.jsx)(re, { className: `icon-sm rotate-180` }),
              }),
          (0, u.jsxs)(`div`, {
            ref: qe,
            "data-testid": `image-preview-dismiss-area`,
            className: i(
              `flex min-h-0 w-full flex-1 touch-none items-start justify-start overflow-auto`,
              ye,
            ),
            onPointerCancelCapture: $,
            onPointerDownCapture: Je,
            onPointerMoveCapture: Ye,
            onPointerUpCapture: $,
            onPointerDown: (e) => {
              e.target === e.currentTarget && G(!1);
            },
                ...
                ? (0, u.jsxs)(`div`, {
                    ...
                    children: [
                      ...
                      (0, u.jsx)(`button`, {
                        ...
                        children: (0, u.jsx)(se, { className: `icon-xs` }),
                      }),
                    ],
                  })
                : null,
...
function de({ naturalSize: e, previewViewportSize: t }) {
...
function pe(e) {
  let n = [...t];
  return (
    e != null && !n.includes(e) && (n.push(e), n.sort((e, t) => e - t)),
    n
  );
}
function m({ maximumZoomPercent: e, minimumZoomPercent: t, zoomPercent: n }) {
...
function he({ event: e, fallbackPoint: t, previewViewportNode: n }) {
  ...
  return (r.clientX !== 0 || r.clientY !== 0) && h(r, i)
    ? r
    : t != null && h(t, i)
      ? t
...
export { p as t };
//# sourceMappingURL=image-preview-dialog-B_7WsC7M.js.map
