...
import { _i as t, di as n, ei as r, gi as i, v as a } from "./src-DAzAmbVS.js";
import { n as o } from "./jsx-runtime-CiQ1k8xo.js";
import { g as s, n as c, xt as l } from "./setting-storage-EK1Te68s.js";
import { n as u } from "./base64-3q0bprhg.js";
var d = 0.0025,
  ee = 48e3;
function f(e) {
    ...
    input: [
      {
        type: `message`,
        role: `user`,
        content: [{ type: `input_text`, text: r }],
      },
    ],
    tools: [],
    tool_choice: `none`,
  ...
  return new Promise((t, n) => {
    ...
    a = s.getInstance().stream(`POST`, `/codex/responses`, {
      ...
      onEvent: (e) => {
        ...
        (t.delta != null && r.push(t.delta),
          t.completedText != null && (i = t.completedText));
      },
      onError: (e) => {
        l(Error(e.error));
      },
        ...
        ((f.current = r),
          ...
          (r.onaudioprocess = (e) => {
            ...
            if (o === `compact`) {
              ...
              if (r > 0 && i > 0)
                for (; o + i <= n.length; ) {
                  ...
                  let s = t / i;
                  (g.current.push(s),
                    g.current.length > r && g.current.shift(),
                    (o = e),
                    (a = !0));
                }
            ...
            if (p.current != null) {
              let e = Math.max(
                0,
                Math.floor((performance.now() - p.current) / 1e3),
              );
...
//# sourceMappingURL=use-recording-waveform-DgC3eTOX.js.map
