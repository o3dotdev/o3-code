...
import { r as e } from "./chunk-S3R3BYOJ-5zDRn6nL.js";
...
import { t } from "./defaultLocale-kl3RWqt7.js";
import { i as n, r, t as i } from "./src-DXdm7MTq.js";
import { t as a } from "./ordinal-Cfda_VbN.js";
import { a as o, t as s } from "./treemap-zgLv8VaX.js";
import {
  B as c,
  C as l,
  U as u,
...
import { t as v } from "./chunk-EXTU4WIE-CgAipfme.js";
import "./dist-Dkaf81wL.js";
import { t as y } from "./chunk-4BX2VUAB-DP9TzDB2.js";
import { t as b } from "./mermaid-parser.core-DlxdytOs.js";
import { t as x } from "./chunk-QN33PNHL-BRcT7LP7.js";
import { i as S, n as C } from "./chunk-ATLVNIR6-DztwCsKK.js";
var w = class {
  constructor() {
    ((this.nodes = []),
      (this.levels = new Map()),
  ...
  addClass(e, t) {
    ...
    (r &&
      r.forEach((e) => {
        (C(e) && (n?.textStyles ? n.textStyles.push(e) : (n.textStyles = [e])),
...
var E = r((e, t) => {
  ...
  D = r((e) => (e.name ? String(e.name) : ``), `getItemName`),
  O = {
    parser: { yy: void 0 },
    parse: r(async (e) => {
      try {
  ...
  M = {
    draw: r((e, c, l, u) => {
      ...
      let b = h ? 30 : 0,
        C = v(c),
        w = f.nodeWidth ? f.nodeWidth * A : 960,
        T = f.nodeHeight ? f.nodeHeight * A : 500,
        E = w,
        D = T + b;
      (C.attr(`viewBox`, `0 0 ${E} ${D}`), p(C, D, E, f.useMaxWidth));
      let O;
      try {
        let e = f.valueFormat || `,`;
        if (e === `$0,0`) O = r((e) => `$` + t(`,`)(e), `valueFormat`);
        else if (e.startsWith(`$`) && e.includes(`,`)) {
          let n = /\.\d+/.exec(e),
            i = n ? n[0] : ``;
          O = r((e) => `$` + t(`,` + i)(e), `valueFormat`);
        } else if (e.startsWith(`$`)) {
          let n = e.substring(1);
          O = r((e) => `$` + t(n || ``)(e), `valueFormat`);
        } else O = t(e);
      } catch (e) {
        (n.error(`Error creating format function:`, e), (O = t(`,`)));
      }
      let M = a().range([
          `transparent`,
          y.cScale0,
      ...
      let F = C.append(`g`)
        ...
        L = s()
          .size([w, T])
          .paddingTop((e) => (e.children && e.children.length > 0 ? j + A : 0))
          .paddingInner(m)
          .paddingLeft((e) => (e.children && e.children.length > 0 ? A : 0))
          .paddingRight((e) => (e.children && e.children.length > 0 ? A : 0))
          .paddingBottom((e) => (e.children && e.children.length > 0 ? A : 0))
          .round(!0)(I),
        ...
        z
          ...
          .each(function (e) {
            ...
            let r = e.x1 - e.x0,
              a;
            a =
              f.showValues !== !1 && e.value ? r - 10 - 30 - 10 - 6 : r - 6 - 6;
            let o = Math.max(15, a),
              s = t.node();
      ...
      (V.append(`rect`)
        ...
        .attr(`fill`, (e) =>
          e.parent ? M(e.parent.data.name) : M(e.data.name),
        )
        .attr(
          `style`,
          (e) => S({ cssCompiledStyles: e.data.cssCompiledStyles }).nodeStyles,
        )
        ...
        f.showValues !== !1 &&
          V.append(`text`)
            ...
            .each(function (e) {
              ...
              let r = i(n).select(`.treemapLabel`);
              if (r.empty() || r.style(`display`) === `none`) {
                t.style(`display`, `none`);
                return;
              }
              let a = parseFloat(r.style(`font-size`)),
        ...
        x(C, f.diagramPadding ?? 8, `flowchart`, f?.useMaxWidth || !1));
    }, `draw`),
...
export { P as diagram };
//# sourceMappingURL=diagram-PSM6KHXK-ClSN57ar.js.map
