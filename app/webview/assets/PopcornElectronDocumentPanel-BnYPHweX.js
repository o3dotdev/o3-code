...
import { D as r, nn as i } from "./presentation-CPM6LXA8.js";
...
import { g as y } from "./document-CWH1TN5T.js";
...
import { r as ie, t as N } from "./feature-catalog-Crm2yJ8b.js";
...
function oe() {
  ...
  return {
    ...
    sections: [
      {
        id: `doc-section-1`,
        breakType: y.SECTION_BREAK_TYPE_UNSPECIFIED,
...
var se = class {
    ...
    #r;
    constructor(e) {
      ((this.#e = new f({ people: e.people ?? [], threads: e.threads ?? [] })),
        (this.#t = e.documentId ?? ``),
  ...
  ce = class {
    ...
    constructor(e) {
      ((this.#t = e.documentId ?? ``),
        (this.#n = e.textElementId ?? ``),
        (this.#r = e.resolveTextRange),
        (this.#e = (e.footnotes ?? []).map((e) => new F(e))));
    }
    add(e, t) {
      let n = this.#i(e),
        r = this.#a(t.range),
      ...
      return (this.#e.push(i), i);
    }
    toProto() {
      return this.#e.map((e) => e.toProto());
    }
    #i(e) {
      return d(e) ? p(e) : p([String(e)]);
    }
    #a(e) {
      let t = this.#r(e);
      if (t)
  ...
  ue = {
    insertion: i.REVIEW_MARK_TYPE_INSERTION,
    deletion: i.REVIEW_MARK_TYPE_DELETION,
  },
  de = class {
    #e;
    constructor(e) {
  ...
  I = class extends u {
    type = `text`;
    constructor(e, t) {
      (super(e, { ...(t ?? {}), type: r.ELEMENT_TYPE_TEXT }),
        (this.data.type = r.ELEMENT_TYPE_TEXT));
    }
    get id() {
      return this.data.id;
    }
  ...
  pe = class {
    ...
    add(e = {}) {
      let { text: t, style: n } = e,
        r;
      if ((this.#t() && this.#e.clear(), t !== void 0 && d(t))) {
        let e = p(t);
...
var ve = class {
    ...
    add(e) {
      if (Array.isArray(e)) return this.#e.add(e);
      let { position: t, style: n, ...r } = e,
        i = ge({
          left: t?.left,
          top: t?.top,
          width: t?.width,
        ...
        o = {
          ...r,
          left: a ? i.left : void 0,
          top: a ? i.top : void 0,
          width: a ? i.width : void 0,
          height: a ? i.height : void 0,
        },
        s = this.#e.add(o);
      if (n) {
        n.preset && (s.style = n.preset);
        let { preset: e, ...t } = n;
        s.styleOptions = { ...s.styleOptions, ...t };
      }
      return (
        _e(n?.preset) === `tablegrid` &&
          s.rowCount > 0 &&
          s.columnCount > 0 &&
          s.cells
            .block({
...
function xe(e, t) {
  let n = { alt: e.alt, position: t, contentType: e.contentType };
  return `blob` in e
    ? { ...n, blob: Se(e.blob), contentType: e.contentType }
    : `dataUrl` in e
      ? { ...n, dataUrl: e.dataUrl }
      : `uri` in e
        ? { ...n, uri: e.uri }
...
var Ce = class {
  ...
  add(e) {
    ...
    return (e.text !== void 0 && (n.text = e.text), n);
  }
};
function we(e) {
  let t = e.size,
...
function Te(e, t) {
  ...
  return n === void 0 ? t : o({ alignment: n }, t);
}
var Ee = class {
    #e;
    constructor(e = []) {
  ...
  L = class {
    ...
    constructor(e) {
      ((this.#l = e.images),
        (this.#u = new Ee(e.textStyles ?? [])),
        (this.#e = this.#d()));
      let { bodyElement: t, remainingElements: n } = this.#_(e.elements ?? []);
      ((this.#i = new I(this.#e, t)), this.#m(this.#i));
      let r = new h(this.#e, []),
        i = new m(this.#e, []),
        a = new g(this.#e, []);
      ((this.#c = new Ce(r)),
        (this.#s = new ye(i)),
        (this.#o = new ve(a)),
        (this.#a = new pe(this.#i.paragraphs)));
      for (let e of n) this.#v(e, r, i, a);
    }
    get text() {
      return this.#i.text;
    }
    get textElements() {
      return this.#n.map((e) => this.#r.get(e)).filter((e) => e instanceof I);
    }
    getElementById(e) {
      if (e) return this.#r.get(e);
    }
    removeElementById(e) {
      return !e || e === this.#i.id || !this.#r.get(e) ? !1 : (this.#g(e), !0);
    }
    resolveTextBlock(e) {
      let t = this.getElementById(e);
      return t && (t instanceof I || `text` in t) ? t.text : null;
    }
    set text(e) {
      this.#i.text.set(e);
    }
    ...
    toProto() {
      return this.#n
        .map((e) => this.#r.get(e))
        .filter((e) => !!e)
        .map((e) => (e instanceof I, e.toProto()));
    }
    #d() {
      return {
        stub: () => {},
        ...
        getResolvedParagraphTextStyle: (e, t) => {
          let n = this.#u.resolveParagraphTextStyle(e.toProto(), t?.toProto());
          return n ? new a(n) : void 0;
        },
        getResolvedParagraphStyle: (e) =>
          this.#u.resolveParagraphStyle(e.toProto()),
        getResolvedRunTextStyle: (e, t, n) => {
          let r = this.#u.resolveRunTextStyle(
            e.toProto(),
            t.toProto(),
            n?.toProto(),
          );
          return r ? new a(r) : void 0;
        },
        getSlide: () => this.#f(),
        getImageById: (e) => this.#l.getById(e),
        createImageAsset: (e) => this.#l.add(e),
        getChartById: () => void 0,
        createChartAsset: () => {
          throw Error(`Charts are not supported in documents yet.`);
        },
        attachChartAsset: () => {
          throw Error(`Charts are not supported in documents yet.`);
        },
        _register: (e, t) => this.#h(e, t),
        _unregister: (e) => this.#g(e),
      };
    }
    #f() {
    ...
    #p(e) {
      let t = this.#u.resolveTextStyleByName(e);
      if (t) return new a(t);
    }
    #m(e) {
      (this.#r.set(e.id, e), (this.#n = [e.id]));
    }
    #h(e, t) {
      let n = e.id;
      if (!n) return;
    ...
    #_(e) {
      let t = e.findIndex(
        (e) =>
          e.type === r.ELEMENT_TYPE_TEXT ||
          e.type === r.ELEMENT_TYPE_TEXT_GROUP,
      );
      return t >= 0
    ...
    #v(e, t, n, i) {
      if (
        ...
        let t = new I(this.#e, e);
        this.#h(t);
        return;
      }
      if (e.type === r.ELEMENT_TYPE_TABLE || e.table) {
        i.add({ proto: e });
        return;
      }
      if (
        e.type === r.ELEMENT_TYPE_IMAGE ||
        e.type === r.ELEMENT_TYPE_IMAGE_REFERENCE ||
        e.imageReference
      ) {
        n.add({ proto: e });
        return;
      }
      (e.type === r.ELEMENT_TYPE_SHAPE || e.shape !== void 0) &&
        t.add({ proto: e });
    }
  };
function R(e) {
...
function B(e) {
  for (let t of e)
    if (
      t &&
      (!(
        t.type === r.ELEMENT_TYPE_TEXT || t.type === r.ELEMENT_TYPE_TEXT_GROUP
      ) ||
        De(t))
    )
      return !0;
...
var V = class {
    ...
    constructor(e) {
      ...
      ((this.#e = t?.id || e.defaultId),
        (this.#t = t?.breakType ?? y.SECTION_BREAK_TYPE_UNSPECIFIED),
        (this.#n = R(t?.pageSetup)),
        (this.#r = z(t?.columns)),
        (this.#i = new L({
    ...
    get pageSetup() {
      return this.#n ? R(this.#n) : void 0;
    }
    set pageSetup(e) {
      this.#n = R(e);
    }
    get columns() {
      return this.#r ? z(this.#r) : void 0;
    }
    set columns(e) {
      this.#r = z(e);
    }
    get header() {
      return ((this.#s = !0), this.#a);
    }
    get footer() {
      return ((this.#c = !0), this.#o);
    }
    clearHeader() {
      this.#s = !1;
    }
    ...
    toProto() {
      let e = {
        ...
        t = this.#a.toProto();
      this.#s && B(t) && (e.header = this.#l(t));
      let n = this.#o.toProto();
      return (this.#c && B(n) && (e.footer = this.#l(n)), e);
    }
    #l(e) {
      return { elements: e };
    }
  ...
  Oe = class {
    ...
    #r;
    constructor(e) {
      ((this.#n = e.images), (this.#r = e.textStyles));
      let t = e.sections ?? [];
      (t.length > 0
        ? (this.#e = t.map(
            (e, t) =>
    ...
    add(e = {}) {
      let t = {
          id: e.id || this.#i(),
          breakType: e.breakType ?? y.SECTION_BREAK_TYPE_UNSPECIFIED,
  ...
  H = class e {
    ...
    constructor(e) {
      ((this.#e = {
        ...
        (this.#t = e.charts ?? []),
        (this.#n = e.textStyles ?? []),
        (this.#r = e.commentReferences ?? []),
        (this.#i = e.comments ?? []),
        (this.#a = new _({ stub: () => {} }, e.images ?? [])),
        (this.#o = new Oe({
          sections: e.sections ?? [],
      ...
      let t = this.#o.first.body,
        n = this.#o.first.pageSetup;
      (n?.widthEmu && (this.#e.widthEmu = n.widthEmu),
        n?.heightEmu && (this.#e.heightEmu = n.heightEmu),
        (this.#c = new se({
          people: [],
          threads: [],
          documentId: this.#e.id,
          textElementId: t.textElementId,
    ...
    toProto() {
      let e = this.#c.toProto(),
        ...
        a = {
          ...
          charts: this.#t,
          elements: n,
          images: this.#a.toProto(),
          footnotes: this.#l.toProto(),
          comments: this.#i,
          commentReferences: this.#r,
          textStyles: this.#n,
          reviewMarks: this.#u.toProto(),
          sections: t,
          numberingDefinitions: r.numberingDefinitions,
          paragraphNumberings: r.paragraphNumberings,
        };
      return ((a.people = e.people), (a.threads = e.threads), a);
    }
    save() {}
  },
  U = e(t()),
...
var K = {
  ...
  q = { count: 1, space: 360, widths: [], hasSeparatorLine: !1 },
  je = { count: 2, space: 360, widths: [], hasSeparatorLine: !1 };
function Me() {
  return N().map((e) => ({
    text: `${J(e.artifact)} / ${e.area}: ${e.feature}. ${e.summary}`,
    style: {
      bulletCharacter: `•`,
      marginLeft: 720,
      indent: 360,
...
function Ne() {
  ...
  ((t.pageSetup = K),
    ...
    (e.body.text.get(`Feature highlights across the engine:`).style =
      `heading1`));
  for (let t of Me()) e.body.paragraphs.add(t);
  ...
  let n = e.sections.add({ pageSetup: K, columns: je });
  ...
  for (let e of N())
    (n.body.paragraphs.add({
      text: `${J(e.artifact)} / ${e.area}`,
      style: { spaceBefore: 120, spaceAfter: 60 },
    }),
      (n.body.text.get(`${J(e.artifact)} / ${e.area}`).style = `heading2`),
      n.body.paragraphs.add({
  ...
  let r = e.sections.add({ pageSetup: K, columns: q });
  return (
...
function Pe() {
  return new Worker(
    new URL(
      `` + new URL(`runtime.worker-ChFQ4OyP.js`, import.meta.url).href,
      `` + import.meta.url,
    ),
    ...
    #f(e) {
      switch (e.kind) {
        ...
        case `rendered-pages`:
          ...
          return;
        case `debug-log`:
          D(e.namespace).debug(e.message, e.details);
          return;
        default:
          return e;
      }
...
function Ue(e) {
  let [t, n] = (0, U.useState)({ width: 0, height: 0 });
  return (
    (0, U.useEffect)(() => {
      let t = e.current;
      if (!t) return;
...
function et({
  ...
  let h = (0, U.useRef)(null),
    ...
    v = (0, U.useMemo)(() => Ye(i, o), [i, o]),
    y = (0, U.useMemo)(() => $e(r, a), [r, a]);
  return (
    (0, U.useEffect)(() => {
      let r = h.current;
      if (
...
function it({
  ...
  let a = (0, U.useRef)(null),
    ...
    l = (0, U.useRef)(new Map()),
    u = (0, U.useRef)(null),
    d = (0, U.useRef)(t.pageIndex),
    [f, p] = (0, U.useState)(0),
    [m, h] = (0, U.useState)(0),
    g = Ue(a),
    _ = (0, U.useSyncExternalStore)(
      (t) => e.subscribeRenderedPages(t),
      () => e.getRenderedPages(),
      () => e.getRenderedPages(),
    ),
    v = (0, U.useMemo)(() => new Map(_.map((e) => [e.pageIndex, e])), [_]),
    y = (0, U.useMemo)(() => {
      let t = new Map();
    ...
    }, [g.width, t.pageLayouts, t.zoom]),
    x = (0, U.useMemo)(() => {
      let e = b.reduce((e, t) => Math.max(e, t.width), 0);
      return Math.max(g.width, e + nt * 2);
    }, [g.width, b]),
    S = (0, U.useMemo)(
      () =>
        b.map((e) => ({
    ...
    C = (0, U.useMemo)(
      () => We(S, { scrollTop: m, viewportHeight: g.height, overscanPx: rt }),
      [g.height, m, S],
    ),
    w = (0, U.useMemo)(() => {
      let e = new Map(b.map((e) => [e.pageIndex, e]));
      return C.map((t) => e.get(t.index)).filter((e) => !!e);
    }, [b, C]),
    ee = (0, U.useMemo)(() => Ge(S) + Y + Math.max(0, i), [i, S]),
    T = (0, U.useMemo)(() => {
      let e = new Map(),
        t = [];
      for (let n of w) {
        let r = v.get(n.pageIndex);
        for (let i of r?.textLayoutBlocks ?? [])
          (e.set(i.id, n.pageIndex), t.push(ot(i, n)));
      }
      return ((c.current = e), t);
    }, [v, w]),
    E = (0, U.useMemo)(
      () =>
        new ne(
          {
            onPointerDown: (t, n) => {
              let r = $(t, n?.blockId ?? null, s.current, c.current, l.current);
              r &&
                ((s.current = r.pageIndex),
                e.textPointerDown(r.pageIndex, r.pagePoint, {
                  shiftKey: n?.shiftKey,
                }));
            },
            onPointerMove: (t) => {
              let n = $(t, null, s.current, c.current, l.current);
  ...
  ((0, U.useEffect)(() => {
    l.current = new Map(b.map((e) => [e.pageIndex, e]));
  }, [b]),
    (0, U.useEffect)(() => {
      ...
      n !== void 0 && (s.current = n);
    }, [t.textEditState]),
    (0, U.useEffect)(
      () => (
        E.attachContainer(a.current),
        () => {
          E.dispose();
        }
      ),
    ...
    (0, U.useEffect)(() => {
      E.updateState({ state: t.textEditState, blocks: T });
    }, [t.textEditState, E, T]),
    (0, U.useEffect)(
      () =>
        qe({
          controller: e,
          getTextLayoutBlocks: () => T,
          getTextEditState: () => t.textEditState,
          getPageRects: () => b,
          getRenderedPages: () => _,
        }),
      [e, b, _, t.textEditState, T],
    ),
    (0, U.useEffect)(() => {
      d.current !== t.pageIndex &&
        ((d.current = t.pageIndex),
        X(b, m, g.height) !== t.pageIndex && (u.current = t.pageIndex));
    }, [g.height, b, m, t.pageIndex]),
    (0, U.useEffect)(() => {
      let n = X(b, m, g.height);
      u.current !== t.pageIndex &&
        (n == null ||
          n === t.pageIndex ||
          e.setPageIndex(n, { origin: `scroll` }));
    }, [g.height, e, b, m, t.pageIndex]),
    (0, U.useEffect)(() => {
      if (!a.current) return;
      if (X(b, m, g.height) === t.pageIndex) {
        u.current = null;
        return;
      }
      let e = b[t.pageIndex];
      if (!e) return;
      let n = Math.max(0, e.top - Y);
      if (
        ((u.current = t.pageIndex), typeof a.current.scrollTo == `function`)
      ) {
        a.current.scrollTo({ top: n, behavior: `auto` });
        return;
      }
      ((a.current.scrollTop = n), h(n));
    }, [g.height, b, m, t.pageIndex]));
  let D = (0, U.useCallback)(() => {
      let e = a.current;
      e && (h(e.scrollTop), (u.current = null));
    }, []),
    O = (0, U.useCallback)(
      (t, n) => (r) => {
        a.current?.focus();
        ...
        if (E.tryPointerDown(i, { shiftKey: r.shiftKey })) {
          ((o.current = !0), (s.current = t.pageIndex));
          try {
    ...
    te = (0, U.useCallback)(
      (e, t) => (n) => {
        let r = at(n, e),
          i = Q(r, e);
        if (!o.current) {
          let r = y.get(e.pageIndex) ?? [];
          if (i && Je(r, i)) {
            n.currentTarget.style.cursor = `move`;
            return;
          }
          let a = i ? Qe(t?.textLayoutBlocks ?? [], i) : null;
    ...
    A = (0, U.useCallback)(
      (e) => (t) => {
        ...
        let n = Z(t, e);
        E.selectParagraphAtPoint(n) &&
          ((s.current = e.pageIndex), t.preventDefault());
      },
      [E],
    ),
    j = (0, U.useCallback)(
      (e) => (t) => {
        let n = Z(t, e);
        (E.selectWordAtPoint(n) || E.tryPointerDown(n)) &&
          ((s.current = e.pageIndex), t.preventDefault());
      },
      [E],
    ),
  ...
  return (0, W.jsx)(`div`, {
    ref: a,
    className: `bg-token-bg-tertiary relative h-full min-h-0 overflow-auto`,
    tabIndex: 0,
    ...
    children: (0, W.jsx)(`div`, {
      ...
      style: { height: Math.max(ee, g.height), width: Math.max(x, g.width) },
      children: w.map((r) => {
        let i = v.get(r.pageIndex);
        return (0, W.jsx)(
          et,
          {
            controller: e,
            ...
            pageObjectTargets: y.get(r.pageIndex) ?? [],
            selectedTextBlockId: t.selectedTextBlockId,
...
function st({
  ...
  renderHeaderZoomControl: n,
  title: r,
  className: i,
  enableWorker: a = !0,
  enablePageNavigation: o,
  theme: s = `web`,
  isEditing: c = !0,
  artifactSearchEnabled: l = !0,
  bottomScrollReservePx: u,
}) {
  let d = O(
    e,
    (0, U.useCallback)(() => He(), []),
  ...
  if (!d) return null;
  let f = (0, U.useSyncExternalStore)(
      (e) => d.subscribe(e),
      () => d.getSnapshot(),
      () => d.getSnapshot(),
    ),
    ...
    m = f.textEditState?.selection
      ? `${f.textEditState.selection.selectedCharacterCount} chars selected`
      : f.textEditState?.activeBlockId
        ? `Editing text`
        : f.selectedObjectId
          ? `${f.selectedObjectKind ?? `object`} selected`
          : f.selectedTextBlockId
            ? `Text block selected`
            : ``,
    h =
      n?.({
        ...
        zoomPercent: Math.round(f.zoom * 100),
      }) ??
      (0, W.jsx)(ee, {
        zoom: f.zoom,
        options: T.filter((e) => e <= 3),
        onZoomChange: p,
        testId: `popcorn-document-zoom-select`,
      });
  return (
    (0, U.useEffect)(() => {
      l || !f.findOpen || d.closeFind();
    }, [l, d, f.findOpen]),
    (0, W.jsx)(ke, {
      ...
      header: (0, W.jsx)(re, {
        ...
        compactTitle: s === `codex`,
        centeredContent:
          (o ?? s === `codex`)
            ? (0, W.jsx)(v, {
                currentIndex: f.pageIndex,
                totalCount: f.pageCount,
                itemLabel: `page`,
                onChangeIndex: (e) => d.setPageIndex(e),
                testId: `popcorn-document-page-navigation`,
              })
            : null,
        actions: (0, W.jsxs)(W.Fragment, {
          children: [
            h,
            (0, W.jsx)(`button`, {
              type: `button`,
            ...
            (0, W.jsx)(`button`, {
              ...
              onClick: () => (c ? d.appendParagraph(`New paragraph`) : void 0),
              disabled: !c,
        ...
        icon: (0, W.jsx)(x, {
          kind: `document`,
          children: (0, W.jsx)(E, { className: `size-4` }),
        }),
      }),
        ...
        children: [
          l
            ? (0, W.jsx)(ie, {
                open: f.findOpen,
                query: f.findQuery,
                summary: f.findSummary,
                focusToken: f.findFocusToken,
                onQueryChange: (e) => d.setFindQuery(e),
                onNavigatePrevious: () => d.goToPreviousFindResult(),
                onNavigateNext: () => d.goToNextFindResult(),
                onClose: () => d.closeFind(),
              })
            : null,
          (0, W.jsx)(it, {
...
function lt({
  ...
  initialDocumentProto: i,
  initialPageIndex: a,
  initialZoom: o,
  title: s = `codex-popcorn-demo.docx`,
  theme: c = `codex`,
  isEditing: l = !1,
  bottomScrollReservePx: u,
  annotationsEnabled: d = !1,
  drawingAnnotationsEnabled: f = !1,
  artifactSearchEnabled: p = !1,
  commentThreadsEnabled: m = !1,
}) {
  let h = (0, U.useRef)(t),
    g = O(
      void 0,
      () => new Ve({ document: ct(i), initialPageIndex: a, initialZoom: o }),
    );
  return (
    (0, U.useEffect)(() => {
      g && t !== h.current && ((h.current = t), g.replaceDocument(ct(i)));
    }, [g, t, i]),
    g
      ? (0, W.jsx)(`section`, {
          ...
          children: (0, W.jsx)(st, {
            ...
            isEditing: l,
            bottomScrollReservePx: u,
            annotationsEnabled: d,
            drawingAnnotationsEnabled: f,
            artifactSearchEnabled: p,
            commentThreadsEnabled: m,
          }),
        })
      : null
  );
}
export { lt as PopcornElectronDocumentPanel };
//# sourceMappingURL=PopcornElectronDocumentPanel-BnYPHweX.js.map
