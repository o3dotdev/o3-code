...
function O(e, t, n, r) {
  let i = m(e),
    a = D(p(e), n === `start`, r);
  return (
    i && ((a = a.map((e) => e + `-` + i)), t && (a = a.concat(a.map(S)))),
    a
  );
}
function k(e) {
        ...
        async fn(t) {
          ...
          if (
            ...
            if (
              ...
              (!(u === `alignment` && S !== v(t)) ||
                M.every((e) =>
                  v(e.placement) === S ? e.overflows[0] > 0 : !0,
                ))
            )
              return {
        ...
        async fn(t) {
          ...
          switch (r) {
            case `referenceHidden`: {
              let e = I(
                await P(t, { ...i, elementContext: `reference` }),
                n.reference,
              );
              return {
    ...
    return (
      e === void 0 && (e = {}),
      {
        ...
        async fn(t) {
          ...
          return {
            ...b,
            data: { x: b.x - n, y: b.y - r, enabled: { [g]: a, [m]: o } },
          };
        },
      }
    );
  ...
  for (; H(o) && !K(o); ) {
    ...
    (!n && t.position === `fixed` && (i = null),
      (
        a
          ? !n && !i
          : (!n && t.position === `static` && i && Ie.has(i.position)) ||
            (W(o) && !n && ze(e, o))
      )
        ? (r = r.filter((e) => e !== o))
        : (i = t),
...
//# sourceMappingURL=floating-ui.react-dom-n8i6eMZZ.js.map
