...
import { Cn as t, _ as n } from "./src-DAzAmbVS.js";
import {
  B as r,
  Cn as i,
  Ni as a,
...
import { n as h, t as g } from "./jsx-runtime-CiQ1k8xo.js";
import { t as _ } from "./clsx-DDuZWq6Y.js";
import {
  B as v,
  H as y,
  J as b,
...
import { t as I } from "./branch-DGCKHu9Z.js";
import { t as ee } from "./github-mark-BJLszk3j.js";
import { r as L, t as R } from "./product-logger-CdHJrfqL.js";
import { r as z } from "./toast-signal-Dfdpi-kK.js";
import { t as te } from "./tooltip-DzyyaBl-.js";
import { t as B } from "./button-bq66r8jD.js";
import { t as V } from "./spinner-D37df5tU.js";
import { t as H } from "./proxy-HwxlKevX.js";
import { t as U } from "./x-DMqExXY8.js";
import { t as ne } from "./with-window-C7Mmo_xd.js";
import { n as re } from "./check-git-index-for-changes-Cr4dfcAI.js";
import { l as ie, n as ae } from "./dialog-layout-D-x8fMKh.js";
import { t as oe } from "./check-md-I6RRy8DL.js";
import { r as W } from "./dropdown-PBHuhi3M.js";
import { t as G } from "./copy-to-clipboard-DUkEoARe.js";
import { t as se } from "./copy-BLEBbe48.js";
import { t as ce } from "./arrow-up-jZdXvEtu.js";
import { t as K } from "./bullet-separator-DcA-iuRu.js";
import { t as le } from "./banner-DpRpGxUf.js";
import { t as ue } from "./use-git-default-branch-D4AXkMr7.js";
import { t as de } from "./toggle-Ray5d_Lx.js";
import { n as fe } from "./diff-stats-C-S_JU1b.js";
import { t as pe } from "./codex-analytics-attribution-CUwZh9tc.js";
function me(e) {
...
function he(e) {
  let n = (0, q.c)(31),
    { cwd: r, hostConfig: a, onErrorMessage: s, showErrorToast: c } = e,
    l = c === void 0 ? !1 : c,
    u = E(C),
    d = x(),
    f = w(),
    p;
  n[0] === a ? (p = n[1]) : ((p = i(a)), (n[0] = a), (n[1] = p));
  let m = p,
    h = r ?? ``,
    g;
  n[2] !== m || n[3] !== h
    ? ((g = [`git`, `init-repo`, m, h]), (n[2] = m), (n[3] = h), (n[4] = g))
    : (g = n[4]);
  let _;
  n[5] !== r || n[6] !== a
    ? ((_ = async () => {
        ...
        await o(`git`).request({
          ...
          params: { cwd: t(r), hostConfig: a, operationSource: `review_model` },
        });
      }),
      (n[5] = r),
      (n[6] = a),
    ...
    : (_ = n[7]);
  let v;
  n[8] !== r || n[9] !== m || n[10] !== f || n[11] !== d || n[12] !== u
    ? ((v = async () => {
        u.get(z).success(
          f.formatMessage({
        ...
        let e = [d.invalidateQueries({ queryKey: M(`git-origins`) })];
        (r != null &&
          e.push(d.invalidateQueries({ queryKey: [`git`, `metadata`, m, r] })),
          await Promise.all(e));
      }),
      (n[8] = r),
      (n[9] = m),
  ...
  n[14] !== f || n[15] !== s || n[16] !== u || n[17] !== l
    ...
    : (y = n[18]);
  let b;
  n[19] !== g || n[20] !== _ || n[21] !== v || n[22] !== y
    ? ((b = { mutationKey: g, mutationFn: _, onSuccess: v, onError: y }),
      (n[19] = g),
      (n[20] = _),
      (n[21] = v),
      (n[22] = y),
  ...
  let D = T,
    ...
    k;
  return (
    n[27] !== D || n[28] !== S.isPending || n[29] !== O
      ? ((k = {
          canCreateGitRepository: O,
          createGitRepository: D,
          isCreatingGitRepository: S.isPending,
        }),
        (n[27] = D),
        (n[28] = S.isPending),
        (n[29] = O),
...
function ge(e, n, r, i) {
  ...
  a[2] === o
    ? ((s = a[3]), (c = a[4]))
    : (({ staleTime: c, ...s } = o), (a[2] = o), (a[3] = s), (a[4] = c));
  let l = String(e),
    u;
  a[5] === l ? (u = a[6]) : ((u = t(l)), (a[5] = l), (a[6] = u));
  let f;
  a[7] !== r || a[8] !== u
    ? ((f = { cwd: u, operationSource: r }), (a[7] = r), (a[8] = u), (a[9] = f))
    : (f = a[9]);
  let p = c ?? D.FIVE_SECONDS,
    m;
  return (
    a[10] !== s || a[11] !== p
      ? ((m = { staleTime: p, ...s }), (a[10] = s), (a[11] = p), (a[12] = m))
      : (m = a[12]),
    d(e, n, `branch-metadata`, f, r, m)
  );
}
function J(e) {
  let t = s(e.root).replace(/\/+$/, ``),
    n = s(e.commonDir).replace(/\/+$/, ``);
...
function _e(e, t, n) {
  ...
  r[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((i = { staleTime: 3e4, refetchOnWindowFocus: !0 }), (r[0] = i))
    : (i = r[0]);
  let a = i,
    o = l(e, t, n),
    s;
  r[1] === n
    ...
    : ((s = (e) => {
      ...
      (r[1] = n),
      (r[2] = s));
  let c = d(e, t, `upstream-branch`, s, n, a),
    u;
  r[3] === n
    ? (u = r[4])
    : ((u = (e) => {
      ...
      (r[3] = n),
      (r[4] = u));
  let f = d(e, t, `branch-ahead-count`, u, n, a),
    p = ue(e, t, n, a),
    m = o.isSuccess && c.isSuccess && f.isSuccess && p.isSuccess,
    h;
  if (m && o.data && c.data) {
    let e = o.data.root,
      t = c.data.branch ?? null,
      n = p.data ?? null,
      i = f.data.commitsAhead,
      a = c.data.upstream?.branch ?? null,
      s;
    r[5] === o.data
      ? (s = r[6])
      : ((s = J(o.data)), (r[5] = o.data), (r[6] = s));
    let l;
    (r[7] !== f.data.commitsAhead ||
    r[8] !== o.data.root ||
    r[9] !== t ||
    r[10] !== n ||
    r[11] !== a ||
  ...
  let g;
  r[14] !== f || r[15] !== c
    ? ((g = async () => Promise.all([c.refetch(), f.refetch()])),
      (r[14] = f),
      (r[15] = c),
      (r[16] = g))
    : (g = r[16]);
  let _;
  return (
    r[17] !== h || r[18] !== m || r[19] !== g
      ? ((_ = { data: h, isSuccess: m, refetch: g }),
        (r[17] = h),
        (r[18] = m),
        (r[19] = g),
        (r[20] = _))
...
function ye(e, n, r, i) {
  ...
  return (
    a[10] !== s || a[11] !== p
      ? ((m = { staleTime: p, ...s }), (a[10] = s), (a[11] = p), (a[12] = m))
      : (m = a[12]),
    d(e, n, `tracked-uncommitted-changes`, f, r, m)
  );
}
var Y = `Testing note: If you mention tests, include unit tests or UI testing frameworks only. Skip lint/tsc since CI runs those.`;
function be({
  commitInstructions: e,
  draftMessage: t,
  oversizedDiffSummary: n = null,
  uncommittedDiff: r,
}) {
  let i = [],
    a = t.trim();
  a.length > 0 && i.push(`Draft message:\n${a}`);
  let o = xe({ oversizedDiffSummary: n, uncommittedDiff: r });
  (o != null && i.push(o), i.length > 0 && i.push(Y));
  let s = e?.trim() ?? ``;
  return (
    s.length > 0 &&
      i.push(
...
function xe({ oversizedDiffSummary: e, uncommittedDiff: t }) {
  if (e != null)
    return [
      `Changes:`,
      `Diff too large to include inline.`,
      `Summary: ${e.filesChanged} changed files, +${e.linesAdded}/-${e.linesRemoved} lines.`,
    ].join(`
`);
...
`),
  ...
  t[11] !== s || t[12] !== o
    ? ((y = o
        ? (0, X.jsx)(`button`, {
            ...
            children: (0, X.jsx)(U, { className: `icon-xs` }),
          })
        : null),
      (t[11] = s),
      (t[12] = o),
  ...
  t[17] !== r || t[18] !== x || t[19] !== S
    ? ((C = (0, X.jsx)(Se, { command: x, output: S, message: r })),
      (t[17] = r),
      (t[18] = x),
      (t[19] = S),
      (t[20] = C))
    ...
    ? ((T =
        g.length > 0
          ? (0, X.jsx)(`button`, {
              ...
              children: (0, X.jsx)(se, { className: `icon-2xs` }),
            })
          : null),
      (t[21] = g),
      (t[22] = s),
  ...
  let E;
  t[24] !== C || t[25] !== T
    ? ((E = (0, X.jsxs)(`div`, { className: `relative`, children: [C, T] })),
      (t[24] = C),
      (t[25] = T),
      (t[26] = E))
    : (E = t[26]);
...
function De(e) {
  let t = (0, q.c)(13),
    { cwd: n, hostConfig: r, gitMetadata: a, onSuccess: o } = e,
    s = E(C),
    c = x(),
    l;
  t[0] === r ? (l = t[1]) : ((l = i(r)), (t[0] = r), (t[1] = l));
  let u = l,
    d;
  t[2] === n ? (d = t[3]) : ((d = Oe(n)), (t[2] = n), (t[3] = d));
  let f;
  t[4] !== a || t[5] !== u || t[6] !== o || t[7] !== c || t[8] !== s
    ? ((f = async (e, t, n, r) => {
        e.status === `success` &&
          (R(s, { eventName: `codex_git_commit_succeeded` }),
          Ee(c, a, u, t.operationSource),
          o?.(e, t, n, r),
          ke(c, { metadata: a, hostKey: u }));
      }),
      (t[4] = a),
      (t[5] = u),
      (t[6] = o),
...
async function ke(e, { metadata: t, hostKey: n }) {
  if (!t) return;
  let r = f(t.commonDir, t.root, n);
  await Promise.all(
    [
      `branch-metadata`,
      `status-summary`,
    ...
    ].map((t) => e.invalidateQueries({ queryKey: [...r, t] })),
  );
}
function Ae(e, t, n) {
  return [`vscode`, `generate-pull-request-message`, e ?? null, t, n ?? null];
}
function je(e) {
  let t = (0, q.c)(7),
    { cwd: n, hostId: r, conversationId: i, onError: a } = e,
    o;
  t[0] !== i || t[1] !== n || t[2] !== r
    ? ((o = Ae(n, r, i)), (t[0] = i), (t[1] = n), (t[2] = r), (t[3] = o))
    : (o = t[3]);
  let s;
  return (
    t[4] !== a || t[5] !== o
      ? ((s = { mutationKey: o, onError: a }),
        (t[4] = a),
        (t[5] = o),
        (t[6] = s))
      : (s = t[6]),
    A(`generate-pull-request-message`, s)
  );
}
function Me({
...
function Ne({ pushStatus: e, ignoreNothingToPush: t = !1 }) {
  switch (!0) {
    case !e:
      return `push-status-loading`;
    case !e?.branch || !e.defaultBranch:
...
function Le(e, t) {
  switch (t) {
    ...
    case `changes-loading`:
      return e.formatMessage(Fe.changesLoading);
    case `changes-unavailable`:
      return e.formatMessage(Fe.changesUnavailable);
    case `no-changes`:
      return e.formatMessage(Fe.noChanges);
  }
}
function Re(e, t) {
  switch (t) {
    case null:
      return;
    case `branch-missing`:
      return e.formatMessage(Ie.branchMissing);
    case `nothing-to-push`:
      return e.formatMessage(Ie.nothingToPush);
    case `push-status-loading`:
      return e.formatMessage(Ie.pushStatusLoading);
  }
}
function ze(e, t) {
  switch (t) {
    case null:
      return;
    case `branch-missing`:
      return e.formatMessage(Q.branchMissing);
    case `checking-existing-pr`:
      return e.formatMessage(Q.checkingExistingPullRequest);
    case `default-branch-checked-out`:
      return e.formatMessage(Q.defaultBranchCheckedOut);
    case `default-branch-missing`:
      return e.formatMessage(Q.defaultBranchMissing);
    case `gh-auth-required`:
      return e.formatMessage(Q.ghAuthRequired);
    case `gh-cli-missing`:
      return e.formatMessage(Q.ghCliMissing);
    case `gh-status-loading`:
      return e.formatMessage(Q.ghStatusLoading);
    case `no-git-repository`:
      return e.formatMessage(Q.noGitRepository);
    case `pull-request-exists`:
      return e.formatMessage(Q.pullRequestExists);
    case `push-status-loading`:
      return e.formatMessage(Q.pushStatusLoading);
    case `upstream-missing`:
      return e.formatMessage(Q.upstreamMissing);
  }
}
var Be = 1e3,
  Ve = 100;
...
`),
  ...
  return (
    ...
    a.push(Ue({ uncommittedDiff: t, filePaths: n })),
    a.join(`

`)
  );
}
function Ue({ uncommittedDiff: e, filePaths: t }) {
  let n = e?.trim() ?? ``,
    r = (n.length > 0 ? We(n) : 0) > Be,
    i = [`Changes:`];
  return n.length === 0 || r
    ? (i.push(Ge(t)),
      i.join(`
...
var Ke = S(C, (e, { signal: t }) => t(null), { key: rt }),
  qe = S(C, (e, { signal: t }) => t(null), { key: rt }),
  Je = S(C, (e, { signal: t }) => t(``), { key: rt }),
  Ye = S(C, (e, { signal: t }) => t(!0), { key: rt }),
  Xe = S(C, (e, { signal: t }) => t(``), { key: rt }),
  Ze = S(C, (e, { signal: t }) => t(``), { key: rt });
function Qe(e, t, n) {
  e.get(Je, t).set(n);
}
function $e(e, t, n) {
...
function nt(e) {
  return e.includes(`create-pr`)
    ? `create-pr`
    : e.includes(`push`)
      ? `push`
      : `commit`;
}
function rt({ cwd: e, hostId: t }) {
  return JSON.stringify([t, e]);
}
function it(e) {
  let t = (0, q.c)(26),
    { cwd: r, hostConfig: a, operationSource: o, onSuccess: s } = e,
    c = E(C),
    u = T(pe),
    d = x(),
    { data: f } = l(r, a, o),
    p;
  t[0] === a ? (p = t[1]) : ((p = i(a)), (t[0] = a), (t[1] = p));
  let m = p,
    h = O(n.alwaysForcePush),
    g;
  t[2] !== r || t[3] !== a.id
    ? ((g = at(r, a.id)), (t[2] = r), (t[3] = a.id), (t[4] = g))
    : (g = t[4]);
  let _;
  t[5] !== u ||
  t[6] !== f ||
  ...
  t[11] !== c
    ? ((_ = (e, t) => {
        ...
        R(c, {
          ...
          metadata: { forced: t.force ?? !1 },
        });
        let n = c.get(L).submitCodexAnalyticsEvent;
        (u != null &&
          n?.({
            ...u,
            action: `push`,
    ...
    : (_ = t[12]);
  let v;
  t[13] !== o || t[14] !== g || t[15] !== _
    ? ((v = { source: o, mutationKey: g, onSuccess: _ }),
      (t[13] = o),
      (t[14] = g),
      (t[15] = _),
      (t[16] = v))
  ...
  let y = A(`git-push`, v),
    b,
    S;
  t[17] !== h || t[18] !== a.id || t[19] !== y
    ? ((b = (e, t) => {
        y.mutate({ ...e, force: e.force ?? h, hostId: a.id }, t);
      }),
      (S = (e, t) =>
        y.mutateAsync({ ...e, force: e.force ?? h, hostId: a.id }, t)),
      (t[17] = h),
      (t[18] = a.id),
      (t[19] = y),
      (t[20] = b),
  ...
  let w;
  return (
    t[22] !== y || t[23] !== b || t[24] !== S
      ? ((w = { ...y, mutate: b, mutateAsync: S }),
        (t[22] = y),
        (t[23] = b),
        (t[24] = S),
        (t[25] = w))
...
function at(e, t) {
  return [`vscode`, `git-push`, e, t ?? null];
}
var ot = 80;
function st({ conversationId: e, tokenUsageInfo: t }) {
  if (e == null) return null;
  let { percent: n } = me(t);
  return n == null || n < ot ? e : null;
}
var ct = e(h()),
  lt = (e) =>
    (0, X.jsxs)(`svg`, {
...
function ut(e) {
  ...
  t[0] === e
    ...
    : (({ children: n, className: r, ...i } = e),
      ...
      (t[3] = i));
  let a;
  t[4] === r ? (a = t[5]) : ((a = _(`gap-3`, r)), (t[4] = r), (t[5] = a));
  let o;
  return (
    t[6] !== n || t[7] !== i || t[8] !== a
      ? ((o = (0, X.jsx)(ae, { ...i, className: a, children: n })),
        (t[6] = n),
        (t[7] = i),
        (t[8] = a),
        (t[9] = o))
...
function dt(e) {
  ...
  t[0] === a
    ? (l = t[1])
    : ((l = _(`flex items-start justify-between`, a)), (t[0] = a), (t[1] = l));
  let u;
  t[2] === c
    ? (u = t[3])
    : ((u = _(`flex h-9 w-9 items-center justify-center rounded-xl`, c)),
      (t[2] = c),
      (t[3] = u));
  let d;
  t[4] !== n || t[5] !== u
    ? ((d = (0, X.jsx)(`span`, { className: u, children: n })),
      (t[4] = n),
      (t[5] = u),
      (t[6] = d))
    : (d = t[6]);
  ...
  return (
    t[9] !== l || t[10] !== d || t[11] !== f
      ? ((p = (0, X.jsxs)(`div`, { className: l, children: [d, f] })),
        (t[9] = l),
        (t[10] = d),
        (t[11] = f),
        (t[12] = p))
...
function ft(e) {
  ...
  t[0] === r
    ? (i = t[1])
    : ((i = _(`text-token-foreground heading-dialog font-semibold`, r)),
      (t[0] = r),
      (t[1] = i));
  let a;
  return (
...
function pt(e) {
  ...
  t[0] === r
    ? (i = t[1])
    : ((i = _(`text-token-description-foreground flex flex-col gap-3`, r)),
      (t[0] = r),
      (t[1] = i));
  let a;
  return (
...
function mt(e) {
  ...
  if (t[0] !== i || t[1] !== n || t[2] !== r) {
    let e = (t, n) => {
        if (!ct.isValidElement(t)) return t;
        if (t.type === B) {
          let e = t;
          return e.props.size == null ? ct.cloneElement(e, { size: n }) : e;
        }
        if (t.props.children == null) return t;
        let r = !1,
          i = ct.Children.map(t.props.children, (t) => {
            let i = e(t, n);
            return (i !== t && (r = !0), i);
          });
        if (!r) return t;
        ...
        return (
          ...
          ct.cloneElement(t, { children: a })
        );
      },
      u = (t) => {
        let i = e(n, t),
          a = e(r, t);
        return (0, X.jsxs)(X.Fragment, { children: [i ?? null, a] });
      };
    (t[8] === i
      ? (c = t[9])
      : ((c = _(`flex flex-1 items-center justify-between gap-2`, i)),
        (t[8] = i),
        (t[9] = c)),
      (l = (0, X.jsx)(ne, { electron: !0, children: u(`medium`) })),
      (a = ne),
      (o = !0),
      (s = u(`toolbar`)),
      (t[0] = i),
  ...
  t[10] !== a || t[11] !== o || t[12] !== s
    ? ((u = (0, X.jsx)(a, { extension: o, children: s })),
      (t[10] = a),
      (t[11] = o),
      (t[12] = s),
      (t[13] = u))
  ...
  return (
    t[14] !== c || t[15] !== l || t[16] !== u
      ? ((d = (0, X.jsxs)(`div`, { className: c, children: [l, u] })),
        (t[14] = c),
        (t[15] = l),
        (t[16] = u),
        (t[17] = d))
...
function ht(e) {
  ...
  t[0] === a
    ? (o = t[1])
    : ((o = _(`grid grid-cols-[minmax(0,1fr)_auto] items-center gap-x-6`, a)),
      (t[0] = a),
      (t[1] = o));
  let s;
  t[2] === n
  ...
  t[4] === r
    ? (c = t[5])
    : ((c = (0, X.jsx)(`span`, { className: `min-w-0`, children: r })),
      (t[4] = r),
      (t[5] = c));
  let l;
  t[6] !== s || t[7] !== c
  ...
  t[9] === i
    ? (u = t[10])
    : ((u = i ?? (0, X.jsx)(`span`, {})), (t[9] = i), (t[10] = u));
  let d;
  return (
    t[11] !== o || t[12] !== l || t[13] !== u
      ? ((d = (0, X.jsxs)(`div`, { className: o, children: [l, u] })),
        (t[11] = o),
        (t[12] = l),
        (t[13] = u),
        (t[14] = d))
...
function gt(e) {
  ...
  t[0] === o
    ? (s = t[1])
    : ((s = _(`grid grid-cols-[auto_minmax(0,1fr)] items-center gap-x-6`, o)),
      (t[0] = o),
      (t[1] = s));
  let c;
  t[2] === n
  ...
  t[7] === a
    ? (u = t[8])
    : ((u = _(`min-w-0 truncate text-right`, a)), (t[7] = a), (t[8] = u));
  let d;
  t[9] !== u || t[10] !== i
    ? ((d = (0, X.jsx)(`div`, { className: u, children: i })),
      (t[9] = u),
      (t[10] = i),
      (t[11] = d))
    : (d = t[11]);
  ...
  return (
    t[12] !== s || t[13] !== l || t[14] !== d
      ? ((f = (0, X.jsxs)(`div`, { className: s, children: [l, d] })),
        (t[12] = s),
        (t[13] = l),
        (t[14] = d),
        (t[15] = f))
...
function _t(e) {
  ...
  t[0] === o
    ? (s = t[1])
    : ((s = _(`rounded-lg p-2`, o)), (t[0] = o), (t[1] = s));
  let c;
  return (
...
function vt(e) {
  ...
  t[11] !== c || t[12] !== l || t[13] !== u
    ? ((m = u
        ? (0, X.jsx)(fe, { variant: `color`, linesAdded: c, linesRemoved: l })
        : (0, X.jsx)(`span`, {})),
      (t[11] = c),
      (t[12] = l),
      (t[13] = u),
...
function yt(e) {
  ...
  t[0] === a
    ? (o = t[1])
    : ((o = _(`flex flex-col gap-2`, a)), (t[0] = a), (t[1] = o));
  let s;
  t[2] === n
    ? (s = t[3])
    : ((s = (0, X.jsx)(`div`, {
  ...
  if (t[4] !== r || t[5] !== i) {
    ...
    (t[7] === i
      ? (e = t[8])
      : ((e = (e) => (0, X.jsx)(vt, { file: e, workspaceRoot: i }, e.path)),
        (t[7] = i),
        (t[8] = e)),
      (c = r.map(e)),
      (t[4] = r),
  ...
  return (
    t[11] !== o || t[12] !== s || t[13] !== l
      ? ((u = (0, X.jsxs)(`div`, { className: o, children: [s, l] })),
        (t[11] = o),
        (t[12] = s),
        (t[13] = l),
        (t[14] = u))
...
function St(e) {
  ...
  t[7] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((l = (0, X.jsx)(`span`, {
        className: `flex items-center gap-1.5 self-center text-base leading-6 font-medium tracking-[-0.01em] text-token-foreground`,
        children: (0, X.jsx)(y, {
          id: `localConversationPage.createPrModal.draft`,
          defaultMessage: `Draft`,
          description: `Label for the create PR draft toggle`,
...
function Ct(e) {
  ...
  let v = g,
    y = !l || u == null,
    b = h === `start` ? `items-start` : `items-center`,
    x = l
      ? `cursor-not-allowed`
      : `cursor-interaction hover:bg-token-editor-background`,
    S;
  t[3] !== f || t[4] !== b || t[5] !== x
    ? ((S = _(
    ...
    ? ((C =
        ...
        (0, X.jsx)(n, {
          className: _(
            `icon-sm`,
            h === `start` ? `mt-0.5` : null,
            l ? `text-token-description-foreground` : `text-token-foreground`,
          ),
        })),
      (t[7] = n),
      (t[8] = h),
      ...
      (t[10] = C))
    : (C = t[10]);
  let w = m === `inline` ? `items-baseline` : `items-center`,
    T = m === `right` ? `justify-between` : null,
    E;
  t[11] !== T || t[12] !== w
    ? ((E = _(`flex min-w-0 gap-2`, w, T)),
      (t[11] = T),
      (t[12] = w),
      (t[13] = E))
    : (E = t[13]);
  let D = m === `right` ? `min-w-0 flex-1` : null,
    O = l ? `text-token-description-foreground` : `text-token-foreground`,
    k;
  t[14] !== D || t[15] !== O
    ? ((k = _(`truncate`, D, O)), (t[14] = D), (t[15] = O), (t[16] = k))
    : (k = t[16]);
  let A;
  t[17] !== r || t[18] !== k
    ? ((A = (0, X.jsx)(`span`, { className: k, children: r })),
      (t[17] = r),
      (t[18] = k),
      (t[19] = A))
    : (A = t[19]);
  ...
  t[20] !== a || t[21] !== m
    ? ((j =
        a && m === `right`
          ? (0, X.jsx)(`span`, {
              className: `flex max-w-[45%] min-w-0 items-center justify-end gap-1 text-xs text-token-description-foreground`,
              children: a,
            })
          : a && m === `inline`
            ? (0, X.jsx)(`span`, {
                className: `max-w-[55%] truncate text-xs text-token-description-foreground`,
                children: a,
              })
            : null),
      (t[20] = a),
    ...
    : (j = t[22]);
  let M;
  t[23] !== E || t[24] !== A || t[25] !== j
    ? ((M = (0, X.jsxs)(`span`, { className: E, children: [A, j] })),
      (t[23] = E),
      (t[24] = A),
      (t[25] = j),
      (t[26] = M))
  ...
  t[27] !== a || t[28] !== m
    ? ((N =
        a && m === `below`
          ? (0, X.jsx)(`span`, {
              className: `min-w-0 truncate text-xs text-token-description-foreground`,
              children: a,
            })
          : null),
      (t[27] = a),
  ...
  t[34] !== M || t[35] !== N || t[36] !== P || t[37] !== F
    ? ((I = (0, X.jsxs)(`span`, {
      ...
      (t[38] = I))
    : (I = t[38]);
  let ee = h === `start` ? `mt-0.5` : null,
    L = l ? `text-token-description-foreground` : `text-token-foreground`,
    R = c ? null : `invisible`,
    z;
  t[39] !== ee || t[40] !== L || t[41] !== R
    ? ((z = _(`icon-sm shrink-0`, ee, L, R)),
      (t[39] = ee),
      (t[40] = L),
      (t[41] = R),
      (t[42] = z))
  ...
  t[43] === z
    ? (B = t[44])
    : ((B = (0, X.jsx)(oe, { className: z })), (t[43] = z), (t[44] = B));
  let V;
  t[45] !== l ||
  t[46] !== v ||
  t[47] !== c ||
  ...
  let H;
  return (
    t[53] !== V || t[54] !== y || t[55] !== u
      ? ((H = (0, X.jsx)(te, { disabled: y, tooltipContent: u, children: V })),
        (t[53] = V),
        (t[54] = y),
        (t[55] = u),
        (t[56] = H))
...
function wt(e) {
  let t = (0, q.c)(15),
    { label: n, target: r, targetMaxWidthClassName: i } = e,
    a;
  t[0] === n
    ? (a = t[1])
    : ((a = (0, X.jsx)(`span`, {
  ...
  t[7] === l
    ? (u = t[8])
    : ((u = (0, X.jsx)(`span`, { className: `truncate`, children: l })),
      (t[7] = l),
      (t[8] = u));
  let d;
  t[9] !== s || t[10] !== u
    ? ((d = (0, X.jsxs)(`span`, { className: s, children: [c, u] })),
      (t[9] = s),
      (t[10] = u),
      (t[11] = d))
    : (d = t[11]);
...
function Tt(e) {
  ...
  if (!r) {
    ...
    t[0] === n
      ? (e = t[1])
      : ((e = (0, X.jsx)(`span`, {
          className: `min-w-0 font-medium text-token-foreground`,
          children: n,
        })),
        (t[0] = n),
        (t[1] = e));
  ...
  let d = r.files.length > 0 || r.totalAdditions > 0 || r.totalDeletions > 0,
    f;
  t[7] === n
    ? (f = t[8])
    : ((f = (0, X.jsx)(`span`, {
  ...
  t[12] !== i ||
  t[13] !== r.files.length ||
  t[14] !== r.totalAdditions ||
  t[15] !== r.totalDeletions
    ? ((p =
        l && !d
          ? (0, X.jsx)(`span`, {
              ...
              children: [
                ...
                (0, X.jsx)(`span`, {
                  ...
                  children: (0, X.jsx)(y, {
                    ...
                    values: { count: r.files.length },
                  }),
                }),
                (0, X.jsx)(fe, {
                  variant: `color`,
                  linesAdded: r.totalAdditions,
                  linesRemoved: r.totalDeletions,
                }),
                i || null,
              ],
            })),
...
function Et(e) {
  let t = (0, q.c)(88),
    {
      ...
      isFetchingChanges: i,
      isLoadingChanges: a,
      isFetchingUntrackedChanges: o,
      isCommitting: s,
      hasSummaryLoadError: c,
      target: l,
      selectionSummary: u,
      commitDisabled: d,
      hasSelectedChanges: f,
      nextStep: p,
      allowedNextSteps: m,
      setNextStep: h,
      canCommitAndPush: g,
      canCommitAndCreatePullRequest: _,
      createPullRequestAsDraft: v,
      showCreatePullRequestHint: x,
      commitAndPushTooltipText: S,
      commitAndCreatePullRequestTooltipText: T,
      branchUpdateWarning: D,
      onCommit: O,
    } = e,
    A = E(C),
    j = w(),
    ...
    : ((R = i
        ? (0, X.jsx)(te, {
            ...
            children: (0, X.jsx)(`span`, {
              className: `inline-flex items-center text-token-description-foreground`,
              children: (0, X.jsx)(V, { className: `icon-xs` }),
            }),
          })
        : null),
      (t[6] = i),
  ...
  t[8] === o
    ...
    : ((H = o
      ...
      (t[9] = H));
  let U = z ?? H,
    ne = s || p !== `commit-and-create-pr` || !_,
    re = m.length > 1,
    ie = p === `commit-and-create-pr`,
    ae;
  t[10] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((ae = (0, X.jsx)(xt.Header, {
        icon: (0, X.jsx)(lt, { className: `icon-md text-token-foreground` }),
      })),
      (t[10] = ae))
    : (ae = t[10]);
  let oe;
  ...
  t[13] === l
    ? (G = t[14])
    : ((G = (0, X.jsx)(wt, { label: W, target: l })), (t[13] = l), (t[14] = G));
  let se;
  ...
  let K;
  t[16] !== u || t[17] !== U
    ? ((K = (0, X.jsx)(Tt, { label: se, summary: u, statusIndicator: U })),
      (t[16] = u),
      (t[17] = U),
      (t[18] = K))
    : (K = t[18]);
  ...
  t[19] === r
    ? (ue = t[20])
    : ((ue = (0, X.jsx)(Ot, { gitActionKey: r })), (t[19] = r), (t[20] = ue));
  let de;
  t[21] !== ue || t[22] !== G || t[23] !== K
    ? ((de = (0, X.jsxs)(`div`, {
              ...
              (0, X.jsxs)(`div`, {
                ...
                children: [
                  ...
                  m.includes(`commit-and-push`)
                    ...
                    : null,
                  m.includes(`commit-and-create-pr`)
                    ? (0, X.jsx)(Ct, {
                        icon: ee,
                        label: (0, X.jsx)(y, {
                        ...
                        description: x
                          ...
                          : null,
                        selected: p === `commit-and-create-pr`,
                        disabled: !_,
                        tooltipText: T,
                        onSelect: () => {
                          h(`commit-and-create-pr`);
                        },
                      })
                    : null,
                ],
    ...
    : ((Se = D
        ? (0, X.jsx)(le, {
            ...
            content: (0, X.jsx)(y, {
              ...
              defaultMessage: `This chat was previously on {threadBranch}. Please confirm you want to commit to {checkedOutBranch}.`,
              description: `Warning shown before commit when the checked out branch differs from the thread branch`,
              values: {
                checkedOutBranch: (0, X.jsx)(`code`, {
                  className: `inline rounded-md border border-token-border bg-token-input-background px-1.5 py-0.5 font-mono text-sm text-token-foreground`,
                  children: D.checkedOutBranch,
                }),
                threadBranch: (0, X.jsx)(`code`, {
                  className: `inline rounded-md border border-token-border bg-token-input-background px-1.5 py-0.5 font-mono text-sm text-token-foreground`,
                  children: D.threadBranch,
                }),
              },
            }),
          })
      ...
      (t[65] = Se));
  let Ce;
  t[66] !== v || t[67] !== ne || t[68] !== A || t[69] !== ie
    ? ((Ce = ie
        ? (0, X.jsx)(St, {
            checked: v,
            disabled: ne,
            onChange: (e) => {
              k(A, n.createPullRequestAsDraft, e);
            },
          })
        : null),
      (t[66] = v),
  ...
  t[72] !== d || t[73] !== s || t[74] !== O
    ...
    : (Ee = t[75]);
  let Z;
  t[76] !== L || t[77] !== we || t[78] !== Ee
    ? ((Z = (0, X.jsx)(te, { disabled: we, tooltipContent: L, children: Ee })),
      (t[76] = L),
      (t[77] = we),
      (t[78] = Ee),
      (t[79] = Z))
  ...
  let Oe;
  return (
    t[83] !== be || t[84] !== xe || t[85] !== Se || t[86] !== De
      ? ((Oe = (0, X.jsxs)(xt.Root, { children: [ae, oe, be, xe, Se, De] })),
        (t[83] = be),
        (t[84] = xe),
        (t[85] = Se),
        (t[86] = De),
...
function Dt({
  isLoadingChanges: e,
  isCommitting: t,
  hasSummaryLoadError: n,
  hasSelectedChanges: r,
}) {
  return t
    ? (0, X.jsx)(y, {
...
function Ot(e) {
  ...
  t[0] === a
    ...
    : ((o = a.formatMessage({
        ...
        description: `Aria label for the toggle to stage unstaged changes before committing`,
      })),
      (t[0] = a),
      (t[1] = o));
  let s;
  ...
  let c;
  t[5] !== i || t[6] !== o || t[7] !== s
    ? ((c = (0, X.jsx)(de, { checked: i, ariaLabel: o, onChange: s })),
      (t[5] = i),
      (t[6] = o),
      (t[7] = s),
      (t[8] = c))
...
function kt({
  ...
  gitActionKey: c,
  hostConfig: u,
  allowedNextSteps: f = [`commit`],
  initialNextStep: p = `commit`,
  onGenerateMessage: h,
  onGenerateCommitPullRequestMessage: g,
  pullRequestInstructions: _,
  commitAttribution: v,
  branchUpdateWarning: y = null,
  onBeforeCommit: x,
  onPullRequestCreated: S,
  onStatusChange: k,
  onRequestReset: A,
}) {
  let M = E(C),
    N = w(),
    { data: P } = l(s, u, `commit_modal`),
    F = O(n.alwaysForcePush),
    I = O(n.createPullRequestAsDraft),
    [ee, L] = (0, ct.useState)(p),
    R = b(Ye, c),
    te = b(Je, c).trim(),
    B = (0, ct.useRef)(null),
    V = b(r, a ?? null),
    ...
    { data: U, refetch: ne, isSuccess: ae } = _e(s, u, `commit_modal`),
    { data: oe, refetch: W } = ge(s, u, `commit_modal`),
    { data: G, refetch: se } = d(
      s,
      u,
      `review-summary`,
      { cwd: s, operationSource: `commit_modal`, source: `branch` },
      `commit_modal`,
      { staleTime: D.FIVE_SECONDS },
    ),
    { data: ce } = j(`gh-cli-status`, { params: { hostId: u.id } }),
    {
      data: K,
      isLoading: le,
      refetch: ue,
      ...
      source: `commit_modal`,
      params: { cwd: s, headBranch: U?.branch ?? ``, hostId: u.id },
      queryConfig: {
        enabled:
          ae && ce && ce.isInstalled && ce.isAuthenticated && !!U?.branch,
        staleTime: D.FIVE_SECONDS,
      },
    }),
    de = (K?.status === `success` ? K : null)?.hasOpenPr ?? !1,
    fe = it({ cwd: s, hostConfig: u, operationSource: `commit_modal` }),
    pe = m({ cwd: s, hostId: u.id, operationSource: `commit_modal` }),
    me = st({ conversationId: a ?? null, tokenUsageInfo: V }),
    q = je({ cwd: s, hostId: u.id, conversationId: me }),
    he = De({ cwd: s, hostConfig: u, gitMetadata: P }),
    J = M.get(qe, c),
    ve = T(J),
    ye = (ve?.status ?? null) === `pushing`,
    Y = ve != null,
    be = Ne({ pushStatus: U, ignoreNothingToPush: !0 }),
    xe = Pe({
      ghStatus: ce,
      pushStatus: U,
      isLoadingPRStatus: le,
      hasOpenPr: de,
    ...
    ),
    {
      ...
      u,
      `review-summary`,
      { cwd: s, operationSource: `commit_modal`, source: `unstaged` },
      `commit_modal`,
      { enabled: R, staleTime: D.FIVE_SECONDS },
    ),
    Ie = Mt(R ? [Z, Ae] : [Z]),
    Q = async () => {
      let [e, t, n] = await Promise.all([
        ...
        oe == null ? W().then((e) => e.data) : Promise.resolve(oe),
        G == null ? se().then((e) => e.data) : Promise.resolve(G),
      ]);
      return He({
        pullRequestInstructions: _,
        uncommittedDiff: e.diff.type === `success` ? e.diff.unifiedDiff : null,
        filePaths: (n?.type === `success` ? n.files : []).map((e) => e.path),
        baseBranch: t?.baseBranch ?? U?.defaultBranch ?? null,
        headBranch: t?.branch ?? U?.branch ?? null,
      });
    },
    Le = null;
  U && (Le = U.branch ?? U.upstreamRef ?? null);
  let Be = Oe || Me,
    Ve = ke || Fe,
    Ue = Z?.type === `error` || (R && Ae?.type === `error`),
    We = (Ie?.files.length ?? 0) > 0,
    Ge = (e) =>
      (e === `commit-and-push` && !Te) || (e === `commit-and-create-pr` && !Ee)
        ? [`commit`]
        : tt(e),
    $ = (e, t, n) => {
      (M.get(z).custom({
        ...
        content: ({ close: r }) =>
          (0, X.jsx)(Ce, {
            title: jt(e, N),
            message: n != null && e === `commit` ? null : t,
            execOutput: n,
            onClose: r,
          }),
      }),
    ...
    Xe = (e, { forcePush: t }) => {
      let n = nt(e);
      (M.get(z).success(At(n, { commitTarget: Le, forcePush: t }, N)),
        Ke(),
        k?.(`success`),
        A());
    },
    ...
    $e = async () => {
      ...
      let e = (await Q()).trim();
      if (e.length === 0) return (M.get(z).danger(H), null);
      let t;
      try {
        t = await q.mutateAsync({
          hostId: u.id,
          prompt: e,
          cwd: s,
          conversationId: me,
        ...
        let n = t.title?.trim() ?? ``,
          r = t.body?.trim() ?? ``;
        if (n.length === 0 || r.length === 0) return (M.get(z).danger(H), null);
        let i = { title: n, body: r };
        return ((B.current = i), i);
      } catch {
        return (M.get(z).danger(H), null);
      }
    },
    et = async (e, n) => {
      let r = F,
        i = (e) => {
          let t = J.get();
          J.set({ sourceActionId: t?.sourceActionId ?? `commit`, status: e });
        };
      try {
        i(`committing`);
        let e = await he.mutateAsync({
          cwd: t(s),
          message: n,
          includeUnstaged: R,
          commitAttribution: v,
      ...
      !U.upstreamRef &&
        U.branch &&
        ((c.refspec = `HEAD:refs/heads/${U.branch}`), (c.setUpstream = !0));
      try {
        let e = await fe.mutateAsync(c);
        if (e.status === `error`) {
          $(`push`, r ? o : Nt(e.error, N), e.execOutput);
          return;
        }
        (ne(), ue());
      } catch {
      ...
      if (!e.includes(`create-pr`)) {
        Xe(e, { forcePush: r });
        return;
      }
      let l = N.formatMessage({
      ...
      try {
        let e = await pe.mutateAsync({
          cwd: s,
          headBranch: U.branch,
          baseBranch: U.defaultBranch,
          isDraft: I,
          titleOverride: u.title,
          bodyOverride: u.body,
        });
        if (e.status !== `success`) {
          $(`create-pr`, e.execOutput == null ? e.error : l, e.execOutput);
          return;
        }
        U.branch != null && (await S?.(U.branch));
      } catch {
        $(`create-pr`, l);
        return;
      }
    ...
    rt = async (e = ee) => {
      if (Y || Ve || Ue || !We || (x && !(await x()))) return;
      let t = Ge(e);
      ((B.current = null),
        J.set({ sourceActionId: `commit`, status: `committing` }),
        i(!1),
        k?.(`loading`));
      try {
        let e = te;
        if (e.length === 0) {
          if (t.includes(`create-pr`) && g != null) {
            let t = await g(await Q());
            if (!t) return;
            e = t.message.trim();
            let n = t.title.trim(),
              r = t.body.trim();
  ...
  return (0, X.jsx)(ie, {
    ...
    children: (0, X.jsx)(Et, {
      gitActionKey: c,
      isFetchingChanges: Be,
      isLoadingChanges: Ve,
      isFetchingUntrackedChanges: !1,
      isCommitting: Y,
      hasSummaryLoadError: Ue,
      target: Le,
      selectionSummary: Ie,
      commitDisabled: Ve || Ue || !We || Y,
      hasSelectedChanges: We,
      nextStep: ee,
      allowedNextSteps: f,
      setNextStep: L,
      canCommitAndPush: Te,
      canCommitAndCreatePullRequest: Ee,
      createPullRequestAsDraft: I,
      showCreatePullRequestHint: !!ce && !ce.isInstalled,
      commitAndPushTooltipText: Se,
      commitAndCreatePullRequestTooltipText: we,
      branchUpdateWarning: y,
      onCommit: () => {
        rt();
      },
    }),
...
function Mt(e) {
  ...
  return {
    files: t.map((e) => {
      let t = e.additions ?? 0,
        i = e.deletions ?? 0;
      return ((n += t), (r += i), { path: e.path, additions: t, deletions: i });
    }),
    totalAdditions: n,
    totalDeletions: r,
  };
...
function Pt(e, t, n) {
  return [`vscode`, `generate-commit-message`, e ?? null, t, n ?? null];
}
function Ft(e) {
  let t = (0, q.c)(7),
    { cwd: n, hostId: r, conversationId: i, onError: a } = e,
    o;
  t[0] !== i || t[1] !== n || t[2] !== r
    ? ((o = Pt(n, r, i)), (t[0] = i), (t[1] = n), (t[2] = r), (t[3] = o))
    : (o = t[3]);
  let s;
  return (
    t[4] !== a || t[5] !== o
...
function It(e, t, n, r) {
  ...
  return (
    i[2] === r
      ? (o = i[3])
      : ((o = { select: Lt, staleTime: D.FIVE_SECONDS, ...r }),
        (i[2] = r),
        (i[3] = o)),
...
function Rt(e, t, n, r) {
  ...
  a[5] !== s || a[6] !== d || a[7] !== r || a[8] !== o
    ...
    : (m = a[9]);
  let h;
  a[10] !== n || a[11] !== r || a[12] !== p || a[13] !== m
    ? ((h = { source: n, mutationKey: p, ...r, onSettled: m }),
      (a[10] = n),
      (a[11] = r),
      (a[12] = p),
      (a[13] = m),
...
var Vt = 5;
function Ht({ branchPrefix: e, conversationTitle: t }) {
  let n = e?.trim() ?? ``,
    r = Ut(t);
...
function Wt(e) {
  ...
  if (
    ...
    ((t[0] = n),
      ...
      (t[15] = O),
      (t[16] = k));
  } else ((E = t[13]), (D = t[14]), (O = t[15]), (k = t[16]));
  let A;
  t[29] === x
    ? (A = t[30])
    : ((A = x.formatMessage({
  ...
  t[39] !== k
    ? ((M = (e) => {
        ...
        if (_ || k || D == null) return;
        let t = D.find((e) => e !== r) ?? D[0];
        t != null && p(t);
      }),
      (t[33] = _),
      (t[34] = D),
    ...
    : (M = t[40]);
  let N;
  t[41] !== T || t[42] !== A || t[43] !== j || t[44] !== M
    ? ((N = (0, X.jsx)(W.SearchInput, {
        autoFocus: !1,
        placeholder: A,
        value: T,
        onChange: j,
...
//# sourceMappingURL=git-branch-picker-dropdown-content-qjFA5f4r.js.map
