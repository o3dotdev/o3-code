...
import { is as r, zo as i } from "./app-server-manager-signals-Csopz8aM.js";
...
import { r as D } from "./toast-signal-Dfdpi-kK.js";
import "./window-zoom-context-BgcP82Wr.js";
import "./tooltip-DzyyaBl-.js";
import { t as O } from "./route-scope-BpEoGCxV.js";
...
import { t as k } from "./button-bq66r8jD.js";
import "./reduced-motion-preference-CcGC6Z5k.js";
import { t as A } from "./spinner-D37df5tU.js";
...
import { h as j } from "./app-shell-state-HP0T5lEX.js";
import "./app-shell-panel-animation-C6SMnz6V.js";
import { t as M } from "./app-shell-Bh-lgoQk.js";
...
import { t as N } from "./with-window-C7Mmo_xd.js";
...
import { t as P } from "./context-menu-TJfRSX1h.js";
...
import { u as F } from "./sidebar-project-group-signals-B2IlZT8R.js";
import { t as I } from "./git-origins-query-Clde8HAB.js";
...
import { r as L, t as R } from "./dropdown-PBHuhi3M.js";
import "./globe-D1xFoTfu.js";
import "./three-dots-CSCWkqFa.js";
import { t as z } from "./chevron-CEHg0DRl.js";
import "./format-relative-date-time-C9hYZCdh.js";
import "./folder-DnqvPFV1.js";
import { t as ee } from "./copy-to-clipboard-DUkEoARe.js";
import "./warning-Cmz-KXha.js";
import { h as B, s as V } from "./review-header-toolbar-6CN1dM2m.js";
...
import { t as te } from "./use-is-pull-request-merge-helper-enabled-yqBhsVRr.js";
...
import { t as U } from "./large-empty-state-8ew20Qp4.js";
...
import { t as re } from "./selectable-list-row-Du758VIB.js";
import { n as W, t as ie } from "./sectioned-page-DEV0c8Vn.js";
import { t as G } from "./segmented-toggle-BH-1E2Gu.js";
import {
  a as ae,
  c as oe,
  d as K,
  ...
  t as de,
  u as fe,
} from "./pull-request-board-model-Dv0dhu_b.js";
var Q = b(),
  pe = e(a(), 1),
  $ = o(),
  me = c({
  ...
  ge = c({
    ...
    openInBrowser: {
      ...
      description: `Context menu item that opens a pull request in the browser`,
    },
  }),
  _e = [];
function ve(e) {
  ...
  r[8] !== o
    ? ((k = O
      ...
      (r[9] = k))
    : (k = r[9]);
  let j = O ? o.length > 0 : a != null,
    N;
  r[10] === j
    ? (N = r[11])
    : ((N = {
        enabled: j,
        intervalMs: g.THIRTY_SECONDS,
        staleTime: g.THIRTY_SECONDS,
      }),
      (r[10] = j),
      (r[11] = N));
  let P;
  r[12] !== k || r[13] !== N
    ? ((P = { source: `pull_request_board`, params: k, queryConfig: N }),
      (r[12] = k),
      (r[13] = N),
      (r[14] = P))
    : (P = r[14]);
...
function Ce(e) {
  ...
  t[4] === i
    ...
    : ((o = i.formatMessage({
        ...
        description: `Title for the pull requests page empty state when the selected repo has no pull requests`,
      })),
      (t[4] = i),
      (t[5] = o));
  let s;
...
function we({ intl: e, isAllReposSelected: t, selectedFilterView: n }) {
  switch (t ? `all` : n) {
    case `all`:
      return e.formatMessage({
        id: `pullRequestsPage.empty.noPullRequests.allReposDescription`,
        defaultMessage: `Pull requests across your GitHub repos will appear here`,
        description: `Description for the pull requests page empty state when all repos are selected and there are no pull requests`,
      });
    case `authored`:
      return e.formatMessage({
        id: `pullRequestsPage.empty.noPullRequests.description`,
        defaultMessage: `Your recent authored pull requests for this repo will appear here`,
        description: `Description for the pull requests page empty state when the selected repo has no pull requests`,
      });
    case `review`:
      return e.formatMessage({
        id: `pullRequestsPage.empty.noPullRequests.reviewDescription`,
        defaultMessage: `Pull requests requesting your review for this repo will appear here`,
        description: `Description for the pull requests page empty state when the review filter has no pull requests`,
      });
  }
}
function Te(e) {
  ...
  t[0] === i
    ...
    : ((a = i.formatMessage({
        ...
        description: `Accessible label for the pull request board saved view toggle`,
      })),
      (t[0] = i),
      (t[1] = a));
  let o;
...
function Ee(e) {
  let t = (0, Q.c)(31),
    {
      ...
      column: r,
      mergeMethod: i,
      selectedPullRequestNumber: a,
      selectedPullRequestUrl: o,
      showRepo: c,
      onSelectPullRequest: l,
      onToggleSection: u,
      repo: d,
    } = e,
    f;
  t[0] === r.key ? (f = t[1]) : ((f = je(r.key)), (t[0] = r.key), (t[1] = f));
  let p = f,
    m = !n,
    h = `${p}-items`,
    g = n && `-rotate-90`,
  ...
  t[2] === g
    ? (_ = t[3])
    : ((_ = s(`icon-2xs shrink-0 transition-transform`, g)),
      (t[2] = g),
      (t[3] = _));
  let v;
  t[4] === _
  ...
  t[8] === y
    ? (b = t[9])
    : ((b = (0, $.jsx)(`span`, { children: y })), (t[8] = y), (t[9] = b));
  let x;
  t[10] !== u || t[11] !== m || t[12] !== h || t[13] !== v || t[14] !== b
    ? ((x = (0, $.jsxs)(`button`, {
        "aria-expanded": m,
        "aria-controls": h,
            ...
            children: r.items.map((e) =>
              (0, $.jsx)(
                `div`,
                {
                  ...
                  children: (0, $.jsx)(Oe, {
                    item: e,
                    selected: e.url === o || (o == null && e.number === a),
                    mergeMethod: i,
                    onSelectPullRequest: l,
                    repo: e.repo ?? d,
                    showRepo: c,
...
function Oe(e) {
  ...
  t[0] !== u || t[1] !== m || t[2] !== c
    ...
    : (_ = t[3]);
  let v;
  t[4] !== n.cwd || t[5] !== n.headBranch || t[6] !== n.hostId || t[7] !== _
    ? ((v = {
        cwd: n.cwd,
  ...
  t[19] !== a
    ? ((w = ke({
        isMergePending: b.isPending,
        pullRequestMergeHelperEnabled: g,
        item: n,
        repo: a,
        onMergePullRequest: C,
      })),
      (t[15] = C),
      (t[16] = n),
      (t[17] = b.isPending),
    ...
    ? ((O = {
        ...
        onSelect: () => {
          (X(c, {
            ...
            x.dispatchMessage(`open-in-browser`, { url: n.url }));
        },
      }),
      (t[25] = n),
      (t[26] = c),
  ...
  t[45] !== n.baseBranch || t[46] !== n.headBranch
    ? ((L = (0, $.jsx)(`span`, {
        ...
        children: (0, $.jsx)(l, {
          ...
          values: { baseBranch: n.baseBranch, headBranch: n.headBranch },
        }),
      })),
      (t[45] = n.baseBranch),
      (t[46] = n.headBranch),
...
function ke({
  isMergePending: e,
  pullRequestMergeHelperEnabled: t,
  item: n,
  repo: r,
  onMergePullRequest: i,
}) {
  return n.isAuthor && n.state === `ready`
    ? (0, $.jsx)(k, {
...
function Pe() {
  ...
  if (w.length === 0) {
    ...
    e[8] === t
      ...
      : ((n = t.formatMessage({
          ...
          defaultMessage: `Add a workspace with a GitHub remote to populate this board`,
          description: `Description for the pull requests page empty state when no repos are available`,
        })),
        (e[8] = t),
        (e[9] = n));
    let r;
    e[10] === t
      ...
      : ((r = t.formatMessage({
          ...
          description: `Title for the pull requests page empty state when no repos are available`,
        })),
        (e[10] = t),
        (e[11] = r));
    let i;
  ...
  let k;
  e[15] !== n || e[16] !== i || e[17] !== O
    ? ((k = (e) => {
        let t = new URLSearchParams(i);
        (O != null && t.set(`repoKey`, O),
          t.set(`view`, e),
        ...
        (O != null && r.set(`repoKey`, O),
          ...
          e == null
            ...
            : (r.set(`pullRequestNumber`, String(e.number)),
              r.set(`pullRequestUrl`, e.url)),
          n(
            { pathname: `/pull-requests`, search: `?${r.toString()}` },
            { replace: t?.replace === !0 },
          ));
      }),
      (e[19] = n),
  ...
  return (
    ...
    e[37] !== M
      ? ((N = (0, $.jsx)(ve, {
          ...
          selectedPullRequestUrl: f,
          selectedRepoKey: O,
          onSelectFilterView: k,
          onSelectPullRequest: j,
          onSelectRepo: M,
        })),
        (e[29] = w),
        (e[30] = l),
...
export { Pe as PullRequestsPage };
//# sourceMappingURL=pull-requests-page-CfICuwyI.js.map
