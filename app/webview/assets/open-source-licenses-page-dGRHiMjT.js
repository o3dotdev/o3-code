...
import { H as t, _ as n, p as r, xt as i } from "./setting-storage-EK1Te68s.js";
import { f as a, u as o } from "./chunk-LFPYN7LY-CkfOxD5s.js";
import { t as s } from "./button-bq66r8jD.js";
import "./reduced-motion-preference-CcGC6Z5k.js";
import "./spinner-D37df5tU.js";
import { t as c } from "./arrow-left-NB8jxLlJ.js";
import { t as l } from "./settings-content-layout-Bnulb0lM.js";
import { t as u } from "./settings-surface-YwAy0P94.js";
...
function m() {
  ...
  e[0] === m.state
    ? (g = e[1])
    : ((g = h(m.state)), (e[0] = m.state), (e[1] = g));
  let _ = g,
    v =
      m.state != null && typeof m.state == `object` && !Array.isArray(m.state)
        ? m.state
        : null,
    y;
  e[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((y = { queryConfig: { enabled: !0, staleTime: n.ONE_MINUTE } }),
      (e[2] = y))
    : (y = e[2]);
  let { data: b, isLoading: x } = r(`third-party-notices`, y),
    S;
  e[3] !== _ || e[4] !== v || e[5] !== i
    ? ((S = () => {
        i(_, { replace: !0, state: v });
      }),
      (e[3] = _),
      (e[4] = v),
      (e[5] = i),
...
export { m as OpenSourceLicensesPage };
//# sourceMappingURL=open-source-licenses-page-dGRHiMjT.js.map
