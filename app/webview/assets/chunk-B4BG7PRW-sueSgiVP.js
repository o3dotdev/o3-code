...
import { t as g } from "./chunk-FMBD7UC4-rrmk1FZY.js";
import { t as _ } from "./chunk-55IACEB6-ouq-OFLp.js";
import { t as v } from "./chunk-QN33PNHL-BRcT7LP7.js";
...
` +
  ...
  return (r($, `Parser`), ($.prototype = oe), (oe.Parser = $), new $());
})();
x.parser = x;
var S = x,
  C = [`#`, `+`, `~`, `-`, ``],
  w = class {
    ...
    getDisplayDetails() {
      ...
      (this.memberType === `method` &&
        ((e += `(${a(this.parameters.trim())})`),
        this.returnType && (e += ` : ` + a(this.returnType))),
        (e = e.trim()));
    ...
    parseMember(e) {
      ...
      ((this.classifier = t),
        (this.id = this.id.startsWith(` `)
          ...
          : this.id.trim()),
        (this.text =
          `${this.visibility ? `\\` + this.visibility : ``}${a(this.id)}${this.memberType === `method` ? `(${a(this.parameters)})${this.returnType ? ` : ` + a(this.returnType) : ``}` : ``}`
            .replaceAll(`<`, `&lt;`)
            .replaceAll(`>`, `&gt;`)),
  ...
  T = `classId-`,
  E = 0,
  D = r((e) => p.sanitizeText(e, f()), `sanitizeText`),
  O = class {
    constructor() {
      ((this.relations = []),
        ...
        (this.getConfig = r(() => f().class, `getConfig`)),
    ...
    addRelation(e) {
      ...
      !t.includes(e.relation.type2)
        ...
        (e.relationTitle1 = p.sanitizeText(e.relationTitle1.trim(), f())),
        (e.relationTitle2 = p.sanitizeText(e.relationTitle2.trim(), f())),
    ...
    setClickFunc(t, n, r) {
      let i = p.sanitizeText(t, f());
      if (f().securityLevel !== `loose` || n === void 0) return;
      let a = i;
      if (this.classes.has(a)) {
        let t = this.lookUpDomId(a),
          i = [];
        if (typeof r == `string`) {
          i = r.split(/,(?=(?:(?:[^"]*"){2})*[^"]*$)/);
    ...
    getData() {
      ...
      for (let t of this.classes.keys()) {
        ...
        if (n) {
          let t = n;
          ((t.parentId = n.parent), (t.look = r.look), e.push(t));
        }
      }
      let i = 0;
      for (let t of this.notes) {
        ...
        e.push(a);
        let o = this.classes.get(t.class)?.id ?? ``;
        if (o) {
          let e = {
            id: `edgeNote${i}`,
            start: t.id,
      ...
      for (let e of this.relations) {
        i++;
        let a = {
          id: t(e.id1, e.id2, { prefix: `id`, counter: i }),
          start: e.id1,
          end: e.id2,
          type: `normal`,
          label: e.title,
...
`,
  ...
  A = {
    ...
    draw: r(async function (t, r, i, a) {
      (n.info(`REF0:`), n.info(`Drawing class diagram (v3)`, r));
      let { securityLevel: o, state: s, layout: c } = f(),
        l = a.db.getData(),
        u = _(r, o);
      ((l.type = a.type),
        (l.layoutAlgorithm = b(c)),
        ...
        v(u, 8, `classDiagram`, s?.useMaxWidth ?? !0));
    }, `draw`),
    getDir: r((e, t = `TB`) => {
      if (!e.doc) return t;
      let n = t;
...
//# sourceMappingURL=chunk-B4BG7PRW-sueSgiVP.js.map
