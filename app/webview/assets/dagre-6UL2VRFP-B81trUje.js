...
import { i as t } from "./_basePickBy-DfOJ5f1T.js";
import { t as n } from "./dagre-BLI2y0OU.js";
import "./chunk-S3R3BYOJ-5zDRn6nL.js";
import { t as r } from "./clone-DgntaiN2.js";
import { t as i } from "./graphlib-BZvYK9y8.js";
import { i as a, r as o } from "./src-DXdm7MTq.js";
import { b as s } from "./chunk-ABZYJK2D-DvAKbH5X.js";
import "./dist-Dkaf81wL.js";
import "./chunk-JA3XYJ7Z-_sm1v70d.js";
import "./marked.esm-B1dI5d9h.js";
import "./chunk-HN2XXSSU-BAQ0kSeo.js";
import { t as c } from "./chunk-CVBHYZKI-B0vHREv4.js";
...
import {
  ...
  t as m,
  u as h,
} from "./chunk-JZLCHNYA-BxKQhlWe.js";
import {
  a as g,
  i as _,
  n as v,
  r as y,
  t as b,
} from "./chunk-QXUST7PY-BKTz6l_w.js";
function x(t) {
  var n = {
    options: {
...
var w = new Map(),
              ...
              try {
                k(i, r)
                  ? (a.info(`Copying as `, i.v, i.w, o, i.name),
                    ...
                    a.info(`newGraph edges `, n.edges(), n.edge(n.edges()[0])))
                  : a.info(
    ...
    (e.nodes().forEach(function (t) {
      ...
      e.nodes().forEach(function (t) {
        let n = e.children(t),
          r = e.edges();
        n.length > 0
          ? (a.debug(`Cluster identified`, t, T),
            r.forEach((e) => {
              O(e.v, t) ^ O(e.w, t) &&
                (a.warn(`Edge: `, e, ` leaves cluster `, t),
                a.warn(`Descendants of XXX `, t, `: `, T.get(t)),
                (w.get(t).externalConnections = !0));
            }))
          : a.debug(`Not a cluster `, t, T);
      }));
    for (let t of w.keys()) {
      let n = w.get(t).id,
        r = e.parent(n);
  ...
  I = o((e, t) => {
    ...
    for (let r of n)
      if (
        ...
        w.get(r)?.clusterData?.dir &&
          ...
          a.warn(`Fixing dir`, w.get(r).clusterData.dir, n));
        ...
        (a.warn(`Old graph before copy`, x(e)),
          A(r, e, o, r),
          e.setNode(r, {
            clusterNode: !0,
            id: r,
          ...
          a.warn(`New graph after copy node: (`, r, `)`, x(o)),
          a.debug(`Old graph after copy`, x(e)));
      } else
        (a.warn(
          `Cluster ** `,
          r,
    ...
    for (let r of n) {
      let n = e.node(r);
      (a.warn(` Now next level`, r, n), n?.clusterNode && I(n.graph, t + 1));
    }
  }, `extractor`),
  L = o((e, t) => {
  ...
  R = o((e) => L(e, e.children()), `sortNodesByHierarchy`),
  z = o(async (e, t, r, i, s, p) => {
    a.warn(`Graph in recursive render:XAX`, x(t), s);
    let m = t.graph().rankdir;
    a.trace(`Dir in recursive render - dir:`, m);
    let _ = e.insert(`g`).attr(`class`, `root`);
    (t.nodes()
      ? a.info(`Recursive render XXX`, t.nodes())
      : a.info(`No nodes found for`, t),
      t.edges().length > 0 && a.info(`Recursive edges`, t.edge(t.edges()[0])));
...
Parent cluster`,
            ...
            t.setNode(s.id, n),
            t.parent(e) ||
              (a.trace(`Setting parent`, e, s.id), t.setParent(e, s.id, n)));
        }
        if (
          (a.info(`(Insert) Node XXX` + e + `: ` + JSON.stringify(t.node(e))),
          n?.clusterNode)
        ) {
          a.info(`Cluster identified XBX`, e, n.width, t.node(e));
          ...
          t.children(e).length > 0
            ...
            : (a.trace(`Node - the non recursive path XAX`, e, T, t.node(e), m),
      ...
      a.info(`Graph before layout:`, JSON.stringify(x(t))),
      a.info(`############################################# XXX`),
      a.info(`###                Layout                 ### XXX`),
      a.info(`############################################# XXX`),
      n(t),
      a.info(`Graph after layout:`, JSON.stringify(x(t))));
    let E = 0,
    ...
    return (
      ...
      t.edges().forEach(function (e) {
        let n = t.edge(e);
        (a.info(`Edge ` + e.v + ` -> ` + e.w + `: ` + JSON.stringify(n), n),
          n.points.forEach((e) => (e.y += D / 2)),
          g(n, v(S, n, w, r, t.node(e.v), t.node(e.w), i)));
      }),
      t.nodes().forEach(function (e) {
        let n = t.node(e);
        (a.info(e, n.type, n.diff), n.isGroup && (E = n.diff));
      }),
      a.warn(`Returning from recursive render XAX`, _, E),
      { elem: _, diff: E }
    );
  }, `recursiveRender`),
  B = o(async (e, t) => {
    ...
    (_(r, e.markers, e.type, e.diagramId),
      ...
      a.warn(`Graph at first:`, JSON.stringify(x(n))),
      F(n),
      a.warn(`Graph after XAX:`, JSON.stringify(x(n))));
    let o = s();
    await z(r, n, e.type, e.diagramId, void 0, o);
  }, `render`);
export { B as render };
//# sourceMappingURL=dagre-6UL2VRFP-B81trUje.js.map
