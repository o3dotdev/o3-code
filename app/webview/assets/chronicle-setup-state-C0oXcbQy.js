...
import { o as l } from "./statsig-CpJRDK88.js";
...
function C(e) {
  let n = (0, b.c)(43),
    ...
    M = o.kind === `accessibility-permission-needed`,
    N = C || M,
    P = y || S || N,
    F;
  n[0] !== l || n[1] !== M || n[2] !== C || n[3] !== o.status
    ? ((F = C
        ? o.status === `denied`
          ? l.formatMessage({
  ...
  n[10] === o
    ...
    : ((W = (0, x.jsxs)(d, {
        children: [
          U,
          (0, x.jsx)(p, {
            title: (0, x.jsx)(k, { setupState: o }),
            subtitle: (0, x.jsx)(A, { setupState: o }),
          }),
        ],
      })),
      (n[10] = o),
  ...
  n[12] !== R || n[13] !== o
    ? ((G = (0, x.jsx)(`p`, {
        ...
        children: (0, x.jsx)(j, { bundleName: R, setupState: o }),
      })),
      (n[12] = R),
      (n[13] = o),
      (n[14] = G))
...
function w() {
  c.dispatchMessage(`open-accessibility-settings`, {});
}
function T() {
  c.dispatchMessage(`open-screen-recording-settings`, {});
}
function E(e) {
  e.preventDefault();
}
function D(e) {
  (e.preventDefault(),
    c.dispatchMessage(`start-permission-settings-app-drag`, {}));
}
function O(e) {
  let n = (0, b.c)(15),
    {
...
function k(e) {
  ...
  if (r.kind === `screen-recording-permission-needed`) {
    let e;
    return (
  ...
  if (r.kind === `accessibility-permission-needed`) {
    let e;
    return (
...
export { y as a, C as i, N as n, v as o, S as r, M as t };
//# sourceMappingURL=chronicle-setup-state-C0oXcbQy.js.map
