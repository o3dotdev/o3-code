...
function v() {
  ...
  function O() {
    ...
    return (k(e), A(e), j(e), M(e), F(e), _(e), e);
  }
  ((O.update = function (e) {
    return (_(e), e);
  }),
    (O.nodeId = function (e) {
      return arguments.length
        ? ((x = typeof e == `function` ? e : c(e)), O)
        : x;
    }),
    (O.nodeAlign = function (e) {
      return arguments.length
        ? ((S = typeof e == `function` ? e : c(e)), O)
        : S;
    }),
    ...
    (O.nodes = function (e) {
      return arguments.length
        ? ((T = typeof e == `function` ? e : c(e)), O)
        : T;
    }),
    (O.links = function (e) {
      return arguments.length
        ? ((E = typeof e == `function` ? e : c(e)), O)
        : E;
    }),
    ...
    (O.extent = function (e) {
      return arguments.length
        ? ((r = +e[0][0]), (a = +e[1][0]), (i = +e[0][1]), (s = +e[1][1]), O)
        : [
            [r, i],
            [a, s],
          ];
  ...
  function k({ nodes: e, links: t }) {
    ...
    for (let [e, r] of t.entries()) {
      ...
      (typeof t != `object` && (t = r.source = g(n, t)),
        typeof i != `object` && (i = r.target = g(n, i)),
        t.sourceLinks.push(r),
        i.targetLinks.push(r));
    }
    if (w != null)
      for (let { sourceLinks: t, targetLinks: n } of e) (t.sort(w), n.sort(w));
  }
  function A({ nodes: e }) {
    for (let t of e)
      t.value =
        t.fixedValue === void 0
          ? Math.max(n(t.sourceLinks, f), n(t.targetLinks, f))
          : t.fixedValue;
  }
  function j({ nodes: e }) {
    let t = e.length,
  ...
  function P(e) {
    let r = t(e, (e) => (s - i - (e.length - 1) * b) / n(e, f));
    for (let t of e) {
      let e = i;
      for (let n of t) {
  ...
  function F(t) {
    let n = N(t);
    ((b = Math.min(y, (s - i) / (e(n, (e) => e.length) - 1))), P(n));
    for (let e = 0; e < D; ++e) {
      let t = 0.99 ** e,
        r = Math.max(1 - t, (e + 1) / D);
      (L(n, t, r), I(n, t, r));
    }
  }
  function I(e, t, n) {
  ...
  function H(e) {
    if (w === void 0)
      for (let { sourceLinks: t, targetLinks: n } of e) (t.sort(u), n.sort(l));
  }
  function U(e, t) {
...
C.prototype = w.prototype = {
    ...
    if (this._x1 === null)
      ...
      if (!(Math.abs(u * s - c * l) > x) || !i)
        ...
        var f = n - a,
          ...
          g = Math.sqrt(m),
          _ = Math.sqrt(d),
          v = i * Math.tan((y - Math.acos((m + d - h) / (2 * g * _))) / 2),
          b = v / _,
          S = v / g;
        (Math.abs(b - 1) > x &&
          (this._ += `L` + (e + b * l) + `,` + (t + b * u)),
          (this._ +=
            `A` +
            i +
            `,` +
  ...
  arc: function (e, t, n, r, i, a) {
    ...
    (this._x1 === null
      ? (this._ += `M` + c + `,` + l)
      : (Math.abs(this._x1 - c) > x || Math.abs(this._y1 - l) > x) &&
        (this._ += `L` + c + `,` + l),
      n &&
        (d < 0 && (d = (d % b) + b),
        d > S
...
function I() {
  return N().source(P).target(F);
}
export { i as a, o as i, v as n, a as o, s as r, I as t };
//# sourceMappingURL=sankeyLinkHorizontal-CguDmNLE.js.map
