function e(e) {
  let n = [];
  if ((e.network != null && n.push({ kind: `network` }), e.fileSystem == null))
    return n;
  let r = new Set(),
    i = new Set();
  ...
  return (
    s.length > 0 &&
      n.push({ kind: `fileSystem`, access: `readWrite`, paths: s }),
...
export { e as t };
//# sourceMappingURL=permission-request-model--mndqI-O.js.map
