...
import { h as n } from "./chunk-S3R3BYOJ-5zDRn6nL.js";
import "./defaultLocale-kl3RWqt7.js";
import { c as r, f as i, i as a, r as o, t as s } from "./linear-BBy1FF1U.js";
import {
  a as c,
  c as l,
  d as u,
  ...
  s as p,
  u as m,
} from "./string-CT3OTLdS.js";
import { i as h, o as g, r as _, t as v } from "./src-DXdm7MTq.js";
import { n as y, t as b } from "./min-DPnMT5mC.js";
import { t as x } from "./init-C9S7-8pU.js";
import {
  B as S,
  C,
  U as w,
...
import { t as ee } from "./dist-Dkaf81wL.js";
var te = Math.PI / 180,
  ne = 180 / Math.PI,
  re = 18,
  ie = 0.96422,
...
function ue(e) {
  ...
  if (e instanceof P) return ve(e);
  e instanceof l || (e = m(e));
  var t = he(e.r),
    n = he(e.g),
    r = he(e.b),
    i = fe((0.2225045 * t + 0.7168786 * n + 0.0606169 * r) / ae),
    a,
    o;
  return (
    t === n && n === r
      ? (a = o = i)
      : ((a = fe((0.4360747 * t + 0.3850649 * n + 0.1430804 * r) / ie)),
        (o = fe((0.0139322 * t + 0.0971045 * n + 0.7141733 * r) / oe))),
    new N(116 * i - 16, 500 * (a - i), 200 * (i - o), e.opacity)
  );
}
function de(e, t, n, r) {
  return arguments.length === 1 ? ue(e) : new N(e, t, n, r ?? 1);
}
function N(e, t, n, r) {
...
u(
  ...
  d(p, {
    brighter(e) {
      return new N(this.l + re * (e ?? 1), this.a, this.b, this.opacity);
    },
    darker(e) {
      return new N(this.l - re * (e ?? 1), this.a, this.b, this.opacity);
    },
...
function fe(e) {
  return e > le ? e ** (1 / 3) : e / ce + se;
}
function pe(e) {
  return e > M ? e * e * e : ce * (e - se);
}
function me(e) {
...
function ge(e) {
  ...
  if ((e instanceof N || (e = ue(e)), e.a === 0 && e.b === 0))
...
function _e(e, t, n, r) {
  return arguments.length === 1 ? ge(e) : new P(e, t, n, r ?? 1);
}
function P(e, t, n, r) {
...
u(
  ...
  d(p, {
    brighter(e) {
      return new P(this.h, this.c, this.l + re * (e ?? 1), this.opacity);
    },
    darker(e) {
      return new P(this.h, this.c, this.l - re * (e ?? 1), this.opacity);
    },
...
function H(e) {
  return F(
    ...
    (e, t) =>
      (t - e - (t.getTimezoneOffset() - e.getTimezoneOffset()) * L) / Te,
  );
}
var Pe = H(0),
  Fe = H(1),
  ...
  Re = H(5),
  ze = H(6);
(Pe.range, Fe.range, Ie.range, Le.range, U.range, Re.range, ze.range);
function W(e) {
  return F(
    (t) => {
...
function Ye(e, t, n, a, o, s) {
  ...
  function u(t, n, a) {
    let o = Math.abs(n - t) / a,
      s = i(([, , e]) => e).right(c, o);
    if (s === c.length) return e.every(r(t / De, n / De, a));
    if (s === 0) return we.every(Math.max(r(t, n, a), 1));
    let [l, u] = c[o / c[s - 1][2] < c[s][2] / o ? s - 1 : s];
    return l.every(u);
  }
  return [l, u];
}
var [Xe, Ze] = Ye(K, Je, Be, Ne, je, ke),
  [Qe, $e] = Ye(G, qe, Pe, V, Ae, Oe);
function et(e) {
  if (0 <= e.y && e.y < 100) {
      ...
      if (
        ...
        (`w` in r || (r.w = 1),
          `Z` in r
            ? ((a = tt(nt(r.y, 0, 1))),
              (o = a.getUTCDay()),
              (a = o > 4 || o === 0 ? Ve.ceil(a) : Ve(a)),
              (a = Me.offset(a, (r.V - 1) * 7)),
              (r.y = a.getUTCFullYear()),
              (r.m = a.getUTCMonth()),
              (r.d = a.getUTCDate() + ((r.w + 6) % 7)))
            : ((a = et(nt(r.y, 0, 1))),
              (o = a.getDay()),
              (a = o > 4 || o === 0 ? Fe.ceil(a) : Fe(a)),
        ...
        (`W` in r || `U` in r) &&
          ...
          (o =
            `Z` in r
              ? tt(nt(r.y, 0, 1)).getUTCDay()
              : et(nt(r.y, 0, 1)).getDay()),
          (r.m = 0),
          (r.d =
            `W` in r
              ? ((r.w + 6) % 7) + r.W * 7 - ((o + 5) % 7)
              : r.w + r.U * 7 - ((o + 6) % 7)));
      return `Z` in r
        ? ((r.H += (r.Z / 100) | 0), (r.M += r.Z % 100), tt(r))
        : et(r);
    };
  }
  function w(e, t, n, r) {
...
function Ht(e, t) {
  return ((e = Vt(e)), J(U.count(G(e), e) + (G(e).getDay() === 4), t, 2));
}
function Ut(e) {
  return e.getDay();
}
function Wt(e, t) {
  return J(Fe.count(G(e) - 1, e), t, 2);
}
function Gt(e, t) {
  return J(e.getFullYear() % 100, t, 2);
}
function Kt(e, t) {
  return ((e = Vt(e)), J(e.getFullYear() % 100, t, 2));
}
function qt(e, t) {
...
function ln(e, t) {
  return ((e = cn(e)), J(We.count(K(e), e) + (K(e).getUTCDay() === 4), t, 2));
}
function un(e) {
  return e.getUTCDay();
}
function dn(e, t) {
  return J(Ve.count(K(e) - 1, e), t, 2);
}
function fn(e, t) {
  return J(e.getUTCFullYear() % 100, t, 2);
}
function pn(e, t) {
  return ((e = cn(e)), J(e.getUTCFullYear() % 100, t, 2));
}
function mn(e, t) {
...
function Tn(e, t, n, r, i, s, c, l, u, d) {
  var f = o(),
    p = f.invert,
    m = f.domain,
    h = d(`.%L`),
  ...
  return (
    ...
    (f.domain = function (e) {
      return arguments.length ? m(Array.from(e, wn)) : m().map(Cn);
    }),
    (f.ticks = function (t) {
      var n = m();
    ...
    (f.copy = function () {
      return a(f, Tn(e, t, n, r, i, s, c, l, u, d));
    }),
    f
  );
}
function En() {
  return x.apply(
    Tn(Qe, $e, G, qe, Pe, V, Ae, Oe, B, xn).domain([
      new Date(2e3, 0, 1),
      new Date(2e3, 0, 2),
    ]),
    arguments,
...
function Rn(e, t) {
  ...
  function f(f) {
    var p = r ?? (t.ticks ? t.ticks.apply(t, n) : t.domain()),
      m = i ?? (t.tickFormat ? t.tickFormat.apply(t, n) : Dn),
      h = Math.max(a, 0) + s,
      g = t.range(),
      _ = +g[0] + c,
      v = +g[g.length - 1] + c,
      y = (t.bandwidth ? In : Fn)(t.copy(), c),
    ...
    ((x = x.merge(
      ...
      (E = E.merge(
        w
          ...
          .attr(u, l * h)
          .attr(`dy`, e === On ? `0em` : e === An ? `0.71em` : `0.32em`),
      )),
      f !== b &&
        ((x = x.transition(f)),
        (S = S.transition(f)),
        ...
        w.attr(`opacity`, Mn).attr(`transform`, function (e) {
      ...
      b
        ...
        .attr(`text-anchor`, e === kn ? `start` : e === jn ? `end` : `middle`),
      b.each(function () {
        this.__axis = y;
      }));
  }
  ...
  Jn = (function () {
    var e = _(function (e, t, n, r) {
      ...
      D = {
        ...
        performAction: _(function (e, t, n, r, i, a, o) {
          var s = a.length - 1;
          switch (i) {
            case 1:
              return a[s - 1];
...
` +
        ...
        performAction: _(function (e, t, n, r) {
          switch (n) {
            case 0:
...
var Xn = { friday: 5, saturday: 6 },
  ...
  ar = ``,
  or = ``,
  sr = [`active`, `done`, `crit`, `milestone`, `vert`],
  cr = [],
  lr = !1,
  ur = !1,
  dr = `sunday`,
  ...
  Ur = _(function (e, t, n) {
    ...
    {
      (h.debug(`Invalid date:` + n), h.debug(`With date format:` + t.trim()));
      let e = new Date(n);
      if (
        e === void 0 ||
        isNaN(e.getTime()) ||
  ...
  Jr = _(function (e, t) {
    ...
    return (
      a &&
        ((i.endTime = Gr(i.startTime, X, a, lr)),
  ...
  ei = _(function (e, t) {
    let n = { section: ar, type: ar, description: e, task: e, classes: [] },
      r = Jr(Xr, t);
    ...
    let e = _(function (e) {
        ...
        switch (Z[e].raw.startTime.type) {
          case `prevTaskEnd`:
            ...
            break;
          case `getStartDate`:
            ((n = Ur(void 0, X, Z[e].raw.startTime.startData)),
              n && (Z[e].startTime = n));
            break;
        }
        return (
          Z[e].startTime &&
            ((Z[e].endTime = Gr(Z[e].startTime, X, Z[e].raw.endTime.data, lr)),
            Z[e].endTime &&
              ((Z[e].processed = !0),
  ...
  ni = _(function (e, t) {
    let n = t;
    (D().securityLevel !== `loose` && (n = (0, Wn.sanitizeUrl)(t)),
  ...
  oi = {
    ...
    setExcludes: jr,
    getExcludes: Mr,
    setClickEvent: _(function (e, t, n) {
      (e.split(`,`).forEach(function (e) {
        ii(e, t, n);
      }),
        ri(e, `clickable`));
...
var ci = _(function () {
  ...
  di = {
    ...
    renderer: {
      setConf: ci,
      draw: _(function (e, t, n, r) {
        let i = D().gantt,
          a = D().securityLevel,
          o;
        a === `sandbox` && (o = v(`#i` + t));
        let c = v(a === `sandbox` ? o.nodes()[0].contentDocument.body : `body`),
          l = a === `sandbox` ? o.nodes()[0].contentDocument : document,
          u = l.getElementById(t);
        (($ = u.parentElement.offsetWidth),
          $ === void 0 && ($ = 1200),
          i.useWidth !== void 0 && ($ = i.useWidth));
        let d = r.db.getTasks(),
          f = [];
        for (let e of d) f.push(e.type);
        f = ee(f);
        let p = {},
          m = 2 * i.topPadding;
        if (
          ...
          for (let n of Object.keys(e)) {
            let r = ui(e[n], t) + 1;
            ((t += r), (m += r * (i.barHeight + i.barGap)), (p[n] = r));
          }
        } else {
          m += d.length * (i.barHeight + i.barGap);
          for (let e of f) p[e] = d.filter((t) => t.type === e).length;
        }
        u.setAttribute(`viewBox`, `0 0 ` + $ + ` ` + m);
        let g = c.select(`[id="${t}"]`),
          x = En()
            .domain([
              b(d, function (e) {
        ...
        function C(e, t, n) {
          let a = i.barHeight,
            ...
            u = s()
              ...
              .range([`#00B9FA`, `#F95002`])
              .interpolate(be);
          (T(o, c, l, t, n, e, r.db.getExcludes(), r.db.getIncludes()),
            E(l, c, t, n),
            w(e, o, c, l, a, u, t, n),
            A(o, c, l, a, u),
            j(l, c, t, n));
        ...
        function w(e, n, a, o, s, c, l) {
          ...
          g.append(`g`)
            ...
            .enter();
          let p = g.append(`g`).selectAll(`rect`).data(e).enter(),
            m = r.db.getLinks();
          if (
            (p
              .append(`rect`)
              ...
              .attr(`height`, function (e) {
                return e.vert
                  ? d.length * (i.barHeight + i.barGap) + i.barHeight * 2
                  : s;
              })
            ...
            p.filter(function (e) {
              ...
              (a.setAttribute(`xlink:href`, m.get(e.id)),
        ...
        function T(e, t, n, a, o, s, c, l) {
          ...
          g.append(`g`)
            ...
            .attr(`height`, o - t - i.gridLineStartPadding)
        ...
        _(T, `drawExcludeDays`);
        function E(e, t, n, a) {
          let o = r.db.getDateFormat(),
            s = r.db.getAxisFormat(),
            c;
        ...
        function A(e, t) {
          let n = 0,
            r = Object.keys(p).map((e) => [e, p[e]]);
          g.append(`g`)
            .selectAll(`text`)
            .data(r)
            .enter()
            .append(function (e) {
              let t = e[0].split(k.lineBreakRegex),
                n = -(t.length - 1) / 2,
                r = l.createElementNS(`http://www.w3.org/2000/svg`, `text`);
              r.setAttribute(`dy`, n + `em`);
              for (let [e, n] of t.entries()) {
                let t = l.createElementNS(
        ...
        function j(e, t, n, a) {
          ...
          if (o === `off`) return;
          let s = g.append(`g`).attr(`class`, `today`),
            c = new Date(),
            l = s.append(`line`);
          (l
            .attr(`x1`, x(c) + e)
...
//# sourceMappingURL=ganttDiagram-LVOFAZNH-DMOnjOhh.js.map
