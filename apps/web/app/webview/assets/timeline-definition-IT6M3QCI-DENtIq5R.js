import { i as e, n as t, r as n, t as r } from "./src-DXdm7MTq.js";
import { t as i } from "./arc-Dgx7D0pn.js";
import {
  $ as a,
  G as o,
  Q as s,
...
var h = ``,
  ...
  M = n(function (e, t) {
    ...
    return (
      n(c, `ambivalent`),
      t.score > 3 ? o(a) : t.score < 3 ? s(a) : c(a),
      r
    );
  }, `drawFace`),
  N = n(function (e, t) {
...
var G = n(function (e, t, n, r) {
  ...
  Y = n(function (t, n, i, a) {
    ...
    (e.debug(`bounds`, E),
      ...
      o(void 0, f, s.timeline?.padding ?? 50, s.timeline?.useMaxWidth ?? !1));
  }, `draw`),
  X = n(function (t, n, r, i, a, o, s, c, l, u, d) {
    for (let c of n) {
      let n = {
        descr: c.task,
        section: r,
...
//# sourceMappingURL=timeline-definition-IT6M3QCI-DENtIq5R.js.map
