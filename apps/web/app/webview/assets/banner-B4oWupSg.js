...
function o(e) {
  ...
  if (
    ...
    bb0: {
      let e = {
        ...
        r = t(
          `icon-sm shrink-0`,
          k === `infoAccent` && `text-token-text-link-foreground`,
          v,
        ),
        i = () =>
          (0, a.jsxs)(`div`, {
      ...
      (n[51] === l
        ? (V = n[52])
        : ((V = t(`flex h-full w-full items-center gap-2`, l)),
          (n[51] = l),
          (n[52] = V)),
        (H =
          _ && (0, a.jsx)(_, { className: t(r, N && `max-[400px]:hidden`) })));
    }
    ((n[17] = _),
      (n[18] = C),
      (n[19] = s),
  ...
  let K =
      N && `max-[400px]:flex-col max-[400px]:items-stretch max-[400px]:gap-2`,
    q;
  n[53] === K
    ? (q = n[54])
    : ((q = t(
...
export { o as t };
//# sourceMappingURL=banner-B4oWupSg.js.map
