...
import { xt as a } from "./setting-storage-kJblH-wH.js";
import { r as o } from "./spinner-avFWYgza.js";
import { t as s } from "./terminal-CNbIwMET.js";
import { t as c } from "./homepage-logo-Cefynusy.js";
import { t as l } from "./clock-BdccdK2N.js";
import { t as u } from "./search-CEAmgNrg.js";
import { t as d } from "./globe-D1xFoTfu.js";
import { t as f } from "./image-square-DaLHX1Fp.js";
import { t as p } from "./codex-1JQAUibh.js";
import { t as m } from "./tasks-8U8vryZ4.js";
var h = e(n()),
  g = r(),
  _ = (e) =>
    (0, g.jsxs)(`svg`, {
  ...
  v = {
    "analyze-image": () =>
      t(
        () =>
          import(`./analyze_image_animation-CGdmvmMb.js`).then(
            (e) => e.default,
          ),
        [],
        import.meta.url,
    ...
    automation: () =>
      t(
        () => import(`./automation-C5MclcIc.js`).then((e) => e.default),
        [],
        import.meta.url,
      ),
    browsing: () =>
      t(
        () => import(`./browsing_animation-afkq02LC.js`).then((e) => e.default),
        [],
        import.meta.url,
      ),
    "code-searching": () =>
      t(
        () =>
          import(`./code-searching-icon-D4aWJuv3.js`).then((e) => e.default),
        [],
        import.meta.url,
      ),
    "codex-happy-small": () =>
      t(
        () => import(`./codex-happy-small-CjuF6i1i.js`).then((e) => e.default),
        [],
        import.meta.url,
      ),
    "codex-looking-around": () =>
      t(
        () =>
          import(`./codex-looking-around-CXtyxA1o.js`).then((e) => e.default),
        [],
        import.meta.url,
      ),
    "edit-files": () =>
      t(
        () =>
          import(`./edit_files_animation-BrmyjeTY.js`).then((e) => e.default),
        [],
        import.meta.url,
      ),
    hello: () =>
      t(
        () => import(`./hello-D50x9wPp.js`).then((e) => e.default),
        [],
        import.meta.url,
      ),
    loader: () =>
      t(
        () => import(`./loader-N3eHDhzQ.js`).then((e) => e.default),
        [],
        import.meta.url,
      ),
    "internal-knowledge": () =>
      t(
        () =>
          import(`./internal-knowledge-icon-B2xv0xry.js`).then(
            (e) => e.default,
          ),
        [],
        import.meta.url,
    ...
    "list-files": () =>
      t(
        () =>
          import(`./list_files_animation-BtFDDJgF.js`).then((e) => e.default),
        [],
        import.meta.url,
      ),
    "local-context": () =>
      t(
        () =>
          import(`./local_context_animation-BIaf36BP.js`).then(
            (e) => e.default,
          ),
        [],
        import.meta.url,
    ...
    "run-command": () =>
      t(
        () =>
          import(`./run_command_animation-D52VpBhF.js`).then((e) => e.default),
        [],
        import.meta.url,
      ),
    searching: () =>
      t(
        () =>
          import(`./searching_animation-DiJNWQQ1.js`).then((e) => e.default),
        [],
        import.meta.url,
      ),
    "to-do": () =>
      t(
        () => import(`./to_do_animation-uc9BHdZq.js`).then((e) => e.default),
        [],
        import.meta.url,
      ),
    "web-search": () =>
      t(
        () => import(`./web-search-icon-BKW6wCUg.js`).then((e) => e.default),
        [],
        import.meta.url,
      ),
  },
...
export { x as t };
//# sourceMappingURL=animated-icon-_aK_YEcJ.js.map
