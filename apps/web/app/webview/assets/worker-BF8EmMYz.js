    ...
    return (
      e.forEach((e) => {
        e.added
          ...
          : e.removed
            ? (i = e)
            : ((r || i) && Mc(n, i, r, e), (n = e), (r = null), (i = null));
      }),
      (r || i) && Mc(n, i, r, null),
      e
    );
...
function Mc(e, t, n, r) {
  if (t && n) {
    ...
    if (e) {
      let r = xc(i, o);
      ((e.value = wc(e.value, o, r)),
        (t.value = Tc(t.value, r)),
        (n.value = Tc(n.value, r)));
    }
    if (r) {
      let e = Sc(a, s);
      ((r.value = Cc(r.value, s, e)),
        (t.value = Ec(t.value, e)),
        (n.value = Ec(n.value, e)));
    }
  } else if (n) {
    if (e) {
      let e = X(n.value);
...
(new (class extends Y {
  ...
  new (class extends Y {
    ...
    castInput(e, t) {
      ...
      return typeof e == `string`
        ? e
        : JSON.stringify(Lc(e, null, null, r), null, `  `);
    }
    equals(e, t, n) {
      return super.equals(
        e.replace(/,([\r\n])/g, `$1`),
...
function al(e) {
  ...
  let n = rl,
    ...
    o = () => {
      ...
      for (let e of i) sl(e);
      (r.push(
        el({ tagName: `span`, properties: { "data-char": a }, children: i }),
      ),
        (i = []),
        (a = void 0));
    },
        ...
        pre(t) {
          ...
          if (r != null) {
            ...
            for (let a of r.children)
              a.type === `element` && (e && al(a), i.push(nl(a, t, n)), t++);
            r.children = i;
          }
          return t;
        },
...
function hl({
  ...
  hunkIterator: for (let [n, r] of e.hunks.entries()) {
    ...
    let o = gl(e.isPartial, r.collapsedBefore, i, n, a),
      c = (() => {
        if (r !== s.finalHunk || !_l(e)) return;
        let t =
        ...
        let o = Math.min(t, n);
        return gl(e.isPartial, o, i, e.hunks.length, a);
      })(),
...
function Cl(
  ...
  for (let i of g.values()) {
    ...
    let a = { name: e.prevName ?? e.name, contents: i.deletionContent.value },
      ...
      { deletionLines: s, additionLines: c } = El({
        deletionFile: a,
...
function wl({
  ...
  if (
    ...
    t == null ||
    o === `none` ||
    ((e = Qc(e)), (t = Qc(t)), e.length > s || t.length > s)
  )
    return;
  ...
  for (let e of c) {
    let t = e === f;
    !e.added && !e.removed
      ? (xl({ item: e, arr: l, enableJoin: d, isNeutral: !0, isLastItem: t }),
        xl({ item: e, arr: u, enableJoin: d, isNeutral: !0, isLastItem: t }))
      : e.removed
        ? xl({ item: e, arr: l, enableJoin: d, isLastItem: t })
        : xl({ item: e, arr: u, enableJoin: d, isLastItem: t });
  }
  let p = 0;
  for (let e of l)
    (e[0] === 1 &&
    ...
    deletionLines:
      e.contents === ``
        ...
        : ((m.lang = u),
          (f.lineInfo = n),
          (m.decorations = a),
          ml(i.codeToHast(Qc(e.contents), m))),
    additionLines:
      t.contents === ``
        ? []
        : ((m.lang = d),
          (m.decorations = o),
          (f.lineInfo = r),
          ml(i.codeToHast(Qc(t.contents), m))),
  };
}
function Dl({
  lines: e,
...
const kl = { forcePlainText: !1 };
function Al(
  e,
  t,
  { theme: n = Vc, tokenizeMaxLineLength: r, useTokenTransformer: i },
  { forcePlainText: a, startingLine: o, totalLines: s, lines: c } = kl,
) {
  ...
  let h =
    ...
    g = ml(t.codeToHast(l ? jl(c ?? Ol(e.contents), o, s) : Qc(e.contents), h)),
    _ = l ? Array(o) : g;
...
async function Nl(e) {
  try {
    ...
    (console.error(`Worker error:`, t), Hl(e.id, t));
  }
}
async function Pl({
  id: e,
  ...
  let s = Rl(n);
  (`then` in s && (s = await s),
    zl({ customExtensionsVersion: a, customExtensionMap: o }),
    qc(r, s),
    i != null && Wc(i, s),
    ($ = t),
    postMessage({
...
async function Fl({ id: e, renderOptions: t, resolvedThemes: n }) {
  let r = Rl();
  (`then` in r && (r = await r),
    qc(n, r),
    ($ = t),
...
async function Il({
  ...
  let a = Rl();
  (`then` in a && (a = await a),
    zl({ customExtensionsVersion: r, customExtensionMap: i }),
    n != null && Wc(n, a));
  let o = {
    theme: $.theme,
...
function zl({ customExtensionsVersion: e, customExtensionMap: t }) {
  if (!(e == null && t == null)) {
    if (e == null || t == null)
      throw Error(
...
//# sourceMappingURL=worker-BF8EmMYz.js.map
