...
function a(e) {
  ...
  function s(e) {
    var n = e.split(i);
    return (n[0] === `` && n.length !== 1 && n.shift(), o(n, t) || c(e));
  }
  function u(e, t) {
    var r = n[e] || [];
    return t && a[e] ? [].concat(r, a[e]) : r;
  }
  return { getClassGroupId: s, getConflictingClassGroupIds: u };
}
function o(e, t) {
  if (e.length === 0) return t.classGroupId;
  var n = e[0],
    r = t.nextPart.get(n),
    a = r ? o(e.slice(1), r) : void 0;
  if (a) return a;
...
function h(e) {
  ...
  return function (e) {
    ...
    var d = a.length === 0 ? e : e.substring(s),
      f = d.startsWith(`!`);
    return {
      modifiers: a,
...
function _(e) {
  return { cache: m(e.cacheSize), splitModifiers: h(e), ...a(e) };
}
var v = /\s+/;
function y(e, t) {
...
function O(e) {
  return N(e) || w.has(e) || C.test(e) || k(e);
}
function k(e) {
  return B(e, `length`, V);
}
...
function K() {
  ...
  return {
    ...
    classGroups: {
      ...
      "object-position": [{ object: [].concat(W(), [I]) }],
      overflow: [{ overflow: D() }],
      ...
      "col-start-end": [{ col: [`auto`, { span: [`full`, F] }, I] }],
      "col-start": [{ "col-start": U() }],
      "col-end": [{ "col-end": U() }],
      "grid-rows": [{ "grid-rows": [L] }],
      "row-start-end": [{ row: [`auto`, { span: [F] }, I] }],
      ...
      "underline-offset": [{ "underline-offset": [`auto`, I, O] }],
      ...
      "outline-offset": [{ "outline-offset": [I, O] }],
      "outline-w": [{ outline: [O] }],
...
var q = b(K),
  ...
  X = Symbol(`isTwElement?`),
  Z = (e, t) => e.reduce((e, n, r) => e.concat(n || [], t[r] || []), []),
  te = (e, t = ``) => {
    let n = e
        .join(` `)
        .trim()
        ...
        .filter((e) => e !== `,`),
      r = t ? t.split(` `) : [];
    return q(...n.concat(r).filter((e) => e !== ` `));
  },
  ne = ([e]) => e.charAt(0) !== `$`,
  Q = (e) => e[X] === !0,
  $ =
    ...
    (t, ...n) => {
      let r = (i = []) => {
        let a = J.forwardRef((r, a) => {
          let { $as: o = e, style: s = {}, ...c } = r,
            l = Q(e) ? e : o,
            u = i
              ? i.reduce(
                  (e, t) => Object.assign(e, typeof t == `function` ? t(r) : t),
                  {},
                )
              : {},
            d = Q(l) ? c : Object.fromEntries(Object.entries(c).filter(ne));
        ...
        return (
          ...
          typeof e == `string`
            ? (a.displayName = `tw.` + e)
            : (a.displayName = e.displayName || e.name || `tw.Component`),
          (a.withStyle = (e) => r(i.concat(e))),
          a
        );
      };
      return r();
    },
  re = Y.reduce((e, t) => ({ ...e, [t]: $(t) }), {}),
  ie = Object.assign($, re);
export { ie as t };
//# sourceMappingURL=tailwind-styled-components.esm-Ck5todVw.js.map
