...
import { n as r, r as i, t as a } from "./chunk-AGHRB4JF-Dk9Dm4Nw.js";
import {
  B as o,
  C as s,
  V as c,
...
` +
  ...
  return (r(X, `Parser`), (X.prototype = Y), (Y.Parser = X), new X());
})();
b.parser = b;
var x = b,
  S = class {
    constructor() {
      ((this.entities = new Map()),
        ...
        (this.getConfig = r(() => f().er, `getConfig`)),
        this.clear(),
      ...
      return (
        this.entities.has(e)
          ? !this.entities.get(e)?.alias &&
            ...
            i.info(`Add alias '${t}' to entity '${e}'`))
          : (this.entities.set(e, {
    ...
    addAttributes(e, t) {
      ...
      for (r = t.length - 1; r >= 0; r--)
        (t[r].keys || (t[r].keys = []),
          ...
          i.debug(`Added attribute `, t[r].name));
    }
    addRelationship(e, t, n, r) {
      let a = this.entities.get(e),
        o = this.entities.get(n);
      if (!a || !o) return;
      let s = { entityA: a.id, roleA: t, entityB: o.id, relSpec: r };
      (this.relationships.push(s), i.debug(`Added new relationship :`, s));
    }
    getRelationships() {
    ...
    getData() {
      ...
      for (let e of this.relationships) {
        let r = {
          id: h(e.entityA, e.entityB, { prefix: `id`, counter: i++ }),
          type: `normal`,
          curve: `basis`,
          start: e.entityA,
          end: e.entityB,
  ...
  C = {};
a(C, { draw: () => w });
var w = r(async function (t, n, r, a) {
    (i.info(`REF0:`), i.info(`Drawing er diagram (unified)`, n));
    let { securityLevel: o, er: s, layout: c } = f(),
      l = a.db.getData(),
      u = g(n, o);
    ((l.type = a.type),
      (l.layoutAlgorithm = y(c)),
      (l.config.flowchart.nodeSpacing = s?.nodeSpacing || 140),
      (l.config.flowchart.rankSpacing = s?.rankSpacing || 80),
      (l.direction = a.db.getDirection()));
    let { config: d } = l,
      { look: p } = d;
    (p === `neo`
      ? (l.markers = [
    ...
    (Array.from(h).length > 0 &&
      h.each(function () {
        let t = e(this),
          n = t.attr(`id`).replace(`-background`, ``),
          r = u.select(`#${CSS.escape(n)}`);
        if (!r.empty()) {
      ...
      _(u, 8, `erDiagram`, s?.useMaxWidth ?? !0));
  }, `draw`),
  T = r((e, r) => {
    let i = n;
...
export { O as diagram };
//# sourceMappingURL=erDiagram-SMLLAGMA-8Z2Rp6PF.js.map
