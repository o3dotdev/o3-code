import { h as e, o as t } from "./chunk-S3R3BYOJ-5zDRn6nL.js";
...
import { t as p } from "./chunk-55IACEB6-ouq-OFLp.js";
import { t as m } from "./chunk-QN33PNHL-BRcT7LP7.js";
import { r as h } from "./chunk-N4CR4FBY-l_UuU9Uv.js";
var g = (function () {
...
` +
  ...
  return (r(P, `Parser`), (P.prototype = N), (N.Parser = P), new P());
})();
g.parser = g;
var _ = g,
  v = `TB`,
  ...
  pe = {
    ...
    draw: r(async function (t, r, i, a) {
      (n.info(`REF0:`), n.info(`Drawing state diagram (v2)`, r));
      let { securityLevel: o, state: s, layout: c } = l();
      a.db.extract(a.db.getRootDocV2());
      let u = a.db.getData(),
        d = p(r, o);
      ((u.type = a.type),
        (u.layoutAlgorithm = c),
        (u.nodeSpacing = s?.nodeSpacing || 50),
        (u.rankSpacing = s?.rankSpacing || 50),
        (u.markers = [`barb`]),
        (u.diagramId = r),
        await h(u, d));
      try {
        (typeof a.db.getLinks == `function`
          ...
          let r =
            typeof t == `string` ? t : typeof t?.id == `string` ? t.id : ``;
          if (!r) {
            n.warn(
          ...
          (o.replaceChild(s, a),
            s.appendChild(a),
            n.info(`🔗 Wrapped node in <a> tag for:`, r, e.url));
        });
      } catch (e) {
          ...
          case C:
            {
              ...
              let n = {
                ...
                style: k,
                labelStyle: ``,
                label: u.sanitizeText(t.description ?? ``, l()),
                arrowheadStyle: A,
                labelpos: j,
                labelType: M,
                thickness: N,
...
r(J, `insertOrUpdateNode`);
function Y(e) {
  return e?.classes?.join(` `) ?? ``;
}
r(Y, `getClassesFromDbInfo`);
function he(e) {
  return e?.styles ?? [];
}
r(he, `getStylesFromDbInfo`);
var X = r((e, t, r, i, a, o, s, c) => {
    let d = t.id,
      f = r.get(d),
      p = Y(f),
      m = he(f),
      h = l();
    if ((n.info(`dataFetcher parsedItem`, t, f, m), d !== `root`)) {
      let r = P;
      (t.start === !0 ? (r = ee) : t.start === !1 && (r = te),
        t.type !== D && (r = t.type),
        W.get(d) ||
          W.set(d, {
            id: d,
            shape: r,
            description: u.sanitizeText(d, h),
            cssClasses: `${p} ${ie}`,
            cssStyles: m,
          }));
      let l = W.get(d);
      (t.description &&
        (Array.isArray(l.description)
          ? ((l.shape = F), l.description.push(t.description))
          : l.description?.length && l.description.length > 0
            ? ((l.shape = F),
              l.description === d
                ? (l.description = [t.description])
                : (l.description = [l.description, t.description]))
            : ((l.shape = P), (l.description = t.description)),
        (l.description = u.sanitizeTextOrArray(l.description, h))),
        l.description?.length === 1 &&
          l.shape === F &&
          (l.type === `group` ? (l.shape = L) : (l.shape = P)),
        !l.type &&
          t.doc &&
          (n.info(`Setting cluster for XCX`, d, q(t)),
          (l.type = `group`),
          (l.isGroup = !0),
          (l.dir = q(t)),
          (l.shape = t.type === O ? I : L),
          (l.cssClasses = `${l.cssClasses} ${le} ${o ? ue : ``}`)));
      let f = {
        labelStyle: ``,
        shape: l.shape,
        label: l.description,
      ...
      if (
        ...
        e &&
          e.id !== `root` &&
          (n.trace(`Setting node `, d, ` to be child of its parent `, e.id),
          (f.parentId = e.id)),
        (f.centerLabel = !0),
        t.note)
      ) {
        ...
        let o = d,
          u = e.id;
        (t.note.position === `left of` && ((o = e.id), (u = d)),
          a.push({
            id: o + `-` + u,
            start: o,
            end: u,
    ...
    t.doc &&
      (n.trace(`Adding nodes children `), me(t, t.doc, r, i, a, !o, s, c));
  }, `dataFetcher`),
  ge = r(() => {
    (W.clear(), (G = 0));
  }, `reset`),
  ...
  _e = r(() => new Map(), `newClassesList`),
  Q = r(() => ({ relations: [], states: new Map(), documents: {} }), `newDoc`),
  $ = r((e) => JSON.parse(JSON.stringify(e)), `clone`),
  ve = class {
    constructor(e) {
      ((this.version = e),
        (this.nodes = []),
    ...
    docTranslator(e, n, r) {
      if (n.stmt === C) {
        (this.docTranslator(e, n.state1, !0),
          this.docTranslator(e, n.state2, !1));
        return;
      }
      if (
        (n.stmt === x &&
          (n.id === Z.START_NODE
            ? ((n.id = e.id + (r ? `_start` : `_end`)), (n.start = r))
            : (n.id = n.id.trim())),
        (n.stmt !== S && n.stmt !== x) || !n.doc)
      )
        return;
      let i = [],
        a = [];
      ...
      if (i.length > 0 && a.length > 0) {
        let e = { stmt: x, id: t(), type: `divider`, doc: $(a) };
        (i.push($(e)), (n.doc = i));
      }
    ...
    addState(
      ...
      if (
        (i &&
          (n.info(`Setting state description`, d, i),
        ...
        let e = this.currentDocument.states.get(d);
        if (!e) throw Error(`State not found: ${d}`);
        ((e.note = a), (e.note.text = u.sanitizeText(e.note.text, l())));
      }
      (o &&
        (n.info(`Setting state classes`, d, o),
        (Array.isArray(o) ? o : [o]).forEach((e) =>
          this.setCssClass(d, e.trim()),
        )),
        s &&
          (n.info(`Setting state styles`, d, s),
    ...
    addLink(e, t, r) {
      (this.links.set(e, { url: t, tooltip: r }),
    ...
    addRelationObjs(e, t, n = ``) {
      ...
      (this.addState(
        ...
        this.currentDocument.relations.push({
          id1: r,
          id2: a,
          relationTitle: u.sanitizeText(n, l()),
        }));
    }
    addRelation(e, t, n) {
      if (typeof e == `object` && typeof t == `object`)
        ...
        (this.addState(r, i),
          ...
          this.currentDocument.relations.push({
            id1: r,
            id2: a,
            relationTitle: n ? u.sanitizeText(n, l()) : void 0,
          }));
      }
    }
    addDescription(e, t) {
      ...
      n?.descriptions?.push(u.sanitizeText(r, l()));
    }
    cleanupLabel(e) {
...
//# sourceMappingURL=chunk-DI55MBZ5-CPTydVPj.js.map
