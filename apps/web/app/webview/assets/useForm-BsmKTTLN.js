...
var ue = b(
    (e) => S.emit(`form-state`, { id: e.formId, state: e.store.state }),
    { wait: 300 },
  ),
  L = (e) => {
    ...
    ((this.options = {}),
        ...
        let e = this.fieldMetaDerived.mount(),
          ...
          o = () => {
            (a(),
              ...
              e(),
              t(),
              S.emit(`form-unmounted`, { id: this._formId }));
          };
      ...
      (this.update = (e) => {
        ...
        let n = !!e.transform?.deps?.some(
          ...
          r =
            e.defaultValues &&
            !M(e.defaultValues, t.defaultValues) &&
        ...
        return (
          h(() => {
            for (let e of t) {
              ...
              for (let e of o) {
                if (this.baseStore.state.fieldMetaBase[e] === void 0 && !i?.[e])
                  continue;
                let { errorMap: t, errorSourceMap: n } =
                    this.getFieldMeta(e) ?? V,
                  o = i?.[e],
    ...
    ((this.options = {}),
      ...
      (this.setValue = (e, t) => {
        (this.form.setFieldValue(
          this.name,
          e,
          N(t, { dontRunListeners: !0, dontValidate: !0 }),
        ),
          ...
          let e = (e, n) => {
            let r = Y(n.cause),
              a = n.validate
                ...
                : void 0,
              o = t[r],
              { newErrorValue: s, newSource: c } = ce({
                formLevelError: o,
                fieldLevelError: a,
              });
...
var ye = ({ children: e, ...t }) => {
  ...
  return (0, $.jsx)($.Fragment, {
    children: (0, Z.useMemo)(() => C(e, n), [e, n]),
  });
};
function be() {
...
export { Ce as t };
//# sourceMappingURL=useForm-BsmKTTLN.js.map
