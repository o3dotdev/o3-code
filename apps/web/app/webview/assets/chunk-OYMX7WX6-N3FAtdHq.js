...
import { h as d, o as f } from "./chunk-5PVQY5BW-CnaqcI9r.js";
import { t as p } from "./chunk-55IACEB6-D64Uo90h.js";
import { t as m } from "./chunk-EDXVE4YY-Dvoshwbp.js";
import { r as h } from "./chunk-336JU56O-CDWwHIND.js";
var g = (function () {
...
var _ = g,
  ...
  pe = {
    getClasses: e(function (e, t) {
      return t.db.getClasses();
    }, `getClasses`),
    draw: e(async function (e, n, r, i) {
      ...
      ((l.type = i.type),
        ...
        c().look === `neo` ? (l.markers = [`barbNeo`]) : (l.markers = [`barb`]),
        (l.diagramId = n),
        await h(l, u));
      try {
    ...
    (t.trace(`items`, n),
      n.forEach((t) => {
        switch (t.stmt) {
          ...
          case C:
            {
              (X(e, t.state1, r, i, a, o, s, u),
                X(e, t.state2, r, i, a, o, s, u));
              let n = s === `neo`,
                d = {
                  id: `edge` + G,
                  start: t.state1.id,
                  ...
                  style: k,
                  labelStyle: ``,
                  label: l.sanitizeText(t.description ?? ``, c()),
                  arrowheadStyle: A,
                  labelpos: j,
                  labelType: M,
                  thickness: N,
...
var X = e((e, n, r, i, a, o, s, u) => {
    ...
    if ((t.info(`dataFetcher parsedItem`, n, f, m), d !== `root`)) {
      ...
      (n.description &&
        (Array.isArray(c.description)
          ? ((c.shape = F), c.description.push(n.description))
          : c.description?.length && c.description.length > 0
            ? ((c.shape = F),
              c.description === d
                ? (c.description = [n.description])
                : (c.description = [c.description, n.description]))
            : ((c.shape = P), (c.description = n.description)),
        (c.description = l.sanitizeTextOrArray(c.description, h))),
        c.description?.length === 1 &&
          c.shape === F &&
          (c.type === `group` ? (c.shape = L) : (c.shape = P)),
        !c.type &&
          n.doc &&
          (t.info(`Setting cluster for XCX`, d, q(n)),
          (c.type = `group`),
          (c.isGroup = !0),
          (c.dir = q(n)),
          (c.shape = n.type === O ? I : L),
          (c.cssClasses = `${c.cssClasses} ${le} ${o ? ue : ``}`)));
      let f = {
        labelStyle: ``,
        shape: c.shape,
        label: c.description,
      ...
      if (
        ...
        e &&
          e.id !== `root` &&
          (t.trace(`Setting node `, d, ` to be child of its parent `, e.id),
          (f.parentId = e.id)),
        (f.centerLabel = !0),
        n.note)
      ) {
        ...
        let o = d,
          l = e.id;
        (n.note.position === `left of` && ((o = e.id), (l = d)),
          a.push({
            id: o + `-` + l,
            start: o,
            end: l,
    ...
    n.doc &&
      (t.trace(`Adding nodes children `), me(n, n.doc, r, i, a, !o, s, u));
  }, `dataFetcher`),
  ge = e(() => {
    (W.clear(), (G = 0));
  }, `reset`),
  ...
  _e = e(() => new Map(), `newClassesList`),
  Q = e(() => ({ relations: [], states: new Map(), documents: {} }), `newDoc`),
  $ = e((e) => JSON.parse(JSON.stringify(e)), `clone`),
  ve = class {
    constructor(e) {
      ((this.version = e),
        (this.nodes = []),
    ...
    addState(
      ...
      if (
        (i &&
          (t.info(`Setting state description`, d, i),
      ...
      (o &&
        (t.info(`Setting state classes`, d, o),
        (Array.isArray(o) ? o : [o]).forEach((e) =>
          this.setCssClass(d, e.trim()),
        )),
        s &&
          (t.info(`Setting state styles`, d, s),
