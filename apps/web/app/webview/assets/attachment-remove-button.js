...
import { Q as n, S as r, nt as i, xt as a } from "./setting-storage.js";
import { t as o } from "./x.js";
var s = 20,
  c = i(r, []),
  l = n(r, (e, { signal: t }) => t(null), { key: d });
function u(e, t, n, r) {
  ...
  e.set(a, r);
  let o = d(i),
    u = [...e.get(c).filter((e) => d(e) !== o), i],
    f = u.slice(0, Math.max(0, u.length - s));
  for (let t of f) e.set(e.get(l, t), null);
  e.set(c, u.slice(f.length));
}
function d(e) {
...
//# sourceMappingURL=attachment-remove-button.js.map
