...
import { B as n, H as r, xt as i } from "./setting-storage-kJblH-wH.js";
import { t as a } from "./button-BynxeNRW.js";
import { p as o } from "./links-BkSjb4EC.js";
...
function f(e) {
  ...
  n[7] === o
    ? (m = n[8])
    : ((m = t(`w-[240px] justify-between`, o)), (n[7] = o), (n[8] = m));
  let h;
  n[9] === c
    ? (h = n[10])
    : ((h = t(`flex min-w-0 flex-1 items-center gap-1.5`, c)),
      (n[9] = c),
      (n[10] = h));
  let g;
  n[11] !== i || n[12] !== h
  ...
  n[16] === _
    ? (v = n[17])
    : ((v = (0, d.jsx)(s, { className: _ })), (n[16] = _), (n[17] = v));
  let y;
  return (
...
//# sourceMappingURL=settings-shared-buyehiMO.js.map
