...
import { t as a } from "./jsx-runtime.js";
import { U as o, wt as s } from "./setting-storage.js";
import { t as c } from "./use-stable-callback.js";
import { r as l } from "./right-panel-composer-overlay-scroll-reserve.js";
...
function x(e) {
  ...
  n[26] === g
    ? (K = n[27])
    : ((K = g ? { paddingBottom: l } : void 0), (n[26] = g), (n[27] = K));
  let q;
  n[28] !== V ||
  n[29] !== L ||
  n[30] !== F ||
...
//# sourceMappingURL=pull-request-code-review-comments-qcxIGUtE.js.map
