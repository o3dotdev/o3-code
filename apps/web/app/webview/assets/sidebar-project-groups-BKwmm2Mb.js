...
import { Bn as n, N as r, Rt as i } from "./src-BLHmAhbF.js";
import {
  Ta as a,
  Zo as o,
  ga as s,
} from "./app-server-manager-signals-7MlBpIlX.js";
import { C as c } from "./setting-storage-kJblH-wH.js";
import { n as l } from "./_baseOrderBy-H105Hl5V.js";
import { n as u } from "./parse-owner-repo-Bz9xN8qO.js";
import { t as d } from "./remote-projects-T90XwaVV.js";
import { t as f } from "./uniq-ckcXPYOW.js";
import { t as p } from "./_defineProperty-pXG_Oy_k.js";
var m = t((e, t) => {
    function n(e) {
  ...
  return (e?.roots ?? []).map((o) => {
    let s = n(o),
      ...
      l =
        ...
        ``,
      d = a[s] ?? void 0,
      f = d?.originUrl ? u(d.originUrl) : null;
    return d && k(d)
      ? {
          projectId: o,
          projectKind: `local`,
          ...
          repositoryData: {
            ownerRepo: f,
            repoPath: P(o, t).join(`/`),
            rootFolder: (0, S.default)(F(d.root)) ?? ``,
          },
          isCodexWorktree: c,
          threadKeys: [],
        }
...
function j(e, t, r, i, a, o) {
  let s = (0, b.default)(
    ...
    l = new Map();
  for (let e of r) e.projectKind === `local` && l.set(n(e.path), e);
  return (
    e.forEach((e) => {
      if (e.kind === `local`)
        R(e, r, l, i, o?.gitOriginsByHostId, a, o?.primaryHostId, o);
      else if (e.kind === `remote`) {
        let t = z(o?.threadProjectAssignments?.[e.task.id], r);
        if (t != null) {
        ...
        q(e, c, r);
      } else e.kind === `pending-worktree` && K(e, s, r, l);
    }),
    r
  );
}
...
var R = (e, t, n, i, o, s, l = a, u) => {
  let f = e.cwd;
  if (!f || !F(f).length) {
    c.warning(`No cwd found for local task`, {
  ...
  if (
    _ &&
    ((u?.enabledRemoteHostIds && !u.enabledRemoteHostIds.has(m)) ||
      !v?.some((e) => e.hostId === m))
  )
    return;
  let y = H({
    gitOrigins: i,
    gitOriginsByHostId: o,
    hostId: m ?? void 0,
    primaryHostId: l,
  });
  if (r(f, s) || (_ && U(f, y))) {
    let r = W(f, e.conversationId, t, n, y, u?.threadWorkspaceRootHints);
    r && (p = r);
  }
  let b = v == null ? null : d(v, m ?? void 0, p);
  if (b != null) {
...
function B(e, t, n, r) {
  ...
  return Array.from(a.entries())
    .map(([e, t]) => ({
      hostId: e,
      dirs: (0, C.default)(t).sort((e, t) => e.localeCompare(t)),
    }))
...
function V(e, t) {
  ...
  return e
    .map(({ hostId: e, dirs: t }) => ({
      hostId: e,
      dirs: t.filter((t) => !r.get(e)?.has(n(t))),
    }))
...
function U(e, t) {
  let r = N(e, t ?? []);
  return r?.commonDir
    ? n(r.commonDir).replace(/\/+$/, ``) !==
        `${n(r.root).replace(/\/+$/, ``)}/.git`
    : !1;
}
function W(e, t, r, i, a, o) {
  if (L(i, e)) return null;
  let s = o?.[t],
    c = s ? I(i, s) : null;
  ...
  let f = (e) =>
    ...
    h = r.filter((e) => {
      let t = n(e.path);
      if (e.isCodexWorktree && p !== t) return !1;
      let r = N(e.path, a);
      return r != null && f(r);
    }),
    g = h.filter((e) => e.repositoryData?.repoPath === m),
    _ = (0, S.default)(F(l.root)) ?? ``,
    v = G(g, _);
  if (v) return v.path;
  let y = g[0];
  if (y) return y.path;
...
function K(e, t, r, i) {
  ...
  if (!o) {
    c.warning(`No original clone cwd found for pending worktree task`, {
  ...
  l &&
    ((s &&
      l.repositoryData?.ownerRepo != null &&
      !M(l.repositoryData.ownerRepo, s)) ||
...
function q(e, t, n) {
  let r = Y(e, t),
    i = X(r);
  if (!i) {
    c.warning(`No owner repo found for remote task`, {
  ...
  (
    n.find(
      (e) =>
        M(e.repositoryData?.ownerRepo, i) &&
        e.repositoryData?.repoPath === `` &&
        e.repositoryData?.rootFolder?.toLowerCase() === a,
    ) ??
    null ??
    n.find((e) => M(e.repositoryData?.ownerRepo, i)) ??
    J(i, r, n)
...
//# sourceMappingURL=sidebar-project-groups-BKwmm2Mb.js.map
