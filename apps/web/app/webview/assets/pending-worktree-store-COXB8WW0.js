...
import { fo as t, po as n } from "./app-server-manager-signals-DkRDRgNB.js";
import { n as r } from "./jsx-runtime.js";
import { t as i } from "./v4.js";
import { wt as a, y as o } from "./setting-storage.js";
var s = e(r(), 1),
  c = new Set(),
  l = new Map(),
  u = [];
...
function f() {
  return {
    ...
    beginPendingWorktreeConversationStart: (e) =>
      l.get(e)?.state === `waiting`
        ? (l.set(e, { state: `starting` }), g(), !0)
        : !1,
...
function b(e) {
  let t = e.lastIndexOf(`:`);
  return t <= 0 || t === e.length - 1 ? n : e.slice(0, t);
}
function x() {
  let [e] = t(`pending_worktrees`);
  return e ?? v;
}
function S(e) {
  let n = (0, _.c)(3),
    [r] = t(`pending_worktrees`);
  if (!e) return null;
  if (r === void 0) return;
  let i;
  return (
    n[0] !== e || n[1] !== r
      ? ((i = r.find((t) => t.id === e) ?? null),
        (n[0] = e),
        (n[1] = r),
        (n[2] = i))
      : (i = n[2]),
...
function C() {
  let e = (0, _.c)(33),
    [, n] = t(`pending_worktrees`),
    {
      removePendingWorktreeConversationStart: r,
      retryPendingWorktreeConversationStart: i,
    } = f(),
    a;
  e[0] === n
    ? (a = e[1])
    : ((a = (e) => {
        ...
        return window.electronBridge == null
          ? (r.launchMode !== `create-stable-worktree` && p(t),
            n((e) => [...(e === void 0 ? [] : e), r]),
            t)
          : E(t, e);
      }),
    ...
    : ((c = (e, t) => {
        if (t.length !== 0) {
          if (window.electronBridge == null) {
            n((n) =>
              (n === void 0 ? [] : n).map((n) => (n.id === e ? O(n, t) : n)),
            );
            return;
          }
          t.forEach((t) => {
            o.dispatchMessage(`pending-worktree-update-metadata`, {
              hostId: b(e),
              id: e,
              update: t,
            });
  ...
  e[12] !== i || e[13] !== n
    ? ((C = (e) => {
        ...
        o.dispatchMessage(`pending-worktree-retry`, { hostId: b(e), id: e });
      }),
      (e[12] = i),
      (e[13] = n),
      (e[14] = C))
  ...
  e[15] === n
    ...
    : ((D = (e) => {
        ...
        o.dispatchMessage(`pending-worktree-continue`, { hostId: b(e), id: e });
      }),
      (e[15] = n),
      (e[16] = D));
  let k = D,
  ...
  e[17] !== r || e[18] !== n
    ? ((A = (e) => {
        ...
        o.dispatchMessage(`pending-worktree-cancel`, { hostId: b(e), id: e });
      }),
      (e[17] = r),
      (e[18] = n),
      (e[19] = A))
  ...
  e[20] !== r || e[21] !== n
    ? ((M = (e) => {
        ...
        o.dispatchMessage(`pending-worktree-dismiss`, { hostId: b(e), id: e });
      }),
      (e[20] = r),
      (e[21] = n),
      (e[22] = M))
...
function E(e, t) {
  ...
  return (
    ...
    o.dispatchMessage(`pending-worktree-create`, {
      hostId: t.hostId,
      request: D(e, t),
    }),
    e
...
//# sourceMappingURL=pending-worktree-store-COXB8WW0.js.map
