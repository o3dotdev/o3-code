import { C as e, c as t, h as n, i as r } from "./chunk-S3R3BYOJ-5zDRn6nL.js";
import { t as i } from "./clone-DgntaiN2.js";
import { t as a } from "./graphlib-BZvYK9y8.js";
import { i as o, r as s, t as c } from "./src-DXdm7MTq.js";
import { t as l } from "./line-D1C4qLvz.js";
import {
  E as u,
  I as d,
  a as f,
...
import { t as y } from "./channel-BnFhepYz.js";
import "./dist-Dkaf81wL.js";
import { a as b, n as x } from "./chunk-JA3XYJ7Z-_sm1v70d.js";
import "./marked.esm-B1dI5d9h.js";
import { t as S } from "./chunk-FMBD7UC4-rrmk1FZY.js";
import { t as C } from "./chunk-HN2XXSSU-BAQ0kSeo.js";
import { t as w } from "./chunk-CVBHYZKI-B0vHREv4.js";
var T = (function () {
  ...
  oe = s((e, t) => {
    ...
    for (let e of n) {
      ...
      if (e.type === `applyClass`) {
        ae(e.id, e?.styleClass ?? ``);
        continue;
      }
      if (e.type === `applyStyles`) {
        e?.stylesStr && ie(e.id, e?.stylesStr);
        continue;
      }
      if (e.type === `column-setting`) t.columns = e.columns ?? -1;
      else if (e.type === `edge`) {
        let t = (k.get(e.id) ?? 0) + 1;
        (k.set(e.id, t), (e.id = t + `-` + e.id), O.push(e));
      } else {
...
var ve = s((e) => {
  ...
  for (let r of e.children) {
    ...
    (o.debug(
      ...
      r.type !== `space` &&
        (i > t && (t = i / (e.widthInColumns ?? 1)), a > n && (n = a)));
  }
  ...
  if (e.children?.length > 0) {
    ...
    for (let t of e.children)
      t.size &&
        ...
        (t.size.width =
          i * (t.widthInColumns ?? 1) + L * ((t.widthInColumns ?? 1) - 1)),
        (t.size.height = a),
        (t.size.x = 0),
        (t.size.y = 0),
        o.debug(
  ...
  we = s(async (e, t) => {
    ...
    if (t.startLabelLeft) {
      ...
      (i.attr(
        ...
        W[t.id] || (W[t.id] = {}),
        (W[t.id].startLeft = r),
        G(l, t.startLabelLeft));
    }
    if (t.startLabelRight) {
      let n = await H(t.startLabelRight, t.labelStyle),
        r = e.insert(`g`).attr(`class`, `edgeTerminals`),
        i = r.insert(`g`).attr(`class`, `inner`);
      ((l = r.node().appendChild(n)), i.node().appendChild(n));
      let a = n.getBBox();
      (i.attr(
        `transform`,
        `translate(` + -a.width / 2 + `, ` + -a.height / 2 + `)`,
...
var at = s(async (e, t) => {
    ...
    return (
      ...
      s.attr(
        `transform`,
        `translate(` + -f.width / 2 + `, ` + (-f.height / 2 - v + 3) + `)`,
      ),
      i
  ...
  ft = {
    ...
    class_box: s(async (e, t) => {
      ...
      t.classData.annotations[0] && ((u += v.height + 4), (l += v.width));
      ...
      ((u += x.height + 4), x.width > l && (l = x.width));
      let S = [];
...
//# sourceMappingURL=blockDiagram-VD42YOAC-DyAFhk6D.js.map
