...
function B(e, t) {
  if (t) {
    ...
    return e.replace(a.escapeReplaceNoEncode, z);
  return e;
}
function V(e) {
  try {
    ...
    parseMarkdown(e) {
      return (t, n) => {
        ...
        if ((i.hooks && ((i.hooks.options = i), (i.hooks.block = e)), i.async))
          return (async () => {
            let n = i.hooks ? await i.hooks.preprocess(t) : t,
              r = await (
                i.hooks ? await i.hooks.provideLexer() : e ? K.lex : K.lexInline
              )(n, i),
        ...
        try {
          ...
          let n = (i.hooks ? i.hooks.provideLexer() : e ? K.lex : K.lexInline)(
            t,
            i,
          );
          ...
          let r = (
            i.hooks ? i.hooks.provideParser() : e ? Y.parse : Y.parseInline
          )(n, i);
...
(($.options = $.setOptions =
  ...
  K.lex);
export { $ as n, Z as t };
//# sourceMappingURL=marked.esm-B1dI5d9h.js.map
