var e = `Codex Light`,
  ...
  r = [
    ...
    { scope: `support.function.console`, settings: { foreground: `#751ED9` } },
    {
      scope: [
        `support.type`,
        `entity.name.type`,
    ...
    { scope: `keyword.operator.ternary`, settings: { foreground: `#D53538` } },
    { scope: `keyword.operator.optional`, settings: { foreground: `#D53538` } },
    ...
    { scope: `meta.template.expression`, settings: { foreground: `#666666` } },
    {
    ...
    { scope: `punctuation.quasi.element`, settings: { foreground: `#D53538` } },
    {
      scope: [
    ...
    { scope: `support.function.std.rust`, settings: { foreground: `#751ED9` } },
    { scope: `entity.name.lifetime.rust`, settings: { foreground: `#BD5800` } },
    ...
    { scope: `keyword.operator.type.php`, settings: { foreground: `#D53538` } },
    {
      scope: [
    ...
    { scope: `variable.other.class.php`, settings: { foreground: `#D53538` } },
    {
    ...
    { scope: `support.type.prelude.elm`, settings: { foreground: `#0071EA` } },
    ...
    { scope: `constant.keyword.clojure`, settings: { foreground: `#0071EA` } },
    {
    ...
    { scope: `constant.character.entity`, settings: { foreground: `#D53538` } },
    ...
    { scope: `constant.character.escape`, settings: { foreground: `#0071EA` } },
    {
  ...
  a = { name: e, type: t, colors: n, tokenColors: r, semanticTokenColors: i };
export {
  n as colors,
  a as default,
  e as name,
...
//# sourceMappingURL=codex-light-RXUhRfZO.js.map
