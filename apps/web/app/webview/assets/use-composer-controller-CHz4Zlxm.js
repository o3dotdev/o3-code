...
import { xt as n } from "./setting-storage-kJblH-wH.js";
function r(e) {
  this.content = e;
}
((r.prototype = {
  ...
  update: function (e, t, n) {
    var i = n && n != e ? this.remove(n) : this,
      ...
      o = i.content.slice();
    return (
      a == -1 ? o.push(n || e, t) : ((o[a + 1] = t), n && (o[a] = n)),
      new r(o)
    );
  },
  remove: function (e) {
  ...
  addBefore: function (e, t, n) {
    var i = this.remove(t),
      a = i.content.slice(),
      o = i.find(e);
    return (a.splice(o == -1 ? a.length : o, 0, t, n), new r(a));
  },
  forEach: function (e) {
    for (var t = 0; t < this.content.length; t += 2)
  ...
  prepend: function (e) {
    return (
      (e = r.from(e)),
      e.size ? new r(e.content.concat(this.subtract(e).content)) : this
    );
  },
  append: function (e) {
    return (
      (e = r.from(e)),
      e.size ? new r(this.subtract(e).content.concat(e.content)) : this
    );
  },
  subtract: function (e) {
    var t = this;
...
function a(e, t, n, r) {
  for (let i = e.childCount, o = t.childCount; ; ) {
    ...
    if (!s.sameMarkup(c)) return { a: n, b: r };
    if (s.isText && s.text != c.text) {
      let e = 0,
        t = Math.min(s.text.length, c.text.length);
      for (
        ;
        e < t && s.text[s.text.length - e - 1] == c.text[c.text.length - e - 1];
      )
        (e++, n--, r--);
      return { a: n, b: r };
    }
    if (s.content.size || c.content.size) {
      let e = a(s.content, c.content, n - 1, r - 1);
      if (e) return e;
    }
    ((n -= l), (r -= l));
  }
...
var o = class e {
  ...
  findIndex(e) {
    ...
    for (let t = 0, n = 0; ; t++) {
      let r = this.child(t),
        i = n + r.nodeSize;
      if (i >= e) return i == e ? c(t + 1, i) : c(t, n);
      n = i;
    }
  }
  toString() {
...
var d = class extends Error {},
  f = class e {
    ...
    insertAt(t, n) {
      let r = m(this.content, t + this.openStart, n);
      return r && new e(r, this.openStart, this.openEnd);
    }
    removeBetween(t, n) {
      return new e(
        p(this.content, t + this.openStart, n + this.openStart),
        this.openStart,
        this.openEnd,
      );
    }
...
function p(e, t, n) {
  ...
  return e.replaceChild(r, a.copy(p(a.content, t - i - 1, n - i - 1)));
}
function m(e, t, n, r) {
...
function ee(e, t, n, r) {
  ...
  if (i == t.index(r) && r < e.depth - n.openStart) {
    ...
    return v(a, re(e, i, o, t, r));
  }
}
function te(e, t) {
  if (!t.type.compatibleContent(e.type))
    throw new d(`Cannot join ` + t.type.name + ` onto ` + e.type.name);
}
function ne(e, t, n) {
  let r = e.node(n);
...
function _(e, t, n, r) {
  ...
  e &&
    ((a = e.index(n)),
    e.depth > n ? a++ : e.textOffset && (g(e.nodeAfter, r), a++));
...
function re(e, t, n, r, i) {
  let a = e.depth > i && ne(e, t, i + 1),
    s = r.depth > i && ne(n, r, i + 1),
    c = [];
  return (
    _(null, e, i, c),
    a && s && t.index(i) == n.index(i)
      ? (te(a, s), g(v(a, re(e, t, n, r, i + 1)), c))
      : (a && g(v(a, y(e, t, i + 1)), c),
        _(t, n, i, c),
        s && g(v(s, y(n, r, i + 1)), c)),
    _(r, null, i, c),
...
function y(e, t, n) {
  ...
  return (
    _(null, e, n, r),
    e.depth > n && g(v(ne(e, t, n + 1), y(e, t, n + 1)), r),
    _(t, null, n, r),
    new o(r)
  );
}
...
var ae = class e {
  ...
  b = class e {
    ...
    hasMarkup(e, t, n) {
      return (
        this.type == e &&
        l(this.attrs, t || e.defaultAttrs || ue) &&
    ...
    replace(e, t, n) {
      return h(this.resolve(e), this.resolve(t), n);
    }
    nodeAt(e) {
      for (let t = this; ; ) {
    ...
    resolve(e) {
      return ae.resolveCached(this, e);
    }
    resolveNoCache(e) {
      return ae.resolve(this, e);
    }
    rangeHasMark(e, t, n) {
      let r = !1;
      return (
...
var de = class e extends b {
  ...
  toString() {
    return this.type.spec.toDebugString
      ...
      : fe(this.marks, JSON.stringify(this.text));
  }
  get textContent() {
    return this.text;
  }
...
var x = class e {
  ...
  fillBefore(e, t = !1, n = 0) {
    let r = [this];
    function i(a, s) {
      let c = a.matchFragment(e, n);
      if (c && (!t || c.validEnd))
        return o.from(s.map((e) => e.createAndFill()));
...
var Ae = class e {
  constructor(e, t, n) {
    ((this.name = e),
      ...
      (this.attrs = ke(e, n.attrs)),
      (this.defaultAttrs = Ee(this.attrs)),
  ...
  create(e = null, t, n) {
    ...
    return new b(this, this.computeAttrs(e), o.from(t), u.setFrom(n));
  }
  createChecked(e = null, t, n) {
    return (
      (t = o.from(t)),
      this.checkContent(t),
      new b(this, this.computeAttrs(e), t, u.setFrom(n))
    );
  }
  createAndFill(e = null, t, n) {
    ...
    let r = this.contentMatch.matchFragment(t),
      i = r && r.fillBefore(o.empty, !0);
    return i ? new b(this, e, t.append(i), u.setFrom(n)) : null;
  }
  validContent(e) {
...
var Me = class {
    constructor(e, t, n) {
      ((this.hasDefault = Object.prototype.hasOwnProperty.call(n, `default`)),
        ...
        (this.validate =
          typeof n.validate == `string` ? je(e, t, n.validate) : n.validate));
    }
    get isRequired() {
  ...
  Pe = class {
    constructor(e) {
      ...
      ((t.nodes = r.from(e.nodes)),
        ...
        (this.nodes = Ae.compile(this.spec.nodes, this)),
        (this.marks = Ne.compile(this.spec.marks, this)));
      let n = Object.create(null);
      for (let e in this.nodes) {
        ...
        let t = this.nodes[e],
          ...
          i = t.spec.marks;
        if (
          ((t.contentMatch = n[r] || (n[r] = x.parse(r, this.nodes))),
      ...
      ((this.nodeFromJSON = (e) => b.fromJSON(this, e)),
        (this.markFromJSON = (e) => u.fromJSON(this, e)),
    ...
    text(e, t) {
      ...
      return new de(n, n.defaultAttrs, e, u.setFrom(t));
    }
    mark(e, t) {
...
var Re = class e {
    ...
    parse(e, t = {}) {
      ...
      return (n.addAll(e, u.none, t.from, t.to), n.finish());
    }
    parseSlice(e, t = {}) {
      let n = new Ue(this, t, !0);
      return (n.addAll(e, u.none, t.from, t.to), f.maxOpen(n.finish()));
    }
    matchTag(e, t, n) {
      for (
  ...
  Be = { head: !0, noscript: !0, object: !0, script: !0, style: !0, title: !0 },
  Ve = { ol: !0, ul: !0 },
  S = 1,
  C = 2,
  w = 4;
...
var T = class {
    ...
    finish(e) {
      ...
      return (
        !e && this.match && (t = t.append(this.match.fillBefore(o.empty, !0))),
  ...
  Ue = class {
    constructor(e, t, n) {
      ...
      let r = t.topNode,
        i,
        a = He(null, t.preserveWhitespace, 0) | (n ? w : 0);
      ((i = r
        ? new T(
            r.type,
            r.attrs,
        ...
        : n
          ? new T(null, null, u.none, !0, null, a)
          : new T(e.schema.topNodeType, null, u.none, !0, null, a)),
        (this.nodes = [i]),
    ...
    addTextNode(e, t) {
      let n = e.nodeValue,
        r = this.top,
        i =
          r.options & C ? `full` : this.localPreserveWS || (r.options & S) > 0,
...
`,
    ...
    addElement(e, t, n) {
      ...
      let a = e.nodeName.toLowerCase(),
        o;
      Ve.hasOwnProperty(a) && this.parser.normalizeLists && We(e);
      let s =
        (this.options.ruleFromNode && this.options.ruleFromNode(e)) ||
        (o = this.parser.matchTag(e, this, n));
      out: if (s ? s.ignore : Be.hasOwnProperty(a))
...
`),
    ...
    insertNode(e, t, n) {
      ...
      if (r) {
        ...
        for (let i of r.concat(e.marks))
          (t.type ? t.type.allowsMarkType(i.type) : qe(i.type, e.type)) &&
            (n = i.addToSet(n));
    ...
    enterInner(e, t, n, r = !1, i) {
      ...
      return (
        (n = n.filter((t) =>
          (a.type ? a.type.allowsMarkType(t.type) : qe(t.type, e))
            ? ((s = t.addToSet(s)), !1)
            : !0,
        )),
        this.nodes.push(new T(e, t, s, r, null, o)),
        this.open++,
        n
      );
    }
...
function Ze(e) {
  let t = Xe.get(e);
  return (t === void 0 && Xe.set(e, (t = Qe(e))), t);
}
function Qe(e) {
  let t = null;
  function n(e) {
...
var it = 1,
  ...
  k = class {
    ...
    get deletedBefore() {
      return (this.delInfo & (it | O)) > 0;
    }
    get deletedAfter() {
      return (this.delInfo & (at | O)) > 0;
    }
    get deletedAcross() {
      ...
      for (let o = 0; o < this.ranges.length; o += 3) {
        ...
        if (e <= u) {
          let i = c ? (e == s ? -1 : e == u ? 1 : t) : t,
            a = s + r + (i < 0 ? 0 : l);
          if (n) return a;
          let d = e == (t < 0 ? s : u) ? null : tt(o / 3, e - s),
            f = e == s ? at : e == u ? it : O;
          return ((t < 0 ? e != s : e != u) && (f |= ot), new k(a, f, d));
        }
        r += l - c;
      }
...
function P(e, t, n) {
  ...
  for (let i = 0; i < e.childCount; i++) {
    let a = e.child(i);
    (a.content.size && (a = a.copy(P(a.content, t, a))),
...
var L = class e extends M {
  ...
  apply(e) {
    ...
    return N.fromReplace(
      e,
      this.pos,
      this.pos + 1,
      new f(o.from(n), 0, t.isLeaf ? 0 : 1),
    );
  }
  invert(t) {
...
var B = class e extends M {
  ...
  apply(e) {
    ...
    return n
      ? N.fromReplace(e, this.from, this.to, n)
      : N.fail(`Content does not fit in gap`);
  }
  getMap() {
    return new A([
      this.from,
...
function ut(e, t, n, r = n.contentMatch, i = !0) {
  ...
  for (let t = 0; t < a.childCount; t++) {
    ...
    if (!d) s.push(new z(c, u, f.empty));
    else {
      r = d;
      for (let t = 0; t < l.marks.length; t++)
        n.allowsMarkType(l.marks[t].type) || e.step(new I(c, u, l.marks[t]));
      if (i && l.isText && n.whitespace != `pre`) {
        ...
        for (; (e = t.exec(l.text)); )
          ((r ||= new f(
            o.from(n.schema.text(` `, n.allowedMarks(l.marks))),
            0,
            0,
          )),
            s.push(new z(c + e.index, c + e.index + e[0].length, r)));
      }
    }
    c = u;
  }
...
function dt(e, t, n) {
  ...
  for (let e = a, t = !1; e > n; e--)
    t || r.index(e) > 0
      ? ((t = !0), (d = o.from(r.node(e).copy(d))), p++)
      : l--;
  let m = o.empty,
    h = 0;
  for (let e = a, t = !1; e > n; e--)
    t || i.after(e + 1) < i.end(e)
      ? ((t = !0), (m = o.from(i.node(e).copy(m))), h++)
      : u++;
  e.step(new B(l, u, s, c, new f(d.append(m), p, h), d.size - p, !0));
}
function ft(e, t, n) {
  let r = o.empty;
  ...
  let i = t.start,
    a = t.end;
  e.step(new B(i, a, i, a, new f(r, 0, 0), n.length, !0));
}
function pt(e, t, n, r, i) {
  ...
  e.doc.nodesBetween(t, n, (t, n) => {
    ...
    if (
      t.isTextblock &&
      !t.hasMarkup(r, s) &&
      gt(e.doc, e.mapping.slice(a).map(n), r)
    ) {
      let i = null;
      ...
      (i === !1 && ht(e, t, n, a),
        ut(e, e.mapping.slice(a).map(n, 1), r, void 0, i === null));
      let c = e.mapping.slice(a),
        l = c.map(n, 1),
        u = c.map(n + t.nodeSize, 1);
      return (
        e.step(
          new B(
            l,
            ...
            l + 1,
            u - 1,
            new f(o.from(r.create(s, null, t.marks)), 0, 0),
            1,
            !0,
          ),
        ),
...
function _t(e, t, n, r, i) {
  ...
  n ||= a.type;
  let s = n.create(r, null, i || a.marks);
  if (a.isLeaf) return e.replaceWith(t, t + a.nodeSize, s);
...
function vt(e, t, n = 1, r) {
  ...
  for (let e = i.depth, t = i.depth - n, c = n - 1; e > t; e--, c--) {
    ...
    let t = r && r[c];
    s = o.from(t ? t.type.create(t.attrs, s) : i.node(e).copy(s));
  }
  e.step(new z(t, t, new f(a.append(s), n, n), !0));
}
function yt(e, t, n) {
  let r = null,
  ...
  if (r === !1) {
    ...
    ht(e, r.node(), r.before(), s);
  }
  o.inlineContent &&
    ut(e, t + n - 1, o, a.node().contentMatchAt(a.index()), r == null);
  let c = e.mapping.slice(s),
    l = c.map(t - n);
  if ((e.step(new z(l, c.map(t + n, -1), f.empty, !0)), r === !0)) {
...
function St(e, t, n = t, r = f.empty) {
  if (t == n && !r.size) return null;
  let i = e.resolve(t),
    a = e.resolve(n);
  return Ct(i, a, r) ? new z(t, n, r) : new wt(i, a, r).fit();
}
function Ct(e, t, n) {
  return (
    !n.openStart &&
...
var wt = class {
  constructor(e, t, n) {
    ...
    for (let t = e.depth; t > 0; t--)
      this.placed = o.from(e.node(t).copy(this.placed));
  }
  get depth() {
    ...
    for (let t = 1; t <= 2; t++)
      for (let n = t == 1 ? e : this.unplaced.openStart; n >= 0; n--) {
        let e,
          r = null;
        n
          ? ((r = Tt(this.unplaced.content, n - 1).firstChild), (e = r.content))
          : (e = this.unplaced.content);
        let i = e.firstChild;
        for (let e = this.depth; e >= 0; e--) {
          let { type: a, match: s } = this.frontier[e],
            c,
            l = null;
          if (
            t == 1 &&
            (i
              ? s.matchType(i.type) || (l = s.fillBefore(o.from(i), !1))
              : r && a.compatibleContent(r.type))
          )
            return { sliceDepth: n, frontierDepth: e, parent: r, inject: l };
          if (t == 2 && i && (c = s.findWrapping(i.type)))
            return { sliceDepth: n, frontierDepth: e, parent: r, wrap: c };
  ...
  dropNode() {
    ...
    if (r.childCount <= 1 && t > 0) {
      ...
      this.unplaced = new f(H(e, t - 1, 1), t - 1, i ? t - 1 : n);
    } else this.unplaced = new f(H(e, t, 1), t, n);
  }
  placeNodes({
    sliceDepth: e,
    frontierDepth: t,
    ...
    (h || (m = -1),
      (this.placed = U(this.placed, t, o.from(u))),
    ...
    this.unplaced = h
      ? e == 0
        ? f.empty
        : new f(H(a.content, e - 1, 1), e - 1, m < 0 ? a.openEnd : e - 1)
      : new f(H(a.content, e, l), a.openStart, a.openEnd);
  }
  mustMoveInline() {
    ...
    if (
      !e.type.isTextblock ||
      !Dt(this.$to, this.$to.depth, e.type, e.match, !1) ||
  ...
  close(e) {
    ...
    (t.fit.childCount && (this.placed = U(this.placed, t.depth, t.fit)),
      (e = t.move));
  ...
  openFrontierNode(e, t = null, n) {
    ...
    ((r.match = r.match.matchType(e)),
      (this.placed = U(this.placed, this.depth, o.from(e.create(t, n)))),
...
function U(e, t, n) {
  return t == 0
    ...
    : e.replaceChild(
        e.childCount - 1,
        e.lastChild.copy(U(e.lastChild.content, t - 1, n)),
      );
}
function Tt(e, t) {
...
function Et(e, t, n) {
  ...
  return (
    t > 1 &&
      (r = r.replaceChild(
        0,
        Et(r.firstChild, t - 1, r.childCount == 1 ? n - 1 : 0),
      )),
    t > 0 &&
      ((r = e.type.contentMatch.fillBefore(r).append(r)),
      n <= 0 &&
        (r = r.append(
          e.type.contentMatch.matchFragment(r).fillBefore(o.empty, !0),
        ))),
    e.copy(r)
  );
}
function Dt(e, t, n, r, i) {
  ...
  return s && !Ot(n, a.content, o) ? s : null;
}
function Ot(e, t, n) {
...
function At(e, t, n, r) {
  ...
  let i = e.doc.resolve(t),
    a = e.doc.resolve(n);
  if (Ct(i, a, r)) return e.step(new z(t, n, r));
  let o = Pt(i, a);
  ...
  for (let t = r.openStart; t >= 0; t--) {
    ...
    if (d)
      for (let t = 0; t < o.length; t++) {
        ...
        let p = i.node(l - 1),
          m = i.index(l - 1);
        if (p.canReplaceWith(m, m, d.type, d.marks))
          return e.replace(
            i.before(l),
            u ? a.after(l) : n,
            new f(jt(r.content, 0, r.openStart, s), s, r.openEnd),
          );
      }
  }
...
function jt(e, t, n, r, i) {
  if (t < n) {
    let i = e.firstChild;
    e = e.replaceChild(0, i.copy(jt(i.content, t + 1, n, r, i)));
  }
  if (t > r) {
...
function Mt(e, t, n, r) {
  ...
  e.replaceRange(t, n, new f(o.from(r), 0, 0));
}
function Nt(e, t, n) {
...
var Lt = class {
    ...
    replace(e, t = e, n = f.empty) {
      let r = St(this.doc, e, t, n);
      return (r && this.step(r), this);
    }
    replaceWith(e, t, n) {
      return this.replace(e, t, new f(o.from(n), 0, 0));
    }
    delete(e, t) {
    ...
    setBlockType(e, t = e, n, r = null) {
      return (pt(this, e, t, n, r), this);
    }
    setNodeMarkup(e, t, n = null, r) {
      return (_t(this, e, t, n, r), this);
    }
    setNodeAttribute(e, t, n) {
      return (this.step(new Ft(e, t, n)), this);
    }
    setDocAttribute(e, t) {
    ...
    removeNodeMark(e, t) {
      ...
      if (t instanceof u) t.isInSet(n.marks) && this.step(new R(e, t));
      else {
        let r = n.marks,
          i,
          a = [];
        for (; (i = t.isInSet(r)); )
          (a.push(new R(e, i)), (r = i.removeFromSet(r)));
  ...
  G = class {
    constructor(e, t, n) {
      ((this.$anchor = e),
        (this.$head = t),
        (this.ranges = n || [new zt(e.min(t), e.max(t))]));
    }
    get anchor() {
    ...
    replace(e, t = f.empty) {
      ...
      for (let o = 0; o < a.length; o++) {
        let { $from: s, $to: c } = a[o],
          l = e.mapping.slice(i);
        (e.replaceRange(l.map(s.pos), l.map(c.pos), o ? f.empty : t),
          o == 0 && Gt(e, i, (n ? n.isInline : r && r.isTextblock) ? -1 : 1));
      }
    }
    replaceWith(e, t) {
      ...
      for (let i = 0; i < r.length; i++) {
        ...
        i
          ? e.deleteRange(c, l)
          : (e.replaceRangeWith(c, l, t), Gt(e, n, t.isInline ? -1 : 1));
      }
    }
    static findFrom(e, t, n = !1) {
      let r = e.parent.inlineContent
        ? new K(e)
        : Y(e.node(0), e.parent, e.pos, e.index(), t, n);
      if (r) return r;
    ...
    static jsonID(e, t) {
      if (e in Rt) throw RangeError(`Duplicate use of selection JSON ID ` + e);
...
var Ht = class e {
  ...
  q = class e extends G {
    ...
    content() {
      return new f(o.from(this.node), 0, 0);
    }
    eq(t) {
...
function Y(e, t, n, r, i, a = !1) {
  ...
  for (let o = r - (i > 0 ? 0 : 1); i > 0 ? o < t.childCount : o >= 0; o += i) {
    ...
    if (!r.isAtom) {
      ...
      if (t) return t;
    } else if (!a && q.isSelectable(r))
      return q.create(e, n - (i < 0 ? r.nodeSize : 0));
    n += r.nodeSize * i;
  }
  return null;
}
  ...
  Jt = class extends Lt {
    ...
    setSelection(e) {
      ...
      return (
        (this.curSelection = e),
        (this.curSelectionFor = this.steps.length),
        (this.updated = (this.updated | Kt) & ~X),
        (this.storedMarks = null),
        this
      );
    }
    get selectionSet() {
      return (this.updated & Kt) > 0;
    }
    setStoredMarks(e) {
        ...
        t &&
          (e = e.mark(
            this.storedMarks ||
              (n.empty
                ? n.$from.marks()
                : n.$from.marksAcross(n.$to) || u.none),
          )),
...
var Z = class {
    constructor(e, t, n) {
      ((this.name = e),
        (this.init = Yt(t.init, n)),
        (this.apply = Yt(t.apply, n)));
    }
  },
  Xt = [
    new Z(`doc`, {
  ...
  Qt = class e {
    ...
    static create(t) {
      let n = new Zt(t.doc ? t.doc.type.schema : t.schema, t.plugins),
        r = new e(n);
    ...
    reconfigure(t) {
      let n = new Zt(this.schema, t.plugins),
        r = n.fields,
        i = new e(n);
      for (let e = 0; e < r.length; e++) {
        let n = r[e].name;
    ...
    static fromJSON(t, n, r) {
      ...
      let i = new Zt(t.schema, t.plugins),
        a = new e(i);
      return (
        i.fields.forEach((e) => {
          if (e.name == `doc`) a.doc = b.fromJSON(t.schema, n.doc);
          else if (e.name == `selection`)
            a.selection = G.fromJSON(a.doc, n.selection);
...
var en = class {
    constructor(e) {
      ((this.spec = e),
        ...
        (this.key = e.key ? e.key.key : tn(`plugin`)));
    }
    getState(e) {
      return e[this.key];
    }
...
var nn = class {
  ...
  rn = new nn(`transactionEventPlugin`),
  an = `prosemirrorDispatchTransaction`;
function on(e, t) {
  let { eventTarget: n } = rn.getState(e.state);
  return (
    n.addEventListener(an, t),
    () => {
      n.removeEventListener(an, t);
    }
  );
}
function sn(e) {
...
var $ = e(t(), 1),
  ...
  dn = (e, t) => {
    ...
    n[0] === e.view
      ? (r = n[1])
      : ((r = (t) => on(e.view, t)), (n[0] = e.view), (n[1] = r));
    let i, a;
    return (
      n[2] !== e || n[3] !== t
        ? ((i = () => t(e)),
...
//# sourceMappingURL=use-composer-controller-CHz4Zlxm.js.map
