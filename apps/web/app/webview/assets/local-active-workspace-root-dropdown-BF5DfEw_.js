...
import { Wi as t } from "./app-server-manager-signals-7MlBpIlX.js";
...
import { t as p } from "./product-logger-CekQ0CO0.js";
import { t as ee } from "./thread-context-inputs-D4zJFWk0.js";
import { n as m, t as h } from "./remote-connection-visibility-BqsxCDqm.js";
import { t as g } from "./tooltip-Bb9X8NK-.js";
import { t as _ } from "./button-BynxeNRW.js";
import { n as te } from "./remote-projects-T90XwaVV.js";
import { r as v, t as y } from "./home-row-layout-Bdv7TEjH.js";
import { t as ne } from "./with-window-BCZl6ce7.js";
import { t as b } from "./use-is-remote-host-BMphGLPr.js";
import {
  n as x,
  r as S,
  t as C,
} from "./open-project-setup-dialog-CAfG73Jf.js";
import { t as re } from "./check-md-I6RRy8DL.js";
import { t as w } from "./compose-D9zy3mEn.js";
import {
  g as T,
  l as E,
  u as D,
} from "./sidebar-project-group-signals--koPX1Ta.js";
import { S as O, t as k } from "./sidebar-thread-list-signals-xCTtHSiV.js";
import { n as ie, t as ae } from "./add-project-menu-items-qOBi6_GC.js";
import { a as A, i as j, r as M, t as oe } from "./dropdown-CLcC-0sa.js";
import { t as se } from "./globe-D1xFoTfu.js";
import { t as ce } from "./chevron-CEHg0DRl.js";
import { t as le } from "./workspace-root-icon-B6fT__i3.js";
import { t as ue } from "./folder-DnqvPFV1.js";
import { t as de } from "./plus-PQBYSO-0.js";
import { t as fe } from "./use-connected-remote-connections-CYxJx8ss.js";
var pe = e(n()),
  N = r(),
  P = (e) =>
    (0, N.jsxs)(`svg`, {
...
function he(e) {
        ...
        return (0, N.jsx)(
          `div`,
          {
            ...
            children: (0, N.jsx)(j, {
              ...
              RightIcon: i.includes(e.projectId) ? re : void 0,
  ...
  n[25] !== v || n[26] !== x || n[27] !== S || n[28] !== w
    ? ((T = (0, N.jsxs)(v, { className: x, children: [S, w] })),
      (n[25] = v),
      (n[26] = x),
      (n[27] = S),
      (n[28] = w),
                ...
                (0, N.jsxs)(M.Section, {
                  ...
                  children: [
                    ...
                    p
                      ...
                      : null,
                    g
                      ? (0, N.jsx)(j, { LeftIcon: P, onSelect: u, children: l })
                      : null,
                  ],
                }),
              ],
  ...
  return (
    n[38] !== C || n[39] !== T || n[40] !== E
      ? ((D = (0, N.jsxs)(N.Fragment, { children: [C, T, E] })),
        (n[38] = C),
        (n[39] = T),
        (n[40] = E),
        (n[41] = D))
...
var ge = u(o, ({ get: e }) => {
  let t = e(T),
    n = e(e(E, { threadKeys: t, enabled: !0 })).groups,
    r = new Map(e(e(k, t)).map((e) => [e.task.key, e]));
  return O(e(D), n, r);
});
function F(e) {
  let t = (0, me.c)(80),
    ...
    Ce = !be,
    {
      selectedRemoteProject: we,
      selectedRemoteProjectId: Te,
      setSelectedRemoteProjectId: L,
    } = te(),
    { remoteConnections: Ee } = h(),
    De = fe(Ee),
    { data: Oe, isLoading: ke } = c(ee),
    R = D && xe && !be && De.length > 0,
    Ae = (e) => {
      p(P, { eventName: `codex_app_workspace_root_selected` });
      ...
      if (t != null) {
        ...
        (L(null),
          f.dispatchMessage(`electron-set-active-workspace-root`, {
            root: t.path,
          }),
          d?.(t.path));
      }
  ...
  t[0] === P
    ? (z = t[1])
    : ((z = () => {
        (p(P, { eventName: `codex_app_workspace_root_add_clicked` }), S());
      }),
      (t[0] = P),
      (t[1] = z));
  let B = z,
  ...
  t[2] === P
    ? (V = t[3])
    : ((V = () => {
        (p(P, { eventName: `codex_app_workspace_root_add_clicked` }), C(P));
      }),
      (t[2] = P),
      (t[3] = V));
  let H = V,
  ...
  t[4] === P
    ? (je = t[5])
    : ((je = () => {
        (p(P, { eventName: `codex_app_workspace_root_add_clicked` }),
          x({ setActive: !0 }));
      }),
      (t[4] = P),
      (t[5] = je));
  ...
  t[6] !== d || t[7] !== P || t[8] !== L
    ? ((Ne = () => {
        (p(P, { eventName: `codex_app_workspace_root_selected` }),
          L(null),
          f.dispatchMessage(`electron-clear-active-workspace-root`, {}),
          d?.(null));
      }),
      (t[6] = d),
      (t[7] = P),
  ...
  let W = U == null && Ce,
    Fe = Ce && U != null,
    Ie = A === `home` && I.length === 0 && !be;
  if (!Se && ke && Oe == null && !Ie && Te == null) return null;
  let G =
      U == null
        ? null
        : ve({
  ...
  let He = Ve,
    Ue;
  t[18] !== G?.isCodexWorktree ||
  t[19] !== G?.projectKind ||
  t[20] !== G?.repositoryData ||
  t[21] !== K ||
  t[22] !== k ||
  t[23] !== W
    ? ((Ue = () =>
        (0, N.jsx)(g, {
          tooltipContent: (0, N.jsx)(a, {
          ...
          children: (0, N.jsxs)(_, {
            ...
            children: [
              W
                ? (0, N.jsx)(w, { className: `icon-2xs shrink-0` })
                : (0, N.jsx)(le, {
            ...
            (0, N.jsxs)(`span`, {
              ...
              children: [
                (0, N.jsx)(`span`, {
                  ...
                  children:
                    W || G == null
                      ? (0, N.jsx)(ie, { className: `icon-xs shrink-0` })
                      : (0, N.jsx)(le, {
                          isCodexWorktree: !!G?.isCodexWorktree,
                          isGitRepository: G?.repositoryData != null,
                          isRemoteProject: G?.projectKind === `remote`,
  ...
  t[46] === H
    ...
    : ((J = (e) => {
      ...
      (t[46] = H),
      (t[47] = J));
  let Je = A === `hero` || A === `home` ? `bottom` : `top`,
    Ye = A === `hero` ? `center` : `start`,
    Y;
  t[48] !== We || t[49] !== qe || t[50] !== q || t[51] !== E || t[52] !== A
    ? ((Y = E ?? (A === `hero` ? qe() : A === `home` ? q() : We())),
      (t[48] = We),
      (t[49] = qe),
      (t[50] = q),
      (t[51] = E),
    ...
    : (Y = t[53]);
  let X;
  t[54] === U ? (X = t[55]) : ((X = U ? [U] : []), (t[54] = U), (t[55] = X));
  let Xe;
  ...
  t[59] === B
    ? (Z = t[60])
    : ((Z = (0, N.jsx)(M.Item, { LeftIcon: ue, onSelect: B, children: $e })),
      (t[59] = B),
      (t[60] = Z));
  let Q;
  t[61] !== He || t[62] !== Z
    ? ((Q = (0, N.jsxs)(M.FlyoutSubmenuItem, {
        LeftIcon: ie,
        label: He,
        children: [Qe, Z],
      })),
  ...
  t[69] !== et
    ? (($ = (0, N.jsx)(he, {
        ...
        onSelectProjectId: Ae,
        projectlessActionLabel: Xe,
        onSelectProjectless: Ze,
        footerItems: Q,
        onAddRemoteProject: et,
      })),
      (t[64] = I),
      (t[65] = Ae),
      (t[66] = X),
...
export { F as t };
//# sourceMappingURL=local-active-workspace-root-dropdown-BF5DfEw_.js.map
