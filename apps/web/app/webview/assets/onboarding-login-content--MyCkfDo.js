import { Xs as e, po as t } from "./app-server-manager-signals-DkRDRgNB.js";
import { t as n } from "./jsx-runtime.js";
import { G as r, U as i, wt as a } from "./setting-storage.js";
import { t as o } from "./button.js";
async function s({ hostId: n = t, signal: r, useStreamlinedLogin: i }) {
  let a = l(r);
  return n === `local`
    ? e(`login-with-chatgpt`, { abortController: a, useStreamlinedLogin: i })
    : e(`login-with-chatgpt-for-host`, {
        abortController: a,
        hostId: n,
...
function c({ signal: t } = {}) {
  return e(`login-with-chatgpt-device-code`, { abortController: l(t) });
}
function l(e) {
...
//# sourceMappingURL=onboarding-login-content--MyCkfDo.js.map
