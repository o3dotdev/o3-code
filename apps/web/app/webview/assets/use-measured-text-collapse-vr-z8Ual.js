...
import { n as r } from "./use-resize-observer-DXGSgvEH.js";
var i = n(),
  a = e(t(), 1),
  o = 1.5,
  s = 1;
function c(e) {
  let t = (0, i.c)(9),
    ...
    d;
  t[0] !== r || t[1] !== o
    ? ((d = { collapsedLineCount: r, fallbackFontSizePx: o }),
      (t[0] = r),
      (t[1] = o),
      (t[2] = d))
    : (d = t[2]);
  let { setTextMeasurementRef: f, textMeasurement: p } = l(d),
    m =
      p == null ||
      p.collapsedHeightPx == null ||
      p.contentHeightPx <= p.collapsedHeightPx + s
        ? `uncollapsible`
        : c === n
          ? `expanded`
          : `collapsed`,
  ...
  return (
    t[5] !== m || t[6] !== g || t[7] !== f
      ? ((_ = {
          setTextContentMeasurementRef: f,
          collapseState: m,
...
//# sourceMappingURL=use-measured-text-collapse-vr-z8Ual.js.map
