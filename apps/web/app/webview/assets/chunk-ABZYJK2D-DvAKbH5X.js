const __vite__mapDeps = (
  i,
  m = __vite__mapDeps,
  d = m.f || (m.f = ["./katex-BdZ1C5Hl.js", "./katex-BzX-JuVf.js"]),
) => i.map((i) => d[i]);
import { t as e } from "./preload-helper-I1wKxk_B.js";
import { a as t, i as n, n as r, r as i } from "./src-DXdm7MTq.js";
var a = {
...
function Ye() {
      ...
      if (!(J && J === e)) {
        if (
          ...
          (st = T(e, `ADD_DATA_URI_TAGS`)
            ...
            : ct),
          (at = T(e, `FORBID_CONTENTS`) ? O({}, e.FORBID_CONTENTS, q) : ot),
          (Ve = T(e, `FORBID_TAGS`) ? O({}, e.FORBID_TAGS, q) : k({})),
          (He = T(e, `FORBID_ATTR`) ? O({}, e.FORBID_ATTR, q) : k({})),
          (it = T(e, `USE_PROFILES`) ? e.USE_PROFILES : !1),
          ...
          it &&
            ((A = O({}, Ne)),
            (j = []),
            it.html === !0 && (O(A, De), O(j, Pe)),
            it.svg === !0 && (O(A, Oe), O(j, Fe), O(j, Le)),
            it.svgFilters === !0 && (O(A, ke), O(j, Fe), O(j, Le)),
            it.mathMl === !0 && (O(A, je), O(j, Ie), O(j, Le))),
          e.ADD_TAGS &&
          ...
          e.FORBID_CONTENTS &&
            (at === ot && (at = k(at)), O(at, e.FORBID_CONTENTS, q)),
          V && (A[`#text`] = !0),
  ...
  let Ot = function (e) {
    ...
    kt = function (e, t, r) {
      if (tt && (t === `id` || t === `name`) && (r in n || r in vt)) return !1;
      if (
        !(Xe && !He[t] && E(w, t)) &&
        !(P && E(ue, t)) &&
  ...
  return (
    (t.sanitize = function (e) {
      ...
      if (
        ($e || bt(n), (t.removed = []), typeof e == `string` && (rt = !1), rt)
      ) {
        if (e.nodeName) {
          let t = q(e.nodeName);
          if (!A[t] || Ve[t])
        ...
        if (!R && !F && !L && e.indexOf(`<`) === -1)
          return g && B ? g.createHTML(e) : e;
        if (((i = wt(e)), !i)) return R ? null : B ? _ : ``;
      }
      i && et && Y(i.firstChild);
      let u = Tt(rt ? e : i);
      for (; (c = u.nextNode()); )
...
`,
  ...
  R = i((e) => I[e].loader, `getDiagramLoader`),
  z = i((e, t, { depth: n = 2, clobber: r = !1 } = {}) => {
    let i = { depth: n, clobber: r };
    return Array.isArray(t) && !Array.isArray(e)
      ? (t.forEach((t) => z(e, t, i)), e)
              ...
              Object.keys(t).forEach((i) => {
                ...
                (e[i] === void 0 || typeof e[i] == `object`)
                  ? (e[i] === void 0 && (e[i] = Array.isArray(t[i]) ? [] : {}),
                    (e[i] = z(e[i], t[i], { depth: n - 1, clobber: r })))
                  : (r ||
    ...
    updateColors() {
      ...
      ((this.classText = this.classText || this.textColor),
        ...
        (this.attributeBackgroundColorOdd =
          this.attributeBackgroundColorOdd || tt),
        (this.attributeBackgroundColorEven =
          this.attributeBackgroundColorEven || nt));
    }
    calculate(e) {
      if (typeof e != `object`) {
        this.updateColors();
  ...
  W = {
    ...
    c4: {
      ...
      external_personFont: i(function () {
        return {
      ...
      external_systemFont: i(function () {
        return {
      ...
      external_system_dbFont: i(function () {
        return {
      ...
      external_system_queueFont: i(function () {
        return {
      ...
      external_containerFont: i(function () {
        return {
      ...
      external_container_dbFont: i(function () {
        return {
      ...
      container_queueFont: i(function () {
        return {
      ...
      external_container_queueFont: i(function () {
        return {
      ...
      external_componentFont: i(function () {
        return {
      ...
      external_component_dbFont: i(function () {
        return {
      ...
      component_queueFont: i(function () {
        return {
      ...
      external_component_queueFont: i(function () {
        return {
  ...
  vt = i((e, t) => {
    let n = B({}, e),
      r = {};
    for (let e of t) (X(e), (r = B(r, e)));
    if (((n = B(n, r)), r.theme && r.theme in H)) {
      let e = B(B({}, _t).themeVariables || {}, r.themeVariables);
      n.theme &&
        n.theme in H &&
  ...
  xt = i((e) => ((K = B(K, e)), vt(K, q), K), `updateSiteConfig`),
  St = i(() => B({}, K), `getSiteConfig`),
  Ct = i((e) => (Ot(e), B(J, e), Y()), `setConfig`),
  Y = i(() => B({}, J), `getConfig`),
  X = i((e) => {
    e &&
...
i(Mt, `setupDompurifyHooks`);
var Nt = i((e) => (jt(), P.sanitize(e)), `removeScript`),
  Pt = i((e, t) => {
  ...
  It = i((e) => Q.test(e), `hasBreaks`),
  Lt = i((e) => e.split(Q), `splitBreaks`),
  Rt = i((e) => e.replace(/#br#/g, `<br/>`), `placeholderToBreak`),
  zt = i((e) => e.replace(Q, `#br#`), `breakToPlaceholder`),
  Bt = i((e) => {
    let t = ``;
    return (
      e &&
  ...
  Gt = i((e, t) => Math.max(0, e.split(t).length - 1), `countOccurrence`),
  Kt = i((e, t) => {
    let n = Gt(e, `~`),
      r = Gt(t, `~`);
    return n === 1 && r === 1;
  ...
  Jt = i(() => window.MathMLElement !== void 0, `isMathMLSupported`),
  Yt = /\$\$(.*)\$\$/g,
  Xt = i((e) => (e.match(Yt)?.length ?? 0) > 0, `hasKatex`),
  Zt = i(async (e, t) => {
  ...
  Qt = i(async (t, n) => {
      ...
      return t.replace(Yt, `MathML is unsupported in this environment.`);
    {
      let { default: r } = await e(
          async () => {
            let { default: e } = await import(`./katex-BdZ1C5Hl.js`);
            return { default: e };
          },
          __vite__mapDeps([0, 1]),
          import.meta.url,
  ...
  $t = i(async (e, t) => $(await Qt(e, t), t), `renderKatexSanitized`),
  en = {
    getRows: At,
    sanitizeText: $,
  ...
  rn = i(function (e, t, n, r) {
    tn(e, nn(t, n, r));
  }, `configureSvgSize`),
  an = i(function (e, t, r, i) {
...
`,
  ...
  yn = i(() => pn, `getAccDescription`),
  bn = i((e) => {
    fn = mn(e);
  }, `setDiagramTitle`),
  xn = i(() => fn, `getDiagramTitle`),
  Sn = n,
  Cn = t,
  wn = Y,
  Tn = Ct,
  En = gt,
  Dn = i((e) => $(e, wn()), `sanitizeText`),
  On = an,
  kn = i(() => un, `getCommonDb`),
  An = {},
  jn = i((e, t, n) => {
...
//# sourceMappingURL=chunk-ABZYJK2D-DvAKbH5X.js.map
