import { Qo as e, ts as t } from "./app-server-manager-signals-7MlBpIlX.js";
import {
  $ as n,
  Q as r,
  S as i,
...
async function d(e, t, n = {}) {
  ...
  (await e.invalidateQueries({
    predicate: ({ queryKey: e }) => e[0] === c[0] && e[1] === t,
    refetchType: i,
  }),
    r && s.dispatchMessage(`query-cache-invalidate`, { queryKey: c }));
}
var f = r(i, (e) =>
  n(i, () => ({
    mutationFn: (n) =>
    ...
    onMutate: async (t, { client: n }) => {
      await n.cancelQueries({ predicate: ({ queryKey: t }) => p(t, e) });
      let r = n.getQueriesData({ predicate: ({ queryKey: t }) => p(t, e) });
      return (
        n.setQueriesData({ predicate: ({ queryKey: t }) => p(t, e) }, (e) =>
          m(e, t),
        ),
        { previousResponses: r }
      );
    ...
    onSettled: async (t, n, r, i, { client: a }) => {
      await d(a, e, { broadcast: !0 });
    },
  })),
);
function p(e, t) {
  return e[0] === c[0] && e[1] === t;
}
function m(t, n) {
  if (t == null) return t;
...
//# sourceMappingURL=hooks-settings-queries-zVGp9kEJ.js.map
