...
import { a as l, o as u, t as d } from "./tslib.es6-PiNIxp0T.js";
var f = e(t(), 1);
function p(e) {
  let t = f.useRef(e);
  return (
    ...
    let {
      ...
      P = E((e) => {
        ...
        [...p.branches].some((e) => e.contains(t)) ||
          (c?.(e), l?.(e), e.defaultPrevented || u?.());
      }, y);
    return (
      m((e) => {
        A === p.layers.size - 1 &&
          (r?.(e), !e.defaultPrevented && u && (e.preventDefault(), u()));
      }, y),
      f.useEffect(() => {
        if (g)
          return (
  ...
  return (
    f.useEffect(() => {
      let e = (e) => {
        e.target &&
          !r.current &&
          O(y, n, { originalEvent: e }, { discrete: !1 });
      };
      return (
        ...
        if (t && i) {
          ...
          r && a
            ? !e.shiftKey && i === a
              ...
              : e.shiftKey &&
                i === r &&
                (e.preventDefault(), n && I(a, { select: !0 }))
...
function dt(e) {
    ...
    f.useEffect(
      function () {
        if (e.inert) {
          ...
          var t = u([e.lockRef.current], (e.shards || []).map(st), !0).filter(
            Boolean,
          );
          return (
  ...
  return f.createElement(
    ...
    h
      ? f.createElement(Je, { noRelative: e.noRelative, gapMode: e.gapMode })
      : null,
  );
}
function ft(e) {
...
//# sourceMappingURL=Combination-CmOISuqp.js.map
