...
import { p as r, wt as i } from "./setting-storage.js";
import { n as a } from "./local-environments-DcKJ5oGa.js";
var o = i(),
  s = t(`local-env-selections-by-workspace`, {});
function c(e) {
  let t = a(e),
    r = t?.configPath ?? null,
    i = r ? n(r) : null;
  return {
    ...
    availableEnvironments: i ? e.filter((e) => n(e.configPath) !== i) : e,
  };
}
function l(e, t) {
  return !e || e === `/` ? null : `${t}:${n(e)}`;
}
function u({
  ...
  o && p && (m = i[o] ?? null);
  let h = m ? n(m) : null,
    g = e && h != null && t.some((e) => n(e.configPath) === h),
    _ = p ? m : null;
  e && p && m != null && !g && (_ = f);
  let v = _ ? n(_) : null;
  return {
...
function f(t) {
  let n = (0, o.c)(37),
    { hostId: i, workspaceRoot: a } = t,
    [c, f] = e(s),
    m;
  n[0] !== i || n[1] !== a
    ? ((m = l(a, i)), (n[0] = i), (n[1] = a), (n[2] = m))
    : (m = n[2]);
  let h = m,
    g = a ?? ``,
    _;
  n[3] !== i || n[4] !== g
    ? ((_ = { hostId: i, workspaceRoot: g }),
      (n[3] = i),
      (n[4] = g),
      (n[5] = _))
    : (_ = n[5]);
  let v = h != null,
    y;
  n[6] === v ? (y = n[7]) : ((y = { enabled: v }), (n[6] = v), (n[7] = y));
  let b;
  n[8] !== _ || n[9] !== y
    ? ((b = { params: _, queryConfig: y, select: p }),
      (n[8] = _),
      (n[9] = y),
      (n[10] = b))
    : (b = n[10]);
...
//# sourceMappingURL=local-environment-selection-DyGLYKsj.js.map
