...
import { Cr as t, Er as n, cr as r, lr as i } from "./src-C.js";
import { Ha as a, Ra as o } from "./app-server-manager-signals-DkRDRgNB.js";
import { n as s, t as c } from "./jsx-runtime.js";
import { t as l } from "./clsx-BcPLHiun.js";
import { B as u, wt as d, y as f } from "./setting-storage.js";
import { t as p } from "./known-app-icon.js";
import { t as m } from "./tooltip-CDzchJxN.js";
import { t as h } from "./external-link-source-DT57c-8r.js";
import { t as g } from "./context-menu.js";
import { t as _ } from "./globe-CnvlclXd.js";
import { t as v } from "./copy-to-clipboard-C2Mq2hN-.js";
import {
  a as y,
  i as b,
  n as ee,
...
var z = (function () {
  ...
  B = (function () {
    let e = [1, {}],
      ...
      V = [0, { dyn: t }],
      ce = [2, { web: t }],
      H = [1, { co: e, com: e, edu: e, gov: e, net: e, org: e }],
      U = [0, { p: t }],
      le = [0, { user: t }],
      ue = [1, { ms: t }],
      W = [0, { cdn: t }],
      G = [2, { raw: i }],
      K = [0, { cust: t, reservd: t }],
      de = [0, { cust: t }],
      q = [0, { s3: t }],
      J = [1, { biz: e, com: e, edu: e, gov: e, info: e, net: e, org: e }],
      Y = [0, { ipfs: t }],
      X = [1, { framer: t }],
      fe = [0, { forgot: t }],
      ...
      0,
      {
        ...
        io: [
          1,
          {
            ...
            edugit: t,
            telebit: t,
            thingdust: [0, { dev: K, disrec: K, prod: de, testing: K }],
            tickets: t,
            webflow: t,
            webflowtest: t,
            "drive-platform": t,
        ...
        jp: [
          1,
          {
            ...
            rgr: t,
            rulez: t,
            sakurastorage: [0, { isk01: q, isk02: q }],
            saloon: t,
            sblo: t,
            skr: t,
            tank: t,
        ...
        edeka: e,
        education: b,
        email: [1, { crisp: [0, { on: t }], intouch: t, tawk: U, tawkto: U }],
        emerck: e,
        energy: e,
        engineer: e,
        engineering: e,
...
`),
  ...
  if (o(r) && !r.startsWith(`//`) && !(r.startsWith(`/`) && n)) {
    let e = a(``, r),
      n = new URL(`file:///`);
    if (t(e)) {
      let t = e.indexOf(`/`, 2);
      return (
        (n.host = e.slice(2, t)),
        (n.pathname = e.slice(t)),
        n.toString()
      );
    }
    return ((n.pathname = e), n.toString());
  }
  let i = q(r);
  return ue(i) ? `http://${r}` : de(r, i) ? `https://${r}` : X(r);
}
function le(e) {
  let t = e.trim();
  ...
  try {
    let e = new URL(t);
    if (e.protocol === `file:`) {
      let t = n(decodeURIComponent(e.pathname));
...
function ue(e) {
  return e != null && G(e.hostname);
}
function W(e) {
  return e.protocol !== `http:` && e.protocol !== `https:` ? !1 : G(e.hostname);
}
function G(e) {
  return i(e);
}
...
function Y(e) {
  let t = H(e, { allowPrivateDomains: !0 });
...
function Z({ conversationId: e, url: t, source: n, initiator: r }) {
  let i = pe(t);
  return i == null
    ? !1
    : (f.dispatchHostMessage({
...
var me = /^(?:[a-z][a-z0-9+.-]*:\/\/|www\.)/i;
function Q({ conversationId: e, href: t, isBrowserSidebarEnabled: n }) {
  return e != null && n && ve(t);
}
function he({ conversationId: e, href: t, isBrowserSidebarEnabled: n }) {
  let r = $(t);
  return (
    Q({ conversationId: e, href: t, isBrowserSidebarEnabled: n }) &&
    (fe(t) || be(r))
  );
}
function $(e) {
...
function ge({ conversationId: e, href: t }) {
  let n = $(t),
    r = be(n);
  return [
    {
      ...
      onSelect: () => {
        if (r) {
          f.dispatchMessage(`open-in-browser`, {
            url: n,
            source: `manual`,
...
function _e({ event: e, href: t, originHostId: n }) {
  ...
  f.dispatchMessage(`open-in-browser`, {
    ...
    ...(ye(e) && be(r) ? { useExternalBrowser: !0 } : {}),
  });
}
function ve(e) {
  return me.test(e);
...
function xe(e) {
  ...
  let u = he({ conversationId: s, href: i, isBrowserSidebarEnabled: c }),
    d;
  ...
  t[4] !== i || t[5] !== o
    ? ((p = (e) => {
        _e({ event: e, href: i, originHostId: o });
      }),
      (t[4] = i),
      (t[5] = o),
      (t[6] = p))
...
export { le as a, U as i, ye as n, H as o, Z as r, xe as t };
//# sourceMappingURL=external-markdown-link-DVRKkYqo.js.map
