...
import { $t as n, Kr as r } from "./src-C.js";
import { xa as i } from "./app-server-manager-signals-DkRDRgNB.js";
import {
  L as a,
  T as o,
  _ as s,
...
import { t as f } from "./useInfiniteQuery.js";
import { t as p } from "./request-DWZTrEAr.js";
import { t as m } from "./invalidate-queries-and-broadcast-BXgBlyBv.js";
import { t as h } from "./use-auth.js";
import { t as g } from "./_baseOrderBy-CIbyNZRe.js";
import { t as _ } from "./parse-owner-repo.js";
import { t as v } from "./use-debounced-value-BtOJx-Vp.js";
function y(e) {
...
function te(e) {
  return e === !0 || e === !1 || (ne(e) && D(e) == `[object Boolean]`);
}
function w(e) {
...
var re = `Incorrect 'index' type`,
  ie = (e) => `Invalid value for key ${e}`,
  ae = (e) => `Pattern length exceeds max of ${e}.`,
  oe = (e) => `Missing ${e} property in key`,
  se = (e) => `Property 'weight' in key '${e}' must be a positive integer`,
...
function k(e) {
  let t = null,
    ...
    i = 1,
    a = null;
  if (C(e) || y(e)) ((r = e), (t = A(e)), (n = j(e)));
  else {
    if (!O.call(e, `name`)) throw Error(oe(`name`));
    let o = e.name;
    if (((r = o), O.call(e, `weight`) && ((i = e.weight), i <= 0)))
      throw Error(se(o));
    ((t = A(o)), (n = j(o)), (a = e.getFn));
  }
    ...
    i = (e, t, a) => {
      if (T(e))
        if (!t[a]) n.push(e);
          ...
          let o = e[t[a]];
          if (!T(o)) return;
          if (a === t.length - 1 && (C(o) || ee(o) || te(o))) n.push(S(o));
          else if (y(o)) {
            r = !0;
...
function ve(
  ...
  if (t.length > I) throw Error(ae(I));
  let u = t.length,
    d = e.length,
...
function Pe(e, { ignoreFieldNorm: t = M.ignoreFieldNorm }) {
  e.forEach((e) => {
    let n = 1;
...
function Fe(e, t) {
  ...
  ((t.matches = []),
    T(n) &&
      n.forEach((e) => {
        if (!T(e.indices) || !e.indices.length) return;
...
var Q = class {
  constructor(e, t = {}, n) {
    ((this.options = { ...M, ...t }),
      ...
      (this._keyStore = new ce(this.options.keys)),
      this.setCollection(e, n));
  }
  setCollection(e, t) {
    if (((this._docs = e), t && !(t instanceof N))) throw Error(re);
    this._myIndex =
      t ||
  ...
  search(e, { limit: t = -1 } = {}) {
    ...
    return (
      Pe(s, { ignoreFieldNorm: o }),
      i && s.sort(a),
      ee(t) && t > -1 && (s = s.slice(0, t)),
      Le(s, this._docs, { includeMatches: n, includeScore: r })
    );
  }
  _searchStringList(e) {
...
var Re = t((e, t) => {
  ...
  ze = e(Re(), 1),
  Be = e(i(), 1),
  Ve = `codex_referral_persistent_invite`;
function He(e) {
  return {
    enabled: e != null,
    queryFn: async () =>
      p.safeGet(`/wham/tasks/{task_id}`, {
...
function Ue(e) {
  return {
    enabled: e != null,
    queryFn: async () =>
      p.safeGet(`/wham/tasks/{task_id}/turns`, {
        parameters: { path: { task_id: e ?? `` } },
      }),
...
function We(e) {
  ...
  t[3] !== e?.limit || t[4] !== e?.taskFilter
    ? ((l = async () =>
        (
          await p.safeGet(`/wham/tasks/list`, {
            parameters: {
      ...
      (t[5] = l))
    : (l = t[5]);
  let u = e?.enabled !== !1 && n === `chatgpt`,
    d;
  t[6] === e
    ? (d = t[7])
    : ((d = e?.environmentLabel
        ? (t) =>
            t.filter(
              (t) =>
...
function Je(e, t, n) {
  ...
  r[3] !== e || r[4] !== t
    ? ((l = async () =>
        p.safeGet(`/wham/tasks/{task_id}/turns/{task_turn_id}`, {
...
function Ye(e, t, n) {
  ...
  r[3] !== e || r[4] !== t
    ? ((c = async () =>
        p.safeGet(`/wham/tasks/{task_id}/turns/{task_turn_id}/logs`, {
          parameters: { path: { task_id: e ?? ``, task_turn_id: t ?? `` } },
        })),
      (r[3] = e),
      (r[4] = t),
...
async function Ze() {
  return p.safeGet(`/wham/environments`);
}
function Qe(e, t) {
  let n = (0, $.c)(14),
    { enabled: r } = t,
  ...
  n[0] === a
    ? (c = n[1])
    : ((c = [`workspace`, `environments-search`, a]), (n[0] = a), (n[1] = c));
  let l;
  n[2] !== a || n[3] !== i
    ? ((l = i && a.trim().length > 0), (n[2] = a), (n[3] = i), (n[4] = l))
    : (l = n[4]);
  let u;
  n[5] === a
    ? (u = n[6])
    : ((u = async () => {
        let e = await p.safeGet(`/wham/environments`),
          t = a.trim().toLowerCase(),
          n = new Q(e, { threshold: 0.4, keys: [`label`, `repos`] }),
          r = n?.search(a).map(et) ?? [],
          i = (e) => {
            let n = e.toLowerCase();
...
function tt(e) {
  ...
  let { data: l } = o(c),
    ...
    d;
  if (t[3] !== l) {
    let e = (0, ze.default)(l, [`owner`, `repoName`]).flatMap(rt);
    ((d = o),
  ...
  t[6] === l
    ...
    : ((p = async () => {
        ...
        return ((0, ze.default)(e, [`is_pinned`, `task_count`, `label`]), e);
      }),
      (t[6] = l),
      (t[7] = p));
  let m;
  return (
    t[8] !== u || t[9] !== f || t[10] !== p
      ? ((m = { queryKey: u, enabled: f, staleTime: s.ONE_MINUTE, queryFn: p }),
        (t[8] = u),
        (t[9] = f),
        (t[10] = p),
        (t[11] = m))
...
function at(e) {
  ...
  return (0, Be.default)(t, ({ owner: e, repoName: t }) => `${e}/${t}`);
}
async function ot(e) {
  let t = [];
  if (
...
async function st({
  ...
  return p.safePost(`/wham/worktree_snapshots/upload_url`, {
    requestBody: {
      repo_name: e,
      filename: t,
      content_type: n,
...
async function ct({ fileId: e, etag: t }) {
  return p.safePost(`/wham/worktree_snapshots/finish_upload`, {
...
async function ft(e) {
  return p.safePost(`/wham/tasks/{task_id}/turns/{task_turn_id}/pr`, {
...
function gt(e) {
  return p.safePost(`/wham/referrals/invite`, {
...
function vt() {
  return p.safeGet(`/referrals/invite/eligibility`, {
    parameters: { query: { referral_key: Ve } },
  });
}
function yt() {
  let e = (0, $.c)(1),
...
function bt() {
  return p.safeGet(`/wham/rate-limit-reset-credits`);
}
function xt() {
  let e = (0, $.c)(2),
    t = a(),
...
function St(e) {
  ...
  return p.safePost(`/wham/rate-limit-reset-credits/consume`, {
...
async function Tt(e) {
  await p.safePost(`/wham/tasks/{task_id}/cancel`, {
    parameters: { path: { task_id: e } },
  });
}
function Et() {
...
async function Ot(e, t, n = 20, r = null) {
  return p.safeGet(`/wham/github/branches/{repo_id}/search`, {
    parameters: {
...
function Pt(e) {
  ...
  t[0] === e
    ? (r = t[1])
    : ((r = () =>
        p.safePost(`/wham/tasks/{task_id}/mark_read`, {
          parameters: { path: { task_id: e } },
        })),
      (t[0] = e),
      (t[1] = r));
...
async function It() {
  return p.safeGet(`/wham/accounts/check`);
}
function Lt(e) {
  let t = (0, $.c)(8),
    n;
...
async function Rt() {
  return p.safeGet(`/wham/onboarding/context`);
}
function zt(e) {
  return p.safePost(`/wham/statsig/bootstrap`, { requestBody: e });
}
function Bt() {
  let e = (0, $.c)(8),
    { data: t, isLoading: n, isError: r, errorUpdatedAt: i } = Ft(),
    a =
...
//# sourceMappingURL=codex-api-bK--r_2t.js.map
