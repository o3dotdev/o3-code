...
import { t as p } from "./chunk-55IACEB6-Dw4U87tB.js";
import { t as m } from "./chunk-QN33PNHL.js";
import { r as h } from "./chunk-N4CR4FBY-BeIHswHY.js";
var g = (function () {
    ...
    draw: n(async function (t, n, i, a) {
      ...
      try {
        (typeof a.db.getLinks == `function`
          ...
          (o.replaceChild(s, a),
            s.appendChild(a),
            r.info(`🔗 Wrapped node in <a> tag for:`, n, e.url));
        });
      } catch (e) {
    ...
    (r.trace(`items`, t),
      t.forEach((t) => {
        switch (t.stmt) {
          ...
          case C:
            {
              (X(e, t.state1, n, i, a, o, s, c),
                X(e, t.state2, n, i, a, o, s, c));
              let r = {
                id: `edge` + G,
                start: t.state1.id,
                end: t.state2.id,
...
var X = n((e, t, n, i, a, o, s, c) => {
    let d = t.id,
      f = n.get(d),
      p = Y(f),
      m = he(f),
      h = l();
    if ((r.info(`dataFetcher parsedItem`, t, f, m), d !== `root`)) {
      let n = P;
      (t.start === !0 ? (n = ee) : t.start === !1 && (n = te),
        t.type !== D && (n = t.type),
        W.get(d) ||
          W.set(d, {
            id: d,
      ...
      (t.description &&
        ...
        !l.type &&
          t.doc &&
          (r.info(`Setting cluster for XCX`, d, q(t)),
          (l.type = `group`),
          (l.isGroup = !0),
          (l.dir = q(t)),
      ...
      if (
        ...
        e &&
          e.id !== `root` &&
          (r.trace(`Setting node `, d, ` to be child of its parent `, e.id),
          (f.parentId = e.id)),
        (f.centerLabel = !0),
        t.note)
      ) {
    ...
    t.doc &&
      (r.trace(`Adding nodes children `), me(t, t.doc, n, i, a, !o, s, c));
  }, `dataFetcher`),
  ge = n(() => {
    (W.clear(), (G = 0));
  }, `reset`),
  ...
  _e = n(() => new Map(), `newClassesList`),
  Q = n(() => ({ relations: [], states: new Map(), documents: {} }), `newDoc`),
  ...
  ve = class {
    ...
    addState(
      ...
      if (
        (i &&
          (r.info(`Setting state description`, d, i),
      ...
      (o &&
        (r.info(`Setting state classes`, d, o),
        (Array.isArray(o) ? o : [o]).forEach((e) =>
          this.setCssClass(d, e.trim()),
        )),
        s &&
          (r.info(`Setting state styles`, d, s),
    ...
    addLink(e, t, n) {
      (this.links.set(e, { url: t, tooltip: n }),
