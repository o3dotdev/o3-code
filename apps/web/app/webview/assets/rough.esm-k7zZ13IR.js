    ...
    n = (function (e) {
      ...
      for (; e !== ``; )
        if (e.match(/^([ \t\r\n,]+)/)) e = e.substr(RegExp.$1.length);
          ...
          ((t[t.length] = { type: p, text: RegExp.$1 }),
            (e = e.substr(RegExp.$1.length)));
        else {
          if (
            !e.match(
            ...
            return [];
          ((t[t.length] = { type: m, text: `${parseFloat(RegExp.$1)}` }),
            (e = e.substr(RegExp.$1.length)));
        }
      return ((t[t.length] = { type: h, text: `` }), t);
    })(e),
    r = `BOD`,
    i = 0,
    a = n[i];
    ...
    switch (l) {
      ...
      case `A`: {
        ...
        e === 0 || n === 0
          ...
          : (r !== c || i !== l) &&
            (S(r, i, c, l, e, n, a, o, s).forEach(function (e) {
              t.push({ key: `C`, data: e });
            }),
            (r = c),
            (i = l));
...
function S(e, t, n, r, i, a, o, s, c, l) {
    ...
    return [O, k, A].concat(f);
  {
    ...
    for (let t = 0; t < f.length; t += 3) {
      let n = x(f[t][0], f[t][1], u),
        r = x(f[t + 1][0], f[t + 1][1], u),
        i = x(f[t + 2][0], f[t + 2][1], u);
...
function w(e, t, n, r, i) {
  return { type: `path`, ops: R(e, t, n, r, i) };
}
function T(e, t, n) {
  let r = (e || []).length;
  if (r > 2) {
    let i = [];
    for (let t = 0; t < r - 1; t++)
      i.push(...R(e[t][0], e[t][1], e[t + 1][0], e[t + 1][1], n));
    return (
      t && i.push(...R(e[r - 1][0], e[r - 1][1], e[0][0], e[0][1], n)),
      { type: `path`, ops: i }
    );
  }
  return r === 2
    ? w(e[0][0], e[0][1], e[1][0], e[1][1], n)
    : { type: `path`, ops: [] };
}
...
function D(e, t) {
  if (e.length) {
    let n = typeof e[0][0] == `number` ? [e] : e,
      r = B(n[0], 1 * (1 + 0.2 * t.roughness), t),
      i = t.disableMultiStroke
        ? []
        : B(n[0], 1.5 * (1 + 0.22 * t.roughness), P(t));
    for (let e = 1; e < n.length; e++) {
      let a = n[e];
      if (a.length) {
        let e = B(a, 1 * (1 + 0.2 * t.roughness), t),
          n = t.disableMultiStroke
            ? []
            : B(a, 1.5 * (1 + 0.22 * t.roughness), P(t));
...
function k(e, t, n, r) {
  let [i, a] = H(
      ...
      r.ry,
      1,
      r.increment * I(0.1, I(0.4, 1, n), n),
      n,
    ),
    o = V(i, null, n);
  if (!n.disableMultiStroke && n.roughness !== 0) {
    let [i] = H(r.increment, e, t, r.rx, r.ry, 1.5, 0, n),
      a = V(i, null, n);
    o = o.concat(a);
  }
...
function A(e, t, n, r, i, a, o, s, c) {
  ...
  return (
    o &&
      (s
        ? _.push(
            ...R(l, u, l + d * Math.cos(p), u + f * Math.sin(p), c),
            ...R(l, u, l + d * Math.cos(m), u + f * Math.sin(m), c),
          )
        : _.push(
            { op: `lineTo`, data: [l, u] },
...
function j(e, t) {
  ...
  for (let { key: e, data: o } of n)
    switch (e) {
      ...
      case `Z`:
        (r.push(...R(a[0], a[1], i[0], i[1], t)), (a = [i[0], i[1]]));
    }
  ...
  for (let r of e)
    if (r.length) {
      let e = t.maxRandomnessOffset || 0,
        i = r.length;
      if (i > 2) {
        n.push({ op: `move`, data: [r[0][0] + L(e, t), r[0][1] + L(e, t)] });
        for (let a = 1; a < i; a++)
          n.push({
            op: `lineTo`,
...
function B(e, t, n) {
  if (!e.length) return [];
  let r = [];
  (r.push([e[0][0] + L(t, n), e[0][1] + L(t, n)]),
    r.push([e[0][0] + L(t, n), e[0][1] + L(t, n)]));
  for (let i = 1; i < e.length; i++)
    (r.push([e[i][0] + L(t, n), e[i][1] + L(t, n)]),
      i === e.length - 1 && r.push([e[i][0] + L(t, n), e[i][1] + L(t, n)]));
  return V(r, null, n);
}
function V(e, t, n) {
  let r = e.length,
  ...
  if (r > 3) {
    ...
    if (t && t.length === 2) {
      ...
      i.push({ op: `lineTo`, data: [t[0] + L(e, n), t[1] + L(e, n)] });
    }
  } else
    r === 3
      ? (i.push({ op: `move`, data: [e[1][0], e[1][1]] }),
...
function H(e, t, n, r, i, a, o, s) {
  ...
  if (s.roughness === 0) {
    ...
    let u = L(0.5, s) - Math.PI / 2;
    l.push([
      L(a, s) + t + 0.9 * r * Math.cos(u - e),
      L(a, s) + n + 0.9 * i * Math.sin(u - e),
    ]);
    ...
    (l.push([
      L(a, s) + t + r * Math.cos(u + 2 * Math.PI + 0.5 * o),
      L(a, s) + n + i * Math.sin(u + 2 * Math.PI + 0.5 * o),
    ]),
      l.push([
        L(a, s) + t + 0.98 * r * Math.cos(u + o),
        L(a, s) + n + 0.98 * i * Math.sin(u + o),
      ]),
      l.push([
        L(a, s) + t + 0.9 * r * Math.cos(u + 0.5 * o),
        L(a, s) + n + 0.9 * i * Math.sin(u + 0.5 * o),
      ]));
  }
  return [l, c];
}
function U(e, t, n, r, i, a, o, s, c) {
  let l = a + L(0.1, c),
    u = [];
  u.push([
    L(s, c) + t + 0.9 * r * Math.cos(l - e),
    L(s, c) + n + 0.9 * i * Math.sin(l - e),
  ]);
  for (let a = l; a <= o; a += e)
    u.push([L(s, c) + t + r * Math.cos(a), L(s, c) + n + i * Math.sin(a)]);
  return (
...
function J(e, t, n, r) {
  ...
  if (
    ...
    let n = e[t + 0];
    (i.length
      ? ((a = i[i.length - 1]), (o = n), Math.sqrt(K(a, o))) > 1 && i.push(n)
      : i.push(n),
      i.push(e[t + 3]));
  } else {
    let r = 0.5,
      ...
      p = q(u, d, r),
      m = q(f, p, r);
    (J([a, l, f, m], 0, n, i), J([m, p, d, c], 0, n, i));
  }
  var a, o;
  return i;
}
...
var Z = `none`,
  Q = class {
            ...
            for (let r of e)
              r.length < 3
                ...
                : r.length === 3
                  ...
                  : t.push(...X(G(r), 10, (1 + n.roughness) / 2));
          }
    ...
    polygon(e, t) {
      ...
      return (
        n.fill &&
          (n.fillStyle === `solid` ? r.push(M([e], n)) : r.push(N([e], n))),
        n.stroke !== Z && r.push(i),
        this._d(`polygon`, r, n)
      );
    }
...
export { ae as t };
//# sourceMappingURL=rough.esm-k7zZ13IR.js.map
