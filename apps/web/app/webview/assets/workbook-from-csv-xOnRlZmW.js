import { a as e, n as t, s as n } from "./address-utils.js";
var r = `CSV import`,
  i = 31,
  a = /\\|\/|\?|\*|\[|\]|:/g;
function o(e) {
  return ((e ?? r).trim().replace(a, ``).trim() || r).slice(0, i);
}
function s(r, i) {
  let a = c(i?.separator),
    s = n(i?.anchor ?? `A1`),
...
export { s as planCsvImport, o as sanitizeSheetName };
//# sourceMappingURL=workbook-from-csv-xOnRlZmW.js.map
