...
var h = {
  encode(e, t = new f()) {
    return (
      ...
      e.transform !== void 0 &&
        Te.encode(e.transform, t.uint32(26).fork()).join(),
  ...
  decode(e, t) {
    ...
    for (; n.pos < r; ) {
      ...
      switch (e >>> 3) {
        ...
        case 3:
          if (e !== 26) break;
          i.transform = Te.decode(n, n.uint32());
          continue;
        case 4:
          if (e !== 34) break;
...
var g = {
  encode(e, t = new f()) {
    return (
      e.ref !== void 0 && ke.encode(e.ref, t.uint32(18).fork()).join(),
  ...
  fromPartial(e) {
    ...
    return (
      (t.ref =
        e.ref !== void 0 && e.ref !== null ? ke.fromPartial(e.ref) : void 0),
      (t.fill =
        e.fill !== void 0 && e.fill !== null ? _.fromPartial(e.fill) : void 0),
      t
    );
  },
};
...
var _ = {
  encode(e, t = new f()) {
    ...
    for (let n of e.gradientStops) ze.encode(n, t.uint32(26).fork()).join();
    return (
      ...
      e.stretchFillRect !== void 0 &&
        C.encode(e.stretchFillRect, t.uint32(122).fork()).join(),
      e.tile !== void 0 && Me.encode(e.tile, t.uint32(146).fork()).join(),
      e.duotone !== void 0 && Le.encode(e.duotone, t.uint32(130).fork()).join(),
      e.pattern !== void 0 && Pe.encode(e.pattern, t.uint32(138).fork()).join(),
      t
    );
  },
  decode(e, t) {
    ...
    for (; n.pos < r; ) {
      ...
      switch (e >>> 3) {
        ...
        case 3:
          if (e !== 26) break;
          i.gradientStops.push(ze.decode(n, n.uint32()));
          continue;
        case 4:
          if (e !== 34) break;
          i.relId = n.string();
        ...
        case 18:
          if (e !== 146) break;
          i.tile = Me.decode(n, n.uint32());
          continue;
        case 16:
          if (e !== 130) break;
          i.duotone = Le.decode(n, n.uint32());
          continue;
        case 17:
          if (e !== 138) break;
          i.pattern = Pe.decode(n, n.uint32());
          continue;
      }
      if ((e & 7) == 4 || e === 0) break;
      n.skip(e & 7);
    ...
    return (
      ...
      (t.color =
        e.color !== void 0 && e.color !== null
          ...
          : void 0),
      (t.gradientStops = e.gradientStops?.map((e) => ze.fromPartial(e)) || []),
      ...
      (t.stretchFillRect =
        e.stretchFillRect !== void 0 && e.stretchFillRect !== null
          ...
          : void 0),
      (t.tile =
        e.tile !== void 0 && e.tile !== null ? Me.fromPartial(e.tile) : void 0),
      (t.duotone =
        e.duotone !== void 0 && e.duotone !== null
          ? Le.fromPartial(e.duotone)
          : void 0),
      (t.pattern =
        e.pattern !== void 0 && e.pattern !== null
          ? Pe.fromPartial(e.pattern)
          : void 0),
      t
    );
  },
...
function Ne() {
  return { patternType: 0, color: void 0 };
}
var Pe = {
  encode(e, t = new f()) {
    return (
...
var Ve = {
  encode(e, t = new f()) {
    return (
      e.noAutofit !== void 0 &&
        Ue.encode(e.noAutofit, t.uint32(10).fork()).join(),
      e.normalAutoFit !== void 0 &&
        qe.encode(e.normalAutoFit, t.uint32(18).fork()).join(),
      e.shapeAutoFit !== void 0 &&
        Ge.encode(e.shapeAutoFit, t.uint32(26).fork()).join(),
      t
    );
  },
  decode(e, t) {
    ...
    for (; n.pos < r; ) {
      ...
      switch (e >>> 3) {
        case 1:
          if (e !== 10) break;
          i.noAutofit = Ue.decode(n, n.uint32());
          continue;
        case 2:
          if (e !== 18) break;
          i.normalAutoFit = qe.decode(n, n.uint32());
          continue;
        case 3:
          if (e !== 26) break;
          i.shapeAutoFit = Ge.decode(n, n.uint32());
          continue;
      }
      if ((e & 7) == 4 || e === 0) break;
      n.skip(e & 7);
    ...
    return (
      (t.noAutofit =
        e.noAutofit !== void 0 && e.noAutofit !== null
          ? Ue.fromPartial(e.noAutofit)
          : void 0),
      (t.normalAutoFit =
        e.normalAutoFit !== void 0 && e.normalAutoFit !== null
          ? qe.fromPartial(e.normalAutoFit)
          : void 0),
      (t.shapeAutoFit =
        e.shapeAutoFit !== void 0 && e.shapeAutoFit !== null
          ? Ge.fromPartial(e.shapeAutoFit)
          : void 0),
      t
    );
  },
...
var y = {
  encode(e, t = new f()) {
    return (
      ...
      e.autoFit !== void 0 && Ve.encode(e.autoFit, t.uint32(170).fork()).join(),
      t
    );
  },
  decode(e, t) {
    ...
    for (; n.pos < r; ) {
      ...
      switch (e >>> 3) {
        ...
        case 21:
          if (e !== 170) break;
          i.autoFit = Ve.decode(n, n.uint32());
          continue;
      }
      if ((e & 7) == 4 || e === 0) break;
      n.skip(e & 7);
...
var Ze = {
  encode(e, t = new f()) {
    (e.id !== `` && t.uint32(10).string(e.id),
      ...
      e.textStyle !== void 0 &&
        y.encode(e.textStyle, t.uint32(34).fork()).join(),
      e.paragraphStyle !== void 0 &&
        b.encode(e.paragraphStyle, t.uint32(42).fork()).join(),
...
var x = {
  encode(e, t = new f()) {
    return (
      ...
      e.textStyle !== void 0 &&
        y.encode(e.textStyle, t.uint32(26).fork()).join(),
      e.paragraphStyle !== void 0 &&
        b.encode(e.paragraphStyle, t.uint32(34).fork()).join(),
...
var S = {
  encode(e, t = new f()) {
    return (
      ...
      e.sketch !== void 0 && rt.encode(e.sketch, t.uint32(42).fork()).join(),
  ...
  encode(e, t = new f()) {
    return (
      ...
      e.contentLineRange !== void 0 &&
        ut.encode(e.contentLineRange, t.uint32(66).fork()).join(),
  ...
  decode(e, t) {
    ...
    for (; n.pos < r; ) {
      ...
      switch (e >>> 3) {
        ...
        case 8:
          if (e !== 66) break;
          i.contentLineRange = ut.decode(n, n.uint32());
          continue;
        case 9:
          if (e !== 74) break;
    ...
    return (
      ...
      (t.contentLineRange =
        e.contentLineRange !== void 0 && e.contentLineRange !== null
          ? ut.fromPartial(e.contentLineRange)
          : void 0),
...
var Tt = {
  encode(e, t = new f()) {
    return (
      ...
      e.context !== void 0 && Ct.encode(e.context, t.uint32(42).fork()).join(),
      t
    );
  },
  decode(e, t) {
    ...
    for (; n.pos < r; ) {
      ...
      switch (e >>> 3) {
        ...
        case 5:
          if (e !== 42) break;
          i.context = Ct.decode(n, n.uint32());
          continue;
      }
      if ((e & 7) == 4 || e === 0) break;
      n.skip(e & 7);
  ...
  encode(e, t = new f()) {
    return (
      e.spreadsheetCell !== void 0 &&
        ht.encode(e.spreadsheetCell, t.uint32(10).fork()).join(),
      e.spreadsheetRange !== void 0 &&
        _t.encode(e.spreadsheetRange, t.uint32(18).fork()).join(),
      e.slide !== void 0 && yt.encode(e.slide, t.uint32(26).fork()).join(),
      e.element !== void 0 && xt.encode(e.element, t.uint32(34).fork()).join(),
      e.textRange !== void 0 &&
        Tt.encode(e.textRange, t.uint32(42).fork()).join(),
      t
    );
  },
  decode(e, t) {
    ...
    for (; n.pos < r; ) {
      ...
      switch (e >>> 3) {
        case 1:
          if (e !== 10) break;
          i.spreadsheetCell = ht.decode(n, n.uint32());
          continue;
        case 2:
          if (e !== 18) break;
          i.spreadsheetRange = _t.decode(n, n.uint32());
          continue;
        case 3:
          if (e !== 26) break;
          i.slide = yt.decode(n, n.uint32());
          continue;
        case 4:
          if (e !== 34) break;
          i.element = xt.decode(n, n.uint32());
          continue;
        case 5:
          if (e !== 42) break;
          i.textRange = Tt.decode(n, n.uint32());
          continue;
      }
      if ((e & 7) == 4 || e === 0) break;
      n.skip(e & 7);
...
var Ft = {
  encode(e, t = new f()) {
    (e.id !== `` && t.uint32(10).string(e.id),
      ...
      e.body !== void 0 && pt.encode(e.body, t.uint32(50).fork()).join(),
    ...
    return (
      e.position !== void 0 &&
        Nt.encode(e.position, t.uint32(82).fork()).join(),
      t
    );
  },
  decode(e, t) {
    ...
    for (; n.pos < r; ) {
      ...
      switch (e >>> 3) {
        ...
        case 10:
          if (e !== 82) break;
          i.position = Nt.decode(n, n.uint32());
          continue;
      }
      if ((e & 7) == 4 || e === 0) break;
      n.skip(e & 7);
  ...
  fromPartial(e) {
    ...
    return (
      ...
      (t.body =
        e.body !== void 0 && e.body !== null ? pt.fromPartial(e.body) : void 0),
...
var T = {
    encode(e, t = new f()) {
      (e.id !== `` && t.uint32(10).string(e.id),
        e.target !== void 0 && Dt.encode(e.target, t.uint32(18).fork()).join());
      for (let n of e.comments) Ft.encode(n, t.uint32(26).fork()).join();
      return (
    ...
    decode(e, t) {
      ...
      for (; n.pos < r; ) {
        ...
        switch (e >>> 3) {
          ...
          case 2:
            if (e !== 18) break;
            i.target = Dt.decode(n, n.uint32());
            continue;
          case 3:
            if (e !== 26) break;
            i.comments.push(Ft.decode(n, n.uint32()));
            continue;
          case 4:
            if (e !== 32) break;
            i.status = n.int32();
      ...
      return (
        ...
        (t.target =
          e.target !== void 0 && e.target !== null
            ? Dt.fromPartial(e.target)
            : void 0),
        (t.comments = e.comments?.map((e) => Ft.fromPartial(e)) || []),
        (t.status = e.status ?? 0),
...
var O = {
  encode(e, t = new f()) {
    ...
    for (let n of e.series) hn.encode(n, t.uint32(26).fork()).join();
    (e.bbox !== void 0 && m.encode(e.bbox, t.uint32(34).fork()).join(),
      ...
      e.plotAreaLine !== void 0 &&
        S.encode(e.plotAreaLine, t.uint32(146).fork()).join(),
      e.pivot !== void 0 && pr.encode(e.pivot, t.uint32(154).fork()).join(),
      e.pivotOptions !== void 0 &&
        hr.encode(e.pivotOptions, t.uint32(162).fork()).join());
    for (let n of e.pivotFormats) _r.encode(n, t.uint32(170).fork()).join();
    return (
      e.mapOptions !== void 0 &&
        Yn.encode(e.mapOptions, t.uint32(178).fork()).join(),
      e.style !== void 0 && lr.encode(e.style, t.uint32(186).fork()).join(),
      ...
      e.view3d !== void 0 && xr.encode(e.view3d, t.uint32(330).fork()).join(),
      e.barOptions !== void 0 &&
        pn.encode(e.barOptions, t.uint32(402).fork()).join(),
      e.lineOptions !== void 0 &&
        Tn.encode(e.lineOptions, t.uint32(410).fork()).join(),
      e.areaOptions !== void 0 &&
        Dn.encode(e.areaOptions, t.uint32(418).fork()).join(),
      e.pieOptions !== void 0 &&
      ...
      e.doughnutOptions !== void 0 &&
        Nn.encode(e.doughnutOptions, t.uint32(434).fork()).join(),
      e.scatterOptions !== void 0 &&
        Fn.encode(e.scatterOptions, t.uint32(442).fork()).join(),
      e.bubbleOptions !== void 0 &&
        Ln.encode(e.bubbleOptions, t.uint32(450).fork()).join(),
      e.radarOptions !== void 0 &&
        zn.encode(e.radarOptions, t.uint32(458).fork()).join(),
      e.surfaceOptions !== void 0 &&
        Vn.encode(e.surfaceOptions, t.uint32(466).fork()).join(),
      e.treemapOptions !== void 0 &&
        $n.encode(e.treemapOptions, t.uint32(354).fork()).join(),
      e.boxWhiskerOptions !== void 0 &&
        tr.encode(e.boxWhiskerOptions, t.uint32(362).fork()).join(),
      e.histogramOptions !== void 0 &&
        rr.encode(e.histogramOptions, t.uint32(370).fork()).join(),
      e.waterfallOptions !== void 0 &&
        ar.encode(e.waterfallOptions, t.uint32(378).fork()).join(),
      e.funnelOptions !== void 0 &&
        sr.encode(e.funnelOptions, t.uint32(386).fork()).join(),
      t
    );
  },
  decode(e, t) {
    ...
    for (; n.pos < r; ) {
      ...
      switch (e >>> 3) {
        ...
        case 3:
          if (e !== 26) break;
          i.series.push(hn.decode(n, n.uint32()));
          continue;
        case 4:
          if (e !== 34) break;
        ...
        case 19:
          if (e !== 154) break;
          i.pivot = pr.decode(n, n.uint32());
          continue;
        case 20:
          if (e !== 162) break;
          i.pivotOptions = hr.decode(n, n.uint32());
          continue;
        case 21:
          if (e !== 170) break;
          i.pivotFormats.push(_r.decode(n, n.uint32()));
          continue;
        case 22:
          if (e !== 178) break;
          i.mapOptions = Yn.decode(n, n.uint32());
          continue;
        case 23:
          if (e !== 186) break;
          i.style = lr.decode(n, n.uint32());
          continue;
        case 28:
          if (e !== 224) break;
        ...
        case 41:
          if (e !== 330) break;
          i.view3d = xr.decode(n, n.uint32());
          continue;
        case 50:
          if (e !== 402) break;
          i.barOptions = pn.decode(n, n.uint32());
          continue;
        case 51:
          if (e !== 410) break;
          i.lineOptions = Tn.decode(n, n.uint32());
          continue;
        case 52:
          if (e !== 418) break;
          i.areaOptions = Dn.decode(n, n.uint32());
          continue;
        case 53:
          if (e !== 426) break;
        ...
        case 54:
          if (e !== 434) break;
          i.doughnutOptions = Nn.decode(n, n.uint32());
          continue;
        case 55:
          if (e !== 442) break;
          i.scatterOptions = Fn.decode(n, n.uint32());
          continue;
        case 56:
          if (e !== 450) break;
          i.bubbleOptions = Ln.decode(n, n.uint32());
          continue;
        case 57:
          if (e !== 458) break;
          i.radarOptions = zn.decode(n, n.uint32());
          continue;
        case 58:
          if (e !== 466) break;
          i.surfaceOptions = Vn.decode(n, n.uint32());
          continue;
        case 44:
          if (e !== 354) break;
          i.treemapOptions = $n.decode(n, n.uint32());
          continue;
        case 45:
          if (e !== 362) break;
          i.boxWhiskerOptions = tr.decode(n, n.uint32());
          continue;
        case 46:
          if (e !== 370) break;
          i.histogramOptions = rr.decode(n, n.uint32());
          continue;
        case 47:
          if (e !== 378) break;
          i.waterfallOptions = ar.decode(n, n.uint32());
          continue;
        case 48:
          if (e !== 386) break;
          i.funnelOptions = sr.decode(n, n.uint32());
          continue;
      }
      if ((e & 7) == 4 || e === 0) break;
      n.skip(e & 7);
  ...
  fromPartial(e) {
    ...
    return (
      ...
      (t.series = e.series?.map((e) => hn.fromPartial(e)) || []),
      (t.bbox =
...
var hn = {
  encode(e, t = new f()) {
    ...
    for (let n of e.points) Un.encode(n, t.uint32(82).fork()).join();
    (e.valuesFormatCode !== void 0 && t.uint32(90).string(e.valuesFormatCode),
      ...
      e.marker !== void 0 && yr.encode(e.marker, t.uint32(130).fork()).join(),
      t.uint32(138).fork());
    ...
    for (let n of e.categoryPaths) Zn.encode(n, t.uint32(178).fork()).join();
    e.dataLabels !== void 0 &&
      A.encode(e.dataLabels, t.uint32(186).fork()).join();
    for (let n of e.dataLabelOverrides)
      qn.encode(n, t.uint32(194).fork()).join();
    for (let n of e.trendlines) Cn.encode(n, t.uint32(202).fork()).join();
    return t;
  },
  decode(e, t) {
    let n = e instanceof p ? e : new p(e),
    ...
    for (; n.pos < r; ) {
      ...
      switch (e >>> 3) {
        ...
        case 10:
          if (e !== 82) break;
          i.points.push(Un.decode(n, n.uint32()));
          continue;
        case 11:
          if (e !== 90) break;
        ...
        case 22:
          if (e !== 178) break;
          i.categoryPaths.push(Zn.decode(n, n.uint32()));
          continue;
        case 23:
          if (e !== 186) break;
          i.dataLabels = A.decode(n, n.uint32());
        ...
        case 24:
          if (e !== 194) break;
          i.dataLabelOverrides.push(qn.decode(n, n.uint32()));
          continue;
        case 25:
          if (e !== 202) break;
          i.trendlines.push(Cn.decode(n, n.uint32()));
          continue;
      }
      if ((e & 7) == 4 || e === 0) break;
      n.skip(e & 7);
    ...
    return (
      ...
      (t.stroke =
        e.stroke !== void 0 && e.stroke !== null
          ? S.fromPartial(e.stroke)
          : void 0),
      (t.points = e.points?.map((e) => Un.fromPartial(e)) || []),
      ...
      (t.categoryPaths = e.categoryPaths?.map((e) => Zn.fromPartial(e)) || []),
      (t.dataLabels =
        e.dataLabels !== void 0 && e.dataLabels !== null
          ? A.fromPartial(e.dataLabels)
          : void 0),
      (t.dataLabelOverrides =
        e.dataLabelOverrides?.map((e) => qn.fromPartial(e)) || []),
      (t.trendlines = e.trendlines?.map((e) => Cn.fromPartial(e)) || []),
      t
    );
  },
};
  ...
  encode(e, t = new f()) {
    (e.text !== void 0 && t.uint32(10).string(e.text),
      ...
      e.manualLayout !== void 0 &&
        _n.encode(e.manualLayout, t.uint32(34).fork()).join(),
      e.textStyle !== void 0 &&
        y.encode(e.textStyle, t.uint32(42).fork()).join(),
      e.fill !== void 0 && _.encode(e.fill, t.uint32(50).fork()).join(),
      e.stroke !== void 0 && S.encode(e.stroke, t.uint32(58).fork()).join());
    for (let n of e.textRuns) xn.encode(n, t.uint32(66).fork()).join();
    return t;
  },
  decode(e, t) {
    let n = e instanceof p ? e : new p(e),
    ...
    for (; n.pos < r; ) {
      ...
      switch (e >>> 3) {
        ...
        case 4:
          if (e !== 34) break;
          i.manualLayout = _n.decode(n, n.uint32());
          continue;
        case 5:
          if (e !== 42) break;
          i.textStyle = y.decode(n, n.uint32());
        ...
        case 8:
          if (e !== 66) break;
          i.textRuns.push(xn.decode(n, n.uint32()));
          continue;
      }
      if ((e & 7) == 4 || e === 0) break;
      n.skip(e & 7);
    ...
    return (
      ...
      (t.stroke =
        e.stroke !== void 0 && e.stroke !== null
          ? S.fromPartial(e.stroke)
          : void 0),
      (t.textRuns = e.textRuns?.map((e) => xn.fromPartial(e)) || []),
      t
    );
  },
};
...
var xn = {
  encode(e, t = new f()) {
    return (
      ...
      e.textStyle !== void 0 &&
        y.encode(e.textStyle, t.uint32(18).fork()).join(),
      t
    );
  },
  decode(e, t) {
...
var Cn = {
  encode(e, t = new f()) {
    return (
      ...
      e.label !== void 0 && yn.encode(e.label, t.uint32(90).fork()).join(),
      t
    );
  },
  decode(e, t) {
...
var k = {
  encode(e, t = new f()) {
    return (
      e.textStyle !== void 0 &&
        y.encode(e.textStyle, t.uint32(10).fork()).join(),
      ...
      e.majorGridlines !== void 0 &&
        S.encode(e.majorGridlines, t.uint32(42).fork()).join(),
      e.minorGridlines !== void 0 &&
        S.encode(e.minorGridlines, t.uint32(50).fork()).join(),
      ...
      e.titleTextStyle !== void 0 &&
        y.encode(e.titleTextStyle, t.uint32(162).fork()).join(),
      t
    );
  },
  decode(e, t) {
  ...
  encode(e, t = new f()) {
    return (
      ...
      e.textStyle !== void 0 &&
        y.encode(e.textStyle, t.uint32(26).fork()).join(),
      e.leaderLine !== void 0 &&
        S.encode(e.leaderLine, t.uint32(34).fork()).join(),
  ...
  encode(e, t = new f()) {
    ...
    return (
      ...
      e.colorScaleEx !== void 0 &&
        dr.encode(e.colorScaleEx, t.uint32(90).fork()).join(),
      t
    );
  },
  decode(e, t) {
    ...
    for (; n.pos < r; ) {
      ...
      switch (e >>> 3) {
        ...
        case 11:
          if (e !== 90) break;
          i.colorScaleEx = dr.decode(n, n.uint32());
          continue;
      }
      if ((e & 7) == 4 || e === 0) break;
      n.skip(e & 7);
    ...
    return (
      ...
      (t.stroke =
        e.stroke !== void 0 && e.stroke !== null
          ...
          : void 0),
      (t.text =
        e.text !== void 0 && e.text !== null ? y.fromPartial(e.text) : void 0),
      t
    );
  },
};
...
var Nr = {
  encode(e, t = new f()) {
    ...
    e.theme !== void 0 && Fr.encode(e.theme, t.uint32(18).fork()).join();
    for (let n of e.layouts) P.encode(n, t.uint32(26).fork()).join();
    for (let n of e.charts) O.encode(n, t.uint32(74).fork()).join();
    for (let n of e.images) ot.encode(n, t.uint32(34).fork()).join();
    for (let n of e.contentReferences) ct.encode(n, t.uint32(42).fork()).join();
    for (let n of e.people) w.encode(n, t.uint32(90).fork()).join();
    for (let n of e.threads) T.encode(n, t.uint32(98).fork()).join();
    for (let n of e.textStyles) Ze.encode(n, t.uint32(50).fork()).join();
    return (
      e.tableStyles !== void 0 &&
        N.encode(e.tableStyles, t.uint32(58).fork()).join(),
      t
    );
  },
  decode(e, t) {
    ...
    for (; n.pos < r; ) {
      ...
      switch (e >>> 3) {
        ...
        case 2:
          if (e !== 18) break;
          i.theme = Fr.decode(n, n.uint32());
          continue;
        case 3:
          if (e !== 26) break;
          i.layouts.push(P.decode(n, n.uint32()));
          continue;
        case 9:
          if (e !== 74) break;
        ...
        case 4:
          if (e !== 34) break;
          i.images.push(ot.decode(n, n.uint32()));
          continue;
        case 5:
          if (e !== 42) break;
          i.contentReferences.push(ct.decode(n, n.uint32()));
          continue;
        case 11:
          if (e !== 90) break;
          i.people.push(w.decode(n, n.uint32()));
          continue;
        case 12:
          if (e !== 98) break;
        ...
        case 6:
          if (e !== 50) break;
          i.textStyles.push(Ze.decode(n, n.uint32()));
          continue;
        case 7:
          if (e !== 58) break;
          i.tableStyles = N.decode(n, n.uint32());
          continue;
      }
      if ((e & 7) == 4 || e === 0) break;
      n.skip(e & 7);
    ...
    return (
      ...
      (t.theme =
        e.theme !== void 0 && e.theme !== null
          ? Fr.fromPartial(e.theme)
          : void 0),
      (t.layouts = e.layouts?.map((e) => P.fromPartial(e)) || []),
      (t.charts = e.charts?.map((e) => O.fromPartial(e)) || []),
      (t.images = e.images?.map((e) => ot.fromPartial(e)) || []),
      (t.contentReferences =
        e.contentReferences?.map((e) => ct.fromPartial(e)) || []),
      (t.people = e.people?.map((e) => w.fromPartial(e)) || []),
      (t.threads = e.threads?.map((e) => T.fromPartial(e)) || []),
      (t.textStyles = e.textStyles?.map((e) => Ze.fromPartial(e)) || []),
      (t.tableStyles =
        e.tableStyles !== void 0 && e.tableStyles !== null
          ? N.fromPartial(e.tableStyles)
          : void 0),
      t
    );
  },
...
var Fr = {
  encode(e, t = new f()) {
    e.colorScheme !== void 0 &&
      j.encode(e.colorScheme, t.uint32(10).fork()).join();
    ...
    for (let n of e.effectStyleList) fi.encode(n, t.uint32(34).fork()).join();
    return t;
  },
  decode(e, t) {
    let n = e instanceof p ? e : new p(e),
    ...
    for (; n.pos < r; ) {
      ...
      switch (e >>> 3) {
        case 1:
          if (e !== 10) break;
          i.colorScheme = j.decode(n, n.uint32());
          continue;
        case 2:
          if (e !== 18) break;
        ...
        case 4:
          if (e !== 34) break;
          i.effectStyleList.push(fi.decode(n, n.uint32()));
          continue;
      }
      if ((e & 7) == 4 || e === 0) break;
      n.skip(e & 7);
  ...
  fromPartial(e) {
    ...
    return (
      ...
      (t.effectStyleList =
        e.effectStyleList?.map((e) => fi.fromPartial(e)) || []),
      t
    );
  },
};
...
var P = {
  encode(e, t = new f()) {
    ...
    return (
      ...
      e.colorMap !== void 0 &&
        Ni.encode(e.colorMap, t.uint32(130).fork()).join(),
      t
    );
  },
  decode(e, t) {
    ...
    for (; n.pos < r; ) {
      ...
      switch (e >>> 3) {
        ...
        case 16:
          if (e !== 130) break;
          i.colorMap = Ni.decode(n, n.uint32());
          continue;
      }
      if ((e & 7) == 4 || e === 0) break;
      n.skip(e & 7);
  ...
  fromPartial(e) {
    ...
    return (
      ...
      (t.bodyLevelStyles =
        e.bodyLevelStyles?.map((e) => x.fromPartial(e)) || []),
      (t.titleLevelStyles =
        e.titleLevelStyles?.map((e) => x.fromPartial(e)) || []),
      (t.otherLevelStyles =
        e.otherLevelStyles?.map((e) => x.fromPartial(e)) || []),
      (t.parentLayoutId = e.parentLayoutId ?? ``),
      (t.colorMap =
        e.colorMap !== void 0 && e.colorMap !== null
          ? Ni.fromPartial(e.colorMap)
          : void 0),
      t
    );
  },
...
var I = {
  encode(e, t = new f()) {
    (e.bbox !== void 0 && m.encode(e.bbox, t.uint32(10).fork()).join(),
      ...
      e.innerXml !== void 0 && t.uint32(58).string(e.innerXml),
      e.outerXml !== void 0 && t.uint32(66).string(e.outerXml),
      e.shape !== void 0 && Ti.encode(e.shape, t.uint32(34).fork()).join(),
      e.image !== void 0 && ki.encode(e.image, t.uint32(42).fork()).join(),
      e.chartReference !== void 0 &&
        W.encode(e.chartReference, t.uint32(146).fork()).join(),
      e.video !== void 0 && ji.encode(e.video, t.uint32(162).fork()).join(),
      e.table !== void 0 && Qr.encode(e.table, t.uint32(170).fork()).join(),
      e.imageReference !== void 0 &&
        v.encode(e.imageReference, t.uint32(26).fork()).join(),
      e.codeBlock !== void 0 &&
        ia.encode(e.codeBlock, t.uint32(74).fork()).join());
    ...
    (e.name !== void 0 && t.uint32(82).string(e.name),
      ...
      e.textStyle !== void 0 &&
        y.encode(e.textStyle, t.uint32(114).fork()).join());
    ...
    (e.fill !== void 0 && _.encode(e.fill, t.uint32(154).fork()).join(),
      ...
      e.scene3d !== void 0 && R.encode(e.scene3d, t.uint32(250).fork()).join(),
      e.shape3d !== void 0 && z.encode(e.shape3d, t.uint32(258).fork()).join(),
      e.imageMask !== void 0 &&
      ...
      e.connector !== void 0 &&
        G.encode(e.connector, t.uint32(226).fork()).join());
  ...
  decode(e, t) {
    ...
    for (; n.pos < r; ) {
      ...
      switch (e >>> 3) {
        ...
        case 4:
          if (e !== 34) break;
          i.shape = Ti.decode(n, n.uint32());
          continue;
        case 5:
          if (e !== 42) break;
          i.image = ki.decode(n, n.uint32());
          continue;
        case 18:
          if (e !== 146) break;
          i.chartReference = W.decode(n, n.uint32());
          continue;
        case 20:
          if (e !== 162) break;
          i.video = ji.decode(n, n.uint32());
          continue;
        case 21:
          if (e !== 170) break;
          i.table = Qr.decode(n, n.uint32());
          continue;
        case 3:
          if (e !== 26) break;
          i.imageReference = v.decode(n, n.uint32());
        ...
        case 9:
          if (e !== 74) break;
          i.codeBlock = ia.decode(n, n.uint32());
          continue;
        case 6:
          if (e !== 50) break;
        ...
        case 31:
          if (e !== 250) break;
          i.scene3d = R.decode(n, n.uint32());
          continue;
        case 32:
          if (e !== 258) break;
          i.shape3d = z.decode(n, n.uint32());
          continue;
        case 33:
          if (e !== 266) break;
        ...
        case 28:
          if (e !== 226) break;
          i.connector = G.decode(n, n.uint32());
          continue;
        case 29:
          if (e !== 234) break;
          i.citations.push(n.string());
    ...
    return (
      ...
      (t.scene3d =
        e.scene3d !== void 0 && e.scene3d !== null
          ? R.fromPartial(e.scene3d)
          : void 0),
      (t.shape3d =
        e.shape3d !== void 0 && e.shape3d !== null
          ? z.fromPartial(e.shape3d)
          : void 0),
      (t.imageMask =
...
var R = {
  encode(e, t = new f()) {
    return (
      e.camera !== void 0 && V.encode(e.camera, t.uint32(10).fork()).join(),
      e.lightRig !== void 0 && H.encode(e.lightRig, t.uint32(18).fork()).join(),
      t
    );
  },
  decode(e, t) {
    ...
    for (; n.pos < r; ) {
      ...
      switch (e >>> 3) {
        case 1:
          if (e !== 10) break;
          i.camera = V.decode(n, n.uint32());
          continue;
        case 2:
          if (e !== 18) break;
          i.lightRig = H.decode(n, n.uint32());
          continue;
      }
      if ((e & 7) == 4 || e === 0) break;
      n.skip(e & 7);
    ...
    return (
      (t.camera =
        e.camera !== void 0 && e.camera !== null
          ? V.fromPartial(e.camera)
          : void 0),
      (t.lightRig =
        e.lightRig !== void 0 && e.lightRig !== null
          ? H.fromPartial(e.lightRig)
          : void 0),
      t
    );
  },
...
var z = {
  encode(e, t = new f()) {
    return (
      ...
      e.bevelTop !== void 0 && B.encode(e.bevelTop, t.uint32(42).fork()).join(),
      e.bevelBottom !== void 0 &&
        B.encode(e.bevelBottom, t.uint32(50).fork()).join(),
  ...
  decode(e, t) {
    ...
    for (; n.pos < r; ) {
      ...
      switch (e >>> 3) {
        ...
        case 5:
          if (e !== 42) break;
          i.bevelTop = B.decode(n, n.uint32());
          continue;
        case 6:
          if (e !== 50) break;
          i.bevelBottom = B.decode(n, n.uint32());
          continue;
        case 7:
          if (e !== 58) break;
    ...
    return (
      ...
      (t.bevelTop =
        e.bevelTop !== void 0 && e.bevelTop !== null
          ? B.fromPartial(e.bevelTop)
          : void 0),
      (t.bevelBottom =
        e.bevelBottom !== void 0 && e.bevelBottom !== null
          ? B.fromPartial(e.bevelBottom)
          : void 0),
      (t.extrusionColor =
...
var V = {
  encode(e, t = new f()) {
    return (
      ...
      e.rotation !== void 0 && U.encode(e.rotation, t.uint32(18).fork()).join(),
      t
    );
  },
  decode(e, t) {
    ...
    for (; n.pos < r; ) {
      ...
      switch (e >>> 3) {
        ...
        case 2:
          if (e !== 18) break;
          i.rotation = U.decode(n, n.uint32());
          continue;
      }
      if ((e & 7) == 4 || e === 0) break;
      n.skip(e & 7);
...
var H = {
  encode(e, t = new f()) {
    return (
      ...
      e.rotation !== void 0 && U.encode(e.rotation, t.uint32(26).fork()).join(),
      t
    );
  },
  decode(e, t) {
...
var G = {
  encode(e, t = new f()) {
    return (
      ...
      e.lineStyle !== void 0 &&
        fa.encode(e.lineStyle, t.uint32(42).fork()).join(),
      t
    );
  },
  decode(e, t) {
    ...
    for (; n.pos < r; ) {
      ...
      switch (e >>> 3) {
        ...
        case 5:
          if (e !== 42) break;
          i.lineStyle = fa.decode(n, n.uint32());
          continue;
      }
      if ((e & 7) == 4 || e === 0) break;
      n.skip(e & 7);
...
var Qr = {
  encode(e, t = new f()) {
    for (let n of e.rows) oi.encode(n, t.uint32(10).fork()).join();
    t.uint32(18).fork();
    for (let n of e.columnWidths) t.int32(n);
    return (
      t.join(),
      e.properties !== void 0 &&
        ei.encode(e.properties, t.uint32(26).fork()).join(),
      t
    );
  },
  decode(e, t) {
    ...
    for (; n.pos < r; ) {
      ...
      switch (e >>> 3) {
        case 1:
          if (e !== 10) break;
          i.rows.push(oi.decode(n, n.uint32()));
          continue;
        case 2:
          if (e === 16) {
        ...
        case 3:
          if (e !== 26) break;
          i.properties = ei.decode(n, n.uint32());
          continue;
      }
      if ((e & 7) == 4 || e === 0) break;
      n.skip(e & 7);
...
var ei = {
  encode(e, t = new f()) {
    ...
    return (e.styleXml !== void 0 && t.uint32(90).string(e.styleXml), t);
  },
  decode(e, t) {
    let n = e instanceof p ? e : new p(e),
      r = t === void 0 ? n.len : n.pos + t,
...
var ni = {
  encode(e, t = new f()) {
    ...
    return (
      e.fill !== void 0 && _.encode(e.fill, t.uint32(42).fork()).join(),
      e.lines !== void 0 && ii.encode(e.lines, t.uint32(50).fork()).join(),
...
var ii = {
  encode(e, t = new f()) {
    return (
      ...
      e.diagonalDown !== void 0 &&
        S.encode(e.diagonalDown, t.uint32(42).fork()).join(),
      e.diagonalUp !== void 0 &&
        S.encode(e.diagonalUp, t.uint32(50).fork()).join(),
      t
    );
  },
  decode(e, t) {
  ...
  fromPartial(e) {
    ...
    return (
      (t.top =
        e.top !== void 0 && e.top !== null ? S.fromPartial(e.top) : void 0),
      (t.right =
        e.right !== void 0 && e.right !== null
          ? S.fromPartial(e.right)
          : void 0),
      (t.bottom =
        e.bottom !== void 0 && e.bottom !== null
          ? S.fromPartial(e.bottom)
          : void 0),
      (t.left =
        e.left !== void 0 && e.left !== null ? S.fromPartial(e.left) : void 0),
      (t.diagonalDown =
...
var oi = {
  encode(e, t = new f()) {
    ...
    for (let n of e.cells) ni.encode(n, t.uint32(10).fork()).join();
  ...
  decode(e, t) {
    ...
    for (; n.pos < r; ) {
      ...
      switch (e >>> 3) {
        ...
        case 1:
          if (e !== 10) break;
          i.cells.push(ni.decode(n, n.uint32()));
          continue;
        case 2:
          if (e !== 16) break;
          i.heightEmu = n.int32();
  ...
  fromPartial(e) {
    ...
    return (
      (t.id = e.id ?? void 0),
      (t.cells = e.cells?.map((e) => ni.fromPartial(e)) || []),
      (t.heightEmu = e.heightEmu ?? void 0),
      t
    );
  },
...
var K = {
  encode(e, t = new f()) {
    ...
    for (let n of e.runs) li.encode(n, t.uint32(10).fork()).join();
    return (
      e.textStyle !== void 0 &&
        y.encode(e.textStyle, t.uint32(18).fork()).join(),
      ...
      e.paragraphStyle !== void 0 &&
        b.encode(e.paragraphStyle, t.uint32(82).fork()).join(),
  ...
  decode(e, t) {
    ...
    for (; n.pos < r; ) {
      ...
      switch (e >>> 3) {
        ...
        case 1:
          if (e !== 10) break;
          i.runs.push(li.decode(n, n.uint32()));
          continue;
        case 2:
          if (e !== 18) break;
          i.textStyle = y.decode(n, n.uint32());
  ...
  fromPartial(e) {
    ...
    return (
      (t.id = e.id ?? void 0),
      (t.runs = e.runs?.map((e) => li.fromPartial(e)) || []),
      (t.textStyle =
        e.textStyle !== void 0 && e.textStyle !== null
          ? y.fromPartial(e.textStyle)
          : void 0),
...
var J = {
  encode(e, t = new f()) {
    return (
      e.type !== 0 && t.uint32(8).int32(e.type),
      e.shadow !== void 0 && xi.encode(e.shadow, t.uint32(18).fork()).join(),
      e.glow !== void 0 && hi.encode(e.glow, t.uint32(26).fork()).join(),
      e.reflection !== void 0 &&
        yi.encode(e.reflection, t.uint32(34).fork()).join(),
      e.softEdges !== void 0 &&
        _i.encode(e.softEdges, t.uint32(42).fork()).join(),
      t
    );
  },
  decode(e, t) {
    ...
    for (; n.pos < r; ) {
      ...
      switch (e >>> 3) {
        ...
        case 2:
          if (e !== 18) break;
          i.shadow = xi.decode(n, n.uint32());
          continue;
        case 3:
          if (e !== 26) break;
          i.glow = hi.decode(n, n.uint32());
          continue;
        case 4:
          if (e !== 34) break;
          i.reflection = yi.decode(n, n.uint32());
          continue;
        case 5:
          if (e !== 42) break;
          i.softEdges = _i.decode(n, n.uint32());
          continue;
      }
      if ((e & 7) == 4 || e === 0) break;
      n.skip(e & 7);
    ...
    return (
      ...
      (t.shadow =
        e.shadow !== void 0 && e.shadow !== null
          ? xi.fromPartial(e.shadow)
          : void 0),
      (t.glow =
        e.glow !== void 0 && e.glow !== null ? hi.fromPartial(e.glow) : void 0),
      (t.reflection =
        e.reflection !== void 0 && e.reflection !== null
          ? yi.fromPartial(e.reflection)
          : void 0),
      (t.softEdges =
        e.softEdges !== void 0 && e.softEdges !== null
          ? _i.fromPartial(e.softEdges)
          : void 0),
      t
    );
  },
...
var Ti = {
  encode(e, t = new f()) {
    ...
    e.rectFormula !== void 0 &&
      Fi.encode(e.rectFormula, t.uint32(66).fork()).join();
    for (let n of e.customPaths) Xi.encode(n, t.uint32(74).fork()).join();
    return t;
  },
  decode(e, t) {
    let n = e instanceof p ? e : new p(e),
    ...
    for (; n.pos < r; ) {
      ...
      switch (e >>> 3) {
        ...
        case 8:
          if (e !== 66) break;
          i.rectFormula = Fi.decode(n, n.uint32());
          continue;
        case 9:
          if (e !== 74) break;
          i.customPaths.push(Xi.decode(n, n.uint32()));
          continue;
      }
      if ((e & 7) == 4 || e === 0) break;
      n.skip(e & 7);
    ...
    return (
      ...
      (t.rectFormula =
        e.rectFormula !== void 0 && e.rectFormula !== null
          ? Fi.fromPartial(e.rectFormula)
          : void 0),
      (t.customPaths = e.customPaths?.map((e) => Xi.fromPartial(e)) || []),
      t
    );
  },
};
...
var Ji = {
  encode(e, t = new f()) {
    return (
      e.moveTo !== void 0 && Li.encode(e.moveTo, t.uint32(10).fork()).join(),
      e.lineTo !== void 0 && zi.encode(e.lineTo, t.uint32(18).fork()).join(),
      e.close !== void 0 && Vi.encode(e.close, t.uint32(26).fork()).join(),
      e.quadBezTo !== void 0 &&
        Ui.encode(e.quadBezTo, t.uint32(34).fork()).join(),
      e.cubicBezTo !== void 0 &&
        Gi.encode(e.cubicBezTo, t.uint32(42).fork()).join(),
      e.arcTo !== void 0 && Z.encode(e.arcTo, t.uint32(50).fork()).join(),
      t
    );
  },
  decode(e, t) {
    ...
    for (; n.pos < r; ) {
      ...
      switch (e >>> 3) {
        case 1:
          if (e !== 10) break;
          i.moveTo = Li.decode(n, n.uint32());
          continue;
        case 2:
          if (e !== 18) break;
          i.lineTo = zi.decode(n, n.uint32());
          continue;
        case 3:
          if (e !== 26) break;
          i.close = Vi.decode(n, n.uint32());
          continue;
        case 4:
          if (e !== 34) break;
          i.quadBezTo = Ui.decode(n, n.uint32());
          continue;
        case 5:
          if (e !== 42) break;
          i.cubicBezTo = Gi.decode(n, n.uint32());
          continue;
        case 6:
          if (e !== 50) break;
          i.arcTo = Z.decode(n, n.uint32());
          continue;
      }
      if ((e & 7) == 4 || e === 0) break;
      n.skip(e & 7);
...
var Xi = {
  encode(e, t = new f()) {
    ...
    for (let n of e.commands) Ji.encode(n, t.uint32(26).fork()).join();
    return t;
  },
  decode(e, t) {
    let n = e instanceof p ? e : new p(e),
    ...
    for (; n.pos < r; ) {
      ...
      switch (e >>> 3) {
        ...
        case 3:
          if (e !== 26) break;
          i.commands.push(Ji.decode(n, n.uint32()));
          continue;
      }
      if ((e & 7) == 4 || e === 0) break;
      n.skip(e & 7);
  ...
  fromPartial(e) {
    ...
    return (
      ...
      (t.widthEmu = e.widthEmu ?? 0),
      (t.heightEmu = e.heightEmu ?? 0),
      (t.commands = e.commands?.map((e) => Ji.fromPartial(e)) || []),
      t
    );
  },
};
...
var ia = {
  encode(e, t = new f()) {
    return (
      ...
      e.theme !== void 0 && Qi.encode(e.theme, t.uint32(26).fork()).join(),
      e.script !== void 0 && ca.encode(e.script, t.uint32(58).fork()).join(),
      t
    );
  },
  decode(e, t) {
    ...
    for (; n.pos < r; ) {
      ...
      switch (e >>> 3) {
        ...
        case 3:
          if (e !== 26) break;
          i.theme = Qi.decode(n, n.uint32());
          continue;
        case 7:
          if (e !== 58) break;
          i.script = ca.decode(n, n.uint32());
          continue;
      }
      if ((e & 7) == 4 || e === 0) break;
      n.skip(e & 7);
  ...
  fromPartial(e) {
    ...
    return (
      ...
      (t.theme =
        e.theme !== void 0 && e.theme !== null
          ? Qi.fromPartial(e.theme)
          : void 0),
      (t.script =
        e.script !== void 0 && e.script !== null
          ? ca.fromPartial(e.script)
          : void 0),
      t
    );
  },
...
var ca = {
  encode(e, t = new f()) {
    return (
      ...
      e.result !== void 0 && ua.encode(e.result, t.uint32(50).fork()).join(),
      e.execution !== void 0 &&
        na.encode(e.execution, t.uint32(58).fork()).join(),
      t
    );
  },
  decode(e, t) {
    ...
    for (; n.pos < r; ) {
      ...
      switch (e >>> 3) {
        ...
        case 6:
          if (e !== 50) break;
          i.result = ua.decode(n, n.uint32());
          continue;
        case 7:
          if (e !== 58) break;
          i.execution = na.decode(n, n.uint32());
          continue;
      }
      if ((e & 7) == 4 || e === 0) break;
      n.skip(e & 7);
    ...
    return (
      ...
      (t.result =
        e.result !== void 0 && e.result !== null
          ? ua.fromPartial(e.result)
          : void 0),
      (t.execution =
        e.execution !== void 0 && e.execution !== null
          ? na.fromPartial(e.execution)
          : void 0),
      t
    );
  },
...
function $(e) {
  let t = ma.Number(e.toString());
  if (t > ma.Number.MAX_SAFE_INTEGER)
    throw new ma.Error(`Value is larger than Number.MAX_SAFE_INTEGER`);
  if (t < ma.Number.MIN_SAFE_INTEGER)
    throw new ma.Error(`Value is smaller than Number.MIN_SAFE_INTEGER`);
  return t;
}
export {
  F as $,
...
//# sourceMappingURL=presentation-CPM6LXA8.js.map
