import { i as e, n as t, o as n, r, t as i } from "./tslib.es6-PiNIxp0T.js";
import { a, f as o, p as s } from "./middleware-DR_TC0-Y.js";
import { l as c } from "./load-script-CxIfiYMX.js";
var l = function () {
    var e,
      t,
      n = !1,
...
function h(e, t) {
  ...
  return r === void 0
    ...
    : m(function () {
        ...
        .catch(function (n) {
          if (n instanceof o && n.type === `middleware_cancellation`) throw n;
...
function _() {
  return c() ? window.navigator.onLine : !0;
}
function v() {
  return !_();
}
...
try {
  y = c() && window.localStorage ? window.localStorage : y;
} catch (e) {
...
function x(e, t) {
  ...
  y.setItem(e, JSON.stringify(Object.values(a)));
}
function S(e) {
  var t = y.getItem(e);
...
function C(e, t) {
  var n = S(e);
  y.setItem(e, JSON.stringify(i(i({}, n), t)));
}
function w(e) {
  y.removeItem(e);
}
...
function E(e, t, n) {
  ...
  var r = 50,
    ...
    c = s === null || a(s);
  if (c) {
    (y.setItem(i, JSON.stringify(T() + r)), t(), y.removeItem(i));
    return;
  }
  !c && n < 3
    ? setTimeout(function () {
...
//# sourceMappingURL=metric-helpers-Cs6bhyFT.js.map
