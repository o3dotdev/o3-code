...
import { n, r, t as i } from "./chunk-AGHRB4JF-CwjJfTB_.js";
import { i as a, o, r as s } from "./invert.js";
import { G as c, a as l, b as u, o as d } from "./chunk-ABZYJK2D-DSLQAJWr.js";
var f = (function () {
...
var h = ``,
  ...
  b = n(() => d, `getCommonDb`),
  x = n(function () {
    ((_.length = 0), (v.length = 0), (h = ``), (y.length = 0), l());
  }, `clear`),
  S = n(function (e) {
    ((h = e), _.push(e));
  }, `addSection`),
  ...
  O = n(function () {
    let e = n(function (e) {
      ...
      t = !0;
    for (let [n, r] of y.entries()) (e(n), (t &&= r.processed));
    return t;
  }, `compileTasks`),
  k = {
    clear: x,
...
var G = n(function (e, t, n, r) {
  ...
  Y = n(function (t, n, i, a) {
    let o = u(),
      s = o.timeline?.leftMargin ?? 50;
    r.debug(`timeline`, a.db);
    let l = o.securityLevel,
      d;
    l === `sandbox` && (d = e(`#i` + n));
    let f = e(
      l === `sandbox` ? d.nodes()[0].contentDocument.body : `body`,
    ).select(`#` + n);
    f.append(`g`);
    let p = a.db.getTasks(),
      m = a.db.getCommonDb().getDiagramTitle();
    (r.debug(`task`, p), J.initGraphics(f));
    let h = a.db.getSections();
    r.debug(`sections`, h);
    let g = 0,
      _ = 0,
      v = 0,
    ...
    h.forEach(function (e) {
      let t = {
        ...
        n = J.getVirtualNodeHeight(f, t, o);
      (r.debug(`sectionHeight before draw`, n), (g = Math.max(g, n + 20)));
    });
    let w = 0,
      T = 0;
    ...
    for (let [e, t] of p.entries()) {
      let n = {
        ...
        i = J.getVirtualNodeHeight(f, n, o);
      ...
      for (let e of t.events) {
        ...
        a += J.getVirtualNodeHeight(f, n, o);
      }
      (t.events.length > 0 && (a += (t.events.length - 1) * 10),
        (T = Math.max(T, a)));
    }
    (r.debug(`maxSectionHeight before draw`, g),
      r.debug(`maxTaskHeight before draw`, _),
      h && h.length > 0
        ? h.forEach((e) => {
            let t = p.filter((t) => t.section === e),
              n = {
                number: S,
                descr: e,
                section: S,
    ...
    (r.debug(`bounds`, E),
      ...
      c(void 0, f, o.timeline?.padding ?? 50, o.timeline?.useMaxWidth ?? !1));
  }, `draw`),
  X = n(function (e, t, n, i, a, o, s, c, l, u, d) {
    for (let c of t) {
      let t = {
        descr: c.task,
        section: n,
      ...
      let u = e.append(`g`).attr(`class`, `taskWrapper`),
        f = J.drawNode(u, t, n, s).height;
      if (
        (r.debug(`taskHeight after draw`, f),
      ...
      ((i += 200), d && !s.timeline?.disableMulticolor && n++);
    }
    a -= 10;
  }, `drawTasks`),
  Z = n(function (e, t, n, i, a, o) {
    let s = 0,
      c = a;
    a += 100;
    for (let c of t) {
...
//# sourceMappingURL=timeline-definition-IT6M3QCI-CQkzHxWR.js.map
