...
import { t as n } from "./arc-Dgx7D0pn.js";
import {
  B as r,
  C as i,
  U as a,
...
import { t as f } from "./chunk-FMBD7UC4-rrmk1FZY.js";
import { a as p, i as m, o as h, t as g } from "./chunk-TZMSLE5B-BxM8yCCK.js";
var _ = (function () {
...
var q = c().journey,
  ...
  te = e(function (e, t, n) {
    ...
    for (let [n, c] of t.entries()) {
      if (i !== c.section) {
        ((s = Z[o % Z.length]), (u = o % Z.length), (l = Q[o % Q.length]));
        let a = 0,
          d = c.section;
        ...
        (H.drawSection(e, f, r), (i = c.section), o++);
      }
      let d = c.people.reduce((e, t) => (W[t] && (e[t] = W[t]), e), {});
      ((c.x = n * r.taskMargin + n * r.width + J),
        (c.y = a),
        (c.width = r.diagramMarginX),
        (c.height = r.diagramMarginY),
        (c.colour = l),
        (c.fill = s),
        (c.num = u),
        (c.actors = d),
        H.drawTask(e, c, r),
        X.insert(c.x, c.y, c.x + c.width + r.taskMargin, 450));
    }
  }, `drawTasks`),
  $ = { setConf: U, draw: Y },
  ne = {
