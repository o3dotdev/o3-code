...
var k = { basename: te, dirname: ne, extname: re, join: ie, sep: `/` };
function te(e, t) {
...
function ie(...e) {
  let t = -1,
    n;
  for (; ++t < e.length; )
    (A(e[t]), e[t] && (n = n === void 0 ? e[t] : n + `/` + e[t]));
...
var M = [`history`, `path`, `basename`, `stem`, `extname`, `dirname`],
  de = class {
    constructor(e) {
      let t;
      ((t = e
    ...
    set basename(e) {
      (P(e, `basename`),
        N(e, `basename`),
        (this.path = k.join(this.dirname || ``, e)));
    }
    get dirname() {
    ...
    get stem() {
      return typeof this.path == `string`
        ? k.basename(this.path, this.extname)
        : void 0;
    }
    set stem(e) {
      (P(e, `stem`),
        N(e, `stem`),
        (this.path = k.join(this.dirname || ``, e + (this.extname || ``))));
    }
    fail(e, t, n) {
...
function N(e, t) {
  if (e && e.includes(k.sep))
    throw Error("`" + t + "` cannot be a path: did not expect `" + k.sep + "`");
}
function P(e, t) {
...
var me = function (e) {
  ...
  ge = new (class e extends me {
    ...
    copy() {
      ...
      return (t.data((0, F.default)(!0, {}, this.namespace)), t);
    }
    data(e, t) {
      return typeof e == `string`
        ? arguments.length === 2
          ? (R(`data`, this.frozen), (this.namespace[e] = t), this)
          : (he.call(this.namespace, e) && this.namespace[e]) || void 0
        : e
    ...
    process(e, t) {
      ...
      function r(r, i) {
        ...
        n.run(o, a, function (e, t, r) {
          ...
          let i = t,
            a = n.stringify(i, r);
          (ye(a) ? (r.value = a) : (r.result = a), s(e, r));
        });
        function s(e, n) {
    ...
    runSync(e, t) {
      let n = !1,
        r;
      return (this.run(e, t, i), _e(`runSync`, `run`, n), r);
      function i(e, t) {
        (C(e), (r = t), (n = !0));
      }
    }
    stringify(e, t) {
      ...
      return (L(`stringify`, r), z(e), r(e, n));
    }
    use(e, ...t) {
      ...
      function a(e) {
        ...
        (o(e.plugins),
          e.settings &&
            (r.settings = (0, F.default)(!0, r.settings, e.settings)));
      }
      function o(e) {
        let t = -1;
        if (e != null)
...
function we(e) {
  ...
  for (; ++r < n.length; ) {
    let e = n[r];
    t.push([Te(e[0]), Ee(e[1])]);
  }
  return t;
}
function Te(e) {
  return typeof e == `string` ? new RegExp(Se(e), `g`) : e;
}
function Ee(e) {
...
function De() {
  return {
    ...
    exit: {
      literalAutolink: Ne,
      literalAutolinkEmail: Me,
      literalAutolinkHttp: Ae,
      literalAutolinkWww: je,
    },
  };
}
function Oe() {
...
function Fe(e, t, n, r, i) {
  ...
  if (
    !ze(i) ||
    (/^w/i.test(t) && ((n = t + n), (t = ``), (a = `http://`)), !Le(n))
  )
    return !1;
  let o = Re(n + r);
  if (!o[0]) return !1;
...
function ze(e, t) {
  ...
  return (e.index === 0 || d(n) || p(n)) && (!t || n !== 47);
}
Ye.peek = Je;
function Be() {
  this.buffer();
...
function We(e) {
  ...
  (n.type,
    (n.identifier = c(this.sliceSerialize(e)).toLowerCase()),
    (n.label = t));
}
function Ge(e) {
  this.exit(e);
...
function Xe() {
  return {
    enter: {
      ...
      gfmFootnoteCall: Ve,
      gfmFootnoteDefinitionLabelString: He,
      gfmFootnoteDefinition: Ue,
    },
    exit: {
...
function Ze(e) {
  ...
  return (
    ...
    {
      handlers: { footnoteDefinition: n, footnoteReference: Ye },
      unsafe: [
...
`
            : ` `) +
            r.indentLines(r.containerFlow(e, a.current()), t ? $e : Qe),
        ))),
      s(),
      o
    );
...
function tt() {
  return {
    ...
    exit: { strikethrough: it },
  };
}
function nt() {
  return {
    unsafe: [{ character: `~`, inConstruct: `phrasing`, notInConstruct: et }],
    handlers: { delete: at },
  };
}
function rt(e) {
...
function ct(e, t) {
  ...
  let d = -1;
  if (typeof r == `object` && `length` in r) for (; ++d < l; ) a[d] = ut(r[d]);
  else {
    let e = ut(r);
    for (; ++d < l; ) a[d] = e;
  }
...
function dt() {
  return {
    enter: { table: ft, tableData: G, tableHeader: G, tableRow: mt },
    exit: {
      codeText: ht,
      table: pt,
      tableData: W,
...
`),
  ...
  function l(e, t) {
    return ct(e, { align: t, alignDelimiters: r, padding: n, stringLength: i });
  }
  function u(e, t, n) {
    let r = e.children,
      i = -1,
...
function xt(e, t, n, r) {
  let i = e.children[0],
    ...
    s = n.createTracker(r);
  a && s.move(o);
  let c = S.listItem(e, t, n, { ...r, ...s.current() });
...
function St() {
  return [De(), Xe(), tt(), dt(), vt()];
}
function Ct(e) {
  return { extensions: [Oe(), Ze(e), nt(), _t(e), yt()] };
}
var wt = { tokenize: Ft, partial: !0 },
  Tt = { tokenize: It, partial: !0 },
  Et = { tokenize: Lt, partial: !0 },
  Dt = { tokenize: Rt, partial: !0 },
  Ot = { tokenize: zt, partial: !0 },
  kt = { name: `wwwAutolink`, tokenize: Nt, previous: Bt },
  At = { name: `protocolAutolink`, tokenize: Pt, previous: Vt },
  q = { name: `emailAutolink`, tokenize: Mt, previous: Ht },
  J = {};
function jt() {
  return { text: J };
}
for (var Y = 48; Y < 123; )
  ((J[Y] = q), Y++, Y === 58 ? (Y = 65) : Y === 91 && (Y = 97));
((J[43] = q),
  (J[45] = q),
  (J[46] = q),
  (J[95] = q),
...
function Mt(e, t, n) {
  ...
  return s;
  function s(t) {
    return !X(t) || !Ht.call(r, r.previous) || Z(r.events)
      ? n(t)
      : (e.enter(`literalAutolink`), e.enter(`literalAutolinkEmail`), c(t));
  }
  function c(t) {
    return X(t) ? (e.consume(t), c) : t === 64 ? (e.consume(t), l) : n(t);
  }
  function l(t) {
    return t === 46
      ? e.check(Ot, d, u)(t)
  ...
  function u(t) {
    return (e.consume(t), (a = !0), l);
  }
  function d(i) {
    return o && a && h(r.previous)
      ? (e.exit(`literalAutolinkEmail`), e.exit(`literalAutolink`), t(i))
      : n(i);
  }
}
function Nt(e, t, n) {
  ...
  return i;
  function i(t) {
    return (t !== 87 && t !== 119) || !Bt.call(r, r.previous) || Z(r.events)
      ? n(t)
      : (e.enter(`literalAutolink`),
        e.enter(`literalAutolinkWww`),
        e.check(wt, e.attempt(Tt, e.attempt(Et, a), n), n)(t));
  }
  function a(n) {
...
function Pt(e, t, n) {
  ...
  return s;
  function s(t) {
    return (t === 72 || t === 104) && Vt.call(r, r.previous) && !Z(r.events)
      ? (e.enter(`literalAutolink`),
  ...
  function l(t) {
    return t === 47 ? (e.consume(t), o ? f : ((o = !0), l)) : n(t);
  }
  function f(t) {
    return t === null || u(t) || a(t) || d(t) || p(t)
      ? n(t)
      : e.attempt(Tt, e.attempt(Et, m), n)(t);
  }
  function m(n) {
...
function Rt(e, t, n) {
  ...
  function i(e) {
    return e === null || e === 40 || e === 91 || a(e) || d(e) ? t(e) : r(e);
  }
  function o(e) {
    return h(e) ? s(e) : n(e);
  }
  function s(t) {
    return t === 59 ? (e.consume(t), r) : h(t) ? (e.consume(t), s) : n(t);
  }
}
function zt(e, t, n) {
  return r;
...
function Wt() {
  return {
    ...
    text: {
      91: { name: `gfmFootnoteCall`, tokenize: qt },
      93: {
...
function Gt(e, t, n) {
  ...
  function s(i) {
    ...
    let s = c(r.sliceSerialize({ start: o.end, end: r.now() }));
...
function qt(e, t, n) {
  ...
  function d(l) {
    if (o > 999 || (l === 93 && !s) || l === null || l === 91 || a(l))
      return n(l);
    if (l === 93) {
      e.exit(`chunkString`);
      let a = e.exit(`gfmFootnoteCallString`);
      return i.includes(c(r.sliceSerialize(a)))
        ? (e.enter(`gfmFootnoteCallLabelMarker`),
          e.consume(l),
          e.exit(`gfmFootnoteCallLabelMarker`),
    ...
    return (a(l) || (s = !0), o++, e.consume(l), l === 92 ? f : d);
  }
  function f(t) {
...
function Jt(e, t, n) {
  ...
  function p(t) {
    if (s > 999 || (t === 93 && !l) || t === null || t === 91 || a(t))
      return n(t);
    if (t === 93) {
      e.exit(`chunkString`);
      let n = e.exit(`gfmFootnoteDefinitionLabelString`);
      return (
        (o = c(r.sliceSerialize(n))),
        e.enter(`gfmFootnoteDefinitionLabelMarker`),
        e.consume(t),
        e.exit(`gfmFootnoteDefinitionLabelMarker`),
    ...
    return (a(t) || (l = !0), s++, e.consume(t), t === 92 ? m : p);
  }
  function m(t) {
  ...
  function h(t) {
    return t === 58
      ? (e.enter(`definitionMarker`),
        ...
        f(e, g, `gfmFootnoteDefinitionWhitespace`))
      : n(t);
  }
  function g(e) {
    return t(e);
...
function Yt(e, t, n) {
  return e.check(m, t, e.attempt(Ut, t, n));
}
function Xt(e) {
...
function Qt(e) {
  let t = (e || {}).singleTilde,
    i = { name: `strikethrough`, tokenize: o, resolveAll: a };
  return (
    (t ??= !0),
    {
      text: { 126: i },
    ...
    for (; ++r < e.length; )
      if (
        ...
        for (; i--; )
          if (
            e[i][0] === `exit` &&
            e[i][1].type === `strikethroughSequenceTemporary` &&
            e[i][1]._open &&
            ...
            (c && n(s, s.length, 0, l(c, e.slice(i + 1, r), t)),
              n(s, s.length, 0, [
                [`exit`, o, t],
                [`enter`, e[r][1], t],
                [`exit`, e[r][1], t],
  ...
  function o(e, n, i) {
    ...
    return c;
    function c(t) {
      return a === 126 && o[o.length - 1][1].type !== `characterEscape`
        ? i(t)
        : (e.enter(`strikethroughSequenceTemporary`), l(t));
    }
    function l(o) {
      let c = r(a);
      if (o === 126) return s > 1 ? i(o) : (e.consume(o), s++, l);
      if (s < 2 && !t) return i(o);
...
function nn() {
  return { flow: { null: { name: `table`, tokenize: rn, resolveAll: an } } };
}
function rn(e, t, n) {
  let r = this,
    i = 0,
  ...
  function h(t) {
    return t === 92 || t === 124 ? (e.consume(t), m) : m(t);
  }
  function g(t) {
    return (
      (r.interrupt = !1),
  ...
  function ee(t) {
    return o(t) ? f(e, y, `whitespace`)(t) : y(t);
  }
  function y(t) {
    return t === 58
      ? ((s += 1),
  ...
  function S(t) {
    return o(t) ? f(e, C, `whitespace`)(t) : C(t);
  }
  function C(n) {
    return n === 124
      ? v(n)
...
function an(e, t) {
  ...
  for (
    c !== 0 && on(f, t, c, l, u), f.consume(t.events), n = -1;
    ++n < t.events.length;
  ) {
    let e = t.events[n];
    e[0] === `enter` &&
      e[1].type === `table` &&
      (e[1]._align = tn(t.events, n));
  }
  return e;
}
...
var sn = { name: `tasklistCheck`, tokenize: ln };
function cn() {
  return { text: { 91: sn } };
}
function ln(e, t, n) {
  ...
  function l(r) {
    return _(r) ? t(r) : o(r) ? e.check({ tokenize: un }, t, n)(r) : n(r);
  }
}
function un(e, t, n) {
...
function pn(e) {
  ...
  (i.push(dn(n)), a.push(St()), o.push(Ct(n)));
}
var mn = `Markdown table`,
  hn = 31,
  gn = /\\|\/|\?|\*|\[|\]|:/g,
  _n = /<br\s*\/?>/gi,
  vn = `BPS_TABLE_BR_PLACEHOLDER`,
  yn = /:{1,3}contentReference\[[^\]]+\](?:\{[^}]*\})?/g,
  bn = /\u200b/g,
  xn = ge().use(xe).use(pn);
function Sn(e) {
  return ((e ?? mn).trim().replace(gn, ``).trim() || mn).slice(0, hn);
}
function Cn(e) {
  return e.replace(_n, vn);
}
function wn(e) {
  return e
    .replace(/\u00a0/g, ` `)
...
function Tn(e) {
  let t = xn.parse(Cn(e)).children.find((e) => e.type === `table`);
  if (!t)
    throw Error(`Unable to build workbook: no markdown table rows found.`);
  let n = [];
  for (let e of t.children) {
    let t = e.children.map((e) => wn(v(e)));
...
export { En as buildTableValuesFromMarkdown, Sn as sanitizeSheetName };
//# sourceMappingURL=workbook-from-markdown-Cc4bry8f.js.map
