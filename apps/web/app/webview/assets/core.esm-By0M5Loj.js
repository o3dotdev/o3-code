...
import { t as n } from "./react-dom-De86Q4ix.js";
var r = e(t());
function i() {
  var e = [...arguments];
  return (0, r.useMemo)(
...
var Ye = class {
    ...
    handleMove(e) {
      ...
      if (!t && a) {
        if (qe(a)) {
          if (a.tolerance != null && Ve(s, a.tolerance))
  ...
  return (
      ...
      if (e !== t) {
        ...
        let o = e
          .map((e) => {
            let t = q(e);
            return t
              ? (t.addEventListener(`scroll`, a, { passive: !0 }), [t, Y(t)])
              : null;
          })
          .filter((e) => e != null);
    ...
    (0, r.useMemo)(
      () =>
        e.length
          ? t
            ? Array.from(t.values()).reduce((e, t) => C(e, t), I)
            : Ne(e)
          : I,
      [e, t],
    )
          ...
          ke.current = new n({
            ...
            onStart(e) {
              ...
              let { onDragStart: r } = M.current,
                i = {
                  activatorEvent: a,
                  active: { id: t, data: n.data, rect: O },
                };
    ...
    return r.createElement(
      ...
      r.createElement(
        ...
        r.createElement(
          zt.Provider,
          { value: Me },
          r.createElement(Kt.Provider, { value: Oe }, a),
        ),
...
function tn(e) {
  ...
  return (
    (0, r.useEffect)(() => {
      !S ||
        !C.current ||
        (S.disconnect(), (f.current = !1), S.observe(C.current));
    }, [C, S]),
    (0, r.useEffect)(
      () => (
        c({
    ...
    (0, r.useEffect)(() => {
      n !== d.current.disabled &&
        (c({ type: N.SetDroppableDisabled, id: i, key: o, disabled: n }),
...
function nn(e) {
  ...
  return (
    ...
    r.createElement(
      ...
      null,
      n,
      i ? (0, r.cloneElement)(i, { ref: s }) : null,
    )
  );
}
...
var on = { position: `fixed`, touchAction: `none` },
  ...
  ln = {
    ...
    keyframes: (e) => {
      ...
      return [
        { transform: O.Transform.toString(t) },
        { transform: O.Transform.toString(n) },
      ];
    },
    sideEffects: ((e) => (t) => {
...
//# sourceMappingURL=core.esm-By0M5Loj.js.map
