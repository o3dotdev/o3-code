var e = 100,
  ...
  a = class {
    ...
    matchingDegree(e) {
      ...
      return r == null
        ? t
        : p(this.fallbackMatcher.matchingDegree(e, !1, r), r);
    }
  },
  o = class {
    myPattern;
    ...
    matchingDegree(e, n = !1, r = this.match(e)) {
      ...
      for (let t of r)
        for (let n = t.startOffset; n < t.endOffset; n += 1) {
          ...
          let f = e[n];
          if (
            ((c = v(this.myPattern, f, c + 1, this.myPattern.length, !0)),
            c < 0)
          )
            break;
    ...
    match(t) {
      ...
      for (
        let e = 0;
        e < t.length && n < this.meaningfulCharacters.length;
        e += 1
      ) {
        let r = t[e];
        (r === this.meaningfulCharacters[n] ||
          r === this.meaningfulCharacters[n + 1]) &&
          (n += 2);
      }
...
export { s as t };
//# sourceMappingURL=score-query-match-BVCuhDNS.js.map
