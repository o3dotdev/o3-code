...
import { Xs as u, v as d } from "./app-server-manager-signals-DkRDRgNB.js";
...
import { t as te } from "./invalidate-queries-and-broadcast-BXgBlyBv.js";
import { u as T } from "./config-queries-BBeTQbuo.js";
var E = w(),
  D = i({ sandbox: n([`elevated`, `unelevated`]).optional() }).passthrough(),
  O = [`windows-sandbox`, `mode`],
  k = [`windows-sandbox`, `readiness`];
function A(e) {
  return [...O, e];
}
function j(e) {
...
async function M(e) {
  try {
    return (await u(`get-windows-sandbox-readiness-for-host`, { hostId: e }))
      .status;
  } catch (e) {
    return (
...
function N(e) {
  ...
  t[2] !== o || t[3] !== r
    ? ((s = async () => {
        try {
          return I((await T(o, r, null, !1)).config.windows);
        } catch (e) {
          let t = e;
          return (
...
function P(e) {
  let t = (0, E.c)(8),
    ...
    r = e?.hostId ?? n,
    i;
  t[0] === r ? (i = t[1]) : ((i = j(r)), (t[0] = r), (t[1] = i));
  let a;
  t[2] === r ? (a = t[3]) : ((a = () => M(r)), (t[2] = r), (t[3] = a));
  let o = e?.enabled ?? !0,
    s;
  return (
    t[4] !== i || t[5] !== a || t[6] !== o
...
function F(e) {
  let t = (0, E.c)(19),
    ...
    a = te(),
    o;
  t[0] === r ? (o = t[1]) : ((o = A(r)), (t[0] = r), (t[1] = o));
  let s = o,
    c;
  t[2] === r ? (c = t[3]) : ((c = j(r)), (t[2] = r), (t[3] = c));
  let l = c,
    f;
  t[4] === r
    ? (f = t[5])
  ...
  let v;
  return (
    t[14] !== f || t[15] !== p || t[16] !== g || t[17] !== _
      ? ((v = { mutationFn: f, onMutate: p, onError: g, onSettled: _ }),
        (t[14] = f),
        (t[15] = p),
        (t[16] = g),
        (t[17] = _),
...
function R() {
  let e = (0, E.c)(7),
    n = y(g),
    r = S(t.followUpQueueMode),
    i = r === `interrupt` ? `steer` : (r ?? `queue`),
    a,
    o;
  (e[0] !== r || e[1] !== n
    ? ((a = () => {
        r === `interrupt` && ee(n, t.followUpQueueMode, `steer`);
      }),
      (o = [r, n]),
      (e[0] = r),
      (e[1] = n),
...
function ie({ defaultWorkspaceWriteMode: e, isWindowsSandboxRequired: t }) {
...
function oe(e, t, n, r, i = null, a, o) {
  return t == null
    ? Q(e, r, i)
      ? null
      : o &&
...
//# sourceMappingURL=permissions-mode-helpers-CfjXuDYv.js.map
