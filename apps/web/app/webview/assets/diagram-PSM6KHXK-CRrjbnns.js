...
import { t } from "./defaultLocale-CwOwouzm.js";
import { t as n } from "./src-BHeH9bp0.js";
import { t as r } from "./ordinal-KRb_VAHU.js";
import { a as i, t as a } from "./treemap-BYFuMAdb.js";
...
import { t as y } from "./chunk-4BX2VUAB-g.js";
import { t as b } from "./mermaid-parser.core-p5FsnjRv.js";
...
var E = o((e, t) => {
  ...
  D = o((e) => (e.name ? String(e.name) : ``), `getItemName`),
  O = {
    parser: { yy: void 0 },
    parse: o(async (e) => {
      try {
  ...
  M = {
    draw: o((e, c, l, u) => {
      ...
      try {
        let e = f.valueFormat || `,`;
        if (e === `$0,0`) O = o((e) => `$` + t(`,`)(e), `valueFormat`);
        else if (e.startsWith(`$`) && e.includes(`,`)) {
          let n = /\.\d+/.exec(e),
            r = n ? n[0] : ``;
          O = o((e) => `$` + t(`,` + r)(e), `valueFormat`);
        } else if (e.startsWith(`$`)) {
          let n = e.substring(1);
          O = o((e) => `$` + t(n || ``)(e), `valueFormat`);
        } else O = t(e);
      } catch (e) {
        (s.error(`Error creating format function:`, e), (O = t(`,`)));
      }
      let M = r().range([
          `transparent`,
          y.cScale0,
...
export { P as diagram };
//# sourceMappingURL=diagram-PSM6KHXK-CRrjbnns.js.map
