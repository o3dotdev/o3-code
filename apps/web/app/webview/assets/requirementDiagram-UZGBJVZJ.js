...
import { n as t, r as n, t as r } from "./chunk-AGHRB4JF-CwjJfTB_.js";
import {
  B as i,
  C as a,
  U as o,
  ...
  v = class {
    constructor() {
      ((this.relations = []),
        ...
        (this.getConfig = t(() => l().requirement, `getConfig`)),
        this.clear(),
...
`,
  ...
  b = {};
r(b, { draw: () => x });
var x = t(async function (t, r, i, a) {
    (n.info(`REF0:`), n.info(`Drawing requirement diagram (unified)`, r));
