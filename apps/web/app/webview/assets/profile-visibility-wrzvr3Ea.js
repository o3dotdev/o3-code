...
import { xt as r } from "./setting-storage-kJblH-wH.js";
import { d as i, u as a } from "./statsig-BwN76nAo.js";
...
var s = n(),
  ...
  u = `3503973010`,
  d = `profile_enabled`,
  f = `show_dropdown_entry_point`;
function p() {
  let e = (0, l.c)(6),
    { authMethod: t, isLoading: n } = o(),
    r = i(),
    s = a(u),
    c = n || (t === `chatgpt` && r),
    f;
  e[0] !== t || e[1] !== s
    ? ((f = t === `chatgpt` && s.get(d, !1)),
      (e[0] = t),
      (e[1] = s),
      (e[2] = f))
    : (f = e[2]);
  ...
  return (
    e[3] !== c || e[4] !== f
      ? ((p = { isProfileVisibilityLoading: c, isProfileVisible: f }),
        (e[3] = c),
        (e[4] = f),
        (e[5] = p))
      : (p = e[5]),
...
function m() {
  ...
  return (
    e[0] === n
      ? (r = e[1])
      : ((r = n.get(d, !1) && n.get(f, !1)), (e[0] = n), (e[1] = r)),
    r
  );
}
export { p as n, c as r, m as t };
//# sourceMappingURL=profile-visibility-wrzvr3Ea.js.map
