...
import { n as a, r as o, t as s } from "./chunk-AGHRB4JF-Dk9Dm4Nw.js";
import {
  K as c,
  a as l,
  b as u,
...
import { t as p } from "./chunk-426QAEUC-D4VNc0Hf.js";
import { f as m } from "./chunk-5PVQY5BW-CnaqcI9r.js";
var h = (function () {
...
` +
  ...
  return (a(d, `Parser`), (d.prototype = u), (u.Parser = d), new d());
})();
h.parser = h;
var g = h,
  _ = {};
...
var v = ``,
  ...
  te = a(function (e, n) {
    ...
    return (
      a(c, `ambivalent`),
      n.score > 3 ? o(i) : n.score < 3 ? s(i) : c(i),
      r
    );
  }, `drawFace`),
  ne = a(function (e, t) {
  ...
  t.each(function () {
    ...
    for (let e = 0; e < r.length; e++)
      ((i = r[r.length - 1 - e]),
        a.push(i),
        l.text(a.join(` `).trim()),
        (l.node().getComputedTextLength() > n || i === `<br>`) &&
          (a.pop(),
          l.text(a.join(` `).trim()),
          (a = i === `<br>` ? [``] : [i]),
          (l = t
...
a(H, `wrap`);
var ce = a(function (t, n, r, i, a, o = !1) {
    let { theme: s, look: c } = i,
      l = s?.includes(`redux`),
      u = (r % (i?.themeVariables?.THEME_COLOR_LIMIT ?? 12)) - 1,
      d = t.append(`g`);
    ((n.section = u),
      d.attr(
        `class`,
        (n.class ? n.class + ` ` : ``) + `timeline-node ` + (`section-` + u),
      ));
    let f = d.append(`g`),
      p = d.append(`g`),
      m = p
    ...
    if (
      ((n.height = m.height + h * 1.1 * 0.5 + n.padding),
      (n.height = Math.max(n.height, n.maxHeight)),
      (n.width += 2 * n.padding),
      p.attr(
        `transform`,
        `translate(` + n.width / 2 + `, ` + n.padding / 2 + `)`,
      ),
      l &&
        p.attr(
          `transform`,
          `translate(${n.width / 2}, ${o ? n.padding / 2 + 3 : n.padding})`,
        ),
      ue(f, n, u, a, i),
      c === `neo` && (d.attr(`data-look`, `neo`), l))
    ) {
      let n = s.includes(`dark`),
        r = e(t.node()?.ownerSVGElement ?? t.node()),
        i = r.attr(`id`) ?? ``,
        a = i ? `${i}-drop-shadow` : `drop-shadow`;
      if (r.select(`#${a}`).empty()) {
        let e = r.select(`defs`);
        (e.empty() ? r.append(`defs`) : e)
          .append(`filter`)
          .attr(`id`, a)
          .attr(`height`, `130%`)
          .attr(`width`, `130%`)
          ...
          .attr(`dy`, `4`)
          .attr(`stdDeviation`, 0)
          .attr(`flood-opacity`, n ? `0.2` : `0.06`)
          .attr(`flood-color`, n ? `#FFFFFF` : `#000000`);
      }
    }
    return n;
  }, `drawNode`),
  ...
  de = a(function (t, n, r, i) {
    let a = u(),
      { look: s, theme: l, themeVariables: d } = a,
      { useGradient: f, gradientStart: p, gradientStop: m } = d,
      h = a.timeline?.leftMargin ?? 50;
    o.debug(`timeline`, i.db);
    let g = a.securityLevel,
      _;
    g === `sandbox` && (_ = e(`#i` + n));
    let v = e(
    ...
    v.append(`g`);
    let y = i.db.getTasks(),
      b = i.db.getCommonDb().getDiagramTitle();
    (o.debug(`task`, y), U.initGraphics(v, n));
    ...
    x.forEach(function (e) {
      let t = {
        ...
        n = U.getVirtualNodeHeight(v, t, a);
      (o.debug(`sectionHeight before draw`, n), (S = Math.max(S, n + 20)));
    });
    let A = 0,
      j = 0;
    o.debug(`tasks.length`, y.length);
    for (let [e, t] of y.entries()) {
      let n = {
        ...
        r = U.getVirtualNodeHeight(v, n, a);
      (o.debug(`taskHeight before draw`, r),
        (C = Math.max(C, r + 20)),
      ...
      for (let e of t.events) {
        ...
        i += U.getVirtualNodeHeight(v, n, a);
      }
      (t.events.length > 0 && (i += (t.events.length - 1) * 10),
        (j = Math.max(j, i)));
    }
    (o.debug(`maxSectionHeight before draw`, S),
      o.debug(`maxTaskHeight before draw`, C),
      x && x.length > 0
        ? x.forEach((e) => {
            let t = y.filter((t) => t.section === e),
              r = {
                number: O,
                descr: e,
                section: O,
            ...
            o.debug(`sectionNode`, r);
            let i = v.append(`g`),
              s = U.drawNode(i, r, O, a, n);
            (o.debug(`sectionNode output`, s),
              i.attr(`transform`, `translate(${E}, ${T})`),
              (D += S + 50),
              t.length > 0 && W(v, t, O, E, D, C, a, A, j, S, !1, n),
              (E += 200 * Math.max(t.length, 1)),
              (D = T),
              O++);
          })
        : ((k = !1), W(v, y, O, E, D, C, a, A, j, S, !0, n)));
    ...
    if (
      ...
      b &&
        v
          .append(`text`)
          .text(b)
          .attr(`x`, s === `neo` ? M.x * 2 + h : M.width / 2 - h)
          .attr(`font-size`, `4ex`)
    ...
    c(void 0, v, a.timeline?.padding ?? 50, a.timeline?.useMaxWidth ?? !1);
  }, `draw`),
  W = a(function (e, t, n, r, i, a, s, c, l, u, d, f) {
    for (let c of t) {
      let t = {
        descr: c.task,
        section: n,
      ...
      let u = e.append(`g`).attr(`class`, `taskWrapper`),
        p = U.drawNode(u, t, n, s, f).height;
      if (
        (o.debug(`taskHeight after draw`, p),
      ...
      ((r += 200), d && !s.timeline?.disableMulticolor && n++);
    }
    i -= 10;
  }, `drawTasks`),
  fe = a(function (e, t, n, r, i, a, s) {
    let c = 0,
      l = i;
    i += 100;
    for (let l of t) {
      ...
      let u = e.append(`g`).attr(`class`, `eventWrapper`),
        d = U.drawNode(u, t, n, a, s, !0).height;
      ((c += d),
        u.attr(`transform`, `translate(${r}, ${i})`),
        (i = i + 10 + d));
    }
  ...
  Z = 30,
  Q = 50,
  _e = a(function (e, t, n, r) {
    let i = u(),
      a = i.timeline?.leftMargin ?? 50;
    o.debug(`timeline`, r.db);
    let s = p(t);
    s.append(`g`);
    let l = r.db.getTasks(),
      d = r.db.getCommonDb().getDiagramTitle();
    (o.debug(`task`, l), U.initGraphics(s));
    let f = r.db.getSections();
    o.debug(`sections`, f);
    let h = 0,
      g = 0,
      _ = 50 + a,
    ...
    f.forEach(function (e) {
      let t = {
        ...
        n = U.getVirtualNodeHeight(s, t, i);
      (o.debug(`sectionHeight before draw`, n), (h = Math.max(h, n)));
    });
    let O = 0;
    o.debug(`tasks.length`, l.length);
    for (let [e, t] of l.entries()) {
      let n = {
        ...
        r = U.getVirtualNodeHeight(s, n, i);
      (o.debug(`taskHeight before draw`, r), (g = Math.max(g, r)));
      let a = 0;
      for (let e of t.events) {
        let n = {
          descr: e,
        ...
        a += U.getVirtualNodeHeight(s, n, i);
      }
      (t.events.length > 0 && (a += (t.events.length - 1) * J),
        (O = Math.max(O, a) + ge));
    }
    (o.debug(`maxSectionHeight before draw`, h),
      o.debug(`maxTaskHeight before draw`, g));
    let k = Math.max(g, O) + Z;
    T
      ? f.forEach((e) => {
          let t = l.filter((t) => t.section === e),
            n = {
              number: w,
              descr: e,
              section: w,
          ...
          o.debug(`sectionNode`, n);
          let r = s.append(`g`),
            a = U.drawNode(r, n, w, i);
          o.debug(`sectionNode output`, a);
          let c = E - x;
          r.attr(`transform`, `translate(${c}, ${v})`);
          let u = v + a.height + Y;
          t.length > 0 && $(s, t, w, E, u, g, i, k, !1);
          let d = t.length,
            f = a.height + Y + k * Math.max(d, 1) - (d > 0 ? Z * 2 : 0);
          ((v += f), w++);
        })
      : $(s, l, w, E, v, g, i, k, !0);
    let A = s.node()?.getBBox();
    if (!A) throw Error(`bbox not found`);
    if ((o.debug(`bounds`, A), d)) {
      if (
        (s
          .append(`text`)
          .text(d)
      ...
      o.debug(`bounds after title`, A);
    }
    let [j] = m(i.fontSize),
      M = (j ?? 16) * 2,
      N = (j ?? 16) * 0.5 + 20,
      P = s.append(`g`).attr(`class`, `lineWrapper`);
    (P.append(`line`)
      .attr(`x1`, E)
      .attr(`y1`, y - M)
      .attr(`x2`, E)
      ...
      P.lower(),
      c(void 0, s, i.timeline?.padding ?? 50, i.timeline?.useMaxWidth ?? !1));
  }, `draw`),
  $ = a(function (e, t, n, r, i, a, s, c, l) {
    for (let u of t) {
      let t = {
        descr: u.task,
        section: n,
      ...
      if (
        ...
        let t = i,
          a = r + Q;
        ve(e, u.events, n, r, a, t, s);
      }
      ((i += c), l && !s.timeline?.disableMulticolor && n++);
    }
  }, `drawTasks`),
  ve = a(function (e, t, n, r, i, a, s) {
    let c = a;
    for (let a of t) {
      let t = {
        descr: a,
      ...
      let l = e.append(`g`).attr(`class`, `eventWrapper`),
        u = U.drawNode(l, t, n, s).height;
      l.attr(`transform`, `translate(${i}, ${c})`);
...
//# sourceMappingURL=timeline-definition-GMOUNBTQ-CkTRi49d.js.map
