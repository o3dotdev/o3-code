import { t as e } from "./Tableau10.js";
...
import {
  ...
  r as s,
  t as c,
} from "./sankeyLinkHorizontal-CguDmNLE.js";
import { n as l } from "./chunk-AGHRB4JF-Dk9Dm4Nw.js";
import {
  B as u,
  C as d,
  K as f,
...
` +
  ...
  return (l(a, `Parser`), (a.prototype = i), (i.Parser = a), new a());
})();
x.parser = x;
var S = x,
  C = [],
  ...
  A = {
    nodesMap: T,
    getConfig: l(() => _().sankey, `getConfig`),
    getNodes: l(() => w, `getNodes`),
    getLinks: l(() => C, `getLinks`),
    getGraph: l(
      () => ({
        nodes: w.map((e) => ({ id: e.ID })),
        links: C.map((e) => ({
          source: e.source.ID,
          target: e.target.ID,
          value: e.value,
    ...
    addLink: O,
    findOrCreateNode: l((e) => {
      e = v.sanitizeText(e, _());
      let t = T.get(e);
      return (t === void 0 && ((t = new k(e)), T.set(e, t), w.push(t)), t);
    }, `findOrCreateNode`),
    getAccTitle: b,
    setAccTitle: p,
    getAccDescription: h,
  ...
  M = { left: r, right: o, center: s, justify: i },
  N = {
    draw: l(function (r, i, o, s) {
      let { securityLevel: u, sankey: d } = _(),
        p = y.sankey,
        m;
      u === `sandbox` && (m = t(`#i` + i));
      let h = t(u === `sandbox` ? m.nodes()[0].contentDocument.body : `body`),
        g = u === `sandbox` ? h.select(`[id="${i}"]`) : t(`[id="${i}"]`),
        v = d?.width ?? p.width,
        b = d?.height ?? p.width,
        x = d?.useMaxWidth ?? p.useMaxWidth,
        S = d?.nodeAlignment ?? p.nodeAlignment,
        C = d?.prefix ?? p.prefix,
        w = d?.suffix ?? p.suffix,
        T = d?.showValues ?? p.showValues,
        E = s.db.getGraph(),
        D = M[S];
      a()
        .nodeId((e) => e.id)
      ...
      g.append(`g`)
        ...
        .join(`g`)
        .attr(`class`, `node`)
        .attr(`id`, (e) => (e.uid = j.next(`node-`)).id)
...
${C}${Math.round(t * 100) / 100}${w}`
      ...
      g.append(`g`)
        ...
        .data(E.nodes)
        .join(`text`)
        .attr(`x`, (e) => (e.x0 < v / 2 ? e.x1 + 6 : e.x0 - 6))
        .attr(`y`, (e) => (e.y1 + e.y0) / 2)
        .attr(`dy`, `${T ? `0` : `0.35`}em`)
        .attr(`text-anchor`, (e) => (e.x0 < v / 2 ? `start` : `end`))
        .text(k);
      let A = g
          .append(`g`)
          .attr(`class`, `links`)
        ...
        N = d?.linkColor ?? `gradient`;
      if (N === `gradient`) {
        let e = A.append(`linearGradient`)
          .attr(`id`, (e) => (e.uid = j.next(`linearGradient-`)).id)
      ...
      switch (N) {
        case `gradient`:
          P = l((e) => e.uid, `coloring`);
          break;
        case `source`:
          P = l((e) => O(e.source.id), `coloring`);
          break;
        case `target`:
          P = l((e) => O(e.target.id), `coloring`);
          break;
        default:
          P = N;
      }
...
`,
  ...
  I = S.parse.bind(S);
S.parse = (e) => I(P(e));
var L = { styles: F, parser: S, db: A, renderer: N };
export { L as diagram };
//# sourceMappingURL=sankeyDiagram-XADWPNL6-BikyJU5f.js.map
