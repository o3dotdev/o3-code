...
((e.prototype = {
  ...
  update: function (t, n, r) {
    var i = r && r != t ? this.remove(r) : this,
      ...
      o = i.content.slice();
    return (
      a == -1 ? o.push(r || t, n) : ((o[a + 1] = n), r && (o[a] = r)),
      new e(o)
    );
  },
  remove: function (t) {
  ...
  prepend: function (t) {
    return (
      (t = e.from(t)),
      t.size ? new e(t.content.concat(this.subtract(t).content)) : this
    );
  },
  append: function (t) {
    return (
      (t = e.from(t)),
      t.size ? new e(this.subtract(t).content.concat(t.content)) : this
    );
  },
  subtract: function (t) {
    var n = this;
...
var x = class e {
  ...
  fillBefore(e, t = !1, n = 0) {
    ...
    function a(o, s) {
      ...
      if (c && (!t || c.validEnd))
        return r.from(s.map((e) => e.createAndFill()));
...
var ke = class {
    constructor(e, t, n) {
      ((this.hasDefault = Object.prototype.hasOwnProperty.call(n, `default`)),
        ...
        (this.validate =
          typeof n.validate == `string` ? Oe(e, t, n.validate) : n.validate));
    }
    get isRequired() {
    ...
    inlineContext(e) {
      return this.type
        ...
        : this.content.length
          ...
          : e.parentNode &&
            !Ie.hasOwnProperty(e.parentNode.nodeName.toLowerCase());
    }
  },
  Be = class {
    constructor(e, t, n) {
...
`,
    ...
    addElement(e, t, n) {
      ...
      out: if (s ? s.ignore : Le.hasOwnProperty(a))
...
`),
    ...
    insertNode(e, t, n) {
      ...
      if (r) {
        ...
        for (let i of r.concat(e.marks))
          (t.type ? t.type.allowsMarkType(i.type) : We(i.type, e.type)) &&
            (n = i.addToSet(n));
    ...
    enterInner(e, t, n, r = !1, i) {
      ...
      return (
        (n = n.filter((t) =>
          (a.type ? a.type.allowsMarkType(t.type) : We(t.type, e))
            ? ((c = t.addToSet(c)), !1)
            : !0,
        )),
  ...
  for (let t = 0; t < o.childCount; t++) {
    ...
    if (!f) s.push(new z(c, d, l.empty));
      ...
      if (a && u.isText && n.whitespace != `pre`) {
        ...
        for (; (e = t.exec(u.text)); )
          ((i ||= new l(
            r.from(n.schema.text(` `, n.allowedMarks(u.marks))),
            0,
            0,
          )),
...
function ct(e, t, n) {
  ...
  for (let e = o, t = !1; e > n; e--)
    t || i.index(e) > 0
      ? ((t = !0), (f = r.from(i.node(e).copy(f))), p++)
      : u--;
  let m = r.empty,
    h = 0;
  for (let e = o, t = !1; e > n; e--)
    t || a.after(e + 1) < a.end(e)
      ? ((t = !0), (m = r.from(a.node(e).copy(m))), h++)
      : d++;
...
function ut(e, t, n, i, a) {
  ...
  e.doc.nodesBetween(t, n, (t, n) => {
    ...
    if (
      t.isTextblock &&
      !t.hasMarkup(i, s) &&
      pt(e.doc, e.mapping.slice(o).map(n), i)
    ) {
      let a = null;
      ...
      (a === !1 && ft(e, t, n, o),
        st(e, e.mapping.slice(o).map(n, 1), i, void 0, a === null));
      ...
      return (
        e.step(
          new B(
            ...
            u + 1,
            d - 1,
            new l(r.from(i.create(s, null, t.marks)), 0, 0),
            1,
            !0,
          ),
        ),
...
function gt(e, t, n) {
  ...
  o.inlineContent &&
    st(e, t + n - 1, o, a.node().contentMatchAt(a.index()), r == null);
...
var xt = class {
  constructor(e, t, n) {
    ...
    for (let t = e.depth; t > 0; t--)
      this.placed = r.from(e.node(t).copy(this.placed));
  }
  get depth() {
...
function Ct(e, t, n) {
  ...
  return (
    t > 1 &&
      (i = i.replaceChild(
        0,
        Ct(i.firstChild, t - 1, i.childCount == 1 ? n - 1 : 0),
      )),
    t > 0 &&
      ((i = e.type.contentMatch.fillBefore(i).append(i)),
      n <= 0 &&
        (i = i.append(
          e.type.contentMatch.matchFragment(i).fillBefore(r.empty, !0),
        ))),
    e.copy(i)
  );
}
...
function Dt(e, t, n, r) {
  ...
  for (
    let s = o.length - 1;
    s >= 0 && (e.replace(t, n, r), !(e.steps.length > f));
    s--
  ) {
    let e = o[s];
...
var Pt = class {
  ...
  G = class {
    constructor(e, t, n) {
      ((this.$anchor = e),
        (this.$head = t),
        (this.ranges = n || [new It(e.min(t), e.max(t))]));
    }
    get anchor() {
    ...
    replaceWith(e, t) {
      ...
      for (let i = 0; i < r.length; i++) {
        ...
        i
          ? e.deleteRange(c, l)
          : (e.replaceRangeWith(c, l, t), Ht(e, n, t.isInline ? -1 : 1));
      }
    }
...
var Z = class {
    constructor(e, t, n) {
      ((this.name = e),
        (this.init = Kt(t.init, n)),
        (this.apply = Kt(t.apply, n)));
    }
  },
  qt = [
    new Z(`doc`, {
...
//# sourceMappingURL=dist-Cp6055if.js.map
