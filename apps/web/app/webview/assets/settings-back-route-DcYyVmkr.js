...
import { _ as s, c } from "./app-shell-state-SfLRxSEg.js";
import { t as l } from "./badge-DJ3VoZ_p.js";
var u = o();
function d() {
  let e = (0, u.c)(3),
    t = r(n),
...
function p(e) {
  ...
  let I = S && `text-token-list-active-selection-icon-foreground`,
    L;
  n[25] !== w || n[26] !== I
    ? ((L = t(w, I)), (n[25] = w), (n[26] = I), (n[27] = L))
    : (L = n[27]);
  let R;
  n[28] !== r || n[29] !== L
    ? ((R = (0, f.jsx)(r, { className: L })),
      (n[28] = r),
      (n[29] = L),
      (n[30] = R))
    : (R = n[30]);
...
function m(e) {
  ...
  n[0] === i
    ? (l = n[1])
    : ((l = t(`flex flex-col gap-1`, i)), (n[0] = i), (n[1] = l));
  let d;
  n[2] !== a || n[3] !== o || n[4] !== c || n[5] !== s
    ? ((d = a
        ? (0, f.jsxs)(`div`, {
            className: t(
...
//# sourceMappingURL=settings-back-route-DcYyVmkr.js.map
