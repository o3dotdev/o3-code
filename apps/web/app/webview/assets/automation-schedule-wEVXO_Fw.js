...
import { o as a, r as o, t as s } from "./tslib.es6-PiNIxp0T.js";
import { S as c, _ as l, f as u } from "./setting-storage-kJblH-wH.js";
var d = u(c, `list-automations`, {
    enabled: !0,
    refetchInterval: l.ONE_MINUTE,
...
var S = function (e, t, n) {
  ...
  w = function (e, t) {
    return { div: Math.floor(e / t), mod: C(e, t) };
  },
  T = function (e) {
  ...
  A = function (e) {
    return ie(e) && !isNaN(e.getTime());
  },
  ae = function (e, t) {
    var n = e.getTime() - t.getTime();
    return Math.round(n / te);
  },
  oe = function (e) {
    return ae(e, ne);
  },
  se = function (e) {
    return new Date(ne.getTime() + e * te);
  },
  ce = function (e) {
    var t = e.getUTCMonth();
    return t === 1 && k(e.getUTCFullYear()) ? 29 : ee[t];
  },
  j = function (e) {
    return re[e.getUTCDay()];
  },
  le = function (e, t) {
    var n = O(e, t + 1, 1);
    return [j(n), ce(n)];
  ...
  fe = function (e) {
    for (var t = [], n = 0; n < e.length; n++) t.push(de(e[n]));
    return t;
  },
  M = function (e) {
    e.sort(function (e, t) {
  ...
  pe = function (e, t) {
    ...
    var n = new Date(e);
    return [
      x(n.getUTCFullYear().toString(), 4, `0`),
      x(n.getUTCMonth() + 1, 2, `0`),
      x(n.getUTCDate(), 2, `0`),
      `T`,
      x(n.getUTCHours(), 2, `0`),
      x(n.getUTCMinutes(), 2, `0`),
      x(n.getUTCSeconds(), 2, `0`),
      t ? `Z` : ``,
    ].join(``);
  },
  me = function (e) {
  ...
  ge = function (e, t) {
    var n = Intl.DateTimeFormat().resolvedOptions().timeZone,
      r = new Date(he(e, n)),
      i = new Date(he(e, t ?? `UTC`)).getTime() - r.getTime();
  ...
  P = (function () {
    function e(e, t, n, r) {
      ...
      if (m(this.origOptions.byweekday)) {
        var o = _(this.origOptions.byweekday)
    ...
    return (
      (e.isFullyConvertible = function (t) {
        ...
        for (var r in t.origOptions) {
          if (ye([`dtstart`, `tzid`, `wkst`, `freq`], r)) return !0;
          if (!ye(e.IMPLEMENTED[t.options.freq], r)) return !1;
        }
        return n;
      }),
      ...
      (e.prototype.weekdaytext = function (e) {
        var t = h(e) ? (e + 1) % 7 : e.getJsWeekday();
...
var Te = function (e, t) {
    return (t === void 0 && (t = ve), new K(Ce(e, t) || void 0));
  },
  ...
  Oe = (function (e) {
    ...
    return (
      ...
      (t.prototype.getWeekday = function () {
        return j(new Date(this.getTime()));
      }),
      ...
      (t.prototype.addHours = function (e, t, n) {
        for (t && (this.hour += Math.floor((23 - this.hour) / e) * e); ; ) {
          this.hour += e;
          var r = w(this.hour, 24),
            i = r.div,
            a = r.mod;
          if (
            (i && ((this.hour = a), this.addDaily(i)), T(n) || D(n, this.hour))
          )
            break;
        }
      }),
      (t.prototype.addMinutes = function (e, t, n, r) {
        for (
          ...
          this.minute += e;
          var i = w(this.minute, 60),
            a = i.div,
            o = i.mod;
          if (
            (a && ((this.minute = o), this.addHours(a, !1, n)),
            (T(n) || D(n, this.hour)) && (T(r) || D(r, this.minute)))
          )
            break;
        }
      }),
      ...
      (t.prototype.fixDay = function () {
        if (!(this.day <= 28)) {
          var e = le(this.year, this.month - 1)[1];
          if (!(this.day <= e))
            for (; this.day > e; ) {
              if (
                ((this.day -= e),
...
function ke(e) {
  for (var t = [], n = Object.keys(e), r = 0, i = n; r < i.length; r++) {
    var a = i[r];
    (D(pt, a) || t.push(a), ie(e[a]) && !A(e[a]) && t.push(a));
  }
...
function Ae(e) {
  var t = s(s({}, ft), ke(e));
  if (
    (m(t.byeaster) && (t.freq = K.YEARLY),
    !(m(t.freq) && K.FREQUENCIES[t.freq]))
  )
    throw Error(`Invalid frequency: ${t.freq} ${e.freq}`);
  if (
    ((t.dtstart ||= new Date(new Date().setMilliseconds(0))),
    m(t.wkst)
      ? h(t.wkst) || (t.wkst = t.wkst.weekday)
      : (t.wkst = K.MO.weekday),
    m(t.bysetpos))
  ) {
    h(t.bysetpos) && (t.bysetpos = [t.bysetpos]);
  ...
  if (
    ...
    switch (t.freq) {
      ...
      case K.MONTHLY:
        ...
        break;
      case K.WEEKLY:
        t.byweekday = [j(t.dtstart)];
        break;
    }
  if (
    (m(t.bymonth) && !_(t.bymonth) && (t.bymonth = [t.bymonth]),
    m(t.byyearday) &&
      !_(t.byyearday) &&
      h(t.byyearday) &&
    ...
    t.bymonthday < 0
      ...
      : ((t.bynmonthday = []), (t.bymonthday = [t.bymonthday]));
  if (
    (m(t.byweekno) && !_(t.byweekno) && (t.byweekno = [t.byweekno]),
    !m(t.byweekday))
  )
    t.bynweekday = null;
  else if (h(t.byweekday))
    ((t.byweekday = [t.byweekday]), (t.bynweekday = null));
  else if (g(t.byweekday))
    ((t.byweekday = [p.fromStr(t.byweekday).weekday]), (t.bynweekday = null));
  else if (t.byweekday instanceof p)
    ...
    for (var o = [], c = [], n = 0; n < t.byweekday.length; n++) {
      ...
      if (h(l)) {
        ...
        o.push(p.fromStr(l).weekday);
        continue;
      }
      !l.n || t.freq > K.MONTHLY ? o.push(l.weekday) : c.push([l.weekday, l.n]);
    }
    ((t.byweekday = E(o) ? o : null), (t.bynweekday = E(c) ? c : null));
  }
  return (
    m(t.byhour)
      ? h(t.byhour) && (t.byhour = [t.byhour])
      : (t.byhour = t.freq < K.HOURLY ? [t.dtstart.getUTCHours()] : null),
    m(t.byminute)
      ? h(t.byminute) && (t.byminute = [t.byminute])
      : (t.byminute = t.freq < K.MINUTELY ? [t.dtstart.getUTCMinutes()] : null),
    m(t.bysecond)
      ? h(t.bysecond) && (t.bysecond = [t.bysecond])
...
function R(e) {
  ...
  var r = n[1],
    i = n[2];
  return (r && (t.tzid = r), (t.dtstart = me(i)), t);
}
function Ne(e) {
...
function Fe(e) {
  return e.indexOf(`,`) === -1 ? Ie(e) : e.split(`,`).map(Ie);
}
function Ie(e) {
...
var z = (function () {
  ...
  return (
    ...
    (e.prototype.toString = function () {
      var e = pe(this.date.getTime(), this.isUTC);
...
function Re(e) {
  for (
    var t = [], n = ``, r = Object.keys(e), i = Object.keys(ft), a = 0;
    a < r.length;
    a++
  )
    if (r[a] !== `tzid` && D(i, r[a])) {
      ...
      if (!(!m(s) || (_(s) && !s.length))) {
        switch (o) {
          case `FREQ`:
            ...
            break;
          case `WKST`:
            c = h(s) ? new p(s).toString() : s.toString();
            break;
          case `BYWEEKDAY`:
            ((o = `BYDAY`),
              (c = b(s)
...
function ze(e, t) {
  return e ? `DTSTART` + new z(new Date(e), t).toString() : ``;
}
function Be(e, t) {
...
var Ve = (function () {
    ...
    return (
      ...
      (e.prototype._cacheGet = function (e, t) {
        ...
        return _(n) ? fe(n) : n instanceof Date ? de(n) : n;
      }),
      e
    );
  })(),
            ...
            a(
              a(
                a(
                  a(
                    a(
                      a(a(a([], y(1, 31), !0), y(2, 28), !0), y(3, 31), !0),
                      y(4, 30),
                      !0,
                    ),
                    y(5, 31),
            ...
            a(
              a(
                a(
                  a(
                    a(
                      a(a(a([], y(1, 31), !0), y(2, 29), !0), y(3, 31), !0),
                      y(4, 30),
                      !0,
                    ),
                    y(5, 31),
      ...
      a(
        a(
          a(
            a(
              a(
                a(a(a(a(a(a([], V, !0), Ge, !0), V, !0), B, !0), V, !0), B, !0),
                V,
                !0,
              ),
              V,
      ...
      a(
        a(
          a(
            a(
              a(
                a(a(a(a(a(a([], V, !0), We, !0), V, !0), B, !0), V, !0), B, !0),
                V,
                !0,
              ),
              V,
      ...
      a(
        a(
          a(
            a(
              a(
                a(a(a(a(a(a([], U, !0), Ye, !0), U, !0), H, !0), U, !0), H, !0),
                U,
                !0,
              ),
              U,
      ...
      a(
        a(
          a(
            a(
              a(
                a(a(a(a(a(a([], U, !0), Je, !0), U, !0), H, !0), U, !0), H, !0),
                U,
                !0,
              ),
              U,
  ...
  Qe = [0, 31, 60, 91, 121, 152, 182, 213, 244, 274, 305, 335, 366],
  $e = [0, 31, 59, 90, 120, 151, 181, 212, 243, 273, 304, 334, 365],
  et = (function () {
    for (var e = [], t = 0; t < 55; t++) e = e.concat(v(7));
    return e;
  })();
function tt(e, t) {
  var n = O(e, 1, 1),
    ...
    o = j(n),
    c = s(
      s({ yearlen: r, nextyearlen: i, yearordinal: a, yearweekday: o }, nt(e)),
      { wnomask: null },
    );
  if (T(t.byweekno)) return c;
  c.wnomask = y(0, r + 7);
  var l,
    u,
    d = (l = C(7 - o + t.wkst, 7));
  d >= 4 ? ((d = 0), (u = c.yearlen + C(o - t.wkst, 7))) : (u = r - d);
  for (
    var f = Math.floor(u / 7), p = C(u, 7), m = Math.floor(f + p / 4), h = 0;
    h < t.byweekno.length;
    h++
  ) {
    var g = t.byweekno[h];
    if ((g < 0 && (g += m + 1), g > 0 && g <= m)) {
      var _ = void 0;
      g > 1 ? ((_ = d + (g - 1) * 7), d !== l && (_ -= 7 - l)) : (_ = d);
      for (
        var v = 0;
        v < 7 && ((c.wnomask[_] = 1), _++, c.wdaymask[_] !== t.wkst);
        v++
      );
    }
  }
  if (D(t.byweekno, 1)) {
    ...
    if ((d !== l && (_ -= 7 - l), _ < r))
      for (
        var h = 0;
        h < 7 && ((c.wnomask[_] = 1), (_ += 1), c.wdaymask[_] !== t.wkst);
        h++
      );
  }
  if (d) {
    var b = void 0;
    if (D(t.byweekno, -1)) b = -1;
    else {
      var x = j(O(e - 1, 1, 1)),
        S = C(7 - x.valueOf() + t.wkst, 7),
        w = k(e - 1) ? 366 : 365,
        E = void 0;
      (S >= 4 ? ((S = 0), (E = w + C(x - t.wkst, 7))) : (E = r - d),
        (b = Math.floor(52 + C(E, 7) / 4)));
    }
    if (D(t.byweekno, b)) for (var _ = 0; _ < d; _++) c.wnomask[_] = 1;
  }
  return c;
}
function nt(e) {
  ...
  for (var c = 0; c < s.length; c++)
    for (
      ...
      var p = void 0,
        ...
        g = m[1];
      (g < 0
        ? ((p = d + (g + 1) * 7), (p -= C(i[p] - h, 7)))
        : ((p = u + (g - 1) * 7), (p += C(7 - i[p] + h, 7))),
...
var at = (function () {
  ...
  return (
    (e.prototype.rebuild = function (e, t) {
      var n = this.options;
      if (
        (e !== this.lastyear && (this.yearinfo = tt(e, n)),
        ...
        var r = this.yearinfo,
          ...
          a = r.mrange,
          o = r.wdaymask;
        this.monthinfo = rt(e, t, i, a, o, n);
      }
      m(n.byeaster) && (this.eastermask = it(e, n.byeaster));
    }),
    ...
    (e.prototype.ydayset = function () {
      return [v(this.yearlen), 0, this.yearlen];
    }),
...
function ot(e, t, n, r, i, a) {
  for (var o = [], s = 0; s < e.length; s++) {
    var c = void 0,
      ...
      u = e[s];
    u < 0
      ? ((c = Math.floor(u / t.length)), (l = C(u, t.length)))
      : ((c = Math.floor((u - 1) / t.length)), (l = C(u - 1, t.length)));
    for (var d = [], f = n; f < r; f++) {
      var p = a[f];
      m(p) && d.push(p);
    }
    var h = void 0;
    h = c < 0 ? d.slice(c)[0] : d[c];
    var g = t[l],
      _ = ue(se(i.yearordinal + h), g);
    D(o, _) || o.push(_);
  }
  return (M(o), o);
}
function st(e, t) {
  ...
  for (var u = dt(l, c, t); ; ) {
    var d = l.getdayset(r)(c.year, c.month, c.day),
      ...
      g = ut(f, p, h, l, t);
    if (E(o))
      for (var _ = ot(o, u, p, h, l, f), v = 0; v < _.length; v++) {
        var y = _[v];
        if (a && y > a) return W(e);
        if (y >= n) {
          var b = lt(y, t);
          if (!e.accept(b) || (s && (--s, !s))) return W(e);
        }
      }
    else
      for (var v = p; v < h; v++) {
        var x = f[v];
        if (m(x))
          for (var S = se(l.yearordinal + x), C = 0; C < u.length; C++) {
            var w = u[C],
              y = ue(S, w);
            if (a && y > a) return W(e);
            if (y >= n) {
    ...
    if (t.interval === 0 || (c.add(t, g), c.year > 9999)) return W(e);
    (we(r) || (u = l.gettimeset(r)(c.hour, c.minute, c.second, 0)),
      l.rebuild(c.year, c.month));
  }
}
function ct(e, t, n) {
  ...
  return (
    (E(r) && !D(r, e.mmask[t])) ||
    (E(i) && !e.wnomask[t]) ||
    (E(a) && !D(a, e.wdaymask[t])) ||
    (E(e.nwdaymask) && !e.nwdaymask[t]) ||
    (o !== null && !D(e.eastermask, t)) ||
    ((E(s) || E(c)) && !D(s, e.mdaymask[t]) && !D(c, e.nmdaymask[t])) ||
    (E(l) &&
      ((t < e.yearlen && !D(l, t + 1) && !D(l, -e.yearlen + t)) ||
        (t >= e.yearlen &&
          !D(l, t + 1 - e.yearlen) &&
          !D(l, -e.nextyearlen + t - e.yearlen))))
  );
}
function lt(e, t) {
...
function dt(e, t, n) {
  ...
  return we(r)
    ? je(n)
    : (r >= K.HOURLY && E(i) && !D(i, t.hour)) ||
        (r >= K.MINUTELY && E(a) && !D(a, t.minute)) ||
        (r >= K.SECONDLY && E(o) && !D(o, t.second))
      ? []
...
var G = {
  ...
  K = (function () {
    function e(e, t) {
      (e === void 0 && (e = {}),
        t === void 0 && (t = !1),
        (this._cache = t ? null : new Ve()),
        (this.origOptions = ke(e)),
        (this.options = Ae(e).parsedOptions));
    }
    return (
      ...
      (e.prototype.all = function (e) {
        if (e) return this._iter(new _e(`all`, {}, e));
        var t = this._cacheGet(`all`);
        return (
          t === !1 &&
            ((t = this._iter(new N(`all`, {}))), this._cacheAdd(`all`, t)),
          t
        );
      }),
      (e.prototype.between = function (e, t, n, r) {
        if ((n === void 0 && (n = !1), !A(e) || !A(t)))
          throw Error(`Invalid date passed in to RRule.between`);
        var i = { before: t, after: e, inc: n };
        if (r) return this._iter(new _e(`between`, i, r));
        var a = this._cacheGet(`between`, i);
        return (
          a === !1 &&
            ((a = this._iter(new N(`between`, i))),
...
function gt(e, t) {
  var n = [],
    ...
    c = o.tzid;
  return (
    Ct(e, t.unfold).forEach(function (e) {
      if (e) {
        var t = St(e),
          o = t.name,
          s = t.parms,
...
function _t(e, t) {
  ...
  if (
    ...
    return (
      ...
      r.forEach(function (e) {
        u.rrule(new K(yt(e, s, c), l));
      }),
      i.forEach(function (e) {
        u.rdate(e);
      }),
      a.forEach(function (e) {
        u.exrule(new K(yt(e, s, c), l));
      }),
  ...
  var d = r[0] || {};
  return new K(yt(d, d.dtstart || t.dtstart || s, d.tzid || t.tzid || c), l);
}
function vt(e, t) {
  return (t === void 0 && (t = {}), _t(e, bt(t)));
}
function yt(e, t, n) {
  ...
  return (
    ...
    (t.prototype.valueOf = function () {
      ...
      return (
        !this._rrule.length &&
          this._dtstart &&
          (e = e.concat(Re({ dtstart: this._dtstart }))),
...
`,
        ...
        this._rdate.length && e.push(At(`RDATE`, this._rdate, this.tzid())),
        this._exdate.length && e.push(At(`EXDATE`, this._exdate, this.tzid())),
        e
      );
    }),
...
function Ot(e, t) {
  ...
  D(t.map(String), String(e)) || t.push(e);
}
function kt(e, t) {
  if (!(e instanceof Date))
    throw TypeError(String(e) + ` is not Date instance`);
  D(t.map(Number), Number(e)) || (t.push(e), M(t));
}
function At(e, t, n) {
  var r = !n || n.toUpperCase() === `UTC`;
  return `${r ? `${e}:` : `${e};TZID=${n}:`}${t
    .map(function (e) {
      return pe(e.valueOf(), r);
    })
    .join(`,`)}`;
}
var q = [`SU`, `MO`, `TU`, `WE`, `TH`, `FR`, `SA`];
function J(e) {
  let t = new Map(q.map((e, t) => [e, t]));
...
function Nt(e, t, n, r, i) {
  ...
  return e.length > 2 && Bt(e)
    ? zt(e, t)
    : Pt(e, t, e.length > 2 ? `short` : i);
}
function Y(e, t) {
  return e.length === t.length ? t.every((t) => e.includes(t)) : !1;
}
function Pt(e, t, n) {
  let r = e.map((e) => (n === `short` ? Rt(e, t) : Ft(e, t, `long`)));
...
function Rt(e, t) {
  let n = Ft(e, t, `short`),
    r = Ft(e, t, `long`);
  return n.length >= r.length ? t.formatDate(It(e), { weekday: `narrow` }) : n;
}
function zt(e, t) {
  let n = J(e),
    r = n[0],
...
var X = Array.from(q),
  ...
  Ut = `09:00`,
  Wt = `MO`,
  Gt = { MO: K.MO, TU: K.TU, WE: K.WE, TH: K.TH, FR: K.FR, SA: K.SA, SU: K.SU };
function Kt() {
  return {
    mode: `daily`,
    intervalHours: 24,
...
function Zt(e) {
  let t = {
    kind: un(e.kind),
    ...(`status` in e ? { status: dn(e.status) } : {}),
    ...Xt(e.rrule),
    hasModel: e.model != null,
    ...(e.reasoningEffort == null
      ? {}
      : { reasoningEffort: fn(e.reasoningEffort) }),
  };
  if (e.kind !== `cron`) return t;
  let n = {
    ...t,
    cwdCount: e.cwds.length,
    executionEnvironment: pn(e.executionEnvironment),
  };
  return (
  ...
  switch (e.mode) {
    case `hourly`:
      return e.intervalMinutes == null
        ? an(e.intervalHours)
        : on(e.intervalMinutes);
    case `daily`:
      return cn({ time: e.time, weekdays: X });
    case `weekdays`:
      return cn({ time: e.time, weekdays: Array.from(Vt) });
    case `weekly`:
      return cn({ time: e.time, weekdays: [wn(e.weekdays)] });
    case `custom`:
...
function $t(e) {
  switch (e.mode) {
    case `hourly`:
      return e.intervalMinutes == null
        ? Z(e.intervalHours) != null
        : Q(e.intervalMinutes) != null;
    case `daily`:
    case `weekdays`:
    case `weekly`:
      return Tn(e.time) != null;
    case `custom`:
      return En(e.customRrule.trim());
  }
}
function en(e, t) {
  return t === `custom`
    ? {
        ...
        mode: `custom`,
        customRrule:
          e.mode === `custom` && e.customRrule.trim() ? e.customRrule : Qt(e),
      }
    : t === `hourly`
      ? {
          ...e,
          ...
          intervalMinutes:
            e.intervalMinutes == null ? null : (Q(e.intervalMinutes) ?? 30),
        }
      : t === `daily`
        ? { ...e, mode: `daily`, weekdays: X }
        : t === `weekdays`
          ? { ...e, mode: `weekdays`, weekdays: Array.from(Vt) }
          : { ...e, mode: `weekly`, weekdays: [wn(e.weekdays)] };
}
function tn(e) {
  return e.length > 0 ? J(e) : X;
}
function nn(e, t) {
  return hn($(Qt(e)), t) ?? null;
}
function rn({ rrule: e, intl: t, fallbackMessage: n }) {
  return e ? (hn($(e), t) ?? n) : null;
}
function an(e) {
  let t = Z(e) ?? 1;
  return new K({
...
function sn(e) {
  return e.freq === K.MINUTELY
    ? (Q(e.interval) ?? 30)
    : e.freq === K.HOURLY
      ? (Z(e.interval) ?? 1) * 60
      : null;
}
function cn({ time: e, weekdays: t }) {
  let n = Tn(e) ?? Tn(Ut);
  return n
    ? new K({
        freq: K.WEEKLY,
...
function $(e) {
  if (!e) return null;
  try {
    let t = vt(e, { forceset: !0, tzid: On() ?? void 0 }).rrules()[0];
    if (!t) return null;
    let n = t.options,
      r = Sn(n.byweekday) ?? Cn(e) ?? X,
      i = xn(n.byminute);
    return {
      freq: n.freq,
...
function ln(e) {
  if (
    ...
    return `hourly`;
  if (e.interval === 1 && (e.freq === K.DAILY || e.freq === K.WEEKLY)) {
    if (Y(e.weekdays, X)) return `daily`;
    if (Y(e.weekdays, Vt)) return `weekdays`;
...
function un(e) {
  switch (e) {
    case `cron`:
      return t.CODEX_AUTOMATION_KIND_CRON;
    case `heartbeat`:
      return t.CODEX_AUTOMATION_KIND_HEARTBEAT;
  }
}
function dn(e) {
  switch (e) {
    case `ACTIVE`:
      return n.CODEX_AUTOMATION_STATUS_ACTIVE;
    case `PAUSED`:
      return n.CODEX_AUTOMATION_STATUS_PAUSED;
    case `DELETED`:
      return n.CODEX_AUTOMATION_STATUS_DELETED;
  }
}
function fn(e) {
  switch (e) {
    case `none`:
      return r.CODEX_AUTOMATION_REASONING_EFFORT_NONE;
    case `minimal`:
      return r.CODEX_AUTOMATION_REASONING_EFFORT_MINIMAL;
    case `low`:
      return r.CODEX_AUTOMATION_REASONING_EFFORT_LOW;
    case `medium`:
      return r.CODEX_AUTOMATION_REASONING_EFFORT_MEDIUM;
    case `high`:
      return r.CODEX_AUTOMATION_REASONING_EFFORT_HIGH;
    case `xhigh`:
      return r.CODEX_AUTOMATION_REASONING_EFFORT_XHIGH;
  }
}
function pn(t) {
  switch (t) {
    case `worktree`:
      return e.CODEX_AUTOMATION_EXECUTION_ENVIRONMENT_WORKTREE;
    case `local`:
      return e.CODEX_AUTOMATION_EXECUTION_ENVIRONMENT_LOCAL;
  }
}
function mn(e) {
  switch (e) {
...
function hn(e, t) {
  ...
  let i = jt(e.time, t);
  return i ? yn({ intl: t, isEveryDay: r, timeLabel: i, weekdays: n }) : null;
}
function gn({ intervalHours: e, intl: t, isEveryDay: n, weekdays: r }) {
  let i =
    e === 1
      ? t.formatMessage({
...
function _n({ intervalMinutes: e, intl: t, isEveryDay: n, weekdays: r }) {
  let i = vn({ intervalMinutes: e, intl: t });
  if (n) return i;
  let a = t.formatMessage(
    {
      id: `settings.automations.scheduleSummary.intervalDayCount`,
...
function vn({ intervalMinutes: e, intl: t }) {
  return e === 1
    ? t.formatMessage({
...
function yn({ intl: e, isEveryDay: t, timeLabel: n, weekdays: r }) {
  let i = Y(r, Vt),
    a = Y(r, Ht);
  if (t)
...
function bn(e, t, n) {
  ...
  return r != null && i != null
    ? Dn(r, i)
    : n.dtstart
      ? Dn(n.dtstart.getHours(), n.dtstart.getMinutes())
      : Ut;
}
function xn(e) {
  return Array.isArray(e)
...
function Sn(e) {
  if (!e) return null;
  let t = new Map(q.map((e) => [Gt[e].weekday, e])),
    n = (Array.isArray(e) ? e : [e])
      .map((e) => {
        if (typeof e == `string`) {
          let t = e.toUpperCase();
          return q.includes(t) ? t : null;
        }
        return typeof e == `number`
          ? (t.get(e) ?? null)
...
//# sourceMappingURL=automation-schedule-wEVXO_Fw.js.map
