...
var rt = (e, t) => {
  ...
  let r = tt(() => {
    ...
    (n.addEventListener(`keyup`, e, t),
      n.addEventListener(`blur`, () => nt(n, `cancel`), t));
  });
...
function Et(e, t, n, r) {
  let i = (0, P.useMemo)(() => {
    let n = Tt();
    return (
      re(n, t, b(r), e.transformTemplate, e.style),
...
function zt(e, t, n, r) {
  ...
  ((e.projection = new n(
    e.latestValues,
    t[`data-framer-portal-id`] ? void 0 : Bt(e.parent),
  )),
...
function Ht(e, { forwardMotionProps: t = !1 } = {}, n, r) {
  ...
  function a(a, o) {
    ...
    if (!u && c) {
      ...
      let t = Gt(l);
      ((s = t.MeasureLayout),
        (d.visualElement = Rt(e, f, l, r, t.ProjectionNode)));
    }
    return (0, Vt.jsxs)(z.Provider, {
      value: d,
      children: [
        s && d.visualElement
          ? (0, Vt.jsx)(s, { visualElement: d.visualElement, ...l })
          : null,
...
function Kt(e, t) {
  ...
  return new Proxy((e, t) => r(e, t), {
    get: (i, a) =>
      a === `create`
        ? r
        : (n.has(a) || n.set(a, Ht(a, void 0, e, t)), n.get(a)),
  });
}
var qt = (e, t) =>
  Ot(e) ? new ve(t) : new Ee(t, { allowProjection: e !== P.Fragment });
...
function rn(e) {
  return (t) =>
    Promise.all(t.map(({ animation: t, options: n }) => Zt(e, t, n)));
}
function an(e) {
  let t = rn(e),
    n = sn(),
...
function yn(e, t, n, r = 0.5) {
  ((e.origin = r),
    ...
    ((e.translate >= gn && e.translate <= _n) || isNaN(e.translate)) &&
      (e.translate = 0));
}
function J(e, t, n, r) {
  (yn(e.x, t.x, n.x, r ? r.originX : void 0),
    yn(e.y, t.y, n.y, r ? r.originY : void 0));
}
function bn(e, t, n) {
...
var Wn = new WeakMap(),
  Gn = class {
    ...
    updateAxis(e, t, n) {
      ...
      (this.constraints &&
        this.constraints[e] &&
        (a = Nn(a, this.constraints[e], this.elastic[e])),
        i.set(a));
    }
    resolveConstraints() {
    ...
    startAxisValueAnimation(e, t) {
      ...
      return (
        ...
        n.start(je(e, n, 0, t, this.visualElement, !1))
      );
    }
    stopAnimation() {
...
var rr = {
  ...
  ar = class {
    ...
    forEach(e) {
      (this.isDirty && this.children.sort(ir),
        (this.isDirty = !1),
...
function dr(e, t, n, r, i, a) {
  i
    ? ((e.opacity = k(0, n.opacity ?? 1, pr(r))),
      (e.opacityExit = k(t.opacity ?? 1, 0, mr(r))))
  ...
  for (let i = 0; i < cr; i++) {
    ...
    (o === void 0 && s === void 0) ||
      ...
      (s ||= 0),
      o === 0 || s === 0 || ur(o) === ur(s)
        ? ((e[a] = Math.max(k(lr(o), lr(s), r), 0)),
          (ye.test(s) || ye.test(o)) && (e[a] += `%`))
        : (e[a] = s));
  }
...
function yr(e, t = 0, n = 1, r = 0.5, i, a = e, o = e) {
  ...
  (e === a && (s -= t),
    (e.min = vr(e.min, t, n, s, i)),
    (e.max = vr(e.max, t, n, s, i)));
}
  ...
  return class {
          ...
          this.addEventListener(
            ...
            ({
              ...
              let a = this.options.transition || i.getDefaultTransition() || ri,
                { onLayoutAnimationStart: s, onLayoutAnimationComplete: c } =
                  i.getProps(),
    ...
    startUpdate() {
      this.isUpdateBlocked() ||
        ((this.isUpdating = !0),
        this.nodes && this.nodes.forEach(Zr),
        this.animationId++);
    }
    ...
    setAnimationOrigin(e, t = !1) {
      ...
      ((this.mixTargetDelta = (t) => {
        ...
        ($r(a.x, e.x, n),
          ...
          s &&
            ((this.animationValues = i), dr(i, r, this.latestValues, n, u, l)),
          this.root.scheduleUpdateProjection(),
          this.scheduleRender(),
    ...
    finishAnimation() {
      (this.currentAnimation &&
        (this.mixTargetDelta && this.mixTargetDelta(Fr),
        this.currentAnimation.stop()),
        this.completeAnimation());
    }
    applyTransformsToTarget() {
      ...
      if (!(!t || !n || !r)) {
        ...
        (Q(t, n),
          N(t, i),
          J(this.projectionDeltaWithTransform, this.layoutCorrected, t, i));
      }
    }
    ...
    applyProjectionStyles(e, t) {
      ...
      this.options.layoutId &&
        (e.pointerEvents = r === this ? B(t?.pointerEvents) || `` : `none`);
    }
    clearSnapshot() {
...
function ci(e, t, n) {
  return (
    e === `position` || (e === `preserve-aspect` && !vn(Ar(t), Ar(n), 0.2))
  );
}
function li(e) {
...
var ui = zr({
  ...
  pi = {
    pan: { Feature: Xn },
    drag: { Feature: Jn, ProjectionNode: fi, MeasureLayout: nr },
  };
function mi(e, t, n) {
  let { props: r } = e;
  e.animationState &&
...
function Ci({ root: e, ...t }) {
  ...
  let r = bi.get(n),
    i = JSON.stringify(t);
  return (
    r[i] || (r[i] = new IntersectionObserver(Si, { root: e, ...t })),
    r[i]
  );
}
function wi(e, t, n) {
...
//# sourceMappingURL=proxy-HwxlKevX.js.map
