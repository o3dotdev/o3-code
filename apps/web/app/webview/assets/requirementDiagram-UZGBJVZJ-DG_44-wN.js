import { h as e } from "./chunk-S3R3BYOJ-5zDRn6nL.js";
import { i as t, n, r } from "./src-DXdm7MTq.js";
import {
  B as i,
  C as a,
  U as o,
...
import { t as f } from "./chunk-55IACEB6-ouq-OFLp.js";
import { t as p } from "./chunk-QN33PNHL-BRcT7LP7.js";
import "./chunk-ATLVNIR6-DztwCsKK.js";
import "./chunk-JZLCHNYA-BxKQhlWe.js";
import "./chunk-QXUST7PY-BKTz6l_w.js";
import { r as m, t as h } from "./chunk-N4CR4FBY-l_UuU9Uv.js";
var g = (function () {
  var e = r(function (e, t, n, r) {
    ...
    le = {
      ...
      table: [
        { 3: 1, 4: 2, 6: t, 9: n, 11: i, 13: a },
        { 1: [3] },
        { 3: 8, 4: 2, 5: [1, 7], 6: t, 9: n, 11: i, 13: a },
        { 5: [1, 9] },
        { 10: [1, 10] },
        { 12: [1, 11] },
        e(o, [2, 6]),
        { 3: 12, 4: 2, 6: t, 9: n, 11: i, 13: a },
        { 1: [2, 2] },
        {
          4: 17,
          5: s,
  ...
  v = class {
    constructor() {
      ((this.relations = []),
        ...
        (this.getConfig = r(() => l().requirement, `getConfig`)),
        this.clear(),
...
`,
  ...
  b = {};
n(b, { draw: () => x });
var x = r(async function (n, r, i, a) {
    (t.info(`REF0:`), t.info(`Drawing requirement diagram (unified)`, r));
    let { securityLevel: o, state: s, layout: c } = l(),
      u = a.db.getData(),
      d = f(r, o);
    ((u.type = a.type),
      (u.layoutAlgorithm = h(c)),
      (u.nodeSpacing = s?.nodeSpacing ?? 50),
      (u.rankSpacing = s?.rankSpacing ?? 50),
      (u.markers = [`requirement_contains`, `requirement_arrow`]),
      (u.diagramId = r),
      await m(u, d),
      e.insertTitle(
        d,
      ...
      p(d, 8, `requirementDiagram`, s?.useMaxWidth ?? !0));
  }, `draw`),
  S = {
    parser: _,
    get db() {
...
export { S as diagram };
//# sourceMappingURL=requirementDiagram-UZGBJVZJ-DG_44-wN.js.map
