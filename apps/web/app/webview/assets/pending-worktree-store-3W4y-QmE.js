...
import { Ta as t, wa as n } from "./app-server-manager-signals-7MlBpIlX.js";
import { n as r } from "./jsx-runtime-CiQ1k8xo.js";
import { t as i } from "./v4-Bk0goSq-.js";
import { xt as a, y as o } from "./setting-storage-kJblH-wH.js";
var s = e(r(), 1),
  c = new Set(),
  l = new Map(),
  u = [];
    ...
    : ((c = (e, n) => {
        if (n.length !== 0) {
          if (window.electronBridge == null) {
            t((t) =>
              (t === void 0 ? [] : t).map((t) => (t.id === e ? O(t, n) : t)),
            );
            return;
          }
          n.forEach((t) => {
  ...
  return (
    ...
    e[28] !== v
      ? ((M = {
          ...
          cancelPendingWorktree: k,
          dismissPendingWorktree: j,
        }),
        (e[21] = k),
        (e[22] = S),
        (e[23] = s),
...
//# sourceMappingURL=pending-worktree-store-3W4y-QmE.js.map
