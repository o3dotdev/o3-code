...
import { H as n, W as r, xt as i } from "./setting-storage-kJblH-wH.js";
import { o as a } from "./statsig-BwN76nAo.js";
import { t as o } from "./link-external-GLfZmEQP.js";
import { t as s } from "./chevron-right-DcOUsgCQ.js";
import {
  A as c,
  F as l,
  L as u,
...
import { n as g, r as _ } from "./dropdown-CLcC-0sa.js";
import { t as v } from "./bullet-separator-DRolu1zj.js";
import { t as y } from "./speedometer-DAUlZKWu.js";
var b = i(),
  x = e();
function S(e) {
  let t = (0, b.c)(6),
    ...
    o;
  t[0] !== a || t[1] !== n || t[2] !== i
    ? ((o = p({ intl: a, minutes: n, variant: i })),
      (t[0] = a),
      (t[1] = n),
      (t[2] = i),
      (t[3] = o))
...
function C(e) {
  ...
  if (
    ...
    let e = h(l, { activeLimitName: u, selectedModel: p }),
      r;
    (i[20] !== u || i[21] !== f
      ? ((r = f ?? !m(u)), (i[20] = u), (i[21] = f), (i[22] = r))
      : (r = i[22]),
      (A = r),
      (O = C === `compact`));
    let a;
    (i[23] === O
      ...
      : ((a = (e) => {
          let { className: n } = e;
          return (0, x.jsx)(o, {
            className: t(n, O && `text-token-description-foreground`),
          });
        }),
        (i[23] = O),
        (i[24] = a)),
    ...
    ((E = i[8]),
      ...
      (L = i[19]));
  let R;
  i[30] !== j || i[31] !== M || i[32] !== N
    ? ((R = (0, x.jsxs)(`span`, { className: j, children: [M, N] })),
      (i[30] = j),
      (i[31] = M),
      (i[32] = N),
      (i[33] = R))
  ...
  i[41] === B
    ? (V = i[42])
    : ((V = t(`grid items-center gap-y-1.5 py-1`, B)),
      (i[41] = B),
      (i[42] = V));
  let H;
  if (i[43] !== O || i[44] !== l) {
    ...
    (i[46] === O
      ? (e = i[47])
      : ((e = (e, t) => {
          let n = m(e.limitName) ? null : e.limitName;
          return (0, x.jsx)(
            ee,
            { rateLimit: e.snapshot, limitName: n, compact: O },
  ...
  let U;
  i[48] !== V || i[49] !== H
    ? ((U = (0, x.jsx)(`div`, { className: V, children: H })),
      (i[48] = V),
      (i[49] = H),
      (i[50] = U))
    : (U = i[50]);
  let W;
  i[51] !== O || i[52] !== v || i[53] !== d || i[54] !== A
    ? ((W =
        !A &&
        (0, x.jsx)(te, {
          planType: d,
    ...
    : (W = i[55]);
  let G =
      O && `pl-[calc(var(--padding-row-x)+1.25rem)] pr-[var(--padding-row-x)]`,
    K;
  i[56] === G ? (K = i[57]) : ((K = t(G)), (i[56] = G), (i[57] = K));
  let q = O ? `text-token-foreground` : `text-token-description-foreground`,
    J;
  i[58] === q ? (J = i[59]) : ((J = t(q)), (i[58] = q), (i[59] = J));
  let Y;
  ...
  let $;
  return (
    i[71] !== D || i[72] !== z || i[73] !== Q
      ? (($ = (0, x.jsx)(D, { trigger: z, children: Q })),
        (i[71] = D),
        (i[72] = z),
        (i[73] = Q),
        (i[74] = $))
...
function ee(e) {
  let r = (0, b.c)(19),
    ...
    s = i?.primary,
    c;
  r[0] === s ? (c = r[1]) : ((c = u(s)), (r[0] = s), (r[1] = c));
  let l = c,
    d = i?.secondary,
    f;
  r[2] === d ? (f = r[3]) : ((f = u(d)), (r[2] = d), (r[3] = f));
  let p = f;
  if (!l && !p) return null;
  let m;
  r[4] !== o || r[5] !== a
...
function w(e) {
  ...
  if (n[0] !== r.resetsAt) {
    ...
    ((a = e == null ? null : d(e)), (n[0] = r.resetsAt), (n[1] = a));
  } else a = n[1];
  let o = a,
    s,
    p,
  ...
  if (n[2] !== r.usedPercent || n[3] !== r.windowDurationMins || n[4] !== i) {
    ...
    let u = i && `shrink-0`,
      d;
    n[11] === u ? (d = n[12]) : ((d = t(u)), (n[11] = u), (n[12] = d));
    ...
    let _;
    (n[15] !== g || n[16] !== d
      ? ((_ = (0, x.jsx)(`span`, { className: d, children: g })),
        (n[15] = g),
        (n[16] = d),
        (n[17] = _))
      : (_ = n[17]),
  ...
  return (
    n[32] !== h || n[33] !== y
      ? ((C = (0, x.jsxs)(x.Fragment, { children: [h, y] })),
        (n[32] = h),
        (n[33] = y),
        (n[34] = C))
      : (C = n[34]),
...
function te(e) {
  let t = (0, b.c)(15),
    { planType: r, className: i, onPlanUpgradeClick: a } = e;
  switch (r) {
    case `free`:
    case `go`: {
      let e;
...
export { C as t };
//# sourceMappingURL=rate-limit-summary-CCQBLWCv.js.map
