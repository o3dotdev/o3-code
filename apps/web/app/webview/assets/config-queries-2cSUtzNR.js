import { gi as e, mi as t, oi as n } from "./src-BLHmAhbF.js";
import { Ta as r, ts as i } from "./app-server-manager-signals-7MlBpIlX.js";
import {
  C as a,
  L as o,
  Q as s,
...
import { t as g } from "./invalidate-queries-and-broadcast-CPrIeBVQ.js";
import { t as _ } from "./thread-context-inputs-D4zJFWk0.js";
var v = h(),
  y = [`config`, `mcp`, `servers`],
  b = [`config`, `user`],
  x = [`config`, `analytics`],
  S = [`config`, `requirements`],
  C = [`config`, `effective`],
  w = [`config`, `layered-response`],
  T = [`config`, `read-response`],
  E = [`mcp`, `servers`, `status`],
  D = [`mcp`, `resource`],
  O = 1e7,
  k = t(e(), n()),
  A = {
...
function ee(e, t) {
  let n = (0, v.c)(11),
    ...
    p;
  n[0] !== r || n[1] !== s
    ? ((p = [...y, r, s]), (n[0] = r), (n[1] = s), (n[2] = p))
    : (p = n[2]);
  let m;
  n[3] !== r || n[4] !== f || n[5] !== s
    ? ((m = () => P(f, r, s)), (n[3] = r), (n[4] = f), (n[5] = s), (n[6] = m))
    : (m = n[6]);
  let h;
  return (
    n[7] !== c || n[8] !== p || n[9] !== m
...
function te(e) {
  ...
  return {
    servers: i,
    configWriteTarget: ie({ layers: r, origins: n, keyPath: `mcp_servers` }),
    serverOrigins: ae({
      origins: n,
      rootKey: `mcp_servers`,
...
var ne = s(c, (e) =>
  f(c, ({ queryClient: t }) => ({
    ...
    queryFn: async () => {
      try {
        return await F(t, e, null, !0);
      } catch (e) {
        return (
          a.error(`Failed to load config`, {
            safe: {},
            sensitive: { error: e },
          }),
          A
...
function M(e, t) {
  let n = (0, v.c)(11),
    ...
    c;
  n[0] !== r || n[1] !== a
    ? ((c = [...C, r, a]), (n[0] = r), (n[1] = a), (n[2] = c))
    : (c = n[2]);
  let f;
  n[3] !== r || n[4] !== s || n[5] !== a
    ? ((f = () => P(s, r, a)), (n[3] = r), (n[4] = s), (n[5] = a), (n[6] = f))
    : (f = n[6]);
  let p = t?.enabled ?? !0,
    m;
  return (
...
function F(e, t, n, r) {
  return e.fetchQuery({
    queryKey: [...T, t, n, r],
    queryFn: () =>
      i(`read-config-for-host`, { hostId: t, includeLayers: r, cwd: n }),
    staleTime: 0,
  });
}
var I = s(c, (e) => f(c, () => L(e, !0)));
function L(e, t) {
  return {
    queryKey: [...S, e],
    queryFn: async () => {
      try {
        return await i(`get-config-requirements-for-host`, { hostId: e });
      } catch (e) {
        return (
...
function R(e, t) {
  ...
  n[5] === r
    ? (c = n[6])
    : ((c = { enabled: r, staleTime: d.FIVE_MINUTES }), (n[5] = r), (n[6] = c));
  let l;
  return (
    n[7] !== s || n[8] !== c
      ? ((l = { params: s, queryConfig: c, select: z }),
        (n[7] = s),
        (n[8] = c),
        (n[9] = l))
      : (l = n[9]),
    p(`local-custom-agents`, l)
  );
}
function z(e) {
...
function B(e) {
  ...
  return (
    t[0] === n
      ...
      : ((r = {
          mutationFn: (e) => {
            let { filePath: t, expectedVersion: r, edits: o } = e;
            try {
              ...
              let t = e;
              throw (
                a.error(`Failed to add MCP server`, {
                  safe: {},
                  sensitive: { error: t },
                }),
                t
...
function V(e) {
  return { ...e, mergeStrategy: e.mergeStrategy ?? `upsert` };
}
function H(e) {
  let t = (0, v.c)(18),
    n = e?.hostId ?? `local`,
  ...
  t[4] !== l || t[5] !== r
    ? ((d = async (e) => {
        ...
        await r.cancelQueries({ queryKey: l });
        let i = r.getQueriesData({ queryKey: l }).flatMap(U);
        for (let [e, a] of i) r.setQueryData(e, W(a, t, n));
        return { previousMcpServerResponses: i };
      }),
      (t[4] = l),
      (t[5] = r),
      (t[6] = d))
  ...
  t[7] === r
    ...
    : ((f = (e, t, n) => {
        ...
        for (let [e, t] of n?.previousMcpServerResponses ?? [])
          r.setQueryData(e, t);
      }),
      (t[7] = r),
      (t[8] = f));
  ...
  return (
    t[13] !== u || t[14] !== d || t[15] !== f || t[16] !== p
      ? ((h = { mutationFn: u, onMutate: d, onError: f, onSettled: p }),
        (t[13] = u),
        (t[14] = d),
        (t[15] = f),
        (t[16] = p),
...
function G(e, t, n) {
  ...
  let i = k.safeParse(r.data[t]);
  return i.success ? { ...r.data, [t]: { ...i.data, enabled: n } } : null;
}
var K = s(c, (e) => f(c, () => J(e, !0))),
  q = s(c, (e) => f(c, () => J(e, !1)));
function J(e, t) {
  return {
    queryKey: [...E, e],
    queryFn: async () =>
      i(`list-mcp-server-status`, { hostId: e, cursor: null, limit: 100 }),
    staleTime: d.FIVE_MINUTES,
    enabled: t,
  };
}
function Y(e) {
  let t = (0, v.c)(14),
    { hostId: n, server: r, threadId: o, uri: s, enabled: c } = e,
    u = c === void 0 ? !0 : c,
    f = n ?? `local`,
    p = s ?? ``,
    m;
  t[0] !== f || t[1] !== r || t[2] !== p || t[3] !== o
    ? ((m = [...D, f, o, r, p]),
      (t[0] = f),
      (t[1] = r),
      (t[2] = p),
        ...
        i(`read-mcp-resource`, {
          ...
          throw (
            a.error(`Failed to read MCP resource`, {
              safe: { server: r, threadId: o, uri: s },
              sensitive: { error: e },
            }),
            e
          );
...
function ie({ layers: e, origins: t, keyPath: n, probeFields: r = [] }) {
...
function ae({ origins: e, rootKey: t, childKeys: n, probeFields: r }) {
  let i = {};
  return (
    n.forEach((n) => {
      let a = `${t}.${n}`;
...
//# sourceMappingURL=config-queries-2cSUtzNR.js.map
