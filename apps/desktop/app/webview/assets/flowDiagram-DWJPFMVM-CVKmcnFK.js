...
import { s as t } from "./invert.js";
import { t as n } from "./channel-Bg_9b54a.js";
...
import { h as g, s as _ } from "./chunk-5PVQY5BW-CnaqcI9r.js";
import "./chunk-U2HBQHQK-bhKagtxE.js";
import { t as te } from "./chunk-FMBD7UC4-Bz4YzVzS.js";
import "./chunk-BSJP7CBP-DflEcVJN.js";
import "./chunk-ZZ45TVLE-Cjc02p6x.js";
import { t as ne } from "./chunk-YZCP3GAM-BiBTM9Rn.js";
import { t as re } from "./chunk-55IACEB6-D64Uo90h.js";
import { t as v } from "./chunk-EDXVE4YY-Dvoshwbp.js";
import "./chunk-X2U36JSP-D4xhl7_D.js";
import { o as y } from "./chunk-5FUZZQ4R-B0fwRQaG.js";
import "./chunk-ENJZ2VHE-ByxrkXoV.js";
import { r as b, t as x } from "./chunk-336JU56O-CDWwHIND.js";
import { n as S, t as C } from "./chunk-XPW4576I-CL9gPToI.js";
var w = `flowchart-`,
  T = class {
    constructor() {
    ...
    sanitizeText(e) {
      return ee.sanitizeText(e, this.config);
    }
    ...
    addSingleLink(e, t, n, r) {
      ...
      if (
        (o !== void 0 &&
          ...
          (a.labelType = this.sanitizeNodeLabelType(o.type))),
        n !== void 0 &&
          ((a.type = n.type),
          (a.stroke = n.stroke),
          (a.length = n.length > 10 ? 10 : n.length)),
        r && !this.edges.some((e) => e.id === r))
      )
        ((a.id = r), (a.isUserDefinedId = !0));
      else {
        ...
        e.length === 0
          ...
          : (a.id = _(a.start, a.end, { counter: e.length + 1, prefix: `L` }));
      }
      if (this.edges.length < (this.config.maxEdges ?? 500))
        (i.info(`Pushing edge...`), this.edges.push(a));
      else
...
You have to call mermaid.initialize.`);
      ...
      e(t)
        ...
        .on(`mouseout`, (t) => {
          (n.transition().duration(500).style(`opacity`, 0),
            e(t.currentTarget).classed(`hover`, !1));
        });
    }
    clear(e = `gen-2`) {
      ((this.vertices = new Map()),
  ...
  E = {
    ...
    draw: r(async function (e, t, n, r) {
      (i.info(`REF0:`), i.info(`Drawing state diagram (v2)`, t));
      let { securityLevel: a, flowchart: o, layout: s } = p();
      (r.db.setDiagramId(t), i.debug(`Before getData: `));
      let c = r.db.getData();
      i.debug(`Data: `, c);
      let l = re(t, a),
        u = r.db.getDirection();
      ((c.type = r.type),
        (c.layoutAlgorithm = x(s)),
      ...
      (g.insertTitle(
        ...
        v(l, d, `flowchart`, o?.useMaxWidth || !1));
    }, `draw`),
  },
  D = (function () {
...
` +
    ...
    return (r(it, `Parser`), (it.prototype = rt), (rt.Parser = it), new it());
  })();
D.parser = D;
var O = D,
  ie = Object.assign({}, O);
...
export { k as diagram };
//# sourceMappingURL=flowDiagram-DWJPFMVM-CVKmcnFK.js.map
