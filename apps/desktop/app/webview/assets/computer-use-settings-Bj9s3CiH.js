...
import { Ca as n } from "./app-server-manager-signals-7MlBpIlX.js";
...
import { T as S } from "./mention-item-qEZjEnZz.js";
...
import { t as T } from "./use-platform-DMNwb8i8.js";
import "./experimental-features-queries-Css_qmsY.js";
import { a as E, i as D } from "./use-is-plugins-enabled-M47TXC7m.js";
...
import { r as U, t as W } from "./dropdown-CLcC-0sa.js";
...
import { t as ee } from "./toggle-BXF5Uzow.js";
import {
  a as te,
  i as ne,
  o as re,
...
import { i as oe, t as se } from "./settings-shared-buyehiMO.js";
import "./settings-host-selection-B8-0dN0N.js";
import { t as ce } from "./settings-host-context-BX1MON7_.js";
import "./more-menu-trigger-D1fusVZY.js";
import {
  i as le,
  l as ue,
} from "./browser-use-origin-state-queries-PjqMaF9f.js";
import { t as de } from "./settings-content-layout-B4F7ZmxE.js";
import { n as q } from "./settings-row-D-T3_hWW.js";
import { t as fe } from "./settings-surface-BVAbQNXw.js";
import { t as J } from "./settings-group-BXAVZ8Oc.js";
import "./plugin-detail-route-utils-Bsq2ujzP.js";
import "./plugins-availability-DST87EXk.js";
import { t as pe } from "./use-home-directory-B3jyQBeT.js";
...
import {
  ...
  r as Y,
  s as X,
} from "./browser-use-settings-C_iIpbpC.js";
var ve = e(r(), 1),
  Z = g(),
  Q = i();
function ye(e) {
...
function Ae() {
  let e = (0, Z.c)(23),
    { selectedHostId: t } = ce(),
    n;
  e[0] === t ? (n = e[1]) : ((n = { hostId: t }), (e[0] = t), (e[1] = n));
  let r = N(n),
    i;
  (e[2] === t ? (i = e[3]) : ((i = { hostId: t }), (e[2] = t), (e[3] = i)),
    j(i));
  let a;
  e[4] === t ? (a = e[5]) : ((a = { hostId: t }), (e[4] = t), (e[5] = a));
  let o = E(a);
  if (v(Oe) != null) {
    let t;
    return (
  ...
  e[10] === o
    ? (d = e[11])
    : ((d = (0, Q.jsx)(je, { computerUseAvailability: o })),
      (e[10] = o),
      (e[11] = d));
  let f;
  e[12] !== r || e[13] !== o.available
    ? ((f = o.available && r ? (0, Q.jsx)(ze, {}) : null),
      (e[12] = r),
      (e[13] = o.available),
      (e[14] = f))
    : (f = e[14]);
  ...
  e[15] !== d || e[16] !== f
    ? ((p = (0, Q.jsxs)(J, {
        children: [u, (0, Q.jsxs)(J.Content, { children: [d, f] })],
      })),
      (e[15] = d),
      (e[16] = f),
      (e[17] = p))
  ...
  return (
    e[20] !== p || e[21] !== m
      ? ((h = (0, Q.jsxs)(de, { title: c, subtitle: l, children: [p, m] })),
        (e[20] = p),
        (e[21] = m),
        (e[22] = h))
      : (h = e[22]),
...
function je(e) {
  ...
  if (
    ...
    w = [];
    let e;
    (t[26] !== r.reason || t[27] !== m || t[28] !== o
      ? ((e =
          m == null && o && r.reason === `config-requirement-disabled`
            ? [
                {
    ...
    if (g != null) {
      ...
      t[39] === x
        ? (n = t[40])
        : ((n = (0, Q.jsx)(xe, { status: x })), (t[39] = x), (t[40] = n));
      let r;
      t[41] !== v || t[42] !== i
        ? ((r = v
            ? (0, Q.jsx)(C, {
  ...
  let j;
  t[50] !== T || t[51] !== E
    ? ((j = [...E, ...T]), (t[50] = T), (t[51] = E), (t[52] = j))
    : (j = t[52]);
  let M;
  return (
    t[53] !== w || t[54] !== d || t[55] !== a || t[56] !== j
      ? ((M = (0, Q.jsx)(he, {
          emptyStateTitle: O,
...
//# sourceMappingURL=computer-use-settings-Bj9s3CiH.js.map
