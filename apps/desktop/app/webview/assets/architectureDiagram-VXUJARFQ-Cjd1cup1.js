...
import { r as n, s as r } from "./chunk-S3R3BYOJ-5zDRn6nL.js";
...
import { t as y } from "./chunk-EXTU4WIE-CgAipfme.js";
import "./dist-Dkaf81wL.js";
import { i as b, n as x, o as S, r as C } from "./chunk-JA3XYJ7Z-_sm1v70d.js";
import "./marked.esm-B1dI5d9h.js";
import { t as w } from "./chunk-4BX2VUAB-DP9TzDB2.js";
import { t as T } from "./mermaid-parser.core-DlxdytOs.js";
import { t as E } from "./cytoscape.esm-BBWSnmeT.js";
var D = t((e, t) => {
    (function (n, r) {
  ...
  j = {
    L: a((e) => `${e},${e / 2} 0,${e} 0,0`, `L`),
    R: a((e) => `0,${e / 2} ${e},0 ${e},${e}`, `R`),
    T: a((e) => `0,0 ${e},0 ${e / 2},${e}`, `T`),
    B: a((e) => `${e / 2},0 ${e},${e} 0,${e}`, `B`),
  },
  M = {
    L: a((e, t) => e - t + 2, `L`),
    R: a((e, t) => e - 2, `R`),
  ...
  re = a((e) => e.data(), `edgeData`),
  U = a((e) => e.data(), `nodeData`),
  W = h.architecture,
  G = class {
    constructor() {
      ((this.nodes = {}),
      ...
      t.edges().map(async (t) => {
        ...
        if (
          ...
          if (
            (t
              .insert(`path`)
              .attr(`d`, `M ${v},${y} L ${b},${S} L${C},${w} `)
              .attr(`class`, `edge`)
              .attr(`id`, r(a, f, { prefix: `L` })),
            u)
          ) {
            let e = F(l) ? M[l](v, s) : v - c,
              n = I(l) ? M[l](y, s) : y - c;
            t.insert(`polygon`)
              .attr(`points`, j[l](s))
...
function fe(e, t, n) {
  ...
  return { horizontal: i, vertical: o };
}
a(fe, `getAlignments`);
function pe(e, t) {
  let n = [],
    r = a((e) => `${e[0]},${e[1]}`, `posToStr`),
    i = a((e) => e.split(`,`).map((e) => parseInt(e)), `strToPos`);
  return (
    e.forEach((e) => {
...
a(pe, `getRelativeConstraints`);
function me(e, t, n, r, s, { spatialMaps: c, groupAlignments: l }) {
  return new Promise((u) => {
    ...
    (d.remove(), ue(n, f), se(e, f, s), ce(t, f, s), de(r, f));
    let p = fe(s, c, l),
      m = pe(c, s),
      h = f.layout({
        name: `fcose`,
    ...
    (h.one(`layoutstop`, () => {
      ...
      (a(e, `getSegmentWeights`), f.startBatch());
...
//# sourceMappingURL=architectureDiagram-VXUJARFQ-Cjd1cup1.js.map
