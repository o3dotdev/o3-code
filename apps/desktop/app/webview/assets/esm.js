var e = Object.freeze({ left: 0, top: 0, width: 16, height: 16 }),
...
function v(e, t, n) {
  let r = g(e);
  return _(r.defs, t + r.content + n);
}
var y = (e) => e === `unset` || e === `undefined` || e === `none`;
function b(e, t) {
  let r = { ...n, ...e },
    i = { ...a, ...t },
  ...
  [r, i].forEach((e) => {
    ...
    switch ((i < 0 && (i -= Math.floor(i / 4) * 4), (i %= 4), i)) {
      case 1:
        ((a = o.height / 2 + o.top),
          t.unshift(`rotate(90 ` + a.toString() + ` ` + a.toString() + `)`));
        break;
      case 2:
        t.unshift(
          `rotate(180 ` +
    ...
    (i % 2 == 1 &&
      (o.left !== o.top && ((a = o.left), (o.left = o.top), (o.top = a)),
      o.width !== o.height &&
        ((a = o.width), (o.width = o.height), (o.height = a))),
      t.length && (s = v(s, `<g transform="` + t.join(` `) + `">`, `</g>`)));
  });
  let c = i.width,
    l = i.height,
    u = o.width,
    ...
    p;
  c === null
    ? ((p = l === null ? `1em` : l === `auto` ? d : l), (f = h(p, u / d)))
    : ((f = c === `auto` ? u : c),
      (p = l === null ? h(f, d / u) : l === `auto` ? d : l));
  let m = {},
    g = (e, t) => {
      y(t) || (m[e] = t.toString());
    };
  (g(`width`, f), g(`height`, p));
  let _ = [o.left, o.top, u, d];
  return ((m.viewBox = _.join(` `)), { attributes: m, viewBox: _, body: s });
}
var x = /\sid="(\S+)"/g,
  S =
    `IconifyId` +
...
function w(e, t = S) {
  let n = [],
    r;
  for (; (r = x.exec(e)); ) n.push(r[1]);
  if (!n.length) return e;
  let i = `suffix` + ((Math.random() * 16777216) | Date.now()).toString(16);
  return (
    n.forEach((n) => {
      let r = typeof t == `function` ? t(n) : t + (C++).toString(),
        a = n.replace(/[.*+?^${}()|[\]\\]/g, `\\$&`);
      e = e.replace(
        RegExp(`([#;"])(` + a + `)([")]|\\.[a-z])`, `g`),
        `$1` + r + i + `$3`,
...
export { f as a, b as i, T as n, o, w as r, E as t };
