...
import { t as ae } from "./invalidate-queries-and-broadcast-CcloHaCj.js";
import { u as oe } from "./thread-context-inputs-DcllWVDq.js";
import { t as se } from "./use-codex-home-xcun36ZB.js";
import {
  a as ce,
  i as le,
  n as ue,
...
import { t as fe } from "./get-build-flavor-DDOtCsji.js";
var _ = [
  `<svg
...
function v(e) {
  ...
  for (let n = 0; n < e.length; n += 1)
    t = (t * 31 + e.charCodeAt(n)) % _.length;
  return _[t] ?? ``;
}
var y = e(r(), 1),
  b = {
  ...
  try {
    let e = { path: r, hostId: t },
      i = await n.fetchQuery({
        queryFn: ({ signal: t }) =>
          re(`read-file-binary`, { params: e, signal: t }),
        queryKey: ie(`read-file-binary`, e),
        retry: !1,
        gcTime: 1 / 0,
        staleTime: h.INFINITE,
      });
    return i.contentsBase64 ? `data:${C(r)};base64,${i.contentsBase64}` : null;
  } catch (e) {
    return (
...
function S(e) {
  ...
  if (
    ...
    r.startsWith(`https:`) ||
    r.startsWith(`file:`) ||
    r.startsWith(`vscode-resource:`) ||
    r.startsWith(`vscode-webview:`) ||
    r.startsWith(`vscode-file:`)
  )
    return null;
  let i = t(n);
  return o(i) ? i : null;
...
function C(e) {
  return b[y.default.extname(e).toLowerCase()] ?? `application/octet-stream`;
}
var pe = g(),
  w = [`plugins`],
  T = 4,
  ...
  O = [],
  k = `computer-use`,
  A = `.tmp/marketplaces/openai-internal-testing`,
  j = new Set(
    [`codex-official`, ...s, `openai-curated`, `openai-primary-runtime`].map(q),
  );
function M(e) {
  return {
    ...Z(e.summary),
...
function N({ marketplacePath: e, remoteMarketplaceName: t }) {
  if (e != null && t != null)
...
function F(e) {
  return e.marketplacePath == null ? L(e.plugin) : e.plugin.name;
}
function I(e) {
  return e.marketplacePath == null ? L(e.plugin) : e.plugin.id;
}
function L(e) {
...
function R(e) {
  return { ...N(e), pluginName: F(e) };
}
function z({ marketplaceName: e, marketplacePath: t }) {
  return t == null
...
function B(e, t, n) {
  ...
  let a = de(i) && (n?.enabled ?? !0),
    o = n?.additionalMarketplaceKinds ?? D,
  ...
  let v = _,
    ...
    x;
  r[5] !== e || r[6] !== y || r[7] !== b
    ? ((x = { enabled: b, hostId: e, isHostLocal: y }),
      (r[5] = e),
      (r[6] = y),
      (r[7] = b),
      (r[8] = x))
  ...
  let S = ce(x),
    C;
  r[9] === e ? (C = r[10]) : ((C = { hostId: e }), (r[9] = e), (r[10] = C));
  let T = ue(C),
    k;
  r[11] !== e || r[12] !== y
    ? ((k = { hostId: e, isHostLocal: y }),
      (r[11] = e),
      (r[12] = y),
      (r[13] = k))
    : (k = r[13]);
  let A = le(k),
    ...
    N = a && v && (t !== void 0 || m.isFetched),
    P;
  r[14] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((P = fe()), (r[14] = P))
    : (P = r[14]);
  let F = P,
    I = s == null ? be(e, M, c) : ve(e, M, D, s),
    L;
  r[15] !== F ||
  r[16] !== e ||
  r[17] !== s ||
    ...
    ? ((L = async () => {
        let t =
            s == null
              ...
              : await p(`send-cli-request-for-host`, {
                  hostId: e,
          ...
          n = ke(t.marketplaces),
          r = F == null ? n : Te({ buildFlavor: F, plugins: n });
        return {
          featuredPluginIds:
            s == null
              ? F == null
                ? t.featuredPluginIds
                : we({ buildFlavor: F, featuredPluginIds: t.featuredPluginIds })
              : E,
          marketplaceLoadErrors: t.marketplaceLoadErrors,
          marketplaces: Ee(t.marketplaces),
          plugins: await De({ hostId: e, plugins: r, queryClient: f }),
        };
      }),
      (r[15] = F),
      (r[16] = e),
  ...
  if (!a || !v) {
    let e;
    return (
      r[29] === Symbol.for(`react.memo_cache_sentinel`)
        ? ((e = {
            availablePlugins: O,
            featuredPluginIds: E,
            installedPlugins: O,
            marketplaceLoadErrors: me,
            marketplaces: he,
            errorMessage: null,
            isLoading: !1,
            isFetching: !1,
  ...
  r[31] !== A.available ||
  r[32] !== T.available ||
  r[33] !== z.data?.featuredPluginIds ||
  r[34] !== z.data?.plugins
    ? ((H = {
        isComputerUseAvailable: S.available,
        isExternalBrowserUseAvailable: A.available,
        isInAppBrowserUseAvailable: T.available,
      }),
      (U = z.data?.plugins ?? O),
      (W = Se({ plugins: U, ...H })),
      (G = xe({ featuredPluginIds: z.data?.featuredPluginIds ?? E, ...H })),
      (r[30] = S.available),
      (r[31] = A.available),
      (r[32] = T.available),
      (r[33] = z.data?.featuredPluginIds),
      ...
      (r[37] = W),
      (r[38] = G))
    : ((H = r[35]), (U = r[36]), (W = r[37]), (G = r[38]));
  let K;
  r[39] === U ? (K = r[40]) : ((K = Ce(U)), (r[39] = U), (r[40] = K));
  let q = z.data?.marketplaceLoadErrors ?? me,
    J = z.data?.marketplaces ?? he,
    Y = z.error ? String(z.error.message) : null,
    X =
      (j && m.isLoading) ||
      z.isLoading ||
      T.isLoading ||
      A.isLoading ||
      S.isLoading,
    Z = (j && m.isFetching) || z.isFetching || S.isFetching,
    Q;
  r[41] !== H || r[42] !== z
    ? ((Q = async () => {
        let e = (await z.refetch()).data?.plugins ?? O;
        return {
          availablePlugins: Se({ plugins: e, ...H }),
          installedPlugins: Ce(e),
        };
      }),
      (r[41] = H),
      (r[42] = z),
...
async function ge() {}
async function _e() {
  return { availablePlugins: O, installedPlugins: O };
}
function V(e) {
  let t = (0, pe.c)(10),
  ...
  let s = de(o),
    ...
    l;
  t[2] !== r || t[3] !== i
    ? ((c = [...w, `marketplace-kind`, r, i]),
      (l = async () =>
        ke(
          (await p(`list-plugins`, { hostId: r, marketplaceKinds: [i] }))
            .marketplaces,
        )),
      (t[2] = r),
      (t[3] = i),
...
function ve(e, t, n = D, r = null) {
  return r == null
    ? be(e, t, ye({ additionalMarketplaceKinds: n, includeRemoteCatalog: !0 }))
    : [...w, e, t, `installed`, r];
}
function ye({ additionalMarketplaceKinds: e, includeRemoteCatalog: t }) {
  return t && e.length === 0 ? null : [`local`, ...e];
}
function be(e, t, n) {
  return n == null ? [...w, e, t] : [...w, e, t, `marketplace-kinds`, n];
}
function xe({ featuredPluginIds: e, ...t }) {
  return e.filter((e) => H(e, t));
}
function Se({ plugins: e, ...t }) {
  return e.filter((e) => H(e.plugin.id, t));
}
function Ce(e) {
...
function we({ buildFlavor: e, featuredPluginIds: t }) {
  let n = c(e);
  return t.filter((e) => {
    let t = l(e);
    return t == null ? !0 : !i(t) || t === n;
  });
}
function Te({ buildFlavor: e, plugins: t }) {
  let n = c(e);
  return t.filter((e) => !i(e.marketplaceName) || e.marketplaceName === n);
}
function q(e) {
  return e
    .trim()
...
async function De({ hostId: e, plugins: t, queryClient: n }) {
  let r = [...t];
  async function i(a) {
    let o = t[a];
    if (o == null) return;
    let [s, c] = await Promise.all([
      x(o.composerIconPath, e, n),
      x(o.logoPath, e, n),
    ]);
    ((s != null || c != null) &&
      (r[a] = {
  ...
  return (
    await Promise.all(
      Array.from({ length: Math.min(T, t.length) }, (e, t) => i(t)),
    ),
    r
  );
}
function Oe({
  ...
  let i = t === `local` && e != null ? f(e, A) : null;
  return Y(
    [
...
function Y(e, t) {
  return Array.from(
    new Set(e.map((e) => e.trim()).filter((e) => o(e) && X(e, t))),
  );
}
function X(e, t) {
  return t == null
    ...
    for (let e of n.plugins)
      t.has(e.id) ||
        t.set(e.id, {
          ...
          plugin: e,
          keywords: e.keywords,
          ...z({ marketplaceName: n.name, marketplacePath: n.path }),
        });
  return Array.from(t.values());
}
function Z(e) {
  let t = e.interface?.composerIcon ?? e.interface?.composerIconUrl ?? null,
    n = e.interface?.logo ?? e.interface?.logoUrl ?? null;
  if (t != null || n != null) return { composerIconPath: t, logoPath: n };
  let r = v(e.id);
  return { composerIconPath: r, logoPath: r };
}
export {
  x as _,
  N as a,
...
//# sourceMappingURL=use-plugins-CPl3j-8i.js.map
