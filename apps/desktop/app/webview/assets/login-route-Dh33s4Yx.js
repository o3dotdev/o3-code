...
import { $t as t } from "./src-DAzAmbVS.js";
import {
  Ct as n,
  Ta as r,
  as as i,
...
import { f as y } from "./chunk-LFPYN7LY-CkfOxD5s.js";
import { t as b } from "./product-logger-CdHJrfqL.js";
import {
  c as x,
  i as S,
  n as C,
...
import { t as D } from "./use-global-state-DjfvqpEA.js";
...
import { c as O, t as k } from "./use-auth-BI4R_D9h.js";
...
import { r as A } from "./toast-signal-Dfdpi-kK.js";
import "./route-scope-BpEoGCxV.js";
import { t as j } from "./button-bq66r8jD.js";
import "./reduced-motion-preference-CcGC6Z5k.js";
import { r as M, t as N } from "./spinner-D37df5tU.js";
import "./use-os-info-DRsIehae.js";
import { t as P } from "./link-external-GLfZmEQP.js";
...
import { t as L } from "./check-md-I6RRy8DL.js";
import "./clock-BdccdK2N.js";
import "./search-CEAmgNrg.js";
import "./globe-D1xFoTfu.js";
import { t as re } from "./copy-to-clipboard-DUkEoARe.js";
import "./image-square-DaLHX1Fp.js";
import "./codex-1JQAUibh.js";
import { t as R } from "./openai-blossom-BF9MooFr.js";
import { t as z } from "./copy-BLEBbe48.js";
import "./minus-D-AnULF0.js";
import "./checkbox-Cf9nEamc.js";
import "./workspace-onboarding-experiment-DxK7IKzt.js";
import { i as ie } from "./workspace-onboarding-controller-D-vB2M4j.js";
import { t as B } from "./codex-app-ga-logo-DAVK7PE_.js";
import { a as ae } from "./onboarding-shell-CIBzTqTF.js";
import { t as oe } from "./animated-icon-UwPnontz.js";
import "./tasks-8U8vryZ4.js";
import "./chatgpt-token-auth.browser-DtPTjYU7.js";
import {
  n as V,
  r as se,
  t as ce,
} from "./onboarding-login-content-Bf2QVA6e.js";
import { n as H, t as le } from "./use-ascii-engine-DK5OzERG.js";
var U = _(),
  W = e(s(), 1),
  G = c();
function K() {
  ...
  ((0, W.useEffect)(() => {
    _ && (P.current?.focus(), P.current?.select());
  }, [_]),
    (0, W.useEffect)(() => {
      let e = !1;
      return (
  ...
  let ee = async () => {
      if (p) {
        (c?.abortController.abort(), u(null));
        return;
      }
      let e = new AbortController();
      u({ abortController: e, kind: `browserRedirect` });
      try {
        let { authUrl: n, completion: r } = await se({ signal: e.signal });
        n && v.dispatchMessage(`open-in-browser`, { url: n });
        let o = await r;
        o.success
          ? (i.setAuthMethod(`chatgpt`), a(`/first-run`))
    ...
    te = async () => {
      ...
      let e = new AbortController();
      (S(!0), u({ abortController: e, kind: `deviceCode` }));
      try {
        let {
          verificationUrl: n,
          userCode: r,
          completion: o,
        } = await V({ signal: e.signal });
        ...
        (u((t) =>
          ...
          v.dispatchMessage(`open-in-browser`, { url: n }));
        let s = await o;
        s.success
          ? (i.setAuthMethod(`chatgpt`), a(`/first-run`))
    ...
    { data: L } = D(`show-copilot-login-first`),
    R = async () => {
      (await n(e, `use-copilot-auth-if-available`, !0),
        i.setAuthMethod(`copilot`),
        a(`/first-run`));
    },
    z = async () => {
      let e = E.trim();
      if (!(!e || M)) {
        N(!0);
        try {
          (await o(`login-with-api-key`, { hostId: r, apiKey: e }),
            i.setAuthMethod(`apikey`),
            a(`/first-run`));
        } catch (e) {
          I(t(e));
        } finally {
    ...
    ie =
      !g || !L
        ...
        : (0, G.jsxs)(G.Fragment, {
            children: [
              !p && (0, G.jsx)(J, { isPrimary: !0, handleCopilotSignIn: R }),
              (0, G.jsx)(`div`, {
                className: `pt-2`,
                children: (0, G.jsx)(q, {
                  isPrimary: !1,
              ...
              children: [
                      ...
                      children: [
                        ...
                        !p &&
                          ...
                          (0, G.jsx)(X, {
                            ...
                            children: (0, G.jsx)(Y, {
                              handleChatGptDeviceCodeSignIn: te,
                            }),
                          }),
                      ],
                    }),
                ...
                B != null &&
                  (0, G.jsx)(ge, {
                    ...
                    userCode: B.userCode ?? ``,
                    onOpenBrowser: () => {
                      let e = B.verificationUrl;
                      e && v.dispatchMessage(`open-in-browser`, { url: e });
                    },
                    onCopyCode: ne,
                    onCancel: () => {
                      (B.abortController.abort(), u(null));
                    },
                  }),
                !p &&
                  _ &&
...
var ue = W.memo(function () {
  ...
  e[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((t = {
      ...
      (e[0] = t))
    : (t = e[0]);
  let { columns: n, rows: r, lines: i } = le(t),
    a;
  return (
    e[1] !== n || e[2] !== i || e[3] !== r
      ? ((a = (0, G.jsx)(H, { lines: i, columns: n, rows: r, autoCover: !0 })),
        (e[1] = n),
        (e[2] = i),
        (e[3] = r),
        (e[4] = a))
...
function q(e) {
  ...
  return (
    t[2] !== r || t[3] !== n || t[4] !== a
      ? ((o = (0, G.jsx)(Q, { isPrimary: n, onClick: r, children: a })),
        (t[2] = r),
        (t[3] = n),
        (t[4] = a),
        (t[5] = o))
...
function J(e) {
  ...
  return (
    t[1] !== r || t[2] !== n
      ? ((a = (0, G.jsx)(Q, { isPrimary: n, onClick: r, children: i })),
        (t[1] = r),
        (t[2] = n),
        (t[3] = a))
      : (a = t[3]),
...
function Y(e) {
  ...
  return (
    t[1] === n
      ? (i = t[2])
      : ((i = (0, G.jsx)(Q, { isPrimary: !1, onClick: n, children: r })),
        (t[1] = n),
        (t[2] = i)),
    i
  );
...
function X(e) {
  ...
  return (
    t[14] !== d || t[15] !== p
      ? ((m = (0, G.jsxs)(`div`, { className: `pt-2`, children: [d, p] })),
        (t[14] = d),
        (t[15] = p),
        (t[16] = m))
      : (m = t[16]),
...
var Z = `w-full cursor-interaction justify-center !rounded-full border px-4 py-2 font-medium`,
  de = `bg-token-foreground/10 w-full justify-center !rounded-full px-4 py-2 font-medium backdrop-blur-md`;
function Q(e) {
  let t = (0, U.c)(5),
...
function pe(e) {
  ...
  t[11] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((_ = (0, G.jsxs)(`button`, {
        ...
        children: [
          ...
          (0, G.jsx)(P, { "aria-hidden": `true`, className: `icon-2xs` }),
        ],
      })),
      (t[11] = _))
    : (_ = t[11]);
  ...
  t[16] === v
    ? (b = t[17])
    : ((b = (0, G.jsx)(j, { color: `ghost`, onClick: v, children: y })),
      (t[16] = v),
      (t[17] = b));
  let x;
  t[18] !== n || t[19] !== a
...
function me() {
  v.dispatchMessage(`open-in-browser`, {
...
function ge(e) {
  ...
  t[11] === u
    ? (b = t[12])
    : ((b = u
        ? (0, G.jsx)(L, { className: `icon-sm text-token-foreground` })
        : (0, G.jsx)(z, { className: `icon-sm` })),
      (t[11] = u),
      (t[12] = b));
  let x;
  ...
  t[26] === o
    ? (E = t[27])
    : ((E = (0, G.jsx)(j, { color: `ghost`, onClick: o, children: T })),
      (t[26] = o),
      (t[27] = E));
  let D = n.length === 0,
    O;
  ...
  let k;
  t[29] !== i || t[30] !== D
    ? ((k = (0, G.jsx)(j, { onClick: i, disabled: D, children: O })),
      (t[29] = i),
      (t[30] = D),
      (t[31] = k))
    : (k = t[31]);
...
var $ = 12,
  ...
  be = { up: `down`, down: `up`, left: `right`, right: `left` };
function xe(e) {
  let t = (0, U.c)(21),
  ...
  let m = (0, W.useRef)(p),
    h = (0, W.useRef)(null),
    g = (0, W.useEffectEvent)(n),
    _;
  t[3] === r
    ? (_ = t[4])
    : ((_ = (e, t, n) => {
        if (r.current == null) return;
        r.current.state === `suspended` && r.current.resume();
        let i = t / 1e3,
          a = r.current.createOscillator(),
          o = r.current.createGain();
        ((a.type = n),
          (a.frequency.value = e),
          o.gain.setValueAtTime(1e-4, r.current.currentTime),
          o.gain.exponentialRampToValueAtTime(
            0.18,
            r.current.currentTime + 0.01,
          ),
          o.gain.exponentialRampToValueAtTime(1e-4, r.current.currentTime + i),
          a.connect(o),
          o.connect(r.current.destination),
          a.start(),
          a.stop(r.current.currentTime + i),
          (a.onended = () => {
  ...
  t[12] === A
    ...
    : ((j = () => {
        ...
        let e = a.current.getBoundingClientRect(),
          ...
          r = Math.max($, Math.floor(t / _e)),
          i = t / r;
        ((m.current = {
          columns: r,
          rows: Math.max($, Math.floor(n / i)),
          cellSize: i,
          width: t,
          height: n,
        }),
            ...
            : e.key === `ArrowDown` || e.key === `s` || e.key === `S`
              ...
              : e.key === `ArrowLeft` || e.key === `a` || e.key === `A`
                ...
                : (e.key === `ArrowRight` || e.key === `d` || e.key === `D`) &&
                  (t = `right`),
            t != null &&
              (e.preventDefault(), be[d.current] !== t && (f.current = t)));
        };
        return (
...
var Se = E(),
  Ce = `https://chatgpt.com/codex/desktop-auth`,
  we = `codex_streamlined_login`,
  Te = `client-sYWqzCYMRkUg4DqqiZcR5DGTNl2iD7zNJY0HoeDLzxR`,
  Ee = `codex_origin_stable_id`;
function De({
  authUrl: e,
  codexOriginStableId: t = Se.StableID.get(Te),
  ...
  try {
    let a = new URL(e);
    if (
      (n && t && a.searchParams.set(Ee, t),
      a.pathname === `/codex/desktop-auth`)
    )
      return (i && a.searchParams.set(we, `true`), a.toString());
    if ((i && a.searchParams.set(we, `true`), !r)) return a.toString();
    let o = new URL(Ce);
    return (
      o.searchParams.set(`authorize_url`, a.toString()),
      i && o.searchParams.set(we, `true`),
      o.toString()
    );
  } catch {
    return e;
...
var Ne = (e) =>
    (0, G.jsxs)(`svg`, {
      ...
      children: [
        ...
        (0, G.jsx)(`path`, { d: `M1 1h22v22H1z`, fill: `none` }),
      ],
    }),
  Pe = (e) =>
    (0, G.jsxs)(`svg`, {
    ...
    ? ((O = r
        ? (0, G.jsx)(`div`, {
            ...
            children: (0, G.jsx)(ce, {
              ...
              onChatGptSignIn: u,
              onShowApiKeyEntry: h,
              apiKeySecondaryActionLabel: (0, G.jsx)(l, {
...
function Ie() {
  let e = m(d),
    ...
    O = a(F),
    j = i(ee),
    P = w == null ? null : { has_previously_completed_onboarding: w },
    L = ie(j?.arm ?? `control`),
    re = x(),
    R = je(T(ke).get(`enabled`, !1)),
    z = (t) => {
      e.get(A).warning(
        h.formatMessage(
          {
    ...
    ge = async (n = `signin`) => {
      ...
      V(i);
      try {
        let { useDesktopAuth: a, useStreamlinedLoginUx: o } = Ae(S(re, Oe)),
          l = C(re, `3963726525`),
          { authUrl: u, completion: d } = await se({
            signal: i.signal,
        ...
        if (u) {
          let e = De({
            ...
            useDesktopAuth: a,
            useStreamlinedLoginUx: o,
          });
          v.dispatchMessage(`open-in-browser`, {
            url: e,
            ...(a ? { useExternalBrowser: !0 } : {}),
          });
        }
        let f = await d;
        f.success
          ? (b(e, {
            ...
            _.removeQueries({ queryKey: g(`account-info`), exact: !0 }),
            de(),
            E(!0),
          ...
          : (b(e, {
              ...
              metadata: { method: r, error_kind: Le(f.error), ...P },
            }),
            z(t(f.error ?? `Unknown error`)));
      } catch (n) {
        if (n instanceof Error && n.name === `AbortError`) {
          b(e, {
            eventName: `codex_login_failure`,
            metadata: { method: r, error_kind: `abort`, ...P },
          });
          return;
        }
        (b(e, {
          eventName: `codex_login_failure`,
          metadata: { method: r, error_kind: Le(n), ...P },
        }),
          z(t(n)));
      } finally {
        V(null);
    ...
    $ = async () => {
      ...
      if (!(!n || Y || P == null)) {
        X(!0);
        try {
          (await o(`login-with-api-key`, { hostId: r, apiKey: n }),
            b(e, {
              eventName: `codex_login_success`,
              metadata: { method: `apikey`, ...P },
            }),
          ...
          (b(e, {
            eventName: `codex_login_failure`,
            metadata: { method: `apikey`, error_kind: Le(n), ...P },
          }),
            z(t(n)));
        } finally {
          X(!1);
  ...
  return P == null
    ? (0, G.jsx)(ae, {
        children: (0, G.jsxs)(`div`, {
          ...
          children: [
            (0, G.jsx)(N, { className: `h-4 w-4 text-token-foreground` }),
            (0, G.jsx)(l, {
      ...
      ? (0, G.jsx)(ae, {
          ...
          children: K
            ? (0, G.jsx)(`div`, {
                ...
                children: (0, G.jsx)(xe, { onExit: pe, audioContextRef: Z }),
              })
            : (0, G.jsx)(Fe, {
                apiKeyValue: q,
                isApiKeyEntryVisible: le,
                isApiKeySignInPending: Y,
                isChatGptSignInPending: H,
                showChatGptProviderSignIn: R,
                onApiKeySubmit: $,
                onApiKeyValueChange: J,
                onChatGptSignIn: ge,
                onChatGptSignUp: () => ge(`signup`),
                onPlaySnake: he,
                onResetApiKeyEntry: Q,
                onShowApiKeyEntry: fe,
              }),
        })
      : (0, G.jsx)(ae, {
          fullBleed: K,
          ...
          children: K
            ...
            : (0, G.jsxs)(`div`, {
                className: `mt-32 flex h-full w-full max-w-[320px] flex-col items-center`,
                children: [
                  (0, G.jsx)(`button`, {
                  ...
                  (0, G.jsx)(`span`, {
                    className: `mt-4 text-center text-heading-lg font-medium text-token-foreground`,
                    children: (0, G.jsx)(l, {
                  ...
                  (0, G.jsx)(`span`, {
                    className: `mt-1 text-center text-lg text-token-description-foreground`,
                    children: (0, G.jsx)(l, {
...
export { Re as LoginRoute };
//# sourceMappingURL=login-route-Dh33s4Yx.js.map
