...
import { Q as s, S as c, Z as l } from "./setting-storage-EK1Te68s.js";
function u(e) {
  if (typeof window > `u`) return e === r;
  let t =
    window.electronBridge?.getSharedObjectSnapshotValue?.(`host_config`) ??
    null;
  return t == null ? e === r : t.id === e && t.kind === `local`;
}
function d({
  hasConversation: e,
  hostId: t,
...
var f = s(c, (e) => l(c, ({ get: n }) => n(n(t, e))?.type ?? null)),
  p = s(c, (t) =>
    l(c, ({ get: r }) =>
      d({
        hasConversation: r(r(e, t)),
        hostId: r(r(n, t)),
        latestTurnId: r(r(i, t)),
        latestTurnStatus: r(r(a, t)),
        pendingRequestType: r(r(f, t)),
        resumeState: r(r(o, t)),
      }),
    ),
  );
export { u as n, p as t };
//# sourceMappingURL=heartbeat-automation-eligibility-hSIxfARy.js.map
