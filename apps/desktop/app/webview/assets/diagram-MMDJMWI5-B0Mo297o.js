...
import { r as m } from "./chunk-5PVQY5BW-CnaqcI9r.js";
import { t as h } from "./chunk-4BX2VUAB-Bu0VDGOe.js";
import { t as g } from "./mermaid-parser.core-CwYzIrth.js";
var _ = { showLegend: !0, ticks: 5, max: null, min: 0, graticule: `circle` },
  v = { axes: [], curves: [], options: _ },
  y = structuredClone(v),
  b = u.radar,
  x = e(() => m({ ...b, ...f().radar }), `getConfig`),
  S = e(() => y.axes, `getAxes`),
  C = e(() => y.curves, `getCurves`),
...
var z = { draw: j },
  ...
  V = e((e) => {
    let t = m(i(), f().themeVariables);
    return { themeVariables: t, radarOptions: m(t.radar, e) };
