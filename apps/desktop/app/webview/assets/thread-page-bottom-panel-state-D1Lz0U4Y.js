...
import { x as n } from "./src-DAzAmbVS.js";
import { qi as r } from "./app-server-manager-signals-Csopz8aM.js";
...
import { t as f } from "./route-scope-BpEoGCxV.js";
import { t as p } from "./button-bq66r8jD.js";
import { n as m, o as h, r as g } from "./app-shell-state-HP0T5lEX.js";
import { t as _ } from "./use-platform-ByMJlQVq.js";
import { n as v, r as y } from "./chrome-theme-C3NmvE0H.js";
import { n as b, t as x } from "./app-shell-tab-controller-B2eCi4Le.js";
import { t as S } from "./local-conversation-title-signals-DH-tj19_.js";
import { i as C, n as w } from "./thread-context-DyfT5Vx-.js";
import { n as T, t as E } from "./focus-composer-C5T4PQQ-.js";
import { t as D } from "./terminal-CNbIwMET.js";
import { t as O } from "./app-intl-signal-jHPWCZy6.js";
import { t as k } from "./terminal-service-BsiZiRKt.js";
import { t as A } from "./error-boundary-CVsORXBJ.js";
import { n as j } from "./check-git-index-for-changes-Cr4dfcAI.js";
import { t as M } from "./font-settings-D-vhQ1CB.js";
import { n as N, r as P } from "./use-resolved-theme-variant-G14Wtv28.js";
import { n as F, r as I, t as L } from "./thread-panel-state-_aKlkyVE.js";
...
function X({
  ...
  if (n != null && ae(t, [`t`])) return (Z(t), n(), !1);
  if (e != null) {
    if (ee(t, a.hasSelection())) {
      Z(t);
  ...
  let o = ne(t);
  return o == null ? !0 : (Z(t), i(o), !1);
}
function Z(e) {
  (e.preventDefault(), e.stopPropagation());
}
function ee(e, t) {
  return (t && re(e, `c`)) || Q(e, `c`) || ie(e, { ctrlKey: !0, shiftKey: !1 });
}
function te(e, t) {
  return (t && re(e, `v`)) || Q(e, `v`) || ie(e, { ctrlKey: !1, shiftKey: !0 });
}
function ne(e) {
  return ae(e, [`ArrowLeft`, `ArrowUp`])
    ? K
    : ae(e, [`ArrowRight`, `ArrowDown`])
      ? q
      : ae(e, [`Backspace`])
        ? Y
        : ae(e, [`Delete`])
...
function he(e) {
  ...
  t[0] === e
    ? (a = t[1])
    : ((a = (0, W.jsx)(_e, { ...e })), (t[0] = e), (t[1] = a));
  let o;
  return (
    t[2] !== i || t[3] !== a
      ? ((o = (0, W.jsx)(
          A,
          { name: `TerminalPanel`, fallback: ge, children: a },
          i,
        )),
        (t[2] = i),
        (t[3] = a),
...
function _e(e) {
  let t = (0, U.c)(50),
    ...
    d = P(N()),
    f = u !== `macOS`,
    p = l(n.lightChromeTheme),
    m = l(n.darkChromeTheme),
    h = l(n.codeFontSize),
    g,
    b,
    x,
    S;
  if (t[0] !== h || t[1] !== m || t[2] !== p || t[3] !== d) {
    g = d === `light` ? y(p, `light`) : y(m, `dark`);
  ...
  (t[11] === x
    ...
    (0, $.useEffect)(R, z));
  let B;
  t[14] === i ? (B = t[15]) : ((B = () => i), (t[14] = i), (t[15] = B));
  let V = (0, $.useEffectEvent)(B),
    H,
    G;
  (t[16] !== g || t[17] !== d
    ? ((H = () => {
  ...
  t[20] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((K = () => {
        ...
        !e ||
          !t ||
          ((e.options.theme = le(t)), e.rows > 0 && e.refresh(0, e.rows - 1));
      }),
      (t[20] = K))
    : (K = t[20]);
  let q;
  (t[21] !== g || t[22] !== d
    ? ((q = [g, d]), (t[21] = g), (t[22] = d), (t[23] = q))
    : (q = t[23]),
    (0, $.useEffect)(K, q));
  let J, Y;
    ...
    ? ((Z = () => {
        ...
        let l = !1,
          ...
          m = () => {
            p ??= requestAnimationFrame(() => {
              ((p = null), d.scrollToBottom());
            });
          };
        E.current = d;
        let h = new ue.ClipboardAddon(),
          g = new de.FitAddon();
        D.current = g;
        let _ = new fe.WebLinksAddon(ye);
        (d.loadAddon(h),
          d.loadAddon(g),
          d.loadAddon(_),
          d.attachCustomKeyEventHandler((e) =>
            X({
              clipboard:
        ...
        let v = () => {
          l ||
            (e.isConnected &&
              requestAnimationFrame(() => {
                l || (e.isConnected && (A.current ? me(d, g, i) : g.fit()));
              }));
        };
        v();
        let y = k.register(i, {
            onClearActive: () => {
              t.contains(document.activeElement) && d.clear();
            },
            onInitLog: (e) => {
              (d.write(e), m());
            },
  ...
  t[44] !== f
    ...
    : (ee = t[45]),
    (0, $.useEffect)(Z, ee));
  let te = s == null ? void 0 : `terminal-panel-${s}`,
    ne;
  ...
  t[47] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Q = (0, W.jsx)(`div`, {
        className: `flex-1 overflow-hidden px-4 pb-3 tracking-normal`,
...
function ye(e, t) {
  t && (e.preventDefault?.(), d.dispatchMessage(`open-in-browser`, { url: t }));
}
function be(e) {
  let t = (0, U.c)(3),
    { conversationId: n } = e,
  ...
  return (
    t[0] === n
      ? ((r = t[1]), (i = t[2]))
      : ((r = (e) => (n == null ? Se : k.subscribeToConversation(n, e))),
        (i = () => (n == null ? null : k.getConversationSnapshot(n))),
        (t[0] = n),
        (t[1] = r),
        (t[2] = i)),
    (0, $.useSyncExternalStore)(r, i, xe)
  );
}
function xe() {
  return null;
...
var we = `terminal:`,
  ...
  De = c(f, ({ get: e }) => {
    let t = e(b.activeTab$);
    return e(h) && t != null && Ye(t.tabId);
  });
function Oe(e) {
  (L(e, `bottom`), requestAnimationFrame(E));
}
function ke(e) {
  (L(e, `right`), requestAnimationFrame(E));
}
function Ae(e) {
  Me(e, `bottom`);
}
...
function Me(e, t) {
  ...
  if (n == null) return;
  let r =
    We(e, t, k.getConversationSnapshot(n.conversationId)?.sessionIds ?? []) ??
    k.addSessionForConversation(n.conversationId);
  (k.setActiveSessionForConversation(n.conversationId, r),
    He(e, n, t),
    Be(e, n, r, !0, t, r));
}
function Ne(e) {
...
function Be(e, t, n, r, i, a) {
  ...
  for (let [n, r] of u.entries()) {
    ...
    l.openTab(e, Ce, {
      ...
      id: a,
      title: s,
      props: { ...t, onNewTerminalTab: i === `bottom` ? Pe : Fe, sessionId: r },
    });
  }
  r && (l.activateTab(e, qe(n)), I(e, i));
}
function Ve(e, t, n, r) {
  let i = F(r);
...
function He(e, t, n) {
  ...
  let a = k.subscribeToConversation(t.conversationId, () => {
    ...
    let i = Te.get(r);
    if (i != null)
      for (let t of i.panels) Be(e, i.target, n.activeSessionId, !1, t);
  });
  Te.set(r, { panels: new Set([n]), target: t, unsubscribe: a });
}
function Ue(e, t, n) {
  let r = F(n),
    i = new Set(t.map(qe));
  for (let t of e.get(r.tabs$))
    Ye(t.tabId) && !i.has(t.tabId) && r.closeTab(e, t.tabId);
  ...
  switch (e.value.routeKind) {
    ...
    case `local-thread`:
      return {
        ...
        conversationTitle: e.get(e.get(S, e.value.conversationId)),
        cwd: e.get(w),
        hostId: e.get(C),
      };
...
function Je(e) {
  return e?.startsWith(we) ? e.slice(9) : null;
}
function Ye(e) {
...
//# sourceMappingURL=thread-page-bottom-panel-state-D1Lz0U4Y.js.map
