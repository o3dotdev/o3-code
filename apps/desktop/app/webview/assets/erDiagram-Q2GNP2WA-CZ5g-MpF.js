...
import { i as n, n as r, r as i, t as a } from "./src-DXdm7MTq.js";
import {
  B as o,
  C as s,
  U as c,
...
import { t as h } from "./channel-BnFhepYz.js";
...
import { t as g } from "./chunk-55IACEB6-ouq-OFLp.js";
import { t as _ } from "./chunk-QN33PNHL-BRcT7LP7.js";
import "./chunk-ATLVNIR6-DztwCsKK.js";
import "./chunk-JZLCHNYA-BxKQhlWe.js";
import "./chunk-QXUST7PY-BKTz6l_w.js";
import { r as v, t as y } from "./chunk-N4CR4FBY-l_UuU9Uv.js";
var b = (function () {
...
` +
  ...
  return (i(q, `Parser`), (q.prototype = K), (K.Parser = q), new q());
})();
b.parser = b;
var x = b,
  S = class {
    constructor() {
      ((this.entities = new Map()),
        ...
        (this.getConfig = i(() => d().er, `getConfig`)),
        this.clear(),
      ...
      return (
        this.entities.has(e)
          ? !this.entities.get(e)?.alias &&
            ...
            n.info(`Add alias '${t}' to entity '${e}'`))
          : (this.entities.set(e, {
    ...
    addAttributes(e, t) {
      ...
      for (i = t.length - 1; i >= 0; i--)
        (t[i].keys || (t[i].keys = []),
          t[i].comment || (t[i].comment = ``),
          r.attributes.push(t[i]),
          n.debug(`Added attribute `, t[i].name));
    }
    addRelationship(e, t, r, i) {
      let a = this.entities.get(e),
        o = this.entities.get(r);
      if (!a || !o) return;
      let s = { entityA: a.id, roleA: t, entityB: o.id, relSpec: i };
    ...
    getData() {
      ...
      for (let e of this.relationships) {
        let a = {
          id: t(e.entityA, e.entityB, { prefix: `id`, counter: i++ }),
          type: `normal`,
          curve: `basis`,
          start: e.entityA,
          end: e.entityB,
      ...
      return { nodes: e, edges: n, other: {}, config: r, direction: `TB` };
    }
  },
  C = {};
r(C, { draw: () => w });
var w = i(async function (t, r, i, o) {
    (n.info(`REF0:`), n.info(`Drawing er diagram (unified)`, r));
    let { securityLevel: s, er: c, layout: l } = d(),
      u = o.db.getData(),
      f = g(r, s);
    ((u.type = o.type),
    ...
    (Array.from(p).length > 0 &&
      ...
      _(f, 8, `erDiagram`, c?.useMaxWidth ?? !0));
  }, `draw`),
  T = i((e, t) => {
    let n = h;
...
export { E as diagram };
//# sourceMappingURL=erDiagram-Q2GNP2WA-CZ5g-MpF.js.map
