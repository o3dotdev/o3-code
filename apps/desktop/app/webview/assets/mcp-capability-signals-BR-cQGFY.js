...
import { Xi as p, ts as m } from "./app-server-manager-signals-Csopz8aM.js";
import {
  Q as h,
  S as g,
  Z as _,
...
import {
  ...
  o as S,
  r as C,
} from "./types-CPCvmS0A.js";
import { r as ae } from "./base64-3q0bprhg.js";
((t) =>
  typeof e < `u`
    ? e
    : typeof Proxy < `u`
...
var oe = r([u(`light`), u(`dark`)]).describe(
    `Color theme preference for the host environment.`,
  ),
  w = r([u(`inline`), u(`fullscreen`), u(`pip`)]).describe(
...
for compatibility with Zod schema generation. Both are functionally equivalent for validation.`),
    r([o(), t()]).describe(`Style variables for theming MCP apps.
...
(i({
  ...
  params: i({ url: o().describe(`URL to open in the host's browser`) }),
}),
  i({
    isError: l()
      .optional()
  ...
  i({ method: u(`ui/notifications/sandbox-proxy-ready`), params: i({}) }));
var T = i({
    connectDomains: a(o()).optional()
...
- Empty or omitted → no network connections (secure default)`),
  ...
  E = i({
    camera: i({}).optional().describe(`Request camera access.

Maps to Permission Policy \`camera\` feature.`),
    microphone: i({}).optional().describe(`Request microphone access.

Maps to Permission Policy \`microphone\` feature.`),
    geolocation: i({}).optional().describe(`Request geolocation access.

Maps to Permission Policy \`geolocation\` feature.`),
    clipboardWrite: i({}).optional().describe(`Request clipboard write access.
...
(i({
  ...
  params: i({
    width: d().optional().describe(`New width in pixels.`),
    height: d().optional().describe(`New height in pixels.`),
  }),
}),
  i({
    ...
    params: i({
      arguments: c(
        o(),
        f().describe(`Complete tool call arguments as key-value pairs.`),
      )
        .optional()
  ...
  i({
    ...
    params: i({
      arguments: c(
        o(),
        f().describe(`Partial tool call arguments (incomplete, may change).`),
      )
        .optional()
...
var D = i({ fonts: o().optional() }),
  O = i({
    variables: se.optional().describe(`CSS variables for theming the app.`),
    css: D.optional().describe(`CSS blocks that apps can inject.`),
  });
(i({ method: u(`ui/resource-teardown`), params: i({}) }), c(o(), f()));
var k = i({
  text: i({}).optional().describe(`Host supports text content blocks.`),
  image: i({}).optional().describe(`Host supports image content blocks.`),
  audio: i({}).optional().describe(`Host supports audio content blocks.`),
  resource: i({}).optional().describe(`Host supports resource content blocks.`),
  resourceLink: i({})
    .optional()
...
i({ method: u(`ui/notifications/request-teardown`), params: i({}).optional() });
var A = i({
    experimental: i({})
      .optional()
    ...
    logging: i({}).optional().describe(`Host accepts log messages.`),
    sandbox: i({
      permissions: E.optional().describe(
        `Permissions granted by the host (camera, microphone, geolocation).`,
      ),
      csp: T.optional().describe(`CSP domains approved by the host.`),
    })
      .optional()
      .describe(`Sandbox configuration applied by the host.`),
    updateModelContext: k
      .optional()
      .describe(
  ...
  j = i({
    ...
    availableDisplayModes: a(w)
      .optional()
      .describe(`Display modes the app supports.`),
  });
(i({ method: u(`ui/notifications/initialized`), params: i({}).optional() }),
  i({
    csp: T.optional().describe(
...
- omitted: host decides border`),
  ...
  i({
    ...
    params: i({ mode: w.describe(`The display mode being requested.`) }),
  }),
  i({
    mode: w.describe(
...
var M = r([u(`model`), u(`app`)]).describe(
  `Tool visibility scope - who can access the tool.`,
);
(i({
  resourceUri: o().optional(),
  visibility: a(M).optional()
...
- "app": Tool callable by the app from this server only`),
  ...
  i({
    ...
    params: i({
      ...
      content: a(C).describe(`Message content blocks (text, image, etc.).`),
    }),
  }),
  i({
    method: u(`ui/notifications/sandbox-resource-ready`),
    params: i({
      html: o().describe(`HTML content to load into the inner iframe.`),
      sandbox: o()
        .optional()
        .describe(
          `Optional override for the inner iframe's sandbox attribute.`,
        ),
      csp: T.optional().describe(`CSP configuration from resource metadata.`),
      permissions: E.optional().describe(
  ...
  i({
    ...
    params: x.describe(`Standard MCP tool execution result.`),
  }));
var N = i({
  toolInfo: i({
    id: re.optional().describe(`JSON-RPC id of the tools/call request.`),
    tool: ie.describe(`Tool definition including name, inputSchema, etc.`),
  })
    .optional()
    .describe(`Metadata of the tool call that instantiated this App.`),
  theme: oe.optional().describe(`Current color theme preference.`),
  styles: O.optional().describe(`Style configuration for theming the app.`),
  ...
  containerDimensions: r([
    i({ height: d().describe(`Fixed container height in pixels.`) }),
    i({
      maxHeight: r([d(), t()])
        .optional()
    ...
    .and(
      r([
        i({ width: d().describe(`Fixed container width in pixels.`) }),
        i({
          maxWidth: r([d(), t()])
            .optional()
...
container holding the app. Specify either width or maxWidth, and either height or maxHeight.`),
  ...
  timeZone: o().optional().describe(`User's timezone in IANA format.`),
  userAgent: o().optional().describe(`Host application identifier.`),
  platform: r([u(`web`), u(`desktop`), u(`mobile`)])
    .optional()
  ...
  safeAreaInsets: i({
    top: d().describe(`Top safe area inset in pixels.`),
    right: d().describe(`Right safe area inset in pixels.`),
    bottom: d().describe(`Bottom safe area inset in pixels.`),
    left: d().describe(`Left safe area inset in pixels.`),
  })
    .optional()
...
(i({
  ...
  params: N.describe(`Partial context update containing only changed fields.`),
}),
  i({
  ...
  i({
    ...
    params: i({
      ...
      appCapabilities: j.describe(
        `Features and capabilities this app provides.`,
      ),
      protocolVersion: o().describe(`Protocol version this app supports.`),
    }),
  }),
  i({
    protocolVersion: o().describe(
      `Negotiated protocol version string (e.g., "2025-11-21").`,
    ),
    hostInfo: v.describe(`Host application identification and version.`),
    hostCapabilities: A.describe(
      `Features and capabilities provided by the host.`,
    ),
    hostContext: N.describe(`Rich context about the host environment.`),
  }).passthrough());
var P = `ui/resourceUri`;
function F(e) {
  let t = e._meta?.ui?.resourceUri;
  if (
    (t === void 0 && (t = e._meta?.[P]),
...
var I = i({ mcpServers: c(o().trim().min(1), i({})) });
function L(e) {
  let t = I.parse(e);
  return { mcpServers: Object.keys(t.mcpServers) };
}
var R = i({ openaiCapabilities: I.optional() });
function z(e) {
  return R.parse(e);
}
var B = i({
    ui: i({
      entrypoints: a(
        r([
          i({ type: u(`global`) }),
          i({ type: u(`thread`) }),
          i({ extensions: a(o().trim().min(1)), type: u(`file`) }),
        ]),
      ).optional(),
    }).optional(),
  }).optional(),
...
async function V(e, t) {
  return (
    await Promise.all(
      t.map(async (t) => {
        try {
          let n = await ue(e, p(t.path, `.codex-plugin/plugin.json`)),
            r = z(JSON.parse(n));
          if (r.openaiCapabilities == null) return null;
          let i = L(r.openaiCapabilities),
              ...
              (
                await Promise.all(
                  i.mcpServers.map(async (n) => {
                    try {
                      let r = ce.parse(
                        await te(`get-openai-capabilities-server-info`, {
                          params: {
                            hostId: e,
                            pluginId: t.id,
                            pluginPath: t.path,
...
function H(e) {
  return e.flatMap((e) =>
    Object.entries(e.servers).flatMap(([t, { tools: n }]) =>
      n.flatMap((r) => G(e.hostId, e.pluginId, t, r, n)),
    ),
  );
}
function U(e) {
  return e.flatMap((e) =>
    Object.entries(e.servers).flatMap(([t, { tools: n }]) =>
      n.flatMap((n) => {
        let r = K(n).flatMap((e) => (e.type === `file` ? e.extensions : [])),
          i = F(n);
        return r.length === 0 || i == null || !J(n)
          ? []
          : [
              {
                extensions: r,
...
function G(e, t, n, r, i) {
  let a = F(r);
  if (a == null || !J(r)) return [];
  let o = q(r);
  return K(r).flatMap((s) => {
    switch (s.type) {
      case `global`:
      case `thread`:
        return [
...
function K(e) {
  let t = B.safeParse(e._meta?.[`com.openai`]);
...
function J(e) {
  let t = i({ visibility: a(n([`app`, `model`])).optional() }).safeParse(
    e._meta?.ui,
  );
  return t.success && t.data.visibility?.includes(`app`) === !0;
}
async function le(e, t) {
  let n = await m(`read-app-plugin-extension-file-for-host`, {
    hostId: e,
    path: t,
  });
  return n == null ? null : ae(n.dataBase64);
}
...
var Y = h(g, (e, { signal: t }) => t([])),
  ...
  Q = _(g, ({ get: e }) => e(e(Z, `local`)).data ?? []),
  de = _(g, ({ get: e }) => W(e(Q))),
  fe = _(g, ({ get: e }) => U(e(Q))),
  $ = _(g, ({ get: e }) => H(e(Q))),
  pe = _(g, ({ get: e }) => e($).filter((e) => e.entrypoint === `global`));
export { pe as a, fe as i, X as n, de as o, Y as r, $ as s, Q as t };
//# sourceMappingURL=mcp-capability-signals-BR-cQGFY.js.map
