...
import { t as f } from "./product-logger-CekQ0CO0.js";
import { d as p } from "./statsig-BwN76nAo.js";
import { t as m } from "./invalidate-queries-and-broadcast-CPrIeBVQ.js";
...
import { n as g } from "./electron-menu-shortcuts-DQYPVyfu.js";
import { t as _ } from "./check-md-I6RRy8DL.js";
import "./chevron-right-DcOUsgCQ.js";
import "./search-CEAmgNrg.js";
import { r as v, t as y } from "./dropdown-CLcC-0sa.js";
import "./chevron-CEHg0DRl.js";
import { t as b } from "./use-is-appshot-available-9cNphkqQ.js";
import { t as x } from "./appshot-logo-ByI1kNN2.js";
import { i as S, t as C } from "./settings-shared-buyehiMO.js";
import { t as w } from "./settings-content-layout-B4F7ZmxE.js";
import { n as T } from "./settings-row-D-T3_hWW.js";
import { t as E } from "./settings-surface-BVAbQNXw.js";
import { t as D } from "./settings-group-BXAVZ8Oc.js";
var O = d(),
  k = `` + new URL(`appshot-demo-DcV9m9GT.mp4`, import.meta.url).href,
  A = e(t(), 1),
  j = n(),
  M = [
...
function N() {
  let e = s(a),
    ...
    { data: h } = l(`appshot-hotkey-state`, { queryConfig: { enabled: t } }),
    x = c(`appshot-set-hotkey`, {
      onSuccess: (e) => {
        let t = u(`appshot-hotkey-state`);
        (n.setQueryData(t, e.state), o(t));
      },
    });
  if (!t || h?.supported === !1) return null;
  async function S(t, n) {
    p(null);
    try {
      let r = await x.mutateAsync({ hotkey: t });
      if (!r.success) {
        p(r.error);
        return;
      }
      f(e, {
        ...
        metadata: { hotkey: t ?? void 0, enabled: t != null, source: n },
      });
    } catch (e) {
      p(e instanceof Error ? e.message : String(e));
    }
  }
  let w = h?.configuredHotkey ?? null,
    E = M.find((e) => e.hotkey === w) ?? null,
    D = E?.label ?? (w == null ? null : g(w)),
    O = E?.hotkey ?? null;
  return (0, j.jsx)(T, {
    label: (0, j.jsx)(r, {
    ...
    description:
      O == null && d == null
        ...
        : (0, j.jsxs)(`div`, {
            ...
            children: [
              O == null ? null : (0, j.jsx)(P, { hotkey: O }),
              d
                ? (0, j.jsx)(`span`, {
    ...
    control: (0, j.jsx)(y, {
      ...
      children: (0, j.jsxs)(v.Section, {
        children: [
          M.map((e) =>
            (0, j.jsx)(
              v.Item,
              {
                RightIcon: e.hotkey === E?.hotkey ? _ : void 0,
                onSelect: () => {
                  (p(null), e.hotkey !== w && S(e.hotkey, `capture`));
                },
                children: e.label,
              },
              e.hotkey,
          ...
          (0, j.jsx)(v.Item, {
            RightIcon: w == null ? _ : void 0,
            onSelect: () => {
              (p(null), w != null && S(null, `disable`));
            },
            children: (0, j.jsx)(r, {
              id: `settings.appshotHotkey.none`,
              defaultMessage: `None`,
...
function F() {
  ...
  e[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((s = (0, j.jsx)(S, { slug: `appshots` })), (e[0] = s))
    : (s = e[0]);
  let c;
...
export { F as AppshotsSettings };
//# sourceMappingURL=appshots-settings-BT8nfBKF.js.map
