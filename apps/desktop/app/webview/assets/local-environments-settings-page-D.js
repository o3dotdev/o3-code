...
import { Dn as t, On as n, Tn as r, U as i } from "./src-C.js";
import {
  Mn as a,
  Qn as o,
  Un as s,
...
import { t as N } from "./use-os-info-CpFtQpVC.js";
...
import { i as ee, r as P } from "./open-project-setup-dialog-cJXYMFtk.js";
import { t as te } from "./folder.js";
import "./local-task-row-signals-BzazYVei.js";
import { u as ne } from "./sidebar-project-group-signals-CEQTKcIf.js";
import "./sidebar-project-groups.js";
import "./_defineProperty.js";
import "./check-md.js";
import { t as F } from "./chevron-right.js";
import { t as I } from "./arrow-left.js";
import { t as L } from "./checkbox-DtuSNXXy.js";
import "./minus.js";
import { d as re } from "./links.js";
import "./bug-B5-GWt65.js";
import "./search.js";
import { r as R, t as ie } from "./dropdown-DtQxMoJw.js";
import { i as z, n as ae, r as B, t as oe } from "./popover.js";
import { t as se } from "./trash.js";
import { t as V } from "./chevron-NmAOI_v1.js";
import { t as ce } from "./worktree-D_6WAQVb.js";
import "./settings.cog.js";
import { t as H } from "./code-snippet-hioibDaj.js";
import "./copy-Cen6nDnP.js";
import "./copy-button.js";
import { t as U } from "./plus.js";
import { t as le } from "./get-project-name.js";
import { r as ue, t as de } from "./local-environments-DcKJ5oGa.js";
import "./sortBy.js";
import "./use-connected-remote-connections.js";
import { i as W } from "./settings-shared-BTHmEeQY.js";
import { n as fe, t as pe } from "./settings-host-context-ILiCQlCE.js";
...
import { t as we } from "./useForm-BsmKTTLN.js";
var X = T(),
  Te = e(d(), 1);
function Ee(e, t) {
  let n = le(e) ?? e;
...
function je(e) {
  let t = (0, X.c)(59),
    ...
    P;
  t[0] !== ee || t[1] !== c
    ? ((P = i(c, ee)), (t[0] = ee), (t[1] = c), (t[2] = P))
    : (P = t[2]);
  let te = P,
    ne = u(n),
    { data: F } = s(c, ne, `local_environment_editor`),
    I;
  t[3] === ne ? (I = t[4]) : ((I = o(ne)), (t[3] = ne), (t[4] = I));
  let re = I,
    z;
  t[5] !== F || t[6] !== re || t[7] !== D
    ? ((z = {
      ...
      (t[8] = z))
    : (z = t[8]);
  let ae = l(`set-config-value`, ne, z),
    [B, oe] = (0, Te.useState)(`default`),
    [V, ce] = (0, Te.useState)(`default`),
    H,
    U;
  if (
    t[9] !== v?.actions ||
    ...
    ? ((de = {
        onSuccess: () => {
          (D.invalidateQueries({
            ...
            D.invalidateQueries({
              queryKey: w(`local-environment`, { configPath: f, hostId: n }),
            }),
            D.invalidateQueries({
      ...
      (t[29] = de))
    : (de = t[29]);
  let W = S(`local-environment-config-save`, de),
    fe;
  t[30] !== f || t[31] !== n || t[32] !== W || t[33] !== U
    ? ((fe = (e) => {
        let { value: t } = e,
          r = Pe(t, U);
        t.name.length !== 0 && W.mutate({ configPath: f, hostId: n, raw: r });
      }),
      (t[30] = f),
      (t[31] = n),
      (t[32] = W),
  ...
  let pe;
  t[35] !== ue || t[36] !== fe
    ? ((pe = { defaultValues: ue, onSubmit: fe }),
      (t[35] = ue),
      (t[36] = fe),
      (t[37] = pe))
    : (pe = t[37]);
...
function He(e) {
  ...
  let d = u,
    ...
    x = m.length > 0 || h.length > 0 || g.length > 0,
                      ...
                      ? (0, Z.jsxs)(`div`, {
                          ...
                          children: [
                            ...
                            m.length > 0
                              ...
                              : null,
                            h.length > 0
                              ? (0, Z.jsx)(Ge, { platform: `linux`, script: h })
                              : null,
                            g.length > 0
                              ? (0, Z.jsx)(Ge, { platform: `win32`, script: g })
                              : null,
                          ],
                        })
                      : null,
...
function Ye(e) {
  let t = (0, X.c)(21),
    ...
    s;
  t[0] !== n.path || t[1] !== r
    ? ((s = { params: { hostId: r, workspaceRoot: n.path }, select: Xe }),
      (t[0] = n.path),
      (t[1] = r),
      (t[2] = s))
    : (s = t[2]);
  let { data: c, isLoading: l, error: u } = C(`local-environments`, s),
    d = c === void 0 ? [] : c,
    [f, h] = (0, Te.useState)(!1),
    { projectEnvironments: g, inheritedEnvironments: v } = $e(d, n.path),
    y = de(g),
    b = n.isCodexWorktree ? ce : te,
    x = n.repositoryData?.ownerRepo?.owner ?? null,
    S = l,
    w = u != null,
    T = g.length > 0 || v.length > 0,
    E;
  t[3] === o
    ? (E = t[4])
    : ((E = o.formatMessage({
  ...
  return (
    t[20] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((R = (0, Z.jsx)(U, { className: `icon-xs` })), (t[20] = R))
      : (R = t[20]),
    (0, Z.jsxs)(q, {
      className: `p-0`,
      children: [
                ...
                : w
                  ? (0, Z.jsx)(`div`, {
                      ...
                      children: (0, Z.jsx)(`div`, {
                        ...
                        children: (0, Z.jsx)(`span`, { children: ne }),
                      }),
                    })
                  : (0, Z.jsxs)(`div`, {
...
function Ze(e) {
  ...
  t[0] === n.configPath
    ? (o = t[1])
    : ((o = Qe(n.configPath)), (t[0] = n.configPath), (t[1] = o));
  let s = o,
    c =
      n.type === `success` &&
...
function $e(e, t) {
  let n = c(t),
    r = [],
    i = [];
  for (let t of e) et(t.configPath) === n ? r.push(t) : i.push(t);
...
function tt() {
  ...
  e[34] === ce
    ? (H = e[35])
    : ((H = { enabled: ce }), (e[34] = ce), (e[35] = H));
  let U;
  e[36] !== V || e[37] !== H
    ? ((U = { params: V, queryConfig: H, select: nt }),
      (e[36] = V),
      (e[37] = H),
      (e[38] = U))
    : (U = e[38]);
  let { data: le, isLoading: ue, error: W } = C(`local-environments`, U),
    G;
  e[39] === le
    ? (G = e[40])
  ...
  let K = G,
    me;
  e[41] === K ? (me = e[42]) : ((me = de(K)), (e[41] = K), (e[42] = me));
  let he = v ?? me ?? null,
    ge = he ?? ``,
    _e;
  e[43] !== c || e[44] !== ge
  ...
  let { data: ke, error: Ae, isLoading: Me } = C(`local-environment`, Oe),
    ...
    Fe = Se?.message ?? Ae?.message ?? W?.message ?? null,
    Ie;
  e[59] !== F || e[60] !== ie || e[61] !== S || e[62] !== k || e[63] !== A
    ? ((Ie =
        k == null
          ? null
          : (0, Z.jsx)(De, {
  ...
  if (Le) {
    ...
    return (
      e[75] === $
        ? (r = e[76])
        : ((r = (0, Z.jsx)(rt, { backSlot: $, children: n })),
          (e[75] = $),
          (e[76] = r)),
      r
    );
  ...
  if (S) {
    ...
    return (
      e[91] !== $ || e[92] !== t
        ? ((n = (0, Z.jsx)(rt, { backSlot: $, children: t })),
          (e[91] = $),
          (e[92] = t),
          (e[93] = n))
        : (n = e[93]),
  ...
  return (
    e[102] !== $ || e[103] !== Re
      ? ((ze = (0, Z.jsx)(rt, { backSlot: $, children: Re })),
        (e[102] = $),
        (e[103] = Re),
        (e[104] = ze))
      : (ze = e[104]),
...
export { tt as LocalEnvironmentsSettings };
//# sourceMappingURL=local-environments-settings-page-D.js.map
