...
function c(e) {
  for (var t = this, n = l(t, e), r = [t]; t !== n; )
    ((t = t.parent), r.push(t));
...
function j() {
  ...
  return (
    ...
    (u.paddingTop = function (e) {
      return arguments.length
        ? ((o = typeof e == `function` ? e : w(+e)), u)
        : o;
    }),
    (u.paddingRight = function (e) {
      return arguments.length
        ? ((s = typeof e == `function` ? e : w(+e)), u)
        : s;
    }),
    (u.paddingBottom = function (e) {
      return arguments.length
        ? ((c = typeof e == `function` ? e : w(+e)), u)
        : c;
    }),
    (u.paddingLeft = function (e) {
      return arguments.length
        ? ((l = typeof e == `function` ? e : w(+e)), u)
        : l;
    }),
    u
  );
...
//# sourceMappingURL=treemap-zgLv8VaX.js.map
