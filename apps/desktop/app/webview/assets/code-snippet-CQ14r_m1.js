const __vite__mapDeps = (
  i,
  m = __vite__mapDeps,
  d = m.f || (m.f = ["./highlight-code-BKLESDA5.js", "./chunk-Bj-mKKzh.js"]),
) => i.map((i) => d[i]);
...
import { W as a, xt as o } from "./setting-storage-EK1Te68s.js";
import { t as s } from "./use-is-dark-YP6LF-lA.js";
import { t as c } from "./tooltip-DzyyaBl-.js";
import { t as l } from "./button-bq66r8jD.js";
import { t as u } from "./data-url-from-svg-D5V7WfjE.js";
import { t as d } from "./copy-to-clipboard-DUkEoARe.js";
import { t as f } from "./tailwind-styled-components.esm-Ck5todVw.js";
import { t as p } from "./copy-button-DEwu0JDM.js";
var m =
  Number.isNaN ||
  function (e) {
...
var x = (e) => {
  ...
  T = _(() =>
    t(
      () => import(`./highlight-code-BKLESDA5.js`),
      __vite__mapDeps([0, 1]),
      import.meta.url,
    ),
  ),
  ...
  D = S.memo(function (e) {
    let t = (0, v.c)(5),
      { html: n, trailingNewline: r } = e,
      i;
    t[0] === n
      ? (i = t[1])
      : ((i = (0, y.jsx)(`span`, { dangerouslySetInnerHTML: { __html: n } })),
        (t[0] = n),
        (t[1] = i));
    let a = r
        ? `
`
    ...
    return (
      t[2] !== i || t[3] !== a
        ? ((o = (0, y.jsxs)(y.Fragment, { children: [i, a] })),
          (t[2] = i),
          (t[3] = a),
          (t[4] = o))
        : (o = t[4]),
...
`),
    ...
    let r = n;
    ((Y = K
      ? (0, y.jsx)(x, { svgString: o, className: `max-h-96 w-full` })
      : e == null
        ...
        : (0, y.jsxs)(`span`, {
            children: [
              e.map((t, n) =>
                (0, y.jsx)(
                  D,
                  { html: t, trailingNewline: n < e.length - 1 },
                  n,
                ),
              ),
              r ? (0, y.jsx)(`span`, { children: r }) : null,
            ],
          })),
      (t[20] = o),
      (t[21] = J),
            ...
            b == null
              ...
              : (0, y.jsx)(c, {
                  ...
                  children: (0, y.jsx)(l, {
                    ...
                    onClick: b,
                    children: (0, y.jsx)(L, { className: `icon-2xs` }),
                  }),
                }),
            (0, y.jsx)(p, {
...
function te(e) {
  ...
  t[13] !== l || t[14] !== d || t[15] !== w
    ? ((T = (0, y.jsx)(A, { ref: d, className: l, children: w })),
      (t[13] = l),
      (t[14] = d),
      (t[15] = w),
      (t[16] = T))
...
var k = f.div`flex items-center text-sm font-sans text-token-description-foreground select-none ps-2 pe-2 py-1 ${(e) => (e.$removeTopBorderRadius ? `` : `rounded-t-lg`)}`,
  A = function (e) {
    let t = (0, v.c)(6),
    ...
    t[0] === r
      ? (o = t[1])
      : ((o = i(`text-size-chat overflow-auto p-2`, r)),
        (t[0] = r),
        (t[1] = o));
    let s;
    return (
  ...
  j = f.code`${(e) => (e.$shouldWrap ? `whitespace-pre-wrap!` : `whitespace-pre!`)}`;
function ne(e) {
  return e.trim().startsWith(`<svg`);
}
export { w as n, C as r, O as t };
//# sourceMappingURL=code-snippet-CQ14r_m1.js.map
