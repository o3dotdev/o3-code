...
import { is as t } from "./app-server-manager-signals-7MlBpIlX.js";
...
import { i as u, t as d } from "./use-collaboration-mode-DsADBvI9.js";
import "./use-model-settings-CyjEC7n3.js";
import { t as f } from "./button-BynxeNRW.js";
...
import { n as m, t as h } from "./use-composer-controller-CHz4Zlxm.js";
import { t as g } from "./plan-DJs4ZXBo.js";
var _ = e(a(), 1),
  v = e(n(), 1),
  y = l(),
  b = r();
function x(e) {
  ...
  t[2] === f
    ? (p = t[3])
    : ((p = i(`flex min-w-0 flex-1 gap-2`, f)), (t[2] = f), (t[3] = p));
  let m;
  t[4] === r
    ? (m = t[5])
    : ((m =
  ...
  t[6] === h
    ? (g = t[7])
    : ((g = i(`min-w-0 flex-1`, h)), (t[6] = h), (t[7] = g));
  ...
  let x;
  t[10] !== v || t[11] !== c
    ? ((x = (0, b.jsx)(`span`, { className: v, children: c })),
      (t[10] = v),
      (t[11] = c),
      (t[12] = x))
    : (x = t[12]);
  ...
  t[13] !== l || t[14] !== o
    ...
    : (S = t[15]);
  let C;
  t[16] !== x || t[17] !== S || t[18] !== g
    ? ((C = (0, b.jsxs)(`div`, { className: g, children: [x, S] })),
      (t[16] = x),
      (t[17] = S),
      (t[18] = g),
      (t[19] = C))
    : (C = t[19]);
  let w;
  t[20] !== C || t[21] !== p || t[22] !== m
    ? ((w = (0, b.jsxs)(`div`, { className: p, children: [m, C] })),
      (t[20] = C),
      (t[21] = p),
      (t[22] = m),
      (t[23] = w))
...
function T({
  ...
  return t
    ? {
        ...
        onDismiss: () => {
          r((e) => (e.includes(`keyword-plan-mode`) ? e : [...e, C]));
        },
      }
    : null;
}
...
var D = `__new-thread__`;
function O(e) {
  let t = (0, y.c)(4),
    { portalTarget: n, conversationId: r, showPlanKeywordSuggestion: i } = e;
...
function k(e) {
  let n = (0, y.c)(21),
    { portalTarget: r, conversationId: i, showPlanKeywordSuggestion: a } = e,
    o = s(),
    l = h(),
    { activeMode: f, modes: p, setSelectedMode: g } = d(i),
    v;
  n[0] === p ? (v = n[1]) : ((v = p.some(A)), (n[0] = p), (n[1] = v));
  let x = v,
    S = f.mode === `plan`,
    T = j(i),
    D;
  ...
  let [O, k] = t(D),
    N;
  n[4] === O ? (N = n[5]) : ((N = new Set(O)), (n[4] = O), (n[5] = N));
  let P = N,
    F;
  n[6] !== P || n[7] !== x || n[8] !== S || n[9] !== a
    ? ((F = (e) =>
        w({
  ...
  n[16] !== r || n[17] !== R
    ? ((z = R
        ? (0, _.createPortal)((0, b.jsx)(M, { suggestion: R }, R.id), r)
        : null),
      (n[16] = r),
      (n[17] = R),
      (n[18] = z))
  ...
  return (
    n[19] === z
      ? (B = n[20])
      : ((B = (0, b.jsx)(b.Fragment, { children: z })),
        (n[19] = z),
        (n[20] = B)),
    B
  );
...
function M({ suggestion: e }) {
  let t = s(),
    [n, r] = (0, v.useState)(!1),
    i = e.icon,
    a = e.actionDisabled === !0 || n,
    o = e.dismissOnAction !== !1,
    c = i ? (0, b.jsx)(i, { className: `icon-xs shrink-0` }) : null,
    l = (t) => {
    ...
    u = (t) => {
      (t.stopPropagation(), e.onDismiss());
    };
  return (0, b.jsx)(x, {
    actions: (0, b.jsxs)(b.Fragment, {
      children: [
        (0, b.jsx)(f, {
          className: `px-2.5`,
          color: `secondary`,
        ...
        (0, b.jsx)(`button`, {
          type: `button`,
          className: `user-select-none no-drag flex size-[22px] shrink-0 cursor-interaction items-center justify-center rounded-full border border-transparent text-token-description-foreground hover:bg-token-list-hover-background focus:outline-none`,
          ...
          onClick: u,
          children: (0, b.jsx)(p, { className: `icon-xs` }),
        }),
      ],
    }),
    icon: c,
...
export { O as AboveComposerSuggestions };
//# sourceMappingURL=above-composer-suggestions-DWeBYz6L.js.map
