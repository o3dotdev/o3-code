...
import { t as i } from "./cytoscape.esm-DHOMt9bj.js";
import { t as a } from "./cytoscape-cose-bilkent.js";
var o = e(a(), 1);
i.use(o.default);
function s(e, t) {
  e.forEach((e) => {
  ...
  return new Promise((n) => {
    ...
    (a.remove(),
      ...
      o
        ...
        .run(),
      o.ready((e) => {
        (r.info(`Cytoscape ready`, e), n(o));
      }));
  });
}
n(l, `createCytoscapeInstance`);
function u(e) {
...
async function f(e, t) {
  ...
  try {
    ...
    let t = await l(e),
      ...
      i = d(t);
    return (
      r.debug(`Layout completed: ${n.length} nodes, ${i.length} edges`),
      { nodes: n, edges: i }
    );
  } catch (e) {
...
export { m as render };
//# sourceMappingURL=cose-bilkent-S5V4N54A-CeW6ZPSo.js.map
