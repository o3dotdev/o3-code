...
var n = e(
  t((e, t) => {
    ...
    var w = /\b\B/,
      ...
      ee = { scope: `number`, begin: O, relevance: 0 },
      te = { scope: `number`, begin: k, relevance: 0 },
      ne = {
        scope: `regexp`,
        begin: /\/(?=[^/\n]*\/)/,
        end: /\/[gimuy]*/,
      ...
      re = { scope: `title`, begin: T, relevance: 0 },
      ie = { scope: `title`, begin: E, relevance: 0 },
      ae = { begin: `\\.\\s*` + E, relevance: 0 },
      V = Object.freeze({
        __proto__: null,
        APOS_STRING_MODE: N,
        BACKSLASH_ESCAPE: M,
    ...
    var ve = {},
      ...
      U = (e, t) => {
        ve[`${e}/${t}`] ||
          (console.log(`Deprecated as of ${e}. ${t}`), (ve[`${e}/${t}`] = !0));
      },
      W = Error();
    ...
    function xe(e) {
      if (Array.isArray(e.begin)) {
        ...
        if (typeof e.beginScope != `object` || e.beginScope === null)
          throw (H(`beginScope must be object`), W);
        (be(e, e.begin, { key: `beginScope` }),
    ...
    function Se(e) {
      if (Array.isArray(e.end)) {
        ...
        if (typeof e.endScope != `object` || e.endScope === null)
          throw (H(`endScope must be object`), W);
        (be(e, e.end, { key: `endScope` }),
    ...
    function Te(e) {
      ...
      function o(n, r) {
        ...
        return (
          ...
          (s ||= /\w+/),
          (n.keywords &&= he(n.keywords, e.case_insensitive)),
        ...
        function d(e) {
          ...
          if (n) {
            ...
            return (
              t ||
                (ye(s.replace(`{}`, n[1])),
                ye(`Falling back to no-highlight mode for this block.`, e)),
              t ? n[1] : `no-highlight`
            );
          }
          ...
          function g(e, t) {
            return (
              e.scope &&
                ...
                M.openNode(D.classNameAliases[e.scope] || e.scope),
              e.beginScope &&
                (e.beginScope._wrap
                  ? (m(
                      P,
                      D.classNameAliases[e.beginScope._wrap] ||
                        e.beginScope._wrap,
                    ),
                    (P = ``))
...
`),
        ...
        function w(e) {
          ...
          ((e.innerHTML = i.value),
            ...
            z(`after:highlightElement`, { el: e, result: i, text: r }));
        }
        function T(e) {
          l = Ae(l, e);
        }
...
function _(e) {
  ...
  return {
    ...
    contains: [
      ...
      { className: `selector-tag`, begin: `\\b(` + f.join(`|`) + `)\\b` },
    ],
  };
}
function v(e) {
...
var S = `[0-9](_*[0-9])*`,
  ...
  T = {
    className: `number`,
    variants: [
      { begin: `(\\b(${S})((${C})|\\.)?|(${C}))[eE][+-]?(${S})[fFdD]?\\b` },
      { begin: `\\b(${S})((${C})[fFdD]?\\b|\\.([fFdD]\\b)?)` },
      { begin: `(${C})[fFdD]?\\b` },
      { begin: `\\b(${S})[fFdD]\\b` },
      {
        begin: `\\b0[xX]((${w})\\.?|(${w})?\\.(${w}))[pP][+-]?(${S})[fFdD]?\\b`,
      },
...
function E(e, t, n) {
  return n === -1 ? `` : e.replace(t, (r) => E(e, t, n - 1));
}
function D(e) {
  let t = e.regex,
...
var R = `[0-9](_*[0-9])*`,
  z = `\\.(${R})`,
  B = `[0-9a-fA-F](_*[0-9a-fA-F])*`,
  ee = {
    className: `number`,
    variants: [
      { begin: `(\\b(${R})((${z})|\\.)?|(${z}))[eE][+-]?(${R})[fFdD]?\\b` },
      { begin: `\\b(${R})((${z})[fFdD]?\\b|\\.([fFdD]\\b)?)` },
      { begin: `(${z})[fFdD]?\\b` },
      { begin: `\\b(${R})[fFdD]\\b` },
      {
        begin: `\\b0[xX]((${B})\\.?|(${B})?\\.(${B}))[pP][+-]?(${R})[fFdD]?\\b`,
      },
      { begin: `\\b(0|[1-9](_*[0-9])*)[lL]?\\b` },
      { begin: `\\b0[xX](${B})[lL]?\\b` },
      { begin: `\\b0(_*[0-7])*[lL]?\\b` },
  ...
  let d = o.concat({ begin: /\{/, end: /\}/, contains: a }),
    ...
    g = {
      ...
      contains: [
        ...
        { className: `selector-pseudo`, begin: `:(:)?(` + ce.join(`|`) + `)` },
...
function Y(...e) {
  return (
    `(` + (Le(e).capture ? `` : `?:`) + e.map((e) => Ie(e)).join(`|`) + `)`
  );
}
var Re = (e) => J(/\b/, e, /\w$/.test(e) ? /\b/ : /\B/),
  ze = [`Protocol`, `Type`].map(Re),
  Be = [`init`, `self`].map(Re),
  Ve = [`Any`, `Self`],
  He = [
    `actor`,
  ...
  X = Y(Xe, /\d/, /[\u0300-\u036F\u1DC0-\u1DFF\u20D0-\u20FF\uFE20-\uFE2F]/),
  Z = J(Xe, X, `*`),
  Q = J(/[A-Z]/, X, `*`),
  Ze = [
    `attached`,
    `autoclosure`,
    J(/convention\(/, Y(`swift`, `block`, `c`), /\)/),
    `discardableResult`,
    `dynamicCallable`,
    `dynamicMemberLookup`,
    `escaping`,
...
function $e(e) {
  let t = { match: /\s+/, relevance: 0 },
    ...
    i = { match: [/\./, Y(...ze, ...Be)], className: { 2: `keyword` } },
    a = { match: J(/\./, Y(...He)), relevance: 0 },
    o = He.filter((e) => typeof e == `string`).concat([`_|0`]),
    s = {
      variants: [
        {
          className: `keyword`,
          match: Y(
            ...He.filter((e) => typeof e != `string`)
              .concat(Ve)
              .map(Re),
            ...Be,
          ),
    ...
    c = { $pattern: Y(/\b\w+/, /#\w+/), keyword: o.concat(Ge), literal: Ue },
    l = [i, a, s],
    u = [
      { match: J(/\./, Y(...Ke)), relevance: 0 },
      { className: `built_in`, match: J(/\b/, Y(...Ke), /(?=\()/) },
    ],
    d = { match: /->/, relevance: 0 },
    f = [
      d,
    ...
    O = [
      {
        ...
        starts: {
          contains: [
            { begin: /\(/, end: /\)/, keywords: Qe, contains: [...f, h, x] },
          ],
        },
      },
      { scope: `keyword`, match: J(/@/, Y(...Ze), q(Y(/\(/, /\s+/))) },
      { scope: `meta`, match: J(/@/, Z) },
    ],
    k = {
      match: q(/\b[A-Z]/),
      relevance: 0,
      contains: [
        ...
        { className: `type`, match: Q, relevance: 0 },
        { match: /[?!]+/, relevance: 0 },
        { match: /\.\.\./, relevance: 0 },
        { match: J(/\s+&\s+/, q(Q)), relevance: 0 },
      ],
    },
    A = {
      begin: /</,
  ...
  let j = {
      ...
      contains: [
        `self`,
        { match: J(Z, /\s*:/), keywords: `_|0`, relevance: 0 },
        ...r,
        T,
        ...l,
        ...u,
    ...
    N = {
      ...
      contains: [
        {
          begin: Y(q(J(Z, /\s*:/)), q(J(Z, /\s+/, Z, /\s*:/))),
          end: /:/,
          relevance: 0,
          contains: [
            { className: `keyword`, match: /\b_\b/ },
            { className: `params`, match: Z },
          ],
        },
        ...r,
        ...l,
    ...
    P = {
      match: [/(func|macro)/, /\s+/, Y(E.match, Z, Ye)],
      className: { 1: `keyword`, 3: `title.function` },
      contains: [M, N, t],
      illegal: [/\[/, /%/],
    },
    ...
    B = {
      begin: [/(struct|protocol|class|extension|enum|actor)/, /\s+/, Z, /\s*/],
      ...
      contains: [
        ...
        ...l,
        {
          ...
          keywords: c,
          contains: [{ scope: `title.class.inherited`, match: Q }, ...l],
          relevance: 0,
        },
      ],
    };
...
var $ = `[A-Za-z$_][0-9A-Za-z$_]*`,
  ...
  tt = [`true`, `false`, `null`, `undefined`, `NaN`, `Infinity`],
  nt =
    `Object.Function.Boolean.Symbol.Math.Date.Number.BigInt.String.RegExp.Array.Float32Array.Float64Array.Int8Array.Uint8Array.Uint8ClampedArray.Int16Array.Int32Array.Uint16Array.Uint32Array.BigInt64Array.BigUint64Array.Set.Map.WeakSet.WeakMap.ArrayBuffer.SharedArrayBuffer.Atomics.DataView.JSON.Promise.Generator.GeneratorFunction.AsyncFunction.Reflect.Proxy.Intl.WebAssembly`.split(
      `.`,
    ),
...
for (let [e, t] of Object.entries(pt)) n.registerLanguage(e, t);
n.registerAliases([`wolfram`], { languageName: `mathematica` });
function mt(e, t) {
  if (t) {
    let { value: r } = n.highlight(e, { language: t });
    return { code: e, html: r, language: t };
  }
  let { value: r, language: i } = n.highlightAuto(e);
  return { code: e, html: r, language: i };
}
export { mt as highlightCode };
//# sourceMappingURL=highlight-code-BKLESDA5.js.map
