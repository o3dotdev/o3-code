...
import { i as e, o as t, r as n } from "./invert.js";
import "./dist-OQR0lEt7.js";
import "./marked.esm-BR-H6018.js";
import { t as r } from "./v4.js";
import { n as i, r as a } from "./chunk-AGHRB4JF-Dk9Dm4Nw.js";
import {
  L as o,
  O as s,
  b as c,
...
import { t as d } from "./chunk-55IACEB6-D64Uo90h.js";
import { t as f } from "./chunk-EDXVE4YY-Dvoshwbp.js";
import "./chunk-X2U36JSP-D4xhl7_D.js";
import "./chunk-5FUZZQ4R-B0fwRQaG.js";
import "./chunk-ENJZ2VHE-ByxrkXoV.js";
import { r as p, t as m } from "./chunk-336JU56O-CDWwHIND.js";
var h = (function () {
  ...
  y = class {
    ...
    addNode(e, t, n, r) {
      ...
      let d = {
          ...
          type: r,
          children: [],
          width: s.mindmap?.maxNodeWidth ?? l.mindmap.maxNodeWidth,
          padding: u,
          isRoot: i,
        },
        f = this.getParent(e);
      if (f) (f.children.push(d), this.nodes.push(d));
      else if (i) this.nodes.push(d);
      else
        throw Error(
    ...
    getData() {
      let e = this.getMindmap(),
        ...
        n = s().layout !== void 0,
        i = t;
      if ((n || (i.layout = `cose-bilkent`), !e))
        return { nodes: [], edges: [], config: i };
      (a.debug(`getData: mindmapRoot`, e, t), this.assignSections(e));
      let o = [],
        l = [];
      (this.flattenNodes(e, o),
        this.generateEdges(e, l),
        a.debug(`getData: processed ${o.length} nodes and ${l.length} edges`));
      let u = new Map();
      for (let e of o)
        u.set(e.id, {
          shape: e.shape,
...
` + e,
      ...
      let i = r.db,
        o = i.getData(),
        s = d(t, o.config.securityLevel);
      if (
        ((o.type = r.type),
        (o.layoutAlgorithm = m(o.config.layout, { fallback: `cose-bilkent` })),
        (o.diagramId = t),
        !i.getMindmap())
      )
        return;
      (o.nodes.forEach((e) => {
        ...
        await p(o, s));
      let { themeVariables: c } = u(),
        { useGradient: h, gradientStart: g, gradientStop: _ } = c;
      if (h && g && _) {
        let e = s.attr(`id`),
          t = s
            .append(`defs`)
      ...
      f(
        s,
        o.config.mindmap?.padding ?? l.mindmap.padding,
        `mindmapDiagram`,
        o.config.mindmap?.useMaxWidth ?? l.mindmap.useMaxWidth,
      );
    }, `draw`),
  },
  x = i((r) => {
    let { theme: i, look: a } = r,
      o = ``;
    for (let i = 0; i < r.THEME_COLOR_LIMIT; i++)
      ((r[`lineColor` + i] = r[`lineColor` + i] || r[`cScaleInv` + i]),
        t(r[`lineColor` + i])
          ? (r[`lineColor` + i] = e(r[`lineColor` + i], 20))
          : (r[`lineColor` + i] = n(r[`lineColor` + i], 20)));
    for (let e = 0; e < r.THEME_COLOR_LIMIT; e++) {
      let t = `` + (a === `neo` ? Math.max(10 - (e - 1) * 2, 2) : 17 - 3 * e);
      o += `
    ...
    [data-look="neo"].mindmap-node.section-${e - 1} rect, [data-look="neo"].mindmap-node.section-${e - 1} path, [data-look="neo"].mindmap-node.section-${e - 1} circle, [data-look="neo"].mindmap-node.section-${e - 1} polygon {
      fill: ${i === `redux` || i === `redux-dark` || i === `neutral` ? r.mainBkg : r[`cScale` + e]};
      stroke: ${i === `redux` || i === `redux-dark` ? r.nodeBorder : r[`cScale` + e]};
      stroke-width: ${r.strokeWidth ?? 2}px;
    }
    [data-look="neo"].section-edge-${e - 1}{
      stroke: ${i?.includes(`redux`) || i === `neo-dark` ? r.nodeBorder : r[`cScale` + e]};
    }
    [data-look="neo"].mindmap-node.section-${e - 1} text {
     fill: ${i === `redux` || i === `redux-dark` ? r.nodeBorder : r[`cScaleLabel` + (i === `neutral` ? 1 : e)]};
    }
    `;
    }
    return o;
...
export { C as diagram };
//# sourceMappingURL=mindmap-definition-QFDTVHPH-CeeqgugY.js.map
