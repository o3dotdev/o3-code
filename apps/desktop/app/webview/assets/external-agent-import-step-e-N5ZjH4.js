...
import { gr as t } from "./src-BLHmAhbF.js";
import {
  Qi as n,
  Ta as r,
  qi as i,
...
import { a as S, o as C, r as w } from "./config-queries-2cSUtzNR.js";
import { i as T, k as E, m as D, n as O } from "./sidebar-signals-oDf-ZfE3.js";
import { t as k } from "./tooltip-Bb9X8NK-.js";
import { t as A } from "./button-BynxeNRW.js";
import { t as j } from "./spinner-avFWYgza.js";
import { t as M } from "./apps-RXjrknWx.js";
import { t as N } from "./use-plugins-C8ZDLcLG.js";
import { t as P } from "./check-circle-filled-UUaZP5xU.js";
import { t as F } from "./terminal-CNbIwMET.js";
import { t as I } from "./info-B8KL--OU.js";
import {
  a as ee,
  d as te,
  i as ne,
...
import { t as z } from "./use-skills-CbLuUp1e.js";
import { t as ae } from "./skills-DDrC9ydQ.js";
import { n as oe, t as B } from "./json-DAjHKBV7.js";
import { t as se } from "./settings.cog-CViPO9-c.js";
import { t as ce } from "./sortBy-B7Ruh_AG.js";
import { t as V } from "./toggle-BXF5Uzow.js";
import { s as le } from "./permissions-mode-visibility-D0xNYQIz.js";
import { t as ue } from "./folders-BO-L3yo5.js";
import { t as H } from "./checkbox-DwnO99Gj.js";
import { t as de } from "./hooks-B5S4lAt0.js";
import { t as fe } from "./codex-app-ga-logo-DAVK7PE_.js";
import { n as pe, r as U } from "./onboarding-shell-Dy7v8Sj3.js";
var me = e(ce(), 1);
function he(e, t) {
  switch (t.itemType) {
    case `AGENTS_MD`:
...
function Te(e) {
  ...
  t[14] !== f || t[15] !== h
    ? ((E = f
        ? (0, q.jsx)(ee, {
            children: (0, q.jsx)(ne, {
              title: (0, q.jsx)(te, { className: `contents`, children: h }),
...
function Ee(e) {
  ...
  t[10] !== i || t[11] !== r || t[12] !== f
    ? ((p = (0, q.jsx)(V, { checked: r, ariaLabel: f, onChange: i })),
      (t[10] = i),
      (t[11] = r),
      (t[12] = f),
      (t[13] = p))
                ...
                (0, q.jsxs)(`label`, {
                  ...
                  children: [
                    (0, q.jsx)(`div`, {
                      ...
                      children: (0, q.jsx)(ke, { icon: e.icon }),
                    }),
                    (0, q.jsxs)(`div`, {
    ...
    case `settings`: {
      ...
      return (
        t[1] === Symbol.for(`react.memo_cache_sentinel`)
          ? ((e = (0, q.jsx)(B, { className: `icon-base` })), (t[1] = e))
          : (e = t[1]),
        e
      );
    }
    ...
    case `chats`: {
      ...
      return (
        t[5] === Symbol.for(`react.memo_cache_sentinel`)
          ? ((e = (0, q.jsx)(Y, { className: `icon-base` })), (t[5] = e))
          : (e = t[5]),
        e
      );
    }
    ...
    case `agents`: {
      ...
      return (
        t[8] === Symbol.for(`react.memo_cache_sentinel`)
          ? ((e = (0, q.jsx)(le, { className: `icon-base` })), (t[8] = e))
          : (e = t[8]),
        e
      );
    }
...
async function je({
  ...
  try {
    ...
    return (
      l.warning(`Failed to add imported project roots after import`, {
        safe: { hostId: e },
        sensitive: { error: t },
      }),
      []
...
async function Me({ hostId: e, projectRoots: t }) {
  ...
  let n = await _(`paths-exist`, { params: { hostId: e, paths: t } }),
...
async function Ne(e) {
  let t = (
    await Promise.allSettled(
      [...e].reverse().map(
        async (e) => (
          await _(`add-workspace-root-option`, {
  ...
  t.length > 0 &&
    l.warning(`Failed to add some imported project roots after import`, {
      safe: { failedRootCount: t.length, totalRootCount: e.length },
      sensitive: { errors: t.map((e) => e.reason) },
    });
}
function Pe(e = r) {
  return a(`refresh-recent-conversations-for-host`, { hostId: e });
}
async function Fe(e) {
  try {
    await e();
  } catch (e) {
    l.warning(`Failed to refresh recent conversations after import`, {
      safe: {},
      sensitive: { error: e },
    });
  }
...
function Le({ model: e, selection: t }) {
  let n = e.projectItems.some((e, n) =>
      Object.prototype.hasOwnProperty.call(t, Re(e, n)),
    ),
    r = X(e).filter((e) => t[e.key] ?? !1);
  return [
    ...r
...
async function Ve(e) {
  await Promise.all([
    ...
    e.invalidateQueries({ queryKey: z }),
...
function He({ items: e, surface: t }) {
  l.info(`external_agent_import_user_flow_started`, {
    safe: { surface: t, ...Ge(e) },
  });
}
function Ue({
  ...
  let c = {
    ...
    projectRootsReturnedCount: i,
    remainingArtifactsCount: a,
    ...(n == null ? {} : { failedStage: n, failureKind: We(n) }),
    ...Ge(r),
  };
  if (o === `success`) {
    l.info(`external_agent_import_user_flow_finished`, { safe: c });
    return;
  }
  l.warning(`external_agent_import_user_flow_finished`, {
    safe: c,
    sensitive: { error: t },
  });
}
...
async function Ke({
  ...
  return _(`external-agent-import-detect`, {
    params: {
      hostId: e,
      includeHome: t,
      providers: r ?? Je(n),
...
async function qe({ hostId: e, items: t }) {
  return t.length === 0
    ? { projectRoots: [] }
    : _(`external-agent-import-import`, { params: { hostId: e, items: t } });
}
function Je(e) {
...
function Ze(e) {
  let t = (0, J.c)(42),
    ...
    c;
  t[0] !== s || t[1] !== a || t[2] !== o
    ? ((c = [`external-agent-config`, `import-model`, `detected`, s, a, o]),
      (t[0] = s),
      (t[1] = a),
      (t[2] = o),
      (t[3] = c))
  ...
  let d = p(u),
    f = d.data?.items ?? Ye,
    m = d.data?.unsupportedProjects ?? Xe,
    h;
  t[12] === f ? (h = t[13]) : ((h = f.filter($e)), (t[12] = f), (t[13] = h));
  let g = h,
    _;
  t[14] === f ? (_ = t[15]) : ((_ = f.filter(Qe)), (t[14] = f), (t[15] = _));
  let v = _,
    b;
  t[16] !== g || t[17] !== v
    ? ((b = Ie({ homeItems: g, projectItems: v })),
      (t[16] = g),
      (t[17] = v),
      (t[18] = b))
    : (b = t[18]);
  ...
  t[19] === x
    ? (S = t[20])
    : ((S = x == null ? [] : X(x)), (t[19] = x), (t[20] = S));
  let C = S,
    w = n && d.isLoading,
    T;
  t[21] === x
    ? (T = t[22])
    : ((T = (e) => (x == null ? [] : Le({ model: x, selection: e }))),
      (t[21] = x),
      (t[22] = T));
  let E = T,
    D;
  t[23] === s
    ? (D = t[24])
    : ((D = { mutationFn: (e) => qe({ hostId: s, items: e }) }),
      (t[23] = s),
      (t[24] = D));
  let O = y(D),
    k = x != null || m.length > 0,
  ...
  t[28] === d
    ? (M = t[29])
    : ((M = async () => (await d.refetch()).data?.items ?? Ye),
      (t[28] = d),
      (t[29] = M));
  let N;
  return (
...
var et = [`claude-code`, `claude-cowork`],
  tt = 6;
function nt({ enabled: e, isCoworkMigrationEnabled: t }) {
  let n = g(f),
    i = m(),
    o = d(),
    s = h(O),
    {
      ...
      isDetecting: y,
      isImporting: b,
    } = Ze({ enabled: e, isCoworkMigrationEnabled: t }),
    x = (0, K.useMemo)(
      () => rt({ detectedItems: c, isCoworkMigrationEnabled: t }),
      [c, t],
    ),
    S = (0, K.useMemo)(
      () => (e ? Z({ detectedItems: c, intl: i, providerIds: x }) : null),
      [c, e, i, x],
    );
  return {
    isLoading: e && y,
    isImporting: e && b,
    providerIds: x,
    shouldShowImportStep: e && S != null,
    summary: S,
    getSummaryForProviders: (e) =>
      Z({ detectedItems: c, intl: i, providerIds: e }),
    importSelection: async (t, d) => {
      if (!e || (d == null && !u)) return;
      let f = d == null ? S : Z({ detectedItems: c, intl: i, providerIds: d }),
        m =
          d == null
            ? l(t)
            : it({ detectedItems: c, providerIds: d, selection: t }),
        h = Date.now(),
        g = `import`,
        y = 0;
      He({ items: m, surface: `first_time_onboarding` });
      let b = f?.chatChoiceKey != null && t[f.chatChoiceKey];
      try {
        g = `import`;
        let { projectRoots: e } = d == null ? await _(t) : await p(m);
        ((y = e.length),
          ...
          await Ae({
            ...
            onImportedProjectRootsReady: (e) => {
              D(n, T({ collapsedGroups: s, importedProjectRoots: e }));
            },
            projectRoots: e,
            ...
            refreshRecentConversations: b
              ? () =>
                  a(`refresh-recent-conversations-for-host`, {
                    hostId: r,
                    sortKey: E,
                  })
              : void 0,
          ...
          await Promise.all([
            ...
            o.invalidateQueries({ queryKey: z }),
          ]),
          Ue({
            durationMs: Date.now() - h,
            items: m,
            projectRootsReturnedCount: y,
...
function rt({ detectedItems: e, isCoworkMigrationEnabled: t }) {
  return et.filter((n) =>
    n === `claude-cowork` && !t ? !1 : at(e, [n]) != null,
  );
}
function Z({ detectedItems: e, intl: t, providerIds: n }) {
  let r = at(e, n),
    i = r == null ? [] : X(r);
  return i.length === 0 ? null : ot(t, i);
}
function it({ detectedItems: e, providerIds: t, selection: n }) {
  let r = at(e, t);
  return r == null ? [] : Le({ model: r, selection: n });
}
function at(e, t) {
...
function ot(e, t) {
  let n = t.filter((e) => e.kind === `migrationItem`),
    ...
    a = vt([...(r?.items ?? []), ...(i?.items ?? [])]),
    o = ct(i, r, n),
    s = i == null ? void 0 : ht(e, i),
    c = n.map((t) => yt(e, t, `toolsAndSetup`));
  return (
    r != null &&
      r.count > 0 &&
      c.push({
        ...
        group: `projects`,
        icon: `projects`,
        ...(a.length === 0 ? {} : { tooltip: { text: Tt(e, a) } }),
      }),
    i != null &&
      i.count > 0 &&
      c.push({
...
function Q(e, t, n = ft(e)) {
  ...
  let o = Object.values(r).reduce((e, t) => e + t, 0),
    ...
    l = lt(e, t, c, s),
    u = ut(`claude-code`, e, t, c, s),
    d = ut(`claude-cowork`, e, t, c, s);
  return {
    ...r,
...
function ct(e, t, n) {
  let r = e?.items ?? [],
    i = [...(t?.items ?? []), ...r];
  return et.flatMap((e) => {
    let t = vt(i.filter((t) => t.providerId === e)).length,
      a = dt(r.filter((t) => t.providerId === e)),
...
function gt(e, t) {
  return [...new Set(t.map((e) => e.providerId))].map((t) => _t(e, t));
}
function _t(e, t) {
  switch (t) {
    case `claude-code`:
...
function bt(e, t) {
  ...
  let r = Ct(t);
  if (r.length > 0) return { tooltip: { text: Tt(e, r) } };
  let i = St(e, t);
...
function $({ count: e, fallback: t, formatCount: n }) {
  return e > 0 ? n(e) : t;
}
function Ct(e) {
  switch (e.itemType) {
...
function Nt({
  ...
  let y = m(),
    [b, x] = (0, K.useState)(() => st(p)),
    [S, C] = (0, K.useState)(!1),
    [w, T] = (0, K.useState)(() => new Set(p.customizeItems.map((e) => e.id))),
    E = l === `dialog`,
    D = i || r,
    O = i || r,
    k = Ht({ summary: p, selection: b }),
    j = Vt({ items: p.customizeItems, selection: b, group: `toolsAndSetup` }),
    M = Vt({ items: p.customizeItems, selection: b, group: `projects` }),
    N = p.chatChoiceKey != null && (b[p.chatChoiceKey] ?? !1),
    P = Lt({ isComplete: r, isSelected: j !== !1 }),
    F = Lt({ isComplete: r, isSelected: M !== !1 }),
    I = Lt({ isComplete: r, isSelected: N }),
    L = (e) => {
      _?.({ source: n, ...e });
    };
  (0, K.useEffect)(() => {
    a && L({ action: `shown`, ...Q(p, b, f) });
  }, []);
  let z = () => {
      (h?.(), C(!0));
    },
    ae = () => {
      i || !k || (r || L({ action: `continue`, ...Q(p, b, f) }), g(b));
    },
    oe = () => {
      D || (L({ action: `skipped`, ...Q(p, b, f) }), v());
    },
    B = i
      ? (0, q.jsx)(u, {
    ...
    H = (0, q.jsxs)(q.Fragment, {
      children: [
        E
          ? (0, q.jsx)(ee, {
              children: (0, q.jsx)(ne, {
                title: (0, q.jsx)(te, { className: `contents`, children: ce }),
                  ...
                  children: [
                    p.toolsAndSetupCount > 0
                      ? (0, q.jsx)(U, {
                          ...
                          checked: j,
                          control: O ? (0, q.jsx)(It, { status: P }) : void 0,
                          disabled: D,
                          leadingContent: (0, q.jsx)(se, {
                            className: `icon-base`,
                          }),
                          label: (0, q.jsx)(u, {
                    ...
                    p.projectCount > 0
                      ? (0, q.jsx)(U, {
                          ...
                          checked: M,
                          control: O ? (0, q.jsx)(It, { status: F }) : void 0,
                          disabled: D,
                    ...
                    p.recentChatCount > 0
                      ? (0, q.jsx)(U, {
                          ...
                          checked: N,
                          control: O ? (0, q.jsx)(It, { status: I }) : void 0,
                          disabled: D || p.chatChoiceKey == null,
                          leadingContent: (0, q.jsx)(Y, {
                            className: `icon-base`,
                          }),
                          label: (0, q.jsx)(u, {
...
function Lt({ isComplete: e, isSelected: t }) {
...
function Ut({ current: e, items: t, selectedItemIds: n }) {
  let r = { ...e };
  return (
    t.forEach((e) => {
      r[e.id] = n.has(e.id);
...
function Wt({ current: e, items: t, group: n, checked: r }) {
  let i = new Set(e);
  return (
    t
      .filter((e) => e.group === n)
...
function Gt({ current: e, items: t, group: n, checked: r }) {
  let i = { ...e };
  return (
    t
      .filter((e) => e.group === n)
...
//# sourceMappingURL=external-agent-import-step-e-N5ZjH4.js.map
