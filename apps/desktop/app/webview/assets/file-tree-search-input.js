...
import { Fa as t } from "./app-server-manager-signals-DkRDRgNB.js";
...
import { t as m } from "./x-C_RDKBp5.js";
...
import { t as x } from "./copy-to-clipboard-C2Mq2hN-.js";
import { t as S } from "./open-target-context-menu-items.js";
import { n as C, r as ee } from "./open-target-selection.js";
import { n as te, t as w } from "./use-target-apps.js";
...
function re(e, t, n) {
  ...
  return r == null && i == null
    ? null
    : (0, P.jsxs)(P.Fragment, { children: [r, i] });
}
function ie(e, t) {
...
function H(e, t) {
  if (typeof e == `number`)
    return { itemHeight: t ?? _t.default.itemHeight, factor: e };
  let n = _t[e ?? `default`];
  ...
  if ((customElements.define(T, e), typeof document < `u`))
    for (let e of Array.from(document.querySelectorAll(T)))
      e instanceof HTMLElement &&
        Ot(e, e.shadowRoot ?? e.attachShadow({ mode: `open` }));
}
var At = 5,
  jt = 1 << At,
  Mt = jt * 4;
...
function sn(e) {
  ...
  for (; r < e.length; ) {
    ...
    let i = 0;
    for (; r < e.length && on(e.charCodeAt(r)); )
...
function Cn() {
  ...
  return (
    e.set(Sn, 0),
    { idByValue: e, valueById: [Sn], sortKeyById: [cn(Sn)] }
  );
}
function wn(e, t) {
...
function zn(e) {
  let t = e;
  return (t[En] === `presorted` && t.presortedPaths != null) ||
    Pn(t.presortedPaths)
    ? t.presortedPaths
    : null;
}
...
function Vn(e, t = {}) {
  ...
  return (
    G(r, `store.preparePathEntries.sort`, () =>
      i.sort((e, t) => kn(e, t, n.sort)),
    ),
    i
  );
}
...
function Vr(e, t) {
  ...
  if (!U(n)) return [K(e, t)];
  if (q(e, t).childIds.length === 0)
    return W(n, 1) && !W(n, 2) ? [K(e, t)] : [];
  let r = [],
...
function Wr(e, t, n) {
  let r = wn(e.snapshot.segmentTable, n),
    i = q(e, t);
  if (Ft(e.snapshot.nodes, i).has(r))
    throw Error(`Path already exists: "${di(e, t, n)}"`);
  let a = J(e, t),
...
function Kr(e, t, n) {
  let r = q(e, t),
    i = J(e, n);
  (Ft(e.snapshot.nodes, r).set(i.nameId, n),
    Bt(r, n, i.subtreeNodeCount, i.visibleSubtreeCount));
  let a = Gr(e, r, n);
...
function Yr(e, t, n) {
  ...
  let o = un(
    _n(e.snapshot.segmentTable, r.nameId),
    _n(e.snapshot.segmentTable, i.nameId),
  );
  if (o !== 0) return o;
...
function Zr(e, t, n) {
  ...
  if (i != null) {
    ...
    if (U(t))
      return {
        basename: Tn(e.snapshot.segmentTable, r.nameId),
        existingNodeId: null,
        parentId: i,
      };
    let a = xn(n).segments;
...
function oi(e, t) {
  let n = J(e, t);
  if ((en(n, (t === e.snapshot.rootId ? -1 : Xt(J(e, n.parentId))) + 1), !U(n)))
    return;
  let r = q(e, t);
...
function ui(e, t, n, r) {
  ...
  if (r) {
    ...
    t == null
      ...
      : G(t, `store.recomputeNodeCounts.rebuildChildAggregates`, () =>
          zt(e.snapshot.nodes, i),
        );
  }
...
function Ei(e) {
  ...
  (G(e.instrumentation, `store.cleanup.stable.clearPathCaches`, () => Si(e)),
    G(e.instrumentation, `store.cleanup.stable.rebuildSegmentTable`, () =>
      Ci(e),
    ),
    G(e.instrumentation, `store.cleanup.stable.rebuildDirectoryIndexes`, () =>
      wi(e),
    ),
    G(
      e.instrumentation,
    ...
    G(e.instrumentation, `store.cleanup.stable.restoreExpansionOverrides`, () =>
      bi(e, t),
    ),
    G(e.instrumentation, `store.cleanup.stable.restoreDirectoryLoadInfos`, () =>
      xi(e, n),
    ),
    G(e.instrumentation, `store.cleanup.stable.recomputeCounts`, () =>
...
function zi(e, t = Mi(e)) {
  ...
  return n == null
    ? Zi(e, t)
    : G(n, `store.getVisibleTreeProjection`, () => Zi(e, t));
}
function Bi(e) {
  return Xi(zi(e));
}
function Vi(e, t) {
  let n = zr(e, t);
  if (n == null || n === e.snapshot.rootId || (U(J(e, n)) && Or(e, n) !== n))
    return null;
  let r = 0,
    i = n,
  ...
  let i = q(e, t),
    ...
    { childIndex: o, localVisibleIndex: s } =
      a == null
        ...
        : G(a, `store.getVisibleSlice.selectChildIndex`, () =>
            Vt(e.snapshot.nodes, i, n),
          ),
    c = i.childIds[o];
...
function Zi(e, t) {
  ...
  for (; d.length > 0 && s < t; ) {
    ...
    let x,
      S = _;
    if (U(v))
      ((S = f ? Or(e, _) : _), (x = S === _ ? `${b}${h[v.nameId]}/` : K(e, S)));
    else {
      let e = p.get(_);
...
var ra = class e {
  ...
  constructor(e = {}) {
    ...
    if (e.preparedInput != null) {
      ...
      e.presorted === !0
        ...
        : n.appendPreparedPaths(
            G(t, `store.preparePathEntries`, () => Vn(r, e)),
          );
    }
    let r = G(t, `store.builder.finish`, () =>
    ...
    ((e.initialExpandedPaths?.length ?? 0) > 0 &&
      G(t, `store.state.checkAllDirectoriesExpanded`, () =>
        this.hasAllDirectoriesExpanded(),
      ))
      ? G(t, `store.state.initializeOpenVisibleCounts`, () => ta(this.#e))
      : G(t, `store.state.recomputeCounts`, () =>
          Lr(this.#e, this.#e.snapshot.rootId),
        );
  }
  ...
  getVisibleCount() {
    return G(this.#e.instrumentation, `store.getVisibleCount`, () =>
      Mi(this.#e),
    );
  }
  getVisibleSlice(e, t) {
    return G(this.#e.instrumentation, `store.getVisibleSlice`, () =>
      Ri(this.#e, e, t),
    );
  }
  getVisibleRowContext(e) {
    return G(this.#e.instrumentation, `store.getVisibleRowContext`, () =>
      Li(this.#e, e),
    );
  }
  ...
  getVisibleIndex(e) {
    return G(this.#e.instrumentation, `store.getVisibleIndex`, () =>
      Vi(this.#e, e),
    );
  }
  getPathInfo(e) {
    ...
    return G(this.#e.instrumentation, `store.applyChildPatch`, () => {
      ...
      for (let e of t.operations) {
        ...
        switch (e.type) {
          ...
          case `remove`:
            a.push(
              hr(this.#e, t, Mr(this.#e, e.path, { recursive: e.recursive })),
            );
            break;
          case `move`: {
...
function ha(e, t) {
  ...
  for (let n of e)
    if (la(n) && (t.directoryPath === n || t.directoryPath.startsWith(n)))
      return !0;
  return !1;
}
function ga(e, t) {
...
var Wa = class {
    ...
    completeDrag() {
      ...
      if (ha(e.draggedPaths, t) || this.#r?.canDrop?.(n) === !1)
        return (this.#De(), !1);
    ...
    #Le(e) {
      ...
      let n = Ca(this.#c, e, !0),
        ...
        o = [...new Set(r)];
      return (
        Oa(this.#B, o) || ((this.#B = new Set(o)), (this.#V += 1)),
        (this.#z = a),
        n
      );
    }
...
function eo(e) {
  ...
  for (let [e, n] of Object.entries(t.byFileName ?? {}))
    r.set(e.toLowerCase(), n);
  let i = new Map();
  for (let [e, n] of Object.entries(t.byFileExtension ?? {})) i.set(Xa(e), n);
  let a = Object.entries(t.byFileNameContains ?? {}).map(([e, t]) => [
    e.toLowerCase(),
    t,
  ]);
  return {
    resolveIcon: (e, o) => {
      if (e === `file-tree-icon-file` && o != null) {
        ...
        let u = ht(t.set, n, l);
        if (u != null && t.set !== `none`)
          return { name: pt(u), remappedFrom: e, token: u };
      }
      let s = n?.[e];
...
function _o(e, t, n) {
  ...
  return (
    arguments.length > 2 &&
      (o.children = arguments.length > 3 ? mo.call(arguments, 2) : n),
    vo(e, o, r, i, null)
  );
}
...
function Co(e) {
  ((8 & e.__g || !(e.__g |= 8) || !no.push(e) || io++) &&
    ro == Y.debounceRendering) ||
...
function To(e, t, n, r, i, a, o, s, c, l, u, d) {
  ...
  for (c = Eo(n, t, y, c, b), f = 0; f < b; f++)
    (m = n.__k[f]) != null &&
      ...
      m.ref &&
        p.ref != m.ref &&
        (p.ref && Lo(p.ref, null, m), u.push(m.ref, m.__c || h, m)),
      g == null && h != null && (g = h),
...
function Do(e, t, n, r) {
  ...
  if (typeof e.type == `function`) {
    for (i = e.__k, a = 0; i && a < i.length; a++)
      i[a] && ((i[a].__ = e), (t = Do(i[a], t, n, r)));
    return t;
  }
  e.__e != t &&
    (r &&
      (t && e.type && !t.parentNode && (t = xo(e)),
  ...
  n: if (typeof A == `function`)
    try {
      ...
      if (((t.__v = null), c || a != null))
        if (e.then) {
          for (
            T = 0, E = !1, t.__u |= c ? 160 : 128, t.__c.__z = [], D = 0;
            D < a.length;
            D++
          )
            (O = a[D]) == null ||
...
function Ro(e, t, n) {
  ...
  if ((r = e.__k))
    for (i = 0; i < r.length; i++)
      r[i] && Ro(r[i], t, n || typeof e.type != `function`);
  (n || go(e.__e),
...
function gs(e, t) {
  let n = t.totalRowCount ?? e.length,
    ...
    b = cs(v)
      ? as
      : ss(Math.max(y, v.startIndex - a), Math.min(n - 1, v.endIndex + a)),
    x = ls(b, t.itemHeight);
  return {
    occlusion: {
...
function Cc(e, t) {
  ...
  return t
    ? { icon: { name: `file-tree-icon-dot`, width: 6, height: 6 }, title: ys }
    : null;
}
function wc(e, t, n) {
          ...
          ? (e) => {
              ...
              S &&
                ...
                w &&
                  ...
                  k(t, M, {
                    anchorRect: Pc(e.clientX, e.clientY),
                    source: `right-click`,
                  })));
            }
          : void 0,
...
function Xc({
  ...
  let Oe = $(null),
    ...
    Ie = (e, t) => {
      ((ke.current = null),
        (Ae.current = { path: e, viewportOffset: t }),
        (je.current = null));
    },
  ...
  let Ze = ec((e, t) => {
    ...
    Dt = ec(
      (e) =>
        Cs(e == null ? null : (te.current.get(e) ?? null)) ? !0 : Cs(S.current),
      [],
    ),
    Ot = ec(
      (e) => {
  ...
  let Nt = ec((e) => {
          ...
          if (t.isSearchOpen()) {
            ...
            ((re.current =
              B < 0 || e == null
                ...
                : Math.max(
                    0,
                    Math.min(B * s - e.scrollTop, Math.max(0, t - s)),
                  )),
              (F.current = !0));
          }
    ...
    U = (e) => {
      ...
      if (ot) {
        if (e.key === `Escape`)
          ((F.current = !1), (re.current = null), t.closeSearch());
        else if (e.key === `Enter`) {
    ...
    Qs(() => {
      ...
      switch (
        Ms({
          ...
          previousRenamingPath: P.current,
          renamingPath: it,
        })
      ) {
        case `reset`:
        ...
        case `reveal-canonical`:
          it != null &&
            It(it, { restoreTreeFocus: !1, targetOffset: `live-overlay` });
          return;
        case `ignore`:
          return;
        case `focus-input`:
          e != null &&
            ((Oe.current = null), (P.current = it), Cs(e), e.select());
          return;
      }
    ...
    Qs(() => {
      ...
      let e = S.current?.getRootNode(),
        ...
        n = (e) => {
          ...
          n instanceof Node &&
            (Mc(e) ||
              (_.current?.contains(n) !== !0 && t?.contains(n) !== !0 && Mt()));
        },
        r = (e) => {
    ...
    Qs(() => {
      ...
      if (ct != null && ct.id !== D.current) {
        ...
        if (r != null) {
          let t = h
            ? Math.max(
                0,
                Math.min(r.ancestorPaths.length * s, Math.max(0, H - s)),
              )
            : Ct;
      ...
      let O = !w && l && As(e, B, s, H, St, u),
        ...
        j =
          ...
          m != null &&
          m.path === z &&
          As(e, B, s, H, St, m.viewportOffset),
        ...
        i =
          n instanceof HTMLElement
            ...
            : r instanceof HTMLElement
              ...
              : null;
      (i != null && we((e) => (e === `pointer` ? e : `pointer`)),
        be((e) => (e === i ? e : i)));
    }, []),
    on = ec(() => {
      be(null);
  ...
  let sn = (e) => {
    ...
    hn =
      z != null && mn && !Tt && B >= 0
        ? (_t[B] ?? t.getVisibleRows(B, B)[0] ?? null)
        : null,
    ...
    vn =
      ...
      _n.index <= yt.end,
    yn =
      pt != null && _n != null && _n.path === pt && !vn && _n.path !== hn?.path
        ? _n
        : null,
    ...
    On = R?.anchorRect,
    kn =
      On == null && Tn != null && xe != null && (R != null || En) ? xe : null,
    An =
      On == null
        ? kn == null
          ? void 0
  ...
  for (var n in e) {
    ...
    if (r != null && r !== ``) {
      var i =
          n[0] == `-`
            ? n
            : gl[n] || (gl[n] = n.replace(vl, `-$&`).toLowerCase()),
        a = `;`;
...
function Sl(e, t, n) {
  if (!e.s) {
    ...
    if (n && n.then)
      return void n.then(Sl.bind(null, e, t), Sl.bind(null, e, 2));
    ((e.s = t), (e.v = n));
    let r = e.o;
    r && r(e);
  }
    ...
    r.getDerivedStateFromProps
      ...
      : i && n.componentWillMount
        ? (n.componentWillMount(),
          (n.state = n[al] === n.state ? n.state : n[al]))
...
function Fl(e, t, n, r, i, a, o) {
  ...
  var s = typeof e;
  if (s != `object`)
    return s == `function` ? jl : s == `string` ? hl(e) : e + jl;
  if (kl(e)) {
    var c,
      l = jl;
    i[rl] = e;
        ...
        try {
          ...
          return (
            h.getDerivedStateFromError &&
              (y[al] = h.getDerivedStateFromError(i)),
            y.componentDidCatch && y.componentDidCatch(i, Ol),
            pl(y)
              ? ((v = Pl(e, t)),
                (y = e[nl]).getChildContext != null &&
                  (t = Al({}, t, y.getChildContext())),
                Fl(
                  (v =
                    v != null &&
                    v.type === yo &&
  ...
  for (var j in g) {
    var M = g[j];
    if (
      typeof (M = Ll(M) ? M.value : M) != `function` ||
      j === `class` ||
      j === `className`
    ) {
      switch (j) {
        ...
        (k =
          !0 === M || M === jl
            ...
            : k +
              ...
              j +
              `="` +
              (typeof M == `string` ? hl(M) : M + jl) +
              `"`);
    }
  }
  if (ol.test(h))
    throw Error(h + ` is not a valid HTML tag name in ` + k + `>`);
  if (
    (A ||
      (typeof O == `string`
        ? (A = hl(O))
...
function eu(e) {
  ...
  let ie = te(re),
    ae;
  n[3] === C ? (ae = n[4]) : ((ae = C.map(tu)), (n[3] = C), (n[4] = ae));
  let I = ae,
    se;
  if (n[5] !== r || n[6] !== C || n[7] !== M) {
    se = new Map();
    for (let e of C)
      typeof e != `string` &&
        se.set(e.displayPath, t(r ?? ``, e.path, M === `windows`));
    ((n[5] = r), (n[6] = C), (n[7] = M), (n[8] = se));
  } else se = n[8];
  let ce = se,
    le;
  n[9] !== i || n[10] !== c
    ? ((le = ru(c, i)), (n[9] = i), (n[10] = c), (n[11] = le))
    : (le = n[11]);
  let ue = le,
    de = (0, N.useRef)(null),
    fe;
  n[12] === l
    ? (fe = n[13])
    : ((fe = Array.from(l ?? [])), (n[12] = l), (n[13] = fe));
  ...
  n[14] === S
    ...
    : ((ve = () => {
        S?.({
          expandedPaths: pe.current,
          scrollTop: ge.current,
          selectedPath: _e.current,
        });
      }),
      (n[14] = S),
      (n[15] = ve));
  ...
  n[22] === D
    ? (we = n[23])
    : ((we = D == null ? void 0 : [D]), (n[22] = D), (n[23] = we));
  let Te;
  n[24] !== ue ||
  n[25] !== O ||
  n[26] !== Ce ||
  ...
  (n[32] !== l || n[33] !== L || n[34] !== E || n[35] !== I
    ? ((R = () => {
        ...
        (t != null &&
          ...
          (pe.current = e),
          (he.current = null),
          L.resetPaths(I, { initialExpandedPaths: l }));
      }),
      (Ee = [l, L, E, I]),
      (n[32] = l),
      (n[33] = L),
    ...
    ? ((De = () => {
        let e = null,
          ...
          n = () => {
            ((e = null),
              !pu(L, k) &&
                (t >= $l || ((t += 1), (e = window.requestAnimationFrame(n)))));
          };
        return (
          k > 0 && !(A && D != null)
            ? ((ge.current = k), n())
...
function au({
  ...
  let a = d(`open-in-targets`, { cwd: e, hostId: n, path: i }),
    o = r.getQueryData(a),
...
function ou({ cwd: e, hostId: t, queryClient: n, targetPath: r }) {
  if (r != null)
    return n.prefetchQuery({
      gcTime: c.INFINITE,
      queryKey: d(`open-in-targets`, { cwd: e, hostId: t, path: r }),
      queryFn: () =>
        l(`open-in-targets`, { params: { cwd: e, hostId: t, path: r } }),
...
function hu(e) {
  ...
  t[4] === o
    ? (g = t[5])
    : ((g = (e) => o(e.target.value)), (t[4] = o), (t[5] = g));
  let _;
  t[6] === u
    ? (_ = t[7])
    : ((_ = u.formatMessage({
