...
import { t as n } from "./linear-DbofqmWv.js";
import {
  _ as r,
  a as i,
  c as a,
...
import { t as x } from "./src-BHeH9bp0.js";
import { n as S, t as C } from "./min-CV_SZUWE.js";
import { t as w } from "./dist-OQR0lEt7.js";
import { a as T, n as E, r as D } from "./chunk-AGHRB4JF-Dk9Dm4Nw.js";
import {
  B as O,
  C as k,
  V as A,
...
import { h as re } from "./chunk-5PVQY5BW-CnaqcI9r.js";
var ie = t((e, t) => {
    (function (n, r) {
...
ue.parser = ue;
var de = ue;
(R.default.extend(oe.default),
  R.default.extend(se.default),
  R.default.extend(ce.default));
var fe = { friday: 5, saturday: 6 },
  ...
  Xe = E(function (e, t, n, r) {
    if (!n.length || e.manualEndTime) return;
    let i;
    ((i =
      e.startTime instanceof Date
        ? (0, R.default)(e.startTime)
        : (0, R.default)(e.startTime, t, !0)),
      (i = i.add(1, `d`)));
    let a;
    a =
      e.endTime instanceof Date
        ? (0, R.default)(e.endTime)
        : (0, R.default)(e.endTime, t, !0);
    let [o, s] = Ze(i, a, t, n, r);
    ((e.endTime = o.toDate()), (e.renderEndTime = s));
  }, `checkTaskDates`),
  Ze = E(function (e, t, n, r, i) {
    let a = !1,
      o = null;
    for (; e <= t; )
      (a || (o = t.toDate()),
  ...
  tt = 0,
  Y = E(function (e) {
    return e === void 0 ? ((tt += 1), `task` + tt) : e;
  }, `parseId`),
  nt = E(function (e, t) {
    let n;
    ...
    switch (r.length) {
      case 1:
        ...
        break;
      case 2:
        ((i.id = Y()), (i.startTime = Qe(void 0, z, r[0])), (a = r[1]));
        break;
      case 3:
        ((i.id = Y(r[0])), (i.startTime = Qe(void 0, z, r[1])), (a = r[2]));
        break;
      default:
    }
    return (
      a &&
        ((i.endTime = et(i.startTime, z, a, q)),
        (i.manualEndTime = (0, R.default)(a, `YYYY-MM-DD`, !0).isValid()),
        Xe(i, z, V, B)),
      i
    );
  }, `compileData`),
    ...
    let e = E(function (e) {
        ...
        switch (Z[e].raw.startTime.type) {
          case `prevTaskEnd`:
            ...
            break;
          case `getStartDate`:
            ((n = Qe(void 0, z, Z[e].raw.startTime.startData)),
              n && (Z[e].startTime = n));
            break;
        }
        return (
          Z[e].startTime &&
            ((Z[e].endTime = et(Z[e].startTime, z, Z[e].raw.endTime.data, q)),
            Z[e].endTime &&
              ((Z[e].processed = !0),
              (Z[e].manualEndTime = (0, R.default)(
  ...
  lt = E(function (e, t) {
    let n = t;
    (N().securityLevel !== `loose` && (n = (0, L.sanitizeUrl)(t)),
  ...
  pt = {
    ...
    setDateFormat: Ae,
    getDateFormat: Le,
    enableInclusiveEndDates: je,
    endDatesAreInclusive: Me,
    enableTopAxis: Ne,
    topAxisEnabled: Pe,
    setAxisFormat: we,
    getAxisFormat: Te,
...
(E(mt, `getTaskTags`), R.default.extend(le.default));
var ht = E(function () {
  ...
  yt = {
    ...
    renderer: {
      setConf: ht,
      draw: E(function (e, t, a, o) {
        let s = N().gantt;
        o.db.setDiagramId(t);
        let d = N().securityLevel,
          m;
        d === `sandbox` && (m = x(`#i` + t));
        let _ = x(d === `sandbox` ? m.nodes()[0].contentDocument.body : `body`),
          y = d === `sandbox` ? m.nodes()[0].contentDocument : document,
          w = y.getElementById(t);
        ...
        function P(e, t, r) {
          let i = s.barHeight,
            ...
            u = n()
              ...
              .range([`#00B9FA`, `#F95002`])
              .interpolate(b);
          (ie(a, c, l, t, r, e, o.db.getExcludes(), o.db.getIncludes()),
            ae(l, c, t, r),
            re(e, a, c, l, i, u, t, r),
            I(a, c, l, i, u),
            L(l, c, t, r));
          ...
          if (
            ...
            d.filter(function (e) {
              ...
              var r = n.querySelector(`#` + CSS.escape(t + `-` + e.id)),
                i = n.querySelector(`#` + CSS.escape(t + `-` + e.id + `-text`));
              let a = r.parentNode;
        ...
        function ie(e, n, r, i, a, c, l, u) {
          ...
          for (let { startTime: e, endTime: t } of c)
            ((d === void 0 || e < d) && (d = e),
              (f === void 0 || t > f) && (f = t));
          if (!d || !f) return;
          if ((0, R.default)(f).diff((0, R.default)(d), `year`) > 5) {
            D.warn(
              `The difference between the min and max time is more than 5 years. This will cause performance issues. Skipping drawing exclude days.`,
            );
            return;
          }
          let p = o.db.getDateFormat(),
            m = [],
            h = null,
            g = (0, R.default)(d);
          for (; g.valueOf() <= f; )
            (o.db.isInvalidDate(g, p, l, u)
              ? h
                ? (h.end = g)
                : (h = { start: g, end: g })
              : (h &&= (m.push(h), null)),
          ...
          j.append(`g`)
            ...
            .attr(`height`, a - n - s.gridLineStartPadding)
        ...
        E(ie, `drawExcludeDays`);
        function F(e, t, n, r) {
          if (n <= 0 || e > t) return 1 / 0;
          let i = t - e,
            a = R.default.duration({ [r ?? `day`]: n }).asMilliseconds();
          return a <= 0 ? 1 / 0 : Math.ceil(i / a);
        }
        E(F, `getEstimatedTickCount`);
        function ae(e, t, n, a) {
          let d = o.db.getDateFormat(),
            m = o.db.getAxisFormat(),
            g;
          g = m || (d === `D` ? `%d` : (s.axisFormat ?? `%Y-%m-%d`));
          let _ = v(M)
              .tickSize(-a + t + s.gridLineStartPadding)
              .tickFormat(u(g)),
            y =
          ...
          if (y !== null) {
            ...
            if (isNaN(e) || e <= 0)
              ...
              if (p > vt)
                D.warn(
                  `The tick interval "${e}${t}" would generate ${p} ticks, which exceeds the maximum allowed (${vt}). This may indicate an invalid date or time range. Skipping custom tick interval.`,
                );
              else
                switch (t) {
                  case `millisecond`:
          ...
          j.append(`g`)
            ...
            .append(function (e) {
              let t = e[0].split(ne.lineBreakRegex),
                n = -(t.length - 1) / 2,
                r = y.createElementNS(`http://www.w3.org/2000/svg`, `text`);
              r.setAttribute(`dy`, n + `em`);
              for (let [e, n] of t.entries()) {
                let t = y.createElementNS(
