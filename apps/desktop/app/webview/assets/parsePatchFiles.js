import { C as e } from "./src-BLHmAhbF.js";
import { t } from "./preload-helper.js";
import { t as n } from "./chrome-theme.js";
var r = e.CODEX,
  i = [
    `editor.background`,
    `sideBar.background`,
  ...
  y = {
    "ayu-dark"() {
      return t(() => import(`./ayu-dark.js`), [], import.meta.url);
    },
    "catppuccin-latte"() {
      return t(() => import(`./catppuccin-latte.js`), [], import.meta.url);
    },
    "catppuccin-mocha"() {
      return t(() => import(`./catppuccin-mocha.js`), [], import.meta.url);
    },
    "dark-plus"() {
      return t(() => import(`./dark-plus.js`), [], import.meta.url);
    },
    dracula() {
      return t(() => import(`./dracula.js`), [], import.meta.url);
    },
    "everforest-dark"() {
      return t(() => import(`./everforest-dark.js`), [], import.meta.url);
    },
    "everforest-light"() {
      return t(() => import(`./everforest-light.js`), [], import.meta.url);
    },
    "github-dark-default"() {
      return t(() => import(`./github-dark-default-.js`), [], import.meta.url);
    },
    "github-light-default"() {
      return t(() => import(`./github-light-default.js`), [], import.meta.url);
    },
    "gruvbox-dark-medium"() {
      return t(() => import(`./gruvbox-dark-medium.js`), [], import.meta.url);
    },
    "gruvbox-light-medium"() {
      return t(() => import(`./gruvbox-light-medium.js`), [], import.meta.url);
    },
    "light-plus"() {
      return t(() => import(`./light-plus.js`), [], import.meta.url);
    },
    "material-theme-darker"() {
      return t(() => import(`./material-theme-darker.js`), [], import.meta.url);
    },
    monokai() {
      return t(() => import(`./monokai.js`), [], import.meta.url);
    },
    "night-owl"() {
      return t(() => import(`./night-owl.js`), [], import.meta.url);
    },
    nord() {
      return t(() => import(`./nord.js`), [], import.meta.url);
    },
    "one-dark-pro"() {
      return t(() => import(`./one-dark-pro.js`), [], import.meta.url);
    },
    "one-light"() {
      return t(() => import(`./one-light.js`), [], import.meta.url);
    },
    "rose-pine-dawn"() {
      return t(() => import(`./rose-pine-dawn.js`), [], import.meta.url);
    },
    "rose-pine-moon"() {
      return t(() => import(`./rose-pine-moon.js`), [], import.meta.url);
    },
    "solarized-dark"() {
      return t(() => import(`./solarized-dark.js`), [], import.meta.url);
    },
    "solarized-light"() {
      return t(() => import(`./solarized-light.js`), [], import.meta.url);
    },
    "tokyo-night"() {
      return t(() => import(`./tokyo-night.js`), [], import.meta.url);
    },
  },
  b = [
    ...
    O(e.ABSOLUTELY, `Absolutely`, {
      dark: {
        load: () =>
          t(() => import(`./absolutely-dark.js`), [], import.meta.url),
        name: `Absolutely Dark`,
      },
      light: {
        load: () =>
          t(() => import(`./absolutely-light.js`), [], import.meta.url),
        name: `Absolutely Light`,
      },
    }),
    O(e.CODEX, `Codex`, {
      dark: {
        load: () => t(() => import(`./codex-dark.js`), [], import.meta.url),
        name: `Codex Dark`,
      },
      light: {
        load: () => t(() => import(`./codex-light.js`), [], import.meta.url),
        name: `Codex Light`,
      },
    }),
    ...
    O(e.LINEAR, `Linear`, {
      dark: {
        load: () => t(() => import(`./linear-dark.js`), [], import.meta.url),
        name: `Linear Dark`,
      },
      light: {
        load: () => t(() => import(`./linear-light.js`), [], import.meta.url),
        name: `Linear Light`,
      },
    }),
    O(e.LOBSTER, `Lobster`, {
      dark: {
        load: () => t(() => import(`./lobster-dark.js`), [], import.meta.url),
        name: `Lobster Dark`,
      },
    }),
    ...
    O(e.MATRIX, `Matrix`, {
      dark: {
        load: () => t(() => import(`./matrix-dark-7.js`), [], import.meta.url),
        name: `Matrix Dark`,
      },
    }),
    ...
    O(e.NOTION, `Notion`, {
      dark: {
        load: () => t(() => import(`./notion-dark.js`), [], import.meta.url),
        name: `Notion Dark`,
      },
      light: {
        load: () => t(() => import(`./notion-light.js`), [], import.meta.url),
        name: `Notion Light`,
      },
    }),
    O(e.OSCURANGE, `Oscurange`, {
      dark: {
        load: () => t(() => import(`./oscurange.js`), [], import.meta.url),
        name: `Oscurange`,
      },
    }),
    ...
    O(e.PROOF, `Proof`, {
      light: {
        load: () => t(() => import(`./proof-light.js`), [], import.meta.url),
        name: `Proof Light`,
      },
    }),
    O(e.RAYCAST, `Raycast`, {
      dark: {
        load: () => t(() => import(`./raycast-dark.js`), [], import.meta.url),
        name: `Raycast Dark`,
      },
      light: {
        load: () => t(() => import(`./raycast-light.js`), [], import.meta.url),
        name: `Raycast Light`,
      },
    }),
    ...
    O(e.SENTRY, `Sentry`, {
      dark: {
        load: () => t(() => import(`./sentry-dark.js`), [], import.meta.url),
        name: `Sentry Dark`,
      },
    }),
    ...
    O(e.TEMPLE, `Temple`, {
      dark: {
        load: () => t(() => import(`./temple-dark.js`), [], import.meta.url),
        name: `Temple Dark`,
      },
    }),
    O(e.VERCEL, `Vercel`, {
      dark: {
        load: () => t(() => import(`./vercel-dark.js`), [], import.meta.url),
        name: `Vercel Dark`,
      },
      light: {
        load: () => t(() => import(`./vercel-light.js`), [], import.meta.url),
        name: `Vercel Light`,
      },
    }),
    ...
    O(e.XCODE, `Xcode`, {
      dark: {
        load: () => t(() => import(`./xcode-dark.js`), [], import.meta.url),
        name: `Xcode Dark`,
      },
      light: {
        load: () => t(() => import(`./xcode-light.js`), [], import.meta.url),
        name: `Xcode Light`,
      },
    }),
  ],
