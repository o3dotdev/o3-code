...
import { n as e, r as t, t as n } from "./chunk-AGHRB4JF-Dk9Dm4Nw.js";
import {
  B as r,
  C as i,
  V as a,
...
import { h as f } from "./chunk-5PVQY5BW-CnaqcI9r.js";
...
import { r as h, t as g } from "./chunk-336JU56O-CDWwHIND.js";
var _ = (function () {
  ...
  y = class {
    constructor() {
      ((this.relations = []),
        ...
        (this.getConfig = e(() => l().requirement, `getConfig`)),
        this.clear(),
...
`;
  ...
  S = {};
n(S, { draw: () => C });
var C = e(async function (e, n, r, i) {
    (t.info(`REF0:`), t.info(`Drawing requirement diagram (unified)`, n));
    let { securityLevel: a, state: o, layout: s, look: c } = l(),
      u = i.db.getData(),
      d = p(n, a);
    ((u.type = i.type),
      (u.layoutAlgorithm = g(s)),
      ...
      m(d, 8, `requirementDiagram`, o?.useMaxWidth ?? !0));
  }, `draw`),
  w = {
    parser: v,
    get db() {
...
export { w as diagram };
//# sourceMappingURL=requirementDiagram-MS252O5E-CBsbO7Zi.js.map
