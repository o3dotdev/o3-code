...
function t(e) {
  return e === `education` || e === `deprecated_edu`;
}
function n(e) {
  return e === `quorum`;
}
...
function i(t) {
  return (
    t === e.SELF_SERVE_BUSINESS_USAGE_BASED ||
    t === e.ENTERPRISE_CBP_USAGE_BASED
  );
}
export { r as n, i as r, e as t };
//# sourceMappingURL=skus-DzR5AEmU.js.map
