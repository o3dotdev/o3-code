...
import { N as t, dn as n, fn as r, ln as i } from "./src-BLHmAhbF.js";
import {
  Ca as a,
  Cn as o,
  Qi as s,
...
import { h as E } from "./chunk-LFPYN7LY-CkfOxD5s.js";
import "./product-logger-CekQ0CO0.js";
import "./statsig-BwN76nAo.js";
import "./use-global-state-DUocq5mo.js";
import { l as D } from "./thread-context-inputs-D4zJFWk0.js";
...
import { r as O } from "./toast-signal-mlbIRbst.js";
...
import { t as M } from "./use-codex-home-B1p9XqNi.js";
import { t as N } from "./use-os-info-Cetdxuhy.js";
...
import { n as ee, r as P } from "./open-project-setup-dialog-CAfG73Jf.js";
import "./check-md-I6RRy8DL.js";
import { t as F } from "./chevron-right-DcOUsgCQ.js";
import { t as I } from "./arrow-left-NB8jxLlJ.js";
import { l as L } from "./links-BkSjb4EC.js";
import "./local-task-row-signals-B48qfpuG.js";
import { u as R } from "./sidebar-project-group-signals--koPX1Ta.js";
...
import { r as te, t as ne } from "./dropdown-CLcC-0sa.js";
import { i as re, n as z, r as ie, t as B } from "./popover-CI4rtiLD.js";
import { t as ae } from "./trash-Ml_NiloR.js";
import { t as oe } from "./chevron-CEHg0DRl.js";
import { t as V } from "./worktree-Dn6TBOr7.js";
import { t as se } from "./folder-DnqvPFV1.js";
import "./settings.cog-CViPO9-c.js";
import { t as H } from "./code-snippet-DrPKGV4s.js";
...
import { t as U } from "./plus-PQBYSO-0.js";
import { t as ce } from "./get-project-name-D3LJ0iVD.js";
import { r as le, t as ue } from "./local-environments-DxGMrD53.js";
import "./sortBy-B7Ruh_AG.js";
import "./use-connected-remote-connections-CYxJx8ss.js";
import { i as W } from "./settings-shared-buyehiMO.js";
import { t as de } from "./settings-host-selection-B8-0dN0N.js";
import { t as fe } from "./settings-host-context-BX1MON7_.js";
import { t as pe } from "./checkbox-DwnO99Gj.js";
import { t as G } from "./settings-content-layout-B4F7ZmxE.js";
...
import { t as me } from "./segmented-toggle-Dy7On_GB.js";
import {
  a as he,
  c as ge,
  i as _e,
...
import { t as we } from "./useForm-B4EZCJg8.js";
var X = T(),
  Te = e(d(), 1);
function Ee(e, t) {
  let n = ce(e) ?? e;
...
function De(e) {
  ...
  t[5] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((l = (0, Z.jsx)(`span`, {
      ...
      (u = (0, Z.jsx)(F, { className: `icon-xs text-token-text-secondary` })),
      (t[5] = l),
      (t[6] = u))
    : ((l = t[5]), (u = t[6]));
  let d;
...
function Ae(e) {
  let t = (0, X.c)(20),
    ...
    i;
  t[0] !== r || t[1] !== n
    ? ((i = Ee(n, r)), (t[0] = r), (t[1] = n), (t[2] = i))
    : (i = t[2]);
  let a = i,
    o = r?.repositoryData?.rootFolder,
    s = o && o !== a ? `(${o})` : null,
    c = r?.isCodexWorktree ? V : se,
    l;
  t[3] === c
    ? (l = t[4])
    : ((l = (0, Z.jsx)(c, {
  ...
  t[5] === a
    ? (u = t[6])
    : ((u = (0, Z.jsx)(`span`, { className: `truncate`, children: a })),
      (t[5] = a),
      (t[6] = u));
  let d;
  t[7] === s
...
function je(e) {
  let n = (0, X.c)(59),
    ...
    P;
  n[0] !== ee || n[1] !== s
    ? ((P = t(s, ee)), (n[0] = ee), (n[1] = s), (n[2] = P))
    : (P = n[2]);
  let F = P,
    I = a(r),
    { data: L } = c(s, I, `local_environment_editor`),
    R;
  n[3] === I ? (R = n[4]) : ((R = o(I)), (n[3] = I), (n[4] = R));
  let re = R,
    z;
  n[5] !== L || n[6] !== re || n[7] !== D
    ? ((z = {
  ...
  n[28] !== s
    ? ((ue = {
        onSuccess: () => {
          (D.invalidateQueries({
            queryKey: w(`local-environment-config`, {
              configPath: f,
              hostId: r,
            }),
          }),
            D.invalidateQueries({
              queryKey: w(`local-environment`, { configPath: f, hostId: r }),
            }),
            D.invalidateQueries({
              queryKey: w(`local-environments`, {
                hostId: r,
                workspaceRoot: s,
              }),
            }),
      ...
      (n[29] = ue))
    : (ue = n[29]);
  let W = S(`local-environment-config-save`, ue),
    de;
  n[30] !== f || n[31] !== r || n[32] !== W || n[33] !== U
    ? ((de = (e) => {
        let { value: t } = e,
          n = Pe(t, U);
        t.name.length !== 0 && W.mutate({ configPath: f, hostId: r, raw: n });
      }),
      (n[30] = f),
      (n[31] = r),
      (n[32] = W),
  ...
  let fe;
  n[35] !== le || n[36] !== de
    ? ((fe = { defaultValues: le, onSubmit: de }),
      (n[35] = le),
      (n[36] = de),
      (n[37] = fe))
    : (fe = n[37]);
  ...
  n[51] !== s
    ? ((he = (e) => {
        ...
        let r = ve.map((e) => ({
          ...
          i = Re(j?.platform),
          a = ze(E),
          o = Fe({ values: t, isDirty: n, isSaving: W.isPending }),
          c = Ie(o),
          l = o != null,
          u = (e, n, r) => {
            if (n === `default`) {
...
function He(e) {
  ...
  let d = u,
    ...
    x = m.length > 0 || g.length > 0 || _.length > 0,
    S = v.length > 0 || y.length > 0 || b.length > 0,
    C;
                      ...
                      ? (0, Z.jsxs)(`div`, {
                          ...
                          children: [
                            ...
                            m.length > 0
                              ...
                              : null,
                            g.length > 0
                              ? (0, Z.jsx)(Ge, { platform: `linux`, script: g })
                              : null,
                            _.length > 0
                              ? (0, Z.jsx)(Ge, { platform: `win32`, script: _ })
                              : null,
                          ],
                        })
                      : null,
                      ...
                      ? (0, Z.jsxs)(`div`, {
                          ...
                          children: [
                            ...
                            v.length > 0
                              ...
                              : null,
                            y.length > 0
                              ? (0, Z.jsx)(Ge, { platform: `linux`, script: y })
                              : null,
                            b.length > 0
                              ? (0, Z.jsx)(Ge, { platform: `win32`, script: b })
                              : null,
                          ],
                        })
                      : null,
...
function qe(e) {
  ...
  t[5] === c
    ...
    : ((l = c.formatMessage({
      ...
      (t[6] = l));
  let u;
  if (t[7] !== n || t[8] !== r || t[9] !== o || t[10] !== s) {
    let e;
    (t[12] !== r || t[13] !== o || t[14] !== s
      ? ((e = (e) =>
          (0, Z.jsx)(
            Je,
            {
...
function Je(e) {
  let t = (0, X.c)(21),
    ...
    s;
  t[0] !== n.path || t[1] !== r
    ? ((s = { params: { hostId: r, workspaceRoot: n.path }, select: Ye }),
      (t[0] = n.path),
      (t[1] = r),
      (t[2] = s))
    : (s = t[2]);
  let { data: c, isLoading: l, error: u } = C(`local-environments`, s),
    d = c === void 0 ? [] : c,
    [f, m] = (0, Te.useState)(!1),
    { projectEnvironments: g, inheritedEnvironments: _ } = Qe(d, n.path),
    v = ue(g),
    b = n.isCodexWorktree ? V : se,
    x = n.repositoryData?.ownerRepo?.owner ?? null,
    S = l,
    w = u != null,
    T = g.length > 0 || _.length > 0,
    E;
  t[3] === o
    ? (E = t[4])
    : ((E = o.formatMessage({
  ...
  return (
    t[20] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((ne = (0, Z.jsx)(U, { className: `icon-xs` })), (t[20] = ne))
      : (ne = t[20]),
    (0, Z.jsxs)(q, {
      className: `p-0`,
      children: [
...
function Xe(e) {
  ...
  t[0] === n.configPath
    ? (o = t[1])
    : ((o = Ze(n.configPath)), (t[0] = n.configPath), (t[1] = o));
  let s = o,
    c =
      n.type === `success` &&
    ...
    m;
  t[2] !== f || t[3] !== p
    ? ((m = (0, Z.jsx)(`span`, { className: f, children: p })),
      (t[2] = f),
      (t[3] = p),
      (t[4] = m))
    : (m = t[4]);
...
function Qe(e, t) {
  let n = s(t),
    r = [],
    i = [];
  for (let t of e) $e(t.configPath) === n ? r.push(t) : i.push(t);
...
function et() {
  ...
  e[0] === t
    ? (n = e[1])
    : ((n = t.get(`workspaceRoot`)), (e[0] = t), (e[1] = n));
  let r = n,
    i;
  e[2] === t ? (i = e[3]) : ((i = t.get(`configPath`)), (e[2] = t), (e[3] = i));
  let a = i,
    o;
  e[4] === t ? (o = e[5]) : ((o = t.get(`mode`)), (e[4] = t), (e[5] = o));
  let s = o,
    { selectedHostId: c } = fe(),
    l;
  e[6] === c ? (l = e[7]) : ((l = { hostId: c }), (e[6] = c), (e[7] = l));
  let { data: u, isLoading: d } = g(D, l),
    f;
  e[8] === u?.roots
    ? (f = e[9])
    : ((f = u?.roots ?? []), (e[8] = u?.roots), (e[9] = f));
  let p = f,
    m = de(b(R), c),
    [_, v] = (0, Te.useState)(r),
    [y, x] = (0, Te.useState)(a),
    [S, w] = (0, Te.useState)(s === `edit`),
    T = _ ?? null,
    O;
  e[10] !== T || e[11] !== p
    ? ((O = T != null && p.includes(T) ? T : null),
      (e[10] = T),
      (e[11] = p),
      (e[12] = O))
    : (O = e[12]);
  let k = O,
    A = k == null ? null : (m.find((e) => e.path === k) ?? null),
    j = k == null,
    M;
  e[13] === c
    ? (M = e[14])
  ...
  let H = !j && k != null,
    U;
  e[34] === H ? (U = e[35]) : ((U = { enabled: H }), (e[34] = H), (e[35] = U));
  let ce;
  e[36] !== se || e[37] !== U
    ? ((ce = { params: se, queryConfig: U, select: tt }),
      (e[36] = se),
      (e[37] = U),
      (e[38] = ce))
    : (ce = e[38]);
  let { data: le, isLoading: W, error: pe } = C(`local-environments`, ce),
    G;
  e[39] === le
    ? (G = e[40])
    : ((G = le === void 0 ? [] : le), (e[39] = le), (e[40] = G));
  let K = G,
    me;
  e[41] === K ? (me = e[42]) : ((me = ue(K)), (e[41] = K), (e[42] = me));
  let he = y ?? me ?? null,
    ge = he ?? ``,
    _e;
  e[43] !== c || e[44] !== ge
    ? ((_e = { configPath: ge, hostId: c }),
      (e[43] = c),
      (e[44] = ge),
      (e[45] = _e))
    : (_e = e[45]);
  let ve = !j && k != null && he != null,
    ye;
  e[46] === ve
    ? (ye = e[47])
    : ((ye = { enabled: ve }), (e[46] = ve), (e[47] = ye));
  let be;
  e[48] !== _e || e[49] !== ye
    ? ((be = { params: _e, queryConfig: ye }),
      (e[48] = _e),
      (e[49] = ye),
      (e[50] = be))
    : (be = e[50]);
  let { data: Y, isLoading: xe, error: Se } = C(`local-environment-config`, be),
    Ce = Y?.configPath ?? ``,
    we;
  e[51] !== c || e[52] !== Ce
    ? ((we = { configPath: Ce, hostId: c }),
      (e[51] = c),
      (e[52] = Ce),
      (e[53] = we))
    : (we = e[53]);
  let Ee = !j && k != null && !!Y?.exists,
    Q;
  e[54] === Ee
    ? (Q = e[55])
    : ((Q = { enabled: Ee }), (e[54] = Ee), (e[55] = Q));
  let Oe;
  e[56] !== we || e[57] !== Q
    ? ((Oe = { params: we, queryConfig: Q }),
      (e[56] = we),
      (e[57] = Q),
      (e[58] = Oe))
    : (Oe = e[58]);
  let { data: ke, error: Ae, isLoading: Me } = C(`local-environment`, Oe),
    ...
    Ie;
  e[59] !== I || e[60] !== z || e[61] !== S || e[62] !== k || e[63] !== A
    ? ((Ie =
        k == null
          ? null
          : (0, Z.jsx)(De, {
  ...
  if (Le) {
    ...
    return (
      e[75] === $
        ? (r = e[76])
        : ((r = (0, Z.jsx)(nt, { backSlot: $, children: n })),
          (e[75] = $),
          (e[76] = r)),
      r
    );
  ...
  if (S) {
    ...
    return (
      e[91] !== $ || e[92] !== t
        ? ((n = (0, Z.jsx)(nt, { backSlot: $, children: t })),
          (e[91] = $),
          (e[92] = t),
          (e[93] = n))
        : (n = e[93]),
  ...
  return (
    e[102] !== $ || e[103] !== Re
      ? ((ze = (0, Z.jsx)(nt, { backSlot: $, children: Re })),
        (e[102] = $),
        (e[103] = Re),
        (e[104] = ze))
      : (ze = e[104]),
...
function nt(e) {
  let t = (0, X.c)(5),
    ...
    a;
  t[0] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((a = (0, Z.jsx)(W, { slug: `local-environments` })), (t[0] = a))
    : (a = t[0]);
  let o;
  return (
    t[1] !== n || t[2] !== i || t[3] !== r
...
export { et as LocalEnvironmentsSettings };
//# sourceMappingURL=local-environments-settings-page-DzYoaHUB.js.map
