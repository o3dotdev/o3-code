...
import { Cn as t, Gr as n, Hr as r, Kr as i } from "./src-DAzAmbVS.js";
import { n as a, t as o } from "./jsx-runtime-CiQ1k8xo.js";
import { _t as s } from "./setting-storage-EK1Te68s.js";
import {
  i as c,
  m as l,
  p as u,
  ...
  t as f,
  u as p,
} from "./automation-schedule-9oeon9DY.js";
e(a());
var m = o(),
  h = (e) =>
    (0, m.jsx)(`svg`, {
  ...
  g = 7;
function _({ intl: e, nextRunAt: t, status: n }) {
  return n === `PAUSED`
    ? `-`
    : t == null
      ? e.formatMessage({
      ...
      : v({ intl: e, timestamp: t });
}
function v({ intl: e, timestamp: t }) {
  let n = new Date(t),
    r = y(n, new Date()),
...
function S(e) {
  ...
  return (
    ...
    p(e.scheduleConfig) || r.push(`schedule`),
    {
      trimmedName: t,
      trimmedPrompt: n,
...
function C(e) {
  return !e.scheduleDirty && e.rawRrule ? e.rawRrule : f(e.scheduleConfig);
}
function w(e, t) {
  return {
    ...e,
...
var T = s(null),
  E = s(null),
  D = s(!1);
function O({ directiveKey: e, automation: t }) {
  return {
    directiveKey: e,
    mode: `view`,
    id: t.id,
...
function k(e, t) {
  ...
  return {
    ...
    status: e.status,
    cwds: n(e) ? [] : e.cwds,
    executionEnvironment: n(e) ? null : i(e.executionEnvironment),
    localEnvironmentConfigPath: n(e) ? null : e.localEnvironmentConfigPath,
    targetThreadId: n(e) ? e.targetThreadId : null,
    model: n(e) ? null : a.model,
    reasoningEffort: n(e) ? null : a.reasoningEffort,
    rawRrule: e.rrule,
    scheduleConfig: n(e) ? u(e.rrule) : l(e.rrule),
    scheduleDirty: !1,
  };
}
function A({ seed: e, targetAutomation: a, models: o }) {
  let s = e.mode === `view` ? a : null,
    c = s?.rrule ?? e.rrule,
    d = a == null ? null : r({ automation: a, models: o ?? [] }),
    f =
      e.id != null && a == null
        ? null
        : a != null && !n(a)
    ...
    p = a?.kind ?? e.kind ?? (e.id != null && a == null ? b.kind : `cron`),
    m =
      p === `heartbeat`
        ? (e.targetThreadId ?? (a != null && n(a) ? a.targetThreadId : null))
        : null;
  return {
    id: e.id ?? a?.id ?? null,
    kind: p,
    name: s?.name ?? e.name,
    prompt: s?.prompt ?? e.prompt,
    status: s?.status ?? e.status ?? a?.status ?? `ACTIVE`,
    cwds: a != null && !n(a) ? a.cwds : e.cwds.map(t),
    executionEnvironment:
      p === `heartbeat` ? null : (e.executionEnvironment ?? f),
    localEnvironmentConfigPath:
      p === `heartbeat`
        ? null
        : (e.localEnvironmentConfigPath ??
          (a != null && !n(a)
            ? a.localEnvironmentConfigPath
            : b.localEnvironmentConfigPath)),
    targetThreadId: m,
    model: p === `heartbeat` ? null : (e.model ?? d?.model ?? b.model),
    reasoningEffort:
      p === `heartbeat`
        ? null
        : (e.reasoningEffort ?? d?.reasoningEffort ?? b.reasoningEffort),
    rawRrule: c,
    scheduleConfig: p === `heartbeat` ? u(c) : l(c),
    scheduleDirty: !1,
  };
}
function j(e) {
...
function M(e, t) {
      ...
      : t === `cron` && e.kind === `heartbeat`
        ? {
            ...
            intervalHours: Math.max(
              1,
              Math.round((e.scheduleConfig.intervalMinutes ?? 60) / 60),
            ),
  ...
  return {
    ...
    kind: t,
    executionEnvironment:
      t === `cron` ? (e.executionEnvironment ?? `worktree`) : null,
...
function P({ allowThreadDestination: e }) {
...
function F(e, t) {
  return t === `thread`
    ...
    : {
        ...
        localEnvironmentConfigPath:
          t === `worktree` ? e.localEnvironmentConfigPath : null,
      };
}
function I(e, t) {
  let n = t;
  t.includes(x) &&
    (n = U(e.cwds) && t.length > 1 ? t.filter((e) => e !== x) : [x]);
...
function L({ draft: e, threadId: t, title: n }) {
  return {
    ...e,
...
function R(e) {
  return e.kind === `cron` && U(e.cwds);
}
function z({ draft: e, modelSettings: t }) {
  return e.kind === `heartbeat`
...
function B({ draft: e, name: t, prompt: n, status: r, rrule: i }) {
...
function V({ draft: e, name: t, prompt: n, rrule: r }) {
  if (e.kind === `heartbeat`) {
    if (e.targetThreadId == null)
      throw Error(`Heartbeat automation draft is incomplete`);
    return {
...
//# sourceMappingURL=automation-shared-9U9-pQH8.js.map
