...
import { H as a, W as o, p as s, xt as c } from "./setting-storage-EK1Te68s.js";
import "./window-zoom-context-BgcP82Wr.js";
import "./tooltip-DzyyaBl-.js";
import { t as l } from "./button-bq66r8jD.js";
...
import { n as u } from "./use-resize-observer-DyNosLxo.js";
import { t as d } from "./check-md-I6RRy8DL.js";
import "./chevron-right-DcOUsgCQ.js";
import "./search-CEAmgNrg.js";
import { r as f, t as p } from "./dropdown-PBHuhi3M.js";
import { t as m } from "./chevron-CEHg0DRl.js";
import { n as h, t as g } from "./rich-preview-primitives-CBd-xtTO.js";
var _ = c(),
  v = e(n(), 1),
  y = {
    A: `A`,
...
function b(e) {
  return y[e.toUpperCase()] ?? `X`;
}
function x(e) {
  return y[e.toUpperCase()] != null;
}
function S(e) {
  return {
    models: C(e)
...
function C(e) {
  ...
  if (!t.some((e) => e.slice(0, 6).trim() === `MODEL`))
    return [{ contents: e, modelNumber: 1, title: j(t) }];
  let n = [],
    r = [],
    i = null,
    a = 1,
  ...
  for (let e of t) {
    ...
    if (t === `MODEL`) {
      (i != null && r.push(i),
        (o = !0),
        (i = { lines: [e], modelNumber: P(e.slice(10, 14)) ?? a, title: null }),
        (a += 1));
      continue;
    }
    if (i == null) {
    ...
    (i.lines.push(e),
      i.title == null && t === `REMARK` && (i.title = M(e)),
...
function T(e) {
  ...
  return {
    atomName: i,
    bFactor: N(e.slice(60, 66)),
    chainId: e.slice(21, 22).trim() || ` `,
    element: e.slice(76, 78).trim() || A(i),
    insertionCode: e.slice(26, 27).trim() || ` `,
    isHetAtom: a === `HETATM`,
    residueName: e.slice(17, 20).trim(),
    residueNumber: P(e.slice(22, 26)) ?? 0,
    serial: P(e.slice(6, 11)),
    x: t,
    y: n,
    z: r,
  };
...
function E(e) {
  let t = new Map(),
    n = new Map();
  for (let r of e) {
    if (r.isHetAtom && !x(r.residueName)) continue;
    let e = D(r),
      i = n.get(e);
    if (i != null) {
...
function j(e) {
  for (let t of e) if (t.slice(0, 6).trim() === `REMARK`) return M(t);
  return null;
}
function M(e) {
...
function V(e) {
  let t = (0, _.c)(19),
    { className: n, fallback: r, hostId: a, path: o, showFileName: c } = e,
    l = c === void 0 ? !1 : c,
    u = o != null && o.length > 0,
    d = o ?? ``,
    f;
  t[0] === a
    ? (f = t[1])
    : ((f = a == null ? {} : { hostId: a }), (t[0] = a), (t[1] = f));
  let p;
  t[2] !== d || t[3] !== f
    ? ((p = { path: d, ...f }), (t[2] = d), (t[3] = f), (t[4] = p))
    : (p = t[4]);
  let m;
  t[5] === u ? (m = t[6]) : ((m = { enabled: u }), (t[5] = u), (t[6] = m));
  let h;
  t[7] !== p || t[8] !== m
    ? ((h = { params: p, queryConfig: m }), (t[7] = p), (t[8] = m), (t[9] = h))
    : (h = t[9]);
  let { data: v, isError: y, isLoading: b } = s(`read-file`, h);
  if (!u) return r;
  if (b) {
    let e;
    t[10] === n
    ...
    t[12] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((r = (0, F.jsx)(g, { className: `text-sm` })), (t[12] = r))
      : (r = t[12]);
    let a;
    return (
      t[13] === e
        ? (a = t[14])
        : ((a = (0, F.jsx)(`div`, { className: e, children: r })),
          (t[13] = e),
          (t[14] = a)),
      a
    );
  }
  if (y || v == null) return r;
  let x = l ? (o ?? void 0) : void 0,
    S;
  return (
    t[15] !== n || t[16] !== v.contents || t[17] !== x
      ? ((S = (0, F.jsx)(H, {
          className: n,
          contents: v.contents,
          filePath: x,
...
function H({ className: n, contents: r, filePath: i }) {
  let s = o(),
    ...
    z = R[_] ?? null,
    B = z?.contents ?? null,
    V = z?.residueChains ?? ee,
    H = V.find((e) => e.chainId === D) ?? V[0] ?? null,
    K = k?.modelIndex === _ ? k : null,
    J = (0, v.useMemo)(() => G(H, K), [H, K]),
    Y = (0, v.useMemo)(() => re(J), [J]),
    X = (0, v.useMemo)(() => G(H, N?.modelIndex === _ ? N : null), [_, H, N]),
    Z = (0, v.useMemo)(() => re(X), [X]);
  function Q(e) {
    ((L.current = e), A(e));
  }
  (0, v.useEffect)(() => {
  ...
  function se(e) {
    (O(e), Q(null), M(null), P(null));
  }
  function ce(e) {
    H != null &&
      (M(e),
      Q({ chainId: H.chainId, endIndex: e, modelIndex: _, startIndex: e }));
  }
  function le(e) {
    j == null ||
      H == null ||
      Q({
        chainId: H.chainId,
        endIndex: Math.max(j, e),
        modelIndex: _,
        startIndex: Math.min(j, e),
      });
  }
  function ue() {
    let e = L.current;
    (M(null), e != null && e.modelIndex === _ && P(e));
  }
  function de(e) {
    if (H == null) return;
    let t = { chainId: H.chainId, endIndex: e, modelIndex: _, startIndex: e };
    (M(null), Q(t), P(t));
  }
  function fe() {
    (Q(null), M(null), P(null), E((e) => e + 1));
  }
  return (
    (0, v.useEffect)(() => {
      ...
      return (
        ...
        (async () => {
          try {
            ...
            if (!n) return;
            let i = r(b, { backgroundColor: `white`, disableFog: !0 });
            ((I.current = i),
              i.addModel(B, `pdb`),
              W(i, null),
              i.zoomTo(),
            ...
            n && (q(b, I.current), (I.current = null), w(`error`));
          }
        })(),
        () => {
          ((n = !1), q(b, I.current), (I.current = null));
        }
      );
    }, [B, T, b]),
    (0, v.useEffect)(() => {
      let e = I.current;
      e == null || C !== `idle` || (W(e, Y), e.render());
    }, [Y, C]),
    (0, v.useEffect)(() => {
      let e = I.current;
      e == null ||
          ...
          children: [
                        ...
                        children: [
                          (0, F.jsx)(`span`, {
                            ...
                            children: s.formatMessage(
                              ...
                              { modelNumber: z.modelNumber },
                            ),
                          }),
                          (0, F.jsx)(m, { className: `icon-2xs opacity-65` }),
                        ],
                      }),
                      children: R.map((e, t) =>
                        (0, F.jsx)(
                  ...
                  children: [
                    (0, F.jsx)(`span`, {
                      children: (0, F.jsx)(a, {
                        ...
                        values: { count: z.stats.residueCount },
                      }),
                    }),
                    (0, F.jsx)(`span`, {
                      children: (0, F.jsx)(a, {
                        ...
                        values: { count: z.stats.atomCount },
                      }),
                    }),
                    (0, F.jsx)(`span`, {
                      children: (0, F.jsx)(a, {
                        ...
                        values: { mean: ae(z.stats.meanScore) },
                      }),
                    }),
                  ],
                }),
            ...
            H == null
              ...
              : (0, F.jsx)(ne, {
                  ...
                  onResidueSelectionMove: le,
                  onResidueSelectionSelect: de,
                  onResidueSelectionStart: ce,
                }),
            (0, F.jsxs)(`div`, {
              ...
              children: [
                ...
                C === `loading`
                  ? (0, F.jsx)(`div`, {
                      ...
                      children: (0, F.jsx)(g, { className: `text-sm` }),
                    })
                  : null,
                C === `error`
                  ? (0, F.jsx)(`div`, {
...
function te(e) {
  let t = (0, _.c)(8),
    { children: n, className: r, filePath: a } = e,
    o;
  t[0] === r
    ? (o = t[1])
    : ((o = i(`flex h-full min-h-0 flex-col bg-token-main-surface-primary`, r)),
      (t[0] = r),
      (t[1] = o));
  let s;
  t[2] === a
  ...
  return (
    t[4] !== n || t[5] !== o || t[6] !== s
      ? ((c = (0, F.jsxs)(`div`, { className: o, children: [s, n] })),
        (t[4] = n),
        (t[5] = o),
        (t[6] = s),
        (t[7] = c))
...
function ne(e) {
  let t = (0, _.c)(40),
    {
      chains: n,
      onChainChange: r,
      onResidueSelectionCommit: s,
      onResidueSelectionMove: c,
      onResidueSelectionSelect: u,
      onResidueSelectionStart: h,
      selectedChain: g,
      selectedRange: y,
      selectedResidues: b,
    } = e,
  ...
  let O = D,
    k;
  t[3] !== n || t[4] !== x || t[5] !== r || t[6] !== g.chainId
    ? ((k =
        n.length > 1
          ? (0, F.jsx)(p, {
              align: `start`,
  ...
  t[8] === g.residues.length
    ...
    : ((A = (0, F.jsx)(`span`, {
        ...
        children: (0, F.jsx)(a, {
          ...
          values: { count: g.residues.length },
        }),
      })),
      (t[8] = g.residues.length),
      (t[9] = A));
  ...
  t[20] === c
    ? (I = t[21])
    : ((I = (e) => {
        if (C.current !== e.pointerId) return;
        let t = E(document.elementFromPoint(e.clientX, e.clientY));
        t != null && c(t);
      }),
      (t[20] = c),
      (t[21] = I));
  let L;
  if (t[22] !== x || t[23] !== u || t[24] !== g.residues || t[25] !== w) {
    let e;
    (t[27] !== x || t[28] !== u || t[29] !== w
      ? ((e = (e, t) => {
          let n = w != null && t >= w.startIndex && t <= w.endIndex,
            r = n && t === w?.startIndex,
            a = n && t === w?.endIndex;
          return (0, F.jsx)(
            `button`,
            {
              ...
              className: i(
                ...
                r && `rounded-l-sm`,
                a && `rounded-r-sm`,
                r && a && `rounded-sm ring-1 ring-orange-300`,
              ),
              onKeyDown: (e) => {
                (e.key !== `Enter` && e.key !== ` `) ||
  ...
  let R;
  t[31] !== O || t[32] !== L || t[33] !== N || t[34] !== P || t[35] !== I
    ? ((R = (0, F.jsx)(`div`, {
        ref: S,
        "aria-label": N,
...
function U(e) {
  ...
  t[0] === r
    ? (a = t[1])
    : ((a = i(`h-2.5 w-2.5 rounded-sm`, r)), (t[0] = r), (t[1] = a));
  let o;
  t[2] === a
    ? (o = t[3])
    : ((o = (0, F.jsx)(`span`, { className: a })), (t[2] = a), (t[3] = o));
  let s;
  return (
    t[4] !== n || t[5] !== o
      ? ((s = (0, F.jsxs)(`span`, {
...
function W(e, t) {
  if (t == null) {
    (e.setStyle({}, I), e.addStyle({ hetflag: !1 }, L));
    return;
  }
  let n = { not: t };
  (e.setStyle(n, R),
    e.addStyle({ and: [n, { hetflag: !1 }] }, z),
    e.setStyle(t, B));
}
function G(e, t) {
...
function re(e) {
  ...
  return t.length > 0 ? { serial: t } : { or: e.map(K) };
}
function K(e) {
  return {
    chain: e.chainId,
...
export { H as PdbPreview, V as PdbPreviewFromFile };
//# sourceMappingURL=preview-CD2HWe-l.js.map
