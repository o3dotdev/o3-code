...
import { Ta as t } from "./app-server-manager-signals-Csopz8aM.js";
...
import { i as u } from "./app-server-manager-hooks-ZyucQ4vj.js";
import { t as d } from "./use-global-state-DjfvqpEA.js";
var f = l(),
  p = s(i, `is-copilot-api-available`, { staleTime: o.INFINITE });
function m() {
  let e = (0, f.c)(2),
    t = r(),
    n;
  return (
    e[0] === t
      ? (n = e[1])
      : ((n = () => {
          t.invalidateQueries({ queryKey: c(`is-copilot-api-available`) });
        }),
        (e[0] = t),
        (e[1] = n)),
    n
...
function x(e, t) {
        ...
        let t = !1,
          ...
          l = () => {
            w(e)
              ...
              .catch(() => {
                ((n = !0), s != null && clearTimeout(s), t || (c(!1), u(C)));
              });
          };
        (a &&
          (s = setTimeout(() => {
  ...
  return (
    n[11] !== l || n[12] !== s
      ? ((v = { isLoading: s, authState: l, setAuthMethod: _ }),
        (n[11] = l),
        (n[12] = s),
        (n[13] = v))
      : (v = n[13]),
...
function A(e) {
  ...
  let i = r === t,
    a = h(),
    { data: o, isLoading: s } = d(`use-copilot-auth-if-available`),
    c = i ? a : !1,
    l = i && !s ? (o ?? !1) : !1,
  ...
  n[2] !== c || n[3] !== l || n[4] !== u
    ? ((p = {
      ...
      (n[5] = p))
    : (p = n[5]);
  let { authState: m, isLoading: g, setAuthMethod: _ } = x(e, p);
  if (e == null) return null;
  let v;
  n[6] === m
    ? (v = n[7])
...
//# sourceMappingURL=use-auth-BI4R_D9h.js.map
