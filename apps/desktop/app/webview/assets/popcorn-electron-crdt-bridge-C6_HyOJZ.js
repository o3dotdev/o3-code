...
import { br as r } from "./comments-DhSPf1GR.js";
...
import { t as m } from "./react-dom-De86Q4ix.js";
import {
  a as h,
  c as g,
  l as _,
...
import { a as x, i as S, n as C, r as w } from "./dist-DscPxs-l.js";
import {
  _ as T,
  c as E,
  g as D,
...
function oe(e) {
  let { children: t, id: n, items: r, strategy: i = G, disabled: a = !1 } = e,
    {
      active: o,
      dragOverlay: s,
      droppableRects: c,
  ...
  return R.createElement(ae.Provider, { value: x }, t);
}
var se = (e) => {
  ...
  le = { duration: 200, easing: `ease` },
  ue = `transform`,
  de = M.Transition.toString({ property: ue, duration: 0, easing: `linear` }),
...
function me(e) {
  let {
    ...
    ie = re
      ...
      : null,
    W = V(f) && V(g) ? a({ id: o, items: u, activeIndex: f, overIndex: g }) : b,
    G = D?.id,
    K = (0, R.useRef)({ activeId: G, items: u, newIndex: W, containerId: d }),
    oe = u !== K.current.items,
    me = t({
      active: D,
      containerId: d,
      isDragging: I,
    ...
    q = pe({ disabled: !me, index: b, node: w, rect: C });
  return (
    (0, R.useEffect)(() => {
      (H && K.current.newIndex !== W && (K.current.newIndex = W),
        d !== K.current.containerId && (K.current.containerId = d),
        u !== K.current.items && (K.current.items = u));
    }, [H, W, d, u]),
    (0, R.useEffect)(() => {
      if (G === K.current.activeId) return;
      if (G != null && K.current.activeId == null) {
        K.current.activeId = G;
        return;
      }
      let e = setTimeout(() => {
        K.current.activeId = G;
  ...
  function ge() {
    if (q || (oe && K.current.newIndex === b)) return de;
    if (!((U && !A(j)) || !l) && (H || me))
      return M.Transition.toString({ ...l, property: ue });
  }
}
function he(e, t) {
...
var q = n();
function ge({ trigger: e, actions: t }) {
  return (0, q.jsxs)(ee, {
    children: [
      (0, q.jsx)(ne, { asChild: !0, children: e }),
      (0, q.jsx)(F, {
        children: (0, q.jsx)(te, {
...
function ke(e) {
  ...
  return {
    centerX: (n.x + r.x) / 2,
    centerY: (n.y + r.y) / 2,
    distance: Math.max(xe, Math.hypot(i, a)),
  };
}
var Ae = typeof window > `u` ? R.useEffect : R.useLayoutEffect;
function je(e) {
  switch (e.type) {
    case `workbook-range`:
...
function Le({
  ...
  let f = n ? 26 : 25,
    p = s != null || c != null || l != null || u != null || d != null,
    m = i(
      `absolute z-30 flex items-center justify-center border-0 bg-transparent p-0`,
      p ? `pointer-events-auto cursor-pointer` : `pointer-events-none`,
    ),
    h = {
      left: t.left,
      top: t.top,
      ...
      transform: r
        ...
        : `translate(-50%, -50%)`,
      background: `transparent ${Pe} center / contain no-repeat`,
    },
    g =
      e == null
        ? null
        : (0, q.jsx)(`span`, {
            className: `pointer-events-none text-[10px] font-bold leading-none text-white [transform:translate(-0.5px,-0.5px)]`,
            children: e,
          });
  return p
    ? (0, q.jsx)(`button`, {
...
function Re({
  ...
  fillOnly: r = !1,
  borderWidthPx: a = 2,
  borderColor: o = `#0285ff`,
  fillColor: s = `#128dff33`,
  shadow: c = !r,
  testId: l,
}) {
  return (0, q.jsx)(`div`, {
...
function He(e) {
  return Ve(e.flatMap((e) => e.points));
}
function Ue(e, { paddingPx: t = 24, minSizePx: n = 96 } = {}) {
  let r = e.width + t * 2,
    i = e.height + t * 2,
    a = Math.max(n, r),
    o = Math.max(n, i);
...
function Je({ stroke: e, projectPoint: t }) {
  let n = qe(e, t);
...
function Ye({ strokes: e, projectPoint: t, testId: n, clipBounds: r }) {
...
var Xe = 0;
function Ze(e) {
  return ((Xe += 1), `${e}-${Date.now().toString(36)}-${Xe.toString(36)}`);
}
function Qe({
  active: e,
  disabled: t = !1,
  ...
  return (0, q.jsx)(`button`, {
    ...
    type: `button`,
    "data-testid": o,
    "aria-label": e ? `${r} mode active` : `${r} mode`,
    "aria-pressed": e,
    disabled: t,
    className: i(
      `inline-flex h-7 min-w-7 appearance-none items-center overflow-hidden rounded-lg border-0 text-base leading-[18px] outline-none transition-[max-width,padding-inline,background-color,color] duration-200 ease-[cubic-bezier(0.32,0.72,0,1)] [will-change:max-width] motion-reduce:transition-none focus:outline-none focus-visible:outline-none focus:ring-0 focus-visible:ring-0 focus-visible:shadow-none`,
      `disabled:cursor-not-allowed disabled:opacity-100`,
      e ? `max-w-40 justify-start px-2` : `max-w-7 justify-center px-0`,
      e
        ? null
        : `bg-transparent text-token-description-foreground hover:bg-token-bg-tertiary`,
    ),
    style: e
      ? {
          backgroundColor: f,
    ...
    children: (0, q.jsxs)(`span`, {
      className: i(
        ...
        e ? `justify-start gap-1` : `w-full justify-center gap-0`,
      ),
      children: [
        a({
          className: i(
            `size-5 shrink-0 transition-transform duration-200 ease-[cubic-bezier(0.32,0.72,0,1)] motion-reduce:transition-none`,
            e ? `-translate-x-0.5` : `-translate-x-px`,
          ),
        }),
        (0, q.jsx)(`span`, {
          className: i(
            `min-w-0 overflow-hidden transition-[max-width] duration-200 ease-[cubic-bezier(0.32,0.72,0,1)] motion-reduce:transition-none`,
            e ? `max-w-32` : `max-w-0`,
          ),
          children: (0, q.jsx)(`span`, {
            className: i(
              `block whitespace-nowrap px-1 text-sm transition-[opacity,transform] duration-150 ease-[cubic-bezier(0.32,0.72,0,1)] motion-reduce:transition-opacity`,
              e ? `translate-x-0 opacity-100` : `-translate-x-1 opacity-0`,
            ),
            children: r,
          }),
        }),
...
var tt = e(m()),
  ...
  ut = `pointer-events-none absolute inset-x-0 top-0 flex flex-col overflow-visible bg-transparent`,
  dt = `pointer-events-auto relative w-full overflow-hidden rounded-[22px] bg-token-dropdown-background shadow-md ring-1 ring-token-border-light transition-[height] duration-150 ease-out motion-reduce:transition-none [background-color:var(--color-token-dropdown-background,var(--color-token-main-surface-primary,white))]`,
  ft = `absolute left-4 min-w-0 overflow-hidden transition-[width,top,bottom] duration-150 ease-out motion-reduce:transition-none`,
  pt = `absolute right-3 bottom-2 left-2 flex origin-bottom-left items-center transition-[opacity,transform] duration-150 ease-out motion-reduce:transition-none`,
  mt = `pointer-events-none absolute top-0 left-0 whitespace-pre text-[length:var(--codex-chat-font-size,13px)] leading-5 font-sans opacity-0`,
  ht = 28,
  gt = 8,
  _t = 16,
  vt = 8,
  ...
  xt = (0, R.forwardRef)(function (
    ...
    if (
      ...
      (0, R.useLayoutEffect)(() => {
        ...
        if (n) {
          ((e.style.height = `0px`),
            (e.style.height = `${Math.min(Math.max(e.scrollHeight, t * X), st)}px`));
          return;
        }
        e.style.height = `${X}px`;
      }, [k, T, r]),
    ...
    let B = (0, q.jsx)(`div`, {
      ...
      style: { position: te, left: ee ?? 0, top: ne ?? 0, width: nt },
      onMouseDown: (e) => {
        e.stopPropagation();
      },
                ...
                children: [
                  k
                    ? (0, q.jsx)(`button`, {
                        ...
                        onClick: d,
                        children: (0, q.jsx)(u, { className: `size-4` }),
                      })
                    : null,
                  (0, q.jsxs)(`div`, {
    ...
    return n ? (0, tt.createPortal)(B, n) : B;
  });
function St({
  text: e,
  hasMultipleBlocks: t,
  ...
  let a = Ct(r),
    o = wt(e, n);
  return a == null || o == null ? i.length >= yt : o + bt > a;
}
function Ct(e) {
...
function Mt(e) {
  let t = Math.min(Ot, Math.max(1, e.containerWidth - Z * 2)),
    n = Math.min(e.previewWidth ?? t, t),
    r = At / 2 + kt,
    i = jt(
      e.markerPoint.top - Et / 2,
      Z,
      Math.max(Z, e.containerHeight - Dt - Z),
    ),
    a = e.markerPoint.left + r;
  if (a + t <= e.containerWidth - Z) return { left: a, top: i, maxWidth: t };
  let o = e.markerPoint.left - r - t;
  if (o >= Z) return { left: o, top: i, maxWidth: t };
  let s = jt(
      e.markerPoint.left - n / 2,
      Z,
      Math.max(Z, e.containerWidth - n - Z),
    ),
    c = e.markerPoint.top + r;
  return c + Dt <= e.containerHeight - Z
    ? { left: s, top: c, maxWidth: t }
    : { left: s, top: Math.max(Z, e.markerPoint.top - r - Dt), maxWidth: t };
}
function Nt({
  body: e,
  markerPosition: t,
  ...
  return (0, q.jsx)(`div`, {
    ref: i,
    "data-testid": r,
    className: `pointer-events-none absolute z-40 flex items-center overflow-hidden rounded-[22px] px-4 shadow-md ring-1 ring-token-border-light [background:var(--color-token-dropdown-background,#fff)] [color:var(--color-token-foreground,rgb(38,38,38))]`,
    style: { ...s, height: Et, width: `fit-content` },
    children: (0, q.jsx)(`div`, {
      className: `min-w-0 overflow-hidden text-ellipsis whitespace-nowrap text-[13px] leading-6 text-inherit`,
...
function Pt(e) {
  let [t, n] = (0, R.useState)([]),
    r = (0, R.useCallback)((e) => {
      n((t) => t.filter((t) => t.annotationId !== e));
    }, []),
    i = (0, R.useCallback)(() => {
      n([]);
    }, []),
    ...
    o = (0, R.useCallback)((e, t) => {
      n((n) => n.map((n) => (n.annotationId === e ? { ...n, ...t } : n)));
    }, []);
  return (
    (0, R.useEffect)(() => {
      if (!e) return;
      let t = { dismissAnnotation: r, dismissAllAnnotations: i };
      return (
        (e.current = t),
        () => {
    ...
    {
      annotations: t,
      addPendingAnnotation: a,
      updatePendingAnnotation: o,
      dismissAnnotation: r,
      dismissAllAnnotations: i,
    }
  );
}
function Ft(e) {
...
function Bt(e) {
  ...
  return {
    visibleSize: n,
    halfVisibleSize: n / 2,
    hitRadius: Math.max(4, Lt / t),
    rotationBand: Math.max(6, Rt / t),
  };
}
function Vt(e) {
...
function Jt(e, t) {
  return Object.values(Gt(t)).every(
    (t) =>
      t.x >= e.left &&
      t.x <= e.left + e.width &&
      t.y >= e.top &&
...
function Xt(e, t, n) {
  if (Yt(e, t, n) || qt(e, t)) return !1;
  let r = Kt(e, t),
    { rotationBand: i } = Bt(n);
  return Math.abs(r.x) <= e.width / 2 + i && Math.abs(r.y) <= e.height / 2 + i;
}
var Zt = new Intl.DateTimeFormat(void 0, {
    dateStyle: `medium`,
    timeStyle: `short`,
  }),
  Qt = [`👍`, `❤️`, `👀`, `✅`],
  Q = `text-[length:var(--codex-chat-font-size,13px)] leading-5`,
  $t = `text-[11px] leading-4`;
function en(e) {
  if (!e) return ``;
  let t = new Date(e);
  return Number.isNaN(t.getTime()) ? `` : Zt.format(t);
}
function tn(e) {
  switch (e) {
    case `resolved`:
...
function nn({ open: e, onOpenChange: t, trigger: n, children: r }) {
  return (0, q.jsxs)(S, {
    open: e,
    onOpenChange: t,
    children: [
      (0, q.jsx)(x, { asChild: !0, children: n }),
      (0, q.jsx)(w, {
        children: (0, q.jsx)(C, {
          side: `bottom`,
          align: `end`,
...
function rn({ label: e, active: t, count: n, onClick: r, interactive: a }) {
  let o = i(
  ...
  return !a || !r
    ? (0, q.jsx)(`span`, { className: o, children: `${e} ${n}` })
    : (0, q.jsx)(`button`, {
        type: `button`,
        className: o,
        onClick: r,
...
function an({ value: e, onChange: t, onSubmit: n }) {
  let r = e.trim();
  return (0, q.jsxs)(`div`, {
                    ...
                    n
                      ? (0, q.jsx)(nn, {
                          ...
                          trigger: (0, q.jsx)(`button`, {
                            ...
                            children: (0, q.jsx)(l, { className: `size-4` }),
                          }),
                          children: (0, q.jsx)(`div`, {
...
function sn({
  ...
  let b = l && f != null,
    ...
    [O, k] = (0, R.useState)(``);
  (0, R.useEffect)(() => {
    E != null && !s.some((e) => e.id === E) && (D(null), k(``));
  }, [s, E]);
  let A = n === `resolved` ? [r, en(o)].filter(Boolean).join(` · `) : null;
  return (0, q.jsxs)(`div`, {
        ...
        children: [
          (0, q.jsxs)(`div`, {
            ...
            children: [
              ...
              A
                ? (0, q.jsx)(`div`, {
                    className: i(`text-token-description-foreground mt-1`, $t),
                    children: A,
                  })
                : null,
            ],
...
function cn({ open: e, onOpenChange: t, trigger: n, content: r }) {
  return (0, q.jsxs)(S, {
    open: e,
    onOpenChange: t,
    children: [
  ...
  let t =
      e.deltaMode === WheelEvent.DOM_DELTA_LINE
        ...
        : e.deltaMode === WheelEvent.DOM_DELTA_PAGE
          ...
          : ln,
    n = 2 ** (-e.deltaY * t * fn);
  return Math.max(pn, Math.min(mn, n));
}
function yn(e, t, n) {
...
var xn = class {
  ...
  #n = (e) => {
    ...
    if (e.ctrlKey) {
      let n = this.#a;
      if (!n) return;
      let r = Oe(n, e.clientX, e.clientY),
        i = vn(e),
        a = this.#p.k * i,
        o = this.#b(a);
      if (yn(this.#p.k, a, o)) return;
      let s =
        this.#i.screenToWorldPoint?.(this.#p, r.x, r.y) ?? J(this.#p, r.x, r.y);
  ...
  #r = (e) => {
    ...
    if (
      ...
      ((this.#o = null),
        ...
        (this.#s = !1),
        (this.#c = null),
        (this.#d = performance.now() + hn),
        this.#i.onCameraSettled?.(this.#p));
      return;
    }
    let n = Oe(t, e.clientX, e.clientY);
  ...
  zoomTo(e, t) {
    ...
    this.setCamera(we(this.#p, r, i, e, this.#i.minZoom, this.#i.maxZoom), {
      settled: t?.settled,
    });
  }
  panByScroll(e, t) {
  ...
  #y(e) {
    return this.#i.clampCamera
      ? this.#i.clampCamera({
          ...e,
          k: Se(e.k, this.#i.minZoom, this.#i.maxZoom),
        })
      : Te(
          { ...e, k: Se(e.k, this.#i.minZoom, this.#i.maxZoom) },
...
function Dn(e, t) {
  ...
  for (let n = 0; n < e.length; n += 1) {
    let r = e[n],
      i = t[n];
    if (!r || !i || !En(r, i)) return !1;
  }
  return !0;
}
function On(e) {
  let t = wn(e.externalCrdtUpdates);
  return (
    e.initialCrdtState &&
...
function Mn({ initialCrdtState: e, externalCrdtUpdates: t }) {
  let n = (0, R.useRef)(null);
  n.current ??= kn({ initialCrdtState: e, externalCrdtUpdates: t });
  let r = n.current;
  return {
    initialCrdtState: r.initialCrdtState,
    externalCrdtUpdates: An({ bootstrapState: r, updates: t }),
  };
}
function Nn({
  artifactLabel: e,
    ...
    (0, R.useEffect)(() => {
      ...
      return (
        (async () => {
          ...
          s(a >= Cn ? { kind: `restoring`, pendingUpdateCount: a } : null);
          try {
            let e = Tn(n, i.current);
...
function Pn({ artifactLabel: e, restoreState: t }) {
  return t
    ? (0, q.jsx)(`div`, {
...
//# sourceMappingURL=popcorn-electron-crdt-bridge-C6_HyOJZ.js.map
