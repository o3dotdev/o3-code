...
import { h, s as g } from "./chunk-5PVQY5BW-CnaqcI9r.js";
import { t as _ } from "./chunk-FMBD7UC4-Bz4YzVzS.js";
import { t as v } from "./chunk-YZCP3GAM-BiBTM9Rn.js";
import { t as y } from "./chunk-55IACEB6-D64Uo90h.js";
import { t as b } from "./chunk-EDXVE4YY-Dvoshwbp.js";
import { r as x, t as S } from "./chunk-336JU56O-CDWwHIND.js";
var C = (function () {
...
var w = C,
  ...
  D = `classId-`,
  O = 0,
  k = t((e) => p.sanitizeText(e, d()), `sanitizeText`),
  A = class {
    constructor() {
      ((this.relations = []),
        ...
        (this.getConfig = t(() => d().class, `getConfig`)),
    ...
    addRelation(e) {
      ...
      !t.includes(e.relation.type2)
        ...
        (e.relationTitle1 = p.sanitizeText(e.relationTitle1.trim(), d())),
        (e.relationTitle2 = p.sanitizeText(e.relationTitle2.trim(), d())),
    ...
    getData() {
      ...
      for (let e of this.relations) {
        r++;
        let i = {
          id: g(e.id1, e.id2, { prefix: `id`, counter: r }),
          start: e.id1,
          end: e.id2,
          type: `normal`,
          label: e.title,
...
//# sourceMappingURL=chunk-4TB4RGXK-DDKEF7Et.js.map
