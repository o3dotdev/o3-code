    ...
    #u(e, t) {
      return t
        ? ((!this.#a || this.#t !== this.#s || t !== this.#o) &&
            ((this.#o = t), (this.#s = this.#t), (this.#a = h(this.#a, t(e)))),
          this.#a)
        : e;
    }
    #d(e) {
      ...
      return (
        e.forEach((e) => {
          ...
          i
            ...
            : n.push({ defaultedQueryOptions: r, observer: new m(this.#e, r) });
        }),
        n
      );
    }
...
function S({ queries: e, ...t }, u) {
    ...
    y = x.useMemo(
      () =>
        e.map((e) => {
          ...
          return ((t._optimisticResults = h ? `isRestoring` : `optimistic`), t);
        }),
      [e, d, h],
    );
  (y.forEach((e) => {
    ...
    s(v));
  let [S] = x.useState(() => new b(d, y, t)),
    [C, w, T] = S.getOptimisticResult(y, t.combine),
    E = !h && t.subscribed !== !1;
  (x.useSyncExternalStore(
    x.useCallback((e) => (E ? S.subscribe(_.batchCalls(e)) : g), [S, E]),
    () => S.getCurrentResult(),
    () => S.getCurrentResult(),
  ),
    x.useEffect(() => {
  ...
  let D = C.some((e, t) => p(y[t], e))
    ? C.flatMap((e, t) => {
        let r = y[t];
        if (r) {
          let t = new m(d, r);
          if (p(r, e)) return c(r, t, v);
          n(e, h) && c(r, t, v);
        }
        return [];
      })
...
export { S as t };
//# sourceMappingURL=useQueries-BQOoTV8H.js.map
