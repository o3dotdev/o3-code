...
import { g as m, n as h, t as g } from "./chunk-5PVQY5BW-CnaqcI9r.js";
import { a as _, s as v } from "./chunk-YZCP3GAM-BiBTM9Rn.js";
var y = t(),
  b = (function () {
...
` +
    ...
    return (n(ue, `Parser`), (ue.prototype = J), (J.Parser = ue), new ue());
  })();
b.parser = b;
var x = b,
  S = [],
  ...
  F = n(function (e, t, n, r, i, a, o, s, l) {
  ...
  B = n(function (e, t, n, r, i, a, o, s, l, u, d) {
  ...
  Y = (function () {
    ...
    function t(e, t, n, r, a, o, s, l) {
      let { fontSize: u, fontFamily: d, fontWeight: p } = l,
        m = e.split(f.lineBreakRegex);
...
function Q(e, t, n, r, i) {
  if (!t[e].width)
    if (n)
      ((t[e].text = m(t[e].text, i, r)),
        (t[e].textLines = t[e].text.split(f.lineBreakRegex).length),
        (t[e].width = i),
        (t[e].height = g(t[e].text, r)));
    else {
      let n = t[e].text.split(f.lineBreakRegex);
      t[e].textLines = n.length;
      let i = 0;
      ((t[e].height = 0), (t[e].width = 0));
      for (let a of n)
        ((t[e].width = Math.max(h(a, r), t[e].width)),
          (i = g(a, r)),
          (t[e].height = t[e].height + i));
    }
}
n(Q, `calcC4ShapeTextWH`);
var Ne = n(function (e, t, n) {
    ((t.x = n.data.startx),
      (t.y = n.data.starty),
    ...
    ((i.fontSize += 2),
      (i.fontWeight = `bold`),
      Q(`label`, t, r, i, h(t.label.text, i)),
      X.drawBoundary(e, t, Z));
  }, `drawBoundary`),
  Pe = n(function (e, t, n, r) {
    let i = 0;
    for (let a of r) {
      i = 0;
      let r = n[a],
        o = Ae(Z, r.typeC4Shape.text);
      switch (
        ((o.fontSize -= 2),
        (r.typeC4Shape.width = h(`«` + r.typeC4Shape.text + `»`, o)),
      ...
      ((u.fontSize += 2),
        ...
        r.type && r.type.text !== ``
          ? ((r.type.text = `[` + r.type.text + `]`),
            Q(`type`, r, s, Ae(Z, r.typeC4Shape.text), l),
            (r.type.Y = i + 5),
            (i = r.type.Y + r.type.height))
          : r.techn &&
            r.techn.text !== `` &&
            ((r.techn.text = `[` + r.techn.text + `]`),
            Q(`techn`, r, s, Ae(Z, r.techn.text), l),
            (r.techn.Y = i + 5),
      ...
      (r.descr &&
        r.descr.text !== `` &&
        (Q(`descr`, r, s, Ae(Z, r.typeC4Shape.text), l),
        (r.descr.Y = i + 20),
  ...
  Le = n(function (e, t, n, r, i) {
    ...
    for (let e of t) {
      ...
      (Q(`label`, e, t, i, o),
        e.techn &&
          e.techn.text !== `` &&
          ((o = h(e.techn.text, i)), Q(`techn`, e, t, i, o)),
        e.descr &&
          e.descr.text !== `` &&
          ((o = h(e.descr.text, i)), Q(`descr`, e, t, i, o)));
...
n(Re, `drawInsideBoundary`);
var ze = {
    drawPersonOrSystemArray: Pe,
    drawBoundary: Ne,
    setConf: ke,
    draw: n(function (t, n, i, a) {
      Z = l().c4;
      let o = l().securityLevel,
        s;
      o === `sandbox` && (s = e(`#i` + n));
      let d = e(o === `sandbox` ? s.nodes()[0].contentDocument.body : `body`),
        f = a.db;
      (a.db.setWrap(Z.wrap),
        (Ee = f.getC4ShapeInRow()),
        (De = f.getC4BoundaryInRow()),
        r.debug(`C:${JSON.stringify(Z, null, 2)}`));
      let p = o === `sandbox` ? d.select(`[id="${n}"]`) : e(`[id="${n}"]`);
      ...
      (Re(p, ``, m, a.db.getBoundaries(``), a),
        ...
        X.insertArrowEnd(p, n),
        X.insertArrowCrossHead(p, n),
        X.insertArrowFilledHead(p, n),
        Le(p, a.db.getRels(), a.db.getC4Shape, a, n),
        (m.data.stopx = we),
        (m.data.stopy = Te));
      let g = m.data,
...
//# sourceMappingURL=c4Diagram-AHTNJAMY-Css_PZqO.js.map
