...
import { Rt as n, vr as r } from "./src-BLHmAhbF.js";
import { zt as i } from "./app-server-manager-signals-7MlBpIlX.js";
import {
  L as a,
  T as o,
  _ as s,
...
import { t as f } from "./useInfiniteQuery-CtH7UI0c.js";
import { t as p } from "./invalidate-queries-and-broadcast-CPrIeBVQ.js";
import { t as m } from "./use-auth-BSv8Pelr.js";
import { t as h } from "./_baseOrderBy-H105Hl5V.js";
import { r as g, t as _ } from "./parse-owner-repo-Bz9xN8qO.js";
import { t as v } from "./use-debounced-value-DzG-dxHX.js";
function y(e) {
  return Array.isArray ? Array.isArray(e) : O(e) === `[object Array]`;
}
var b = 1 / 0;
function x(e) {
...
function ee(e) {
  return e === !0 || e === !1 || (te(e) && O(e) == `[object Boolean]`);
}
function T(e) {
...
var ne = `Incorrect 'index' type`,
  re = (e) => `Invalid value for key ${e}`,
  ie = (e) => `Pattern length exceeds max of ${e}.`,
  ae = (e) => `Missing ${e} property in key`,
...
function A(e) {
  let t = null,
    ...
    i = 1,
    a = null;
  if (C(e) || y(e)) ((r = e), (t = ce(e)), (n = j(e)));
  else {
    if (!k.call(e, `name`)) throw Error(ae(`name`));
    let o = e.name;
    if (((r = o), k.call(e, `weight`) && ((i = e.weight), i <= 0)))
      throw Error(oe(o));
    ((t = ce(o)), (n = j(o)), (a = e.getFn));
  }
  return { path: t, id: n, weight: i, src: r, getFn: a };
}
function ce(e) {
  return y(e) ? e : e.split(`.`);
}
function j(e) {
  return y(e) ? e.join(`.`) : e;
}
    ...
    i = (e, t, a) => {
      if (E(e))
        if (!t[a]) n.push(e);
          ...
          let o = e[t[a]];
          if (!E(o)) return;
          if (a === t.length - 1 && (C(o) || w(o) || ee(o))) n.push(S(o));
          else if (y(o)) {
            r = !0;
...
var ue = { includeMatches: !1, findAllMatches: !1, minMatchCharLength: 1 },
  de = {
    isCaseSensitive: !1,
    ignoreDiacritics: !1,
    includeScore: !1,
  ...
  fe = { location: 0, threshold: 0.6, distance: 100 },
  pe = {
    useExtendedSearch: !1,
    getFn: le,
    ignoreLocation: !1,
...
function P(
  ...
  return (i.setKeys(e.map(A)), i.setSources(t), i.create(), i);
}
function ge(
  e,
...
function _e(e = [], t = M.minMatchCharLength) {
  let n = [],
    r = -1,
    i = -1,
    a = 0;
...
function ve(
  ...
  if (t.length > I) throw Error(ie(I));
  let u = t.length,
    d = e.length,
...
var L = String.prototype.normalize
    ? (e) =>
        e
          .normalize(`NFD`)
          .replace(
  ...
  R = class {
    constructor(
      ...
      if (
        ...
        return;
      let u = (e, t) => {
          this.chunks.push({ pattern: e, alphabet: ye(e), startIndex: t });
        },
      ...
      if (d > I) {
        let e = 0,
          t = d % I,
          n = d - t;
        for (; e < n; ) (u(this.pattern.substr(e, I), e), (e += I));
        if (t) {
          let e = d - I;
    ...
    searchIn(e) {
      ...
      if (
        ((e = t ? e : e.toLowerCase()), (e = n ? L(e) : e), this.pattern === e)
      ) {
...
var be = class extends z {
  ...
  U = [be, H, Se, Ce, Te, we, xe, V],
  W = U.length,
  Ee = / +(?=(?:[^\"]*\"[^\"]*\")*[^\"]*$)/,
  De = `|`;
function Oe(e, t = {}) {
  return e.split(De).map((e) => {
    let n = e
        .trim()
        .split(Ee)
        .filter((e) => e && !!e.trim()),
...
var q = { AND: `$and`, OR: `$or` },
  ...
  Me = (e) => !!e[J.PATH],
  Ne = (e) => !y(e) && T(e) && !Y(e),
  X = (e) => ({ [q.AND]: Object.keys(e).map((t) => ({ [t]: e[t] })) });
function Pe(e, t, { auto: n = !0 } = {}) {
  let r = (e) => {
    let i = Object.keys(e),
      a = Me(e);
    if (!a && i.length > 1 && !Y(e)) return r(X(e));
    if (Ne(e)) {
      let r = a ? e[J.PATH] : i[0],
        o = a ? e[J.PATTERN] : e[r];
      if (!C(o)) throw Error(re(r));
      let s = { keyId: j(r), pattern: o };
  ...
  return (Y(e) || (e = X(e)), r(e));
}
function Fe(e, { ignoreFieldNorm: t = M.ignoreFieldNorm }) {
  e.forEach((e) => {
    let n = 1;
...
function Ie(e, t) {
  ...
  ((t.matches = []),
    E(n) &&
      n.forEach((e) => {
        if (!E(e.indices) || !e.indices.length) return;
...
var Z = class {
  ...
  setCollection(e, t) {
    if (((this._docs = e), t && !(t instanceof N))) throw Error(ne);
    this._myIndex =
      t ||
  ...
  search(e, { limit: t = -1 } = {}) {
    ...
    return (
      Fe(s, { ignoreFieldNorm: o }),
      i && s.sort(a),
      w(t) && t > -1 && (s = s.slice(0, t)),
      Re(s, this._docs, { includeMatches: n, includeScore: r })
    );
  }
  _searchStringList(e) {
  ...
  _findMatches({ key: e, value: t, searcher: n }) {
    ...
    if (y(t))
      t.forEach(({ v: t, i, n: a }) => {
        ...
        o &&
          r.push({ score: s, key: e, value: t, idx: i, norm: a, indices: c });
      });
    else {
      let { v: i, n: a } = t,
...
function Ue(e) {
  return {
    enabled: e != null,
    queryFn: async () =>
      i.safeGet(`/wham/tasks/{task_id}/turns`, {
        parameters: { path: { task_id: e ?? `` } },
      }),
...
function We(e) {
  let t = (0, Q.c)(13),
    ...
    l;
  t[0] !== r || t[1] !== a
    ? ((l = [`tasks`, r, a]), (t[0] = r), (t[1] = a), (t[2] = l))
    : (l = t[2]);
  let u;
  t[3] !== e?.limit || t[4] !== e?.taskFilter
    ? ((u = async () =>
        (
          await i.safeGet(`/wham/tasks/list`, {
            parameters: {
      ...
      (t[5] = u))
    : (u = t[5]);
  let d = e?.enabled !== !1 && n === `chatgpt`,
    f;
  t[6] === e
    ? (f = t[7])
    : ((f = e?.environmentLabel
        ? (t) =>
            t.filter(
              (t) =>
...
function Ge(e) {
  return e.state.data?.some(Ke) ? 15e3 : 6e4;
}
function Ke(e) {
...
function qe(e) {
  let t = (0, Q.c)(2),
    n;
  return (
    t[0] === e ? (n = t[1]) : ((n = He(e)), (t[0] = e), (t[1] = n)),
    o(n)
  );
}
function Je(e, t, n) {
  let r = (0, Q.c)(11),
    a;
  r[0] !== e || r[1] !== t
    ? ((a = [`task`, e, `turn`, t]), (r[0] = e), (r[1] = t), (r[2] = a))
    : (a = r[2]);
  let c = !!e && !!t && (n?.enabled ?? !0),
    l = n?.refetchInterval,
    u;
  r[3] !== e || r[4] !== t
    ? ((u = async () =>
        i.safeGet(`/wham/tasks/{task_id}/turns/{task_turn_id}`, {
...
function Ye(e, t, n) {
  let r = (0, Q.c)(10),
    a;
  r[0] !== e || r[1] !== t
    ? ((a = [`task`, e, `turn`, t, `logs`]), (r[0] = e), (r[1] = t), (r[2] = a))
    : (a = r[2]);
  let c = !!e && !!t && (n?.enabled ?? !0),
    l;
  r[3] !== e || r[4] !== t
    ? ((l = async () =>
        i.safeGet(`/wham/tasks/{task_id}/turns/{task_turn_id}/logs`, {
          parameters: { path: { task_id: e ?? ``, task_turn_id: t ?? `` } },
        })),
      (r[3] = e),
      (r[4] = t),
...
async function Ze() {
  return i.safeGet(`/wham/environments`);
}
function Qe(e, t) {
  let n = (0, Q.c)(14),
    { enabled: r } = t,
  ...
  n[0] === c
    ? (l = n[1])
    : ((l = [`workspace`, `environments-search`, c]), (n[0] = c), (n[1] = l));
  let u;
  n[2] !== c || n[3] !== a
    ? ((u = a && c.trim().length > 0), (n[2] = c), (n[3] = a), (n[4] = u))
    : (u = n[4]);
  let d;
  n[5] === c
    ? (d = n[6])
    : ((d = async () => {
        let e = await i.safeGet(`/wham/environments`),
          t = c.trim().toLowerCase(),
          n = new Z(e, { threshold: 0.4, keys: [`label`, `repos`] }),
          r = n?.search(c).map(et) ?? [],
          a = (e) => {
            let n = e.toLowerCase();
  ...
  n[7] === c
    ...
    : ((f = (e) => {
        let [t, n] = e;
        if (!c?.trim()) return n;
        let r = c.trim().toLocaleLowerCase();
        return t.search(r).map($e);
      }),
      (n[7] = c),
      (n[8] = f));
  let p;
  return (
    n[9] !== l || n[10] !== u || n[11] !== d || n[12] !== f
      ? ((p = {
          queryKey: l,
          enabled: u,
          queryFn: d,
...
function tt(e) {
  ...
  t[1] === a
    ? (c = t[2])
    : ((c = { queryKey: i, queryFn: it, staleTime: s.ONE_MINUTE, enabled: a }),
      (t[1] = a),
      (t[2] = c));
  let { data: l } = o(c),
    u,
    d;
  if (t[3] !== l) {
    let e = (0, Be.default)(l, [`owner`, `repoName`]).flatMap(rt);
    ((d = o),
      (u = [`workspace`, `environments-by-repo`, ...e]),
      (t[3] = l),
      (t[4] = u),
      (t[5] = d));
  } else ((u = t[4]), (d = t[5]));
  ...
  t[6] === l
    ? (p = t[7])
    : ((p = async () => {
        let e = (await Promise.all((l ?? []).map(nt))).flat();
        return ((0, Be.default)(e, [`is_pinned`, `task_count`, `label`]), e);
      }),
      (t[6] = l),
      (t[7] = p));
  let h;
  return (
    t[8] !== u || t[9] !== f || t[10] !== p
      ? ((h = { queryKey: u, enabled: f, staleTime: s.ONE_MINUTE, queryFn: p }),
        (t[8] = u),
        (t[9] = f),
        (t[10] = p),
        (t[11] = h))
...
async function it() {
  return at(
    (await l(`git-origins`, { source: `workspace_repo_owner_names` })).origins,
  );
}
function at(e) {
  let t = [];
  ...
  return (0, Ve.default)(t, ({ owner: e, repoName: t }) => `${e}/${t}`);
}
async function ot(e) {
  let t = [];
  if (
  ...
  if (
    ...
    for (let n of e.commentAttachments) t.push(r(n));
  let n = {
    branch: e.ref,
...
async function st({
  ...
  return i.safePost(`/wham/worktree_snapshots/upload_url`, {
    requestBody: {
      repo_name: e,
      filename: t,
      content_type: n,
...
async function ct({ fileId: e, etag: t }) {
  return i.safePost(`/wham/worktree_snapshots/finish_upload`, {
...
async function ft(e) {
  return i.safePost(`/wham/tasks/{task_id}/turns/{task_turn_id}/pr`, {
...
function ht() {
  ...
  return (
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = { mutationFn: gt }), (e[0] = t))
      : (t = e[0]),
    u(t)
  );
}
function gt(e) {
  return i.safePost(`/wham/referrals/invite`, {
...
async function yt(e) {
  await i.safePost(`/wham/tasks/{task_id}/cancel`, {
    parameters: { path: { task_id: e } },
  });
}
function bt() {
...
async function St(e, t, n = 20, r = null) {
  return i.safeGet(`/wham/github/branches/{repo_id}/search`, {
    parameters: {
...
function Ct(e, t, n) {
  ...
  let { enabled: a } = i,
    ...
    c;
  r[2] !== t || r[3] !== e
    ? ((c = [`search-branches`, e, t]), (r[2] = t), (r[3] = e), (r[4] = c))
    : (c = r[4]);
  let l = !!e && o,
    u;
  r[5] !== t || r[6] !== e
...
function Tt(e) {
  return e.pages.flatMap(Et);
}
function Et(e) {
  return e.items?.map(Dt) ?? [];
}
function Dt(e) {
  return e.branch;
}
function Ot(e) {
  ...
  t[0] === e
    ? (r = t[1])
    : ((r = () =>
        i.safePost(`/wham/tasks/{task_id}/mark_read`, {
          parameters: { path: { task_id: e } },
        })),
      (t[0] = e),
      (t[1] = r));
...
async function kt() {
  return i.safeGet(`/wham/accounts/check`);
}
function At(e) {
  let t = (0, Q.c)(8),
    n;
  ...
  let { enabled: r } = n,
    i = r === void 0 ? !0 : r,
    { accountId: a, authMethod: c } = m(),
    l;
  t[2] !== a || t[3] !== c
    ? ((l = [`onboarding`, `context`, c, a]),
      (t[2] = a),
      (t[3] = c),
      (t[4] = l))
    : (l = t[4]);
...
async function jt() {
  return i.safeGet(`/wham/onboarding/context`);
}
function Mt() {
  let e = (0, Q.c)(8),
    { data: t, isLoading: n, isError: r, errorUpdatedAt: i } = $(),
    a =
      t?.account_ordering && t.account_ordering.length > 0
        ? t.account_ordering[0]
        : void 0,
    o;
  e[0] !== a || e[1] !== t
...
//# sourceMappingURL=codex-api-s1Mcln0L.js.map
