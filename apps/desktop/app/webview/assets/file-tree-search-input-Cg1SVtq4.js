...
import { Ki as t } from "./app-server-manager-signals-Csopz8aM.js";
...
import { t as p } from "./button-bq66r8jD.js";
import { t as m } from "./x-DMqExXY8.js";
import { t as h } from "./use-platform-ByMJlQVq.js";
import { n as g, r as _ } from "./use-resolved-theme-variant-G14Wtv28.js";
import { t as v } from "./use-stable-callback-D_6XYV-7.js";
import { t as y } from "./context-menu-TJfRSX1h.js";
import { t as b } from "./search-CEAmgNrg.js";
import { t as x } from "./copy-to-clipboard-DUkEoARe.js";
import { n as S, r as C } from "./open-target-selection-Cijq0StV.js";
import { a as ee, i as te, n as ne, t as w } from "./iconResolver-BZbgWuPi.js";
import { n as re, t as T } from "./use-target-apps-DgO11eKw.js";
var E = `file-tree-container`,
  D = `data-file-tree-style`,
  O = `data-file-tree-unsafe-css`,
  k = `data-file-tree-scrollbar-measure`,
  A = `data-file-tree-scrollbar-gutter-measured`,
  ie = `--trees-scrollbar-gutter-measured`,
  ae = `header`,
  oe = `context-menu`,
  se = `context-menu-trigger`,
  ce = 5,
  le = 1 << ce,
  ue = le * 4;
function j() {
...
function ve(e, t) {
  if (t.childIds.length < ue) {
    t.childVisibleChunkSums = null;
    return;
  }
  let n = Math.ceil(t.childIds.length / le),
    r = new Int32Array(n);
  for (let n = 0; n < t.childIds.length; n++) {
    let i = t.childIds[n];
    if (i == null) continue;
    let a = e[i];
    a != null && (r[n >> ce] += a.visibleSubtreeCount);
  }
  t.childVisibleChunkSums = r;
}
function ye(e, t, n, r) {
  let i = Math.min(t.childIds.length, n + le),
    a = r;
  for (let r = n; r < i; r++) {
    let n = t.childIds[r];
    if (n == null) continue;
...
function F(e) {
  return e.depthAndFlags >>> Ce;
}
function we(e) {
  return (e.depthAndFlags & Se) >> xe;
}
function I(e) {
  return (e.depthAndFlags & Se) !== 0;
}
function Te(e) {
  return e.depthAndFlags & be;
}
function L(e, t) {
  return (Te(e) & t) !== 0;
}
...
function De(e, t) {
  e.depthAndFlags = P(t, Te(e), we(e));
}
var Oe = Symbol(`benchmarkInstrumentation`);
function ke(e, t) {
  return (
    t == null ||
...
function Ne(e) {
  let t = [],
    ...
    r = 0;
  for (; r < e.length; ) {
    for (; r < e.length && !Me(e.charCodeAt(r)); ) r += 1;
    if (r >= e.length) break;
    r > n && t.push(e.slice(n, r));
    let i = 0;
    for (; r < e.length && Me(e.charCodeAt(r)); )
...
function Pe(e) {
  let t = e.toLowerCase();
  return { lowerValue: t, tokens: Ne(t) };
}
function z(e, t) {
...
function ze(e, t) {
  ...
  for (let r = 0; r < n; r++) {
    ...
    if (n === i) continue;
    let a = Re(e, r);
    return a === Re(t, r) ? Le(n, i) : a === 1 ? -1 : 1;
  }
...
function Ve(e, t, n) {
  ...
  for (let n = 0; n < i; n++) {
    ...
    if (i === a) continue;
    let o = Re(e, n);
    return o === Re(t, n) ? Ie(i, a, r) : o === 1 ? -1 : 1;
  }
  return e.segments.length === t.segments.length
    ? e.isDirectory === t.isDirectory
      ? 0
...
function Ge(e) {
  let { hasTrailingSlash: t, segments: n } = We(e);
  return {
...
function Je() {
  ...
  return (
    e.set(qe, 0),
    { idByValue: e, valueById: [qe], sortKeyById: [Pe(qe)] }
  );
}
function Ye(e, t) {
...
var V = Symbol(`pathStorePreparedInputKind`);
function Xe(e, t) {
  return ((e[V] = t), e);
}
function Ze(e) {
...
function Qe(e, t, n) {
  return n === `default` ? Be(e, t) : n(Ze(e), Ze(t));
}
function $e() {
  return {
    depthAndFlags: P(0, 3, 1),
    nameId: 0,
    parentId: 0,
    subtreeNodeCount: 1,
...
function H(e, t = {}) {
  return lt(e, t).map((e) => e.path);
}
function it(e, t = {}) {
  let n = lt(e, t);
  return Xe({ paths: n.map((e) => e.path), preparedPaths: n }, `prepared`);
}
function at(e) {
  let t = e.length,
    n = !1;
...
function ot(e) {
  let t = e,
    n = t.preparedPaths;
  if (t[V] === `prepared` && n != null) return n;
  if (!nt(n))
...
function st(e) {
  let t = e;
  return (t[V] === `presorted` && t.presortedPaths != null) ||
    rt(t.presortedPaths)
    ? t.presortedPaths
    : null;
}
...
function lt(e, t = {}) {
  let n = Ue(t),
    r = Ae(t);
  je(r, `workload.inputFiles`, e.length);
  let i = R(r, `store.preparePathEntries.parse`, () => e.map((e) => Ge(e)));
  return (
    R(r, `store.preparePathEntries.sort`, () =>
      i.sort((e, t) => Qe(e, t, n.sort)),
    ),
    i
  );
}
var ut = class {
  ...
  constructor(e = {}) {
    ((this.instrumentation = Ae(e)), (this.options = Ue(e)));
    ...
    this.directories.set(0, j());
  }
  appendPaths(e) {
    return R(this.instrumentation, `store.builder.appendPaths.parse`, () =>
      this.appendPreparedPaths(e.map((e) => Ge(e))),
    );
  }
  appendPreparedPaths(e, t = !0) {
    return (
      (this.createdDirectoriesAllExpanded = !1),
      R(this.instrumentation, `store.builder.appendPreparedPaths`, () => {
  ...
  appendPresortedPaths(e, t = null) {
    return (
      R(this.instrumentation, `store.builder.appendPresortedPaths`, () => {
        if (t === !1) {
        ...
        for (let t of e) {
          ...
          if (e) {
            if (m < a) {
              let e = c[l];
              if (e === void 0)
                throw Error(`Unable to resolve directory parent for "${t}"`);
              r++;
              let n = t.slice(m, a),
                u = o.get(n);
            ...
            let e = c[l];
            if (e === void 0)
              throw Error(`Unable to resolve directory node for "${t}"`);
        ...
        ((c.length = l + 1),
          n != null && (this.lastPreparedPath = Ge(n)),
  ...
  appendPresortedFilePaths(e) {
    ...
    ((s.length = c + 1),
      t != null && (this.lastPreparedPath = Ge(t)),
      (this.hasDeferredDirectoryIndexes = !0));
  }
  finish(e = {}) {
    ...
    return (
      this.hasDeferredDirectoryIndexes
        ? (R(this.instrumentation, `store.builder.buildDirectoryIndexes`, () =>
            this.buildPresortedFinish(t),
          ),
          (this.hasDeferredDirectoryIndexes = !1))
        : t ||
          R(this.instrumentation, `store.builder.computeSubtreeCounts`, () =>
  ...
  appendPreparedPath(e, t) {
    if (
      ...
      if (
        ...
        (this.options.sort === `default`
          ? Ve(this.lastPreparedPath, e, this.segmentSortKeyCache)
          : Qe(this.lastPreparedPath, e, this.options.sort)) > 0
      )
        throw Error(
    ...
    let n = this.lastPreparedPath,
      r = tt(e),
      i = n == null ? 0 : tt(n),
      a = n == null ? 0 : et(n.segments, e.segments),
      o = Math.min(a, r, i);
  ...
  promoteDirectoryToExplicit(e, t) {
    ...
    if (!I(n)) throw Error(`Path is not a directory: "${t}"`);
    if (L(n, 1)) throw Error(`Duplicate path: "${t}"`);
    Ee(n, 1);
  }
  getDirectoryIndex(e) {
...
function mt(e, t) {
  return L(t, 2) || e.defaultExpansion === `open`
    ? !0
    : e.defaultExpansion === `closed`
      ? !1
      : F(t) <= e.defaultExpansion;
}
function U(e, t, n = e.snapshot.nodes[t]) {
  return n == null || !I(n)
    ? !1
...
function ht(e, t, n, r = e.snapshot.nodes[t]) {
...
function It(e, t, n) {
  return { ...n, visibleCountDelta: qt(e) - t };
}
function Lt(e, t) {
  let n = qt(e),
    r = ft();
...
function Rt(e, t) {
  ...
  R(n, `store.events.record`, () => zt(e, t));
}
function zt(e, t) {
...
function Bt(e, t, n, r = null) {
  ...
  if (i != null) {
    let n = e.instrumentation;
    n == null ? Ut(i, t) : R(n, `store.events.batch.merge`, () => Ut(i, t));
    return;
  }
  let a = Vt(t, r),
    o = e.instrumentation;
  ...
  R(o, `store.events.batch.commit`, () => Gt(e, a));
}
function Vt(e, t) {
  return {
    affectedAncestorIds: [...e.affectedAncestorIds],
...
function Zt(e, t) {
  let n = t == null ? e.snapshot.rootId : sn(e, t);
  return n == null ? [] : ln(e, n);
}
function Qt(e, t) {
  let n = Ge(t),
    r = n.isDirectory ? n.segments : n.segments.slice(0, -1),
    i = wn(e, Cn(e, r)),
    { createdNodeIds: a, directoryId: o } = un(e, r),
    s = new Set(a),
    c = o;
  if (n.isDirectory) {
    let n = K(e, o);
    if (L(n, 1)) throw Error(`Path already exists: "${t}"`);
    (Ee(n, 1),
      e.pathCacheByNodeId.set(o, { path: t, version: e.pathCacheVersion }),
      s.add(o));
  } else ((c = fn(e, o, n.basename)), s.add(c));
  rn(e, o);
  let l = wn(e, o);
  return Tt({
    affectedAncestorIds: on(e, c),
    affectedNodeIds: [...s],
    path: t,
    projectionChanged: Tn(i, l),
  });
}
function $t(e, t, n) {
  let r = sn(e, t);
  ...
  let i = K(e, r);
  if (L(i, 2)) throw Error(`The root node cannot be removed`);
  if (I(i) && G(e, r).childIds.length > 0 && n.recursive !== !0)
    throw Error(
  ...
  let a = i.parentId,
    o = wn(e, a),
    s = xn(e, r);
  (hn(e, a, r, i.nameId), Sn(e, a), rn(e, a));
  let c = wn(e, a);
  return Et({
    affectedAncestorIds: on(e, a),
    affectedNodeIds: s,
    path: t,
    projectionChanged: Tn(o, c),
...
function en(e, t, n, r) {
  ...
  let a = K(e, i);
  if (L(a, 2)) throw Error(`The root node cannot be moved`);
  let o = r.collision ?? `error`,
    s = yn(e, i, n),
    c = wn(e, a.parentId),
    l = wn(e, s.parentId),
    u = B(e.snapshot.segmentTable, a.nameId),
    d = Ye(e.snapshot.segmentTable, s.basename);
  if (s.parentId === a.parentId && u === s.basename) return null;
  if (I(a) && kn(e, i, s.parentId))
    throw Error(`Cannot move a directory into one of its descendants`);
  let f = M(e.snapshot.nodes, G(e, s.parentId)).get(d),
    p = s.existingNodeId ?? f ?? null;
  if (p != null && p !== i && bn(e, p, o, we(a)) === `skip`) return null;
  let m = a.parentId;
  (hn(e, m, i, a.nameId),
    ...
    e.pathCacheVersion++,
    rn(e, m),
    s.parentId !== m && rn(e, s.parentId));
  let h = wn(e, m),
    g = wn(e, s.parentId);
  return Dt({
    affectedAncestorIds: [...new Set([...on(e, m), ...on(e, s.parentId)])],
    affectedNodeIds: [i],
    from: t,
    projectionChanged: En([c, l], [h, g]),
    to: W(e, i),
  });
}
function tn(e, t) {
...
function W(e, t) {
  let n = K(e, t),
    r = tn(e, t);
  if (r != null) return r;
  if (L(n, 2)) return nn(e, t, ``);
  let i = W(e, n.parentId),
    a = B(e.snapshot.segmentTable, n.nameId),
    o = i.length === 0 ? a : `${i}${a}`;
  return nn(e, t, I(n) ? `${o}/` : o);
}
function rn(e, t) {
  let n = e.instrumentation;
  if (n == null) {
  ...
  R(n, `store.recomputeCountsUpwardFrom`, () => jn(e, t));
}
function an(e, t) {
  let n = [[t, 0]],
...
function sn(e, t) {
  ...
  let n = Ke(t);
  return cn(e, n.segments, n.requiresDirectory);
}
function cn(e, t, n) {
...
function K(e, t) {
  let n = e.snapshot.nodes[t];
  if (n === void 0 || L(n, 4)) throw Error(`Unknown node ID: ${String(t)}`);
  return n;
}
function ln(e, t) {
  let n = e.snapshot.nodes[t];
  if (n === void 0 || L(n, 4)) return [];
  if (!I(n)) return [W(e, t)];
  if (G(e, t).childIds.length === 0)
    return L(n, 1) && !L(n, 2) ? [W(e, t)] : [];
  let r = [],
  ...
  for (; i.length > 0; ) {
    ...
    if (!I(n)) {
      (r.push(W(e, t.nodeId)), i.pop());
      continue;
    }
    let a = G(e, t.nodeId);
    if (a.childIds.length === 0) {
      (L(n, 1) && !L(n, 2) && r.push(W(e, t.nodeId)), i.pop());
      continue;
    }
...
function un(e, t) {
  let n = [],
    r = e.snapshot.rootId;
  for (let i of t) {
    let t = Ye(e.snapshot.segmentTable, i),
      a = G(e, r),
      o = M(e.snapshot.nodes, a).get(t);
    if (o !== void 0) {
      if (!I(K(e, o)))
        throw Error(
...
function dn(e, t, n) {
  ...
  return (
    e.snapshot.nodes.push({
      depthAndFlags: P(F(r) + 1, 0, 1),
      nameId: n,
      parentId: t,
      subtreeNodeCount: 1,
      visibleSubtreeCount: 1,
    }),
    e.snapshot.directories.set(i, j()),
    mn(e, t, i),
...
function fn(e, t, n) {
  let r = Ye(e.snapshot.segmentTable, n),
    i = G(e, t);
  if (M(e.snapshot.nodes, i).has(r))
    throw Error(`Path already exists: "${Nn(e, t, n)}"`);
  let a = K(e, t),
    o = e.snapshot.nodes.length;
  return (
    e.snapshot.nodes.push({
      depthAndFlags: P(F(a) + 1, 0),
      nameId: r,
      parentId: t,
      subtreeNodeCount: 1,
      visibleSubtreeCount: 1,
...
function mn(e, t, n) {
  let r = G(e, t),
    i = K(e, n);
  (M(e.snapshot.nodes, r).set(i.nameId, n),
    he(r, n, i.subtreeNodeCount, i.visibleSubtreeCount));
  let a = pn(e, r, n);
  (r.childIds.splice(a, 0, n), pe(r, a), ve(e.snapshot.nodes, r));
}
function hn(e, t, n, r) {
  let i = G(e, t),
    a = fe(i),
    o = a.get(n) ?? -1;
  (M(e.snapshot.nodes, i).delete(r), a.delete(n));
  let s = e.snapshot.nodes[n];
  (s != null && he(i, n, -s.subtreeNodeCount, -s.visibleSubtreeCount),
    o >= 0 && (i.childIds.splice(o, 1), pe(i, o), ve(e.snapshot.nodes, i)));
}
function gn(e, t, n) {
  let r = e.snapshot.options.sort;
  return r === `default` ? _n(e, t, n) : r(vn(e, t), vn(e, n));
}
function _n(e, t, n) {
  let r = K(e, t),
    i = K(e, n),
    a = I(r);
  if (a !== I(i)) return a ? -1 : 1;
  let o = Fe(
    He(e.snapshot.segmentTable, r.nameId),
    He(e.snapshot.segmentTable, i.nameId),
  );
  if (o !== 0) return o;
  let s = B(e.snapshot.segmentTable, r.nameId),
    c = B(e.snapshot.segmentTable, i.nameId);
...
function vn(e, t) {
  let n = K(e, t),
    ...
    a = i ? r.slice(0, -1) : r;
  return {
    basename: B(e.snapshot.segmentTable, n.nameId),
    depth: F(n),
    isDirectory: i,
    path: r,
...
function yn(e, t, n) {
  ...
  if (i != null) {
    ...
    if (I(t))
      return {
        basename: B(e.snapshot.segmentTable, r.nameId),
        existingNodeId: null,
        parentId: i,
      };
    let a = Ke(n).segments;
  ...
  let a = Ke(n),
    ...
    c = s.length === 0 ? e.snapshot.rootId : cn(e, s, !0);
...
function xn(e, t) {
  ...
  for (; r.length > 0; ) {
    ...
    if (t == null) break;
    let i = K(e, t.nodeId);
    if (t.visitedChildren || !I(i)) {
      (I(i) && e.snapshot.directories.delete(t.nodeId),
        Ee(i, 4),
...
function Sn(e, t) {
  ...
  for (; n != null; ) {
    let t = K(e, n);
    if (!I(t) || L(t, 2) || G(e, n).childIds.length > 0) return;
    (Ee(t, 1), (n = t.parentId === n ? null : t.parentId));
  }
}
function Cn(e, t) {
  ...
  for (let r of t) {
    ...
    if (t == null) break;
    let i = M(e.snapshot.nodes, G(e, n)).get(t);
    if (i == null || !I(K(e, i))) break;
    n = i;
  }
  return n;
}
function wn(e, t) {
  ...
  let r = Yt(e, n),
    i = K(e, r),
    a = n === r ? null : Xt(e, n).map((t) => W(e, t));
  return JSON.stringify({
    flattenedSegmentPaths: a,
    hasChildren: G(e, r).childIds.length > 0,
    path: W(e, r),
    terminalKind: we(i),
  });
}
...
function On(e, t) {
  let n = K(e, t);
  if ((De(n, (t === e.snapshot.rootId ? -1 : F(K(e, n.parentId))) + 1), !I(n)))
    return;
  let r = G(e, t);
  for (let t of r.childIds) On(e, t);
}
function kn(e, t, n) {
  let r = n;
  for (; r != null; ) {
...
function An(e, t, n = K(e, t), r = !1) {
  let i = e.instrumentation;
  if (i == null) {
    Mn(e, t, n, r);
    return;
  }
  R(i, `store.recomputeNodeCounts`, () => Mn(e, t, n, r));
}
function jn(e, t) {
  let n = t;
  for (; n != null; ) {
    ...
    if ((An(e, n, t), n === e.snapshot.rootId)) return;
    let a = t.subtreeNodeCount - r,
      o = t.visibleSubtreeCount - i,
      s = t.parentId;
    ((a !== 0 || o !== 0) && he(G(e, s), n, a, o), (n = s));
  }
}
function Mn(e, t, n, r) {
  if (!I(n)) {
  ...
  if (r) {
    ...
    t == null
      ? me(e.snapshot.nodes, i)
      : R(t, `store.recomputeNodeCounts.rebuildChildAggregates`, () =>
          me(e.snapshot.nodes, i),
        );
  }
  let a = 1 + i.totalChildSubtreeNodeCount,
    o = i.totalChildVisibleSubtreeCount;
  if (((n.subtreeNodeCount = a), L(n, 2))) {
    n.visibleSubtreeCount = o;
    return;
  }
  n.visibleSubtreeCount = Jt(e, t) == null ? (U(e, t, n) ? 1 + o : 1) : o;
}
function Nn(e, t, n) {
  let r = W(e, t);
...
function Fn(e, t) {
  let n = e.snapshot.nodes[t];
  return !Pn(n) || !I(n) || L(n, 2) ? null : n;
}
function In(e) {
  let t = 0;
  for (let [n, r] of e.pathCacheByNodeId)
    r.version === e.pathCacheVersion && Pn(e.snapshot.nodes[n]) && (t += 1);
  return t;
}
function Ln(e) {
...
function Rn(e) {
  return {
    ...
    cachedPathEntryCount: In(e),
    loadInfoEntryCount: e.directoryLoadInfoById.size,
    segmentCount: Ln(e.snapshot.segmentTable),
...
function Bn(e) {
  let t = [],
    n = [];
  for (let n of e.collapsedDirectoryIds) Fn(e, n) != null && t.push(W(e, n));
  for (let t of e.expandedDirectoryIds) Fn(e, t) != null && n.push(W(e, t));
...
function Hn(e, t) {
  ...
  for (let n of t.expandedPaths) {
    let t = sn(e, n);
    t != null && ht(e, t, !0, K(e, t));
  }
  for (let n of t.collapsedPaths) {
    let t = sn(e, n);
    t != null && ht(e, t, !1, K(e, t));
  }
}
function Un(e, t) {
...
function Kn(e) {
  for (let [t, n] of e.snapshot.directories) {
    ...
    let i = n.childIds.filter((n) => {
      ...
      return Pn(r) && r.parentId === t;
    });
    ((n.childIds = i),
      (n.childIdByNameId = new Map(i.map((t) => [K(e, t).nameId, t]))),
      (n.childPositionById = new Map(i.map((e, t) => [e, t]))),
      me(e.snapshot.nodes, n));
  }
}
function qn(e) {
...
function Jn(e) {
  let t = Bn(e),
    n = Vn(e);
  (R(e.instrumentation, `store.cleanup.stable.clearPathCaches`, () => Wn(e)),
    R(e.instrumentation, `store.cleanup.stable.rebuildSegmentTable`, () =>
      Gn(e),
    ),
    R(e.instrumentation, `store.cleanup.stable.rebuildDirectoryIndexes`, () =>
      Kn(e),
    ),
    R(
      e.instrumentation,
    ...
    R(e.instrumentation, `store.cleanup.stable.restoreExpansionOverrides`, () =>
      Hn(e, t),
    ),
    R(e.instrumentation, `store.cleanup.stable.restoreDirectoryLoadInfos`, () =>
      Un(e, n),
    ),
    R(e.instrumentation, `store.cleanup.stable.recomputeCounts`, () =>
      an(e, e.snapshot.rootId),
    ));
}
function Yn(e) {
  let t = Bn(e),
    n = Vn(e),
    r = R(e.instrumentation, `store.cleanup.aggressive.listPaths`, () => Zt(e)),
    i = ke({ ...e.snapshot.options }, e.instrumentation),
    a = R(e.instrumentation, `store.cleanup.aggressive.rebuildSnapshot`, () => {
      let e = new ut(i);
  ...
  ((e.snapshot = a),
    ...
    R(e.instrumentation, `store.cleanup.aggressive.recomputeCounts`, () =>
      an(e, e.snapshot.rootId),
    ));
}
function Xn(e) {
...
function Zn(e, t) {
  let n = Rn(e);
  t === `stable`
    ? R(e.instrumentation, `store.cleanup.stable`, () => Jn(e))
    : R(e.instrumentation, `store.cleanup.aggressive`, () => Yn(e));
  let r = Rn(e);
  return zn(t, t === `stable`, n, r);
}
var Qn = 64;
function $n(e, t) {
  let n = t + 2;
...
function er(e) {
  return K(e, e.snapshot.rootId).visibleSubtreeCount;
}
function tr(e, t, n, r) {
  let i = K(e, t.terminalNodeId),
...
function nr(e, t, n, r) {
  return {
    ...
    row: xr(e, t.cursor),
    setSize: t.setSize,
    subtreeEndIndex: tr(e, t.cursor, t.index, n),
  };
}
  ...
  let o = G(e, t),
    {
      ...
      childVisibleIndex: c,
      localVisibleIndex: l,
    } = ge(e.snapshot.nodes, o, n),
    u = o.childIds[s];
  if (u == null) throw Error(`Visible index ${String(n)} is out of range`);
  return ir(e, u, l, r + c, i + 1, s, o.childIds.length, a);
}
function ir(e, t, n, r, i, a, o, s) {
  ...
  let l = K(e, c.terminalNodeId);
  if (!I(l) || !U(e, c.terminalNodeId, l))
    throw Error(
      `Visible index ${String(n)} is out of range for collapsed directory`,
    );
  return rr(e, c.terminalNodeId, n - 1, r + 1, c.visibleDepth, [
    ...s,
...
function ar(e, t) {
  ...
  let r = rr(e, e.snapshot.rootId, t, 0, -1, []),
    i = r.ancestors.map((t) => W(e, t.cursor.terminalNodeId)),
    a = null;
  return {
    ancestorPaths: i,
    get ancestorRows() {
    ...
    row: xr(e, r.cursor),
    setSize: r.setSize,
    subtreeEndIndex: tr(e, r.cursor, r.index, n),
  };
}
function or(e, t, n) {
  ...
  let s = [],
    c = 0,
    l = 0,
    u = R(r, `store.getVisibleSlice.selectFirstRow`, () => fr(e, a));
  for (let t = a; t <= o && u != null; t++) {
    let t = R(r, `store.getVisibleSlice.materializeRow`, () => xr(e, u));
    (s.push(t),
      t.isFlattened && (c++, (l += t.flattenedSegments?.length ?? 0)),
      (u = R(r, `store.getVisibleSlice.advanceCursor`, () => _r(e, u))));
  }
  return (
    je(r, `workload.visibleRowsRead`, s.length),
    je(r, `workload.flattenedRowsRead`, c),
    je(r, `workload.flattenedSegmentsRead`, l),
    s
  );
}
function sr(e, t = er(e)) {
  let n = e.instrumentation;
  return n == null
    ? yr(e, t)
    : R(n, `store.getVisibleTreeProjection`, () => yr(e, t));
}
function cr(e) {
  return vr(sr(e));
}
function lr(e, t) {
  let n = sn(e, t);
  if (n == null || n === e.snapshot.rootId || (I(K(e, n)) && Yt(e, n) !== n))
    return null;
  let r = 0,
    i = n,
    { nodes: a, rootId: o } = e.snapshot;
  for (; i !== o; ) {
    let t = K(e, i).parentId,
      n = G(e, t),
      s = fe(n).get(i);
    if (s == null)
...
function ur(e, t) {
  ...
  let r = K(e, n);
  if (!I(r)) throw Error(`Path is not a directory: "${t}"`);
  return U(e, n, r)
    ? null
    : (ht(e, n, !0, r),
      rn(e, n),
      Ot({
        affectedAncestorIds: on(e, n),
        affectedNodeIds: [n],
        path: t,
        projectionChanged: !0,
      }));
...
function fr(e, t) {
  return t < 0 || t >= er(e) ? null : pr(e, e.snapshot.rootId, t, -1);
}
function pr(e, t, n, r) {
  let i = G(e, t),
    a = e.instrumentation,
    { childIndex: o, localVisibleIndex: s } =
      a == null
        ? ge(e.snapshot.nodes, i, n)
        : R(a, `store.getVisibleSlice.selectChildIndex`, () =>
            ge(e.snapshot.nodes, i, n),
          ),
    c = i.childIds[o];
  if (c != null) return mr(e, c, s, r + 1);
...
function mr(e, t, n, r) {
  ...
  let i = hr(e, t, r);
  if (n === 0) return i;
  let a = K(e, i.terminalNodeId);
  if (!I(a) || !U(e, i.terminalNodeId, a))
    throw Error(
      `Visible index ${String(n)} is out of range for collapsed directory`,
    );
  return pr(e, i.terminalNodeId, n - 1, i.visibleDepth);
}
function hr(e, t, n) {
  return I(K(e, t))
    ? e.instrumentation == null
      ? { headNodeId: t, terminalNodeId: Yt(e, t), visibleDepth: n }
      : {
          headNodeId: t,
          terminalNodeId: R(
            e.instrumentation,
...
function gr(e, t) {
  ...
  if (!I(n)) return !0;
  let r = n.parentId;
  return r === e.snapshot.rootId ? !0 : Jt(e, r) !== t;
}
function _r(e, t) {
  let n = K(e, t.terminalNodeId);
  if (I(n)) {
    let r = G(e, t.terminalNodeId);
    if (U(e, t.terminalNodeId, n) && r.childIds.length > 0) {
      let n = r.childIds[0];
      return n == null ? null : mr(e, n, 0, t.visibleDepth + 1);
    }
  }
...
function yr(e, t) {
  ...
  for (; d.length > 0 && s < t; ) {
    ...
    let x,
      S = _;
    if (I(v))
      ((S = f ? Yt(e, _) : _), (x = S === _ ? `${b}${h[v.nameId]}/` : W(e, S)));
    else {
      let e = p.get(_);
    ...
    ((r[s] = o[y]),
      ...
      (s += 1));
    let C = c[S];
    C != null && I(C) && U(e, S, C) && d.push([l.get(S), 0, y, x]);
  }
  s < t && (n.length = s);
  ...
  for (; s.length > 0 && r < t; ) {
    ...
    if (!I(p)) {
      ...
      n[r++] = {
        ...
        loadState: void 0,
        name: c[p.nameId],
        path: t != null && t.version === d ? t.path : W(e, f),
      };
      continue;
    }
    let h = l ? Yt(e, f) : f,
    ...
    n[r++] = xr(e, g);
    let _ = i[h];
    _ != null && I(_) && U(e, h, _) && s.push([a.get(h), 0, m]);
  }
...
function xr(e, t) {
  let n = K(e, t.terminalNodeId),
    r = I(n) ? Sr(e, t) : null,
    i = W(e, t.terminalNodeId),
    a = B(e.snapshot.segmentTable, n.nameId),
    o = I(n) && G(e, t.terminalNodeId).childIds.length > 0,
    s = t.headNodeId !== t.terminalNodeId,
    c = e.instrumentation,
    l = s
      ? c == null
        ? Xt(e, t.headNodeId).map((n) => {
            let r = K(e, n);
            return {
              isTerminal: n === t.terminalNodeId,
              name: B(e.snapshot.segmentTable, r.nameId),
              nodeId: n,
              path: W(e, n),
            };
          })
        : R(c, `store.getVisibleSlice.flatten.collectSegments`, () =>
            Xt(e, t.headNodeId).map((n) => {
              let r = K(e, n);
              return {
                isTerminal: n === t.terminalNodeId,
  ...
  return {
    ...
    hasChildren: o,
    id: t.terminalNodeId,
    isExpanded: I(n) && U(e, t.terminalNodeId, n),
    isFlattened: s,
    isLoading: r === `loading`,
    kind: I(n) ? `directory` : `file`,
...
function Sr(e, t) {
  if (t.headNodeId === t.terminalNodeId) return _t(e, t.terminalNodeId);
  let n = Xt(e, t.headNodeId),
    r = !1,
    i = !1;
  for (let t of n) {
    let n = _t(e, t);
...
var Tr = class e {
  ...
  constructor(e = {}) {
    let t = Ae(e),
      n = R(t, `store.builder.create`, () => new ut(e));
    if (e.preparedInput != null) {
      let t = st(e.preparedInput);
      t == null
        ? n.appendPreparedPaths(ot(e.preparedInput), !1)
        : n.appendPresortedPaths(t, ct(e.preparedInput));
    } else {
      let r = e.paths ?? [];
      e.presorted === !0
        ? n.appendPaths(r)
        : n.appendPreparedPaths(
            R(t, `store.preparePathEntries`, () => lt(r, e)),
          );
    }
    let r = R(t, `store.builder.finish`, () =>
    ...
    ((this.#e = R(t, `store.state.create`, () =>
      dt(r, i ? `open` : (e.initialExpansion ?? `closed`), t),
    )),
      i && (this.#e.collapseNewDirectoriesByDefault = !0));
    let a = i
      ? this.#e.snapshot.directories.size - 1
      : R(t, `store.state.initializeExpandedPaths`, () =>
    ...
    ((e.initialExpandedPaths?.length ?? 0) > 0 &&
      R(t, `store.state.checkAllDirectoriesExpanded`, () =>
        this.hasAllDirectoriesExpanded(),
      ))
      ? R(t, `store.state.initializeOpenVisibleCounts`, () => Cr(this.#e))
      : R(t, `store.state.recomputeCounts`, () =>
          an(this.#e, this.#e.snapshot.rootId),
        );
  }
  ...
  list(e) {
    return R(this.#e.instrumentation, `store.list`, () => Zt(this.#e, e));
  }
  add(e) {
    R(this.#e.instrumentation, `store.add`, () => {
      let t = er(this.#e);
      Rt(this.#e, It(this.#e, t, Qt(this.#e, e)));
    });
  }
  remove(e, t = {}) {
    R(this.#e.instrumentation, `store.remove`, () => {
      let n = er(this.#e);
      Rt(this.#e, It(this.#e, n, $t(this.#e, e, t)));
    });
  }
  move(e, t, n = {}) {
    R(this.#e.instrumentation, `store.move`, () => {
      let r = er(this.#e),
        i = en(this.#e, e, t, n);
      i != null && Rt(this.#e, It(this.#e, r, i));
    });
  }
  batch(e) {
    Lt(this.#e, () => {
  ...
  getVisibleCount() {
    return R(this.#e.instrumentation, `store.getVisibleCount`, () =>
      er(this.#e),
    );
  }
  getVisibleSlice(e, t) {
    return R(this.#e.instrumentation, `store.getVisibleSlice`, () =>
      or(this.#e, e, t),
    );
  }
  getVisibleRowContext(e) {
    return R(this.#e.instrumentation, `store.getVisibleRowContext`, () =>
      ar(this.#e, e),
    );
  }
  ...
  getVisibleIndex(e) {
    return R(this.#e.instrumentation, `store.getVisibleIndex`, () =>
      lr(this.#e, e),
    );
  }
  getPathInfo(e) {
    return R(this.#e.instrumentation, `store.getPathInfo`, () => {
      let t = sn(this.#e, e);
  ...
  isExpanded(e) {
    return R(this.#e.instrumentation, `store.isExpanded`, () => {
  ...
  expand(e) {
    R(this.#e.instrumentation, `store.expand`, () => {
      let t = er(this.#e),
        n = ur(this.#e, e);
      n != null && Rt(this.#e, It(this.#e, t, n));
    });
  }
  collapse(e) {
    R(this.#e.instrumentation, `store.collapse`, () => {
      let t = er(this.#e),
        n = dr(this.#e, e);
      n != null && Rt(this.#e, It(this.#e, t, n));
    });
  ...
  markDirectoryUnloaded(e) {
    R(this.#e.instrumentation, `store.markDirectoryUnloaded`, () => {
      let t = this.requireDirectoryNodeId(e);
      if (G(this.#e, t).childIds.length > 0)
        throw Error(
      ...
      (yt(this.#e, t),
        Rt(
          ...
          It(
            ...
            n,
            At({
              affectedAncestorIds: on(this.#e, t),
              affectedNodeIds: [t],
              path: e,
  ...
  beginChildLoad(e) {
    return R(this.#e.instrumentation, `store.beginChildLoad`, () => {
      let t = this.requireDirectoryNodeId(e),
        n = er(this.#e),
        r = vt(this.#e, t);
      return (
  ...
  applyChildPatch(e, t) {
    return R(this.#e.instrumentation, `store.applyChildPatch`, () => {
      let n = this.resolveActiveDirectoryNodeId(e.nodeId);
      if (
        n == null ||
        _t(this.#e, n) !== `loading` ||
        !xt(this.#e, n, e.attemptId)
      )
        return !1;
      let r = W(this.#e, n);
      ...
      for (let e of t.operations) {
        ...
        switch (e.type) {
          case `add`:
            a.push(It(this.#e, t, Qt(this.#e, e.path)));
            break;
          case `remove`:
            a.push(
              It(this.#e, t, $t(this.#e, e.path, { recursive: e.recursive })),
            );
            break;
          case `move`: {
            let n = en(this.#e, e.from, e.to, { collision: e.collision });
            n != null && a.push(It(this.#e, t, n));
            break;
          }
        }
      }
      ...
      return (
        Rt(
          ...
          It(
            ...
            i,
            Mt({
              affectedAncestorIds: on(this.#e, n),
              affectedNodeIds: [n],
              attemptId: e.attemptId,
              childEvents: a,
              path: W(this.#e, n),
  ...
  completeChildLoad(e) {
    return R(this.#e.instrumentation, `store.completeChildLoad`, () => {
      let t = this.resolveActiveDirectoryNodeId(e.nodeId);
      if (t == null) return !1;
      let n = er(this.#e),
        r = bt(this.#e, t, e.attemptId);
      return (
        Rt(
          this.#e,
          It(
  ...
  failChildLoad(e, t) {
    return R(this.#e.instrumentation, `store.failChildLoad`, () => {
      let n = this.resolveActiveDirectoryNodeId(e.nodeId);
      if (n == null) return !1;
      let r = er(this.#e),
        i = St(this.#e, n, e.attemptId, t);
      return (
        Rt(
          this.#e,
          It(
  ...
  cleanup(e = {}) {
    return R(this.#e.instrumentation, `store.cleanup`, () => {
  ...
  initializeExpandedPaths(e) {
    ...
    for (let u of e) {
      ...
      for (let e = d; e < m; e += 1) {
        ...
        if (n == null) continue;
        let i = K(this.#e, n);
        U(this.#e, n, i) || (ht(this.#e, n, !0, i), (t += 1));
      }
    }
    return t;
  }
  ...
  requireDirectoryNodeId(e) {
    ...
    if (!I(K(this.#e, t))) throw Error(`Path is not a directory: "${e}"`);
    return t;
  }
  ...
  isDirectoryProjectionVisible(e) {
    ...
    for (; t !== this.#e.snapshot.rootId; ) {
      let e = K(this.#e, t).parentId;
      if (e !== this.#e.snapshot.rootId) {
        let n = K(this.#e, e),
          r = Jt(this.#e, e);
        if (!U(this.#e, e, n) && r !== t) return !1;
      }
      t = e;
    }
    return !0;
...
function Or(e, t) {
  if (typeof e == `number`)
    return { itemHeight: t ?? Dr.default.itemHeight, factor: e };
  let n = Dr[e ?? `default`];
  return { itemHeight: t ?? n.itemHeight, factor: n.factor };
}
var kr = Dr.default.itemHeight,
  Ar = `@layer base, theme, unsafe;
...
function Fr(e) {
  ...
  return (n.remove(), Pr.set(e, i), i);
}
function Ir(e, t) {
  if (!e.isConnected) return;
  let n = Fr(t);
  if (n == null) return;
  let r = t.querySelector(`style[${A}]`),
    i = r instanceof HTMLStyleElement ? r : document.createElement(`style`);
  (r instanceof HTMLStyleElement || (i.setAttribute(A, ``), t.appendChild(i)),
    (i.textContent = `:host { ${ie}: ${n}px; }`));
}
var Lr;
function Rr(e) {
  if (
    ...
    Lr ?? ((Lr = new CSSStyleSheet()), Lr.replaceSync(Mr(Ar)));
    let t = !1;
    try {
      ((e.adoptedStyleSheets = [Lr]), (t = !0));
    } catch {}
    if (t) {
      e.querySelector(`style[${D}]`)?.remove();
      return;
    }
  }
  if (e.querySelector(`style[data-file-tree-style]`) == null) {
    let t = document.createElement(`style`);
    (t.setAttribute(D, ``), (t.textContent = Mr(Ar)), e.prepend(t));
  }
}
function zr(e, t) {
  (Br(e, t), Rr(t), Ir(e, t));
...
if (
  ...
  if ((customElements.define(E, e), typeof document < `u`))
    for (let e of Array.from(document.querySelectorAll(E)))
      e instanceof HTMLElement &&
        zr(e, e.shadowRoot ?? e.attachShadow({ mode: `open` }));
}
var Vr = (e) => (e.startsWith(`f::`) ? e.slice(3) : e);
function Hr(e) {
  let t = e.lastIndexOf(`/`);
  return t < 0
...
function Zr(e, t) {
  ...
  for (let n of e)
    if (Gr(n) && (t.directoryPath === n || t.directoryPath.startsWith(n)))
      return !0;
  return !1;
}
function Qr(e, t) {
  return t.kind === `root` || t.directoryPath == null ? Kr(e) : t.directoryPath;
}
function $r(e, t) {
  let n = e
    .map((e) => {
...
function gi(e, t, n = !1) {
  ...
  switch (t.operation) {
    ...
    case `cleanup`:
      return e;
    case `remove`:
      return hi(e, t.path) ? (n ? e : null) : e;
    case `move`:
      return mi(e, t.from, t.to);
    case `batch`: {
      let r = e;
      for (let e of t.events) if (((r = gi(r, e, n)), r == null)) return null;
      return r;
    }
  }
}
...
function yi(e, t, n) {
  ...
  if (!vi(Tr.preparePaths(r, n == null ? {} : { sort: n }), a))
    throw Error(
...
function bi(e) {
  switch (e.operation) {
    case `add`:
      return { ..._i(e), operation: `add`, path: e.path };
    case `remove`:
      return {
        ..._i(e),
        operation: `remove`,
    ...
    case `move`:
      return { ..._i(e), from: e.from, operation: `move`, to: e.to };
  }
}
function xi(e) {
  return {
...
function wi(e, t, n) {
  ...
  return {
    focusedIndex: Ci(e.paths.length, r, t),
    getParentIndex: e.getParentIndex,
    paths: e.paths,
    posInSetByIndex: e.posInSetByIndex,
    setSizeByIndex: e.setSizeByIndex,
...
var Ti = class {
    ...
    constructor(e) {
      let {
        ...
        u = yi({ paths: s, preparedInput: c }, `constructor`, l.sort);
      ((this.#e = l),
        ...
        (this.#B = this.#se(u.paths, u.preparedInput)));
      let d = i?.map((e) => this.#Ae(e)).filter((e) => e != null) ?? [],
        f = d.at(-1) ?? null;
      (d.length > 0 && ((this.#R = new Set(d)), (this.#L = f), (this.#z = 1)),
        this.#Oe(f, !1),
        r != null && this.#Se(r, !1),
        (this.#W = this.#Fe()));
    }
    ...
    focusFirstItem() {
      this.#ve().length > 0 && this.#Me(0);
    }
    focusLastItem() {
      this.#U <= 0 || (this.#Ne(), this.#Me(this.#U - 1));
    }
    focusNextItem() {
      this.#De(1);
    }
    ...
    focusPath(e) {
      let t = this.#B.getPathInfo(e)?.path ?? null;
      if (t == null) return;
      this.#Ne();
      let n = this.#Y(t);
      n >= 0 && this.#Me(n);
    ...
    focusNearestPath(e) {
      ...
      if (t == null) return null;
      let n = this.#Y(t);
      return n >= 0 ? (this.#Me(n), this.#ve()[n] ?? t) : null;
    }
    focusPreviousItem() {
      this.#De(-1);
    }
    ...
    getFocusedItem() {
      return this.#c == null ? null : this.#X(this.#c);
    }
    getFocusedPath() {
      return this.#c;
    }
    resolveNearestVisiblePath(e) {
      ...
      let n = this.#B.getPathInfo(e)?.path ?? e,
        r = this.#Y(n);
      return r >= 0 ? (t[r] ?? n) : (this.#J(n) ?? this.#c ?? t[0] ?? null);
    }
    getSelectedPaths() {
      return [...this.#R];
    }
    ...
    getVisibleRows(e, t) {
      if (t < e || this.#U === 0) return [];
      let n = Math.max(0, e),
        r = Math.min(this.#U - 1, t);
      if (r < n) return [];
      let i = r - n + 1;
      if (this.#F == null && !this.#l && r >= this.#b.length && i <= ri) {
        let e = [];
        for (let t = n; t <= r; t += 1) {
          let n = this.#B.getVisibleRowContext(t);
          if (n == null) break;
          e.push(this.#Q(n));
        }
        return e;
      }
      if ((!this.#l && r >= this.#b.length && this.#Ne(), this.#F != null)) {
        ...
        for (let n = 1; n <= e.length; n += 1) {
          ...
          if (
            (i >= 0 &&
              this.#B.getVisibleSlice(i, a).forEach((e, n) => {
                t.set(i + n, e);
              }),
            r == null)
          ) {
        ...
        return Array.from({ length: r - n + 1 }, (e, r) => {
          ...
          return this.#Z(o, i, a, { ancestorPaths: this.#te(a), path: s });
        });
      }
      return this.#B.getVisibleSlice(n, r).map((e, t) => {
        let r = n + t,
          i = this.#b[r];
        if (i == null)
          throw Error(`Missing projection path for visible index ${String(r)}`);
        return this.#Z(e, r, r, { ancestorPaths: this.#te(r), path: i });
      });
    }
    getStickyRowCandidates(e, t) {
      if (this.#F != null) return null;
      if (this.#U === 0 || e <= 0 || t <= 0) return [];
      let n = [];
      for (let r = 0; r < this.#U; r += 1) {
        let i = e + r * t,
          a = Math.min(this.#U - 1, Math.floor(i / t)),
          o = this.#$(a, r) ?? (a > 0 ? this.#$(a - 1, r) : void 0);
        if (o == null) break;
        n.push({ row: this.#Q(o), subtreeEndIndex: o.subtreeEndIndex });
      }
      return n;
    }
    getItem(e) {
      let t = this.#B.getPathInfo(e);
      return t == null ? null : this.#X(t.path, t);
    }
    selectAllVisiblePaths() {
      this.#Ne();
      let e = [...this.#ve()];
      this.#re(e, this.#c ?? this.#L);
    }
    selectOnlyPath(e) {
      let t = this.#Ae(e);
      t != null && this.#re([t], t);
    ...
    selectPath(e) {
      let t = this.#Ae(e);
      t == null || this.#R.has(t) || this.#re([...this.#R, t]);
    }
    deselectPath(e) {
      let t = this.#Ae(e);
      t == null ||
        !this.#R.has(t) ||
        this.#re([...this.#R].filter((e) => e !== t));
    }
    ...
    extendSelectionFromFocused(e) {
      ...
      let t = this.#s;
      if (t === -1) return;
      let n = Math.min(this.#U - 1, Math.max(0, t + e));
      if (n === t) return;
      !this.#l && n >= this.#b.length && this.#Ne();
      let r = this.#ve(),
        i = r[t] ?? null,
        a = r[n] ?? null;
      if (i == null || a == null) return;
      let o = new Set(this.#R);
      (o.has(i) && o.has(a) ? o.delete(i) : o.add(a),
        this.#re([...o], this.#L ?? i, !1),
        this.#Me(n));
    }
    ...
    setDragTarget(e) {
      ...
      let n = e;
      if (n != null) {
        let e = Xr(t.draggedPaths, n);
        (Zr(t.draggedPaths, n) || this.#r?.canDrop?.(e) === !1) && (n = null);
      }
      Yr(t.target, n) || ((this.#i = { ...t, target: n }), this.#we());
    }
    cancelDrag() {
      this.#i != null && ((this.#i = null), this.#we());
    }
    completeDrag() {
      let e = this.#i;
      if (e == null) return !1;
      ...
      if (t == null) return (this.#we(), !1);
      let n = Xr(e.draggedPaths, t);
      if (Zr(e.draggedPaths, t) || this.#r?.canDrop?.(n) === !1)
        return (this.#we(), !1);
      let r = $r(e.draggedPaths, t);
      if (r == null) return (this.#we(), !1);
      try {
        if (r.operations.length === 1) {
          ...
          this.#B.move(e.from, e.to, { collision: e.collision });
        } else (this.#oe(r.operations), this.#B.batch(r.operations));
      } catch (e) {
        return (
          this.#we(),
    ...
    startRenaming(e = this.#c ?? ``, t = {}) {
      if (!this.#w) return !1;
      let n = this.#B.getPathInfo(e);
      if (n == null) return !1;
      let r = n.path,
        i = ui(r),
        a = fi(r);
      if (this.#C?.({ isFolder: i, path: a }) === !1) return !1;
      for (let e of ai(r)) this.#B.isExpanded(e) || this.#B.expand(e);
      return (
        this.#re([r], r, !1),
        this.#M != null && (this.#Se(null, !1), this.#y?.(this.#M)),
        this.#je(r),
        (this.#T = r),
        (this.#E = di(r)),
    ...
    #G() {
      ...
      if (((this.#T = null), (this.#E = ``), (this.#D = !1), t)) {
        this.remove(e, ui(e) ? { recursive: !0 } : void 0);
        return;
      }
      (this.#je(e), this.#we());
    }
    #K() {
      ...
      if (((this.#T = null), (this.#E = ``), (this.#D = !1), `error` in n)) {
        (this.#je(e), this.#v?.(n.error), this.#we());
        return;
      }
      ...
      (this.#_?.({
        ...
        this.move(pi(n.sourcePath, t), pi(n.destinationPath, t)));
    }
    #q(e) {
      this.#T == null || this.#E === e || ((this.#E = e), this.#we());
    }
    resetPaths(e, t = {}) {
      let n = this.#B.list().length,
        r = this.#U,
        i = yi(
        ...
        a = this.#se(i.paths, i.preparedInput, t.initialExpandedPaths),
        o = this.#c,
        s = this.#T,
        c = this.getSelectedPaths(),
        l = this.#L;
      (this.#W?.(), (this.#B = a), this.#d.clear(), this.#pe());
      let u = c
      ...
      ((this.#R = new Set(u)),
        d && (this.#z += 1),
        (this.#L = l == null ? null : (a.getPathInfo(l)?.path ?? null)),
        (this.#T = s == null ? null : (a.getPathInfo(s)?.path ?? null)),
        this.#T ?? ((this.#E = ``), (this.#D = !1)),
        this.#Oe(o, o != null || u.length > 0 || this.#L != null),
        (this.#W = this.#Fe()),
        this.#we(),
        this.#Te({
          canonicalChanged: !0,
    ...
    #Y(e) {
      ...
      return this.#ve().length > 0 ? 0 : -1;
    }
    #X(e, t) {
      let n = this.#d.get(e);
      if (n != null) return n;
      let r = t ?? this.#B.getPathInfo(e);
      if (r == null) return null;
      let i = r.kind === `directory` ? this.#ie(r.path) : this.#ae(r.path);
    ...
    #Q(e) {
      return this.#Z(e.row, e.index, e.index, {
    ...
    #$(e, t) {
      let n = this.#B.getVisibleRowContext(e);
      return n == null
        ? void 0
        : (n.ancestorRows[t] ??
    ...
    #ie(e) {
      return {
        ...
        getPath: () => e,
        isDirectory: () => !0,
        isExpanded: () => this.#B.isExpanded(e),
        isFocused: () => this.#c === e,
        isSelected: () => this.#R.has(e),
        select: () => {
          this.selectPath(e);
        },
        toggleSelect: () => {
    ...
    #ce() {
      return ((this.#h ??= this.#B.list()), this.#h);
    }
    #le() {
      ...
      for (let t of this.#ce()) {
        e.add(t);
        for (let n of ai(t)) e.add(n);
      }
      return ((this.#m = [...e].sort()), this.#m);
    }
    #ue() {
      return ((this.#g ??= this.#ce().map(li)), this.#g);
    }
    #de() {
      return ((this.#f ??= this.#le().filter((e) => e.endsWith(`/`))), this.#f);
    }
    #fe() {
      return ((this.#p ??= this.#de().map(li)), this.#p);
    }
    #pe() {
      ((this.#f = null),
        (this.#p = null),
    ...
    #me() {
      return this.#de().filter((e) => this.#B.isExpanded(e));
    }
    #he(e) {
      let t = new Set(this.#j ?? []);
      if (e) for (let e of this.#R) for (let n of ai(e)) t.add(n);
      this.#ge(t);
    }
    #ge(e) {
      this.#H = !0;
      try {
        for (let t of this.#de()) {
          let n = e.has(t),
            r = this.#B.isExpanded(t);
          n && !r ? this.#B.expand(t) : !n && r && this.#B.collapse(t);
        }
      } finally {
        this.#H = !1;
      }
    ...
    #_e() {
      ...
      ((this.#F = t), (this.#I = n), (this.#P = r), (this.#U = n.length));
    }
    #ve() {
    ...
    #be(e) {
      return this.#P?.get(e) ?? this.#B.getVisibleIndex(e) ?? -1;
    }
    #xe(e) {
      let t = this.#k;
      if (t.length === 0) return;
    ...
    #Se(e, t) {
      let n = e == null ? null : ci(e),
        r = this.#M;
      if (r !== n) {
        if (
          (r == null && n != null && (this.#j = this.#me()),
          (this.#M = n),
          n == null)
        )
          (this.#he(!0),
    ...
    #Ce() {
      ...
      for (let e of r) {
        ...
        for (let t of ai(e)) (l.add(t), c?.add(t));
      }
      return (this.#ge(l), a ?? this.#c);
    }
    #we() {
    ...
    #Ee(e) {
      for (let t of ai(e)) this.#B.isExpanded(t) || this.#B.expand(t);
      this.#B.isExpanded(e) || this.#B.expand(e);
    }
    #De(e) {
      let t = this.#U;
      if (t === 0) return;
      ...
      (r !== n || this.#s === -1) &&
        (!this.#l && this.#F == null && r >= this.#b.length && this.#Ne(),
        this.#Me(r));
    }
    #Oe(e, t = !0) {
      let n = this.#B.getVisibleCount();
      this.#V = n;
      let r = wi(
        this.#B.getVisibleTreeProjectionData(t ? void 0 : Math.min(n, ni)),
        e,
        t ? (e) => this.#B.getVisibleIndex(e) : void 0,
      );
      (this.#a.clear(),
        this.#o.clear(),
        ...
        this.#_e(),
        (this.#s = e == null ? (this.#ve().length > 0 ? 0 : -1) : this.#Y(e)),
        (this.#c = this.#s < 0 ? null : this.#ke(this.#s)));
    }
    #ke(e) {
      return (
        this.#ve()[e] ??
        (this.#F == null
          ? (this.#B.getVisibleRowContext(e)?.row.path ?? null)
          : null)
      );
    }
    #Ae(e) {
      return this.#B.getPathInfo(e)?.path ?? null;
    }
    #je(e) {
      if (e == null) return;
      let t = this.#Y(e);
    ...
    #Me(e, t = !0) {
      ...
      n != null &&
        ((this.#s === e && this.#c === n) ||
          ((this.#s = e), (this.#c = n), t && this.#we()));
    }
    #Ne() {
      this.#l || this.#Oe(this.#c, !0);
    }
    #Pe(e) {
      let t = gi(this.#T, e);
      ...
      let n = gi(this.#c, e, !0),
        r = [...this.#R]
          .map((t) => gi(t, e))
          .filter((e) => e != null)
          .map((e) => this.#B.getPathInfo(e)?.path ?? null)
          .filter((e) => e != null),
        i = gi(this.#L, e),
        a = i == null ? null : (this.#B.getPathInfo(i)?.path ?? null),
        o = [...new Set(r)];
      return (
        ii(this.#R, o) || ((this.#R = new Set(o)), (this.#z += 1)),
        (this.#L = a),
        n
      );
    }
    #Fe() {
      return this.#B.on(`*`, (e) => {
        if (this.#H) return;
        (e.canonicalChanged && (this.#d.clear(), this.#pe()),
          this.#i != null && ti(e) && (this.#i = null));
        let t = ti(e) ? this.#Pe(e) : this.#c,
          n =
...
function Ai(e, t = null) {
  ...
  for (let t of e ?? []) {
    let e = Di(t.path);
    if (e == null) continue;
    let n = ki(e.path, e.isDirectory);
    (r.set(n, t.status),
      t.status === `ignored` && e.isDirectory
        ? a.add(n)
        : e.isDirectory && a.delete(n));
    for (let t of Oi(e.path)) i.add(t);
  }
  return {
...
function Ki(e, t, n) {
  ...
  return (
    arguments.length > 2 &&
      (o.children = arguments.length > 3 ? Ui.call(arguments, 2) : n),
    qi(e, o, r, i, null)
  );
}
...
function Xi(e, t) {
  if (t == null) return e.__ ? Xi(e.__, e.__i + 1) : null;
...
function Qi(e) {
  ((8 & e.__g || !(e.__g |= 8) || !Mi.push(e) || Pi++) &&
    Ni == q.debounceRendering) ||
    ((Ni = q.debounceRendering) || queueMicrotask)($i);
}
function $i() {
  for (var e, t, n, r, i, a, o, s, c = 1; Mi.length; )
    (Mi.length > c && Mi.sort(Fi),
      (e = Mi.shift()),
      (c = Mi.length),
      8 & e.__g &&
        ((n = void 0),
...
function ea(e, t, n, r, i, a, o, s, c, l, u, d) {
  var f,
    ...
    y = (r && r.__k) || Vi,
    b = t.length;
  for (c = ta(n, t, y, c, b), f = 0; f < b; f++)
    (m = n.__k[f]) != null &&
      ((p = m.__i == -1 ? Bi : y[m.__i] || Bi),
      (m.__i = f),
      (_ = sa(e, m, p, i, a, o, s, c, l, u, d)),
      (h = m.__e),
      m.ref &&
        p.ref != m.ref &&
        (p.ref && fa(p.ref, null, m), u.push(m.ref, m.__c || h, m)),
      g == null && h != null && (g = h),
      ...
      ? ((c = a + f),
        ((o = e.__k[a] =
          ...
          o.constructor == String
            ? qi(null, o, null, null, null)
            : Hi(o)
              ? qi(Ji, { children: o }, null, null, null)
              : o.constructor == null && o.__b > 0
                ? qi(o.type, o.props, o.key, o.ref ? o.ref : null, o.__v)
                : o).__ = e),
        (o.__b = e.__b + 1),
        (s = null),
        (l = o.__i = ra(o, n, c, d)) != -1 && (d--, (s = n[l]) && (s.__u |= 2)),
        s == null || s.__v == null
          ? (l == -1 && (i > u ? f-- : i < u && f++),
...
function na(e, t, n, r) {
  ...
  if (typeof e.type == `function`) {
    for (i = e.__k, a = 0; i && a < i.length; a++)
      i[a] && ((i[a].__ = e), (t = na(i[a], t, n, r)));
    return t;
  }
  e.__e != t &&
    (r &&
      (t && e.type && !t.parentNode && (t = Xi(e)),
  ...
  n: if (t == `style`)
    if (typeof n == `string`) e.style.cssText = n;
      ...
      if ((typeof r == `string` && (e.style.cssText = r = ``), r))
        for (t in r) (n && t in n) || ia(e.style, t, ``);
      if (n) for (t in n) (r && n[t] == r[t]) || ia(e.style, t, n[t]);
    }
  else if (t[0] == `o` && t[1] == `n`)
    ((a = t != (t = t.replace(Ii, `$1`))),
      ...
      n
        ? r
          ? (n.l = r.l)
          : ((n.l = Li), e.addEventListener(t, a ? zi : Ri, a))
        : e.removeEventListener(t, a ? zi : Ri, a));
  else {
...
function sa(e, t, n, r, i, a, o, s, c, l, u) {
  var d,
    f,
    p,
    m,
    ...
    try {
      if (
        ...
        y &&
          ...
          (f.__s == f.state && (f.__s = Wi({}, f.__s)),
          Wi(f.__s, O.getDerivedStateFromProps(v, f.__s))),
        (m = f.props),
        (h = f.state),
        (f.__v = t),
        p)
      ...
      if (
        ...
        while (8 & f.__g && ++ee < 25);
      ((f.state = f.__s),
        f.getChildContext != null && (r = Wi({}, r, f.getChildContext())),
        y &&
          !p &&
        ...
        d != null &&
          d.type === Ji &&
          d.key == null &&
          (ne = ua(d.props.children)),
        (s = ea(e, Hi(ne) ? ne : [ne], t, n, r, i, a, o, s, c, l, u)),
        (t.__u &= -161),
      ...
      if (((t.__v = null), c || a != null))
        if (e.then) {
          for (
            w = 0, re = !1, t.__u |= c ? 160 : 128, t.__c.__z = [], T = 0;
            T < a.length;
            T++
          )
            (E = a[T]) == null ||
              re ||
              (E.nodeType == 8 && E.data == `$s`
                ? (w > 0 && t.__c.__z.push(E), w++, (a[T] = null))
                : E.nodeType == 8 && E.data == `/$s`
                  ? (--w > 0 && t.__c.__z.push(E),
                    (re = w === 0),
                    (s = a[T]),
                    (a[T] = null))
                  : w > 0 && (t.__c.__z.push(E), (a[T] = null)));
          if (!re) {
          ...
          for (D = a.length; D--; ) Gi(a[D]);
          ca(t);
        }
      else ((t.__e = n.__e), (t.__k = n.__k), e.then || ca(t));
      q.__e(e, t, n);
    }
  else s = t.__e = da(n.__e, t, n, r, i, a, o, c, l, u);
  return ((d = q.diffed) && d(t), 128 & t.__u ? void 0 : s);
}
function ca(e) {
  (e && e.__c && (e.__c.__g |= 4), e && e.__k && e.__k.forEach(ca));
}
function la(e, t, n) {
  for (var r = 0; r < n.length; r++) fa(n[r], n[++r], n[++r]);
  (q.__c && q.__c(t, e),
    e.some(function (t) {
      try {
        ((e = t.__h),
...
function da(e, t, n, r, i, a, o, s, c, l) {
  ...
  if (b == null) v === y || (s && e.data == y) || (e.data = y);
    ...
    if (((a &&= Ui.call(e.childNodes)), (v = n.props || Bi), !s && a != null))
...
function pa(e, t, n) {
  ...
  if ((r = e.__k))
    for (i = 0; i < r.length; i++)
      r[i] && pa(r[i], t, n || typeof e.type != `function`);
  (n || Gi(e.__e),
...
function ha(e, t) {
  ...
  (t == document && (t = document.documentElement),
    ...
    sa(
      ...
      Bi,
      t.namespaceURI,
      r ? null : t.firstChild ? Ui.call(t.childNodes) : null,
      i,
  ...
  (Yi.prototype.setState = function (e, t) {
    var n =
      this.__s != null && this.__s != this.state
        ? this.__s
        : (this.__s = Wi({}, this.state));
    (typeof e == `function` && (e = e(Wi({}, n), this.props)),
      e && Wi(n, e),
      e != null && this.__v && (t && this._sb.push(t), Qi(this)));
  }),
  (Yi.prototype.forceUpdate = function (e) {
    this.__v && ((this.__g |= 4), e && this.__h.push(e), Qi(this));
  }),
  (Yi.prototype.render = Ji),
  (Mi = []),
  (Pi = 0),
  (Fi = function (e, t) {
    return e.__v.__b - t.__v.__b;
  }),
  (Ii = /(PointerCapture)$|Capture$/i),
  (Li = 0),
  (Ri = oa(!1)),
  (zi = oa(!0)));
var _a = 0;
...
function xa({
  ...
  "use no memo";
  let c = `#${e.replace(/^#/, ``)}`,
    { width: l, height: u, viewBox: d } = ba[e] ?? { width: va, height: ya },
    f = r ?? l,
    p = i ?? u,
    m = a ?? d ?? `0 0 ${l} ${u}`,
...
function Oa({ children: e, marker: t, variant: n = `default` }) {
  "use no memo";
  let r = n === `fade`;
  return J(`div`, {
    "aria-hidden": !0,
...
function ka(e) {
  ...
  return J(`div`, {
    children: [
      J(`div`, {
        "data-truncate-content": `visible`,
        children: t === `fruncate` ? J(`span`, { children: n }) : n,
      }),
      J(`div`, {
        "data-truncate-content": `overflow`,
        "aria-hidden": !0,
...
function Aa({
  ...
  "use no memo";
  let a = J(ka, { mode: t, children: e }, `content`),
    o = J(Oa, { marker: n, mode: t, variant: r }, `marker`),
    s = J(`div`, { "data-truncate-fill": !0 }, `fill`);
  return J(`div`, {
...
function ja({ children: e, ...t }) {
  "use no memo";
  return J(Aa, { mode: `truncate`, ...t, children: e });
}
function Ma({ children: e, ...t }) {
  "use no memo";
  return J(Aa, { mode: `fruncate`, ...t, children: e });
}
function Na({
  children: e,
  contents: t,
  ...
  if (Array.isArray(t)) {
    ...
    ((c = J(ja, { ...s, children: t[0] })),
      (l = J(Ma, { ...s, children: t[1] })));
  } else {
    if (typeof e != `string`)
      return (console.error(`MiddleTruncate: children must be a string`), null);
    if (e.length === 0) return J(`div`, { className: a, style: o });
    if (e.length < i)
      return J(n === `end` ? Ma : ja, {
        ...s,
        className: a,
        style: o,
        children: e,
    ...
    if (typeof r == `string`)
      r === `center`
        ...
        : r === `extension`
          ? (t = Ca)
          : r === `leaf-path` && (t = wa);
    else if (typeof r == `number`) ((t = Ta), (u = r));
    else if (Array.isArray(r)) {
      let [e, n] = r;
      ((d = n), e === `last` ? (t = Ea) : e === `first` && (t = Da));
    ...
    (h && (_.marker = ``),
      g && (v.marker = ``),
      (c = J(ja, { ...s, ..._, children: f })),
      (l = J(Ma, { ...s, ...v, children: p })));
  }
  return J(`div`, {
    "data-truncate-group-container": `middle`,
    className: a,
...
var Pa = { endIndex: -1, startIndex: -1 };
function Fa(e, t, n) {
  return Math.min(Math.max(e, t), n);
}
function Ia(e, t) {
  return e < 0 || t < e ? Pa : { endIndex: t, startIndex: e };
}
function La(e) {
  return e.startIndex < 0 || e.endIndex < e.startIndex;
}
function Ra(e, t) {
  return La(e) ? 0 : (e.endIndex - e.startIndex + 1) * t;
}
function za(e, t, n) {
  if (t <= 0) return -1;
  let r = t * n;
...
function Wa(e, t, n) {
  ...
  for (let r = 0; r < e.length; r += 1) {
    ...
    let s = t + r * n,
      c = Ha(o, Math.min(e.length - 1, Math.floor(s / n))),
      l = null;
    for (; c >= 0; ) {
      let t = o[c],
...
function Ga(e, t) {
  let n = t.totalRowCount ?? e.length,
    ...
    o = Math.max(0, r - i),
    s = Fa(t.scrollTop, 0, o),
    c = t.stickyRows ?? Wa(e, s, t.itemHeight),
    l = c.reduce((e, n) => Math.max(e, n.top + t.itemHeight), 0),
    u = Math.min(r, s + l),
    d = Math.max(0, i - l),
    f = Math.max(0, r - u),
    p = za(s, n, t.itemHeight),
    m = za(u, n, t.itemHeight),
    h = l <= 0 || p < 0 || p >= n ? -1 : p,
    g = h === -1 ? -1 : Math.min(n - 1, m - 1),
    _ = h === -1 || g < h ? 0 : g - h + 1,
    v = d <= 0 || m >= n ? Pa : Ia(m, Ba(u + d, n, t.itemHeight)),
    y = g + 1,
    b = La(v)
      ? Pa
      : Ia(Math.max(y, v.startIndex - a), Math.min(n - 1, v.endIndex + a)),
    x = Ra(b, t.itemHeight);
  return {
    occlusion: {
    ...
    window: {
      endIndex: b.endIndex,
      height: x,
      offsetTop: La(b) ? 0 : b.startIndex * t.itemHeight,
      ...
      ((r.__ = [
        ...
        function (e) {
          var t = r.__N ? r.__N[0] : r.__[0],
            n = r.t(t, e);
          ro(t, n) || ((r.__N = [n, r.__[1]]), r.__c.setState({}));
        },
      ]),
      (r.__c = Y),
      !Y.__f))
    ...
    var i = function (e, t, n) {
      ...
      return (
        i.forEach(function (e) {
          if (e.__N) {
            var t = e.__[0];
            ((e.__ = e.__N), (e.__N = void 0), ro(t, e.__[0]) || (o = !0));
          }
        }),
...
function go(e, t) {
  var n = po(eo++, 3);
  !X.__s && To(n.__H, t) && ((n.__ = e), (n.u = t), Y.__H.__h.push(n));
}
function _o(e, t) {
  var n = po(eo++, 4);
  !X.__s && To(n.__H, t) && ((n.__ = e), (n.u = t), Y.__h.push(n));
}
function Z(e) {
  return (
    (io = 5),
...
function bo() {
  for (var e; (e = ao.shift()); )
    if (e.__P && e.__H)
      try {
        (e.__H.__h.forEach(Co), e.__H.__h.forEach(wo), (e.__H.__h = []));
      } catch (t) {
...
((X.__b = function (e) {
  ...
  (X.__ = function (e, t) {
    (e && t.__k && t.__k.__m && (e.__m = t.__k.__m), fo && fo(e, t));
  }),
  (X.__r = function (e) {
    (so && so(e), (eo = 0));
    var t = (Y = e.__c).__H;
    (t &&
      (to === Y
        ...
        : (t.__h.forEach(Co), t.__h.forEach(wo), (t.__h = []), (eo = 0))),
      (to = Y));
  }),
  (X.diffed = function (e) {
    co && co(e);
    ...
    (t &&
      t.__H &&
      (t.__H.__h.length &&
        ((ao.push(t) !== 1 && no === X.requestAnimationFrame) ||
          ((no = X.requestAnimationFrame) || So)(bo)),
...
function So(e) {
  var t,
    n = function () {
      (clearTimeout(r), xo && cancelAnimationFrame(t), setTimeout(e));
    },
    r = setTimeout(n, 35);
  xo && (t = requestAnimationFrame(n));
}
function Co(e) {
  var t = Y,
    n = e.__c;
            ...
            Ji,
            {
              children: [
                J(`span`, {
                  ...
                  children: a && t != null ? t : J(ja, { children: e.name }),
                }),
                i < r.length - 1 ? ` / ` : ``,
              ],
            },
...
function Fo({
  ...
  let o = e.getVisibleCount(),
    ...
    l = Ga(c, {
      ...
      overscan: n,
      scrollTop: r,
      stickyRows: s == null ? void 0 : No(s, r, t, o),
      totalRowCount: o,
      viewportHeight: a,
    }),
...
function qo(e, t) {
  if (e != null) {
    let t = Ka[e];
    return t == null ? null : { text: t, title: qa[e] };
  }
  return t
    ? { icon: { name: `file-tree-icon-dot`, width: 6, height: 6 }, title: Ja }
    : null;
}
function Jo(e, t, n) {
...
function Qo(e, t) {
  return e?.clientHeight != null && e.clientHeight > 0 ? e.clientHeight : t;
}
...
function us(e, t, n) {
  return e == null ? null : (t.get(e) ?? n.get(e) ?? null);
}
function ds(e, t) {
  return { kind: e.kind, name: Mo(e), path: t };
}
function fs(e) {
...
function hs(e, t) {
  if (e == null) return null;
  if (`text` in e) return J(`span`, { title: e.title, children: e.text });
  let n =
    typeof e.icon == `string`
      ...
      : ms(e.icon.name)
        ...
        : e.icon;
  return J(`span`, { title: e.title, children: J(xa, { ...n }) });
}
function gs(e) {
  e != null &&
    Do(
  ...
  return J(Ji, {
    children: [
      ...
      J(`div`, {
        ...
        children:
          e.kind === `directory`
            ? J(xa, { ...t(`file-tree-icon-chevron`) })
            : J(xa, { ...t(`file-tree-icon-file`, u) }),
      }),
      J(`div`, {
        "data-item-section": `content`,
        children: e.isFlattened
          ? Ao(e, c, a)
          : (c ??
            J(Na, { minimumLength: 5, split: `extension`, children: e.name })),
      }),
      i
        ? J(`div`, {
            "data-item-section": `decoration`,
            children: r == null ? null : hs(r, t),
          })
        : null,
      s ? J(`div`, { "data-item-section": `git`, children: hs(o, t) }) : null,
      n
        ? J(`div`, {
            "data-item-section": `action`,
            children: l
              ? J(`span`, {
                  "aria-hidden": `true`,
                  "data-item-action-affordance": `decorative`,
                  children: J(xa, { ...t(`file-tree-icon-ellipsis`) }),
                })
              : null,
          })
        : null,
...
function vs(e, t, n, r = {}) {
  let {
      ...
      contextMenuRightClickEnabled: ne,
      registerRenameInput: w,
      registerButton: re,
      resolveIcon: T,
      renderDecorationForRow: E,
      openContextMenuForRow: D,
      onRowClick: O,
      onKeyDown: k,
    } = e,
    A = jo(t),
    { isParked: ie = !1, mode: ae = `flow`, style: oe } = r,
    se = ae === `sticky`,
    ce = _?.get(A) ?? null ?? Jo(t.ancestorPaths, v, y),
    le = t.kind === `directory` && (b?.has(A) ?? !1),
    ue = E(t, A),
    j = qo(ce, le),
    de = S && ee,
    M = ue != null || x || de,
    ...
    he = _s(t, T, {
      ...
      customDecoration: ue,
      decorationLaneEnabled: M,
      dragTargetFlattenedSegmentPath: l?.flattenedSegmentPath ?? null,
      gitDecoration: j,
      gitLaneActive: x,
      renameInput: me,
      showDecorativeActionAffordance: fe,
    }),
    ge = {
      ...Xa({
        ariaLabel: Mo(t),
        domId: t.isFocused ? ps(h, A, ie) : void 0,
        extraStyle: oe,
        features: {
          actionLaneEnabled: de,
        ...
        row: t,
        state: {
          containsGitChange: le,
          effectiveGitStatus: ce,
          ...
          ? (e) => {
              ...
              S &&
                ...
                ne &&
                  (i.focusPath(A),
                  D(t, A, {
                    anchorRect: ss(e.clientX, e.clientY),
                    source: `right-click`,
                  })));
            }
          : void 0,
      ...
      onKeyDown: se ? void 0 : k,
      ref: (e) => {
        re(A, e);
      },
    };
  return !se && N
    ? J(`div`, { ...ge, children: he })
    : J(`button`, {
        ...ge,
        type: `button`,
        draggable: u && !ie,
        onDragEnd: u && !ie ? p : void 0,
        onDragStart:
          u && !ie
            ? (e) => {
                f(e, t, A);
...
function bs({
  ...
  let z =
    ...
    Fe = e?.contextMenu?.triggerMode ?? (z ? `right-click` : `both`),
    Ie = Fe === `both` || Fe === `button`,
    Le = e?.contextMenu?.buttonVisibility ?? `when-needed`,
    Re = Fe === `both` || Fe === `right-click`;
  _o(() => {
    let e = S.current;
    if (e == null) return;
    let t = (e) => {
        ...
        ((L.current = t), be(t), P(t == null ? null : `pointer`));
      },
      n = (e) => {
        e instanceof CustomEvent && (Ee.current = e.detail?.disabled === !0);
      };
    return (
  ...
  let ze = yo((e, t) => {
    ...
    He = yo((e) => us(e, ne.current, te.current), []),
    Ue = n != null || r != null || i != null,
    { resolveIcon: We } = vo(() => w(a), [a]),
    Ge = t[ei](),
    Ke = Ge.getPath(),
    qe = Ke != null,
    Je = t.isSearchOpen(),
    ...
    B = t.getFocusedPath(),
    V = t.getFocusedIndex(),
    Xe = t.isDragAndDropEnabled(),
    Ze = t.getDragSession(),
    Qe = vo(() => (Ze == null ? null : new Set(Ze.draggedPaths)), [Ze]),
    $e = Ze?.target ?? null,
    et = Ze?.primaryPath ?? null,
    tt = fs(o),
    { overlayHeight: nt, overlayRows: rt, snapshot: H, visibleRows: it } = je,
    at = H.physical.viewportHeight,
    ot = vo(
      () => ({ end: H.window.endIndex, start: H.window.startIndex }),
      [H.window.endIndex, H.window.startIndex],
    ),
    st = rt,
    ct = H.sticky.rows,
    lt = H.physical.totalHeight,
    ut = H.sticky.height,
    dt = vo(() => new Set(ct.map((e) => jo(e.row))), [ct]),
    ft = V >= 0 && V >= ot.start && V <= ot.end,
    pt = yo((e, t) => u?.({ item: ds(e, t), row: e }) ?? null, [u]),
    mt = yo(
      (e) =>
        Do(e == null ? null : (te.current.get(e) ?? null)) ? !0 : Do(S.current),
      [],
    ),
    U = yo(
      (e) => {
        mt(t.focusNearestPath(e));
      },
      [t, mt],
    ),
    ht = Z(U);
  ...
  _t.current = vt;
  let yt = yo((e) => {
      let t = e == null ? null : cs(S.current, e);
      Se((e) => (e === t ? e : t));
    }, []),
    bt = yo(
      (e, n, r) => {
          ...
          if (t.isSearchOpen()) {
            ...
            ((k.current =
              V < 0 || e == null
                ...
                : Math.max(
                    0,
                    Math.min(V * s - e.scrollTop, Math.max(0, t - s)),
                  )),
              (O.current = !0));
          }
          t.startRenaming(e) !== !1 && (P(`focus`), ge((e) => e + 1));
        }
      },
      [t, V, s, l, at],
    ),
    ...
    Ct = () => me.current != null || M.current === !0,
    wt = (e) =>
    ...
    Et = () => {
      (ce.current != null && (clearTimeout(ce.current), (ce.current = null)),
        (ie.current = null));
    },
    Dt = () => {
      (ue.current?.remove(), (ue.current = null));
    },
    Ot = () => {
      (Tt(A.current), (A.current = null), (le.current = null));
    },
    kt = (e) => {
    ...
    At = () => {
      (de.current?.(),
        ...
        (pe.current = null),
        N.current != null &&
          (N.current.setAttribute(`draggable`, `true`),
          N.current.style.removeProperty(`touch-action`),
          (N.current = null)),
        Dt(),
        Et(),
        Ot(),
    ...
    jt = (e, n) => {
      let r = S.current?.getRootNode(),
        i = Uo(Vo(r instanceof ShadowRoot ? r : document, e, n));
    ...
    Nt = () => {
      ...
      (o !== n.scrollTop && ((n.scrollTop = o), re.current()),
        Mt(jt(e.clientX, e.clientY)),
        (A.current = wt(Nt)));
    },
    Pt = (e, t) => {
      ((le.current = { clientX: e, clientY: t }), (A.current ??= wt(Nt)));
    },
    Ft = (e, n, r) => {
      let i = e.currentTarget;
      if (i != null) {
        if ((At(), Dt(), Et(), Ot(), t.startDrag(r) === !1)) {
          e.preventDefault();
          return;
        }
        if (
    ...
    It = () => {
      (Dt(), Et(), Ot(), (j.current = null), t.cancelDrag());
    },
    Lt = (e, n, r) => {
      if (me.current != null || M.current) return;
      let i = e.touches[0],
        a = e.currentTarget;
      if (i == null || a == null) return;
      ...
      let o = (e = {}) => {
          let t = e.restoreNativeDraggable ?? !M.current;
          (me.current != null &&
            (clearTimeout(me.current), (me.current = null)),
      ...
      (document.addEventListener(`touchmove`, s, { passive: !0 }),
        ...
        (me.current = setTimeout(() => {
          ...
          (Object.assign(s.style, {
            ...
            kt(s),
            (ue.current = s),
            (fe.current = { x: i.clientX - e.left, y: i.clientY - e.top }));
          let c = (e) => {
              let t = e.touches[0];
              if (t == null) return;
              e.preventDefault();
              ...
              (n != null &&
                ue.current != null &&
                (ue.current.style.transform = `translate3d(${t.clientX - n.x}px, ${t.clientY - n.y}px, 0)`),
                Mt(jt(t.clientX, t.clientY)),
                Pt(t.clientX, t.clientY));
            },
            l = (e) => {
              let n = e.changedTouches[0];
              (n != null && jt(n.clientX, n.clientY), t.completeDrag(), At());
            },
            u = () => {
              (t.cancelDrag(), At());
            };
    ...
    Rt = (e) => {
      if (F != null) {
        if (e.key === `Escape`) {
          (vt(), e.preventDefault(), e.stopPropagation());
          return;
        }
        is.has(e.key) && (e.preventDefault(), e.stopPropagation());
        return;
      }
      if (Ge.isActive()) {
        if (e.key === `Escape`) Ge.cancel();
        else if (e.key === `Enter`) Ge.commit();
        else return;
        (P(`focus`), ge((e) => e + 1), e.preventDefault(), e.stopPropagation());
        return;
      }
      if (l && e.key === `F2`) {
        (xt(B ?? void 0), e.preventDefault(), e.stopPropagation());
        return;
      }
      if (Je) {
        if (e.key === `Escape`)
          ((O.current = !1), (k.current = null), t.closeSearch());
        else if (e.key === `Enter`) {
      ...
      if (e.shiftKey && e.key === `ArrowDown`) t.extendSelectionFromFocused(1);
      ...
      else if (z && rs(e) && B != null && V >= 0) {
        let e = t.getVisibleRows(V, V)[0] ?? null,
          n = te.current.get(B) ?? null;
        e == null || n == null ? (i = !1) : bt(e, B);
      } else if ((e.ctrlKey || e.metaKey) && Xo(e)) t.toggleFocusedSelection();
        ...
        switch (e.key) {
          ...
          case `ArrowUp`:
            ...
            break;
          case `ArrowRight`:
            r == null || r.isExpanded() ? t.focusNextItem() : r.expand();
            break;
          case `ArrowLeft`:
            r != null && r.isExpanded() ? r.collapse() : t.focusParentItem();
            break;
          case `Home`:
            t.focusFirstItem();
            break;
  ...
  (_o(() => {
    ...
    _o(() => {
      ...
      switch (
        Ya({
          ...
          previousRenamingPath: D.current,
          renamingPath: Ke,
        })
      ) {
        case `reset`:
        ...
        case `reveal-canonical`:
          Ke != null &&
            St(Ke, { restoreTreeFocus: !1, targetOffset: `live-overlay` });
          return;
        case `ignore`:
          return;
        case `focus-input`:
          e != null &&
            ((Te.current = null), (D.current = Ke), Do(e), e.select());
          return;
      }
    }, [ot.end, ot.start, Ke, St, dt]),
    _o(() => {
      let e = S.current;
      if (e == null) return;
      let t = () => {
          let t = Oo(e)?.dataset.itemPath ?? null;
          ve((e) => (e === t ? e : t));
        },
        n = () => {
          ((T.current = !0), t());
    ...
    _o(() => {
      let e = S.current;
      e != null &&
        (H.physical.scrollTop <= 0
          ? (e.dataset.scrollAtTop = `true`)
          : delete e.dataset.scrollAtTop);
    }, [H.physical.scrollTop]),
    _o(() => {
      S.current?.dispatchEvent(
        new CustomEvent(Bo, { bubbles: !0, composed: !0 }),
      );
    }, [
      H.physical.scrollTop,
      H.physical.totalHeight,
      H.physical.viewportHeight,
      H.sticky.height,
      H.window.endIndex,
      H.window.startIndex,
    ]),
      ...
      let o = !1,
        ...
        m = () => {
          if (
            (a(),
            n.scrollTop > 0 && f(),
            I.current != null && y.current && _t.current(),
            Ee.current === !0)
          ) {
            y.current = !1;
            return;
  ...
  let zt = vo(() => (F == null ? null : `${F.path}::${F.source}`), [F]);
  (_o(() => {
    if (zt == null) {
      m?.clearSlotContent(oe);
      return;
    }
    let t = I.current;
    if (t == null) return;
    ...
    let r = {
        anchorElement: n,
        anchorRect: t.anchorRect ?? os(n.getBoundingClientRect()),
        close: (e) => {
          _t.current(e?.restoreFocus ?? !0);
        },
        restoreFocus: () => {
          gt.current && ht.current(I.current?.path ?? null);
        },
      },
      i = e?.contextMenu?.render?.(t.item, r) ?? null;
    return (
      m?.setSlotContent(oe, i),
      e?.contextMenu?.onOpen?.(t.item, r),
      gs(i),
      queueMicrotask(() => {
        i == null || !i.isConnected || (document.activeElement === i && gs(i));
      }),
      () => {
        m?.clearSlotContent(oe);
      }
    ...
    _o(() => {
      F != null && t.getItem(F.path) == null && vt();
    }, [vt, F, t]),
    _o(() => {
      if (F == null) return;
      let e = S.current?.getRootNode(),
        ...
        n = (e) => {
          ...
          n instanceof Node &&
            (as(e) ||
              (_.current?.contains(n) !== !0 && t?.contains(n) !== !0 && vt()));
        },
        r = (e) => {
          e.key === `Escape` && (e.preventDefault(), e.stopPropagation(), vt());
        };
      return (
    ...
    _o(() => {
      ...
      let n = B == null ? null : (te.current.get(B) ?? null),
        r = Oo(t),
        i = r?.dataset.itemPath ?? null,
        a = qe && x.current === r,
        o = f && ee.current === r,
        c = O.current && !Je,
        l = k.current ?? 0,
        ...
        p = T.current || d,
        m = E.current !== B,
        h = c && es(e, V, s, at, lt, l);
      if (
        (((u != null && u === B && es(e, V, s, at, lt, ut)) ||
          h ||
          (p && m && u !== B && $o(e, V, s, at, ut))) &&
          re.current(),
        !p)
      ) {
        E.current = B;
      ...
      if (n == null) {
        (c && V >= 0 && (es(e, V, s, at, lt, l), re.current()),
          (E.current = B));
        return;
      }
      ((m || c || u === B || i == null || i !== B) &&
        ...
        (k.current = null)),
        (E.current = B));
    }, [t, V, B, ft, s, qe, Je, ot, at, f, ut, lt, it]));
  let Bt = Ie && T.current === !0 ? B : null,
    Vt = Ce === `pointer` ? ye : null,
    Ht = F?.path ?? L.current ?? Vt ?? Bt ?? ye,
    Ut = F?.source === `right-click`;
  _o(() => {
    yt(He(Ht));
  }, [He, ot, at, st, Ht, yt, it]);
  let Wt = yo((e) => {
      if (y.current || as(e)) return;
      let t = e.target;
      if (
        !(t instanceof HTMLElement) ||
        ...
        i =
          n instanceof HTMLElement
            ...
            : r instanceof HTMLElement
              ...
              : null;
      (i != null && P((e) => (e === `pointer` ? e : `pointer`)),
        be((e) => (e === i ? e : i)));
    }, []),
    Gt = yo(() => {
      be(null);
  ...
  _o(() => {
    ...
    return (
      ...
      () => {
        (window.removeEventListener(`dragend`, e), At(), t.cancelDrag());
      }
    );
  }, [t, Xe]);
  let Kt = (e) => {
      if (!Xe || t.getDragSession() == null || M.current) return;
      let n = Uo(e.target instanceof HTMLElement ? e.target : null);
      (t.setDragTarget(n),
        Mt(t.getDragSession()?.target ?? null),
    ...
    Yt = H.window.height,
    Xt = H.window.offsetTop,
    Zt = Math.min(0, at - Yt - ut),
    Qt = _e === B || O.current,
    $t =
      B != null && Qt && !ft && V >= 0
        ? (it[V] ?? t.getVisibleRows(V, V)[0] ?? null)
        : null,
    en = $t == null ? null : ts(V, s, ot, Yt),
    tn = j.current,
    nn =
      et != null &&
      tn != null &&
      ...
      tn.index <= ot.end,
    W =
      et != null && tn != null && tn.path === et && !nn && tn.path !== $t?.path
        ? tn
        : null,
    rn = W == null ? null : ts(W.index, s, ot, Yt),
    an = ns(
      (V >= 0
        ? (it[V] ?? t.getVisibleRows(V, V)[0] ?? null)
        : null
    ...
    on = Je && B != null ? ps(o, B, !ft) : void 0,
    sn = F?.path ?? (Je ? B : _e),
    cn = F?.path ?? ye,
    G = He(Ht),
    K = z && Ie && !Ut && !qe && G != null && xe != null && Ht != null,
    ln = z && (K || F != null),
    un = F?.anchorRect,
    dn = un == null && G != null && xe != null && (F != null || K) ? xe : null,
    fn =
      un == null
        ? dn == null
          ? void 0
    ...
    mn = yo(
      (e, n, r, i) => {
        ...
        switch (o.selection.kind) {
          case `range`:
            t.selectPathRange(r, o.selection.additive);
            break;
          case `toggle`:
            t.togglePathSelectionFromInput(r);
            break;
          case `single`:
            t.selectOnlyPath(r);
            break;
        }
        let s = e.currentTarget instanceof HTMLElement ? e.currentTarget : null,
          c = n.index >= H.visible.startIndex && n.index <= H.visible.endIndex,
          l = i === `flow` && c && s != null && s.dataset.itemParked !== `true`;
        (a?.focus(),
          l && ((T.current = !0), ve((e) => (e === r ? e : r)), P(`focus`)),
          o.toggleDirectory && Yo(a) && a.toggle(),
          o.closeSearch && t.closeSearch(),
          o.revealCanonical && St(r, { targetOffset: `sticky-parents` }));
      },
      [t, H.visible.endIndex, H.visible.startIndex, St],
    ),
    hn = () => {
      if (!Ie || Ht == null || G == null) return;
      let e = t.getItem(Ht);
      e != null &&
        (yt(G),
        (gt.current = !0),
        we({
          ...
          item: {
            ...
            name: G.getAttribute(`aria-label`) ?? Ht,
            path: e.getPath(),
          },
          path: e.getPath(),
          source: `button`,
    ...
    gn = {
      contextHoverPath: cn,
      contextMenuButtonTriggerEnabled: Ie,
      contextMenuButtonVisibility: Le,
      contextMenuEnabled: z,
      contextMenuRightClickEnabled: Re,
      contextMenuTriggerMode: Fe,
      controller: t,
      directoriesWithGitChanges: i,
      dragAndDropEnabled: Xe,
      draggedPathSet: Qe,
      dragTarget: $e,
      gitLaneActive: Ue,
      gitStatusByPath: n,
      handleRowDragEnd: It,
      handleRowDragStart: Ft,
      handleRowTouchStart: Lt,
      ignoredGitDirectories: r,
      ...
      onKeyDown: Rt,
      onRowClick: mn,
      openContextMenuForRow: bt,
      registerButton: ze,
      registerRenameInput: Ve,
      renameView: Ge,
      renderDecorationForRow: pt,
      resolveIcon: We,
      shouldSuppressContextMenu: Ct,
      visualFocusPath: sn,
    },
    _n = { ...gn, registerButton: Be };
  return J(`div`, {
    ref: S,
    id: tt,
    "data-file-tree-context-menu-button-visibility": z && Ie ? Le : void 0,
    "data-file-tree-context-menu-trigger-mode": z ? Fe : void 0,
    "data-file-tree-has-context-menu-action-lane": z && Ie ? `true` : void 0,
    "data-file-tree-has-git-lane": Ue ? `true` : void 0,
    "data-file-tree-virtualized-root": `true`,
    onDragLeave: Xe ? qt : void 0,
    onDragOver: Xe ? Kt : void 0,
    onDrop: Xe ? Jt : void 0,
    onKeyDown: Rt,
    onPointerLeave: z ? Gt : void 0,
    onPointerOver: z ? Wt : void 0,
    role: `tree`,
    tabIndex: -1,
    ...
    children: [
      J(`style`, {
        ...
        dangerouslySetInnerHTML: { __html: an },
      }),
      J(`slot`, { name: ae, "data-type": `header-slot` }),
      f
        ? J(`div`, {
            ...
            children: J(`input`, {
              ...
              "data-file-tree-search-input-fake-focus": Oe ? `true` : void 0,
              value: Ye,
              onBlur: () => {
                (d === `retain` && !Ae.current) || t.closeSearch();
              },
              onFocus: R,
              onPointerDown: R,
              onInput: (e) => {
        ...
        children: [
          ...
          J(`div`, {
            ...
            children: [
              ...
              J(`div`, {
                "data-file-tree-virtualized-sticky": `true`,
                style: { height: `${Yt}px`, top: `${Zt}px`, bottom: `${Zt}px` },
                children: [
                  ys(gn, ot, dt),
                  $t != null && en != null
                    ? vs(gn, $t, `parked:${$t.path}`, {
                        isParked: !0,
                        style: {
                          left: `0`,
                          opacity: `0`,
                          pointerEvents: et === $t.path ? `none` : void 0,
                          position: `absolute`,
                          right: `0`,
                          top: `${en}px`,
                        },
        ...
        ? J(`div`, {
            ...
            children: [
              J(`button`, {
                ...
                "aria-label": `Options`,
                "aria-haspopup": `menu`,
                "aria-expanded": F == null ? `false` : `true`,
                "data-visible": K ? `true` : `false`,
                onMouseDown: (e) => {
                  e.preventDefault();
                },
                onClick: (e) => {
                  if ((e.preventDefault(), e.stopPropagation(), F != null)) {
                    vt();
                    return;
                  }
                  hn();
                ...
                tabIndex: -1,
                style: pn,
                children: J(xa, { ...We(`file-tree-icon-ellipsis`) }),
              }),
              F == null ? null : J(`slot`, { name: oe }),
            ],
          })
        : null,
      F == null
        ...
        : J(`div`, {
            ...
            onTouchStartCapture: (e) => {
              (e.preventDefault(), e.stopPropagation(), vt());
            },
...
var Ts = class {
  ...
  Ps = new Set([`draggable`, `spellcheck`]);
function Fs(e) {
  e.__g === void 0 ? (e[Os] = !0) : (e.__g |= 8);
}
function Is(e) {
  e.__g === void 0 ? (e[Os] = !1) : (e.__g &= -9);
}
function Ls(e) {
  return e.__g === void 0 ? !0 === e[Os] : !!(8 & e.__g);
}
var Rs = /["&<]/;
function zs(e) {
  if (e.length === 0 || !1 === Rs.test(e)) return e;
  ...
  for (var n in e) {
    ...
    if (r != null && r !== ``) {
      var i =
          n[0] == `-`
            ? n
            : Bs[n] || (Bs[n] = n.replace(Hs, `-$&`).toLowerCase()),
        a = `;`;
      (typeof r != `number` || i.startsWith(`--`) || Vs.has(i) || (a = `px;`),
        (t = t + i + `:` + r + a));
    }
  }
  return t || void 0;
...
function Ks(e, t, n) {
  if (!e.s) {
    if (n instanceof qs) {
      if (!n.s) return void (n.o = Ks.bind(null, e, t));
      (1 & t && (t = n.s), (n = n.v));
    }
    if (n && n.then)
      return void n.then(Ks.bind(null, e, t), Ks.bind(null, e, 2));
    ((e.s = t), (e.v = n));
    let r = e.o;
    r && r(e);
  }
...
function ic(e, t) {
  var n,
    ...
    i = !0;
  return (
    e[Es] ? ((i = !1), ((n = e[Es]).state = n[ks])) : (n = new r(e.props, t)),
    (e[Es] = n),
    (n.__v = e),
    (n.props = e.props),
    (n.context = t),
    ...
    r.getDerivedStateFromProps
      ...
      : i && n.componentWillMount
        ? (n.componentWillMount(),
          (n.state = n[ks] === n.state ? n.state : n[ks]))
...
function ac(e, t, n, r, i, a, o) {
  if (e == null || !0 === e || !1 === e || e === tc) return tc;
  var s = typeof e;
  if (s != `object`)
    return s == `function` ? tc : s == `string` ? zs(e) : e + tc;
  if ($s(e)) {
    var c,
      l = tc;
    i[Ds] = e;
      ...
      if (f != null && typeof f != `boolean`) {
        ...
        typeof m == `string`
          ...
          : ((c ||= Array(u)),
            l && c.push(l),
            (l = tc),
            $s(m) ? (p = c).push.apply(p, m) : c.push(m));
      }
    }
    return c ? (l && c.push(l), c) : l;
  }
  if (e.constructor !== void 0) return tc;
  ((e.__ = i), Js && Js(e));
  var h = e.type,
    g = e.props;
  if (typeof h == `function`) {
    ...
    if (h === Ji) {
      if (`tpl` in g) {
        for (var x = tc, S = 0; S < g.tpl.length; S++)
          if (((x += g.tpl[S]), g.exprs && S < g.exprs.length)) {
            var C = g.exprs[S];
            if (C == null) continue;
            typeof C != `object` || (C.constructor !== void 0 && !$s(C))
              ? (x += C)
              : (x += ac(C, t, n, r, e, a, o));
          }
        return x;
      ...
      if (te) ((v = ic(e, b)), (y = e[Es]));
      else {
        e[Es] = y = Gs(e, b);
        for (var ne = 0; Ls(y) && ne++ < 25; ) {
          (Is(y), Xs && Xs(e));
          try {
            v = h.call(y, g, b);
          } catch (t) {
      ...
      if (
        (y.getChildContext != null && (t = ec({}, t, y.getChildContext())),
        te &&
          q.errorBoundaries &&
          (h.getDerivedStateFromError || y.componentDidCatch))
      ) {
        v =
          v != null && v.type === Ji && v.key == null && v.props.tpl == null
            ? v.props.children
            : v;
        try {
          return ac(v, t, n, r, e, a, !1);
        } catch (i) {
          return (
            h.getDerivedStateFromError &&
              (y[ks] = h.getDerivedStateFromError(i)),
            y.componentDidCatch && y.componentDidCatch(i, Qs),
            Ls(y)
              ? ((v = ic(e, t)),
                (y = e[Es]).getChildContext != null &&
                  (t = ec({}, t, y.getChildContext())),
                ac(
                  (v =
                    v != null &&
                    v.type === Ji &&
    ...
    try {
      ...
      return i.then(function i() {
        try {
          var s = ac(v, t, n, r, e, a, o);
          return e._suspended ? nc + s + rc : s;
        } catch (e) {
  ...
  for (var k in g) {
    var A = g[k];
    if (
      typeof (A = sc(A) ? A.value : A) != `function` ||
      k === `class` ||
      k === `className`
    ) {
      switch (k) {
        ...
        case `httpEquiv`:
          ...
          break;
        default:
          if (js.test(k)) k = k.replace(js, `$1:$2`).toLowerCase();
          else {
            if (As.test(k)) continue;
            (k[4] !== `-` && !Ps.has(k)) || A == null
              ? n
                ? Ns.test(k) &&
                  (k =
        ...
        (D =
          !0 === A || A === tc
            ...
            : D +
              ...
              k +
              `="` +
              (typeof A == `string` ? zs(A) : A + tc) +
              `"`);
    }
  }
  if (As.test(h))
    throw Error(h + ` is not a valid HTML tag name in ` + D + `>`);
  if (
    (O ||
      (typeof E == `string`
        ? (O = zs(E))
...
var cc = 0;
function lc(e) {
  return e != null && e.length > 0 ? e : ((cc += 1), `pst_ft_${cc}`);
}
function uc({ initialVisibleRowCount: e, itemHeight: t }) {
  return e == null ? 420 : Math.max(0, e) * (t ?? kr);
}
function dc(e) {
...
var mc = `file-tree-layout-commit`,
  hc = 60,
  gc = 2,
  _c = 2;
function vc(e, t) {
...
var yc = class {
    ...
    #N = !1;
    #P = () => {
      (this.#O != null && (this.#E > 0 && --this.#E, this.#q()),
        this.#C != null && this.#K());
    };
    #F = (e) => {
      let t = this.#V();
      if (
        !(t == null || e.target !== t) &&
        !(this.#O == null && this.#C == null)
      ) {
        if (this.#A != null && vc(t.scrollTop, this.#A)) {
          this.#A = null;
          return;
        }
        ((this.#A = null), this.#G(), this.#W());
      }
    };
    #I = () => {
      ((this.#x = null), this.#K());
    ...
    unmount() {
      (this.#W(),
        this.#G(),
        this.#j != null &&
          (this.#j.removeEventListener(mc, this.#P),
          this.#j.removeEventListener(`scroll`, this.#F, !0),
          ws(this.#j),
          delete this.#j.dataset.fileTreeVirtualizedWrapper,
          (this.#j = void 0)),
        this.#l.clearAll(),
        this.#l.setHost(null),
        this.#f != null &&
    ...
    getVisibleCount() {
      return this.#t.getVisibleCount();
    }
    getScrollTop() {
      return this.#V()?.scrollTop ?? 0;
    }
    setScrollTop(e) {
      (this.#G(),
        (this.#A = null),
    ...
    focusNearestPath(e) {
      return (this.#G(), this.#t.focusNearestPath(e));
    }
    add(e) {
      this.#t.add(e);
    }
    ...
    setComposition(e) {
      this.#e = e;
      let t = this.#B();
      t != null && (this.#X(), Ss(t.wrapper, this.#z()));
    }
    setGitStatus(e) {
      this.#p = Ai(e, this.#p);
      let t = this.#B();
      t != null && Ss(t.wrapper, this.#z());
    }
    setIcons(e) {
      this.#m = e;
      let t = this.#B();
      t != null && (this.#J(t.host, t.wrapper), Ss(t.wrapper, this.#z()));
    }
    ...
    render({ containerWrapper: e, fileTreeContainer: t }) {
      let n = this.#ne(t ?? this.#f, e),
        r = this.#te(n);
      (this.#X(), Ss(r, this.#z()));
    }
    #R() {
      return {
        initialViewportHeight: uc({
    ...
    #V() {
      return (
        this.#j?.querySelector(`[data-file-tree-virtualized-scroll='true']`) ??
        null
      );
    }
    #H() {
    ...
    #W() {
      (this.#x != null &&
        (typeof window.cancelAnimationFrame == `function`
          ? window.cancelAnimationFrame(this.#x)
          : window.clearTimeout(this.#x),
        (this.#x = null)),
        (this.#b = 0),
        (this.#S = 0),
        (this.#C = null),
    ...
    #K() {
      ...
      if (t == null) this.#S = 0;
        ...
        if (e <= n || vc(n, e))
          if (((this.#A = e), (t.scrollTop = e), vc(t.scrollTop, e))) {
            if (((this.#S += 1), this.#S >= gc)) {
              this.#W();
              return;
            }
          } else this.#S = 0;
    ...
    #q() {
      ...
      if (e == null) return;
      let t = this.#V();
      if (t == null) ((this.#D = 0), (this.#k = null));
      else {
        this.#t.focusPath(e);
        let n = this.#t.getFocusedIndex();
        if (n === -1) ((this.#D = 0), (this.#k = null));
        else {
          let r = Po(
              this.#t,
              this.#u.itemHeight,
              this.#d.overscan,
              t.scrollTop,
              this.#d.stickyFolders === !0,
              t.clientHeight || 420,
            ),
            i = this.#k != null && vc(this.#k, r);
          this.#k = r;
          let a = t.clientHeight || 420,
            o = this.#t.getVisibleCount() * this.#u.itemHeight,
            s = $a({
              currentScrollTop: t.scrollTop,
              focusedIndex: n,
              itemHeight: this.#u.itemHeight,
              targetViewportOffset: r,
              totalHeight: o,
              viewportHeight: a,
            });
          if (
            (s != null && ((this.#A = s), (t.scrollTop = s)),
            this.#E === 0 &&
              i &&
              $a({
                currentScrollTop: t.scrollTop,
              ...
              this.#t.getFocusedPath() === e)
          ) {
            if (((this.#D += 1), this.#D >= gc)) {
              this.#G();
              return;
            }
          } else this.#D = 0;
    ...
    #J(e, t) {
      let n = e.shadowRoot;
      (n != null && (this.#Z(n), this.#Q(n)), this.#$(t));
    }
    #Y() {
      let e = this.#r;
      if (e == null) return;
    ...
    #X() {
      ...
      if (e != null) {
        this.#l.setSlotContent(ae, e());
        return;
      }
      this.#l.setSlotHtml(ae, this.#e?.header?.html ?? null);
    }
    #Z(e) {
      let t = pc(e).find((e) => fc(e)),
        n = dc(te(ne(this.#m).set));
      n != null &&
    ...
    #ee(e) {
      ...
      (this.#g?.parentNode === e && this.#_ === this.#h) ||
        ...
        this.#g.setAttribute(O, ``),
        this.#g.parentNode !== e && e.appendChild(this.#g),
        (this.#g.textContent = Nr(this.#h)),
        (this.#_ = this.#h));
    }
    #te(e) {
      ...
      return (
        ...
        (this.#j = r ?? document.createElement(`div`)),
        (this.#j.dataset.fileTreeId = this.#n),
        (this.#j.dataset.fileTreeVirtualizedWrapper = `true`),
        this.#j.addEventListener(mc, this.#P),
        this.#j.addEventListener(`scroll`, this.#F, !0),
        this.#J(e, this.#j),
        this.#j.parentNode !== t && t.appendChild(this.#j),
        this.#j
      );
    }
    #ne(e, t) {
    ...
    #ie(e) {
      ((this.#M &&= (e.style.removeProperty(`--trees-item-height`), !1)),
        (this.#N &&= (e.style.removeProperty(`--trees-density-override`), !1)));
    }
  },
  Q = e(n(), 1),
  $ = r(),
  bc = typeof window > `u` ? Q.useEffect : Q.useLayoutEffect;
function xc(e, t, n) {
  let r = e == null ? null : (0, $.jsx)(`div`, { slot: ae, children: e }),
    i =
      t != null && n != null
        ? (0, $.jsx)(`div`, { slot: oe, children: t(n.item, n.context) })
        : null;
  return r == null && i == null
    ? null
    : (0, $.jsxs)($.Fragment, { children: [r, i] });
}
function Sc(e, t) {
...
function Tc({
  ...
  let [o, s] = (0, Q.useState)(null),
    [c, l] = (0, Q.useState)(null),
    u = (0, Q.useRef)(n.getComposition()),
    d = (0, Q.useRef)(n);
  ...
  let f = i != null,
    ...
    h = u.current,
    g = (0, Q.useMemo)(() => wc(h, e, f, p, m), [h, p, m, f, e]),
    _ = (0, Q.useCallback)((e) => {
      l(e);
    }, []);
  ((0, Q.useEffect)(() => {
...
function Ic(e) {
  let n = (0, Nc.c)(105),
    {
      ...
      cwd: i,
      decorationIcons: o,
      flattenEmptyDirectories: s,
      hostId: c,
      icons: u,
      initialExpandedPaths: d,
      initialScrollTop: f,
      onClick: p,
      onDoubleClick: m,
      ...
      onStateChange: C,
      paths: ee,
      revealSelectedPath: te,
      renderRowDecoration: ne,
      resetKey: w,
      selectedPath: E,
    } = e,
    D = r === void 0 ? !1 : r,
    ...
    ie = _(g()),
    { platform: ae } = h(),
    oe = l(`add-context-file`),
    se = a(),
    ce;
  n[0] !== i || n[1] !== c
    ? ((ce = { cwd: i, hostId: c }), (n[0] = i), (n[1] = c), (n[2] = ce))
    : (ce = n[2]);
  let le = re(ce),
    ue;
  n[3] === ee ? (ue = n[4]) : ((ue = ee.map(Lc)), (n[3] = ee), (n[4] = ue));
  let j = ue,
    de;
  if (n[5] !== i || n[6] !== ee || n[7] !== ae) {
    de = new Map();
    for (let e of ee)
      typeof e != `string` &&
        de.set(e.displayPath, t(i ?? ``, e.path, ae === `windows`));
    ((n[5] = i), (n[6] = ee), (n[7] = ae), (n[8] = de));
  } else de = n[8];
  let M = de,
    fe;
  n[9] !== o || n[10] !== u
    ? ((fe = Rc(u, o)), (n[9] = o), (n[10] = u), (n[11] = fe))
    : (fe = n[11]);
  let N = fe,
    pe = (0, Q.useRef)(null),
    me;
  n[12] === d
    ? (me = n[13])
    : ((me = Array.from(d ?? [])), (n[12] = d), (n[13] = me));
  let he = (0, Q.useRef)(me),
    ge = (0, Q.useRef)(null),
    _e = (0, Q.useRef)(k),
    ve = (0, Q.useRef)(E ?? null),
    ye;
  n[14] === C
    ? (ye = n[15])
    : ((ye = () => {
        C?.({
          expandedPaths: he.current,
          scrollTop: _e.current,
          selectedPath: ve.current,
        });
      }),
      (n[14] = C),
      (n[15] = ye));
  ...
  n[22] === E
    ? (F = n[23])
    : ((F = E == null ? void 0 : [E]), (n[22] = E), (n[23] = F));
  let we;
  n[24] !== N ||
  n[25] !== O ||
  n[26] !== P ||
  ...
  n[32] === I
    ? (Te = n[33])
    : ((Te = () => I.getVisibleCount()), (n[32] = I), (n[33] = Te));
  let [L, Ee] = (0, Q.useState)(Te),
    De;
  n[34] !== d ||
  n[35] !== k ||
  n[36] !== I ||
  ...
  n[39] !== j
    ? ((De = () => {
        ((he.current = Array.from(d ?? [])),
          (ge.current = null),
          I.resetPaths(j, { initialExpandedPaths: d }),
          Ee(I.getVisibleCount()),
          k > 0 && !(A && E != null)
            ? ((_e.current = k), I.setScrollTop(k))
            : (_e.current = 0));
      }),
      (n[34] = d),
      (n[35] = k),
  ...
  n[47] !== j
    ...
    (0, Q.useEffect)(De, Oe));
  let ke;
  n[49] !== I || n[50] !== A || n[51] !== E
    ? ((ke = () => {
        if (((ve.current = E ?? null), Wc(I, E), !A || E == null)) {
          ge.current = null;
          return;
        }
        ge.current !== E && Gc(I, E) && (ge.current = E);
      }),
      (n[49] = I),
      (n[50] = A),
      (n[51] = E),
  ...
  (n[58] !== N || n[59] !== I
    ...
    (0, Q.useEffect)(R, je));
  let Me, Ne;
  (n[62] !== Se || n[63] !== I || n[64] !== j
    ? ((Me = () =>
        I.subscribe(() => {
          (Ee((e) => {
            let t = I.getVisibleCount();
            return e === t ? e : t;
          }),
            (_e.current = I.getScrollTop()),
            Se(Uc(I, j)));
        })),
      (Ne = [Se, I, j]),
      (n[62] = Se),
  ...
  (n[67] !== I || n[68] !== be
    ? ((Pe = () => {
        let e = null,
          ...
          i = () => {
            if (((e = null), I.getScrollMetrics() != null)) {
              n = I.subscribeToScroll(r);
              return;
            }
            t >= Fc || ((t += 1), (e = window.requestAnimationFrame(i)));
          };
        return (
          i(),
          () => {
  ...
  n[79] !== M
    ? ((Ie = () => {
        let e = Hc(M, pe.current);
        return Oc({
          ...Bc({
            cwd: i,
            fallbackOpenTargets: le,
            hostId: c,
            queryClient: se,
            targetPath: e,
          }),
          onAddToChat:
            c == null
              ? void 0
              : (e) => {
                  oe.mutateAsync({ hostId: c, path: e });
                },
          onCopyPath: x,
          onOpenInTarget: (e, t, n) => {
            le.open(e, { appPath: t, persistPreferred: !1, path: n });
          },
          targetPath: e,
        });
      }),
    ...
    : (Ie = n[80]);
  let Le;
  n[81] !== i || n[82] !== c || n[83] !== se || n[84] !== M
    ? ((Le = () =>
        Vc({
          cwd: i,
          hostId: c,
          queryClient: se,
          targetPath: Hc(M, pe.current),
        })),
      (n[81] = i),
      (n[82] = c),
      (n[83] = se),
  ...
  return (
    n[102] !== Fe || n[103] !== He
      ? ((Ue = (0, $.jsxs)($.Fragment, { children: [Fe, He] })),
        (n[102] = Fe),
        (n[103] = He),
        (n[104] = Ue))
      : (Ue = n[104]),
...
function Rc(e, t) {
  ...
  let n = t
      ...
      .join(``),
    r = zc(typeof e == `string` ? void 0 : e?.spriteSheet, n);
  return e == null
...
function Bc({
  ...
  let a = u(`open-in-targets`, { cwd: e, hostId: n, path: i }),
    o = r.getQueryData(a),
...
function Vc({ cwd: e, hostId: t, queryClient: n, targetPath: r }) {
  if (r != null)
    return n.prefetchQuery({
      gcTime: s.INFINITE,
      queryKey: u(`open-in-targets`, { cwd: e, hostId: t, path: r }),
      queryFn: () =>
        c(`open-in-targets`, { params: { cwd: e, hostId: t, path: r } }),
...
function Uc(e, t) {
  ...
  for (let r of t) {
    ...
    let t = r.slice(0, -1),
      i = e.getItem(t);
    i == null || !Kc(i) || !i.isExpanded() || n.push(t);
  }
  return n;
}
function Wc(e, t) {
...
function Gc(e, t) {
  return e.getItem(t) == null ? !1 : (e.revealPath(t), !0);
}
function Kc(e) {
...
function qc(e) {
  ...
  t[4] === s
    ? (g = t[5])
    : ((g = (e) => s(e.target.value)), (t[4] = s), (t[5] = g));
  let _;
  t[6] === u
    ? (_ = t[7])
    : ((_ = u.formatMessage({
    ...
    ? ((y =
        c.length > 0
          ? (0, $.jsx)(p, {
              ...
              size: `icon`,
              onClick: () => s(``),
              children: (0, $.jsx)(m, { className: `icon-2xs` }),
            })
          : null),
      (t[15] = u),
      (t[16] = s),
...
export { Dc as i, Ic as n, Mc as r, qc as t };
