...
import { D as t, E as n, T as r, kr as i } from "./src-DAzAmbVS.js";
import { Aa as a, ka as o } from "./app-server-manager-signals-Csopz8aM.js";
...
import { f as g } from "./chunk-LFPYN7LY-CkfOxD5s.js";
import { t as ee } from "./button-bq66r8jD.js";
import { t as te } from "./spinner-D37df5tU.js";
import { t as ne } from "./use-platform-ByMJlQVq.js";
import { t as re } from "./info-B8KL--OU.js";
import { t as ie } from "./download-Cf0FyA1Y.js";
import { t as ae } from "./with-window-C7Mmo_xd.js";
...
function ve() {
  return _ ? b(`loggerSettings`, () => ({ enabled: !1 })) : { enabled: !1 };
}
var S = {
    enable: de,
    disable: fe,
...
`);
    for (let e = n; e < a.length; e++) {
      ...
      let o = be.test(n) ? n.replace(be, `$1`) : n;
      if (!o.match(/\S*Error: /)) {
        for (let e of t) {
          let t = e(o);
          if (t) {
...
function we(e) {
  ...
  let t = Array.from(e);
  return (
    /sentryWrapped/.test(Te(t).function || ``) && t.pop(),
    t.reverse(),
    xe.test(Te(t).function || ``) &&
      (t.pop(), xe.test(Te(t).function || ``) && t.pop()),
    t.slice(0, ye).map((e) => ({
      ...e,
      filename: e.filename || Te(t).filename,
      function: e.function || `?`,
    }))
  );
}
...
function C(e) {
  try {
    return !e || typeof e != `function` ? Ee : e.name || Ee;
  } catch {
    return Ee;
  }
}
...
function Re() {
  ((Ie = v.onunhandledrejection),
    (v.onunhandledrejection = function (e) {
      return (w(`unhandledrejection`, e), Ie ? Ie.apply(this, arguments) : !0);
    }),
...
function Ke(e) {
  return (
    e === null || Ge(e) || (typeof e != `object` && typeof e != `function`)
  );
}
function qe(e) {
  return Ve(e, `Object`);
...
function E(e, t = {}) {
  ...
  try {
    let n = e,
      ...
      c = (!Array.isArray(t) && t.maxStringLength) || rt;
    for (
      ;
      n &&
      i++ < 5 &&
...
function lt(e) {
  if (Be(e))
    return { message: e.message, name: e.name, stack: e.stack, ...dt(e) };
  if (Je(e)) {
    let t = {
      type: e.type,
      target: ut(e.target),
      currentTarget: ut(e.currentTarget),
      ...dt(e),
    };
    return (
      typeof CustomEvent < `u` && $e(e, CustomEvent) && (t.detail = e.detail),
      t
    );
  } else return e;
}
function ut(e) {
  try {
    return Ye(e) ? E(e) : Object.prototype.toString.call(e);
  } catch {
    return `<unknown>`;
  }
}
...
function mt(e, t) {
  ...
  for (let t = 0; t < e.length; t++) {
    let r = e[t];
    try {
      et(r) ? n.push(Oe(r)) : n.push(String(r));
    } catch {
...
function k(e = _t()) {
  ...
  return (
    (vt ||= `10000000100040008000100000000000`),
    vt.replace(/[018]/g, (e) => (e ^ ((yt() & 15) >> (e / 4))).toString(16))
  );
}
function bt(e) {
  ...
  Vt = class e {
    ...
    setUser(e) {
      return (
        ...
        this._session && Nt(this._session, { user: e }),
    ...
    update(t) {
      ...
      let n = typeof t == `function` ? t(this) : t,
        ...
        } = (n instanceof e ? n.getScopeData() : qe(n) ? t : void 0) || {};
      return (
    ...
    addBreadcrumb(e, t) {
      let n = typeof t == `number` ? t : Bt;
      if (n <= 0) return this;
      let r = {
        timestamp: Dt(),
        ...e,
        message: e.message ? pt(e.message, 2048) : e.message,
      };
      return (
    ...
    setSDKProcessingMetadata(e) {
      return (
        (this._sdkProcessingMetadata = It(this._sdkProcessingMetadata, e, 2)),
        this
      );
    }
...
function Ht() {
  return b(`defaultCurrentScope`, () => new Vt());
}
function Ut() {
  return b(`defaultIsolationScope`, () => new Vt());
}
var Wt = class {
  constructor(e, t) {
    let n;
...
function Gt() {
  let e = se(y());
  return (e.stack = e.stack || new Wt(Ht(), Ut()));
}
function Kt(e) {
  return Gt().withScope(e);
}
function qt(e, t) {
  let n = Gt();
...
function Jt(e) {
  return Gt().withScope(() => e(Gt().getIsolationScope()));
}
function Yt() {
  return {
    withIsolationScope: Jt,
    withScope: Kt,
    withSetScope: qt,
    withSetIsolationScope: (e, t) => Jt(t),
...
function Xt(e) {
  let t = se(e);
  return t.acs ? t.acs : Yt();
}
function P() {
  return Xt(y()).getCurrentScope();
}
function F() {
  return Xt(y()).getIsolationScope();
}
function Zt() {
  return b(`globalScope`, () => new Vt());
}
function Qt(...e) {
  let t = Xt(y());
  if (e.length === 2) {
...
function gn(e, t, n) {
  e && (O(e, pn, mn(n)), O(e, fn, t));
}
function _n(e) {
  let t = e;
  return { scope: t[fn], isolationScope: hn(t[pn]) };
}
var vn = `sentry-`,
  yn = /^sentry-/;
function bn(e) {
...
function Nn(e) {
  let t = e.getOptions(),
    { host: n } = e.getDsn() || {},
    r;
  return (t.orgId ? (r = String(t.orgId)) : n && (r = Mn(n)), r);
}
function Pn(e) {
  let t = typeof e == `string` ? kn(e) : An(e);
  if (!(!t || !jn(t))) return t;
}
function Fn(e) {
...
var In = RegExp(`^[ \\t]*([0-9a-f]{32})?-?([0-9a-f]{16})?-?([01])?[ \\t]*$`);
function Ln(e) {
  if (!e) return;
  let t = e.match(In);
  if (!t) return;
...
function Vn(e, t) {
  let n = Fn(t?.sample_rand);
  if (n !== void 0) return n;
  let r = Fn(t?.sample_rate);
...
var er = `_sentryChildSpans`,
  tr = `_sentryRootSpan`;
function nr(e, t) {
  (O(t, tr, e[tr] || e), e[er] ? e[er].add(t) : O(e, er, new Set([t])));
}
function rr(e, t) {
  e[er] && e[er].delete(t);
}
...
function H() {
  let e = Xt(y());
  return e.getActiveSpan ? e.getActiveSpan() : zt(P());
}
function ar() {
  Hn ||=
    (x(() => {
...
function sr() {
  ...
  ((e.tag = `sentry_tracingErrorCallback`), (or = !0), Pe(e), Le(e));
}
function U(e) {
...
function lr(e, t) {
  ...
  for (let n of t) {
    if (dr(n)) {
      if (ht(e.description, n)) return (_ && cr(e), !0);
      continue;
    }
    if (!n.name && !n.op) continue;
    let t = n.name ? ht(e.description, n.name) : !0,
      r = n.op ? e.op && ht(e.op, n.op) : !0;
    if (t && r) return (_ && cr(e), !0);
  }
  return !1;
}
function ur(e, t) {
...
function _r(e) {
  ...
  let l = a?.get(`sentry.dsc`),
    u = l && bn(l);
  if (u) return s(u);
  let d = hr(e.spanContext().traceId, t),
    f = i[L],
    p = r.description;
  return (
    f !== `url` && p && (d.transaction = p),
    U() &&
      ((d.sampled = String(Qn(n))),
      (d.sample_rand =
        a?.get(`sentry.sample_rand`) ??
        _n(n).scope?.getPropagationContext().sampleRand.toString())),
    s(d),
...
function Ar(e) {
  ...
  function i(e) {
    typeof r == `string`
      ? (r = typeof e == `string` ? r + e : [kr(r), e])
      : r.push(typeof e == `string` ? kr(e) : e);
  }
  for (let e of n) {
    let [t, n] = e;
    if (
...
function Nr(e) {
  let t = typeof e.data == `string` ? kr(e.data) : e.data;
  return [
    {
      type: `attachment`,
      length: t.length,
...
function Br(e, t, n, r) {
  ...
  Rr(e, n?.sdk);
  let o = Lr(e, i, r, t);
  return (delete e.sdkProcessingMetadata, Er(o, [[{ type: a }, e]]));
}
function Vr(e, t) {
  function n(e) {
  ...
  let r = _r(e[0]),
    ...
    l = c?.length ? e.filter((e) => !lr(B(e), c)) : e,
    u = e.length - l.length;
...
var Kr = 1e3,
  qr = class {
    ...
    updateName(e) {
      ...
      this._endTime || ((this._endTime = Jn(e)), Ur(this), this._onSpanEnded());
    }
    getSpanJSON() {
      return {
    ...
    addEvent(e, t, n) {
      ...
      let r = Jr(t) ? t : n || A(),
        i = Jr(t) ? {} : t || {},
        a = { name: e, time: Jn(r), attributes: i };
    ...
    _onSpanEnded() {
      ...
      t && (_n(this).scope || P()).captureEvent(t);
    }
    _convertSpanToTransaction() {
      ...
      let a = {
          ...
          sdkProcessingMetadata: {
            ...
            dynamicSamplingContext: _r(this),
          },
          request: n,
...
function Xr(e) {
  return e instanceof qr && e.isStandaloneSpan();
}
function Zr(e) {
  let t = I();
  if (!t) return;
...
var ti = `__SENTRY_SUPPRESS_TRACING__`;
function ni(e, t) {
  let n = si();
...
function ri(e) {
  ...
  return (
    ...
    return e.onlyIfParent && !a
      ? new vr()
      : ai({ parentSpan: a, spanArguments: n, forceTransaction: r, scope: t });
  });
}
function ii(e, t) {
  let n = si();
...
function ai({
  ...
  let i = F(),
    a;
  if (e && !n) ((a = li(e, r, t)), nr(e, a));
  else if (e) {
    let n = _r(e),
      { traceId: i, spanId: o } = e.spanContext(),
      s = Qn(e);
    ((a = ci({ traceId: i, parentSpanId: o, ...t }, r, s)), mr(a, n));
  } else {
    let {
      traceId: e,
      dsc: n,
    ...
    ((a = ci({ traceId: e, parentSpanId: o, ...t }, r, s)), n && mr(a, n));
  }
  return (Hr(a), gn(a, r, i), a);
}
function oi(e) {
  let t = { isStandalone: (e.experimental || {}).standalone, ...e };
  if (e.startTime) {
    let n = { ...t };
    return ((n.startTimestamp = Jn(e.startTime)), delete n.startTime, n);
  }
  return t;
}
function si() {
...
function ci(e, t, n) {
  ...
  let s = o.parentSampled ?? n,
    ...
    [u, d, f] = t.getScopeData().sdkProcessingMetadata[ti]
      ? [!1]
      : ei(
          i,
          {
            ...
            parentSampled: s,
            attributes: c,
            parentSampleRate: Fn(l.dsc?.sample_rate),
          },
          l.sampleRand,
        ),
    p = new qr({
      ...e,
      attributes: { [L]: `custom`, [en]: d !== void 0 && f ? d : void 0, ...c },
      sampled: u,
    });
  return (
    !u &&
...
function li(e, t, n) {
  let { spanId: r, traceId: i } = e.spanContext(),
    a = t.getScopeData().sdkProcessingMetadata[ti] ? !1 : Qn(e),
    o = a
      ? new qr({ ...n, parentSpanId: r, traceId: i, sampled: a })
      : new vr({ traceId: i });
  nr(e, o);
  let s = I();
  return (
...
function di(e) {
  return e === void 0 ? (e) => e() : (t) => ii(e, t);
}
var fi = { idleTimeout: 1e3, finalTimeout: 3e4, childSpanTimeout: 15e3 },
  pi = `heartbeatFailed`,
  mi = `idleTimeout`,
  hi = `finalTimeout`,
  gi = `externalFinish`;
function _i(e, t = {}) {
  let n = new Map(),
    ...
    s = [],
    {
      idleTimeout: c = fi.idleTimeout,
      finalTimeout: l = fi.finalTimeout,
      childSpanTimeout: u = fi.childSpanTimeout,
      beforeSpanEnd: d,
  ...
  if (!p || !U()) {
    let e = new vr();
    return (mr(e, { sample_rate: `0`, sampled: `false`, ..._r(e) }), e);
  }
  let m = P(),
    h = H(),
    g = vi(e);
  g.end = new Proxy(g.end, {
    apply(e, t, n) {
      if ((d && d(g), t instanceof vr)) return;
      let [r, ...i] = n,
        a = Jn(r || A()),
        o = ir(g).filter((e) => e !== g),
        s = B(g);
  ...
  function ae(e) {
    ((r = !0), n.clear(), s.forEach((e) => e()), Rt(m, h));
    let t = B(g),
      { start_timestamp: i } = t;
    if (!i) return;
    t.data[`sentry.idle_span_finish_reason`] || g.setAttribute(nn, a);
    let o = t.status;
    ((!o || o === `unknown`) && g.setStatus({ code: 1 }),
      S.log(`[Tracing] Idle span "${t.op}" finished`));
    let u = ir(g).filter((e) => e !== g),
      d = 0;
    (u.forEach((t) => {
      t.isRecording() &&
    ...
    s.push(
      p.on(`spanStart`, (e) => {
        r ||
          e === g ||
          B(e).timestamp ||
          (e instanceof qr && e.isStandaloneSpan()) ||
          (ir(g).includes(e) && re(e.spanContext().spanId));
      }),
    ),
    s.push(
      p.on(`spanEnd`, (e) => {
...
function vi(e) {
  let t = ri(e);
  return (Rt(P(), t), _ && S.log(`[Tracing] Started span is an idle span`), t);
}
var yi = 0,
  bi = 1,
  xi = 2;
...
var wi = class e {
  constructor(e) {
    ((this._state = yi), (this._handlers = []), this._runExecutor(e));
  }
  then(t, n) {
    return new e((e, r) => {
      (this._handlers.push([
  ...
  _executeHandlers() {
    if (this._state === yi) return;
    let e = this._handlers.slice();
    ((this._handlers = []),
      e.forEach((e) => {
        e[0] ||=
          (this._state === bi && e[1](this._value),
          this._state === xi && e[2](this._value),
          !0);
      }));
  }
  _runExecutor(e) {
...
function Ei(e, t, n, r) {
  ...
  return (
    ...
    Ze(a) ? a.then((e) => Ei(e, t, n, r + 1)) : Ei(a, t, n, r + 1)
  );
}
function Di(e, t) {
  let { fingerprint: n, span: r, breadcrumbs: i, sdkProcessingMetadata: a } = t;
  (Ai(e, t), r && Ni(e, r), Pi(e, n), ji(e, i), Mi(e, a));
}
function Oi(e, t) {
  let {
    extra: n,
  ...
  (ki(e, `extra`, n),
    ...
    ki(e, `user`, i),
    ki(e, `contexts`, a),
    (e.sdkProcessingMetadata = It(e.sdkProcessingMetadata, s, 2)),
    o && (e.level = o),
...
function Ni(e, t) {
  ((e.contexts = { trace: Wn(t), ...e.contexts }),
    (e.sdkProcessingMetadata = {
      dynamicSamplingContext: _r(t),
      ...e.sdkProcessingMetadata,
    }));
...
function zi(e) {
  ...
  let r = t ? Object.keys(t) : [],
    i = n ? Object.keys(n) : [];
  if (Ri && r.length === Ii && i.length === Li) return Ri;
  ((Ii = r.length), (Li = i.length), (Ri = {}), (Fi ||= {}));
  let a = (t, n) => {
    for (let r of t) {
      let t = n[r],
        i = Fi?.[r];
      if (i && Ri && t) ((Ri[i[0]] = t), Fi && (Fi[r] = [i[0], t]));
      else if (t) {
        let n = e(r);
...
function Bi(e, t, n, r, i, a) {
  ...
  (Vi(c, e),
    ...
    t.type === void 0 && Hi(c, e.stackParser));
  let u = Ki(r, n.captureContext);
  n.mechanism && Ct(c, n.mechanism);
  let d = i ? i.getEventProcessors() : [],
    f = Zt().getScopeData();
  (a && Oi(f, a.getScopeData()), u && Oi(f, u.getScopeData()));
  let p = [...(n.attachments || []), ...f.attachments];
  return (
    p.length && (n.attachments = p),
    Di(c, f),
    Ti([...d, ...f.eventProcessors], c, n).then(
      (e) => (e && Ui(e), typeof o == `number` && o > 0 ? Gi(e, o, s) : e),
    )
  );
}
function Vi(e, t) {
  ...
  ((e.environment = e.environment || n || `production`),
    ...
    !e.dist && i && (e.dist = i));
  let o = e.request;
  (o?.url && a && (o.url = pt(o.url, a)),
    a &&
      e.exception?.values?.forEach((e) => {
        e.value &&= pt(e.value, a);
      }));
}
function Hi(e, t) {
  let n = zi(t);
...
function Ki(e, t) {
  if (!t) return e;
  let n = e ? e.clone() : new Vt();
  return (n.update(t), n);
}
function qi(e) {
  if (e) return Ji(e) || Xi(e) ? { captureContext: e } : e;
}
function Ji(e) {
  return e instanceof Vt || typeof e == `function`;
}
var Yi = [
  `user`,
  `level`,
...
function Xi(e) {
  return Object.keys(e).some((e) => Yi.includes(e));
}
function Zi(e, t) {
  return P().captureException(e, qi(t));
}
function Qi(e, t) {
...
function na(e) {
  let t = F(),
    ...
    a = t.getSession();
  return (
    a?.status === `ok` && Nt(a, { status: `exited` }),
    ra(),
    t.setSession(i),
    i
  );
...
function ya(e, t) {
  ...
  let r = e.getOptions(),
    i = va(n, r._metadata, r.tunnel, e.getDsn());
  (xa().set(e, []), e.emit(`flushLogs`), e.sendEnvelope(i));
}
function ba(e) {
  return xa().get(e);
}
function xa() {
  return b(`clientToLogBufferMap`, () => new WeakMap());
}
function Sa(e) {
  return [
    {
...
function wa(e, t) {
  ...
  if (n.length === 0) return;
  let r = e.getOptions(),
    i = Ca(n, r._metadata, r.tunnel, e.getDsn());
  (Ea().set(e, []), e.emit(`flushMetrics`), e.sendEnvelope(i));
}
function Ta(e) {
  return Ea().get(e);
}
function Ea() {
  return b(`clientToMetricBufferMap`, () => new WeakMap());
}
var Da = Symbol.for(`SentryBufferFullError`);
function Oa(e = 100) {
  let t = new Set();
  function n() {
    return t.size < e;
...
function Na(e, { statusCode: t, headers: n }, r = Date.now()) {
  let i = { ...e },
  ...
  else o ? (i.all = r + Aa(o, r)) : t === 429 && (i.all = r + 60 * 1e3);
  return i;
}
function Pa(e, t, n = Oa(e.bufferSize || 64)) {
  let r = {},
    i = (e) => n.drain(e);
  function a(i) {
    let a = [];
    if (
      (Or(i, (t, n) => {
        let i = Fr(n);
        Ma(r, i) ? e.recordDroppedEvent(`ratelimit_backoff`, i) : a.push(t);
      }),
      a.length === 0)
    )
...
var za = `Not capturing exception because it's already been captured.`,
  Ba = `Discarded session because of missing or non-string release`,
  Va = Symbol.for(`SentryInternalError`),
  Ha = Symbol.for(`SentryDoNotSendEventError`),
  Ua = 5e3;
function Wa(e) {
  return { message: e, [Va]: !0 };
}
function Ga(e) {
  return { message: e, [Ha]: !0 };
}
function Ka(e) {
  return !!e && typeof e == `object` && Va in e;
}
function qa(e) {
...
var Ya = class {
  constructor(e) {
    if (
      ...
      (this._hooks = {}),
      (this._eventProcessors = []),
      (this._promiseBuffer = Oa(e.transportOptions?.bufferSize ?? 64)),
      e.dsn
        ? (this._dsn = Pn(e.dsn))
        : _ && S.warn(`No DSN provided, client will not send events.`),
      this._dsn)
    ) {
      let t = ua(this._dsn, e.tunnel, e._metadata ? e._metadata.sdk : void 0);
    ...
    ((this._options.enableLogs =
      ...
      this._options.enableLogs &&
        Ja(this, `afterCaptureLog`, `flushLogs`, no, ya),
      (this._options.enableMetrics ??
        this._options._experiments?.enableMetrics ??
        !0) &&
        Ja(this, `afterCaptureMetric`, `flushMetrics`, to, wa));
  }
  captureException(e, t, n) {
    let r = k();
    if (wt(e)) return (_ && S.log(za), r);
    let i = { event_id: r, ...t };
    return (
      this._process(
        () =>
  ...
  captureEvent(e, t, n) {
    let r = k();
    if (t?.originalException && wt(t.originalException))
      return (_ && S.log(za), r);
    let i = { event_id: r, ...t },
  ...
  captureSession(e) {
    (this.sendSession(e), Nt(e, { init: !1 }));
  }
  getDsn() {
    return this._dsn;
  }
  ...
  addIntegration(e) {
    ...
    (ga(this, e, this._integrations), t || ha(this, [e]));
  }
  sendEvent(e, t = {}) {
    this.emit(`beforeSendEvent`, e, t);
    let n = Br(e, this._dsn, this._options._metadata, this._options.tunnel);
    for (let e of t.attachments || []) n = Dr(n, Nr(e));
    this.sendEnvelope(n).then((t) => this.emit(`afterSendEvent`, e, t));
  }
  sendSession(e) {
    let { release: t, environment: n = fr } = this._options;
    if (`aggregates` in e) {
      let r = e.attrs || {};
      if (!r.release && !t) {
        _ && S.warn(Ba);
    ...
    let r = zr(e, this._dsn, this._options._metadata, this._options.tunnel);
    this.sendEnvelope(r);
  }
  ...
  _setupIntegrations() {
    ...
    ((this._integrations = ma(this, e)), ha(this, e));
  }
  ...
  _prepareEvent(e, t, n, r) {
    ...
    return (
      ...
      Bi(i, e, t, n, this, r).then((e) =>
        e === null
          ? e
          : (this.emit(`postprocessEvent`, e, t),
            (e.contexts = { trace: $t(n), ...e.contexts }),
            (e.sdkProcessingMetadata = {
              dynamicSamplingContext: gr(this, n),
              ...e.sdkProcessingMetadata,
            }),
            e),
      )
  ...
  _captureEvent(e, t = {}, n = P(), r = F()) {
    return (
      _ &&
        $a(e) &&
        S.log(`Captured error event \`${Ia(e)[0] || `<unknown>`}\``),
      this._processEvent(e, t, n, r).then(
        (e) => e.event_id,
        (e) => {
          _ &&
            (qa(e) ? S.log(e.message) : Ka(e) ? S.warn(e.message) : S.warn(e));
        },
      )
    );
  }
    ...
    return this._prepareEvent(e, t, n, r)
      .then((e) => {
        if (e === null)
          throw (
            ...
            Ga("An event processor returned `null`, will not send event.")
          );
      ...
      .then((i) => {
        if (i === null) {
          ...
          throw Ga(`${c} returned \`null\`, will not send event.`);
        }
  ...
  _process(e, t) {
    (this._numProcessing++,
      this._promiseBuffer.add(e).then(
        ...
        (e) => (
          this._numProcessing--,
          e === Da && this.recordDroppedEvent(`queue_overflow`, t),
          e
        ),
      ));
  }
  ...
  _flushOutcomes() {
    ...
    let t = Fa(e, this._options.tunnel && On(this._dsn));
    this.sendEnvelope(t);
  }
};
function Xa(e) {
...
function Za(e, t) {
  ...
  if (Ze(e))
    return e.then(
      (e) => {
        if (!qe(e) && e !== null) throw Wa(n);
        return e;
      },
      (e) => {
        throw Wa(`${t} rejected with ${e}`);
      },
    );
  if (!qe(e) && e !== null) throw Wa(n);
  return e;
...
function Qa(e, t, n, r) {
  let {
    ...
    c = n;
  if ($a(c) && i) return i(c, r);
  if (eo(c)) {
    if (o || s) {
      let t = La(c);
      if (s?.length && lr(t, s)) return null;
      if (o) {
        let e = o(t);
        e ? (c = It(n, Ra(e))) : ar();
      }
...
function to(e) {
  let t = 0;
  return (e.name && (t += e.name.length * 2), (t += 8), t + ro(e.attributes));
}
function no(e) {
  let t = 0;
  return (e.message && (t += e.message.length * 2), t + ro(e.attributes));
}
function ro(e) {
  if (!e) return 0;
  let t = 0;
...
function bo(e, t) {
  let n = I(),
    r = F();
  if (!n) return;
  let { beforeBreadcrumb: i = null, maxBreadcrumbs: a = yo } = n.getOptions();
  if (a <= 0) return;
...
var xo,
  ...
  Do = G((e = {}) => {
    ...
    return {
      ...
      processEvent(n, r, i) {
        return ((t ||= ko(e, i.getOptions())), Ao(n, t) ? null : n);
      },
    };
  }),
  Oo = G((e = {}) => ({ ...Do(e), name: `InboundFilters` }));
function ko(e = {}, t = {}) {
  return {
...
function Ao(e, t) {
  ...
  } else if (e.type === `transaction` && Mo(e, t.ignoreTransactions))
    return (
      _ &&
        S.warn(
...
function jo(e, t) {
  return t?.length ? Ia(e).some((e) => gt(e, t)) : !1;
}
function Mo(e, t) {
...
function Io(e) {
  try {
    ...
    return (_ && S.error(`Cannot extract url for event ${xt(e)}`), null);
  }
}
function Lo(e) {
...
function Ro(e, t, n, r, i, a) {
  if (!i.exception?.values || !a || !$e(a.originalException, Error)) return;
  let o =
    i.exception.values.length > 0
      ? i.exception.values[i.exception.values.length - 1]
      : void 0;
  o &&
    (i.exception.values = zo(
      e,
      t,
      r,
      a.originalException,
...
function zo(e, t, n, r, i, a, o, s) {
  ...
  if ($e(r[i], Error)) {
    ...
    let a = e(t, r[i]),
      l = c.length;
    (Vo(a, i, l, s), (c = zo(e, t, n, r[i], i, [a, ...c], a, l)));
  }
  return (
      ...
      e in v.console &&
        D(v.console, e, function (t) {
          return (
            (ue[e] = t),
            function (...t) {
              (w(`console`, { args: t, level: e }), ue[e]?.apply(v.console, t));
            }
          );
        });
    });
...
function ts(e, t, n, r) {
  let i = go({ span: n, propagateTraceparent: r }),
    a = i[`sentry-trace`],
    o = i.baggage,
    s = i.traceparent;
  if (!a) return;
  let c = t.headers || (tt(e) ? e.headers : void 0);
  if (!c) return { ...i };
  if (is(c)) {
    let e = new Headers(c);
    if (
    ...
    let t = c.find((e) => e[0] === `baggage` && rs(e[1]));
    ...
    let e = `sentry-trace` in c ? c[`sentry-trace`] : void 0,
      ...
      l = n && (Array.isArray(n) ? n.find((e) => rs(e)) : rs(n));
    o && !l && i.push(o);
    let u = {
      ...c,
      "sentry-trace": e ?? a,
...
function rs(e) {
  return e.split(`,`).some((e) => e.trim().startsWith(vn));
}
function is(e) {
...
function as(e, t, n) {
  let r = lo(e);
  return { name: r ? `${t} ${uo(r)}` : t, attributes: os(e, r, t, n) };
}
function os(e, t, n, r) {
  let i = {
    url: e,
  ...
  return (
    t &&
      (co(t) || ((i[`http.url`] = t.href), (i[`server.address`] = t.host)),
  ...
  if (t && typeof t.createElement == `function`)
    try {
      ...
      ((n.hidden = !0),
        ...
        n.contentWindow?.fetch && (e = ds(n.contentWindow.fetch)),
...
function bs(e) {
  ...
  if (e.length === 2) {
    ...
    return {
      url: ys(t),
      method: vs(n, `method`) ? String(n.method).toUpperCase() : `GET`,
    };
  }
  let t = e[0];
  return {
    url: ys(t),
    method: vs(t, `method`) ? String(t.method).toUpperCase() : `GET`,
  };
}
function xs(e) {
  let [t, n] = e;
  try {
    ...
    if (tt(t)) return new Headers(t.headers);
  } catch {}
}
function Ss() {
...
var Ns = `sentry-electron-renderer-id`;
function Ps(e) {
  let t = Ms(e);
...
function Is(e = I()) {
  ...
  let n = e.getOptions().ipcNamespace,
    r = Ps(n);
  return (Fs.set(e, r), r.sendRendererStart(), r);
}
var K = v,
  Ls = 0;
function Rs() {
...
function Bs(e, t = {}) {
    ...
    try {
      ...
      throw (
        ...
        Qt((r) => {
          (r.addEventProcessor(
            (e) => (
              t.mechanism && (St(e, void 0, void 0), Ct(e, t.mechanism)),
  ...
  (st(r, e), O(e, `__sentry_wrapped__`, r));
  try {
...
function Us(e, t, n, r) {
  let i = I()?.getOptions().normalizeDepth,
    a = ic(t),
    o = { __serialized__: yr(t, i) };
  if (a) return { exception: { values: [Hs(e, a)] }, extra: o };
  let s = {
    exception: {
      values: [
        {
          type: Je(t) ? t.constructor.name : r ? `UnhandledRejection` : `Error`,
          value: nc(t, { isUnhandledRejection: r }),
        },
      ],
    },
    extra: o,
...
function Ws(e, t) {
  return { exception: { values: [Hs(e, t)] } };
}
function Gs(e, t) {
...
var Ks = /Minified React error #\d+;/i;
function qs(e) {
  return e && Ks.test(e.message) ? 1 : 0;
}
function Js(e) {
...
function Qs(e, t, n, r) {
  let i = ec(e, t, n?.syntheticException || void 0, r);
  return (
    Ct(i),
    (i.level = `error`),
...
function $s(e, t, n = `info`, r, i) {
  let a = tc(e, t, r?.syntheticException || void 0, i);
  return ((a.level = n), r?.event_id && (a.event_id = r.event_id), Si(a));
}
function ec(e, t, n, r, i) {
  let a;
  if (He(t) && t.error) return Ws(e, t.error);
  if (Ue(t) || We(t)) {
    let i = t;
    if (`stack` in t) a = Ws(e, t);
    else {
      let t = i.name || (Ue(i) ? `DOMError` : `DOMException`),
  ...
  return Be(t)
    ? Ws(e, t)
    : qe(t) || Je(t)
      ? ((a = Us(e, t, n, i)), Ct(a, { synthetic: !0 }), a)
      : ((a = tc(e, t, n, r)),
        St(a, `${t}`, void 0),
        Ct(a, { synthetic: !0 }),
        a);
...
function nc(e, { isUnhandledRejection: t }) {
  let n = ft(e),
    r = t ? `promise rejection` : `exception`;
  return He(e)
    ? `Event \`ErrorEvent\` captured as ${r} with message \`${e.message}\``
    : Je(e)
      ? `Event \`${rc(e)}\` (type=${e.type}) captured as ${r}`
...
var ac = class extends Ya {
  constructor(e) {
    let t = oc(e);
    (ho(t, `browser`, [`browser`], K.SENTRY_SDK_SOURCE || Cs()),
      t._metadata?.sdk &&
    ...
    (K.document &&
      ...
      K.document.addEventListener(`visibilitychange`, () => {
        K.document.visibilityState === `hidden` &&
          (r && this._flushOutcomes(), i && ya(this), s && wa(this));
      }),
      n && this.on(`beforeSendSession`, mo));
  }
  eventFromException(e, t) {
    return Qs(this._options.stackParser, e, t, this._options.attachStacktrace);
  }
...
var sc = typeof __SENTRY_DEBUG__ > `u` || __SENTRY_DEBUG__,
  q = v,
  cc = (e, t) => (e > t[1] ? `poor` : e > t[0] ? `needs-improvement` : `good`),
  lc = (e, t, n, r) => {
    let i, a;
    return (o) => {
      t.value >= 0 &&
        ...
        ((a = t.value - (i ?? 0)),
        (a || i === void 0) &&
          ((i = t.value), (t.delta = a), (t.rating = cc(t.value, n)), e(t)));
    };
  },
  uc = (e = !0) => {
  ...
  _c = (e) => {
    if (yc(e) && mc > -1) {
      if (e.type === `visibilitychange` || e.type === `pagehide`)
        for (let e of hc) e();
      isFinite(mc) ||
        ((mc = e.type === `visibilitychange` ? e.timeStamp : 0),
        pc(`prerenderingchange`, _c, !0));
    }
  },
  vc = () => {
    if (q.document && mc < 0) {
      ...
      ((mc =
        (q.document.prerendering
          ...
          : globalThis.performance
              ...
              ?.startTime) ?? gc()),
        fc(`visibilitychange`, _c, !0),
        fc(`pagehide`, _c, !0),
        fc(`prerenderingchange`, _c, !0));
    }
    return {
      get firstHiddenTime() {
        return mc;
...
var bc = () =>
  ...
  Sc = new WeakMap();
function Cc(e, t) {
  return (Sc.get(e) || Sc.set(e, new t()), Sc.get(e));
}
var wc = class e {
    constructor() {
          ...
          for (let t of e)
            t.name === `first-contentful-paint` &&
              ...
              t.startTime < n.firstHiddenTime &&
                ((r.value = Math.max(t.startTime - dc(), 0)),
                r.entries.push(t),
                i(!0)));
        });
      a && (i = lc(e, r, Oc, t.reportAllChanges));
    });
  },
  Ac = [0.1, 0.25],
  jc = (e, t = {}) => {
    kc(
      Ec(() => {
        let n = xc(`CLS`, 0),
          ...
          s = Tc(`layout-shift`, o);
        s &&
          ((r = lc(e, n, Ac, t.reportAllChanges)),
          i.onHidden(() => {
            (o(s.takeRecords()), r(!0));
          }),
          q?.setTimeout?.(r));
  ...
  Fc = (e) => {
    e.forEach((e) => {
      e.interactionId &&
        ((Nc = Math.min(Nc, e.interactionId)),
        (Pc = Math.max(Pc, e.interactionId)),
        (Mc = Pc ? (Pc - Nc) / 7 + 1 : 0));
    });
  },
  Ic,
  Lc = () => (Ic ? Mc : performance.interactionCount || 0),
  Rc = () => {
  ...
  Hc = class e {
    ...
    _processEntry(e) {
      ...
      if (
        n ||
        this._longestInteractionList.length < zc ||
        ...
        if (
          ...
          let e = this._longestInteractionList.splice(zc);
  ...
  Uc = (e) => {
    ...
    (fc(`visibilitychange`, t, !0), fc(`pagehide`, t, !0));
  },
  Wc = (e) => {
    ...
    q.document?.visibilityState === `hidden`
      ? e()
      : ((e = Ec(e)),
        fc(`visibilitychange`, e, { once: !0, capture: !0 }),
        t(() => {
          (e(), pc(`visibilitychange`, e, { capture: !0 }));
        }),
        Uc(e));
  },
  Gc = [200, 500],
  ...
  qc = (e, t = {}) => {
    ...
    Dc(() => {
      ...
      let r = xc(`INP`),
        ...
        s = Tc(`event`, o, { durationThreshold: t.durationThreshold ?? Kc });
      ((i = lc(e, r, Gc, t.reportAllChanges)),
        s &&
  ...
  Xc = (e, t = {}) => {
    Dc(() => {
      ...
      if (s) {
        i = lc(e, r, Yc, t.reportAllChanges);
        let n = Ec(() => {
            (o(s.takeRecords()), s.disconnect(), i(!0));
          }),
          a = (e) => {
            e.isTrusted && (Wc(n), pc(e.type, a, { capture: !0 }));
          };
  ...
  Qc = (e) => {
    q.document?.prerendering
      ...
      : q.document?.readyState === `complete`
        ? setTimeout(e)
        : addEventListener(`load`, () => Qc(e), !0);
  },
  $c = (e, t = {}) => {
    let n = xc(`TTFB`),
      r = lc(e, n, Zc, t.reportAllChanges);
    Qc(() => {
      let e = uc();
      e &&
        ((n.value = Math.max(e.responseStart - dc(), 0)),
        (n.entries = [e]),
        r(!0));
    });
  },
  ...
  al;
function ol(e, t = !1) {
  return gl(`cls`, e, fl, nl, t);
}
function sl(e, t = !1) {
  return gl(`lcp`, e, pl, rl, t);
}
function cl(e) {
  return gl(`ttfb`, e, ml, il);
}
function ll(e) {
  return gl(`inp`, e, hl, al);
}
function ul(e, t) {
  return (vl(e, t), tl[e] || (_l(e), (tl[e] = !0)), yl(e, t));
}
function dl(e, t) {
  let n = el[e];
  if (n?.length)
...
function ml() {
  return $c((e) => {
    (dl(`ttfb`, { metric: e }), (il = e));
  });
}
function hl() {
  return qc((e) => {
    (dl(`inp`, { metric: e }), (al = e));
  });
}
...
function kl(e, t, n, r) {
  ...
  let c = Cl({ name: o, transaction: a, attributes: s, startTime: i });
...
function Ml(e) {
  ...
  if (e.nextHopProtocol != null) {
    let { name: n, version: r } = Tl(e.nextHopProtocol);
    ((t[`network.protocol.version`] = r), (t[`network.protocol.name`] = n));
  }
  return j() || wl()?.timeOrigin
    ? Nl({
        ...t,
      ...
      for (let n of e)
        if (n.name === `click`) {
          let e = J(j() + n.startTime),
            ...
            a = ot(n.target);
          (a && (i.attributes[`ui.component_name`] = a), Sl(t, e, e + r, i));
        }
    }
  });
}
function Vl() {
  return ol(({ metric: e }) => {
    ...
    t && ((X.cls = { value: e.value, unit: `` }), (Il = t));
  }, !0);
}
function Hl() {
  return sl(({ metric: e }) => {
  ...
  (a.slice(Fl).forEach((n) => {
    ...
    if (!(o === `navigation` && s && i + r < s))
      switch (n.entryType) {
        ...
        case `paint`:
        case `measure`: {
          Kl(e, n, r, a, i, t.ignorePerformanceApiSpans);
          let o = vc(),
        ...
        case `resource`:
          Ql(e, n, n.name, r, a, i, t.ignoreResourceSpans);
          break;
      }
  }),
    ...
    o === `pageload` &&
      ...
      e.setAttribute(`performance.activationStart`, dc()),
      eu(e, t)),
    (Z = void 0),
    (Il = void 0),
    (X = {}));
...
function Kl(e, t, n, r, i, a) {
  if (Gl(t) || ([`mark`, `measure`].includes(t.entryType) && gt(t.name, a)))
    return;
  let o = uc(!1),
  ...
  (c !== l &&
    ...
    ql(d, t),
    c <= u && Sl(e, c, u, { name: t.name, op: t.entryType, attributes: d }));
}
function ql(e, t) {
  try {
    let n = t.detail;
    ...
    if (typeof n == `object`) {
      for (let [t, r] of Object.entries(n))
        if (r && Ke(r)) e[`sentry.browser.measure.detail.${t}`] = r;
        else if (r !== void 0)
          try {
...
function Jl(e, t, n) {
  ([
    ...
    Yl(e, t, `secureConnection`, n, `TLS/SSL`),
    Yl(e, t, `fetch`, n, `cache`),
    Yl(e, t, `domainLookup`, n, `DNS`),
    Zl(e, t, n));
}
function Yl(e, t, n, r, i = n) {
  let a = t[Xl(n)],
    o = t[`${n}Start`];
  !o ||
    !a ||
...
function $l(e) {
  ...
  (n &&
    ...
    xl(n.rtt) && (X[`connection.rtt`] = { value: n.rtt, unit: `millisecond` })),
    xl(t.deviceMemory) &&
      e.setAttribute(`deviceMemory`, `${t.deviceMemory} GB`),
    xl(t.hardwareConcurrency) &&
...
function tu(e, t, n) {
  n.forEach(([n, r]) => {
    let i = e[n];
    i != null &&
      ((typeof i == `number` && i < Pl) || typeof i == `string`) &&
      (t[r] = i);
  });
}
function nu(e) {
...
function ru() {
  return wl() && j() ? ul(`element`, iu) : () => void 0;
}
var iu = ({ entries: e }) => {
    let t = H(),
      n = t ? V(t) : void 0,
...
function du(e) {
  if (e.type !== su) return !1;
  try {
    if (!e.target || e.target._sentryId !== cu) return !1;
  } catch {}
  return !0;
}
function fu(e, t) {
  ...
  if (
    (q.addEventListener(`popstate`, () => {
      let e = q.location.href,
        t = hu;
      ((hu = e), t !== e && w(`history`, { from: t, to: e }));
    }),
    !ls())
  )
    return;
  function e(e) {
    return function (...t) {
      ...
      if (n) {
        let r = hu,
          i = vu(String(n));
        if (((hu = i), r === i)) return e.apply(this, t);
...
function bu(e) {
  ...
  return n && (yu[e] = n.bind(q));
}
function xu(e) {
  yu[e] = void 0;
}
var Su = `__sentry_xhr_v3__`;
function Cu(e) {
  (je(`xhr`, e), Me(`xhr`, wu));
}
function wu() {
  ...
  ((e.open = new Proxy(e.open, {
    apply(e, t, n) {
      ...
      ((t[Su] = { method: a, url: o, request_headers: {} }),
        a === `POST` &&
          o.match(/sentry_key/) &&
...
function Eu(e) {
  ...
  try {
    ...
    return (sc && S.error(t, `Failed to get xhr response headers`, e), {});
  }
  return t
    ? t
        .split(
...
var Pu = ({ metric: e }) => {
  ...
  let t = J(e.value);
  if (t > Au) return;
  let n = e.entries.find((t) => t.duration === e.value && Mu[t.name]);
  if (!n) return;
...
function Fu() {
  ...
  function t(e) {
    ...
    if ((ku.set(r, n), ku.size > 50)) {
      let e = ku.keys().next().value;
      e !== void 0 && ku.delete(e);
    }
  }
  function n(e) {
  ...
  let r = ({ entries: e }) => {
    ...
    e.forEach((e) => {
      ...
      if (t == null || Ou.has(t)) return;
      let i = e.target ? E(e.target) : n(e);
      if (Du.length > 10) {
        let e = Du.shift();
        Ou.delete(e);
      }
      (Du.push(t), Ou.set(t, { span: r, elementName: i }));
    });
  };
  (ul(`event`, r), ul(`first-input`, r));
}
var Iu = 40;
function Lu(e, t = bu(`fetch`)) {
  let n = 0,
    r = 0;
  async function i(i) {
    let a = i.body.length;
  ...
  return Pa(e, i, Oa(e.bufferSize || Iu));
}
  ...
  Gu = [
    ...
    (e) => {
      ...
      if (r) {
        ...
        let [e, t] = Yu(r[1] || `?`, r[2]);
        return Bu(t, e, r[3] ? +r[3] : void 0, r[4] ? +r[4] : void 0);
      }
    },
  ],
  Ku =
  ...
  Ju = Se(Gu, [
    ...
    (e) => {
      ...
      if (t) {
        ...
        return (
          ([n, e] = Yu(n, e)),
          Bu(e, n, t[4] ? +t[4] : void 0, t[5] ? +t[5] : void 0)
        );
      }
    },
  ]),
    ...
    return {
      ...
      setup(e) {
        (t.console && Ho(td(e)),
          ...
          t.fetch && ps(rd(e)),
          t.history && gu(id(e)),
          t.sentry && e.on(`beforeSendEvent`, $u(e)));
      },
    };
  });
function $u(e) {
...
function ed(e, t) {
  return function (n) {
    ...
    (o &&
      ...
      (Q &&
        S.warn(
          `\`dom.maxStringLength\` cannot exceed ${Xu}, but a value of ${o} was configured. Sentry will use ${Xu} instead.`,
        ),
      (o = Xu)),
      typeof a == `string` && (a = [a]));
    try {
      let e = n.event,
        t = ad(e) ? e.target : e;
      ((r = E(t, { keyAttrs: a, maxStringLength: o })), (i = ot(t)));
    } catch {
      r = `<unknown>`;
    }
    ...
    (i && (s.data = { "ui.component_name": i }),
      bo(s, { event: n.event, name: n.name, global: n.global }));
  };
}
function td(e) {
  return function (t) {
    ...
    if (t.level === `assert`)
      if (t.args[0] === !1)
        ((n.message = `Assertion failed: ${mt(t.args.slice(1), ` `) || `console.assert`}`),
          (n.data.arguments = t.args.slice(1)));
      else return;
    bo(n, { input: t.args, level: t.level });
  };
}
function nd(e) {
  return function (t) {
    ...
    let { method: a, url: o, status_code: s, body: c } = i,
      ...
      d = { category: `xhr`, data: l, type: `http`, level: ss(s) };
    (e.emit(`beforeOutgoingRequestBreadcrumb`, d, u), bo(d, u));
  };
}
function rd(e) {
  return function (t) {
    ...
    if (
      ...
      if ((t.fetchData.method, t.fetchData.url, t.error)) {
        ...
        (e.emit(`beforeOutgoingRequestBreadcrumb`, o, a), bo(o, a));
      } else {
        let i = t.response,
        ...
        let o = {
          ...
          s = {
            ...
            data: a,
            type: `http`,
            level: ss(a.status_code),
          };
        (e.emit(`beforeOutgoingRequestBreadcrumb`, s, o), bo(s, o));
      }
  };
}
function id(e) {
...
var od =
  ...
  cd = G((e = {}) => {
    ...
    return {
      name: sd,
      setupOnce() {
        (t.setTimeout && D(K, `setTimeout`, ld),
          t.setInterval && D(K, `setInterval`, ld),
          t.requestAnimationFrame && D(K, `requestAnimationFrame`, ud),
          t.XMLHttpRequest &&
            `XMLHttpRequest` in K &&
            D(XMLHttpRequest.prototype, `send`, dd));
        let e = t.eventTarget;
        e && (Array.isArray(e) ? e : od).forEach((e) => fd(e, t));
      },
    };
  });
function ld(e) {
        ...
        e in n &&
          ...
          D(n, e, function (t) {
            let n = {
              ...
              r = ct(t);
            return (r && (n.mechanism.data.handler = C(r)), Bs(t, n));
          });
      }),
      e.apply(this, t)
    );
  ...
  n?.hasOwnProperty?.(`addEventListener`) &&
    (D(n, `addEventListener`, function (n) {
      return function (r, i, a) {
        try {
          pd(i) &&
            (i.handleEvent = Bs(i.handleEvent, {
              mechanism: {
        ...
        return (
          t.unregisterOriginalCallbacks && md(this, r, i),
          n.apply(this, [
            r,
            Bs(i, {
              mechanism: {
...
var hd = G(() => ({
    ...
    setupOnce() {
      ...
      (na({ ignoreDuration: !0 }),
        aa(),
        gu(({ from: e, to: t }) => {
          e !== void 0 && e !== t && (na({ ignoreDuration: !0 }), aa());
        }));
    },
  })),
  gd = `GlobalHandlers`,
  _d = G((e = {}) => {
    ...
    return {
      ...
      setup(e) {
        (t.onerror && (vd(e), Cd(`onerror`)),
          t.onunhandledrejection && (yd(e), Cd(`onunhandledrejection`)));
      },
    };
  });
function vd(e) {
  Pe((t) => {
    let { stackParser: n, attachStacktrace: r } = wd();
    if (I() !== e || Rs()) return;
    let { msg: i, url: a, line: o, column: s, error: c } = t,
      l = Sd(ec(n, c || i, void 0, r, !1), a, o, s);
    ((l.level = `error`),
      Qi(l, {
        originalException: c,
        mechanism: {
  ...
  Ad = G((e = {}) => {
    ...
    return {
      ...
      preprocessEvent(e, r, i) {
        Ro(Hs, i.getOptions().stackParser, n, t, e, r);
      },
    };
  });
function jd() {
...
function Nd(e) {
  return [Oo(), wo(), cd(), Qu(), _d(), Ad(), Ko(), Ed(), hd()];
}
function Pd(e = {}) {
  let t = !e.skipBrowserExtensionCheck && jd(),
    n = e.defaultIntegrations == null ? Nd() : e.defaultIntegrations;
  return ao(ac, {
    ...e,
    enabled: t ? !1 : e.enabled,
    stackParser: Ce(e.stackParser || Ju),
    integrations: pa({ integrations: e.integrations, defaultIntegrations: n }),
    transport: e.transport || Lu,
  });
}
function Fd(e) {
...
function Hd(e, t) {
  ...
  (n &&
    (e.addEventProcessor(
      (e) => (
        e.type === `transaction` &&
          ...
          e.spans.forEach((e) => {
            if (e.op === `http.client`) {
              let t = Bd.get(e.span_id);
              t && ((e.timestamp = t / 1e3), Bd.delete(e.span_id));
            }
          }),
        e
      ),
    ...
    i &&
      ms((e) => {
        if (e.response) {
          let t = zd.get(e.response);
          t && e.endTimestamp && Bd.set(t, e.endTimestamp);
        }
      }),
    ps((e) => {
      let t = $o(e, u, d, f, { propagateTraceparent: p, onRequestSpanEnd: l });
      if (
        (e.response &&
          e.fetchData.__span &&
          zd.set(e.response, e.fetchData.__span),
        t)
      ) {
        let n = Id(e.fetchData.url),
          r = n ? fo(n).host : void 0;
    ...
    r &&
      Cu((e) => {
        let t = Gd(e, u, d, f, p, l);
        t &&
          (o && Ud(t),
          c?.(t, { headers: Rd(e.xhr.__sentry_xhr_v3__?.request_headers) }));
      }));
}
function Ud(e) {
  let { url: t } = B(e).data;
  if (!t || typeof t != `string`) return;
  let n = ul(`resource`, ({ entries: r }) => {
    r.forEach((r) => {
      Ld(r) && r.name.endsWith(t) && (e.setAttributes(Ml(r)), setTimeout(n));
    });
  });
}
function Wd(e, t) {
  ...
  if (n) {
    ...
    let a = r.origin === i;
    return t ? gt(r.toString(), t) || (a && gt(r.pathname, t)) : a;
  } else {
    let n = !!e.match(/^\/(?!\/)/);
    return t ? gt(e, t) : n;
  }
...
function Gd(e, t, n, r, i, a) {
  ...
  if (e.endTimestamp && u) {
    ...
    n &&
      ...
      (dn(n, s.status_code),
      n.end(),
      a?.(n, { headers: Rd(Eu(o)), error: e.error }),
      delete r[t]);
    return;
  }
  let d = Id(c),
...
function Kd(e, t, n) {
  let {
    ...
    baggage: i,
    traceparent: a,
  } = go({ span: t, propagateTraceparent: n });
  r && qd(e, r, i, a);
}
function qd(e, t, n, r) {
  ...
  if (!(i?.[`sentry-trace`] || !e.setRequestHeader))
    try {
      if (
        ...
        let t = i?.baggage;
        (!t || !Fd(t)) && e.setRequestHeader(`baggage`, n);
      }
    } catch {}
}
function Jd() {
...
var Yd = `sentry_previous_trace`,
  Xd = `sentry.previous_trace`;
function Zd(e, { linkPreviousTrace: t, consistentTraceSampling: n }) {
    ...
    e.on(`beforeSampling`, (e) => {
      ...
      (t.setPropagationContext({
        ...
        dsc: {
          ...
          sampled: String(tf(i.spanContext)),
        },
        sampleRand: i.sampleRand,
      }),
        (e.parentSampled = tf(i.spanContext)),
...
function Qd(e, t, n) {
  ...
  return o.traceId === r.trace_id
    ...
    : (Date.now() / 1e3 - e.startTimestamp <= 3600 &&
        ...
        t.addLink({ context: o, attributes: { [ln]: `previous_trace` } }),
        t.setAttribute(Xd, `${o.traceId}-${o.spanId}-${tf(o) ? 1 : 0}`)),
      a);
}
function $d(e) {
  try {
    K.sessionStorage.setItem(Yd, JSON.stringify(e));
  } catch (e) {
...
function ef() {
  try {
    let e = K.sessionStorage?.getItem(Yd);
    return JSON.parse(e);
  } catch {
    return;
  }
        ...
        (e.on(`startNavigationSpan`, (n, r) => {
          ...
          if (r?.isRedirect) {
            (Q &&
              ...
              fe(e, { op: `navigation.redirect`, ...n }, !1));
            return;
          }
          ((x = void 0),
            t(),
          ...
          e.on(`startPageLoadSpan`, (n, r = {}) => {
            ...
            t();
            let i = Rn(
                r.sentryTrace || cf(`sentry-trace`),
                r.baggage || cf(`baggage`),
              ),
              a = P();
            (a.setPropagationContext(i),
              U() || (a.getPropagationContext().propagationSpanId = N()),
              a.setSDKProcessingMetadata({ normalizedRequest: Vs() }),
              fe(e, { op: `pageload`, ...n }));
          }),
          e.on(`endPageloadSpan`, () => {
            b && de && (de.setAttribute(nn, `reportPageLoaded`), de.end());
          }));
      },
      afterAllSetup(e) {
        let n = at();
        if (
          (y !== `off` &&
            Zd(e, { linkPreviousTrace: y, consistentTraceSampling: se }),
          K.location)
        ) {
          if (ae) {
            let t = j();
...
function sf(e, t, n) {
  ...
  return (
    ...
    r &&
      !i &&
      a.setSDKProcessingMetadata({ normalizedRequest: { ...Vs(), url: r } }),
    df(e)
  );
}
function cf(e) {
...
function mf(e, t) {
  let n = B(e),
    r = Dt();
  return !(r - n.start_timestamp > pf || (t && r - t <= pf));
}
function hf() {
  let e = Zt().getScopeData(),
    t = F().getScopeData(),
    n = P().getScopeData();
  return (Oi(e, t), Oi(e, n), (e.eventProcessors = []), e);
}
function gf(e) {
...
function vf(e) {
  ...
  return Pa(
    e,
    async (e) => ((t ||= Is()), t.sendEnvelope(e.body), { statusCode: 200 }),
  );
}
var yf = 50,
  [, bf] = Gu,
...
function Cf(e) {
  return [...Nd(e).filter((e) => e.name !== `BrowserSession`), _f()];
}
function wf(e = {}, t = Pd) {
...
If init has been called in the preload and contextIsolation is disabled, is not required to call init in the renderer`);
  ...
  ((window.__SENTRY__RENDERER_INIT__ = !0),
    ...
    e.defaultIntegrations === void 0 && (e.defaultIntegrations = Cf(e)),
    e.stackParser === void 0 && (e.stackParser = Sf),
    e.ipcNamespace === void 0 && (e.ipcNamespace = `sentry-ipc`),
    e.dsn === void 0 && (e.dsn = `https://12345@dummy.dsn/12345`),
    e.transport === void 0 && (e.transport = vf),
  ...
  switch (n ?? i) {
    case `idle`: {
      ...
      t[0] === r
        ...
        : ((e = () => {
            h.dispatchMessage(
              r === `macOS` ? `install-app-update` : `check-app-update`,
              {},
            );
          }),
          (t[0] = r),
...
function Pf() {
  return h.dispatchMessage(`install-app-update`, {});
}
var Ff = e(s(), 1);
function If(e) {
...
var zf = { componentStack: null, error: null, eventId: `` };
function Bf(e, t) {
  let n = new WeakMap();
  function r(e, t) {
    if (!n.has(e)) {
...
function Vf(e) {
  ...
  let o;
  t[2] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((o = (0, $.jsx)(ae, { electron: !0, children: (0, $.jsx)(Nf, {}) })),
      (t[2] = o))
    : (o = t[2]);
  let s;
  t[3] !== r || t[4] !== n
...
var Hf = class extends Ff.Component {
  state = zf;
  ...
  componentDidCatch(e, { componentStack: t }) {
    let n = t ?? ``,
      r = Rf(e) ? e : Error(String(e));
    if (Rf(e)) {
      let t = Error(e.message);
      ((t.name = `React ErrorBoundary ${t.name}`), (t.stack = n), Bf(e, t));
    }
    let i = kf(r, { boundaryName: this.props.name, componentStack: n });
    this.props.onError && this.props.onError(r, n, i);
    try {
      l.error(`error boundary`, {
  ...
  resetErrorBoundary = () => {
    ...
    (e && e(t, n ?? ``, r), this.setState(zf));
  };
  render() {
    let { fallback: e, children: t } = this.props,
      n = this.state,
      r = e ?? ((e) => (0, $.jsx)(Vf, { resetError: () => e.resetError() }));
    if (n.error) {
      let e;
      return (
        (e =
          typeof r == `function`
            ...
            : r),
        (0, Ff.isValidElement)(e) ? e : null
      );
    }
    return typeof t == `function` ? t() : t;
  }
};
export { Df as a, jf as i, Nf as n, Of as o, Af as r, Hf as t };
//# sourceMappingURL=error-boundary-CVsORXBJ.js.map
