...
import { t as ie } from "./invalidate-queries-and-broadcast-CPrIeBVQ.js";
import { u as ae } from "./thread-context-inputs-D4zJFWk0.js";
import { t as oe } from "./use-codex-home-B1p9XqNi.js";
import {
  a as se,
  i as ce,
  n as le,
...
import { t as de } from "./get-build-flavor-DDOtCsji.js";
var v = [
  `<svg
...
function y(e) {
  ...
  for (let n = 0; n < e.length; n += 1)
    t = (t * 31 + e.charCodeAt(n)) % v.length;
  return v[t] ?? ``;
}
var b = e(r(), 1),
  x = {
...
async function S(e, t, n) {
  ...
  try {
    ...
    return i.contentsBase64 ? `data:${w(r)};base64,${i.contentsBase64}` : null;
  } catch (e) {
    return (
...
function w(e) {
  return x[b.default.extname(e).toLowerCase()] ?? `application/octet-stream`;
}
var fe = _(),
  T = [`plugins`],
  E = 4,
  ...
  k = [],
  A = `computer-use`,
  j = `.tmp/marketplaces/openai-internal-testing`,
  M = new Set(
    [`codex-official`, ...s, `openai-curated`, `openai-primary-runtime`].map(J),
  );
function N(e) {
  return {
    ...Q(e.summary),
...
function P({ marketplacePath: e, remoteMarketplaceName: t }) {
  if (e != null && t != null)
...
function I(e) {
  return e.marketplacePath == null ? R(e.plugin) : e.plugin.name;
}
function L(e) {
  return e.marketplacePath == null ? R(e.plugin) : e.plugin.id;
}
function R(e) {
...
function z(e) {
  return { ...P(e), pluginName: I(e) };
}
function B({ marketplaceName: e, marketplacePath: t }) {
  return t == null
...
function V(e, t, n) {
  ...
  let a = ue(i) && (n?.enabled ?? !0),
    o = n?.additionalMarketplaceKinds ?? O,
    ...
    v;
  r[2] !== e || r[3] !== _
    ? ((v = _.includes(e)), (r[2] = e), (r[3] = _), (r[4] = v))
    : (v = r[4]);
  let y = v,
    b = a && y,
    x;
  r[5] !== e || r[6] !== b
    ? ((x = { enabled: b, hostId: e }), (r[5] = e), (r[6] = b), (r[7] = x))
    : (x = r[7]);
  let S = se(x),
    C;
  r[8] === e ? (C = r[9]) : ((C = { hostId: e }), (r[8] = e), (r[9] = C));
  let w = le(C),
    E;
  r[10] !== e || r[11] !== g
    ? ((E = { hostId: e, isHostLocal: g }),
      (r[10] = e),
      (r[11] = g),
      (r[12] = E))
    : (E = r[12]);
  let A = ce(E),
    ...
    N = a && y && (t !== void 0 || m.isFetched),
    P;
  r[13] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((P = de()), (r[13] = P))
    : (P = r[13]);
  let F = P,
    I = s == null ? ye(e, M, c) : _e(e, M, O, s),
    L;
  r[14] !== F ||
  r[15] !== e ||
  r[16] !== s ||
  ...
  r[19] !== M
    ? ((L = async () => {
        let t =
          ...
          n = Oe(t.marketplaces),
          r = F == null ? n : we({ buildFlavor: F, plugins: n });
        return {
          featuredPluginIds:
            s == null
              ? F == null
                ? t.featuredPluginIds
                : Ce({ buildFlavor: F, featuredPluginIds: t.featuredPluginIds })
              : D,
          marketplaceLoadErrors: t.marketplaceLoadErrors,
          marketplaces: Te(t.marketplaces),
          plugins: await Ee({ hostId: e, plugins: r, queryClient: f }),
        };
      }),
      (r[14] = F),
      (r[15] = e),
  ...
  r[30] !== A.available ||
  r[31] !== w.available ||
  r[32] !== z.data?.featuredPluginIds ||
  r[33] !== z.data?.plugins
    ? ((H = {
        isComputerUseAvailable: S.available,
        isExternalBrowserUseAvailable: A.available,
        isInAppBrowserUseAvailable: w.available,
      }),
      (U = z.data?.plugins ?? k),
      (W = xe({ plugins: U, ...H })),
      (G = be({ featuredPluginIds: z.data?.featuredPluginIds ?? D, ...H })),
      (r[29] = S.available),
      (r[30] = A.available),
      (r[31] = w.available),
      (r[32] = z.data?.featuredPluginIds),
      ...
      (r[36] = W),
      (r[37] = G))
    : ((H = r[34]), (U = r[35]), (W = r[36]), (G = r[37]));
  let K;
  r[38] === U ? (K = r[39]) : ((K = Se(U)), (r[38] = U), (r[39] = K));
  let q = z.data?.marketplaceLoadErrors ?? pe,
    J = z.data?.marketplaces ?? me,
  ...
  r[40] !== H || r[41] !== z
    ? ((Q = async () => {
        let e = (await z.refetch()).data?.plugins ?? k;
        return {
          availablePlugins: xe({ plugins: e, ...H }),
          installedPlugins: Se(e),
        };
      }),
      (r[40] = H),
      (r[41] = z),
...
async function he() {}
async function ge() {
  return { availablePlugins: k, installedPlugins: k };
}
function H(e) {
  let t = (0, fe.c)(10),
...
function _e(e, t, n = O, r = null) {
  return r == null
    ? ye(e, t, ve({ additionalMarketplaceKinds: n, includeRemoteCatalog: !0 }))
    : [...T, e, t, `installed`, r];
}
function ve({ additionalMarketplaceKinds: e, includeRemoteCatalog: t }) {
  return t && e.length === 0 ? null : [`local`, ...e];
}
function ye(e, t, n) {
  return n == null ? [...T, e, t] : [...T, e, t, `marketplace-kinds`, n];
}
function be({ featuredPluginIds: e, ...t }) {
  return e.filter((e) => U(e, t));
}
function xe({ plugins: e, ...t }) {
  return e.filter((e) => U(e.plugin.id, t));
}
function Se(e) {
...
function Ce({ buildFlavor: e, featuredPluginIds: t }) {
  let n = c(e);
  return t.filter((e) => {
    let t = l(e);
...
function we({ buildFlavor: e, plugins: t }) {
  let n = c(e);
...
async function Ee({ hostId: e, plugins: t, queryClient: n }) {
  let r = [...t];
  async function i(a) {
    let o = t[a];
    if (o == null) return;
    let [s, c] = await Promise.all([
      S(o.composerIconPath, e, n),
      S(o.logoPath, e, n),
    ]);
    ((s != null || c != null) &&
      (r[a] = {
  ...
  return (
    await Promise.all(
      Array.from({ length: Math.min(E, t.length) }, (e, t) => i(t)),
    ),
    r
  );
}
function De({
  ...
  let i = t === `local` && e != null ? f(e, j) : null;
  return X(
    [
...
function X(e, t) {
  return Array.from(
    new Set(e.map((e) => e.trim()).filter((e) => o(e) && Z(e, t))),
  );
}
function Z(e, t) {
  return t == null
    ...
    for (let e of n.plugins)
      t.has(e.id) ||
        t.set(e.id, {
          ...
          plugin: e,
          keywords: e.keywords,
          ...B({ marketplaceName: n.name, marketplacePath: n.path }),
        });
