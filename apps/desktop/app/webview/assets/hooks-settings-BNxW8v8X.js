...
import { Ca as t, Qi as n } from "./app-server-manager-signals-Csopz8aM.js";
...
import { u as M } from "./links-BkSjb4EC.js";
import "./_defineProperty-Cewpr_r1.js";
import { t as N } from "./chevron-CEHg0DRl.js";
import { t as P } from "./folder-DnqvPFV1.js";
import { t as F } from "./warning-Cmz-KXha.js";
import { t as I } from "./get-project-name-D3LJ0iVD.js";
import "./sortBy-Dqo8FD7r.js";
import "./use-connected-remote-connections-BjxI1Jtl.js";
import { t as L } from "./banner-DpRpGxUf.js";
import { t as R } from "./toggle-Ray5d_Lx.js";
import { a as z, i as B, r as ee } from "./hooks-settings-queries-DAs0g-NL.js";
import {
  a as V,
  i as H,
  n as U,
  r as W,
  t as G,
} from "./hooks-settings-model-B0m5hjMs.js";
import { t as te } from "./regenerate-C3FUHd6G.js";
import { i as K } from "./settings-shared-B5KlTTu7.js";
import "./settings-host-selection-9fosNT9W.js";
import { t as ne } from "./settings-host-context-B5kZhSF6.js";
import { t as q } from "./settings-content-layout-Bnulb0lM.js";
import { n as J } from "./settings-row-DYYQqFuu.js";
import { t as Y } from "./settings-surface-YwAy0P94.js";
import { t as X } from "./hooks-B5S4lAt0.js";
import { r as re } from "./plugin-detail-route-utils-CB0gVYMU.js";
var Z = h(),
  ie = e(r()),
  Q = i();
function ae(e, t) {
...
function oe(e, t) {
  switch (e) {
    case `preToolUse`:
      return t.formatMessage($.preToolUse);
    case `permissionRequest`:
      return t.formatMessage($.permissionRequest);
    case `postToolUse`:
      return t.formatMessage($.postToolUse);
    case `preCompact`:
      return t.formatMessage($.preCompact);
    case `postCompact`:
      return t.formatMessage($.postCompact);
    case `sessionStart`:
      return t.formatMessage($.sessionStart);
    case `userPromptSubmit`:
      return t.formatMessage($.userPromptSubmit);
    case `subagentStart`:
      return t.formatMessage($.subagentStart);
    case `stop`:
      return t.formatMessage($.stop);
  }
}
function se(e, t) {
  switch (e) {
    case `preToolUse`:
      return t.formatMessage($.preToolUseDescription);
    case `permissionRequest`:
      return t.formatMessage($.permissionRequestDescription);
    case `postToolUse`:
      return t.formatMessage($.postToolUseDescription);
    case `preCompact`:
      return t.formatMessage($.preCompactDescription);
    case `postCompact`:
      return t.formatMessage($.postCompactDescription);
    case `sessionStart`:
      return t.formatMessage($.sessionStartDescription);
    case `userPromptSubmit`:
      return t.formatMessage($.userPromptSubmitDescription);
    case `subagentStart`:
      return t.formatMessage($.subagentStartDescription);
    case `stop`:
      return t.formatMessage($.stopDescription);
  }
}
function ce(e, t) {
  return t.formatMessage($.fallbackHookTitle, { index: e + 1 });
}
function le(e, t, n, r) {
  if (e.source === `plugin`) {
    let n = ue(e.pluginId);
    return n == null
      ? t.formatMessage($.pluginSource)
      : t.formatMessage($.pluginSourceSummary, { pluginName: n });
  }
  return e.source === `project` && n != null
    ? t.formatMessage($.projectSourceSummary, { projectName: n })
    : e.source === `user`
      ? t.formatMessage($.userConfigSourceSummary, {
          path: de(e.sourcePath, r),
        })
      : fe(e.source, t);
}
function ue(e) {
...
function de(e, t) {
  let r = n(e),
    i = t == null ? null : n(t).replace(/\/+$/, ``);
  return r.startsWith(`~/.codex/`)
    ? r.slice(9)
    : i != null && r.startsWith(`${i}/`)
      ? r.slice(i.length + 1)
      : r;
}
function fe(e, t) {
  switch (e) {
    ...
    case `legacyManagedConfigMdm`:
      return t.formatMessage($.adminConfigSource);
    case `user`:
      return t.formatMessage($.userConfigSource);
    case `project`:
      return t.formatMessage($.projectConfigSource);
    case `sessionFlags`:
      return t.formatMessage($.sessionFlagsSource);
    case `plugin`:
      return t.formatMessage($.pluginSource);
    case `unknown`:
      return t.formatMessage($.unknownSource);
  }
}
var $ = o({
    preToolUse: {
    ...
    pluginSourceSummary: {
      id: `settings.hooks.source.pluginSummary`,
      defaultMessage: `Plugin · {pluginName}`,
      description: `Source summary for plugin hooks`,
    },
    adminConfigSource: {
    ...
    userConfigSourceSummary: {
      id: `settings.hooks.source.userConfigSummary`,
      defaultMessage: `User config · {path}`,
      description: `Source summary for user config hooks`,
    },
    projectConfigSource: {
    ...
    projectSourceSummary: {
      id: `settings.hooks.source.projectSummary`,
      defaultMessage: `Project · {projectName}`,
      description: `Source summary for project hooks`,
    },
    sessionFlagsSource: {
...
function me(e) {
  ...
  if (
    ...
    let e = W(a, n);
    ((_ = `border-t border-token-border px-3`),
      (h = `divide-y-[0.5px] divide-token-border`));
    let d;
    (t[13] !== c ||
    t[14] !== r ||
    t[15] !== f ||
    ...
    t[20] !== o
                      ...
                      children: (0, Q.jsx)(S, {
                        ...
                        children: (0, Q.jsx)(`span`, {
                          ...
                          children: (0, Q.jsx)(C, {
                            ...
                            children: (0, Q.jsx)(T, { className: `icon-xxs` }),
                          }),
                        }),
                      }),
                    }),
      ...
      (t[11] = g),
      (t[12] = _));
  } else ((h = t[10]), (g = t[11]), (_ = t[12]));
  let v;
  t[22] !== h || t[23] !== g
    ? ((v = (0, Q.jsx)(`div`, { className: h, children: g })),
      (t[22] = h),
      (t[23] = g),
      (t[24] = v))
    : (v = t[24]);
  ...
  return (
    t[25] !== _ || t[26] !== v
      ? ((y = (0, Q.jsx)(`div`, { className: _, children: v })),
        (t[25] = _),
        (t[26] = v),
        (t[27] = y))
      : (y = t[27]),
...
function ge(e) {
  let t = (0, Z.c)(17),
    { hook: n, projectName: r, codexHome: i } = e,
    a = d(),
    o;
  t[0] === n.pluginId
    ? (o = t[1])
    : ((o = ue(n.pluginId)), (t[0] = n.pluginId), (t[1] = o));
  let c = o,
    l;
  t[2] !== n.pluginId || t[3] !== n.source
    ? ((l =
        n.source === `plugin` && n.pluginId != null ? re(n.pluginId) : null),
      (t[2] = n.pluginId),
      (t[3] = n.source),
      (t[4] = l))
    : (l = t[4]);
  let u = l;
  if (n.source === `plugin` && c != null) {
    let e;
    t[5] === u
      ? (e = t[6])
      : ((e = (e) =>
    ...
    return (
      t[7] !== c || t[8] !== e
        ? ((n = (0, Q.jsx)(s, {
            id: `settings.hooks.source.pluginSummaryWithLink`,
            defaultMessage: `Plugin · <link>{pluginName}</link>`,
            description: `Source summary for plugin hooks with a plugin details link`,
            values: { pluginName: c, link: e },
          })),
          (t[7] = c),
          (t[8] = e),
          (t[9] = n))
  ...
  return (
    t[15] === f
      ? (p = t[16])
      : ((p = (0, Q.jsx)(Q.Fragment, { children: f })),
        (t[15] = f),
        (t[16] = p)),
    p
  );
...
function _e(e) {
  ...
  t[0] === c
    ...
    : ((m =
        c == null
          ...
          : (0, Q.jsx)(O, {
              asChild: !0,
              children: (0, Q.jsx)(`h2`, { children: c }),
            })),
      (t[0] = c),
      (t[1] = m));
  let h = m,
  ...
  t[18] === y
    ? (b = t[19])
    : ((b = (0, Q.jsx)(D, { className: `gap-3`, children: y })),
      (t[18] = y),
      (t[19] = b));
  let x;
  t[20] !== v || t[21] !== b
    ? ((x = (0, Q.jsxs)(j, { className: `gap-4`, children: [v, b] })),
      (t[20] = v),
      (t[21] = b),
      (t[22] = x))
    : (x = t[22]);
...
function ve(e) {
  ...
  if (
    ...
    (t[14] === v
      ? (m = t[15])
      : ((m = v > 0 ? (0, Q.jsx)(be, {}) : null), (t[14] = v), (t[15] = m)),
      t[16] !== _ || t[17] !== y || t[18] !== u || t[19] !== d
        ? ((h =
            y > 0
              ? (0, Q.jsx)(xe, {
                  errors: _,
              ...
              children: e.map((e) =>
                (0, Q.jsxs)(
                  `div`,
                  {
                    children: [
                      (0, Q.jsx)(J, {
                        icon: (0, Q.jsx)(X, { className: `icon-xs` }),
                        label: oe(e.eventName, l),
                        description: se(e.eventName, l),
                        control:
                          e.needsReview > 0
                            ? (0, Q.jsx)(F, {
      ...
      (t[12] = h),
      (t[13] = g));
  } else ((m = t[11]), (h = t[12]), (g = t[13]));
  let _;
  return (
    t[21] !== m || t[22] !== h || t[23] !== g
      ? ((_ = (0, Q.jsxs)(Q.Fragment, { children: [m, h, g] })),
        (t[21] = m),
        (t[22] = h),
        (t[23] = g),
        (t[24] = _))
...
function xe(e) {
        ...
        children: [
          ...
          (0, Q.jsx)(`span`, {
            ...
            children: (0, Q.jsx)(s, {
              ...
              defaultMessage: `{count, plural, one {# issue loading hooks for this project} other {# issues loading hooks for this project}}`,
  ...
  t[5] === f
    ? (p = t[6])
    : ((p = (0, Q.jsx)(N, { className: f })), (t[5] = f), (t[6] = p));
  let m;
  t[7] !== c || t[8] !== u || t[9] !== p
    ? ((m = (0, Q.jsxs)(`button`, {
        type: `button`,
...
function Ce(e) {
  return (0, Q.jsx)(`div`, { children: e }, e);
}
var we = `hooks-settings`;
function Te(e) {
  let t = (0, Z.c)(50),
    {
      entries: n,
      ...
      codexHome: m,
      onSelectProjectRoot: h,
      onRefreshHooks: g,
      onToggleHookEnabled: _,
      onTrustHook: v,
    } = e,
    y = d(),
    b;
  ...
  t[2] !== n || t[3] !== c || t[4] !== f
    ...
    : (w = t[5]);
  let T = w,
    E = p != null && T?.includes(p) === !0 ? p : null,
    D;
  t[6] !== n || t[7] !== E
    ? ((D = n?.find((e) => e.cwd === E) ?? null),
      (t[6] = n),
      (t[7] = E),
      (t[8] = D))
    : (D = t[8]);
  ...
  t[10] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((A = (0, Q.jsx)(s, {
      ...
      (t[10] = A))
    : (A = t[10]);
  let j = f == null || f.length === 0 || c || l,
    M;
  t[11] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((M = (0, Q.jsx)(te, { className: `icon-xs` })), (t[11] = M))
    : (M = t[11]);
  let N;
  t[12] !== g || t[13] !== x || t[14] !== j
    ? ((N = (0, Q.jsx)(C, {
        "aria-label": x,
        color: `ghost`,
        disabled: j,
    ...
    ? ((F =
        f == null && a
          ? (0, Q.jsx)(Y, {
              children: (0, Q.jsx)(J, {
                label: (0, Q.jsx)(s, {
                  id: `settings.hooks.loadingProjects.label`,
                  defaultMessage: `Loading projects…`,
                  description: `Label while hooks project roots are loading`,
                }),
                control: null,
              }),
            })
          : f == null || f.length === 0
            ? (0, Q.jsx)(Y, {
                children: (0, Q.jsx)(J, {
                  label: (0, Q.jsx)(s, {
                    id: `settings.hooks.emptyProject.label`,
                    defaultMessage: `No projects found`,
                    description: `Label when hooks settings has no projects`,
                  }),
                  description: (0, Q.jsx)(s, {
                    id: `settings.hooks.emptyProject.description`,
                    defaultMessage: `Open a project to view its hooks`,
                    description: `Description when hooks settings has no projects`,
                  }),
                  control: null,
                }),
              })
                ...
                ? (0, Q.jsx)(Y, {
                    children: (0, Q.jsx)(J, {
                      ...
                      description: (0, Q.jsx)(s, {
                        ...
                        description: `Description when known projects do not have hooks or hook load issues`,
                      }),
                      control: null,
                    }),
                  })
  ...
  let I = E ?? `none`,
    L;
  t[28] !== u || t[29] !== E
    ? ((L = E == null ? null : ke(E, u)), (t[28] = u), (t[29] = E), (t[30] = L))
    : (L = t[30]);
  let R;
  t[31] === h
    ? (R = t[32])
...
function De(e) {
  let t = (0, Z.c)(23),
    {
      ...
      projectRoot: i,
      projectRootLabels: a,
      onSelectProjectRoot: o,
    } = e,
    s;
  t[0] === n
    ? (s = t[1])
    : ((s = n == null ? null : U(n)), (t[0] = n), (t[1] = s));
  let c = s,
    l;
  t[2] !== o || t[3] !== i
    ? ((l = () => {
  ...
  t[5] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((u = (0, Q.jsx)(P, { className: `icon-sm text-token-text-secondary` })),
      (t[5] = u))
    : (u = t[5]);
  let d;
  t[6] !== i || t[7] !== a
    ? ((d = ke(i, a)), (t[6] = i), (t[7] = a), (t[8] = d))
    : (d = t[8]);
  let f;
  t[9] === d
    ? (f = t[10])
    : ((f = (0, Q.jsx)(`span`, { className: `block truncate`, children: d })),
      (t[9] = d),
      (t[10] = f));
  let p;
  t[11] !== r || t[12] !== c
    ? ((p = (0, Q.jsx)(Oe, { summary: c, isLoading: r })),
      (t[11] = r),
      (t[12] = c),
      (t[13] = p))
    : (p = t[13]);
  ...
  t[14] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((m = (0, Q.jsx)(N, { className: `icon-2xs shrink-0 -rotate-90` })),
      (t[14] = m))
    : (m = t[14]);
  let h;
  t[15] === p
  ...
  let g;
  t[17] !== f || t[18] !== h
    ? ((g = (0, Q.jsx)(J, { icon: u, label: f, control: h })),
      (t[17] = f),
      (t[18] = h),
      (t[19] = g))
    : (g = t[19]);
...
function Oe(e) {
  let t = (0, Z.c)(10),
    { summary: n, isLoading: r } = e,
    i = d(),
    a = n != null && (n.issueCount > 0 || n.needsReview > 0);
  if (!r && !a) return null;
  let o;
  t[0] === a
    ? (o = t[1])
    : ((o = a
      ...
      (t[1] = o));
  let c;
  t[2] !== a || t[3] !== i || t[4] !== r || t[5] !== n
    ? ((c =
        !a && r
          ? (0, Q.jsx)(`span`, {
              className: `max-[30rem]:hidden`,
              children: (0, Q.jsx)(s, {
                id: `settings.hooks.project.loadingSummary`,
                defaultMessage: `Loading hooks…`,
                description: `Summary shown while hook counts are loading for a project`,
              }),
            })
          : (0, Q.jsx)(`span`, {
              className: `max-[30rem]:hidden`,
              children: n == null ? null : ae(n, i),
            })),
      (t[2] = a),
      (t[3] = i),
      (t[4] = r),
...
function Ae() {
  let e = (0, Z.c)(51),
    ...
    T = f(y),
    E;
  e[0] === m ? (E = e[1]) : ((E = { hostId: m }), (e[0] = m), (e[1] = E));
  let { data: D, isPending: O } = c(v, E),
    k;
  e[2] === a ? (k = e[3]) : ((k = a.get(`hostId`)), (e[2] = a), (e[3] = k));
  let A = k,
    j,
    M;
  if (
    ...
    let t = A == null || A === m ? a.get(`projectRoot`) : null,
      n =
        m === `local`
          ? (C?.roots?.[0] ?? null)
          : T?.hostId === m
            ? T.remotePath
            : null;
    ((j = D == null ? void 0 : je(D.roots, [n, t])),
      (M = t != null && j?.includes(t) === !0 ? t : null),
      (e[4] = C?.roots?.[0]),
      (e[5] = a),
      (e[6] = m),
      (e[7] = A),
  ...
  let R = c(z, m),
    V;
  e[22] !== F || e[23] !== r || e[24] !== s || e[25] !== n || e[26] !== m
    ? ((V = () => {
        F.refetch().then(async (e) => {
          e.isSuccess &&
            (await B(s, m, { broadcast: !0, refetchType: `none` }),
            n.get(x).success(
              r.formatMessage({
  ...
  let H = V,
    U;
  e[28] !== a || e[29] !== m || e[30] !== o
    ? ((U = (e) => {
        let t = new URLSearchParams(a);
        (e == null
          ? (t.delete(`hostId`), t.delete(`projectRoot`))
          : (t.set(`hostId`, m), t.set(`projectRoot`, e)),
          o(t, { replace: !0 }));
      }),
      (e[28] = a),
      (e[29] = m),
  ...
  return (
    ...
    e[49] !== N
      ? ((X = (0, Q.jsx)(Te, {
          ...
          projectRootLabels: q,
          projectRoots: j,
          selectedProjectRoot: N,
          codexHome: S,
          onSelectProjectRoot: W,
          onRefreshHooks: H,
          onToggleHookEnabled: J,
          onTrustHook: Y,
        })),
        (e[35] = S),
        (e[36] = H),
...
export { Ae as HooksSettings };
//# sourceMappingURL=hooks-settings-BNxW8v8X.js.map
