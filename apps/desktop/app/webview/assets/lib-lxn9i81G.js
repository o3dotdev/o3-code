...
function Se(e) {
  ...
  for (; ++n < u.length; ) {
    ...
    if (r[0] === `enter`)
      r[1].contentType && (Object.assign(t, Ce(u, n)), (n = t[n]), (l = !0));
...
function qe(e, t, n) {
  ...
  function S(t) {
    return t === 45 || t === 46 || t === 58 || t === 95 || x(t)
      ? (e.consume(t), S)
      : C(t);
  }
  function C(t) {
...
function rt(e, t) {
  ...
  return (
    ...
    (s = p(
      s,
      V(t.parser.constructs.insideSpan.null, e.slice(a + r + 4, o - 3), t),
    )),
    ...
    return a
      ? a._inactive
        ...
        : ((o = r.parser.defined.includes(
            y(r.sliceSerialize({ start: a.end, end: r.now() })),
          )),
          e.enter(`labelEnd`),
          e.enter(`labelMarker`),
          e.consume(t),
  ...
  function c(t) {
    return t === i
      ...
      : (e.exit(`thematicBreakSequence`),
        k(t) ? N(e, s, `whitespace`)(t) : s(t));
  }
}
var Q = {
    continuation: { tokenize: vt },
    exit: bt,
    name: `list`,
    tokenize: _t,
  },
  ...
  let t = this,
    n = e.attempt(
      ...
      e.attempt(
        ...
        N(
          e,
          e.attempt(this.parser.constructs.flow, i, e.attempt(we, i)),
          `linePrefix`,
        ),
      ),
    );
...
function Ut(e, t, n) {
  ...
  function d(e) {
    return (
      ...
      v(),
      o[o.length - 1] === null
        ? (E(t, 0), (l.events = V(a, l.events, l)), l.events)
        : []
    );
  }
  function m(e, t) {
...
function tn(e) {
  ...
  function i(e) {
    ...
    for (s = -1; ++s < e.length; ) {
      ...
      $t.call(t, e[s][1].type) &&
        t[e[s][1].type].call(
          Object.assign({ sliceSerialize: e[s][2].sliceSerialize }, i),
          e[s][1],
        );
    }
  ...
  function f(e, n) {
    ...
    if (i)
      i[0].type !== e.type &&
        (n ? n.call(this, e, i[0]) : (i[1] || an).call(this, e, i[0]));
    else
      throw Error(
        "Cannot close `" +
          e.type +
...
//# sourceMappingURL=lib-lxn9i81G.js.map
