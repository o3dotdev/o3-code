...
import { i as c } from "./chunk-LFPYN7LY-CkfOxD5s.js";
import "./window-zoom-context-BgcP82Wr.js";
import { t as l } from "./tooltip-Bb9X8NK-.js";
import { t as u } from "./button-BynxeNRW.js";
import "./reduced-motion-preference-DnjdGHz7.js";
import "./spinner-avFWYgza.js";
import { t as d } from "./x-DMqExXY8.js";
import "./electron-menu-shortcuts-DQYPVyfu.js";
import "./command-keybindings-B9IgRGSI.js";
import { t as f } from "./use-window-controls-safe-area-BX_fybIh.js";
import { t as p } from "./compose-D9zy3mEn.js";
import "./use-hotkey-BtzpyVol.js";
import { t as m } from "./use-command-hotkey-B5VZRy-0.js";
import { t as h } from "./pop-in-mac-GyHEqBaX.js";
import { t as g } from "./use-hotkey-window-detail-layout-E7Gw-w1y.js";
import { t as _ } from "./use-hotkey-window-dismiss-on-escape-BllZzrRL.js";
var v = e(t(), 1),
  y = o(),
  b = n(),
  x = r({
...
function S(e) {
  ...
  t[3] !== E || t[4] !== n
    ...
    : (D = t[5]);
  let O;
  t[6] !== h || t[7] !== S || t[8] !== r || t[9] !== p
    ? ((O = p
        ? (0, b.jsx)(`div`, {
            className: `absolute flex items-center gap-0`,
            style: { left: S },
            children: (0, b.jsx)(l, {
              tooltipContent: (0, b.jsx)(i, { ...x.dismiss }),
              delayOpen: !0,
              children: (0, b.jsx)(u, {
                size: `toolbar`,
                color: `ghost`,
                "aria-label": h.formatMessage(x.dismiss),
                onClick: r,
                children: (0, b.jsx)(d, { className: `icon-xs` }),
              }),
            }),
          })
        : null),
...
function C(e) {
  ...
  t[0] !== c || t[1] !== d
    ? ((f = c
        ? (0, b.jsx)(l, {
            tooltipContent: (0, b.jsx)(i, { ...x.newThread }),
            delayOpen: !0,
            children: (0, b.jsx)(u, {
              size: `toolbar`,
              color: `ghost`,
              "aria-label": d.formatMessage(x.newThread),
              onClick: w,
              children: (0, b.jsx)(p, { className: `icon-sm` }),
            }),
          })
        : null),
      (t[0] = c),
  ...
  t[3] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((m = (0, b.jsx)(i, { ...x.openInMainWindow })), (t[3] = m))
    : (m = t[3]);
  let g;
  t[4] === d
    ? (g = t[5])
    : ((g = d.formatMessage(x.openInMainWindow)), (t[4] = d), (t[5] = g));
  let _;
  t[6] === r
    ? (_ = t[7])
    : ((_ = () => {
  ...
  t[8] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((v = (0, b.jsx)(h, { className: `icon-sm` })), (t[8] = v))
    : (v = t[8]);
  let C;
  t[9] !== g || t[10] !== _
    ? ((C = (0, b.jsx)(l, {
  ...
  let E;
  t[12] !== f || t[13] !== C
    ? ((E = (0, b.jsxs)(b.Fragment, { children: [f, C] })),
      (t[12] = f),
      (t[13] = C),
      (t[14] = E))
    : (E = t[14]);
  ...
  return (
    t[15] !== E || t[16] !== n
      ? ((D = (0, b.jsx)(S, { title: n, onDismiss: T, rightActions: E })),
        (t[15] = E),
        (t[16] = n),
        (t[17] = D))
      : (D = t[17]),
...
function w() {
  s.dispatchMessage(`hotkey-window-collapse-to-home`, {});
}
function T() {
  s.dispatchMessage(`hotkey-window-dismiss`, {});
}
function E() {
  let e = (0, y.c)(7);
  _();
  ...
  (e[0] === r
    ? (i = e[1])
    : ((i = { commandId: `newThread`, enabled: r, onKeyDown: D }),
      (e[0] = r),
      (e[1] = i)),
    m(i));
  let a;
...
export { E as HotkeyWindowDetailLayout };
//# sourceMappingURL=hotkey-window-detail-layout-C3Y98nRD.js.map
