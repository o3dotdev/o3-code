...
import { r as f } from "./product-logger-CdHJrfqL.js";
import { t as p } from "./tooltip-DzyyaBl-.js";
import { t as m } from "./button-bq66r8jD.js";
import { t as h } from "./proxy-HwxlKevX.js";
import { t as g } from "./download-Cf0FyA1Y.js";
import { t as _ } from "./with-window-C7Mmo_xd.js";
import { r as ee } from "./modal-controller-state-DPULK8bl.js";
import { t as te } from "./thinking-shimmer-d7JU22OY.js";
import { t as ne } from "./animations-ueKOHTrS.js";
import { t as re } from "./chevron-CEHg0DRl.js";
import { t as ie } from "./copy-to-clipboard-DUkEoARe.js";
import { t as ae } from "./copy-button-DEwu0JDM.js";
import { n as oe, t as se } from "./markdown-surface-DPRMy4Cr.js";
import { t as ce } from "./arrow-top-right-DAJEunDk.js";
import { t as le } from "./feedback-form-dialog-C14qhNxB.js";
var ue = e(t()),
  v = n(),
  y = (e) =>
    (0, v.jsxs)(`svg`, {
  ...
  pe = {
    thumbs_down: [
      ...
      { id: `wrong_topics_or_subtopics`, label: x.wrongTopicsOrSubtopics },
      {
        ...
        label: x.didntFollowMyInstructions,
      },
    ...
    thumbs_up: [
      ...
      { id: `good_style_format_or_visuals`, label: x.goodStyleFormatOrVisuals },
      {
        ...
        label: x.followedMyInstructionsWell,
      },
          ...
          ee(u, le, {
            ...
            onSubmit: (e) => {
              ...
              return m.submitCodexAnalyticsEvent?.({
                ...
                threadId: r,
                turnId: i,
                metadata: { details: t, has_artifacts: s, selected_option: n },
              });
            },
            options: s ? pe[e] : S[e],
          }));
...
function C(e) {
  (e.preventDefault(), d.dispatchMessage(`open-in-browser`, { url: fe }));
}
function w(e) {
  let t = (0, de.c)(17),
  ...
  let f = n === `thumbs_down` ? `icon-xs rotate-180` : `icon-xs`,
    h;
  t[6] !== l || t[7] !== f
    ? ((h = (0, v.jsx)(l, { className: f })),
      (t[6] = l),
      (t[7] = f),
      (t[8] = h))
    : (h = t[8]);
  let g;
  t[9] !== c || t[10] !== u || t[11] !== d || t[12] !== h
    ? ((g = (0, v.jsx)(m, {
        color: `ghost`,
        size: `icon`,
        "aria-pressed": u,
  ...
  return (
    t[14] !== c || t[15] !== g
      ? ((_ = (0, v.jsx)(p, { tooltipContent: c, children: g })),
        (t[14] = c),
        (t[15] = g),
        (t[16] = _))
      : (_ = t[16]),
...
function ve(e) {
  ...
  t[21] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((I = r(`text-token-foreground text-base font-semibold leading-tight`)),
      (t[21] = I))
    : (I = t[21]);
  let L;
  t[22] === n.completed
  ...
  let R;
  t[24] !== Oe || t[25] !== L
    ? ((R = (0, v.jsx)(te, { active: Oe, className: I, children: L })),
      (t[24] = Oe),
      (t[25] = L),
      (t[26] = R))
    : (R = t[26]);
  ...
  t[43] !== F || t[44] !== xe
    ? ((V = xe
        ? (0, v.jsx)(ae, { iconOnly: !0, iconClassName: `icon-2xs`, onCopy: F })
        : null),
      (t[43] = F),
      (t[44] = xe),
      (t[45] = V))
  ...
  t[56] === W
    ? (G = t[57])
    : ((G = (0, v.jsx)(re, { className: W })), (t[56] = W), (t[57] = G));
  let K;
  t[58] !== Ee || t[59] !== G
    ? ((K = (0, v.jsx)(m, {
        color: `ghost`,
...
//# sourceMappingURL=plan-summary-item-content-DKNKX0lM.js.map
