...
import { a as y, i as b, n as x, r as te, t as S } from "./dist-Dc9hCHPN.js";
var C = e(t(), 1),
  w = n();
function T(e) {
...
var re = C.forwardRef((e, t) => {
    ...
    return (
      C.useEffect(() => {
        let e = _.current;
        if (e)
          return (e.addEventListener(O, S), () => e.removeEventListener(O, S));
      }, [S]),
      (0, w.jsx)(F, {
        scope: n,
        orientation: r,
    ...
    return (
      ...
      (0, w.jsx)(j.ItemSlot, {
        ...
        children: (0, w.jsx)(o.span, {
          ...
          children:
            typeof c == `function`
              ? c({ isCurrentTabStop: p, hasTabStop: v != null })
              : c,
        }),
      })
    );
...
var J = `MenuContent`,
  ...
  Pe = C.forwardRef((e, t) => {
    ...
    let z = C.useCallback(
      (e) => F.current === P.current?.side && gt(e, P.current?.area),
      [],
    );
    return (0, w.jsx)(Oe, {
      scope: n,
  ...
  He = C.forwardRef((e, t) => {
    ...
    return (0, w.jsx)(Xe, {
      ...
      children: (0, w.jsx)(X, {
        ...
        ref: t,
        "data-state": dt(n),
        onSelect: a(i.onSelect, () => r?.(Q(n) ? !0 : !n), {
          checkForDefaultPrevented: !1,
        }),
      }),
    });
  ...
  Je = C.forwardRef((e, t) => {
    ...
    return (0, w.jsx)(Xe, {
      ...
      children: (0, w.jsx)(X, {
        ...
        ref: t,
        "data-state": dt(o),
        onSelect: a(r.onSelect, () => i.onValueChange?.(n), {
          checkForDefaultPrevented: !1,
        }),
      }),
    });
        ...
        children: (0, w.jsx)(H.Slot, {
          ...
          children: (0, w.jsx)(Pe, {
            ...
            onKeyDown: a(e.onKeyDown, (e) => {
              ...
              t &&
                n &&
                (o.onOpenChange(!1), l.trigger?.focus(), e.preventDefault());
            }),
          }),
        }),
      }),
...
//# sourceMappingURL=dist-PjNkCZD1.js.map
