import { t as e } from "./tslib.es6-PiNIxp0T.js";
import { t } from "./is-plan-event-enabled-BObLQg--.js";
function n(e, t) {
  ...
  function a(a) {
    ...
    if (o && s) {
      ...
      if (t(o, c)) {
        ...
        a.updateEvent(
          `integrations`,
          e(e(e({}, a.event.integrations), c?.integrations), l),
        );
      } else
        return (
          a.updateEvent(
            `integrations`,
            e(e({}, a.event.integrations), { All: !1, "Segment.io": !0 }),
          ),
          a
        );
    }
...
export { r as schemaFilter };
//# sourceMappingURL=schema-filter-DhwWMLTv.js.map
