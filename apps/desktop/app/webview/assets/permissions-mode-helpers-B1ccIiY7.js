...
import { ts as l, v as u } from "./app-server-manager-signals-7MlBpIlX.js";
...
var D = w(),
  O = a({ sandbox: r([`elevated`, `unelevated`]).optional() }).passthrough(),
  ee = [`windows-sandbox`, `mode`],
  te = [`windows-sandbox`, `readiness`];
function k(e) {
  return [...ee, e];
}
function A(e) {
...
async function j(e) {
  try {
    return (await l(`get-windows-sandbox-readiness-for-host`, { hostId: e }))
      .status;
  } catch (e) {
    return (
      p.error(`Failed to load Windows sandbox readiness`, {
        safe: {},
        sensitive: { error: e },
      }),
      `notConfigured`
...
function M(e) {
  ...
  t[2] !== o || t[3] !== r
    ? ((s = async () => {
        try {
          return F((await E(o, r, null, !1)).config.windows);
        } catch (e) {
          let t = e;
          return (
            p.error(`Failed to load Windows sandbox mode`, {
              safe: { error: String(t) },
              sensitive: {},
            }),
            null
  ...
  return (
    t[5] !== a || t[6] !== s
      ? ((c = { queryKey: a, queryFn: s, staleTime: b.ONE_MINUTE }),
        (t[5] = a),
        (t[6] = s),
        (t[7] = c))
      : (c = t[7]),
...
function N(e) {
  ...
  return (
    t[4] !== i || t[5] !== a || t[6] !== o
      ? ((s = { queryKey: i, queryFn: a, staleTime: b.INFINITE, enabled: o }),
        (t[4] = i),
        (t[5] = a),
        (t[6] = o),
        (t[7] = s))
...
function P(e) {
  ...
  t[4] === r
    ? (f = t[5])
    : ((f = (e) =>
        l(`batch-write-config-value-for-host`, {
          hostId: r,
          edits: [
            {
  ...
  t[6] !== i || t[7] !== s
    ? ((m = (e) => {
      ...
      (g = (e, t, n) => {
        (p.error(`Failed to update Windows sandbox mode`, {
          safe: { error: String(e) },
          sensitive: {},
        }),
    ...
    : ((m = t[8]), (g = t[9]));
  let _;
  t[10] !== a || t[11] !== s || t[12] !== d
    ? ((_ = async () => {
        await Promise.all([a(s), a(d)]);
      }),
      (t[10] = a),
      (t[11] = s),
      (t[12] = d),
  ...
  let y;
  return (
    t[14] !== f || t[15] !== m || t[16] !== g || t[17] !== _
      ? ((y = { mutationFn: f, onMutate: m, onError: g, onSettled: _ }),
        (t[14] = f),
        (t[15] = m),
        (t[16] = g),
        (t[17] = _),
...
function L() {
  let e = (0, D.c)(7),
    t = y(g),
    n = x(o.followUpQueueMode),
    r = n === `interrupt` ? `steer` : (n ?? `queue`),
    i,
    a;
  (e[0] !== n || e[1] !== t
    ? ((i = () => {
        n === `interrupt` && S(t, o.followUpQueueMode, `steer`);
      }),
      (a = [n, t]),
      (e[0] = n),
      (e[1] = t),
...
function B({
  ...
  canStopFromEscape: i,
  isComposerFocused: a,
  hasActiveMentionMenu: o,
  isTerminalTarget: s,
  hasActiveApprovalSurface: c,
}) {
  return e
    ? `abort-dictation`
    : t === `starting` || t === `active`
...
function Z({
  ...
  requirements: t,
  resolvedConfig: r,
  isGuardianApprovalEnabledByStatsig: a,
  defaultWorkspaceWriteMode: o = `auto`,
}) {
  let l = e
    ...
    u = s(r ?? void 0) ?? !0,
    d = a,
    f = l.filter((e) => e !== `guardian-approvals`),
    p = l.includes(`guardian-approvals`) && f.length === 0,
    m = (d && u) || p ? l : f,
    h = m.includes(`guardian-approvals`),
    g = m.filter((e) => e !== `custom`),
    _ = c(r ?? void 0, o),
    v = _ === `full-access` ? null : _,
    y = h && _ === `auto` && i(r ?? void 0) === `guardian_subagent`,
    b = Y(g);
  return (
    y ? (b = `guardian-approvals`) : v != null && g.includes(v) && (b = v),
    {
      availableAgentModes: m,
      canShowCustom: m.includes(`custom`),
      canUnlock: m.includes(`full-access`),
      customEquivalentMode: y ? `guardian-approvals` : _,
      isGuardianModeAvailable: h,
      isConfigDataPending: e,
      configNonFullAccessMode: b,
      showGuardianOption: d,
    }
  );
}
...
//# sourceMappingURL=permissions-mode-helpers-B1ccIiY7.js.map
