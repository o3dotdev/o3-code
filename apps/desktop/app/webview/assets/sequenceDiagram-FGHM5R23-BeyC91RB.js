...
import { t } from "./dist-OQR0lEt7.js";
...
import { f as S, h as C } from "./chunk-5PVQY5BW-CnaqcI9r.js";
import {
  a as w,
  c as T,
  i as E,
  ...
  r as O,
  s as k,
} from "./chunk-YZCP3GAM-BiBTM9Rn.js";
import { t as A } from "./chunk-QZHKN3VN-DYg2f7_V.js";
import { n as j, t as M } from "./chunk-XPW4576I-CL9gPToI.js";
var N = t(),
  P = (function () {
...
` +
    ...
    return (n(Te, `Parser`), (Te.prototype = we), (we.Parser = Te), new Te());
  })();
P.parser = P;
var F = P,
  I = {
...
` +
    ...
    parseMessage(e) {
      let t = e.trim(),
        { wrap: n, cleanedText: i } = this.extractWrap(t),
        a = { text: i, wrap: n };
      return (r.debug(`parseMessage: ${JSON.stringify(a)}`), a);
    }
    parseBoxData(e) {
      ...
      return { text: a ? s(a, m()) : void 0, color: n, wrap: i };
    }
    addNote(e, t, n) {
      let r = {
          actor: e,
    ...
    addLinks(e, t) {
      ...
      try {
        ...
        r.error(`error while parsing actor link text`, e);
      }
    }
    addALink(e, t) {
      let n = this.getActor(e);
    ...
    addProperties(e, t) {
      ...
      try {
        ...
        r.error(`error while parsing actor properties text`, e);
      }
    }
    ...
    addDetails(e, t) {
      ...
      try {
        ...
        r.error(`error while parsing actor details text`, e);
      }
    }
...
`;
  ...
  W = n(function (e, t) {
    let n = w(e, t);
    return (x().look === `neo` && n.attr(`data-look`, `neo`), n);
  }, `drawRect`),
  ie = n(function (e, t, n, r, i) {
    if (
      t.links === void 0 ||
      t.links === null ||
  ...
  oe = n(async function (e, t, n = null) {
  ...
  G = n(function (e, t) {
    let r = 0,
      i = 0,
      a = t.text.split(y.lineBreakRegex),
      [o, s] = S(t.fontSize),
      c = [],
      l = 0,
      u = n(() => t.y, `yfunc`);
  ...
  le = n(function (e, t, n, r, i) {
    ...
    if (
      (U.has(l) &&
        (v.style(`stroke`, f[y % f.length]), v.style(`fill`, d[y % f.length])),
      c === `neo` && v.attr(`filter`, `url(#drop-shadow)`),
      (t.rectData = h),
      t.properties?.icon)
    ) {
  ...
  ue = n(function (e, t, n, r, i) {
    ...
    (t.properties?.class ? (g = t.properties.class) : (h.fill = `#eaeaea`),
      ...
      (h.class = g),
      (h.name = t.name));
    let v = { ...h, x: h.x + -6, y: h.y + 6, class: `actor` },
      y = W(m, h),
      b = W(m, v);
  ...
  fe = n(function (e, t, n, r, i, a) {
    ...
    return (
      U.has(u)
        ? (v.style(`stroke`, p[C % p.length]), v.style(`fill`, f[C % p.length]))
        : (v.style(`stroke`, m), v.style(`fill`, h)),
      (t.height =
        v.node().getBBox().height + 2 * (n?.sequence?.labelBoxHeight ?? 0)),
      Y(n, _(t.description))(
        t.description,
        v,
        b.x,
      ...
      r ||
        (v.attr(`data-et`, `participant`),
        v.attr(`data-type`, `control`),
        v.attr(`data-id`, t.name)),
      t.height
    );
  }, `drawActorTypeControl`),
  pe = n(function (e, t, n, r, i) {
    let a = r ? t.stopy : t.starty,
      o = t.x + t.width / 2,
      s = a + 75,
      { look: c, theme: l, themeVariables: u } = n,
  ...
  me = n(function (e, t, n, r, i) {
    ...
    let g = k(),
      v = `actor`;
    (t.properties?.class ? (v = t.properties.class) : (g.fill = `#eaeaea`),
      r ? (v += ` ${V}`) : (v += ` ${B}`),
      (g.x = t.x),
      (g.y = a),
      (g.width = t.width),
...
`;
  ...
  ge = n(function (e, t, n, r, i) {
    ...
    (b.attr(`cx`, t.x + t.width / 2),
      b.attr(`cy`, y + 10 * v),
      b.attr(`r`, 15 * v),
      b.attr(`width`, t.width * v),
      b.attr(`height`, t.height * v),
  ...
  _e = n(async function (e, t, n, r, i, a, o) {
    let s =
  ...
  xe = n(async function (e, t, r, i, a) {
    ...
    ((h.text = r),
      ...
      (h.fontWeight = f),
      (h.wrap = !0));
    let g = _(h.text) ? await oe(p, h, t) : G(p, h);
      ...
      for (let [e, n] of Object.entries(t.sectionTitles))
        if (n.message) {
          ((h.text = n.message),
            ...
            (h.wrap = t.wrap),
            _(h.text)
              ? ((t.starty = t.sections[e].y), await oe(p, h, t))
              : G(p, h));
          let r = Math.round(
            g
  ...
  Y = (function () {
    ...
    n(r, `byFo`);
    async function i(e, n, r, i, o, s, l, u) {
      let d = await g(e, x()),
        f = n.append(`switch`),
        p = f
          .append(`foreignObject`)
  ...
  X = {
    ...
    insertDropShadow: Oe,
    insertSolidTopArrowHead: n(function (e, t) {
      e.append(`defs`)
        .append(`marker`)
    ...
    insertSolidBottomArrowHead: n(function (e, t) {
      e.append(`defs`)
        .append(`marker`)
    ...
    insertStickTopArrowHead: n(function (e, t) {
      e.append(`defs`)
        .append(`marker`)
    ...
    insertStickBottomArrowHead: n(function (e, t) {
      e.append(`defs`)
        .append(`marker`)
  ...
  Q = {
    ...
    updateBounds: n(function (e, t, r, i) {
      ...
      function s(s) {
        return n(function (n) {
          ...
          (a.updateVal(n, `starty`, t - c * Z.boxMargin, Math.min),
            a.updateVal(n, `stopy`, i + c * Z.boxMargin, Math.max),
            a.updateVal(Q.data, `startx`, e - c * Z.boxMargin, Math.min),
            a.updateVal(Q.data, `stopx`, r + c * Z.boxMargin, Math.max),
            s !== `activation` &&
              (a.updateVal(n, `startx`, e - c * Z.boxMargin, Math.min),
              a.updateVal(n, `stopx`, r + c * Z.boxMargin, Math.max),
              a.updateVal(Q.data, `starty`, t - c * Z.boxMargin, Math.min),
    ...
    newLoop: n(function (e = { message: void 0, wrap: !1, width: void 0 }, t) {
  ...
  Me = n(async function (e, t, n) {
    ...
    ((o.x = t.startx),
      ...
      (o.valign = `center`));
    let s = _(o.text) ? await oe(i, o) : G(i, o),
      c = Math.round(
        s
          .map((e) => (e._groups || e)[0][0].getBBox().height)
          .reduce((e, t) => e + t),
...
async function Le(e, t) {
  ...
  let { startx: n, stopx: r, message: i } = t,
    a = y.splitBreaks(i).length,
    o = _(i),
    s = o ? await g(i, m()) : C.calculateTextDimensions(i, Pe(Z));
  if (!o) {
    let e = s.height / a;
...
n(Le, `boundMessage`);
var Re = n(async function (e, t, n, r, i, a) {
    let {
        startx: s,
        stopx: c,
        starty: l,
      ...
      m = C.calculateTextDimensions(u, Pe(Z)),
      h = T();
    ((h.x = s),
      (h.y = l + 10),
      (h.width = c - s),
      ...
      (h.tspan = !1),
      _(h.text) ? await oe(e, h, { startx: s, stopx: c, starty: n }) : G(e, h));
    let g = m.width,
      v;
    if (s === c) {
      ...
      ((v = Z.rightAngles
        ? e
            ...
            .attr(
              `d`,
              `M  ${u},${n} H ${s + y.getMax(Z.width / 2, g / 2)} V ${n + 25} H ${s}`,
            )
        : e
            .append(`path`)
            .attr(
    ...
    d === r.db.LINETYPE.STICK_ARROW_BOTTOM_REVERSE_DOTTED
      ...
      : v.attr(`class`, `messageLine0`),
      v.attr(`data-et`, `message`),
      v.attr(`data-id`, `i` + t.id),
      v.attr(`data-from`, t.from),
      v.attr(`data-to`, t.to));
    let b = ``;
    if (
      (Z.arrowMarkerAbsolute && (b = o(!0)),
      v.attr(`stroke-width`, 2),
      v.attr(`stroke`, `none`),
      v.style(`fill`, `none`),
      (d === r.db.LINETYPE.SOLID_TOP || d === r.db.LINETYPE.SOLID_TOP_DOTTED) &&
        v.attr(`marker-end`, `url(` + b + `#` + a + `-solidTopArrowHead)`),
      (d === r.db.LINETYPE.SOLID_BOTTOM ||
        d === r.db.LINETYPE.SOLID_BOTTOM_DOTTED) &&
        v.attr(`marker-end`, `url(` + b + `#` + a + `-solidBottomArrowHead)`),
      (d === r.db.LINETYPE.STICK_TOP || d === r.db.LINETYPE.STICK_TOP_DOTTED) &&
        v.attr(`marker-end`, `url(` + b + `#` + a + `-stickTopArrowHead)`),
      (d === r.db.LINETYPE.STICK_BOTTOM ||
        d === r.db.LINETYPE.STICK_BOTTOM_DOTTED) &&
        v.attr(`marker-end`, `url(` + b + `#` + a + `-stickBottomArrowHead)`),
      (d === r.db.LINETYPE.SOLID_ARROW_TOP_REVERSE ||
        d === r.db.LINETYPE.SOLID_ARROW_TOP_REVERSE_DOTTED) &&
        v.attr(`marker-start`, `url(` + b + `#` + a + `-solidBottomArrowHead)`),
      (d === r.db.LINETYPE.SOLID_ARROW_BOTTOM_REVERSE ||
        d === r.db.LINETYPE.SOLID_ARROW_BOTTOM_REVERSE_DOTTED) &&
        v.attr(`marker-start`, `url(` + b + `#` + a + `-solidTopArrowHead)`),
      (d === r.db.LINETYPE.STICK_ARROW_TOP_REVERSE ||
        d === r.db.LINETYPE.STICK_ARROW_TOP_REVERSE_DOTTED) &&
        v.attr(`marker-start`, `url(` + b + `#` + a + `-stickBottomArrowHead)`),
      (d === r.db.LINETYPE.STICK_ARROW_BOTTOM_REVERSE ||
        d === r.db.LINETYPE.STICK_ARROW_BOTTOM_REVERSE_DOTTED) &&
        v.attr(`marker-start`, `url(` + b + `#` + a + `-stickTopArrowHead)`),
      (d === r.db.LINETYPE.SOLID || d === r.db.LINETYPE.DOTTED) &&
        v.attr(`marker-end`, `url(` + b + `#` + a + `-arrowhead)`),
      (d === r.db.LINETYPE.BIDIRECTIONAL_SOLID ||
        d === r.db.LINETYPE.BIDIRECTIONAL_DOTTED) &&
        (v.attr(`marker-start`, `url(` + b + `#` + a + `-arrowhead)`),
        v.attr(`marker-end`, `url(` + b + `#` + a + `-arrowhead)`)),
      (d === r.db.LINETYPE.SOLID_POINT || d === r.db.LINETYPE.DOTTED_POINT) &&
        v.attr(`marker-end`, `url(` + b + `#` + a + `-filled-head)`),
      (d === r.db.LINETYPE.SOLID_CROSS || d === r.db.LINETYPE.DOTTED_CROSS) &&
        v.attr(`marker-end`, `url(` + b + `#` + a + `-crosshead)`),
      ...
      ((h = g
        ...
        e
          ...
          .attr(`y2`, n)
          .attr(`stroke-width`, 0)
          .attr(`marker-start`, `url(` + b + `#` + a + `-sequencenumber)`),
        e
          .append(`text`)
          .attr(`x`, h)
          .attr(`y`, n + 4)
  ...
  ze = n(function (e, t, n, r, i, a, o) {
    ...
    for (let e of r) {
      ...
      (l && l != a && (o || Q.models.addBox(l), (c += Z.boxMargin + l.margin)),
        ...
        (r.width = y.getMax(r.width || Z.width, Z.width)),
        (r.height = y.getMax(r.height || Z.height, Z.height)),
  ...
  Be = n(async function (e, t, n, r, i, a, o) {
    if (r) {
      let r = 0;
...
function $(e, t, n, i, a) {
  ...
  if (t.id && t.message && e[t.id]) {
    let n = e[t.id].width,
      a = Pe(Z);
    ((t.message = C.wrapLabel(`[${t.message}]`, n - 2 * Z.wrapPadding, a)),
      (t.width = n),
      (t.wrap = !0));
    let s = C.calculateTextDimensions(t.message, a),
      c = y.getMax(s.height, Z.labelBoxHeight);
    ((o = i + c), r.debug(`${c} - ${t.message}`));
  }
  (a(t), Q.bumpVerticalPos(o));
}
n($, `adjustLoopHeightForWrap`);
...
n(Ge, `adjustCreatedDestroyedData`);
var Ke = n(async function (t, i, a, o) {
  let { securityLevel: s, sequence: c, look: l } = m();
  Z = c;
  let u;
  s === `sandbox` && (u = e(`#i` + i));
  let d = e(s === `sandbox` ? u.nodes()[0].contentDocument.body : `body`),
    f = s === `sandbox` ? u.nodes()[0].contentDocument : document;
  (Q.init(), r.debug(o.db));
  let p = s === `sandbox` ? d.select(`[id="${i}"]`) : e(`[id="${i}"]`),
    g = o.db.getActors(),
  ...
  for (let e of x) {
    ...
    switch (e.type) {
      case o.db.LINETYPE.NOTE:
        (Q.resetVerticalPos(), (n = e.noteModel), await Me(p, n, e.id));
        break;
      case o.db.LINETYPE.ACTIVE_START:
        Q.newActivation(e, p, g);
        break;
      ...
      case o.db.LINETYPE.LOOP_START:
        $(D, e, Z.boxMargin, Z.boxMargin + Z.boxTextMargin, (e) =>
          Q.newLoop(e),
        );
        break;
      ...
      case o.db.LINETYPE.ALT_ELSE:
        $(D, e, Z.boxMargin + Z.boxTextMargin, Z.boxMargin, (e) =>
      ...
      default:
        try {
          ...
          let t = await Le(p, i);
          (Ge(e, i, t, N, g, _, v),
            j.push({ messageModel: i, lineStartY: t, msg: e }),
            Q.models.addMessage(i));
        } catch (e) {
          r.error(`error while drawing message`, e);
        }
    }
    ([
  ...
  (r.debug(`createdActors`, _),
    r.debug(`destroyedActors`, v),
    await Be(p, g, b, !1, i, o, E));
  for (let e of j) await Re(p, e.messageModel, e.lineStartY, o, e.msg, i);
  (Z.mirrorActors && (await Be(p, g, b, !0, i, o, E)),
  ...
  (S &&
    p
      ...
      .attr(`y`, -25),
    h(p, L, R, Z.useMaxWidth));
  let te = S ? 40 : 0,
    ne = g.size && l === `neo` ? 30 : 0;
  (p.attr(
    `viewBox`,
    F.startx -
      Z.diagramMarginX +
...
async function qe(e, t, n) {
  ...
  for (let r of t)
    if (e.get(r.to) && e.get(r.from)) {
      let t = e.get(r.to);
      if (
        (r.placement === n.db.PLACEMENT.LEFTOF && !t.prevActor) ||
        (r.placement === n.db.PLACEMENT.RIGHTOF && !t.nextActor)
      )
        continue;
      let a = r.placement !== void 0,
        o = !a,
        s = a ? Fe(Z) : Pe(Z),
        c = r.wrap
          ? C.wrapLabel(r.message, Z.width - 2 * Z.wrapPadding, s)
          : r.message,
        l =
          (_(c) ? await g(r.message, m()) : C.calculateTextDimensions(c, s))
            .width +
          2 * Z.wrapPadding;
      o && r.from === t.nextActor
        ? (i[r.to] = y.getMax(i[r.to] || 0, l))
        : o && r.from === t.prevActor
          ? (i[r.from] = y.getMax(i[r.from] || 0, l))
          : o && r.from === r.to
            ? ((i[r.from] = y.getMax(i[r.from] || 0, l / 2)),
              (i[r.to] = y.getMax(i[r.to] || 0, l / 2)))
            : r.placement === n.db.PLACEMENT.RIGHTOF
              ? (i[r.from] = y.getMax(i[r.from] || 0, l))
              : r.placement === n.db.PLACEMENT.LEFTOF
                ? (i[t.prevActor] = y.getMax(i[t.prevActor] || 0, l))
                : r.placement === n.db.PLACEMENT.OVER &&
                  (t.prevActor &&
                    (i[t.prevActor] = y.getMax(i[t.prevActor] || 0, l / 2)),
                  t.nextActor && (i[r.from] = y.getMax(i[r.from] || 0, l / 2)));
    }
  return (r.debug(`maxMessageWidthPerActor:`, i), i);
}
n(qe, `getMaxMessageWidthPerActor`);
var Je = n(function (e) {
  let t = 0,
    n = Ie(Z);
  for (let r in e.links) {
    let e =
      C.calculateTextDimensions(r, n).width +
      2 * Z.wrapPadding +
      2 * Z.boxMargin;
    t < e && (t = e);
  }
...
async function Ye(e, t, n) {
  ...
  for (let t of e.keys()) {
    let n = e.get(t);
    n.wrap &&
      (n.description = C.wrapLabel(
        n.description,
        Z.width - 2 * Z.wrapPadding,
        Ie(Z),
      ));
    let i = _(n.description)
      ? await g(n.description, m())
      : C.calculateTextDimensions(n.description, Ie(Z));
    ((n.width = n.wrap
      ? Z.width
      : y.getMax(Z.width, i.width + 2 * Z.wrapPadding)),
      (n.height = n.wrap ? y.getMax(i.height, Z.height) : Z.height),
      (r = y.getMax(r, n.height)));
  }
  for (let n in t) {
    let r = e.get(n);
    if (!r) continue;
    ...
    if (!i) {
      ...
      r.margin = y.getMax(e, Z.actorMargin);
      continue;
    }
    let a = t[n] + Z.actorMargin - r.width / 2 - i.width / 2;
    r.margin = y.getMax(a, Z.actorMargin);
  }
  let i = 0;
  return (
    n.forEach((t) => {
      ...
      ((r += a),
        (r -= 2 * Z.boxTextMargin),
        t.wrap && (t.name = C.wrapLabel(t.name, r - 2 * Z.wrapPadding, n)));
      let o = C.calculateTextDimensions(t.name, n);
      i = y.getMax(o.height, i);
      let s = y.getMax(r, o.width + 2 * Z.wrapPadding);
...
n(Ye, `calculateActorMargins`);
var Xe = n(async function (e, t, n) {
    let i = t.get(e.from),
      a = t.get(e.to),
      o = i.x,
      s = a.x,
      ...
      l = _(e.message)
        ? await g(e.message, m())
        : C.calculateTextDimensions(
            c ? C.wrapLabel(e.message, Z.width, Fe(Z)) : e.message,
            Fe(Z),
          ),
      u = {
        width: c ? Z.width : y.getMax(Z.width, l.width + 2 * Z.noteMargin),
        height: 0,
        startx: i.x,
        stopx: 0,
        starty: 0,
    ...
    return (
      e.placement === n.db.PLACEMENT.RIGHTOF
        ? ((u.width = c
            ? y.getMax(Z.width, l.width)
            : y.getMax(i.width / 2 + a.width / 2, l.width + 2 * Z.noteMargin)),
          (u.startx = o + (i.width + Z.actorMargin) / 2))
        : e.placement === n.db.PLACEMENT.LEFTOF
          ? ((u.width = c
              ? y.getMax(Z.width, l.width + 2 * Z.noteMargin)
              : y.getMax(
                  i.width / 2 + a.width / 2,
                  l.width + 2 * Z.noteMargin,
                )),
            (u.startx = o - u.width + (i.width - Z.actorMargin) / 2))
          : e.to === e.from
            ? ((l = C.calculateTextDimensions(
                c
                  ? C.wrapLabel(e.message, y.getMax(Z.width, i.width), Fe(Z))
                  : e.message,
                Fe(Z),
              )),
              (u.width = c
                ? y.getMax(Z.width, i.width)
                : y.getMax(i.width, Z.width, l.width + 2 * Z.noteMargin)),
              (u.startx = o + (i.width - u.width) / 2))
            : ((u.width =
                Math.abs(o + i.width / 2 - (s + a.width / 2)) + Z.actorMargin),
              (u.startx =
                o < s
                  ? o + i.width / 2 - Z.actorMargin / 2
                  : s + a.width / 2 - Z.actorMargin / 2)),
      c &&
        (u.message = C.wrapLabel(
          e.message,
  ...
  rt = n(function (e, t, r) {
    ...
    e.wrap &&
      e.message &&
      (e.message = C.wrapLabel(
        e.message,
        y.getMax(g + 2 * Z.wrapPadding, Z.width),
        Pe(Z),
      ));
    let _ = C.calculateTextDimensions(e.message, Pe(Z));
    return {
      width: y.getMax(
        e.wrap ? 0 : _.width + 2 * Z.wrapPadding,
        g + 2 * Z.wrapPadding,
        Z.width,
      ),
      height: 0,
      ...
      type: e.type,
      wrap: e.wrap,
      fromBounds: Math.min.apply(null, h),
      toBounds: Math.max.apply(null, h),
    };
  }, `buildMessageModel`),
  it = n(async function (e, t, n, i) {
    let a = {},
      o = [],
      s,
      c,
        ...
        case i.db.LINETYPE.ACTIVE_START:
          {
            let e = t.get(n.from ? n.from : n.to.actor),
              r = Ue(n.from ? n.from : n.to.actor).length,
            ...
            o.forEach((e) => {
              if (((s = e), l.startx === l.stopx)) {
                ...
                ((s.from = y.getMin(l.startx, s.from)),
                  ...
                  (s.width = y.getMax(s.width, l.width) - Z.labelBoxWidth));
            }))
        : ((c = await Xe(n, t, i)),
          (n.noteModel = c),
          o.forEach((e) => {
            ((s = e),
              ...
              (s.width =
                y.getMax(s.width, Math.abs(s.from - s.to)) - Z.labelBoxWidth));
          }));
    }
    return ((Q.activations = []), r.debug(`Loop type widths:`, a), a);
  }, `calculateLoopBounds`),
  at = {
    parser: F,
    get db() {
    ...
    init: n((e) => {
      ((e.sequence ||= {}),
        e.wrap &&
          ((e.sequence.wrap = e.wrap), l({ sequence: { wrap: e.wrap } })));
    }, `init`),
  };
export { at as diagram };
//# sourceMappingURL=sequenceDiagram-FGHM5R23-BeyC91RB.js.map
