...
var l = t((e) => {
  ...
  N = t((e) => {
    ...
    e.FlushCoordinator = class {
      ...
      _processOneBatch(e, n) {
        return t(this, void 0, void 0, function* () {
          if (
            this._loggingEnabled !== f.LoggingEnabledOption.always &&
            (0, u._isServerEnv)()
          )
  ...
  I = t((e) => {
    ...
    e.EventLogger = class e {
      ...
      _shouldLogEvent(e) {
        if (this._options?.loggingEnabled !== `always` && (0, d._isServerEnv)())
          return !1;
        ...
        return o && s - o < T
          ? !1
          : (Object.keys(this._lastExposureTimeMap).length > w &&
              (this._lastExposureTimeMap = {}),
    ...
    e.DataAdapterCore = class {
      ...
      _fetchAndPrepFromNetwork(e, i, a) {
        return t(this, void 0, void 0, function* () {
          ...
          else if (t && l?.has_updates === !1)
            p = u(`NetworkNotModified`, t, f, i);
          else return null;
          ...
          (n.Log.warn(`Caught error in ${c}`, { error: l }),
            t(this, void 0, void 0, function* () {
              ...
              let p = l || Error(a),
                ...
                h = m ? p.name : `No Name`;
              if (((this._lastSeenError = o(p)), !d && this._seen.has(h)))
                return;
              if (
                (this._seen.add(h),
                ...
                (t = this._emitter) == null ||
                  t.call(this, { name: `error`, error: l, tag: c });
                return;
              }
              ...
              (yield (b?.networkOverrideFunc ?? fetch)(
                b?.sdkExceptionUrl ?? e.EXCEPTION_ENDPOINT,
                {
                  method: `POST`,
                  headers: {
                ...
                (n = this._emitter) == null ||
                  n.call(this, { name: `error`, error: l, tag: c }));
            })
              .then(() => {})
              .catch(() => {}));
        } catch {}
    ...
    e.StatsigClientBase = class {
      constructor(e, t, n, o) {
        ...
        (o?.logLevel != null && (a.Log.level = o.logLevel),
          ...
          o != null &&
            o.storageProvider &&
            p.Storage._setProvider(o.storageProvider),
          o != null &&
            o.enableCookies &&
            d.StableID._setCookiesEnabled(e, o.enableCookies),
          ...
          e.logEventCompressionMode
            ...
            : e.disableCompression &&
              this._logger.setLogEventCompressionMode(
                f.LogEventCompressionMode.Disabled,
              ));
      }
      flush() {
  ...
  Te = t((e) => {
    ...
    function l(e) {
      ...
      d(a, r, l);
      let u = (0, i.useMemo)(
        () => ({ renderVersion: n, client: a, isLoading: c }),
        [n, a, c],
      );
      return (0, t.jsx)(o.default.Provider, {
        value: u,
        children:
          e.loadingComponent == null || !u.isLoading
            ? e.children
            : e.loadingComponent,
      });
    }
    function u(e) {
      ...
      d(a, r, c);
      let l = (0, i.useMemo)(
        () => ({ renderVersion: n, client: a, isLoading: s }),
        [n, a, s],
      );
      return (0, t.jsx)(o.default.Provider, {
        value: l,
      ...
      (0, i.useEffect)(() => {
        ...
        return (
          ...
          () => {
            (e
              .flush()
              .catch((e) => a.Log.error(`An error occurred during flush`, e)),
...
function tt() {
  ...
  e[0] === t
    ? (n = e[1])
    : ((n = (e, n) => et(t, e, n)), (e[0] = t), (e[1] = n));
  let r = n,
    i;
  e[2] === t
    ? (i = e[3])
    : ((i = (e, n) => $e(t, e, n)), (e[2] = t), (e[3] = i));
  let a = i,
    o;
  return (
    e[4] !== r || e[5] !== a
...
//# sourceMappingURL=statsig-CpJRDK88.js.map
