  ...
  P = (function () {
    ...
    return (
      ...
      (e.prototype.toString = function () {
        ...
        if (
          ((this.text = [t(`every`)]),
          this[G.FREQUENCIES[this.options.freq]](),
          this.options.until)
        ) {
          this.add(t(`until`));
      ...
      do {
        ...
        if (i)
          a
            ? (r.nextSymbol(),
              (n.byweekday ||= []),
              n.byweekday.push(G[a].nth(i)))
            : ((n.bymonthday ||= []), n.bymonthday.push(i), r.accept(`day(s)`));
        else if (a)
          (r.nextSymbol(), (n.byweekday ||= []), n.byweekday.push(G[a]));
      ...
      (t.prototype.addHours = function (e, t, n) {
        for (t && (this.hour += Math.floor((23 - this.hour) / e) * e); ; ) {
          ...
          var r = b(this.hour, 24),
            ...
            a = r.mod;
          if (
            (i && ((this.hour = a), this.addDaily(i)), x(n) || C(n, this.hour))
          )
            break;
        }
      }),
...
function De(e) {
  ...
  if (
    ...
    t.bymonthday < 0
      ...
      : ((t.bynmonthday = []), (t.bymonthday = [t.bymonthday]));
  if (
    (u(t.byweekno) && !p(t.byweekno) && (t.byweekno = [t.byweekno]),
    !u(t.byweekday))
  )
    t.bynweekday = null;
  else if (d(t.byweekday))
...
function Fe(e) {
  for (
    var t = [], n = ``, r = Object.keys(e), i = Object.keys(lt), a = 0;
    a < r.length;
    a++
  )
    if (r[a] !== `tzid` && C(i, r[a])) {
            ...
            a(
              a(
                a(
                  a(
                    a(
                      a(a(a([], h(1, 31), !0), h(2, 28), !0), h(3, 31), !0),
                      h(4, 30),
                      !0,
                    ),
                    h(5, 31),
            ...
            a(
              a(
                a(
                  a(
                    a(
                      a(a(a([], h(1, 31), !0), h(2, 29), !0), h(3, 31), !0),
                      h(4, 30),
                      !0,
                    ),
                    h(5, 31),
      ...
      a(
        a(
          a(
            a(
              a(
                a(a(a(a(a(a([], B, !0), He, !0), B, !0), z, !0), B, !0), z, !0),
                B,
                !0,
              ),
              B,
      ...
      a(
        a(
          a(
            a(
              a(
                a(a(a(a(a(a([], B, !0), Ve, !0), B, !0), z, !0), B, !0), z, !0),
                B,
                !0,
              ),
              B,
      ...
      a(
        a(
          a(
            a(
              a(
                a(a(a(a(a(a([], H, !0), Ke, !0), H, !0), V, !0), H, !0), V, !0),
                H,
                !0,
              ),
              H,
      ...
      a(
        a(
          a(
            a(
              a(
                a(a(a(a(a(a([], H, !0), Ge, !0), H, !0), V, !0), H, !0), V, !0),
                H,
                !0,
              ),
              H,
...
function Qe(e, t) {
  var n = w(e, 1, 1),
    ...
    o = A(n),
    c = s(
      s({ yearlen: r, nextyearlen: i, yearordinal: a, yearweekday: o }, $e(e)),
      { wnomask: null },
    );
  ...
  for (
    ...
    if ((_ < 0 && (_ += m + 1), _ > 0 && _ <= m)) {
      ...
      for (
        var b = 0;
        b < 7 && ((c.wnomask[v] = 1), v++, c.wdaymask[v] !== t.wkst);
        b++
      );
    }
  }
  if (C(t.byweekno, 1)) {
    ...
    if ((d !== l && (v -= 7 - l), v < r))
      for (
        var g = 0;
        g < 7 && ((c.wnomask[v] = 1), (v += 1), c.wdaymask[v] !== t.wkst);
        g++
      );
  }
  if (d) {
...
function it(e, t) {
  ...
  for (var d = ct(l, c, t); ; ) {
    ...
    (be(r) || (d = l.gettimeset(r)(c.hour, c.minute, c.second, 0)),
      l.rebuild(c.year, c.month));
  }
}
function at(e, t, n) {
  ...
  G = (function () {
    ...
    return (
      ...
      (e.prototype.all = function (e) {
        ...
        return (
          t === !1 &&
            ((t = this._iter(new M(`all`, {}))), this._cacheAdd(`all`, t)),
          t
        );
      }),
  ...
  return (
    ...
    (t.prototype.valueOf = function () {
      ...
      return (
        !this._rrule.length &&
          this._dtstart &&
          (e = e.concat(Fe({ dtstart: this._dtstart }))),
...
function At(e, t, n, r, i) {
  ...
  return e.length > 2 && Lt(e)
    ? It(e, t)
    : jt(e, t, e.length > 2 ? `short` : i);
}
function J(e, t) {
...
function qt(e) {
  let t = {
    ...
    ...(e.reasoningEffort == null
      ? {}
      : { reasoningEffort: cn(e.reasoningEffort) }),
  };
  if (e.kind !== `cron`) return t;
  let n = {
    ...t,
    cwdCount: e.cwds.length,
    executionEnvironment: ln(e.executionEnvironment),
  };
  return (
...
function Xt(e, t) {
  return t === `custom`
    ? {
        ...
        mode: `custom`,
        customRrule:
          e.mode === `custom` && e.customRrule.trim() ? e.customRrule : Jt(e),
      }
    : t === `hourly`
      ? {
          ...e,
...
function sn(e) {
  switch (e) {
    case `ACTIVE`:
      return r.CODEX_AUTOMATION_STATUS_ACTIVE;
    case `PAUSED`:
      return r.CODEX_AUTOMATION_STATUS_PAUSED;
    case `DELETED`:
      return r.CODEX_AUTOMATION_STATUS_DELETED;
  }
}
function cn(e) {
  switch (e) {
    case `none`:
      return i.CODEX_AUTOMATION_REASONING_EFFORT_NONE;
    case `minimal`:
      return i.CODEX_AUTOMATION_REASONING_EFFORT_MINIMAL;
    case `low`:
      return i.CODEX_AUTOMATION_REASONING_EFFORT_LOW;
    case `medium`:
      return i.CODEX_AUTOMATION_REASONING_EFFORT_MEDIUM;
    case `high`:
      return i.CODEX_AUTOMATION_REASONING_EFFORT_HIGH;
    case `xhigh`:
      return i.CODEX_AUTOMATION_REASONING_EFFORT_XHIGH;
  }
}
function ln(e) {
  switch (e) {
    case `worktree`:
      return n.CODEX_AUTOMATION_EXECUTION_ENVIRONMENT_WORKTREE;
    case `local`:
      return n.CODEX_AUTOMATION_EXECUTION_ENVIRONMENT_LOCAL;
  }
}
function un(e) {
  switch (e) {
    case G.SECONDLY:
      return t.CODEX_AUTOMATION_SCHEDULE_FREQUENCY_SECONDLY;
    case G.MINUTELY:
      return t.CODEX_AUTOMATION_SCHEDULE_FREQUENCY_MINUTELY;
    case G.HOURLY:
      return t.CODEX_AUTOMATION_SCHEDULE_FREQUENCY_HOURLY;
    case G.DAILY:
      return t.CODEX_AUTOMATION_SCHEDULE_FREQUENCY_DAILY;
    case G.WEEKLY:
      return t.CODEX_AUTOMATION_SCHEDULE_FREQUENCY_WEEKLY;
    case G.MONTHLY:
      return t.CODEX_AUTOMATION_SCHEDULE_FREQUENCY_MONTHLY;
    case G.YEARLY:
      return t.CODEX_AUTOMATION_SCHEDULE_FREQUENCY_YEARLY;
  }
}
function dn(e, t) {
  if (!e) return null;
...
//# sourceMappingURL=automation-schedule-CNorTxWd.js.map
