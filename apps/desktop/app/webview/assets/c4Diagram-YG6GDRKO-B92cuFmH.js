import { g as e, n as t, t as n } from "./chunk-S3R3BYOJ-5zDRn6nL.js";
...
import { i as _, o as v } from "./chunk-TZMSLE5B-BxM8yCCK.js";
var y = g(),
  b = (function () {
...
` +
    ...
    return (i(ue, `Parser`), (ue.prototype = J), (J.Parser = ue), new ue());
  })();
b.parser = b;
var x = b,
  S = [],
  ...
  F = i(function (e, t, n, r, i, a, o, s, l) {
  ...
  ee = i(function (e, t, n, r, i, a, o, s, l, u, d) {
...
function Q(r, i, a, o, s) {
  if (!i[r].width)
    if (a)
      ((i[r].text = e(i[r].text, s, o)),
        (i[r].textLines = i[r].text.split(p.lineBreakRegex).length),
        (i[r].width = s),
        (i[r].height = n(i[r].text, o)));
    else {
      let e = i[r].text.split(p.lineBreakRegex);
      i[r].textLines = e.length;
      let a = 0;
      ((i[r].height = 0), (i[r].width = 0));
      for (let s of e)
        ((i[r].width = Math.max(t(s, o), i[r].width)),
          (a = n(s, o)),
          (i[r].height = i[r].height + a));
    }
}
i(Q, `calcC4ShapeTextWH`);
var Pe = i(function (e, n, r) {
    ((n.x = r.data.startx),
      (n.y = r.data.starty),
      (n.width = r.data.stopx - r.data.startx),
      (n.height = r.data.stopy - r.data.starty),
      (n.label.y = Z.c4ShapeMargin - 35));
    let i = n.wrap && Z.wrap,
      a = Me(Z);
    ((a.fontSize += 2),
      (a.fontWeight = `bold`),
      Q(`label`, n, i, a, t(n.label.text, a)),
      X.drawBoundary(e, n, Z));
  }, `drawBoundary`),
  Fe = i(function (e, n, r, i) {
    let a = 0;
    for (let o of i) {
      a = 0;
      let i = r[o],
        s = je(Z, i.typeC4Shape.text);
      switch (
        ((s.fontSize -= 2),
        (i.typeC4Shape.width = t(`«` + i.typeC4Shape.text + `»`, s)),
        (i.typeC4Shape.height = s.fontSize + 2),
        (i.typeC4Shape.Y = Z.c4ShapePadding),
        (a = i.typeC4Shape.Y + i.typeC4Shape.height - 4),
      ...
      ((d.fontSize += 2),
        ...
        i.type && i.type.text !== ``
          ? ((i.type.text = `[` + i.type.text + `]`),
            Q(`type`, i, l, je(Z, i.typeC4Shape.text), u),
            (i.type.Y = a + 5),
            (a = i.type.Y + i.type.height))
          : i.techn &&
            i.techn.text !== `` &&
            ((i.techn.text = `[` + i.techn.text + `]`),
            Q(`techn`, i, l, je(Z, i.techn.text), u),
            (i.techn.Y = a + 5),
            (a = i.techn.Y + i.techn.height)));
      let f = a,
        p = i.label.width;
      (i.descr &&
        i.descr.text !== `` &&
        (Q(`descr`, i, l, je(Z, i.typeC4Shape.text), u),
        (i.descr.Y = a + 20),
        (a = i.descr.Y + i.descr.height),
        (p = Math.max(i.label.width, i.descr.width)),
        (f = a - i.descr.textLines * 5)),
        (p += Z.c4ShapePadding),
        (i.width = Math.max(i.width || Z.width, p, Z.width)),
        (i.height = Math.max(i.height || Z.height, f, Z.height)),
        (i.margin = i.margin || Z.c4ShapeMargin),
        e.insert(i),
        X.drawC4Shape(n, i, Z));
    }
  ...
  Re = i(function (e, n, r, i) {
    let a = 0;
    for (let e of n) {
      a += 1;
      let n = e.wrap && Z.wrap,
        o = Ne(Z);
      i.db.getC4Type() === `C4Dynamic` &&
        (e.label.text = a + `: ` + e.label.text);
      let s = t(e.label.text, o);
      (Q(`label`, e, n, o, s),
        e.techn &&
          e.techn.text !== `` &&
          ((s = t(e.techn.text, o)), Q(`techn`, e, n, o, s)),
        e.descr &&
          e.descr.text !== `` &&
          ((s = t(e.descr.text, o)), Q(`descr`, e, n, o, s)));
      let l = Le(r(e.from), r(e.to));
...
i(ze, `drawInsideBoundary`);
var Be = {
    drawPersonOrSystemArray: Fe,
    drawBoundary: Pe,
    setConf: Ae,
    draw: i(function (e, t, n, i) {
      Z = u().c4;
      ...
      (m.setData(
        ...
        (Ee = Z.diagramMarginY));
      let h = i.db.getTitle();
      (ze(p, ``, m, i.db.getBoundaries(``), i),
        X.insertArrowHead(p),
        X.insertArrowEnd(p),
        X.insertArrowCrossHead(p),
        X.insertArrowFilledHead(p),
        Re(p, i.db.getRels(), i.db.getC4Shape, i),
        (m.data.stopx = Te),
        (m.data.stopy = Ee));
      let g = m.data,
...
//# sourceMappingURL=c4Diagram-YG6GDRKO-B92cuFmH.js.map
