...
import { t as e } from "./linear-BBy1FF1U.js";
...
var g = (function () {
  var e = n(function (e, t, n, r) {
    ...
    pe = {
      ...
      table: [
        { 18: t, 26: 1, 27: 2, 28: r, 55: i, 56: a, 57: o },
        { 1: [3] },
        { 18: t, 26: 8, 27: 2, 28: r, 55: i, 56: a, 57: o },
        { 18: t, 26: 9, 27: 2, 28: r, 55: i, 56: a, 57: o },
        e(s, [2, 33], { 29: 10 }),
        e(c, [2, 61]),
        e(c, [2, 62]),
        e(c, [2, 63]),
...
` +
  ...
  return (n($, `Parser`), ($.prototype = pe), (pe.Parser = $), new $());
})();
g.parser = g;
var _ = g,
  v = s(),
  y = class {
    ...
    getDefaultConfig() {
      return {
        ...
        showYAxis: !0,
        showTitle: !0,
        chartHeight: p.quadrantChart?.chartWidth || 500,
        chartWidth: p.quadrantChart?.chartHeight || 500,
        titlePadding: p.quadrantChart?.titlePadding || 10,
        titleFontSize: p.quadrantChart?.titleFontSize || 20,
        quadrantPadding: p.quadrantChart?.quadrantPadding || 5,
        xAxisLabelPadding: p.quadrantChart?.xAxisLabelPadding || 5,
        yAxisLabelPadding: p.quadrantChart?.yAxisLabelPadding || 5,
        xAxisLabelFontSize: p.quadrantChart?.xAxisLabelFontSize || 16,
        yAxisLabelFontSize: p.quadrantChart?.yAxisLabelFontSize || 16,
        quadrantLabelFontSize: p.quadrantChart?.quadrantLabelFontSize || 16,
        quadrantTextTopPadding: p.quadrantChart?.quadrantTextTopPadding || 5,
        pointTextPadding: p.quadrantChart?.pointTextPadding || 5,
        pointLabelFontSize: p.quadrantChart?.pointLabelFontSize || 12,
        pointRadius: p.quadrantChart?.pointRadius || 5,
        xAxisPosition: p.quadrantChart?.xAxisPosition || `top`,
        yAxisPosition: p.quadrantChart?.yAxisPosition || `left`,
        quadrantInternalBorderStrokeWidth:
          p.quadrantChart?.quadrantInternalBorderStrokeWidth || 1,
        quadrantExternalBorderStrokeWidth:
          p.quadrantChart?.quadrantExternalBorderStrokeWidth || 2,
      };
    }
    ...
    setConfig(e) {
      (t.trace(`setConfig called with: `, e),
        (this.config = { ...this.config, ...e }));
    }
    setThemeConfig(e) {
      (t.trace(`setThemeConfig called with: `, e),
...
n(z, `setHeight`);
function B() {
  let { themeVariables: e, quadrantChart: t } = d();
  return (
    t && E.setConfig(t),
    E.setThemeConfig({
...
var ee = {
  ...
  renderer: {
    draw: n((e, i, a, o) => {
      ...
      n(l, `getTransformation`);
      let u = d();
      t.debug(
        `Rendering quadrant chart
` + e,
      );
      let p = u.securityLevel,
        m;
      p === `sandbox` && (m = r(`#i` + i));
      let h = r(
      ...
      (f(h, v, _, u.quadrantChart?.useMaxWidth ?? !0),
...
//# sourceMappingURL=quadrantDiagram-AYHSOK5B-C-AexoQn.js.map
