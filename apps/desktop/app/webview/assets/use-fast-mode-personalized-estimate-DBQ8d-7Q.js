...
import { is as t, zo as n } from "./app-server-manager-signals-Csopz8aM.js";
import { n as r } from "./jsx-runtime-CiQ1k8xo.js";
import { B as i, W as a, l as o } from "./setting-storage-EK1Te68s.js";
import { t as s } from "./use-is-remote-host-CaeHryrK.js";
var c = e(r(), 1),
  l = i({
    bodyPersonalized: {
  ...
  m = 3600 * 1e3,
  h = 1440 * 60 * 1e3,
  g = n(`fast-mode-personalized-estimate`, null);
...
function b(e) {
      ...
      return (
        ...
        (v.inFlight = (async () => {
          try {
            ...
            ((v.failedAtMs = Date.now()), !s && !n && C(`failed`));
          } finally {
            v.inFlight = null;
          }
        })()),
  ...
  let T = (0, c.useMemo)(
    () =>
      ...
      r ||
      p == null ||
      p.rolloutCountWithCompletedTurns < 1 ||
      p.estimatedSavedMs < u
        ? null
        : {
            threadCountLabel: S(n, p.rolloutCountWithCompletedTurns),
            savedDuration: x(n, p.estimatedSavedMs),
          },
    [e, n, r, p],
  );
  return !e || r
    ...
    : T == null || p == null
      ...
      : {
          estimate: T,
          estimateStatus: b,
          isEstimateFreshForAnnouncement: _(p.computedAtMs),
        };
}
function x(e, t) {
  ...
  return r > 0 && i > 0
    ? e.formatMessage(l.durationHoursAndMinutes, {
        hoursLabel: a,
        minutesLabel: o,
      })
    : r > 0
...
function S(e, t) {
  return e.formatMessage(t === 1 ? l.threadCountOne : l.threadCountOther, {
    count: t,
  });
}
export { b as n, l as t };
//# sourceMappingURL=use-fast-mode-personalized-estimate-DBQ8d-7Q.js.map
