...
import { t as r } from "./tooltip-Bb9X8NK-.js";
import { n as i } from "./use-measured-text-collapse-vr-z8Ual.js";
var a =
...
function _() {
  return (
    h === null && (h = new Intl.Segmenter(g, { granularity: `word` })),
    h
  );
}
...
function ue(e) {
  ...
  for (let a = 0; a < e.len; a++) {
    ...
    c.length > 0 &&
      (t.push(I(c)), n.push(!0), r.push(`text`), i.push(l), (a = u - 1));
  }
...
function fe(e) {
  ...
  for (let a = 0; a < e.len; a++) {
    ...
    if (s === `text` && V(o) && B(o)) {
      let s = [o],
        c = a + 1;
      for (; c < e.len && e.kinds[c] === `text` && V(e.texts[c]); )
        (s.push(e.texts[c]), c++);
      (t.push(I(s)),
        n.push(!0),
        r.push(`text`),
...
function ge(e) {
  ...
  for (let e = 0; e < t.length - 1; e++) {
    if (r[e] !== `text` || r[e + 1] !== `text` || !S(t[e]) || !S(t[e + 1]))
      continue;
    let n = P(t[e]);
    n !== null &&
      ((t[e] = n.head),
...
function _e(e, t, n) {
  ...
  let u = ge(
    pe(
      me(
        fe(
          ue(le(he({ len: l, texts: a, isWordLike: o, kinds: s, starts: c }))),
        ),
      ),
    ),
  );
...
function q() {
  ...
  if (typeof OffscreenCanvas < `u`)
    return ((H = new OffscreenCanvas(1, 1).getContext(`2d`)), H);
  if (typeof document < `u`)
    return ((H = document.createElement(`canvas`).getContext(`2d`)), H);
  throw Error(
...
function J(e, t) {
  ...
  return (
    n === void 0 &&
      ((n = { width: q().measureText(e).width, containsCJK: S(e) }),
      t.set(e, n)),
    n
  );
}
...
function X() {
  return (
    G === null && (G = new Intl.Segmenter(void 0, { granularity: `grapheme` })),
    G
  );
}
function we(e) {
...
function Be() {
  return (
    $ === null && ($ = new Intl.Segmenter(void 0, { granularity: `grapheme` })),
    $
  );
}
function Ve(e) {
    ...
    if (l === `text` && f.containsCJK) {
      ...
      for (let t of r.segment(n)) {
        ...
        if (
          ...
          C.has(n) ||
          E.has(n) ||
          (i.carryCJKAfterClosingQuote && S(n) && F(e))
        ) {
          e += n;
          continue;
        }
...
function Qe(e) {
  ...
  n[5] === o
    ? (p = n[6])
    : ((p = t(`block min-w-0 overflow-hidden whitespace-nowrap`, o)),
      (n[5] = o),
      (n[6] = p));
  let m;
  n[7] !== d || n[8] !== c || n[9] !== p
...
export { Qe as t };
//# sourceMappingURL=middle-truncated-text-BmHmgvvq.js.map
