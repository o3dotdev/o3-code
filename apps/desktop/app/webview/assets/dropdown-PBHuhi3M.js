...
import { c as a, d as o, i as s, l as c, t as l } from "./dist-BzssiQ2D.js";
import { i as u } from "./Combination-CmOISuqp.js";
import {
  _ as d,
  a as f,
  c as p,
  ...
  t as E,
  u as D,
} from "./dist-PjNkCZD1.js";
import { xt as O } from "./setting-storage-EK1Te68s.js";
import { n as k } from "./window-zoom-context-BgcP82Wr.js";
import { t as A } from "./tooltip-DzyyaBl-.js";
import { n as j } from "./tooltip-dismiss-DFX6aZnQ.js";
import { t as M } from "./proxy-HwxlKevX.js";
import { t as N } from "./AnimatePresence-BMR_rf2Q.js";
import { t as P } from "./chevron-right-DcOUsgCQ.js";
import { t as F } from "./search-CEAmgNrg.js";
import { t as I } from "./animations-ueKOHTrS.js";
var L = e({
    Arrow: () => Re,
    CheckboxItem: () => Ne,
    Content: () => ke,
    ...
    DropdownMenuCheckboxItem: () => Y,
    DropdownMenuContent: () => K,
    DropdownMenuGroup: () => q,
    DropdownMenuItem: () => le,
    DropdownMenuItemIndicator: () => ge,
    DropdownMenuLabel: () => J,
    DropdownMenuPortal: () => ie,
    DropdownMenuRadioGroup: () => fe,
    DropdownMenuRadioItem: () => me,
    DropdownMenuSeparator: () => ve,
    DropdownMenuSub: () => xe,
    DropdownMenuSubContent: () => Te,
    DropdownMenuSubTrigger: () => Ce,
    DropdownMenuTrigger: () => ne,
    Group: () => Ae,
    Item: () => Me,
    ItemIndicator: () => Ie,
    Label: () => je,
...
le.displayName = ce;
var ue = `DropdownMenuCheckboxItem`,
  Y = R.forwardRef((e, t) => {
    let { __scopeDropdownMenu: n, ...r } = e,
      i = U(n);
...
me.displayName = pe;
var he = `DropdownMenuItemIndicator`,
  ge = R.forwardRef((e, t) => {
    let { __scopeDropdownMenu: n, ...r } = e,
      i = U(n);
...
var Ee = ee,
  ...
  Ve = Te,
  He = `_content_1hiti_1`,
  Ue = `_contentWithFadeExitAnimation_1hiti_40`,
  We = `_contentWithoutExitAnimation_1hiti_45`,
  Ge = `_parentBottomAlignedContent_1hiti_83`,
  X = {
    content: He,
    "dropdown-content-enter": `_dropdown-content-enter_1hiti_1`,
    "dropdown-content-exit": `_dropdown-content-exit_1hiti_1`,
    contentWithFadeExitAnimation: Ue,
    "dropdown-content-fade-exit": `_dropdown-content-fade-exit_1hiti_1`,
    contentWithoutExitAnimation: We,
    parentBottomAlignedContent: Ge,
  ...
  qe = { ...Ke, maxHeight: `calc(100vh - 16px)` };
function Je(e) {
...
function Qe(e) {
  ...
  let g = n ?? `start`,
    _;
  t[15] === c ? (_ = t[16]) : ((_ = { ...Ke, ...c }), (t[15] = c), (t[16] = _));
  let v;
  return (
    t[17] !== p ||
    t[18] !== r ||
...
var $e = (e) => {
    ...
    t[2] === a
      ? (u = t[3])
      : ((u = i(`max-w-64 text-pretty`, a)), (t[2] = a), (t[3] = u));
    let d;
    t[4] !== u || t[5] !== r
      ? ((d = (0, z.jsx)(`div`, { className: u, children: r })),
        (t[4] = u),
        (t[5] = r),
        (t[6] = d))
      : (d = t[6]);
...
function tt(e) {
  ...
  t[0] === e
    ...
    : (({
        ...
        SubText: a,
        tooltipText: S,
        tooltipTextClassName: C,
        tooltipInteractive: y,
        tooltipSide: x,
        tooltipAlign: v,
        tooltipOpenWhen: b,
        allowWrap: g,
  ...
  if (t[22] !== o) {
    ...
    ((O = R.isValidElement(e[0]) && e[0].type === nt ? e[0] : null),
      (k = O ? e.slice(1) : o),
      (t[22] = o),
      (t[23] = O),
      (t[24] = k));
  ...
  t[31] !== b
    ? ((j = (e, t, a, o) => {
        ...
        return (0, z.jsxs)(`div`, {
          ...
          children: [
            ...
            n && !O
              ? s
                ? (0, z.jsx)(n, { className: i(d ?? `icon-xs`, Q.icon) })
                : l
                  ? (0, z.jsx)(`span`, {
                      "aria-hidden": !0,
                      className: i(d ?? `icon-xs`, Q.icon),
                    })
                  : null
              : null,
            (0, z.jsx)(`span`, {
              "data-tooltip-overflow-target":
                b === `trigger-overflows` ? `` : void 0,
              className: i(
                `flex-1 min-w-0`,
                c ? `whitespace-normal` : `truncate`,
              ),
              children: e,
            }),
            u
            ...
            r
              ? s
                ? (0, z.jsx)(r, { className: i(h ?? `icon-xs`, Q.icon) })
                : l
                  ? (0, z.jsx)(`span`, {
                      "aria-hidden": !0,
                      className: i(h ?? `icon-xs`, Q.icon),
                    })
                  : null
              : null,
          ],
    ...
    : (j = t[32]);
  let M = j,
    N = c ? `cursor-default opacity-50` : D && Q.itemInteractive,
    P;
  t[33] !== s || t[34] !== N
    ? ((P = i(`no-drag`, Q.itemBase, N, s)),
      (t[33] = s),
      (t[34] = N),
      (t[35] = P))
    : (P = t[35]);
  let F = c ? void 0 : f,
    I = c ? void 0 : p,
    L = l && `!text-token-foreground focus:!outline-none`,
    B;
  t[36] === L
    ? (B = t[37])
    : ((B = i(L, `flex flex-col`)), (t[36] = L), (t[37] = B));
  let V;
  t[38] !== w || t[39] !== M || t[40] !== A
    ? ((V = M(A, !0, w)), (t[38] = w), (t[39] = M), (t[40] = A), (t[41] = V))
    : (V = t[41]);
  let H;
  t[42] !== a || t[43] !== M || t[44] !== T
    ? ((H = a ? M(a, !1, T, !1) : null),
      (t[42] = a),
      (t[43] = M),
      (t[44] = T),
    ...
    : (H = t[45]);
  let U;
  t[46] !== E || t[47] !== l || t[48] !== B || t[49] !== V || t[50] !== H
    ? ((U = (0, z.jsxs)(E, { href: l, className: B, children: [V, H] })),
      (t[46] = E),
      (t[47] = l),
      (t[48] = B),
      (t[49] = V),
...
function nt(e) {
  ...
  return (
    t[2] !== n || t[3] !== a
      ? ((o = (0, z.jsx)(`span`, { className: a, children: n })),
        (t[2] = n),
        (t[3] = a),
        (t[4] = o))
      : (o = t[4]),
...
function st(e) {
  ...
  t[0] === r
    ? (a = t[1])
    : ((a = i(et.sectionLabel, r)), (t[0] = r), (t[1] = a));
  let o;
  return (
    t[2] !== n || t[3] !== a
...
function lt(e) {
  ...
  let F = P,
    ...
    V;
  t[3] !== r || t[4] !== n
    ? ((V = (0, z.jsx)($.Trigger, { asChild: !0, disabled: r, children: n })),
      (t[3] = r),
      (t[4] = n),
      (t[5] = V))
    : (V = t[5]);
      ...
      (0, z.jsx)(Oe, {
        ...
        children: (0, z.jsx)($.Content, {
          ...
          className: i(
            A,
            M,
            !C && X.contentWithoutExitAnimation,
            w && X.contentWithFadeExitAnimation,
            g,
          ),
...
function ut(e) {
  ...
  if (t[0] !== o || t[1] !== l || t[2] !== n) {
    ...
    t[4] !== o || t[5] !== n.props
      ? ((e = (e) => {
          (n.props.onSelect?.(e),
            !e.defaultPrevented &&
              (e.preventDefault(), e.stopPropagation(), !o && c(dt)));
        }),
        (t[4] = o),
        (t[5] = n.props),
        (t[6] = e))
    ...
    let i;
    (t[9] !== e || t[10] !== r
      ? ((i = { onSelect: e, RightIcon: r }),
        (t[9] = e),
        (t[10] = r),
        (t[11] = i))
      : (i = t[11]),
      (u = R.cloneElement(n, i)),
      (t[0] = o),
      (t[1] = l),
      (t[2] = n),
      (t[3] = u));
  ...
  t[15] === p
    ? (m = t[16])
    : ((m = (0, z.jsx)(N, { initial: !1, children: p })),
      (t[15] = p),
      (t[16] = m));
  let h;
  return (
    t[17] !== d || t[18] !== f || t[19] !== m
      ? ((h = (0, z.jsxs)(`div`, {
...
function ft(e) {
  ...
  if (
    ...
    w = ze;
    let r = y ? `cursor-default opacity-50` : Q.itemInteractive,
      c;
    t[20] !== s || t[21] !== r
      ? ((c = i(Q.itemBase, `flex w-full items-center`, r, s)),
        (t[20] = s),
        (t[21] = r),
        (t[22] = c))
      : (c = t[22]);
    ...
    t[23] !== y || t[24] !== f
      ? ((d = (e) => {
          y || f == null || (e.preventDefault(), e.stopPropagation(), f());
        }),
        (t[23] = y),
        (t[24] = f),
        (t[25] = d))
    ...
    t[26] !== a || t[27] !== n || t[28] !== o || t[29] !== p
      ? ((x =
          ...
          (0, z.jsxs)(`div`, {
            ...
            children: [
              a
                ? (0, z.jsx)(a, { className: i(o ?? `icon-xs`, Q.icon) })
                : null,
              (0, z.jsx)(`span`, {
    ...
    (t[31] !== y || t[32] !== c || t[33] !== d || t[34] !== x
      ...
      (C = Oe),
      (S = Ve),
      (T = i(e, l && X.parentBottomAlignedContent, u)),
      (t[0] = a),
      (t[1] = l),
      (t[2] = s),
      (t[3] = u),
      ...
      (t[18] = T),
      (t[19] = E));
  } else ((S = t[15]), (C = t[16]), (w = t[17]), (T = t[18]), (E = t[19]));
  let D = !l,
    O = l ? qe : Ke,
    A = x === 1 ? void 0 : x,
    j;
  t[43] !== O || t[44] !== A
    ? ((j = { ...O, zoom: A }), (t[43] = O), (t[44] = A), (t[45] = j))
    : (j = t[45]);
  let M;
  t[46] === r
    ? (M = t[47])
    : ((M = (0, z.jsx)(`div`, { dir: `ltr`, children: r })),
      (t[46] = r),
      (t[47] = M));
  let N;
  t[48] !== S || t[49] !== T || t[50] !== D || t[51] !== j || t[52] !== M
    ? ((N = (0, z.jsx)(S, {
        className: T,
        collisionPadding: 6,
        avoidCollisions: D,
  ...
  let I;
  return (
    t[57] !== w || t[58] !== F || t[59] !== E
      ? ((I = (0, z.jsxs)(w, { children: [E, F] })),
        (t[57] = w),
        (t[58] = F),
        (t[59] = E),
        (t[60] = I))
...
export { it as a, tt as i, ut as n, ot as o, $ as r, lt as t };
//# sourceMappingURL=dropdown-PBHuhi3M.js.map
