...
import { O as i, b as a, x as o } from "./remote-text-edit-session-T49lxGFA.js";
var s = e(t()),
  c = n();
function l({
  open: e,
  ...
  return (0, c.jsxs)(`div`, {
    ...
    children: [
      ...
      (0, c.jsx)(`button`, {
        ...
        onClick: p,
        children: (0, c.jsx)(i, { className: `size-4` }),
      }),
    ],
  });
}
...
function d(e) {
  return e ? u.filter((t) => t.artifact === e) : [...u];
}
function f() {
  return u.map((e) => [p(e.artifact), e.area, e.feature, e.summary]);
}
function p(e) {
  return e.charAt(0).toUpperCase() + e.slice(1);
}
export { f as n, l as r, d as t };
//# sourceMappingURL=feature-catalog-Crm2yJ8b.js.map
