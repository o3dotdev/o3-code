import { i as e, n as t, o as n, t as r } from "./tslib.es6-PiNIxp0T.js";
import { a as i, f as a, i as o, t as s } from "./middleware-DR_TC0-Y.js";
import { i as c } from "./helpers-DT7PVJL_.js";
import {
  a as l,
  f as u,
  i as d,
...
import { i as v, n as y, t as b, u as x } from "./load-script-CxIfiYMX.js";
import { t as S } from "./is-plan-event-enabled-BObLQg--.js";
var C = o();
function w(e) {
      ...
      switch (e.label) {
        case 0:
          ((t = w(r)),
            ...
            (e.label = 1));
        case 1:
          return (e.trys.push([1, 3, , 4]), [4, b(c)]);
        case 2:
          return (e.sent(), D(c, n, r), [3, 4]);
        case 3:
          throw (
            (l = e.sent()),
            n.stats.gauge(`legacy_destination_time`, -1, [
              `plugin:${r}`,
              `failed`,
            ]),
            l
  ...
  return t(this, void 0, void 0, function () {
    ...
    return e(this, function (e) {
      return (
        ...
        (a = w(n)),
        (o = T(n, i)),
        (s = `${t}/integrations/${o ?? a}/${r}/${o ?? a}.dynamic.js.gz`),
        [2, y(s)]
      );
    });
  });
...
var F = (function () {
  ...
  return (
      ...
      return t(this, void 0, void 0, function () {
        ...
        return e(this, function (e) {
          switch (e.label) {
            ...
            case 2:
              return [4, k(n, this.name, this.version, this.options.obfuscate)];
            case 3:
              ((a = e.sent()), (e.label = 4));
            case 4:
              return (
                (t = a),
                (this.integration = O(t, this.settings, r)),
                [3, 6]
              );
            case 5:
              throw (
    ...
    (n.prototype.unload = function (e, t) {
      return A(this.name, this.version, this.options.obfuscate);
    }),
    (n.prototype.addMiddleware = function () {
      for (var e, t = [], n = 0; n < arguments.length; n++) t[n] = arguments[n];
      this.middleware = (e = this.middleware).concat.apply(e, t);
    }),
    (n.prototype.shouldBuffer = function (e) {
      return (
        e.event.type !== `page` &&
        (l() || this._ready !== !0 || this._initialized !== !0)
      );
    }),
    (n.prototype.send = function (n, i, o) {
      return t(this, void 0, void 0, function () {
        var t, c, l, u, d, f;
        return e(this, function (e) {
          switch (e.label) {
            case 0:
              return this.shouldBuffer(n)
                ? (this.buffer.push(n), this.scheduleFlush(), [2, n])
                : ((t = this.options?.plan?.track),
                  ...
                  t &&
                    ...
                    S(t, l)
                      ? n.updateEvent(
                          `integrations`,
                          r(r({}, n.event.integrations), l?.integrations),
                        )
                      : (n.updateEvent(
                          `integrations`,
                          r(r({}, n.event.integrations), {
                            All: !1,
                            "Segment.io": !0,
                          }),
                        ),
                        n.cancel(
                          new a({
                            retry: !1,
                            reason: `Event ${c} disabled for integration ${this.name} in tracking plan`,
                            type: `Dropped by plan`,
                          }),
                        )),
                    l?.enabled &&
                      l?.integrations[this.name] === !1 &&
                      n.cancel(
                        new a({
                          retry: !1,
                          reason: `Event ${c} disabled for integration ${this.name} in tracking plan`,
                  ...
                  [4, s(this.name, n.event, this.middleware)]);
            case 1:
              if (((u = e.sent()), u === null)) return [2, n];
              ((d = new i(u, { traverse: !this.disableAutoISOConversion })),
                g(n, {
                  integrationName: this.name,
                  methodName: o,
                  type: `classic`,
            ...
            case 2:
              return (
                e.trys.push([2, 5, , 6]),
                this.integration
                  ? [4, this.integration.invoke.call(this.integration, o, d)]
                  : [3, 4]
              );
            case 3:
              (e.sent(), (e.label = 4));
    ...
    (n.prototype.track = function (n) {
      return t(this, void 0, void 0, function () {
        return e(this, function (e) {
          return [2, this.send(n, C.Track, `track`)];
        });
      });
    }),
      ...
      return t(this, void 0, void 0, function () {
        return e(this, function (e) {
          switch (e.label) {
            ...
            case 1:
              return (e.sent(), [2, this.send(n, C.Page, `page`)]);
          }
        });
      });
    }),
    (n.prototype.identify = function (n) {
      return t(this, void 0, void 0, function () {
        return e(this, function (e) {
          return [2, this.send(n, C.Identify, `identify`)];
        });
      });
    }),
    (n.prototype.alias = function (n) {
      return t(this, void 0, void 0, function () {
        return e(this, function (e) {
          return [2, this.send(n, C.Alias, `alias`)];
        });
      });
    }),
    (n.prototype.group = function (n) {
      return t(this, void 0, void 0, function () {
        return e(this, function (e) {
          return [2, this.send(n, C.Group, `group`)];
        });
      });
    }),
        ...
        setTimeout(function () {
          return t(n, void 0, void 0, function () {
            ...
            return e(this, function (e) {
              switch (e.label) {
                case 0:
                  return l() || this._ready !== !0 || this._initialized !== !0
                    ? (this.scheduleFlush(), [2])
                    : ((this.flushing = !0),
                      (t = this),
                      [4, P(this, this.buffer)]);
                case 1:
                  return (
                    (t.buffer = e.sent()),
                    (this.flushing = !1),
...
function I(e, t, i, a, o, s) {
  if ((i === void 0 && (i = {}), a === void 0 && (a = {}), x())) return [];
  t.plan && ((a ??= {}), (a.plan = t.plan));
  var l = t.middlewareSettings?.routingRules ?? [],
    u = t.integrations,
    d = a.integrations,
    p = f(t, a ?? {}),
    m = s?.reduce(function (e, t) {
      var n;
      return r(r({}, e), ((n = {}), (n[E(t)] = t), n));
    }, {}),
    h = new Set(
      n(
        n(
...
export { I as ajsDestinations };
//# sourceMappingURL=ajs-destination-BYy3-oU5.js.map
