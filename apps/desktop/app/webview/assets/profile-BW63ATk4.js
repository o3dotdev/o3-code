...
import { di as t, gi as n } from "./src-DAzAmbVS.js";
...
import { t as p } from "./use-auth-BI4R_D9h.js";
import { l as ee } from "./codex-api-5vE1HRY8.js";
...
import { t as te } from "./proxy-HwxlKevX.js";
import { t as ne } from "./use-reduced-motion-DwzvbwaT.js";
import { t as re } from "./settings-content-layout-Bnulb0lM.js";
import { i as ie, n as ae, t as h } from "./codex-avatar-5rBVLDei.js";
import { t as oe } from "./lock-nKsRyd28.js";
var g = f(),
  _ = e(r(), 1),
  v = 52;
7 * v;
...
function b({ dailyUsage: e, todayIso: t }) {
  let n = S(t),
    r = Array.from({ length: v }, () => 0),
    i = new Map(Array.from({ length: v }, (e, t) => [F(n, t * 7), t]));
  for (let n of e) {
    if (n.date > t) continue;
    let e = i.get(j(n.date));
    e != null && (r[e] += Math.max(0, n.credits));
  }
  return r;
}
function de({ dailyUsage: e, todayIso: t }) {
  return O(b({ dailyUsage: e, todayIso: t }));
}
function x(e = new Date()) {
...
function D(e) {
  let t = I(e);
  return Array.from({ length: 364 }, (n, r) => {
    let i = r % 7,
      a = k(e[Math.floor(r / 7)] ?? 0, t),
      o = 7 - i;
    return a === 0 || o > a ? 0 : 4;
  });
}
...
function A(e, t) {
  let n = P(e),
    r = S(t);
  return Array.from({ length: 364 }, (e, t) => n.get(F(r, t)) ?? 0);
}
function j(e) {
...
function M(e) {
  return Array.from({ length: v }, (t, n) =>
...
function N(e, t) {
  if (e <= 0 || t <= 0) return 0;
  let n = e / t;
  return n > 0.8 ? 4 : n > 0.6 ? 3 : n > 0.4 ? 2 : n > 0.2 ? 1 : 0;
}
function P(e) {
  return e.reduce(
...
function F(e, t) {
  ...
  return (n.setUTCDate(n.getUTCDate() + t), x(n));
}
function I(e) {
...
var R = 978,
  z = [0.74, 0.88, 0.82, 0.9, 0.76, 0.52, 0.42];
function fe(e) {
  return Array.from({ length: 364 }, (t, n) => {
    let r = n % 7;
    return { credits: B(Math.floor(n / 7), r) * 10 * R, date: C(n, e) };
  }).filter((t) => t.credits > 0 && t.date <= e);
}
function B(e, t) {
  let n =
      Math.sin((e + 1) * 12.9898 + (t + 1) * 78.233 + 3 * 37.719) * 43758.5453,
    r = 0.44 + 0.28 * Math.sin(e * 0.31 - 1.2),
    i = z[t] ?? 0,
    a = e > 5 && e < 14 ? 0.22 : e > 28 && e < 36 ? 0.18 : 0,
    o = r * i + a + (n - Math.floor(n)) * 0.55;
  return o > 1.03 ? 4 : o > 0.82 ? 3 : o > 0.62 ? 2 : o > 0.42 ? 1 : 0;
}
var V = t({
    name: n().nullable().optional(),
    picture: n().nullable().optional(),
  }),
  H = {
    currentStreakDays: 6,
    longestStreakDays: 23,
    longestTaskDurationMs: 1332e4,
    peakTokens: 842e3,
    totalTextTokens: 182e5,
  };
function U({ email: e, todayIso: t, userId: n }) {
  return [`profile`, `usage`, e ?? null, n ?? null, t];
}
function pe(e) {
  let t = (0, g.c)(7),
    { email: n, enabled: r, todayIso: i, userId: a } = e,
    o;
  t[0] !== n || t[1] !== i || t[2] !== a
    ? ((o = U({ email: n, todayIso: i, userId: a })),
      (t[0] = n),
      (t[1] = i),
      (t[2] = a),
      (t[3] = o))
  ...
  return (
    t[4] !== o || t[5] !== c
      ? ((u = { queryKey: o, enabled: c, queryFn: W, staleTime: l.ONE_MINUTE }),
        (t[4] = o),
        (t[5] = c),
        (t[6] = u))
      : (u = t[6]),
...
async function W() {
  try {
    let { body: e } = await u.getInstance().get(`/me`),
      t = V.parse(e);
    return {
      dailyUsage: [],
      imageUrl: t.picture?.trim() || null,
      name: t.name?.trim() || null,
      summary: H,
    };
  } catch {
    return { dailyUsage: [], imageUrl: null, name: null, summary: H };
  }
}
var G = i(),
  K = 12,
...
function q({ today: e = new Date() }) {
  let t = c(),
    n = ne(),
    { authMethod: r, email: i, planAtLogin: s, userId: u } = p(),
    { data: f } = ee(),
    { data: h } = d(`account-info`, {
      queryConfig: { enabled: r === `chatgpt` && !0, staleTime: l.ONE_MINUTE },
    }),
    { data: g } = d(`custom-avatars`, {
      queryConfig: {
        enabled: !0,
        refetchOnMount: !1,
    ...
    T = ie(g?.avatars),
    E = T.filter((e) => e.id.startsWith(`custom:`)),
    { selectedAvatar: D } = ae(T),
    [O, k] = (0, _.useState)(null),
    [A, j] = (0, _.useState)(`daily`),
    [M, N] = (0, _.useState)(null),
    P = w.data?.imageUrl ?? f?.profile_picture_url ?? null,
    F = P != null && P !== O,
    I = w.data?.name ?? f?.name ?? null,
    L = ce(f?.plan_type ?? h?.plan ?? s),
    R = w.data?.summary,
    z = w.data?.dailyUsage,
    B = z == null || z.length === 0 ? fe(v) : z,
    V = le({ dailyUsage: B, todayIso: v, view: A }),
    H = ue({ dailyUsage: B, todayIso: v }),
    U = b({ dailyUsage: B, todayIso: v }),
    W = de({ dailyUsage: B, todayIso: v }),
    K = t.formatMessage({
      ...
      children: [
        (0, G.jsxs)(`section`, {
          ...
          children: [
            (0, G.jsxs)(`div`, {
              ...
              children: [
                F
                  ...
                  : (0, G.jsx)(`div`, {
                      className: `flex size-20 items-center justify-center rounded-full bg-token-bg-secondary text-[28px] font-medium text-token-text-secondary`,
                      children: se(I),
                    }),
                (0, G.jsx)(`div`, {
                  className: `absolute -right-5 -bottom-1`,
                  children: (0, G.jsx)($, { avatar: D, size: `profile` }),
                }),
              ],
            }),
            (0, G.jsx)(`h1`, {
              className: `text-center text-[24px] leading-8 font-normal tracking-[0.072px] text-token-text-primary`,
              children:
                I ??
                (0, G.jsx)(o, {
            ...
            (0, G.jsx)(`div`, {
              className: `mt-1 flex items-center gap-1.5 text-sm leading-5 text-token-text-tertiary`,
              children:
                L == null
                  ? null
                  : (0, G.jsx)(`span`, {
                      className: `inline-flex h-[22px] items-center rounded-lg border border-token-border-light px-[5px] text-xs leading-4 text-token-text-tertiary`,
                      children: L,
                    }),
            }),
          ],
        ...
        (0, G.jsx)(`section`, {
          className: `flex flex-col items-center justify-center overflow-hidden rounded-[20px] border border-token-border-light bg-transparent`,
          children: (0, G.jsxs)(`div`, {
            className: `flex w-full items-center`,
            children: [
              (0, G.jsx)(J, {
                value: X(t, R?.totalTextTokens),
                label: (0, G.jsx)(o, {
              ...
              (0, G.jsx)(Y, {}),
              (0, G.jsx)(J, {
                value: he(t, R?.longestTaskDurationMs),
                label: (0, G.jsx)(o, {
            ...
            (0, G.jsxs)(`div`, {
              ...
              children: [
                (0, G.jsxs)(`div`, {
                  ...
                  children: [
                    (0, G.jsx)(`div`, {
                      className: `grid grid-flow-col grid-cols-[repeat(52,minmax(1px,1fr))] grid-rows-[repeat(7,minmax(1px,1fr))] gap-[5px] overflow-hidden`,
                      children: V.map((e, r) => {
                        let i = C(r, v);
                        if (A === `daily` && i > v) return null;
                        let o = (0, G.jsx)(
                          `div`,
                          {
                            className: `aspect-square w-full`,
                            children: (0, G.jsx)(te.div, {
                              animate: { opacity: 1, scale: 1 },
                              className: a(
                                `size-full rounded-[4px] transition-colors duration-500 ease-out [corner-shape:superellipse(1.5)]`,
                                me[e],
                              ),
                              initial: n ? !1 : { opacity: 0, scale: 0.7 },
                              transition: n
                                ? { duration: 0 }
                                : {
                                    delay: ge(r),
                    ...
                    A === `weekly` || A === `cumulative`
                      ? (0, G.jsx)(`div`, {
                          className: `pointer-events-none absolute inset-0 grid grid-cols-[repeat(52,minmax(1px,1fr))] grid-rows-[repeat(7,minmax(1px,1fr))] gap-[5px]`,
                          children: (A === `weekly` ? U : W).map((e, n) => {
                            let r = C(n * 7, v),
                              i = `${A}:${n}`;
                            return (0, G.jsx)(
                              m,
                              {
                                ...
                                children: (0, G.jsx)(`div`, {
                                  "aria-hidden": !0,
                                  className: a(
                                    `pointer-events-auto rounded-[4px] transition-colors`,
                                    M === i &&
                                      `bg-token-list-hover-background ring-1 ring-inset ring-token-border-light`,
                                  ),
                                  style: {
                                    gridColumn: n + 1,
                                    gridRow: `1 / 8`,
                ...
                (0, G.jsx)(`div`, {
                  ...
                  children: y.map((e) =>
                    (0, G.jsx)(
                      `span`,
                      {
                        children: t.formatDate(new Date(e), {
                          month: `short`,
                          timeZone: `UTC`,
                        }),
                      },
        ...
        (0, G.jsxs)(`section`, {
          ...
          children: [
            (0, G.jsx)(`h2`, {
              ...
              children: (0, G.jsx)(o, {
                id: `profile.myPets.title`,
                defaultMessage: `My Custom Pets`,
                description: `Heading above the custom pet list on the profile page`,
              }),
            }),
            E.length > 0
              ? (0, G.jsx)(`div`, {
                  className: `flex flex-wrap gap-3`,
                  children: E.map((e) => (0, G.jsx)(Se, { avatar: e }, e.id)),
                })
              : (0, G.jsx)(`div`, {
                  className: `text-sm text-token-text-tertiary`,
                  children: (0, G.jsx)(o, {
                    id: `profile.myPets.empty`,
                    defaultMessage: `No custom pets yet`,
                    description: `Empty state shown when the user has no custom pets`,
                  }),
                }),
          ],
        }),
...
function Y() {
  ...
  return (
    e[0] === Symbol.for(`react.memo_cache_sentinel`)
      ? ((t = (0, G.jsx)(`div`, {
          className: `w-px shrink-0 self-stretch rounded-sm bg-token-border-light`,
        })),
        (e[0] = t))
      : (t = e[0]),
    t
...
function he(e, t) {
  let n = Math.max(0, Math.floor((t ?? 0) / 6e4)),
    r = Math.floor(n / 60),
    i = n % 60;
  return r > 0
    ? e.formatMessage(
...
function _e(e) {
  let t = new Date(`${e}T00:00:00.000Z`),
    n = t.getUTCMonth(),
    r = t.getUTCFullYear();
  return Array.from({ length: K }, (e, t) => {
    let i = t - (K - 1);
    return new Date(Date.UTC(r, n + i, 1)).toISOString();
  });
}
function ve({ dateIso: e, intl: t, tokenCount: n, todayIso: r }) {
  return t.formatMessage(
    ...
    { date: xe({ dateIso: e, intl: t, todayIso: r }), tokens: X(t, n) },
  );
}
function ye({ intl: e, tokenCount: t, weekStartIso: n }) {
  return e.formatMessage(
    {
    ...
    {
      tokens: X(e, t),
      weekStart: e.formatDate(new Date(`${n}T00:00:00.000Z`), {
        day: `numeric`,
        month: `short`,
        timeZone: `UTC`,
        year: `numeric`,
...
function be({ intl: e, tokenCount: t, weekStartIso: n }) {
  return e.formatMessage(
    {
...
function xe({ dateIso: e, intl: t, todayIso: n }) {
...
function Q(e) {
  let t = (0, g.c)(7),
    { active: n, children: r, onSelect: i } = e,
    o = n
      ? `text-token-text-primary`
      : `text-token-text-tertiary hover:bg-token-list-hover-background hover:text-token-text-primary focus-visible:bg-token-list-hover-background focus-visible:text-token-text-primary`,
    s;
  t[0] === o
    ? (s = t[1])
    : ((s = a(
        `cursor-interaction rounded-md px-1.5 py-0.5 text-sm leading-5 outline-none transition-colors focus-visible:ring-1 focus-visible:ring-token-focus-border`,
        o,
      )),
      (t[0] = o),
      (t[1] = s));
...
function $(e) {
  ...
  t[0] === c
    ? (l = t[1])
    : ((l = a(`flex shrink-0 items-center justify-center overflow-hidden`, c)),
      (t[0] = c),
      (t[1] = l));
  let u = s ? void 0 : `scale-[0.66]`,
    d = o && !s ? `jumping` : `idle`,
    f;
  t[2] !== n.assetRef || t[3] !== n.spritesheetUrl || t[4] !== u || t[5] !== d
    ? ((f = (0, G.jsx)(h, {
        assetRef: n.assetRef,
        className: u,
...
function Se(e) {
  ...
  t[2] !== n || t[3] !== r
    ? ((s = (0, G.jsx)(`div`, {
        className: `relative`,
        children: (0, G.jsx)($, { avatar: n, isHovered: r, size: `grid` }),
      })),
      (t[2] = n),
      (t[3] = r),
      (t[4] = s))
  ...
  t[5] === n.displayName
    ? (c = t[6])
    : ((c = (0, G.jsx)(`div`, {
        className: `w-full truncate text-xs leading-4 text-token-text-secondary group-hover:text-token-text-primary`,
  ...
  return (
    t[7] !== s || t[8] !== c
      ? ((l = (0, G.jsxs)(`div`, {
          className: `group flex w-20 flex-col items-center gap-1 text-center`,
          onPointerEnter: a,
          onPointerLeave: o,
          children: [s, c],
        })),
...
export { q as Profile };
//# sourceMappingURL=profile-BW63ATk4.js.map
