...
import { t as s } from "./jsx-runtime-CiQ1k8xo.js";
...
import { H as l, W as u, xt as d } from "./setting-storage-EK1Te68s.js";
...
import { t as h } from "./code-snippet-CQ14r_m1.js";
...
import { t as g } from "./play-sm-Bcu8ds1M.js";
...
import { t as _ } from "./regenerate-C3FUHd6G.js";
...
import { i as v, r as y, t as b } from "./artifact-preview-status-D5kFRFQE.js";
var x = d(),
...
function k(e) {
  ...
  return { cells: t.data.cells.map(ee), title: M(t.data.metadata, `title`) };
}
function ee(e) {
  let t = j(e.source),
    n = e.id ?? null,
...
function te(e, t, n) {
  switch (e.output_type) {
    ...
    case `error`:
      return [
        {
          ename: M(e, `ename`) ?? `Error`,
          evalue: M(e, `evalue`) ?? ``,
          summaryMarkdown: n,
          traceback: I(e.traceback) ?? ``,
          type: `error`,
        },
      ];
    case `display_data`:
    case `execute_result`:
      return ne(e.data, t, n);
    default:
      return [];
  }
}
...
function P(e, t) {
  for (let n of F(e)) {
    ...
    let r = T.safeParse(e[t]);
    if (!r.success) continue;
    let i = I(r.data.summaryMarkdown);
...
function B(e) {
  ...
  let d = c,
    f;
  t[2] !== d.document || t[3] !== d.status || t[4] !== o
    ? ((f = d.status === `ready` ? (d.document.title ?? $(o)) : $(o)),
      (t[2] = d.document),
      (t[3] = d.status),
      (t[4] = o),
      (t[5] = f))
  ...
  let p = f,
    m;
  t[6] !== s || t[7] !== d.document || t[8] !== d.status
    ? ((m =
        d.status === `ready`
          ? s.formatMessage(
              {
    ...
    : (m = t[9]);
  let h = m,
    S = h == null ? `IPYNB` : `IPYNB · ${h}`,
    C;
  t[10] !== s || t[11] !== d.status
    ? ((C =
        d.status === `ready`
          ? (0, z.jsxs)(z.Fragment, {
              children: [
...
function W(e) {
  ...
  t[0] !== n || t[1] !== r || t[2] !== i
    ? ((a = (0, z.jsx)(`summary`, {
        ...
        children: (0, z.jsx)(G, { cell: n, cellNumber: r, totalCellCount: i }),
      })),
      (t[0] = n),
      (t[1] = r),
      (t[2] = i),
  ...
  t[4] === n
    ? (o = t[5])
    : ((o = (0, z.jsx)(K, { cell: n })), (t[4] = n), (t[5] = o));
  let s;
  return (
    t[6] !== a || t[7] !== o
      ? ((s = (0, z.jsxs)(`details`, {
...
function G(e) {
    ...
    ? ((_ =
        n.cellType === `code`
          ? (0, z.jsx)(`span`, {
              ...
              children: (0, z.jsx)(g, { className: `icon-2xs` }),
            })
          : null),
      (t[16] = n.cellType),
      (t[17] = a),
  ...
  return (
    t[22] !== m || t[23] !== v
      ? ((y = (0, z.jsxs)(z.Fragment, { children: [m, v] })),
        (t[22] = m),
        (t[23] = v),
        (t[24] = y))
      : (y = t[24]),
...
function K(e) {
  ...
  if (n.cellType === `code`) {
    ...
    let c;
    t[14] !== o || t[15] !== s
      ? ((c = (0, z.jsxs)(`div`, { className: `px-4 py-3`, children: [o, s] })),
        (t[14] = o),
        (t[15] = s),
        (t[16] = c))
      : (c = t[16]);
...
function ae(e) {
  ...
  switch (n.type) {
    ...
    case `html`: {
      ...
      t[13] === n.html
        ? (o = t[14])
        : ((o = (0, z.jsx)(Y, { className: `mt-2`, children: n.html })),
          (t[13] = n.html),
          (t[14] = o));
      let s;
      return (
        t[15] !== a || t[16] !== o
          ? ((s = (0, z.jsxs)(`div`, { children: [a, o] })),
            (t[15] = a),
            (t[16] = o),
            (t[17] = s))
          : (s = t[17]),
    ...
    case `error`: {
      ...
      t[27] === n
        ...
        : ((r =
            Z(n).trim().length > 0
              ? (0, z.jsx)(Y, { className: `mt-2`, children: Z(n) })
              : null),
          (t[27] = n),
          (t[28] = r));
      let i;
...
function J(e) {
  ...
  if (i != null) {
    ...
    t[2] === r
      ? (n = t[3])
      : ((n = (0, z.jsx)(Y, { className: `mt-2`, children: r })),
        (t[2] = r),
        (t[3] = n));
    let a;
    return (
  ...
  return (
    t[10] === r
      ? (a = t[11])
      : ((a = (0, z.jsx)(X, { children: r })), (t[10] = r), (t[11] = a)),
    a
  );
}
function Y(e) {
  ...
  t[1] === n
    ? (a = t[2])
    : ((a = (0, z.jsx)(X, { className: `mt-2`, children: n })),
      (t[1] = n),
      (t[2] = a));
  let o;
  return (
    t[3] !== r || t[4] !== a
      ? ((o = (0, z.jsxs)(`details`, { className: r, children: [i, a] })),
        (t[3] = r),
        (t[4] = a),
        (t[5] = o))
      : (o = t[5]),
...
function X(e) {
  ...
  return (
    t[2] !== n || t[3] !== i
      ? ((a = (0, z.jsx)(`pre`, { className: i, children: n })),
        (t[2] = n),
        (t[3] = i),
        (t[4] = a))
      : (a = t[4]),
...
function oe(e) {
  try {
    return {
      document: k(JSON.parse(new TextDecoder().decode(se(e)))),
      status: `ready`,
    };
  } catch {
    return { status: `error` };
...
function ce(e, t, n) {
  ...
  switch (t.cellType) {
    ...
    case `code`: {
      let r = ue(t.descriptionMarkdown ?? ``);
      return r.length > 0
        ? Q(r)
        : e.formatMessage(
            {
...
function le(e) {
  let t = e
    ...
    .map((e) => e.trim())
    .find((e) => /^#{1,6}\s+/.test(e));
  return t == null ? null : Q(t.replace(/^#{1,6}\s+/, ``));
}
function ue(e) {
  return e
    .replace(/`{1,3}([^`]+)`{1,3}/g, `$1`)
...
export { B as NotebookPreviewPanel };
//# sourceMappingURL=notebook-preview-panel-CAO-aRhM.js.map
