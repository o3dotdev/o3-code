...
import { W as r, xt as i } from "./setting-storage-kJblH-wH.js";
var a = i(),
  o = e(t(), 1),
  s = n(),
  c = 6e4,
...
function S() {
  return (0, o.useSyncExternalStore)(b, x, x);
}
function C(e, t) {
...
function T(e) {
  ...
  if (r != null) {
    ...
    return (
      t[2] !== n || t[3] !== e
        ? ((i = (0, s.jsx)(D, { dateString: n, now: e })),
          (t[2] = n),
          (t[3] = e),
          (t[4] = i))
        : (i = t[4]),
  ...
  return (
    t[5] === n
      ? (i = t[6])
      : ((i = (0, s.jsx)(E, { dateString: n })), (t[5] = n), (t[6] = i)),
    i
  );
}
function E(e) {
  ...
  return (
    t[0] !== n || t[1] !== r
      ? ((i = (0, s.jsx)(D, { dateString: n, now: r })),
        (t[0] = n),
        (t[1] = r),
        (t[2] = i))
      : (i = t[2]),
...
export { T as t };
//# sourceMappingURL=format-relative-date-time-DUnZZMJU.js.map
