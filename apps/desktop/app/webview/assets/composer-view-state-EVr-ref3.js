...
import { t as r } from "./v4-Bk0goSq-.js";
import {
  Q as i,
  S as a,
  Y as o,
...
import { i as d, r as f } from "./codex-api-5vE1HRY8.js";
import { t as p } from "./route-scope-BpEoGCxV.js";
import { n as m, o as h } from "./prompt-text-Dka9Yl6Q.js";
import { n as g } from "./use-environment-CuUO0qYe.js";
function _(e) {
  return `input_items` in e;
}
function ee({ taskTurns: e, fallbackUserTurn: t, fallbackAssistantTurn: n }) {
  let r = new Map();
  return (
...
var b = c(p, ({ scope: e }) =>
    f(e.value.routeKind === `remote-thread` ? e.value.taskId : null),
  ),
  x = c(p, ({ scope: e }) =>
    d(e.value.routeKind === `remote-thread` ? e.value.taskId : null),
  ),
  S = l(p, null),
  C = i(a, (e, { signal: t }) => t(!1)),
  w = s(p, ({ get: e }) => {
    let { data: t } = e(b);
    return ee({
      taskTurns: e(x).data,
  ...
  T = s(p, ({ get: e }) => {
    ...
    if (t != null) return t;
    let { data: n } = e(b);
    return n?.current_assistant_turn?.id ?? v(e(w));
  }),
  E = s(p, ({ get: e }) => {
    let t = e(T);
    if (t == null) return null;
    let n = e(w).find((e) => e.id === t);
    return n == null || _(n) ? null : n;
  }),
  D = s(p, ({ get: e }) => {
    let t = e(T);
    return t == null ? !1 : e(e(C, t));
  });
function O(e, t) {
  e.set(S, t);
}
...
var j = s(p, ({ get: e }) => {
    ...
    if (!(t == null || n == null))
      return {
        type: `cloud`,
        hasAppliedCodeLocally: e(D),
        taskDetails: t,
        selectedTurnId: n,
        selectedTurn: e(E) ?? void 0,
      };
  }),
  M = s(h, ({ get: e, scope: t }) => {
    switch (t.value.kind) {
  ...
  N = u(),
  P = n(`last-used-continue-in-mode`, `local`);
function F(e) {
  return e === `remote` ? `local` : e;
}
var I = e(`last-used-continue-in-mode`, `local`),
  L = e(`environment`, null),
  R = e(`composer-auto-context-enabled`, !0),
  z = i(a, (e, { signal: t }) => t(void 0)),
  B = l(h, () => void 0),
  V = l(h, () => void 0, {
    onMount(e, t) {
      if (t.value.kind !== `local`) return;
      let n = t.get(z, t.value.conversationId),
        r = t.get(n);
      r != null && (e(me(r)), t.set(B, r.prompt), t.set(n, void 0));
    },
  }),
  H = s(h, ({ get: e }) => {
    let t = e(L) ?? null,
      n = F(e(I) ?? `local`),
      r = g(t)?.default_branch ?? `main`,
      i = e(M);
    return (
      i != null && n === `worktree`
        ? (n = `local`)
  ...
  U = s(h, ({ get: e }) => ({ ...e(H), ...e(V) })),
  W = s(h, ({ get: e }) => e(U).composerMode),
  G = s(h, ({ get: e }) => e(B) ?? ``),
  K = s(h, ({ get: e }) => m(e(G))),
  ne = s(h, ({ get: e }) => ({ ...e(U), prompt: e(G) })),
  q = s(h, ({ get: e }) => e(U).pendingThreadGoalObjective),
  J = s(h, ({ get: e }) => e(U).isAutoContextOn),
  Y = s(h, ({ get: e }) => e(U).imageAttachments),
  X = s(h, ({ get: e }) => e(U).appshotContexts),
  Z = s(h, ({ get: e }) => e(U).fileAttachments),
  re = s(h, ({ get: e }) => e(U).addedFiles),
  ie = s(h, ({ get: e }) => e(U).commentAttachments),
  ae = s(h, ({ get: e }) => e(U).mcpAppModelContextAttachments),
  oe = s(h, ({ get: e }) => e(U).selectedTextAttachments),
  se = s(h, ({ get: e }) => e(U).pullRequestChecks),
  Q = s(h, ({ get: e }) => e(U).asyncThreadStartingState),
  ce = s(h, ({ get: e }) => e(U).followUpCloudStartingState),
  le = s(h, ({ get: e }) => e(U).defaultBranchSnapshot);
function ue(e, t) {
  let n = e.get(G),
    r = typeof t == `function` ? t(n) : t;
  Object.is(n, r) || e.set(B, r);
}
function $(e, n) {
  let r = e.get(U),
    i = t(r, n);
...
function de(e, t) {
  ...
  n.length !== 0 &&
    $(e, (e) => {
      e.selectedTextAttachments.push({ id: r(), text: n });
    });
}
function fe(e) {
  let t = (0, N.c)(3),
  ...
  return (
    t[0] !== e || t[1] !== n
      ? ((r = (t) => {
          n.value.kind !== `local` || n.value.conversationId !== e || de(n, t);
        }),
        (t[0] = e),
        (t[1] = n),
        (t[2] = r))
...
function pe(e) {
  ...
  return (
    t[0] !== e || t[1] !== n
      ? ((r = (t) => {
          let { id: r, imageAttachments: i, text: a, title: o } = t;
          n.value.kind !== `local` ||
            n.value.conversationId !== e ||
            $(n, (e) => {
              ...
              if (n.length === 0 && i.length === 0) {
                t !== -1 && e.mcpAppModelContextAttachments.splice(t, 1);
                return;
              }
              let s = {
                id: r,
                imageAttachments: i,
                text: n.length > 0 ? n : null,
                title: o,
              };
              if (t === -1) {
              ...
              e.mcpAppModelContextAttachments[t] = s;
            });
        }),
        (t[0] = e),
        (t[1] = n),
...
//# sourceMappingURL=composer-view-state-EVr-ref3.js.map
