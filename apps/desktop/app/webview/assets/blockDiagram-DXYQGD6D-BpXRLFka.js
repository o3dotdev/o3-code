...
import { t } from "./line-DcJPiuto.js";
import { h as n } from "./step.js";
import { t as r } from "./clone-D6226BAN.js";
import { s as i } from "./invert.js";
import { t as a } from "./channel-Bg_9b54a.js";
import "./dist-OQR0lEt7.js";
import "./marked.esm-BR-H6018.js";
import { n as o, r as s } from "./chunk-AGHRB4JF-Dk9Dm4Nw.js";
import {
  D as c,
  L as l,
  a as u,
...
import { c as g, h as _, i as v } from "./chunk-5PVQY5BW-CnaqcI9r.js";
import { n as y } from "./chunk-U2HBQHQK-bhKagtxE.js";
import { t as b } from "./chunk-FMBD7UC4-Bz4YzVzS.js";
import { n as x, t as S } from "./chunk-BSJP7CBP-DflEcVJN.js";
import { n as C, t as w } from "./chunk-ZZ45TVLE-Cjc02p6x.js";
import { t as T } from "./graphlib-BY2jPsah.js";
var E = (function () {
...
var D = E,
  ...
  N = new Map(),
  re = ``,
  ie = o((e) => p.sanitizeText(e, ne), `sanitizeText`),
  ae = o(function (e, t = ``) {
    let n = N.get(e);
...
o(pe, `edgeStrToEdgeData`);
var me = 0,
  he = {
    getConfig: o(() => h().block, `getConfig`),
    typeStr2Type: de,
    edgeTypeStr2Type: fe,
    edgeStrToEdgeData: pe,
    getLogger: o(() => s, `getLogger`),
    getBlocksFlat: o(() => [...O.values()], `getBlocksFlat`),
    getBlocks: o(() => le || [], `getBlocks`),
    getEdges: o(() => k, `getEdges`),
    setHierarchy: o((e) => {
      ((P.children = e), ce(e, P), (le = P.children));
    }, `setHierarchy`),
    getBlock: o((e) => O.get(e), `getBlock`),
    setBlock: o((e) => {
      O.set(e.id, e);
    }, `setBlock`),
    getColumns: o((e) => {
    ...
    getDiagramId: o(() => re, `getDiagramId`),
  },
  F = o((e, t) => {
    let n = a;
  ...
  if (e.children?.length > 0) {
    ...
    for (let t of e.children)
      t.size &&
        ...
        (t.size.width =
          i * (t.widthInColumns ?? 1) + I * ((t.widthInColumns ?? 1) - 1)),
        (t.size.height = a),
        (t.size.x = 0),
        (t.size.y = 0),
        s.debug(
    ...
    if (f < n) {
      ...
      let t = (n - u * I - I) / u,
        o = (r - d * I - I) / d;
      (s.debug(`Size indata abc88`, e.id, `childWidth`, t, `maxWidth`, i),
        s.debug(`Size indata abc88`, e.id, `childHeight`, o, `maxHeight`, a),
        s.debug(`Size indata abc88 xSize`, u, `padding`, I));
    ...
    if (
      ...
      if (t > 0) {
        let n = (f - t * I - I) / t;
        s.debug(`abc95 (growing to fit) width`, e.id, f, e.size?.width, n);
...
function z(e, t) {
  ...
  let n = e.columns ?? -1;
  if (
    (s.debug(`layoutBlocks columns abc95`, e.id, `=>`, n, e),
    e.children && e.children.length > 0)
  ) {
    let r = e?.children[0]?.size?.width ?? 0,
      i = e.children.length * r + (e.children.length - 1) * I;
    s.debug(`widthOfChildren 88`, i, `posX`);
    let a = new Map();
    {
      let t = 0;
      for (let r of e.children) {
    ...
    let l = e?.size?.x ? e?.size?.x + (-e?.size?.width / 2 || 0) : -I,
      u = 0;
    for (let r of e.children) {
      let i = e;
      if (!r.size) continue;
      ...
      if (
        (m != u &&
          ((u = m),
          (l = e?.size?.x ? e?.size?.x + (-e?.size?.width / 2 || 0) : -I),
          s.debug(`New row in layout for block`, e.id, ` and child `, r.id, u)),
        s.debug(
          `abc89 layout blocks (child) id: ${r.id} Pos: ${c} (px, py) ${p},${m} (${i?.size?.x},${i?.size?.y}) parent: ${i.id} width: ${d}${I}`,
        ),
        i.size)
      ) {
        let e = d / 2;
        ((r.size.x = l + I + e),
          s.debug(
            `abc91 layout blocks (calc) px, pyid:${r.id} startingPos=X${l} new startingPosX${r.size.x} ${e} padding=${I} width=${d} halfWidth=${e} => x:${r.size.x} y:${r.size.y} ${r.widthInColumns} (width * (child?.w || 1)) / 2 ${(d * (r?.widthInColumns ?? 1)) / 2}`,
          ),
          (l = r.size.x + e));
        let t = o.get(m) ?? 0,
          n = a.get(m) ?? f;
        ((r.size.y = i.size.y - i.size.height / 2 + t + n / 2 + I),
          s.debug(
            `abc88 layout blocks (calc) px, pyid:${r.id}startingPosX${l}${I}${e}=>x:${r.size.x}y:${r.size.y}${r.widthInColumns}(width * (child?.w || 1)) / 2${(d * (r?.widthInColumns ?? 1)) / 2}`,
          ));
      }
      r.children && z(r, t);
      let h = r?.widthInColumns ?? 1;
      (n > 0 && (h = Math.min(h, n - (c % n))),
        (c += h),
        s.debug(`abc88 columnsPos`, r, c));
    }
  }
  s.debug(
...
function xe(e) {
  ...
  if (!t) return;
  (R(t, e, 0, 0), z(t, e), s.debug(`getBlocks`, JSON.stringify(t, null, 2)));
  let { minX: n, minY: r, maxX: i, maxY: a } = B(t),
    o = a - r;
  return { x: n, y: r, width: i - n, height: o };
}
o(xe, `layout`);
var V = o(async (e, t, n, r = !1, i = !1) => {
    let a = t || ``;
  ...
  Te = o(async (t, n) => {
    let r = d(),
      i = m(r),
      a = t.insert(`g`).attr(`class`, `edgeLabel`),
      o = a.insert(`g`).attr(`class`, `label`),
      s = n.labelType === `markdown`,
      c = await y(
        t,
        n.label,
        {
    ...
    if (n.startLabelLeft) {
      let r = t.insert(`g`).attr(`class`, `edgeTerminals`),
        ...
        o = await V(a, n.startLabelLeft, n.labelStyle);
      f = o;
      let s = o.getBBox();
      if (i) {
        let t = o.children[0],
      ...
      (a.attr(`transform`, S(s, i)),
        U[n.id] || (U[n.id] = {}),
        (U[n.id].startLeft = r),
        W(f, n.startLabelLeft));
    }
    if (n.startLabelRight) {
      let r = t.insert(`g`).attr(`class`, `edgeTerminals`),
        a = r.insert(`g`).attr(`class`, `inner`),
        o = await V(r, n.startLabelRight, n.labelStyle);
      ...
      (a.attr(`transform`, S(s, i)),
        U[n.id] || (U[n.id] = {}),
        (U[n.id].startRight = r),
        W(f, n.startLabelRight));
    }
    if (n.endLabelLeft) {
      let r = t.insert(`g`).attr(`class`, `edgeTerminals`),
        a = r.insert(`g`).attr(`class`, `inner`),
        o = await V(a, n.endLabelLeft, n.labelStyle);
      f = o;
      let s = o.getBBox();
      if (i) {
        let t = o.children[0],
    ...
    if (n.endLabelRight) {
      let r = t.insert(`g`).attr(`class`, `edgeTerminals`),
        a = r.insert(`g`).attr(`class`, `inner`),
        o = await V(a, n.endLabelRight, n.labelStyle);
      f = o;
      let s = o.getBBox();
      if (i) {
        let t = o.children[0],
...
var Ee = o((e, t) => {
    ...
    if (e.startLabelLeft) {
      let t = U[e.id].startLeft,
        r = e.x,
        i = e.y;
      if (n) {
        let t = _.calcTerminalLabelPosition(
  ...
  node        : x:${e.x} y:${e.y} w:${e.width} h:${e.height}`);
    ...
    if (Math.abs(i - t.y) * o > Math.abs(r - t.x) * l) {
      ...
      return (
        ...
        d === 0 && (r.x = t.x),
        u === 0 && (r.y = t.y),
        s.debug(`abc89 topp/bott calc, Q ${u}, q ${e}, R ${d}, r ${c}`, r),
        r
      );
    } else {
      ...
      return (
        s.debug(`sides calc abc89, Q ${u}, q ${e}, R ${d}, r ${c}`, {
          _x: i,
          _y: a,
        }),
        c === 0 && ((i = t.x), (a = t.y)),
  ...
  Ae = o(function (e, r, i, a, o, l, u) {
    let f = i.points;
    s.debug(`abc88 InsertEdge: edge=`, i, `e=`, r);
    let p = !1,
      m = l.node(r.v);
    var h = l.node(r.w);
    (h?.intersect &&
      m?.intersect &&
      ((f = f.slice(1, i.points.length - 1)),
      f.unshift(m.intersect(f[0])),
      f.push(h.intersect(f[f.length - 1]))),
      i.toCluster &&
        (s.debug(`to cluster abc88`, a[i.toCluster]),
        (f = ke(i.points, a[i.toCluster].node)),
        (p = !0)),
      i.fromCluster &&
        (s.debug(`from cluster abc88`, a[i.fromCluster]),
        (f = ke(f.reverse(), a[i.fromCluster].node).reverse()),
        (p = !0)));
    let g = f.filter((e) => !Number.isNaN(e.y)),
      _ = n;
    ...
    let C = e
        ...
        .attr(`style`, i.style),
      w = ``;
    ((d().flowchart.arrowMarkerAbsolute || d().state.arrowMarkerAbsolute) &&
      (w = c(!0)),
      Se(C, i, w, u, o));
    let T = {};
    return (p && (T.updatedPath = f), (T.originalPath = i.points), T);
  }, `insertEdge`),
  je = o((e) => {
    let t = new Set();
    for (let n of e)
...
o(Fe, `intersectEllipse`);
var Ie = Fe;
function Le(e, t, n) {
  return Ie(e, t, t, n);
}
o(Le, `intersectCircle`);
var Re = Le;
function ze(e, t, n, r) {
  var i = t.y - e.y,
    a,
...
var K = {
  ...
  q = o(async (t, n, r, i) => {
    let a = d(),
      o,
      s = n.useHtmlLabels || m(a);
    o = r || `node default`;
    let c = t
        .insert(`g`)
        .attr(`class`, o)
        .attr(`id`, n.domId || n.id),
      u = c.insert(`g`).attr(`class`, `label`).attr(`style`, n.labelStyle),
      f;
    f =
      n.labelText === void 0
        ? ``
        : typeof n.labelText == `string`
          ? n.labelText
          : n.labelText[0];
    let p;
    p =
      n.labelType === `markdown`
        ? y(
            ...
            {
              useHtmlLabels: s,
              width: n.width || a.flowchart.wrappingWidth,
              classes: `markdown-node-label`,
            },
            a,
          )
        : await V(u, l(v(f), a), n.labelStyle, !1, i);
    let h = p.getBBox(),
      g = n.padding / 2;
    if (m(a)) {
      let t = p.children[0],
    ...
    return (
      s
        ...
        : u.attr(`transform`, `translate(0, ` + -h.height / 2 + `)`),
      n.centerLabel &&
        u.attr(
          `transform`,
          `translate(` + -h.width / 2 + `, ` + -h.height / 2 + `)`,
      ...
      { shapeSvg: c, bbox: h, halfPadding: g, label: u }
    );
  }, `labelHelper`),
  J = o((e, t) => {
...
o(Y, `insertPolygonShape`);
var Ue = o(async (e, t) => {
    t.useHtmlLabels || m(d()) || (t.centerLabel = !0);
    let {
      shapeSvg: n,
      bbox: r,
      halfPadding: i,
  ...
  nt = o(async (e, t) => {
    let {
      ...
      l = t.positioned ? -o / 2 : -r.width / 2 - i,
    ...
    if (
      ...
      (t.props.borders && (Z(a, t.props.borders, o, c), e.delete(`borders`)),
        e.forEach((e) => {
...
function Z(e, t, n, r) {
  ...
  (t.includes(`t`) ? (s.debug(`add top border`), a(n)) : c(n),
    t.includes(`r`) ? (s.debug(`add right border`), a(r)) : c(r),
    t.includes(`b`) ? (s.debug(`add bottom border`), a(n)) : c(n),
    t.includes(`l`) ? (s.debug(`add left border`), a(r)) : c(r),
    e.attr(`stroke-dasharray`, i.join(` `)));
}
o(Z, `applyNodePropertyBorders`);
var at = o(async (t, n) => {
    let r;
    ...
    let i = t
      ...
      l = n.labelText.flat ? n.labelText.flat() : n.labelText,
      u = ``;
    ((u = typeof l == `object` ? l[0] : l),
      s.info(`Label text abc79`, u, l, typeof l == `object`));
    let f = await V(c, u, n.labelStyle, !0, !0),
      p = { width: 0, height: 0 };
    if (m(d())) {
      let t = f.children[0],
        n = e(f);
      ((p = t.getBoundingClientRect()),
        n.attr(`width`, p.width),
        n.attr(`height`, p.height));
    }
    s.info(`Text 2`, l);
    let h = l.slice(1, l.length),
      g = f.getBBox(),
      _ = await V(c, h.join ? h.join(`<br/>`) : h, n.labelStyle, !0, !0);
    if (m(d())) {
      let t = _.children[0],
        n = e(_);
      ((p = t.getBoundingClientRect()),
    ...
    return (
      e(_).attr(
        `transform`,
        `translate( ` +
          (p.width > g.width ? 0 : (g.width - p.width) / 2) +
          `, ` +
          (g.height + v + 5) +
          `)`,
      ),
      ...
      a
        ...
        .attr(`x`, -p.width / 2 - v)
        .attr(`y`, -p.height / 2 - v)
        .attr(`width`, p.width + n.padding)
        .attr(`height`, p.height + n.padding),
      o
        .attr(`class`, `divider`)
        .attr(`x1`, -p.width / 2 - v)
        .attr(`x2`, p.width / 2 + v)
        .attr(`y1`, -p.height / 2 - v + g.height + v)
        .attr(`y2`, -p.height / 2 - v + g.height + v),
      J(n, a),
  ...
  st = o(async (e, t) => {
    ...
    return (
      ...
      (t.intersect = function (e) {
        return (
          s.info(`Circle intersect`, t, r.width / 2 + i, e),
  ...
  ct = o(async (e, t) => {
    ...
    return (
      ...
      (t.intersect = function (e) {
        return (
          s.info(`DoubleCircle intersect`, t, r.width / 2 + i + 5, e),
  ...
  ft = {
    ...
    class_box: o(async (t, n) => {
      ...
      let a = t
        ...
        l = 0,
        u = 4,
        f = a.insert(`g`).attr(`class`, `label`),
        p = 0,
        h = n.classData.annotations?.[0],
        g = await V(
          f,
          n.classData.annotations[0]
            ? `«` + n.classData.annotations[0] + `»`
            : ``,
          n.labelStyle,
          !0,
      ...
      if (m(d())) {
        ...
        ((_ = t.getBoundingClientRect()),
          ...
          n.attr(`height`, _.height));
      }
      n.classData.annotations[0] && ((u += _.height + 4), (l += _.width));
      let v = n.classData.label;
      n.classData.type !== void 0 &&
        n.classData.type !== `` &&
        (m(d())
          ? (v += `&lt;` + n.classData.type + `&gt;`)
          : (v += `<` + n.classData.type + `>`));
      let y = await V(f, v, n.labelStyle, !0, !0);
      ...
      (n.classData.members.forEach(async (t) => {
        let r = t.getDisplayDetails(),
          i = r.displayText;
        m(d()) && (i = i.replace(/</g, `&lt;`).replace(/>/g, `&gt;`));
        let a = await V(f, i, r.cssStyle ? r.cssStyle : n.labelStyle, !0, !0),
          o = a.getBBox();
        if (m(d())) {
          let t = a.children[0],
            n = e(a);
          ((o = t.getBoundingClientRect()),
            n.attr(`width`, o.width),
            n.attr(`height`, o.height));
        }
      ...
      let S = [];
      if (
        (n.classData.methods.forEach(async (t) => {
          let r = t.getDisplayDetails(),
            i = r.displayText;
          m(d()) && (i = i.replace(/</g, `&lt;`).replace(/>/g, `&gt;`));
          let a = await V(f, i, r.cssStyle ? r.cssStyle : n.labelStyle, !0, !0),
      ...
      return (
        ...
        o
          ...
          .attr(`x`, -l / 2 - r)
          .attr(`y`, -(u / 2) - r)
          .attr(`width`, l + n.padding)
          .attr(`height`, u + n.padding),
        J(n, o),
        (n.intersect = function (e) {
          return K.rect(n, e);
        }),
...
function ht(e, t, n = !1) {
  ...
  return {
    ...
    intersect: void 0,
    type: r.type,
    padding: s ?? h()?.block?.padding ?? 0,
  };
}
o(ht, `getNodeFromBlock`);
async function gt(e, t, n) {
  let r = ht(t, n, !1);
  if (r.type === `group`) return;
  let i = await pt(e, r, { config: h() }),
    a = i.node().getBBox(),
    o = n.getBlock(r.id);
...
o(gt, `calculateBlockSize`);
async function _t(e, t, n) {
  let r = ht(t, n, !0);
  n.getBlock(r.id).type !== `space` &&
    (await pt(e, r, { config: h() }), (t.intersect = r?.intersect), mt(r));
}
o(_t, `insertBlockPositioned`);
...
var xt = {
  ...
  db: he,
  renderer: {
    draw: o(async function (t, n, r, i) {
      let { securityLevel: a, block: o } = h(),
        c = i.db;
      c.setDiagramId(n);
      let l;
      a === `sandbox` && (l = e(`#i` + n));
      let u = e(a === `sandbox` ? l.nodes()[0].contentDocument.body : `body`),
        d = a === `sandbox` ? u.select(`[id="${n}"]`) : e(`[id="${n}"]`);
      ye(d, [`point`, `circle`, `cross`], i.type, n);
      let p = c.getBlocks(),
        m = c.getBlocksFlat(),
        g = c.getEdges(),
        _ = d.insert(`g`).attr(`class`, `block`);
      await vt(_, p, c);
      let v = xe(c);
      if ((await yt(_, p, c), await bt(_, g, m, c, n), v)) {
        let e = v,
...
//# sourceMappingURL=blockDiagram-DXYQGD6D-BpXRLFka.js.map
