...
import { i as fe, n as pe } from "./isEmpty-hl33V4on.js";
import { E as O } from "./chunk-S3R3BYOJ-5zDRn6nL.js";
import { t as k } from "./graphlib-BZvYK9y8.js";
function me(e) {
  return i(t(e, void 0, T), e + ``);
}
var he = RegExp(
  `[\\u200d\\ud800-\\udfff\\u0300-\\u036f\\ufe20-\\ufe2f\\u20d0-\\u20ff\\ufe0e\\ufe0f]`,
);
...
function j(e, t, n) {
  for (var r = -1, i = e.length; ++r < i; ) {
    var a = e[r],
      o = t(a);
    if (o != null && (s === void 0 ? o === o && !g(o) : n(o, s)))
      var s = o,
        c = a;
  }
  return c;
...
function M(e) {
  return e && e.length ? j(e, p, Ce) : void 0;
}
function N(e) {
  return e && e.length ? j(e, p, we) : void 0;
}
function P(e, t) {
  return e && e.length ? j(e, v(t, 2), we) : void 0;
}
function Te(e, t) {
  var n = e.length;
...
var ke = ae(`length`),
  ...
  ze = Pe + `?`,
  Be = `[` + Me + `]?`,
  Ve = `(?:` + Re + `(?:` + [Fe, Ie, Le].join(`|`) + `)` + Be + ze + `)*`,
  He = Be + ze + Ve,
  Ue = `(?:` + [Fe + F + `?`, F, Ie, Le, Ne].join(`|`) + `)`,
  We = RegExp(I + `(?=` + I + `)|` + Ue + He, `g`);
function Ge(e) {
  for (var t = (We.lastIndex = 0); We.test(e); ) ++t;
  return t;
}
function Ke(e) {
  return ge(e) ? Ge(e) : ke(e);
}
function qe(e, t) {
  return de(e, t, function (t, n) {
    return ie(e, n);
  });
}
var L = me(function (e, t) {
    return e == null ? {} : qe(e, t);
  }),
  Je = Math.ceil,
  Ye = Math.max;
function Xe(e, t, n, r) {
  for (var i = -1, a = Ye(Je((t - e) / (n || 1)), 0), o = Array(a); a--; )
    ((o[r ? a : ++i] = e), (e += n));
  return o;
}
function Ze(t) {
  return function (n, r, i) {
    return (
      i && typeof i != `number` && e(n, r, i) && (r = i = void 0),
      (n = C(n)),
      r === void 0 ? ((r = n), (n = 0)) : (r = C(r)),
      (i = i === void 0 ? (n < r ? 1 : -1) : C(i)),
      Xe(n, r, i, t)
    );
  };
}
...
function et(e) {
  if (e == null) return 0;
  if (f(e)) return le(e) ? Ke(e) : e.length;
  var t = pe(e);
  return t == Qe || t == $e ? e.size : fe(e).length;
}
var z = n(function (t, n) {
    if (t == null) return [];
    var r = n.length;
    return (
      r > 1 && e(t, n[0], n[1])
        ? (n = [])
        : r > 2 && e(n[0], n[1], n[2]) && (n = [n[0]]),
      Oe(t, te(n, 1), [])
    );
  }),
  tt = 0;
...
var it = class {
  ...
  dequeue() {
    var e = this._sentinel,
      t = e._prev;
    if (t !== e) return (at(t), t);
  }
  enqueue(e) {
    var t = this._sentinel;
    (e._prev && e._next && at(e),
      (e._next = t._next),
      (t._next._prev = e),
      (t._next = e),
      (e._prev = t));
  ...
  toString() {
    for (var e = [], t = this._sentinel, n = t._prev; n !== t; )
      (e.push(JSON.stringify(n, ot)), (n = n._prev));
    return `[` + e.join(`, `) + `]`;
  }
};
function at(e) {
...
function ct(e, t) {
  ...
  var n = ut(e, t || st);
  return T(
    w(lt(n.graph, n.buckets, n.zeroIdx), function (t) {
...
function V(e, t, n, r, i) {
  ...
  return (
    S(e.inEdges(r.v), function (r) {
      var o = e.edge(r),
        s = e.node(r.v);
      (i && a.push({ v: r.v, w: r.w }), (s.out -= o), H(t, n, s));
    }),
...
function dt(e) {
  S(e.graph().acyclicer === `greedy` ? ct(e, t(e)) : ft(e), function (t) {
    var n = e.edge(t);
    (e.removeEdge(t),
      (n.forwardName = t.name),
      (n.reversed = !0),
      e.setEdge(t.w, t.v, n, B(`rev`)));
  });
  function t(e) {
    return function (t) {
  ...
  function t(n) {
    ...
    if (
      ...
      for (var a = i.minRank, o = i.maxRank + 1; a < o; ++a)
        (Tt(e, `borderLeft`, `_bl`, n, i, a),
          Tt(e, `borderRight`, `_br`, n, i, a));
    }
  }
  S(e.children(), t);
}
...
function At(e) {
  (S(e.nodes(), function (t) {
    ...
    S(e.edges(), function (t) {
      var n = e.edge(t);
      (S(n.points, G), Object.prototype.hasOwnProperty.call(n, `y`) && G(n));
    }));
}
function G(e) {
  e.y = -e.y;
...
function jt(e) {
  (S(e.nodes(), function (t) {
    ...
    S(e.edges(), function (t) {
      var n = e.edge(t);
      (S(n.points, K), Object.prototype.hasOwnProperty.call(n, `x`) && K(n));
    }));
}
function K(e) {
  var t = e.x;
...
function Ft(e) {
  var t = new k({ directed: !1 }),
    n = e.nodes()[0],
    r = e.nodeCount();
  t.setNode(n, {});
  for (var i, a; It(t, e) < r; )
    ((i = Lt(t, e)), (a = t.hasNode(i.v) ? J(e, i) : -J(e, i)), Rt(t, e, a));
  return t;
}
function It(e, t) {
  function n(r) {
...
function Lt(e, t) {
  return P(t.edges(), function (n) {
    if (e.hasNode(n.v) !== e.hasNode(n.w)) return J(t, n);
  });
}
function Rt(e, t, n) {
  S(e.nodes(), function (e) {
...
(a(1), a(1), (zt.CycleException = Y));
function zt(e) {
  var t = {},
    n = {},
    r = [];
  function i(a) {
    if (Object.prototype.hasOwnProperty.call(n, a)) throw new Y();
  ...
  if ((S(e.sinks(), i), et(t) !== e.nodeCount())) throw new Y();
  return r;
}
function Y() {}
Y.prototype = Error();
...
function X(e) {
  ...
  var t = Ft(e);
  (Q(t), Z(t, e));
  for (var n, r; (n = qt(t)); ) ((r = Jt(t, e, n)), Yt(t, e, n, r));
}
function Z(e, t) {
  var n = Ht(e, e.nodes());
...
function Q(e, t) {
  (arguments.length < 2 && (t = e.nodes()[0]), Kt(e, {}, 1, t));
}
function Kt(e, t, n, r, i) {
  ...
  return (
    ...
    S(e.neighbors(r), function (i) {
      Object.prototype.hasOwnProperty.call(t, i) || (n = Kt(e, t, n, i, r));
    }),
    (o.low = a),
    (o.lim = n++),
  ...
  return (
    ...
    P(
      _(t.edges(), function (t) {
        return c === Qt(e, e.node(t.v), s) && c !== Qt(e, e.node(t.w), s);
      }),
      function (e) {
        return J(t, e);
      },
...
function Yt(e, t, n, r) {
  var i = n.v,
    a = n.w;
  (e.removeEdge(i, a), e.setEdge(r.v, r.w, {}), Q(e), Z(e, t), Xt(e, t));
}
function Xt(e, t) {
  var n = Ut(
    e,
...
function dn(e) {
  for (var t; e.hasNode((t = B(`_root`))); );
  return t;
}
function fn(e, t) {
  for (var n = 0, r = 1; r < t.length; ++r) n += pn(e, t[r - 1], t[r]);
  return n;
}
function pn(e, t, n) {
  for (
...
function mn(e) {
  ...
  function i(n) {
    ue(t, n) || ((t[n] = !0), r[e.node(n).rank].push(n), S(e.successors(n), i));
  }
  return (
    S(
      z(n, function (t) {
...
function gn(e, t) {
  ...
  return (
    S(e, function (e, t) {
      ...
      x(e.barycenter) || ((r.barycenter = e.barycenter), (r.weight = e.weight));
    }),
    S(t.edges(), function (e) {
      var t = n[e.v],
        r = n[e.w];
      !x(t) && !x(r) && (r.indegree++, t.out.push(n[e.w]));
    }),
    _n(
      _(n, function (e) {
        return !e.indegree;
...
function _n(e) {
  ...
  function n(e) {
    return function (t) {
      t.merged ||
        ((x(t.barycenter) || x(e.barycenter) || t.barycenter >= e.barycenter) &&
          vn(e, t));
    };
  }
  function r(t) {
  ...
  for (; e.length; ) {
    var i = e.pop();
    (t.push(i), S(i.in.reverse(), n(i)), S(i.out, r(i)));
  }
  return w(
    _(t, function (e) {
      return !e.merged;
    ...
    function (e) {
      return L(e, [`vs`, `i`, `barycenter`, `weight`]);
    },
  );
}
function vn(e, t) {
...
function Sn(e, t, n, r) {
  ...
  S(l, function (t) {
    if (e.children(t.v).length) {
      var i = Sn(e, t.v, n, r);
      ((c[t.v] = i),
        Object.prototype.hasOwnProperty.call(i, `barycenter`) && wn(t, i));
    }
  });
  var u = gn(l, n);
  Cn(u, c);
  var d = yn(u, r);
  if (o && ((d.vs = T([o, d.vs, s])), e.predecessors(o).length)) {
...
function Tn(e) {
  var t = bt(e),
    n = En(e, R(1, t + 1), `inEdges`),
    r = En(e, R(t - 1, -1, -1), `outEdges`),
    i = mn(e);
  On(e, i);
  for (var a = 1 / 0, o, s = 0, c = 0; c < 4; ++s, ++c) {
    (Dn(s % 2 ? n : r, s % 4 >= 2), (i = W(e)));
    var l = fn(e, i);
    l < a && ((c = 0), (o = ye(i)), (a = l));
  }
  On(e, o);
  ...
  function r(t, r) {
    ...
    return (
      S(r, function (t, c) {
        ...
        (l || t === s) &&
          (S(r.slice(a, c + 1), function (t) {
            S(e.predecessors(t), function (r) {
              var a = e.node(r),
                o = a.order;
              (o < i || u < o) && !(a.dummy && e.node(t).dummy) && Fn(n, r, t);
            });
          }),
          (a = c + 1),
          (i = u));
      ...
      ((s = t[r]),
        e.node(s).dummy &&
          S(e.predecessors(s), function (t) {
            var r = e.node(t);
            r.dummy && (r.order < a || r.order > o) && Fn(n, t, s);
          }));
    });
  }
  function i(t, n) {
...
function Pn(e, t) {
  if (e.node(t).dummy)
    return E(e.predecessors(t), function (t) {
...
function Jn(e, t) {
  var n = t && t.debugTiming ? St : Ct;
  n(`layout`, () => {
    var t = n(`  buildLayoutGraph`, () => ar(e));
    (n(`  runLayout`, () => Yn(t, n)), n(`  updateInputGraph`, () => Xn(e, t)));
  });
}
function Yn(e, t) {
  (t(`    makeSpaceForEdgeLabels`, () => or(e)),
    t(`    removeSelfEdges`, () => hr(e)),
    t(`    acyclic`, () => dt(e)),
    t(`    nestingGraph.run`, () => rn(e)),
    t(`    rank`, () => $t(ht(e))),
    t(`    injectEdgeLabelProxies`, () => sr(e)),
    t(`    removeEmptyRanks`, () => vt(e)),
    t(`    nestingGraph.cleanup`, () => cn(e)),
    t(`    normalizeRanks`, () => _t(e)),
    t(`    assignRankMinMax`, () => cr(e)),
    t(`    removeEdgeLabelProxies`, () => lr(e)),
    t(`    normalize.run`, () => Mt(e)),
    t(`    parentDummyChains`, () => kn(e)),
    t(`    addBorderSegments`, () => wt(e)),
    t(`    order`, () => Tn(e)),
    t(`    insertSelfEdges`, () => gr(e)),
    t(`    adjustCoordinateSystem`, () => Et(e)),
    t(`    position`, () => Kn(e)),
    t(`    positionSelfEdges`, () => _r(e)),
    t(`    removeBorderNodes`, () => mr(e)),
    t(`    normalize.undo`, () => Pt(e)),
    t(`    fixupEdgeLabelCoords`, () => fr(e)),
    t(`    undoCoordinateSystem`, () => Dt(e)),
    t(`    translateGraph`, () => ur(e)),
    t(`    assignNodeIntersects`, () => dr(e)),
    t(`    reversePoints`, () => pr(e)),
    t(`    acyclic.undo`, () => pt(e)));
}
function Xn(e, t) {
  (S(e.nodes(), function (n) {
...
var Zn = [`nodesep`, `edgesep`, `ranksep`, `marginx`, `marginy`],
  Qn = { ranksep: 50, edgesep: 20, nodesep: 50, rankdir: `tb` },
  $n = [`acyclicer`, `ranker`, `rankdir`, `align`],
  er = [`width`, `height`],
  tr = { width: 0, height: 0 },
  nr = [`minlen`, `weight`, `width`, `height`, `labeloffset`],
  rr = {
    minlen: 1,
    weight: 1,
    width: 0,
  ...
  ir = [`labelpos`];
function ar(e) {
  var t = new k({ multigraph: !0, compound: !0 }),
    n = vr(e.graph());
  return (
    t.setGraph(O({}, Qn, $(n, Zn), L(n, $n))),
    S(e.nodes(), function (n) {
      var r = vr(e.node(n));
      (t.setNode(n, ce($(r, er), tr)), t.setParent(n, e.parent(n)));
    }),
    S(e.edges(), function (n) {
      var r = vr(e.edge(n));
      t.setEdge(n, O({}, rr, $(r, nr), L(r, ir)));
    }),
    t
  );
}
...
function dr(e) {
  S(e.edges(), function (t) {
    ...
    (n.points
      ...
      : ((n.points = []), (a = i), (o = r)),
      n.points.unshift(gt(r, a)),
      n.points.push(gt(i, o)));
  });
}
function fr(e) {
  S(e.edges(), function (t) {
  ...
  (S(e.nodes(), function (t) {
    if (e.children(t).length) {
      var n = e.node(t),
        ...
        a = e.node(D(n.borderLeft)),
        o = e.node(D(n.borderRight));
...
export { Jn as t };
//# sourceMappingURL=dagre-BLI2y0OU.js.map
