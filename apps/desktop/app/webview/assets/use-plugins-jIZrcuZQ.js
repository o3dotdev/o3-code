...
import { o as ae } from "./statsig--EYRNU53.js";
import { t as oe } from "./invalidate-queries-and-broadcast-BXgBlyBv.js";
import { u as se } from "./thread-context-inputs-DBrOekVr.js";
  ...
  try {
    let e = { path: r, hostId: t },
      i = await n.fetchQuery({
        queryFn: ({ signal: t }) =>
          ie(`read-file-binary`, { params: e, signal: t }),
...
var me = _(),
  ...
  M = new Set([`codex-official`, o, t, s, `openai-primary-runtime`].map(Y));
function N(e) {
  return {
    ...je(e.summary),
...
function V(e, n, r) {
  let i = (0, me.c)(54),
    a;
  i[0] === e ? (a = i[1]) : ((a = { hostId: e }), (i[0] = e), (i[1] = a));
  let o = fe(a) && (r?.enabled ?? !0),
    s = r?.additionalMarketplaceKinds ?? O,
    c = r?.installSuggestionPluginNames ?? null,
    l = ae(`4218407052`),
    u = be({
      additionalMarketplaceKinds: s,
      includeRemoteCatalog: r?.includeRemoteCatalog ?? !0,
      includeVerticalCatalog: !l,
    }),
    d = oe(),
    p = te(),
    m = re(se),
    ...
    _;
  i[2] !== e || i[3] !== g
    ? ((_ = g.includes(e)), (i[2] = e), (i[3] = g), (i[4] = _))
    : (_ = i[4]);
  let v = _,
    y = o && v,
    b;
  i[5] !== e || i[6] !== y
    ? ((b = { enabled: y, hostId: e }), (i[5] = e), (i[6] = y), (i[7] = b))
    : (b = i[7]);
  let x = le(b),
    S;
  i[8] === e ? (S = i[9]) : ((S = { hostId: e }), (i[8] = e), (i[9] = S));
  let C = ue(S),
    w;
  i[10] === e ? (w = i[11]) : ((w = { hostId: e }), (i[10] = e), (i[11] = w));
  let E = de(w),
    A = n === void 0,
    j = Ae({
      codexHome: ie,
    ...
    M = o && v && (n !== void 0 || m.isFetched),
    N;
  i[12] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((N = pe()), (i[12] = N))
    : (N = i[12]);
  let P = N,
    F = c == null ? xe(e, j, u, l) : ye(e, j, O, c, l),
    I;
  i[13] !== P ||
  i[14] !== e ||
  i[15] !== c ||
    ...
    ? ((I = async () => {
        ...
        if (c != null) {
          let t = await f(`send-cli-request-for-host`, {
              ...
              params: {
                ...(j.length > 0 ? { cwds: j } : {}),
                installSuggestionPluginNames: c,
              },
            }),
            r = Se(t.marketplaces, n),
            i = $(r);
          return {
            featuredPluginIds: D,
            marketplaceLoadErrors: t.marketplaceLoadErrors,
            marketplaces: Oe(r),
            plugins: await ke({ hostId: e, plugins: i, queryClient: p }),
          };
        }
        let r = await f(
            `list-plugins`,
            u == null
              ? { hostId: e, ...(j.length > 0 ? { cwds: j } : {}) }
              : {
                  hostId: e,
                  ...(j.length > 0 ? { cwds: j } : {}),
                  marketplaceKinds: u,
          ...
          i = Se(r.marketplaces, n),
          a = $(i),
          o = P == null ? a : De({ buildFlavor: P, plugins: a }),
          s =
            n == null
              ? r.featuredPluginIds
              : r.featuredPluginIds.filter((e) => !e.endsWith(`@${n}`));
        return {
          featuredPluginIds:
            P == null ? s : Ee({ buildFlavor: P, featuredPluginIds: s }),
          marketplaceLoadErrors: r.marketplaceLoadErrors,
          marketplaces: Oe(i),
          plugins: await ke({ hostId: e, plugins: o, queryClient: p }),
        };
      }),
      (i[13] = P),
      (i[14] = e),
  ...
  i[33] !== R.data?.plugins
    ? ((V = {
      ...
      (H = R.data?.plugins ?? k),
      (U = we({ plugins: H, ...V })),
      (W = Ce({ featuredPluginIds: R.data?.featuredPluginIds ?? D, ...V })),
      (i[29] = x.available),
      (i[30] = E.available),
      (i[31] = C.available),
      (i[32] = R.data?.featuredPluginIds),
      ...
      (i[36] = U),
      (i[37] = W))
    : ((V = i[34]), (H = i[35]), (U = i[36]), (W = i[37]));
  let G;
  i[38] === H ? (G = i[39]) : ((G = Te(H)), (i[38] = H), (i[39] = G));
  let K = R.data?.marketplaceLoadErrors ?? he,
    q = R.data?.marketplaces ?? ge,
    J = R.error ? String(R.error.message) : null,
    Y =
      (A && m.isLoading) ||
      R.isLoading ||
      C.isLoading ||
      E.isLoading ||
      x.isLoading,
    X = (A && m.isFetching) || R.isFetching || x.isFetching,
    Z;
  i[40] !== V || i[41] !== R
    ? ((Z = async () => {
        let e = (await R.refetch()).data?.plugins ?? k;
        return {
          availablePlugins: we({ plugins: e, ...V }),
          installedPlugins: Te(e),
        };
      }),
      (i[40] = V),
      (i[41] = R),
...
function H(e) {
  ...
  t[2] !== r || t[3] !== i
    ? ((c = [...T, `marketplace-kind`, r, i]),
      (l = async () =>
        $(
          (await f(`list-plugins`, { hostId: r, marketplaceKinds: [i] }))
            .marketplaces,
        )),
      (t[2] = r),
      (t[3] = i),
...
function ye(e, t, n = O, r = null, i = !1) {
  return r == null
    ? xe(
        e,
        t,
    ...
    : [...T, e, t, `installed`, r, `curated-marketplace`, U(i)];
}
function be({
...
function xe(e, t, n, r) {
  let i = U(r);
  return n == null
    ? [...T, e, t, `curated-marketplace`, i]
    : [...T, e, t, `marketplace-kinds`, n, `curated-marketplace`, i];
}
function U(e) {
  return e ? s : t;
}
function Se(e, t) {
  return t == null ? e : e.filter((e) => e.name !== t);
}
function Ce({ featuredPluginIds: e, ...t }) {
  return e.filter((e) => W(e, t));
}
function we({ plugins: e, ...t }) {
  return e.filter((e) => W(e.plugin.id, t));
}
function Te(e) {
...
function Ee({ buildFlavor: e, featuredPluginIds: t }) {
  let n = u(e);
  return t.filter((e) => {
    let t = c(e);
    return t == null ? !0 : !l(t) || t === n;
  });
}
function De({ buildFlavor: e, plugins: t }) {
  let n = u(e);
  return t.filter((e) => !l(e.marketplaceName) || e.marketplaceName === n);
}
function Y(e) {
  return e
    .trim()
...
function Ae({
  ...
  let i = t === `local` && e != null ? p(e, j) : null;
  return Z(
    [
...
function Z(e, t) {
  return Array.from(
    new Set(e.map((e) => e.trim()).filter((e) => d(e) && Q(e, t))),
  );
}
function Q(e, t) {
  return t == null
...
//# sourceMappingURL=use-plugins-jIZrcuZQ.js.map
