...
import { h as e, p as t, r as n } from "./chunk-S3R3BYOJ.js";
import "./main.js";
...
import { t as _ } from "./chunk-4BX2VUAB-g.js";
import { t as te } from "./mermaid-parser.core-p5FsnjRv.js";
import { t as ne } from "./chunk-QZHKN3VN-Dn4wC5X9.js";
var v = { NORMAL: 0, REVERSE: 1, HIGHLIGHT: 2, MERGE: 3, CHERRY_PICK: 4 },
  re = ee.gitGraph,
  y = i(() => n({ ...re, ...h().gitGraph }), `getConfig`),
  b = new ne(() => {
    let e = y(),
      t = e.mainBranchName,
      n = e.mainBranchOrder;
...
var ie = i(function (e) {
  ...
  ae = i(function (e) {
    (a.debug(`options str`, e), (e = e?.trim()), (e ||= `{}`));
    try {
      b.records.options = JSON.parse(e);
    } catch (e) {
      a.error(`error while parsing gitGraph options`, e.message);
    }
  }, `setOptions`),
  oe = i(function () {
  ...
  se = i(function (e) {
    let t = e.msg,
      ...
      r = e.type,
      i = e.tags;
    (a.info(`commit`, t, n, r, i), a.debug(`Entering commit:`, t, n, r, i));
    let o = y();
    ((n = p.sanitizeText(n, o)),
      (t = p.sanitizeText(t, o)),
      (i = i?.map((e) => p.sanitizeText(e, o))));
    let s = {
      id: n || b.records.seq + `-` + x(),
      message: t,
      seq: b.records.seq++,
      type: r ?? v.NORMAL,
      tags: i ?? [],
    ...
    ((b.records.head = s),
      a.info(`main branch`, o.mainBranchName),
      b.records.commits.has(s.id) && a.warn(`Commit ID ${s.id} already exists`),
      b.records.commits.set(s.id, s),
      b.records.branches.set(b.records.currBranch, s.id),
      a.debug(`in pushCommit ` + s.id));
  }, `commit`),
  ce = i(function (e) {
    let t = e.name,
      n = e.order;
    if (((t = p.sanitizeText(t, y())), b.records.branches.has(t)))
      throw Error(
    ...
    (b.records.branches.set(
      ...
      b.records.branchConfig.set(t, { name: t, order: n }),
      C(t),
      a.debug(`in createBranch`));
  }, `branch`),
  le = i((e) => {
    let t = e.branch,
      n = e.id,
    ...
    let d = c || ``,
      f = {
        id: n || `${b.records.seq}-${x()}`,
        message: `merged branch ${t} into ${b.records.currBranch}`,
        seq: b.records.seq++,
        parents: b.records.head == null ? [] : [b.records.head.id, d],
        branch: b.records.currBranch,
        type: v.MERGE,
        customType: r,
        customId: !!n,
    ...
    ((b.records.head = f),
      b.records.commits.set(f.id, f),
      b.records.branches.set(b.records.currBranch, f.id),
      a.debug(b.records.branches),
      a.debug(`in mergeBranch`));
  }, `merge`),
  ue = i(function (e) {
    let t = e.id,
      n = e.targetId,
      r = e.tags,
      i = e.parent;
    a.debug(`Entering cherryPick:`, t, n, r);
    let o = y();
    if (
      ((t = p.sanitizeText(t, o)),
      (n = p.sanitizeText(n, o)),
      (r = r?.map((e) => p.sanitizeText(e, o))),
      (i = p.sanitizeText(i, o)),
      !t || !b.records.commits.has(t))
    ) {
      let e = Error(
    ...
    if (!n || !b.records.commits.has(n)) {
      ...
      let e = b.records.branches.get(b.records.currBranch);
      if (e === void 0 || !e) {
        let e = Error(
      ...
      let l = {
        ...
        tags: r
          ? r.filter(Boolean)
          : [`cherry-pick:${s.id}${s.type === v.MERGE ? `|parent:${i}` : ``}`],
      };
      ((b.records.head = l),
        b.records.commits.set(l.id, l),
        b.records.branches.set(b.records.currBranch, l.id),
        a.debug(b.records.branches),
        a.debug(`in cherryPick`));
    }
  }, `cherryPick`),
  C = i(function (e) {
    if (((e = p.sanitizeText(e, y())), b.records.branches.has(e))) {
...
function T(e) {
  ...
  for (let e in b.records.branches)
    b.records.branches.get(e) === t.id && r.push(e);
  if (
    (a.debug(r.join(` `)),
    t.parents && t.parents.length == 2 && t.parents[0] && t.parents[1])
  ) {
    let n = b.records.commits.get(t.parents[0]);
    (w(e, t, n), t.parents[1] && e.push(b.records.commits.get(t.parents[1])));
...
i(T, `prettyPrintCommitHistory`);
var de = i(function () {
    a.debug(b.records.commits);
    let e = E()[0];
    T([e]);
  }, `prettyPrint`),
  fe = i(function () {
  ...
  E = i(function () {
    let e = [...b.records.commits.values()];
    return (
      e.forEach(function (e) {
        a.debug(e.id);
      }),
  ...
  k = i((e, t) => {
    let n = {
      Commit: i((e) => t.commit(A(e)), `Commit`),
      Branch: i((e) => t.branch(j(e)), `Branch`),
      Merge: i((e) => t.merge(M(e)), `Merge`),
      Checkout: i((e) => t.checkout(N(e)), `Checkout`),
      CherryPicking: i((e) => t.cherryPick(P(e)), `CherryPicking`),
    }[e.$type];
    n ? n(e) : a.error(`Unknown statement type: ${e.$type}`);
  }, `parseStatement`),
  A = i(
    (e) => ({
      id: e.id,
  ...
  j = i((e) => ({ name: e.name, order: e.order ?? 0 }), `parseBranch`),
  M = i(
    (e) => ({
      branch: e.branch,
      id: e.id ?? ``,
  ...
  X = i((e) => {
    ...
    return (
      ...
      e.forEach((e) => {
        let i = J === `TB` || J == `BT` ? U.get(e)?.y : U.get(e)?.x;
  ...
  be = i((e) => ye(e) + R, `calculateCommitPosition`),
  xe = i((e, t) => {
  ...
  Z = i((e, t, n) => {
    ...
    let r = e.append(`g`).attr(`class`, `commit-bullets`),
    ...
    (J === `BT` && (c && ve(u, t, o), (u = u.reverse())),
      u.forEach((e) => {
        ...
        if (n) {
          ...
          (Ce(r, i, s, e, H.get(i.branch)?.index ?? 0, t),
            we(a, i, s, o),
            Te(a, i, s, o));
        }
        (J === `TB` || J === `BT`
          ? U.set(i.id, { x: s.x, y: s.posWithOffset })
          : U.set(i.id, { x: s.posWithOffset, y: s.y }),
          (o = J === `BT` && c ? o + R : o + R + L),
          o > q && (q = o));
      }));
  }, `drawCommits`),
  Q = i((e, t, n, r, a) => {
    let o = (J === `TB` || J === `BT` ? n.x < r.x : n.y < r.y)
        ? t.branch
        : e.branch,
...
`,
        ...
        (u.forEach((e, t) => {
          ...
          let o = n.getBBox();
          ((f = Me(e.name, f, t, o, s)), a.remove(), i.remove(), r.remove());
        }),
          Z(d, G, !1),
          I.showBranches && je(d, u),
          Ae(d, G),
          Z(d, G, !0),
          e.insertTitle(
            d,
          ...
          c(void 0, d, I.diagramPadding, I.useMaxWidth));
      }, `draw`),
    },
    styles: i(
      (e) => `
...
//# sourceMappingURL=gitGraphDiagram-NY62KEGX-CmaMgRyS.js.map
