...
import { a as de, wt as fe } from "./setting-storage.js";
import { t as pe } from "./use-is-dark-BHkhnHe-.js";
import {
  D as me,
  T as he,
  _ as ge,
...
import { n as Te, r as Ee } from "./use-resolved-theme-variant.js";
var De = class {
...
function K(e) {
  return B({
    tagName: `div`,
    children: [
      B({ tagName: `span`, children: [O(`No newline at end of file`)] }),
    ],
    properties: {
      "data-no-newline": ``,
      "data-line-type": e,
...
function J({
  ...
  return (
    e === `custom` &&
      i != null &&
      c.push(B({ tagName: `slot`, properties: { name: i } })),
    B({
      tagName: `div`,
      children: c,
      properties: {
  ...
  Me = class {
    ...
    constructor(e = { theme: W }, t, n) {
      ((this.options = e),
        ...
        n?.isWorkingPool() !== !0 &&
          (this.highlighter = V(e.theme ?? W) ? S() : void 0));
    }
    cleanUp() {
    ...
    processDiffResult(e, t, { code: n, themeStyles: r, baseThemeType: i }) {
      ...
      function S(e) {
        (b.flush(),
          a === `unified`
            ? Y(`unified`, e, v)
            : (Y(`deletions`, e, v), Y(`additions`, e, v)));
      }
      (C({
        diff: e,
        diffStyle: a,
            ...
            if (m) {
              let e =
                c === `context` || c === `context-expanded`
                  ...
                  : `change-deletion`;
              a === `unified`
                ? (v.unifiedContentAST.push(K(e)),
                  v.pushToGutter(`unified`, H(e, `metadata`, 1)))
  ...
  if (e === `unified`) {
    if (
      ...
      (c.unifiedContentAST.push(s(i)),
        c.pushToGutter(`unified`, H(e, `annotation`, 1)),
        (l = !0));
    }
  } else if (e === `split`) {
    if (
...
function Y(
  ...
  if (c.hunkSeparators === `metadata`) {
    i != null &&
      (c.pushToGutter(
        e,
        J({ type: `metadata`, content: i, isFirstHunk: a, isLastHunk: o }),
      ),
      l.push(
        J({ type: `metadata`, content: i, isFirstHunk: a, isLastHunk: o }),
      ),
    ...
    hydrationSetup({
      ...
      ((this.lineAnnotations = r ?? this.lineAnnotations),
        ...
        (this.fileDiff =
          e ??
          (t != null && n != null
            ? Z(t, n, this.options.parseDiffOptions)
            : void 0)),
        this.pre != null &&
...
function Je(e, t) {
  ...
  if (n != null)
    return { hunkIndex: e.hunkIndex, lineIndex: Ye(n, e.startContentIndex) };
}
function Ye(e, t) {
...
var Qe = -1,
  $e = class extends Ve {
    ...
    constructor(e, t, n, r, i = !1) {
      ...
      ((this.virtualizer = t),
        (this.metrics = Xe(typeof a == `function` ? `custom` : a, n)));
    }
    getLineHeight(e, t = !1) {
    ...
    children: [
      p == null
        ? (0, Q.jsxs)(Q.Fragment, {
            children: [
              m != null &&
                (0, Q.jsx)(`div`, { slot: `header-prefix`, children: m }),
              h != null &&
                (0, Q.jsx)(`div`, { slot: `header-metadata`, children: h }),
            ],
          })
        : (0, Q.jsx)(`div`, { slot: ve, children: p }),
      a != null &&
        l?.map((e, t) => (0, Q.jsx)(`div`, { slot: g(e), children: a(e) }, t)),
      t != null &&
        c != null &&
        d != null &&
        t.map((t) => {
...
function at({
  ...
  return (
    ...
    {
      ref: f,
      getHoveredLine: (0, $.useCallback)(() => d.current?.getHoveredLine(), []),
    }
  );
}
function ot({ options: e, hasCustomHeader: t, hasGutterRenderUtility: n }) {
  return n || t
    ? {
        ...e,
        renderCustomHeader: t ? j : void 0,
        renderGutterUtility: n ? j : void 0,
      }
    : e;
}
function st({
...
function ut(e) {
  ...
  let g = p === void 0 ? `line-info` : p,
    ...
    v = (0, $.useRef)(null),
    y = Ee(Te()),
    b = de(t.lightCodeThemeId),
    x = de(t.darkCodeThemeId),
    S = de(t.diffMarkerStyle);
  pe();
  let C = S === `symbols`,
    w;
  ...
  n[20] === o
    ? (O = n[21])
    : ((O = o == null ? null : (0, Q.jsx)(dt, { lineDiffType: o })),
      (n[20] = o),
      (n[21] = O));
  let k = st,
    A = y,
...
//# sourceMappingURL=file-diff-DOHfgomY.js.map
