...
import { Cn as t, Tn as n, di as r, gi as i } from "./src-DAzAmbVS.js";
import { Ca as a, ts as o } from "./app-server-manager-signals-Csopz8aM.js";
...
import { f as b, u as x } from "./chunk-LFPYN7LY-CkfOxD5s.js";
...
import { l as S, o as C } from "./statsig-CpJRDK88.js";
import { t as w } from "./app-server-manager-hooks-ZyucQ4vj.js";
import "./use-global-state-DjfvqpEA.js";
import "./invalidate-queries-and-broadcast-CcloHaCj.js";
import { t as T } from "./thread-context-inputs-DcllWVDq.js";
import {
  c as E,
  d as D,
  f as O,
...
import { r as oe } from "./toast-signal-Dfdpi-kK.js";
...
import { t as se } from "./button-bq66r8jD.js";
import "./reduced-motion-preference-CcGC6Z5k.js";
import "./spinner-D37df5tU.js";
import { t as ce } from "./use-codex-home-xcun36ZB.js";
import "./use-os-info-DRsIehae.js";
import { t as le } from "./link-external-GLfZmEQP.js";
import { r as j, t as M } from "./open-config-toml-button-CHT8XCrZ.js";
import { t as N } from "./open-workspace-file-DFjZ10XZ.js";
import "./send-open-file-request-CJ2nkcce.js";
import "./mime-types-BO2aPrWZ.js";
import "./proxy-HwxlKevX.js";
import "./apps-RXjrknWx.js";
import { t as ue } from "./x-DMqExXY8.js";
import "./use-platform-ByMJlQVq.js";
import { n as P, r as de } from "./experimental-features-queries-CTmahqSy.js";
...
import { t as fe } from "./download-Cf0FyA1Y.js";
import { t as F } from "./with-window-C7Mmo_xd.js";
...
import { r as L, t as he } from "./dropdown-PBHuhi3M.js";
import "./globe-D1xFoTfu.js";
import "./chevron-CEHg0DRl.js";
import "./folder-DnqvPFV1.js";
import { t as ge } from "./warning-Cmz-KXha.js";
import { n as R } from "./markdown-Pq7xh_0E.js";
...
import { t as _e } from "./alert-CbWF3t74.js";
import "./sortBy-Dqo8FD7r.js";
import "./use-connected-remote-connections-BjxI1Jtl.js";
import { t as ve } from "./toggle-Ray5d_Lx.js";
import { i as z, t as ye } from "./settings-shared-B5KlTTu7.js";
import "./settings-host-selection-9fosNT9W.js";
import { t as be } from "./settings-host-context-B5kZhSF6.js";
import { t as xe } from "./settings-content-layout-Bnulb0lM.js";
import { i as B, t as Se } from "./primary-runtime-install-action-3_5zhnuK.js";
import {
  a as Ce,
  i as we,
  n as Te,
  r as Ee,
} from "./primary-runtime-install-state-BBsLAHo7.js";
import { t as V } from "./alert-D2AtlyXd.js";
import { n as H } from "./settings-row-DYYQqFuu.js";
import { t as De } from "./settings-surface-YwAy0P94.js";
import { t as Oe } from "./arrow-top-right-DAJEunDk.js";
import { t as U } from "./settings-group-DNhpghsa.js";
import {
  n as ke,
  t as Ae,
} from "./primary-runtime-install-status-message-Me_Vjs9K.js";
import { t as W } from "./lock-nKsRyd28.js";
var je = y(),
  G = e(s(), 1);
async function Me({ filePath: e, keyPath: t, value: n }) {
  let r = K(t, n);
  if (r == null)
    throw Error(`Unsupported config key for project config write.`);
  await Ne({ filePath: e, field: r });
}
async function Ne({ filePath: e, field: t }) {
  let n = ``;
  try {
    n = (await m(`read-file`, { params: { path: e } })).contents;
  } catch (e) {
    if (!Fe(e)) throw Error(`Failed to read project config.`);
  }
  let r = q(n, t.name, t.value);
  if (r !== n)
    try {
      await m(`local-environment-config-save`, {
...
function q(e, t, n) {
  return t === `network_access` ? Pe(e, n === !0) : J(e, t, String(n));
}
function J(e, t, n) {
  let r =
      e.length > 0
...
function Ie(e) {
  ...
  t[7] === y
    ? (b = t[8])
    : ((b = (0, Q.jsx)(U.Header, { title: v, subtitle: y })),
      (t[7] = y),
      (t[8] = b));
  let x = U,
    S = De,
  ...
  t[9] === s
    ...
    : ((C = s
        ? (0, Q.jsx)(H, {
            ...
            control: (0, Q.jsx)(`span`, { className: `h-5 w-8` }),
          })
        : null),
      (t[9] = s),
      (t[10] = C));
  ...
  t[14] !== S || t[15] !== T || t[16] !== C || t[17] !== w
    ...
    : (E = t[18]);
  let D;
  t[19] !== E || t[20] !== x.Content
    ? ((D = (0, Q.jsx)(x.Content, { children: E })),
      (t[19] = E),
      (t[20] = x.Content),
      (t[21] = D))
    : (D = t[21]);
  let O;
  return (
    t[22] !== _ || t[23] !== D || t[24] !== b
      ? ((O = (0, Q.jsxs)(_, { children: [b, D] })),
        (t[22] = _),
        (t[23] = D),
        (t[24] = b),
        (t[25] = O))
...
var ze = r({ workspaceRoot: i().min(1).nullable().optional() }).passthrough();
function Be(e) {
...
function Ue() {
  ...
  e[13] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((f = (0, Q.jsx)(`span`, { className: `block` })),
      (p = (0, Q.jsx)(l, {
  ...
  e[19] === h
    ...
    : ((_ = (0, Q.jsx)(F, {
        extension: !0,
        children: (0, Q.jsxs)(De, { children: [h, g] }),
      })),
      (e[19] = h),
      (e[20] = _));
  let v;
  e[21] !== _ || e[22] !== u || e[23] !== d
    ? ((v = (0, Q.jsxs)(U, {
        className: `gap-2`,
        children: [ee, (0, Q.jsxs)(U.Content, { children: [u, d, _] })],
      })),
      (e[21] = _),
      (e[22] = u),
      (e[23] = d),
  ...
  e[28] === y
    ? (b = e[29])
    : ((b = (0, Q.jsx)(F, { electron: !0, children: y })),
      (e[28] = y),
      (e[29] = b));
  let x;
  e[30] !== i || e[31] !== n || e[32] !== t
    ? ((x = i && n.kind === `local` ? (0, Q.jsx)(Ge, { hostId: t }) : null),
      (e[30] = i),
      (e[31] = n),
      (e[32] = t),
      (e[33] = x))
  ...
  e[34] === x
    ? (S = e[35])
    : ((S = (0, Q.jsx)(F, { electron: !0, children: x })),
      (e[34] = x),
      (e[35] = S));
  let T;
  return (
    e[36] !== v || e[37] !== b || e[38] !== S
      ? ((T = (0, Q.jsx)(Q.Fragment, {
          children: (0, Q.jsxs)(xe, {
            title: s,
            subtitle: c,
            children: [v, b, S],
          }),
...
function Ge(e) {
  let t = (0, je.c)(87),
    ...
    a = te(),
    o = u(),
    { logEventWithStatsig: s } = S(),
    { data: c, isLoading: m } = ee(P, r),
    y;
  t[0] === r ? (y = t[1]) : ((y = { hostId: r }), (t[0] = r), (t[1] = y));
  let b = de(y),
    x;
  t[2] === c ? (x = t[3]) : ((x = c?.find(Ke)), (t[2] = c), (t[3] = x));
  let C = x,
    w = C?.enabled === !0,
    T;
  t[4] === r ? (T = t[5]) : ((T = { hostId: r }), (t[4] = r), (t[5] = T));
  let E;
  t[6] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((E = { staleTime: p.FIVE_SECONDS }), (t[6] = E))
    : (E = t[6]);
  let D;
  t[7] === T
    ? (D = t[8])
    : ((D = { params: T, queryConfig: E }), (t[7] = T), (t[8] = D));
  let O = g(`diagnose-primary-runtime-dependencies`, D),
    k = h(`diagnose-primary-runtime-dependencies`),
    re = h(`primary-runtime-update-run-now`),
    A = h(`reset-primary-runtime-dependencies`),
    ie;
  t[9] === r
    ? (ie = t[10])
    : ((ie = { mutationFn: () => Ce({ hostId: r }) }),
      (t[9] = r),
      (t[10] = ie));
  let ae = v(ie),
    ce = ne(we),
    le = ne(Ee),
    j = ce?.hostId === r ? ce : null,
    M;
  t[11] === i ? (M = t[12]) : ((M = i.get(oe)), (t[11] = i), (t[12] = M));
  let N = M,
    F =
      m ||
      b.isPending ||
      ...
      ae.isPending,
    pe;
  t[13] === j ? (pe = t[14]) : ((pe = Te(j)), (t[13] = j), (t[14] = pe));
  let I = pe,
    L =
      O.data?.bundleVersion == null || O.data.bundleVersion.length === 0
        ? null
        : O.data.bundleVersion,
    he;
  t[15] !== k ||
  t[16] !== O ||
  t[17] !== r ||
  ...
  t[20] !== N
    ? ((he = () => {
        let e = Date.now();
        k.mutateAsync({ hostId: r })
          .then((t) => {
            if (
              (s(`codex_primary_runtime_dependencies_diagnose`, {
                bundle_version: t.bundleVersion ?? ``,
                duration_ms: Date.now() - e,
                problem_count: t.problems.length,
                status: t.installed ? `ok` : `problem`,
              }),
              O.refetch(),
              t.installed)
            ) {
  ...
  t[30] !== N
    ? ((R = () => {
        let e = Date.now();
        A.mutateAsync({ hostId: r, release: le })
          .then((t) => {
            (s(`codex_primary_runtime_dependencies_reset`, {
              bundle_version: t.bundleVersion ?? ``,
              duration_ms: Date.now() - e,
              status: t.status,
            }),
              Promise.all([
                O.refetch(),
                o.invalidateQueries({
                  queryKey: _(`load-primary-runtime-dependencies`, {
                    hostId: r,
                  }),
                }),
              ]),
  ...
  let _e = R,
    z;
  t[32] !== ae || t[33] !== O || t[34] !== a || t[35] !== i || t[36] !== N
    ? ((z = () => {
        ae.mutateAsync()
          .then((e) => {
            let { canceled: t } = e;
            if ((i.set(we, null), O.refetch(), !t)) {
              N.info(
                a.formatMessage({
  ...
  t[39] === Symbol.for(`react.memo_cache_sentinel`)
    ...
    : (xe = t[39]);
  let B;
  t[40] === O.data?.problems.length
    ? (B = t[41])
    : ((B = O.data?.problems.length
        ? (0, Q.jsx)(l, {
      ...
      (t[41] = B));
  let V;
  t[42] !== L || t[43] !== O.isLoading || t[44] !== I || t[45] !== j
    ? ((V = I
        ? ke(j, Ae(j))
        : O.isLoading
          ? (0, Q.jsx)(l, {
  ...
  let W;
  t[49] !== B || t[50] !== Oe
    ? ((W = (0, Q.jsx)(H, { label: xe, description: B, control: Oe })),
      (t[49] = B),
      (t[50] = Oe),
      (t[51] = W))
    : (W = t[51]);
  ...
  t[52] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((G = (0, Q.jsx)(l, {
      ...
      (t[53] = Me))
    : ((G = t[52]), (Me = t[53]));
  let Ne = m || b.isPending || C == null,
    K;
  t[54] !== le || t[55] !== re || t[56] !== b
    ? ((K = (e) => {
        b.mutate(
          { enabled: e, featureName: n },
          {
            onSuccess: () => {
              e && re.mutate({ release: le });
            },
          },
        );
      }),
  ...
  t[67] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((X = (0, Q.jsx)(me, { className: `icon-2xs` })),
      (Fe = (0, Q.jsx)(l, {
    ...
    : ((X = t[67]), (Fe = t[68]));
  let Z;
  t[69] !== k.isPending || t[70] !== ge || t[71] !== A.isPending
    ? ((Z = (0, Q.jsx)(H, {
        label: Pe,
        description: Y,
        control: (0, Q.jsxs)(se, {
  ...
  t[73] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((Ie = (0, Q.jsx)(l, {
      ...
      (t[74] = Le))
    : ((Ie = t[73]), (Le = t[74]));
  let $ = I ? ae.isPending : A.isPending,
    Re = !w || (I ? ae.isPending : F),
    ze = I ? ye : _e,
    Be;
  t[75] === I
    ? (Be = t[76])
  ...
  let He;
  return (
    t[82] !== W || t[83] !== J || t[84] !== Z || t[85] !== Ve
      ? ((He = (0, Q.jsxs)(U, {
          className: `gap-2`,
          children: [
            be,
            (0, Q.jsx)(U.Content, {
              children: (0, Q.jsxs)(De, { children: [W, J, Z, Ve] }),
            }),
          ],
        })),
        (t[82] = W),
...
function qe({ hostId: e }) {
  let n = te(),
    ...
    y = v.hasValue
      ...
      : e === `local`
        ...
        : null,
    b = ce(e),
    { data: S, isPending: C } = ae(y, {
      hostId: e,
      cwdMode: e === `local` ? `fallback-to-workspace` : `preserve-null`,
    }),
    { data: w, isPending: oe } = ee(E, e),
    le = h(`open-file`),
    j = S?.config ?? null,
    M = S?.layers ?? null,
    ue = S?.origins ?? null,
    P = w?.requirements ?? null,
    de = Ze(M, n),
    fe = M?.find((e) => e.name.type === `user`) ?? null,
    F = M?.find((e) => O(e.name)) ?? null,
    I = b == null ? null : `${b}/config.toml`,
    me = fe == null ? I : D(fe.name),
    R = {
      key: `user`,
      kind: `user`,
      ...
      tooltipText: me ?? `~/.codex/config.toml`,
      filePath: me,
      expectedVersion: fe?.version ?? null,
      workspaceRoot: null,
      layer: fe,
    },
    _e =
    ...
    z = [...de, R, ...(_e == null ? [] : [_e])],
    be = de.length > 0,
    xe = y == null ? (z[0]?.key ?? null) : `project:${y}`,
    B =
      z.find((e) => e.key === a) ?? z.find((e) => e.key === xe) ?? z[0] ?? null,
    { data: Se } = g(`open-in-targets`, {
      params: {
        cwd:
      ...
      queryConfig: { staleTime: p.ONE_MINUTE, enabled: !0 },
    }),
    Ce = et(B?.layer?.config ?? null),
    we = at(j?.approval_policy ?? null) ?? `on-request`,
    Te = j?.sandbox_mode == null ? `read-only` : j.sandbox_mode,
    Ee = Ce.sandboxMode == null && Te === `workspace-write`,
    V = Ce.sandboxMode === `workspace-write` || Ee,
    ke = Ce.approvalPolicy ?? we,
    Ae = Ce.sandboxMode ?? Te,
    W = Ce.networkAccess ?? j?.sandbox_workspace_write?.network_access ?? !1,
    je = ue == null ? null : k(ue, `approval_policy`, [`approvalPolicy`]),
    Ne = ue == null ? null : k(ue, `sandbox_mode`),
    K =
      ue == null ? null : k(ue, `sandbox_workspace_write`, [`network_access`]),
    q = B?.kind === `project` ? (B.layer?.disabledReason ?? null) : null,
    J = tt(B, n),
    Pe = Ve.filter((e) =>
      P?.allowedApprovalPolicies == null ||
      P.allowedApprovalPolicies.length === 0
        ? !0
  ...
  async function X(t, n, r) {
    if (!(B == null || B.filePath == null) && c == null) {
      (d(t), m((e) => ({ ...e, [t]: void 0 })));
      try {
        (B.kind === `project`
          ? await Me({ filePath: B.filePath, keyPath: n, value: r })
          : await o(`write-config-value`, {
              hostId: e,
              keyPath: n,
              value: r,
          ...
          await Promise.all([
            ...
            i.invalidateQueries({ queryKey: [...A, e] }),
            i.invalidateQueries({ queryKey: [...ie, e] }),
          ]));
      } catch (e) {
        m((n) => ({
          ...n,
    ...
    children: [
      (0, Q.jsx)(U.Header, {
        ...
        actions: (0, Q.jsxs)(se, {
          color: `ghost`,
          size: `toolbar`,
          disabled: B?.filePath == null,
          onClick: () => {
            B?.filePath != null &&
              N({
                path: B.filePath,
                cwd: B.workspaceRoot == null ? null : t(B.workspaceRoot),
                hostId: e,
                target: Se?.preferredTarget,
                openFile: le.mutate,
              });
          },
          children: [
            ...
            (0, Q.jsx)(H, {
              ...
              control: (0, Q.jsx)(he, {
                ...
                triggerButton: (0, Q.jsx)(ye, {
                  disabled: $ || Z != null,
                  contentClassName: `truncate`,
                  children: rt(ke)?.label ?? ke,
                }),
                children: Pe.map((e) =>
                  (0, Q.jsx)(
                    L.Item,
                    {
                      RightIcon: e.value === ke ? pe : void 0,
                      subTextAllowWrap: !0,
                      onSelect: () => {
                        X(`approval`, `approval_policy`, e.value);
                      },
                      SubText: (0, Q.jsx)(`div`, {
            ...
            (0, Q.jsx)(H, {
              ...
              control: (0, Q.jsx)(he, {
                ...
                triggerButton: (0, Q.jsx)(ye, {
                  disabled: $ || Ie != null,
                  contentClassName: `truncate`,
                  children: it(Ae)?.label ?? Ae,
                }),
                children: Y.map((e) =>
                  (0, Q.jsx)(
                    L.Item,
                    {
                      RightIcon: e.value === Ae ? pe : void 0,
                      subTextAllowWrap: !0,
                      onSelect: () => {
                        X(`sandbox`, `sandbox_mode`, e.value);
                      },
                      SubText: (0, Q.jsx)(`div`, {
                        className: `pt-1 text-sm text-token-text-secondary`,
                        children: e.description,
            ...
            V
              ? (0, Q.jsx)(H, {
                  ...
                  control: (0, Q.jsx)(ve, {
                    ...
                    disabled: $ || Le != null,
                    onChange: (e) => {
                      X(`network`, `sandbox_workspace_write.network_access`, e);
                    },
...
function Ye(e) {
  ...
  t[0] === n
    ? (a = t[1])
    : ((a = (0, Q.jsx)(`div`, { children: n })), (t[0] = n), (t[1] = a));
  let o;
  t[2] === i
    ? (o = t[3])
    : ((o =
...
function Ze(e, t) {
  ...
  for (let r of e) {
    ...
    let e = Qe(r.name.dotCodexFolder);
    n.push({
      ...
      label: t.formatMessage(
        ...
        { repoName: $e(e ?? r.name.dotCodexFolder) },
      ),
      tooltipText: D(r.name) ?? r.name.dotCodexFolder,
      filePath: D(r.name),
...
function nt({
  ...
  return (
    t ??
    (i
      ? r?.kind !== `managed` && n != null && O(n.name)
        ? e.formatMessage({
...
function rt(e) {
  return Ve.find((t) => t.value === e) ?? null;
}
function it(e) {
  return He.find((t) => t.value === e) ?? null;
}
function at(e) {
  return e === `untrusted` ||
    e === `on-failure` ||
...
export { Ue as AgentSettings };
//# sourceMappingURL=agent-settings-BM8f40Nt.js.map
